...
The interactive build facilities may be found in the org.eclipse.ocl.build plugin. The "Generate OCL All" launch invokes all the sub-generators for models and editors.
