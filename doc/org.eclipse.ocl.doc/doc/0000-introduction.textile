...
A PDF version of this documentation is available at "OCL 6.3.0 Documentation":http://download.eclipse.org/ocl/doc/6.3.0/ocl.pdf.
...
Full model-driven extensibility is planned for the Photon release.
...
Direct tooling of the UML 2.5 and OCL 2.5 specifications for the Photon Eclipse release may demonstrate that the OCL aspects of the specifications is also functionally consistent.
