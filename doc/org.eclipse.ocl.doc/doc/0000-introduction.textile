...
Full model-driven extensibility is planned for the Neon release.
...
Direct tooling of the UML 2.5 and OCL 2.5 specifications for the Neon Eclipse release may demonstrate that the OCL aspects of the specifications is also functionally consistent.
