...
The available export formats are extensible through the org.eclipse.ocl.emf.validation.validity.validity_exporter extension point.
...
The constraints displayed in the right hand pane are located by constraint locators that are registered with the org.eclipse.ocl.emf.validation.validity.constraint_locator extension point. A constraint locator implements org.eclipse.ocl.emf.validation.validity.locator.ConstraintLocator or the org.eclipse.ocl.emf.validation.validity.ui.locator.ConstraintUILocator to define location, presentation, execution and debug launching of a particular kind of constraint.
...
h4. org.eclipse.ocl.emf.validation.validity.locator.EClassConstraintLocator
...
h4. org.eclipse.ocl.emf.validation.validity.locator.EValidatorConstraintLocator
