...
<genAnnotations source="http://www.eclipse.org/OCL/GenModel/ToString">
  <details key="org.eclipse.ocl.codegen.cgmodel.CGElement"
    value="return &lt;%org.eclipse.ocl.codegen.analyzer.CG2StringVisitor%>.toString(this);"/>
</genAnnotations>
...
h4. @org.eclipse.ocl.build@

The @org.eclipse.ocl.build@ plugin hosts the build-time functionality that does not need to bloat the distribution.
...
Custom JET templates are declared by OCLBuildGenModelGeneratorAdapterFactory which creates a OCLBuildGenClassGeneratorAdapter that replaces the normal reference to @org.eclipse.emf.codegen.ecore.templates.model.Class@ by @org.eclipse.ocl.build.templates.model.Class@.
