...
In earlier releases, the EMF idiom was followed whereby Problems View markers were created by ther save action
of an appropriate editor. Problems in files that had not been saved were often not visible and so diagnosis
onlyoccurred when some consuming application complained..
