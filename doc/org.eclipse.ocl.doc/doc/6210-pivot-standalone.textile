...
h2(#PivotStandalone). Pivot Standalone API Configuration
...
If you want to use an alternate library examine the code for the standard installation above, and if you want to compile your library examine the @/org.eclipse.ocl.build/src/org/eclipse/ocl/build/GenerateOCLstdlibModel.mwe2@ launcher for the
@/org.eclipse.ocl.build/src/org/eclipse/ocl/build/xtend/GenerateOCLstdlibXtend.xtend@ Xtend template.
