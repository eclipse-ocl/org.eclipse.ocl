...
If you want to use direct calls to Java operations, the "java:" parsing and evaluation support must be activated.

bc.. 
org.eclipse.ocl.examples.codegen.java.JavaLanguageSupport.FACTORY.install();
