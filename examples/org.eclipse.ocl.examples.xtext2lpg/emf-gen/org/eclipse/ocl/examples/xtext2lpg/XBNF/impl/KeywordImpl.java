 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.examples.xtext2lpg.XBNF.impl.KeywordImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KeywordImpl extends AbstractElementImpl implements Keyword {
	...
	protected EClass eStaticClass() {
		return XBNFPackage.Literals.KEYWORD;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XBNFPackage.KEYWORD__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XBNFPackage.KEYWORD__VALUE:
				return getValue();
		}
