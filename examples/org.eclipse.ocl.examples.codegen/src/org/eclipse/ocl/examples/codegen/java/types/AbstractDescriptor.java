...
public abstract class AbstractDescriptor implements TypeDescriptor
{
	...
	public @NonNull Boolean appendBox(@NonNull JavaStream js, @NonNull ExecutableNameManager localNameManager, @NonNull CGBoxExp cgBoxExp, @NonNull CGValuedElement unboxedValue) {
		...
		js.append(" = ");
		if (!unboxedValue.isRequiredOrNonNull() && !js.isPrimitive(unboxedValue)) {
	...
	@Override
	public void appendCastTerm(@NonNull JavaStream js, @Nullable Boolean isRequired, @NonNull CGValuedElement cgElement) {
		js.append("(");
		append(js, isRequired);
		js.append(")");
	...
	protected @NonNull Boolean appendEcoreLegacy(@NonNull JavaStream js, @NonNull NestedNameManager localNameManager, @NonNull CGEcoreExp cgEcoreExp, @NonNull CGValuedElement unboxedValue) {
	...
	public @NonNull Boolean appendEcoreStatements(@NonNull JavaStream js, @NonNull ExecutableNameManager localNameManager,
		...
		return ecoreDescriptor.appendEcore(js, localNameManager, cgEcoreExp, boxedValue);
	...
	public void appendEqualsValue(@NonNull JavaStream js, @NonNull CGValuedElement thisValue, @NonNull CGValuedElement thatValue, boolean notEquals) {
		...
		if (isBoxedType(metamodelManager, thisValue) && isBoxedType(metamodelManager, thatValue)) {
			boolean nullSafe = thisValue.isRequiredOrNonNull() && thatValue.isRequiredOrNonNull();
			if (!nullSafe) {
				String prefix = "";
				if (!thisValue.isRequiredOrNonNull()) {
					js.append("(");
					js.appendValueName(thisValue);
					js.append(" != null)");
					prefix = " && ";
				}
				if (!thatValue.isRequiredOrNonNull()) {
					js.append(prefix);
					js.append("(");
		...
		else if (thisValue.isRequiredOrNonNull()) {
			if (notEquals) {
				js.append("!");
			}
...
//	@Override
	...
	protected boolean isBoxedType(@NonNull PivotMetamodelManager metamodelManager, @NonNull CGValuedElement cgValue) {
		...
		Type type = asType/*.behavioralType()*/;
