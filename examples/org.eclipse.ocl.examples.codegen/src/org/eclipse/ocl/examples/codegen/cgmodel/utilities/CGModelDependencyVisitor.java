 ...
 */
public class CGModelDependencyVisitor extends DependencyVisitor
{
	public CGModelDependencyVisitor(@NonNull JavaCodeGenerator codeGenerator, @NonNull GlobalPlace globalPlace) {
