...
public class NameManagerHelper
{
	...
	public static class ASNameHelper extends AbstractExtendingVisitor<@Nullable String, @NonNull NameManagerHelper>
	{
		...
		@Override
		public @Nullable String visitCollectionLiteralExp(@NonNull CollectionLiteralExp object) {
			Type type = object.getType();
			return type != null ? context.getTypeNameHint(type) : null;
		}

		@Override
		public @Nullable String visitCollectionRange(@NonNull CollectionRange object) {
			return RANGE_NAME_HINT_PREFIX;
		}

		@Override
		public @Nullable String visitExpressionInOCL(@NonNull ExpressionInOCL object) {
			return EXPRESSION_IN_OCL_NAME_HINT_PREFIX;
		}

		@Override
		public @Nullable String visitIntegerLiteralExp(@NonNull IntegerLiteralExp object) {
			Number numberSymbol = object.getIntegerSymbol();
			return numberSymbol != null ? context.getNumericNameHint(numberSymbol) : null;
		}

		@Override
		public @Nullable String visitLiteralExp(@NonNull LiteralExp object) {
			return "literal";
		}

		@Override
		public @Nullable String visitLoopExp(@NonNull LoopExp object) {
			Iteration referredIteration = object.getReferredIteration();
			return referredIteration != null ? context.getIterationNameHint(referredIteration) : null;
		}

		@Override
		public @Nullable String visitNamedElement(@NonNull NamedElement object) {
			return object.getName();
		}

		@Override
		public @Nullable String visitOperation(@NonNull Operation object) {
			return context.getOperationNameHint(object);
		}

		@Override
		public @Nullable String visitOperationCallExp(@NonNull OperationCallExp object) {
			Operation referredOperation = object.getReferredOperation();
			return referredOperation != null ? context.getOperationCallExpNameHint(referredOperation) : null;
		}

		@Override
		public @Nullable String visitOppositePropertyCallExp(@NonNull OppositePropertyCallExp object) {
			...
			return referredProperty != null ? context.getPropertyNameHint(referredProperty) : null;
		}

		@Override
		public @Nullable String visitPropertyCallExp(@NonNull PropertyCallExp object) {
			Property referredProperty = object.getReferredProperty();
			return referredProperty != null ? context.getPropertyNameHint(referredProperty) : null;
		}

		@Override
		public @Nullable String visitRealLiteralExp(@NonNull RealLiteralExp object) {
			Number numberSymbol = object.getRealSymbol();
			return numberSymbol != null ? context.getNumericNameHint(numberSymbol) : null;
		}

		@Override
		public @Nullable String visitStringLiteralExp(@NonNull StringLiteralExp object) {
			String stringSymbol = object.getStringSymbol();
			return stringSymbol != null ? context.getStringNameHint(stringSymbol) : null;
		}

		@Override
		public @Nullable String visitTupleLiteralExp(@NonNull TupleLiteralExp object) {
			return TUPLE_NAME_HINT_PREFIX;
		}

		@Override
		public @Nullable String visitType(@NonNull Type object) {
			return context.getTypeNameHint(object);
		}

		@Override
		public @Nullable String visitTypeExp(@NonNull TypeExp object) {
			Type referredType = object.getType();
			return referredType != null ? context.getTypeNameHint(referredType) : null;
		}

		@Override
		public @Nullable String visitUnlimitedNaturalLiteralExp(@NonNull UnlimitedNaturalLiteralExp object) {
			Number numberSymbol = object.getUnlimitedNaturalSymbol();
			return numberSymbol != null ? context.getNumericNameHint(numberSymbol) : null;
		}

		@Override
		public @Nullable String visitVariableExp(@NonNull VariableExp object) {
			VariableDeclaration referredVariable = object.getReferredVariable();
			return referredVariable != null ? context.getVariableDeclarationNameHint(referredVariable) : null;
		}
	...
	public static class CGNameHelper extends AbstractExtendingCGModelVisitor<@Nullable String, @NonNull NameManagerHelper>
	{
		...
		@Override
		public @Nullable String visitCGAccumulator(@NonNull CGAccumulator object) {
			return "accumulator";
		}
		...
		@Override
		public @Nullable String visitCGCastExp(@NonNull CGCastExp object) {
		...
		@Override
		public @Nullable String visitCGCollectionExp(@NonNull CGCollectionExp object) {
			String kind = object.getName();
			return kind != null ? context.getKindHint(kind) : null;
		}

		@Override
		public @Nullable String visitCGCollectionPart(@NonNull CGCollectionPart object) {
			return RANGE_NAME_HINT_PREFIX;
		}
		...
		@Override
		public @Nullable String visitCGElementId(@NonNull CGElementId object) {
			ElementId elementId = object.getElementId();
			return elementId.accept(context.idVisitor);
		}

		@Override
		public @Nullable String visitCGExecutorType(@NonNull CGExecutorType object) {
			return context.getTypeNameHint(CGUtil.getAST(object));
		}
		...
		@Override
		public @Nullable String visitCGInteger(@NonNull CGInteger object) {
			Number numericValue = object.getNumericValue();
			return numericValue != null ? context.getNumericNameHint(numericValue) : null;
		}

		@Override
		public @Nullable String visitCGIterationCallExp(@NonNull CGIterationCallExp object) {
			Iteration referredIteration = ((LoopExp)object.getAst()).getReferredIteration();
			return referredIteration != null ? context.getIterationNameHint(referredIteration) : null;
		}

		@Override
		public @Nullable String visitCGInvalid(@NonNull CGInvalid object) {
			String nameHint = INVALID_NAME_HINT_PREFIX;
			return nameHint;
		}

		@Override
		public @Nullable String visitCGMapPart(@NonNull CGMapPart object) {
		...
		@Override
		public @Nullable String visitCGOperationCallExp(@NonNull CGOperationCallExp object) {
			Operation referredOperation = object.getReferredOperation();
			return referredOperation != null ? context.getOperationCallExpNameHint(referredOperation) : null;
		}

		@Override
		public @Nullable String visitCGOppositePropertyCallExp(@NonNull CGOppositePropertyCallExp object) {
		...
		@Override
		public @Nullable String visitCGPropertyCallExp(@NonNull CGPropertyCallExp object) {
		...
		@Override
		public @Nullable String visitCGReal(@NonNull CGReal object) {
			Number numericValue = object.getNumericValue();
			return numericValue != null ? context.getNumericNameHint(numericValue) : null;
		}

		@Override
		public @Nullable String visitCGString(@NonNull CGString object) {
			String stringValue = object.getStringValue();
			return stringValue != null ? context.getStringNameHint(stringValue) : null;
		}
...
/*		@Override
		public @Nullable String visitCGTypeId(@NonNull CGTypeId object) {
		//	Element type = object.getAst();
		//	return (type instanceof Type) ? context.getTypeNameHint((Type) type) : null;
			ElementId elementId = object.getElementId();
			return elementId.accept(context.idVisitor);
		} */
...
//	}
	...
	protected @NonNull String getIterationNameHint(@NonNull Iteration anIteration) {
	...
	protected @NonNull String getKindHint(@NonNull String kind) {
...
//	}
	...
	public @Nullable String getNameHint(@NonNull Object anObject) {
		if (anObject instanceof CGElement) {
			if (anObject instanceof CGValuedElement) {
				if (anObject instanceof CGConstantExp) {
					getClass();		// XXX
				}
	...
	protected @NonNull String getOperationNameHint(@NonNull Operation anOperation) {
	...
	protected @NonNull String getOperationCallExpNameHint(@NonNull Operation anOperation) {
	...
	protected @NonNull String getPropertyNameHint(@NonNull Property aProperty) {
	...
	protected @NonNull String getStringNameHint(@NonNull String aString) {
	...
	protected @NonNull String getTypeNameHint(@NonNull Type aType) {
