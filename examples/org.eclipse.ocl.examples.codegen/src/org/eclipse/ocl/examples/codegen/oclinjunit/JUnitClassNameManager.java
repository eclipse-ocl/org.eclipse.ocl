 ...
 */
public class JUnitClassNameManager extends ClassNameManager
{
	public JUnitClassNameManager(@NonNull JavaCodeGenerator codeGenerator, @NonNull NameManager parent, @NonNull CGClass cgClass) {
