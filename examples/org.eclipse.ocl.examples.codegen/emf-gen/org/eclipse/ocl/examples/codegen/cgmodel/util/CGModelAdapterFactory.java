...
public class CGModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected CGModelSwitch<@Nullable Adapter> modelSwitch =
		new CGModelSwitch<@Nullable Adapter>() {
			...
			@Override
			public Adapter caseCGForeignOperationCallExp(CGForeignOperationCallExp object) {
				return createCGForeignOperationCallExpAdapter();
			}
			@Override
			public Adapter caseCGForeignProperty(CGForeignProperty object) {
				return createCGForeignPropertyAdapter();
			}
			@Override
			public Adapter caseCGForeignPropertyCallExp(CGForeignPropertyCallExp object) {
				return createCGForeignPropertyCallExpAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.ocl.examples.codegen.cgmodel.CGForeignOperationCallExp <em>CG Foreign Operation Call Exp</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCGForeignOperationCallExpAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.ocl.examples.codegen.cgmodel.CGForeignProperty <em>CG Foreign Property</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCGForeignPropertyAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.ocl.examples.codegen.cgmodel.CGForeignPropertyCallExp <em>CG Foreign Property Call Exp</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCGForeignPropertyCallExpAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.ocl.examples.codegen.cgmodel.CGTemplateParameterExp <em>CG Template Parameter Exp</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
