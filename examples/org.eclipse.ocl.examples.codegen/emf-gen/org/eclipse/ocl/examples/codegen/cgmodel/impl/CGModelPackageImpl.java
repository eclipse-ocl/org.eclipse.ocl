...
public class CGModelPackageImpl extends EPackageImpl implements CGModelPackage {
	 ...
	 * @generated
	 */
	private EClass cgBodiedPropertyEClass = null;
	 ...
	 * @generated
	 */
	private EClass cgConstrainedPropertyEClass = null;
	 ...
	 * @generated
	 */
	private EClass cgSourcedCallExpEClass = null;
	 ...
	 * @generated
	 */
	private EClass cgForeignOperationCallExpEClass = null;
	 ...
	 * @generated
	 */
	private EClass cgForeignPropertyEClass = null;
	 ...
	 * @generated
	 */
	private EClass cgForeignPropertyCallExpEClass = null;
	 ...
	 * @generated
	 */
	private EClass cgInlinedOperationEClass = null;
	 ...
	 * @generated
	 */
	private EDataType operationCallingConventionEDataType = null;
	 ...
	 * @generated
	 */
	private EDataType propertyCallingConventionEDataType = null;
	 ...
	 */
	@Override
	public EClass getCGBodiedProperty() {
		return cgBodiedPropertyEClass;
	}
	 ...
	 */
	@Override
	public EReference getCGBodiedProperty_Body() {
		return (EReference)cgBodiedPropertyEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EClass getCGConstrainedProperty() {
		return cgConstrainedPropertyEClass;
	}
	 ...
	 */
	@Override
	public EClass getCGSourcedCallExp() {
		return cgSourcedCallExpEClass;
	}
	 ...
	 */
	@Override
	public EReference getCGSourcedCallExp_Source() {
		return (EReference)cgSourcedCallExpEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EClass getCGForeignOperationCallExp() {
		return cgForeignOperationCallExpEClass;
	}
	 ...
	 */
	@Override
	public EClass getCGForeignProperty() {
		return cgForeignPropertyEClass;
	}
	 ...
	 */
	@Override
	public EReference getCGExecutorProperty_InitExpression() {
	...
	public EReference getCGExecutorProperty_UnderlyingPropertyId() {
		return (EReference)cgExecutorPropertyEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getCGIterationCallExp_ReferredIteration() {
	 ...
	 */
	@Override
	public EAttribute getCGIterationCallExp_AsIteration() {
		return (EAttribute)cgIterationCallExpEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EReference getCGNativeOperationCallExp_CgThis() {
		return (EReference)cgNativeOperationCallExpEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getCGNavigationCallExp_ReferredProperty() {
		return (EReference)cgNavigationCallExpEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getCGNavigationCallExp_AsProperty() {
		return (EAttribute)cgNavigationCallExpEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getCGOperation_CallingConvention() {
		return (EAttribute)cgOperationEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getCGOperationCallExp_ReferredOperation() {
	 ...
	 */
	@Override
	public EAttribute getCGOperationCallExp_AsOperation() {
		return (EAttribute)cgOperationCallExpEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getCGParameter_IsSelf() {
		return (EAttribute)cgParameterEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getCGParameter_IsThis() {
		return (EAttribute)cgParameterEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getCGPropertyAssignment_ReferredProperty() {
	...
	public EReference getCGPropertyAssignment_OwnedSlotValue() {
		return (EReference)cgPropertyAssignmentEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EAttribute getCGPropertyAssignment_AsProperty() {
		return (EAttribute)cgPropertyAssignmentEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EAttribute getCGProperty_CallingConvention() {
		return (EAttribute)cgPropertyEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EDataType getOperationCallingConvention() {
		return operationCallingConventionEDataType;
	}
	 ...
	 */
	@Override
	public EDataType getPropertyCallingConvention() {
		return propertyCallingConventionEDataType;
	}
	...
	public void createPackageContents() {
		...
		cgBodiedPropertyEClass = createEClass(2);
		createEReference(cgBodiedPropertyEClass, 7);

		cgBooleanEClass = createEClass(3);
		createEAttribute(cgBooleanEClass, 5);

		cgBoxExpEClass = createEClass(4);

		cgBuiltInIterationCallExpEClass = createEClass(5);
		createEReference(cgBuiltInIterationCallExpEClass, 13);

		cgCachedOperationEClass = createEClass(6);
		createEReference(cgCachedOperationEClass, 11);
		createEReference(cgCachedOperationEClass, 12);

		cgCachedOperationCallExpEClass = createEClass(7);
		createEAttribute(cgCachedOperationCallExpEClass, 10);
		createEAttribute(cgCachedOperationCallExpEClass, 11);

		cgCallableEClass = createEClass(8);
		createEReference(cgCallableEClass, 5);
		createEReference(cgCallableEClass, 6);

		cgCallExpEClass = createEClass(9);
		createEAttribute(cgCallExpEClass, 5);
		createEAttribute(cgCallExpEClass, 6);

		cgCastExpEClass = createEClass(10);
		createEReference(cgCastExpEClass, 8);

		cgCatchExpEClass = createEClass(11);

		cgClassEClass = createEClass(12);
		...
		createEReference(cgCollectionExpEClass, 5);

		cgCollectionPartEClass = createEClass(14);
		createEReference(cgCollectionPartEClass, 5);
		createEReference(cgCollectionPartEClass, 6);
		createEReference(cgCollectionPartEClass, 7);

		cgConstantEClass = createEClass(15);

		cgConstantExpEClass = createEClass(16);
		createEReference(cgConstantExpEClass, 5);

		cgConstrainedPropertyEClass = createEClass(17);

		cgConstraintEClass = createEClass(18);
		...
		createEReference(cgEcoreExpEClass, 8);
		...
		createEReference(cgEcoreOperationCallExpEClass, 10);
		...
		createEAttribute(cgGuardExpEClass, 8);
		...
		createEReference(cgIndexExpEClass, 8);
		...
		createEReference(cgIsEqualExpEClass, 8);
		createEAttribute(cgIsEqualExpEClass, 9);

		cgIsEqual2ExpEClass = createEClass(49);
		createEReference(cgIsEqual2ExpEClass, 8);

		cgIsInvalidExpEClass = createEClass(50);

		cgIsKindOfExpEClass = createEClass(51);
		createEReference(cgIsKindOfExpEClass, 8);
		...
		createEAttribute(cgIterationCallExpEClass, 12);
		...
		createEAttribute(cgLibraryOperationCallExpEClass, 10);
		...
		createEReference(cgNativeOperationCallExpEClass, 13);
		...
		createEReference(cgNavigationCallExpEClass, 8);
		...
		createEReference(cgOperationCallExpEClass, 7);
		...
		createEReference(cgSourcedCallExpEClass, 7);
	...
	public void initializePackageContents() {
		...
		cgAssertNonNullExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		cgBodiedPropertyEClass.getESuperTypes().add(this.getCGProperty());
		cgBooleanEClass.getESuperTypes().add(this.getCGConstant());
		cgBoxExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		...
		cgCastExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		cgCatchExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		...
		cgForeignOperationCallExpEClass.getESuperTypes().add(this.getCGOperationCallExp());
		cgForeignPropertyEClass.getESuperTypes().add(this.getCGBodiedProperty());
		...
		cgIsEqualExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		cgIsEqual2ExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		cgIsInvalidExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		cgIsKindOfExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		cgIsUndefinedExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		cgIterationCallExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		...
		cgNativePropertyEClass.getESuperTypes().add(this.getCGBodiedProperty());
		cgNativePropertyCallExpEClass.getESuperTypes().add(this.getCGPropertyCallExp());
		cgNavigationCallExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		...
		cgPropertyAssignmentEClass.getESuperTypes().add(this.getCGValuedElement());
		cgPropertyCallExpEClass.getESuperTypes().add(this.getCGNavigationCallExp());
		cgRealEClass.getESuperTypes().add(this.getCGNumber());
		cgSequenceEClass.getESuperTypes().add(this.getCGValuedElement());
		...
		cgSourcedCallExpEClass.getESuperTypes().add(this.getCGCallExp());
		...
		cgThrowExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		...
		cgUnboxExpEClass.getESuperTypes().add(this.getCGSourcedCallExp());
		...
		initEClass(cgBodiedPropertyEClass, CGBodiedProperty.class, "CGBodiedProperty", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCGBodiedProperty_Body(), this.getCGValuedElement(), null, "body", null, 0, 1, CGBodiedProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(cgConstrainedPropertyEClass, CGConstrainedProperty.class, "CGConstrainedProperty", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEReference(getCGExecutorProperty_InitExpression(), this.getCGValuedElement(), null, "initExpression", null, 0, 1, CGExecutorProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCGIterationCallExp_ReferredIteration(), this.getCGOperation(), null, "referredIteration", null, 1, 1, CGIterationCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCGIterationCallExp_AsIteration(), this.getIteration(), "asIteration", null, 1, 1, CGIterationCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCGNativeOperationCallExp_CgThis(), this.getCGValuedElement(), null, "cgThis", null, 0, 1, CGNativeOperationCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCGNavigationCallExp_ReferredProperty(), this.getCGProperty(), null, "referredProperty", null, 1, 1, CGNavigationCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCGNavigationCallExp_AsProperty(), this.getProperty(), "asProperty", null, 1, 1, CGNavigationCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCGOperation_CallingConvention(), this.getOperationCallingConvention(), "callingConvention", null, 1, 1, CGOperation.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCGOperationCallExp_ReferredOperation(), this.getCGOperation(), null, "referredOperation", null, 1, 1, CGOperationCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCGOperationCallExp_AsOperation(), this.getOperation(), "asOperation", null, 1, 1, CGOperationCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCGParameter_IsSelf(), ecorePackage.getEBoolean(), "isSelf", "false", 0, 1, CGParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCGParameter_IsThis(), ecorePackage.getEBoolean(), "isThis", "false", 0, 1, CGParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(cgPropertyEClass, CGProperty.class, "CGProperty", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCGProperty_CallingConvention(), this.getPropertyCallingConvention(), "callingConvention", null, 1, 1, CGProperty.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCGPropertyAssignment_ReferredProperty(), this.getCGProperty(), null, "referredProperty", null, 1, 1, CGPropertyAssignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCGPropertyAssignment_OwnedInitValue(), this.getCGValuedElement(), null, "ownedInitValue", null, 1, 1, CGPropertyAssignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCGPropertyAssignment_OwnedSlotValue(), this.getCGValuedElement(), null, "ownedSlotValue", null, 1, 1, CGPropertyAssignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCGPropertyAssignment_AsProperty(), this.getProperty(), "asProperty", null, 1, 1, CGPropertyAssignment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCGSequence_OwnedStatements(), this.getCGValuedElement(), null, "ownedStatements", null, 0, -1, CGSequence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(cgSourcedCallExpEClass, CGSourcedCallExp.class, "CGSourcedCallExp", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getCGSourcedCallExp_Source(), this.getCGValuedElement(), null, "source", null, 0, 1, CGSourcedCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
