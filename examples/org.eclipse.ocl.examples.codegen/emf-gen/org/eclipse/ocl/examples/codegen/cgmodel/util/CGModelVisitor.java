...
public interface CGModelVisitor<R>
{
	...
	R visitCGForeignProperty(org.eclipse.ocl.examples.codegen.cgmodel.@NonNull CGForeignProperty object);
	...
	R visitCGIndexExp(org.eclipse.ocl.examples.codegen.cgmodel.@NonNull CGIndexExp object);
	...
	R visitCGSourcedCallExp(org.eclipse.ocl.examples.codegen.cgmodel.@NonNull CGSourcedCallExp object);
