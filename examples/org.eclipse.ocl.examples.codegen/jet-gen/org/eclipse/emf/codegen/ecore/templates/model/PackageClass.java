...
public class PackageClass
{
  ...
  protected final String TEXT_56 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected String packageFilename = \"";
  protected final String TEXT_57 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_58 = NL + "\tprivate ";
  protected final String TEXT_59 = " ";
  protected final String TEXT_60 = " = null;" + NL;
  protected final String TEXT_61 = NL + "\t/**" + NL + "\t * Creates an instance of the model <b>Package</b>, registered with" + NL + "\t * {@link org.eclipse.emf.ecore.EPackage.Registry EPackage.Registry} by the package" + NL + "\t * package URI value." + NL + "\t * <p>Note: the correct way to create the package is via the static" + NL + "\t * factory method {@link #init init()}, which also performs" + NL + "\t * initialization of the package, or returns the registered package," + NL + "\t * if one already exists." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see org.eclipse.emf.ecore.EPackage.Registry" + NL + "\t * @see ";
  protected final String TEXT_62 = "#eNS_URI" + NL + "\t * @see #init()" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate ";
  protected final String TEXT_63 = "()" + NL + "\t{" + NL + "\t\tsuper(eNS_URI, ";
  protected final String TEXT_64 = ");" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate static boolean isInited = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates, registers, and initializes the <b>Package</b> for this model, and for any others upon which it depends." + NL + "\t *" + NL + "\t * <p>This method is used to initialize {@link ";
  protected final String TEXT_65 = "#eINSTANCE} when that field is accessed." + NL + "\t * Clients should not invoke it directly. Instead, they should simply access that field to obtain the package." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #eNS_URI";
  protected final String TEXT_66 = NL + "\t * @see #createPackageContents()" + NL + "\t * @see #initializePackageContents()";
  protected final String TEXT_67 = NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static ";
  protected final String TEXT_68 = " init()" + NL + "\t{" + NL + "\t\tif (isInited) return (";
  protected final String TEXT_69 = ")";
  protected final String TEXT_70 = ".Registry.INSTANCE.getEPackage(";
  protected final String TEXT_71 = ".eNS_URI);" + NL;
  protected final String TEXT_72 = NL + "\t\tinitializeRegistryHelpers();" + NL;
  protected final String TEXT_73 = NL + "\t\t// Obtain or create and register package" + NL + "\t\tObject registered";
  protected final String TEXT_74 = ".Registry.INSTANCE.get(eNS_URI);" + NL + "\t\t";
  protected final String TEXT_75 = " the";
  protected final String TEXT_76 = " = registered";
  protected final String TEXT_77 = " instanceof ";
  protected final String TEXT_78 = " ? (";
  protected final String TEXT_79 = ")registered";
  protected final String TEXT_80 = " : new ";
  protected final String TEXT_81 = "();" + NL + "" + NL + "\t\tisInited = true;" + NL;
  protected final String TEXT_82 = NL + "\t\t// Initialize simple dependencies";
  protected final String TEXT_83 = NL + "\t\t";
  protected final String TEXT_84 = ".eINSTANCE.eClass();";
  protected final String TEXT_85 = NL + "\t\t// Obtain or create and register interdependencies";
  protected final String TEXT_86 = "Object ";
  protected final String TEXT_87 = "registeredPackage = ";
  protected final String TEXT_88 = ".eNS_URI);" + NL + "\t\t";
  protected final String TEXT_89 = " = (";
  protected final String TEXT_90 = ")(registeredPackage instanceof ";
  protected final String TEXT_91 = " ? registeredPackage : ";
  protected final String TEXT_92 = ".eINSTANCE);";
  protected final String TEXT_93 = NL + "\t\t// Load packages";
  protected final String TEXT_94 = NL + "\t\tthe";
  protected final String TEXT_95 = ".loadPackage();";
  protected final String TEXT_96 = NL + "\t\t// Create package meta-data objects";
  protected final String TEXT_97 = ".createPackageContents();";
  protected final String TEXT_98 = NL + NL + "\t\t// Initialize created meta-data";
  protected final String TEXT_99 = ".initializePackageContents();";
  protected final String TEXT_100 = NL + "\t\t// Fix loaded packages";
  protected final String TEXT_101 = ".fixPackageContents();";
  protected final String TEXT_102 = NL + "\t\t// Register package validator" + NL + "\t\t";
  protected final String TEXT_103 = ".Registry.INSTANCE.put" + NL + "\t\t\t(the";
  protected final String TEXT_104 = "," + NL + "\t\t\t new ";
  protected final String TEXT_105 = ".Descriptor()" + NL + "\t\t\t {";
  protected final String TEXT_106 = NL + "\t\t\t\t @Override";
  protected final String TEXT_107 = NL + "\t\t\t\t public ";
  protected final String TEXT_108 = " getEValidator()" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return ";
  protected final String TEXT_109 = ".INSTANCE;" + NL + "\t\t\t\t }" + NL + "\t\t\t });" + NL;
  protected final String TEXT_110 = NL + "\t\t// Mark meta-data to indicate it can't be changed" + NL + "\t\tthe";
  protected final String TEXT_111 = ".freeze();" + NL;
  protected final String TEXT_112 = NL + "\t\t// Update the registry and return the package" + NL + "\t\t";
  protected final String TEXT_113 = ".Registry.INSTANCE.put(";
  protected final String TEXT_114 = ".eNS_URI, the";
  protected final String TEXT_115 = ");" + NL + "\t\treturn the";
  protected final String TEXT_116 = ";" + NL + "\t}";
  protected final String TEXT_117 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static void initializeRegistryHelpers()" + NL + "\t{";
  protected final String TEXT_118 = ".register" + NL + "\t\t\t(";
  protected final String TEXT_119 = ".class," + NL + "\t\t\t new ";
  protected final String TEXT_120 = ".Helper()" + NL + "\t\t\t {" + NL + "\t\t\t\t public boolean isInstance(Object instance)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return instance instanceof ";
  protected final String TEXT_121 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return new ";
  protected final String TEXT_122 = "[size];" + NL + "\t\t\t\t }" + NL + "\t\t\t });";
  protected final String TEXT_123 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {";
  ...
  protected final String TEXT_128 = NL + "\t}" + NL + "" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static class WhiteList implements ";
  protected final String TEXT_129 = ", EBasicWhiteList" + NL + "\t{";
  protected final String TEXT_130 = NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tprotected ";
  protected final String TEXT_131 = ";" + NL;
  protected final String TEXT_132 = NL + "\t}";
  protected final String TEXT_133 = NL + "\t * Returns the meta object for class '{@link ";
  protected final String TEXT_134 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for class '<em>";
  protected final String TEXT_135 = "</em>'." + NL + "\t * @see ";
  protected final String TEXT_136 = NL + "\t * @model ";
  protected final String TEXT_137 = NL + "\t *        ";
  protected final String TEXT_138 = NL + "\t * @model";
  protected final String TEXT_139 = NL + "\t * Returns the meta object for enum '{@link ";
  protected final String TEXT_140 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for enum '<em>";
  protected final String TEXT_141 = NL + "\t * Returns the meta object for data type '<em>";
  protected final String TEXT_142 = "</em>'.";
  protected final String TEXT_143 = NL + "\t * Returns the meta object for data type '{@link ";
  protected final String TEXT_144 = "</em>}'.";
  protected final String TEXT_145 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_146 = NL + "     * <!-- begin-model-doc -->" + NL + "     * ";
  protected final String TEXT_147 = NL + "     * <!-- end-model-doc -->";
  protected final String TEXT_148 = NL + "\t * @return the meta object for data type '<em>";
  ...
  protected final String TEXT_154 = " == null)" + NL + "\t\t{" + NL + "\t\t\t";
  protected final String TEXT_155 = ".eNS_URI).getEClassifiers().get(";
  protected final String TEXT_156 = ");" + NL + "\t\t}";
  protected final String TEXT_157 = NL + "\t\treturn ";
  protected final String TEXT_158 = ";" + NL + "\t}" + NL;
  protected final String TEXT_159 = "();" + NL;
  protected final String TEXT_160 = NL + "\t/**" + NL + "\t * Returns the meta object for the ";
  protected final String TEXT_161 = " '{@link ";
  protected final String TEXT_162 = "#";
  protected final String TEXT_163 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the ";
  protected final String TEXT_164 = " '<em>";
  protected final String TEXT_165 = NL + "\t * @see #get";
  protected final String TEXT_166 = NL + "\t\treturn (";
  protected final String TEXT_167 = ".getEStructuralFeatures().get(";
  ...
  protected final String TEXT_173 = NL + "\t/**" + NL + "\t * Returns the meta object for the '{@link ";
  protected final String TEXT_174 = "(";
  protected final String TEXT_175 = ") <em>";
  protected final String TEXT_176 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the '<em>";
  protected final String TEXT_177 = "</em>' operation." + NL + "\t * @see ";
  protected final String TEXT_178 = ".getEOperations().get(";
  protected final String TEXT_179 = NL + "        return get";
  protected final String TEXT_180 = "().getEOperations().get(";
  protected final String TEXT_181 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_182 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_183 = "()" + NL + "\t{" + NL + "\t\treturn (";
  protected final String TEXT_184 = ")getEFactoryInstance();" + NL + "\t}";
  protected final String TEXT_185 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_186 = NL + "\t@SuppressWarnings(\"deprecation\")";
  protected final String TEXT_187 = NL + "\tpublic void createPackageContents()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;";
  protected final String TEXT_188 = NL + NL + "\t\t// Create classes and their features";
  protected final String TEXT_189 = " = create";
  protected final String TEXT_190 = NL + "\t\tcreate";
  protected final String TEXT_191 = ", ";
  protected final String TEXT_192 = NL + "\t\tcreateEOperation(";
  protected final String TEXT_193 = NL + NL + "\t\t// Create enums";
  protected final String TEXT_194 = " = createEEnum(";
  protected final String TEXT_195 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_196 = " = createEDataType(";
  protected final String TEXT_197 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_198 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_199 = NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_200 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_201 = ".eNS_URI);";
  protected final String TEXT_202 = NL + NL + "\t\t// Add subpackages";
  protected final String TEXT_203 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_204 = NL + NL + "\t\t// Create type parameters";
  protected final String TEXT_205 = "_";
  protected final String TEXT_206 = " = addETypeParameter(";
  protected final String TEXT_207 = ", \"";
  protected final String TEXT_208 = "\");";
  protected final String TEXT_209 = NL + "\t\taddETypeParameter(";
  protected final String TEXT_210 = NL + NL + "\t\t// Set bounds for type parameters";
  protected final String TEXT_211 = "g";
  protected final String TEXT_212 = " = createEGenericType(";
  protected final String TEXT_213 = NL + "\t\tg";
  protected final String TEXT_214 = ".";
  protected final String TEXT_215 = "(g";
  protected final String TEXT_216 = ".getEBounds().add(g1);";
  protected final String TEXT_217 = NL + NL + "\t\t// Add supertypes to classes";
  protected final String TEXT_218 = ".getESuperTypes().add(";
  protected final String TEXT_219 = ".get";
  protected final String TEXT_220 = "());";
  protected final String TEXT_221 = ".getEGenericSuperTypes().add(g1);";
  protected final String TEXT_222 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_223 = ", features, and operations; add parameters";
  protected final String TEXT_224 = " and features; add operations and parameters";
  protected final String TEXT_225 = NL + "\t\tinitEClass(";
  protected final String TEXT_226 = "null";
  protected final String TEXT_227 = ".class";
  protected final String TEXT_228 = "\", ";
  protected final String TEXT_229 = "\"";
  protected final String TEXT_230 = NL + "\t\tinitEReference(get";
  protected final String TEXT_231 = "(), ";
  protected final String TEXT_232 = "g1";
  protected final String TEXT_233 = NL + "\t\tget";
  protected final String TEXT_234 = "().getEKeys().add(";
  protected final String TEXT_235 = NL + "\t\tinitEAttribute(get";
  protected final String TEXT_236 = "initEOperation(get";
  protected final String TEXT_237 = "addEOperation(";
  protected final String TEXT_238 = "(), \"";
  protected final String TEXT_239 = ", null, \"";
  protected final String TEXT_240 = "addETypeParameter(op, \"";
  protected final String TEXT_241 = NL + "\t\tt";
  protected final String TEXT_242 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_243 = NL + "\t\taddEException(op, g";
  protected final String TEXT_244 = NL + "\t\taddEException(op, ";
  protected final String TEXT_245 = NL + "\t\tinitEOperation(op, g1);";
  protected final String TEXT_246 = NL + NL + "\t\t// Initialize enums and add enum literals";
  protected final String TEXT_247 = NL + "\t\tinitEEnum(";
  protected final String TEXT_248 = ".class, \"";
  protected final String TEXT_249 = NL + "\t\taddEEnumLiteral(";
  protected final String TEXT_250 = NL + NL + "\t\t// Initialize data types";
  protected final String TEXT_251 = NL + "\t\tinitEDataType(";
  protected final String TEXT_252 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(";
  protected final String TEXT_253 = NL + NL + "\t\t// Create annotations";
  protected final String TEXT_254 = NL + "\t\t// ";
  protected final String TEXT_255 = "Annotations();";
  protected final String TEXT_256 = NL + "\t}" + NL;
  protected final String TEXT_257 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_258 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_259 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_260 = "null;";
  protected final String TEXT_261 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_262 = "," + NL + "\t\t   source," + NL + "\t\t   new String[]" + NL + "\t\t   {";
  protected final String TEXT_263 = NL + "\t\t\t   ";
  protected final String TEXT_264 = NL + "\t\t   }";
  protected final String TEXT_265 = ",";
  protected final String TEXT_266 = NL + "\t\t   new ";
  protected final String TEXT_267 = "[]" + NL + "\t\t   {";
  protected final String TEXT_268 = NL + "\t\t\t ";
  protected final String TEXT_269 = ".createURI(";
  protected final String TEXT_270 = "eNS_URI).appendFragment(\"";
  protected final String TEXT_271 = "\")";
  protected final String TEXT_272 = NL + "\t\t   });";
  protected final String TEXT_273 = "," + NL + "\t\t   ";
  protected final String TEXT_274 = "new boolean[] { ";
  protected final String TEXT_275 = " }";
  protected final String TEXT_276 = "null,";
  protected final String TEXT_277 = "\",";
  protected final String TEXT_278 = NL + "\t\t   new String[]" + NL + "\t\t   {";
  protected final String TEXT_279 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_280 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_281 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_282 = " uri = ";
  protected final String TEXT_283 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_284 = " resource = new ";
  protected final String TEXT_285 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_286 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_287 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_288 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
  protected final String TEXT_289 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_290 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_291 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{";
  protected final String TEXT_292 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_293 = ".\" + eClassifier.getName());";
  protected final String TEXT_294 = NL + "\t\t\tsetGeneratedClassName(eClassifier);";
  protected final String TEXT_295 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
  protected final String TEXT_296 = NL + "\t\t\t\tcase ";
  protected final String TEXT_297 = ":";
  protected final String TEXT_298 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_299 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_300 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_301 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_302 = " addEOperation(";
  protected final String TEXT_303 = " owner, ";
  protected final String TEXT_304 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_305 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL;
  protected final String TEXT_306 = " addEParameter(";
  protected final String TEXT_307 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL;
  protected final String TEXT_308 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_309 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_310 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_311 = "public ";
  protected final String TEXT_312 = "interface Literals" + NL + "\t{";
  protected final String TEXT_313 = NL + "\t\t/**";
  protected final String TEXT_314 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_315 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_316 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_317 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_318 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  ...
  protected final String TEXT_324 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_325 = "</b></em>' ";
  protected final String TEXT_326 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_327 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
 ...
 */
    ...
    boolean packageNeedsSuppressDeprecation = isJDK50 && OCLGenModelUtil.INSTANCE.hasAPIDeprecatedTag(genPackage.getOrderedGenClassifiers()) && !OCLGenModelUtil.INSTANCE.hasAPIDeprecatedTag(genPackage) && !genModel.isSuppressEMFMetaData();
    ...
    if (OCLGenModelUtil.INSTANCE.hasAPITags(genClassifier, true)) {
    stringBuffer.append(TEXT_50);
    stringBuffer.append(OCLGenModelUtil.INSTANCE.getAPITags(genClassifier, genModel.getIndentation(stringBuffer), true));
    }
    stringBuffer.append(TEXT_51);
    if (isJDK50 && OCLGenModelUtil.INSTANCE.hasAPIDeprecatedTag(genClassifier)) {
    stringBuffer.append(TEXT_52);
    ...
    {boolean needsSuppressDeprecation = false; if (!packageNeedsSuppressDeprecation && isJDK50 && !genModel.isSuppressEMFMetaData()) { LOOP: for (GenClass genClass : genPackage.getGenClasses()) { for (GenFeature genFeature : genClass.getGenFeatures()) { if (OCLGenModelUtil.INSTANCE.hasAPIDeprecatedTag(genFeature)) { needsSuppressDeprecation = true; break LOOP; }}
