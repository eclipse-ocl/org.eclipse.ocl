...
import org.eclipse.ocl.examples.xtext.idioms.parser.antlr.IdiomsAntlrTokenFileProvider;
import org.eclipse.ocl.examples.xtext.idioms.parser.antlr.IdiomsParser;
import org.eclipse.ocl.examples.xtext.idioms.parser.antlr.internal.InternalIdiomsLexer;
import org.eclipse.ocl.examples.xtext.idioms.scoping.IdiomsScopeProvider;
...
public abstract class AbstractIdiomsRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/eclipse/ocl/examples/xtext/idioms/Idioms.properties");
		super.configure(binder);
	}

	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.eclipse.ocl.examples.xtext.idioms.Idioms");
	}
