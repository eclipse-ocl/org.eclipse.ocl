...
import org.eclipse.ocl.codegen.utilities.RereferencingCopier;
...
public abstract class LookupVisitorsCodeGenerator extends AutoVisitorsCodeGenerator
{
	...
	protected LookupVisitorsCodeGenerator(@NonNull EnvironmentFactory environmentFactory, org.eclipse.ocl.pivot.@NonNull Package asPackage,
		...
		this.asElementEnvOperation = ClassUtil.requireNonNull(asElementCompleteClass.getBestOperation(envOperationId));
