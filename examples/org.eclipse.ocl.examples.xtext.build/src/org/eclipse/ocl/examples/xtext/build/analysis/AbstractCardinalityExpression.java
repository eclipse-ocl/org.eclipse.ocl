...
public abstract class AbstractCardinalityExpression implements CardinalityExpression
{
	...
	//
	@Override
	public boolean analyzeMayBeZeroCommonFactors(@NonNull SerializationRuleAnalysis serializationRuleAnalysis, boolean mayBeMany) {
		Set<@NonNull Integer> intersection = getUnknownCommonVariables(serializationRuleAnalysis, sumOfProducts);
...
/*	public boolean analyzeConstants(@NonNull SerializationRuleAnalysis serializationRuleAnalysis) {
	...
	@Override
	public boolean analyzeRedundantProducts(@NonNull SerializationRuleAnalysis serializationRuleAnalysis) {
			...
			for (@NonNull CardinalityVariable variable : products) {
				if (serializationRuleAnalysis.basicGetMatchTerm(variable) == null) {
					if (products != manyProducts) {
						serializationRuleAnalysis.addMatchTerm(variable.getIndex(), new SerializationMatchTermInteger(0));
					}
					else if (variable == manyVariable) {
						SerializationMatchTerm solution = createSizeCardinalityMatchTerm();
						serializationRuleAnalysis.addMatchTerm(variable.getIndex(), solution);
					}
					else {
						SerializationMatchTerm solution = createSizeCardinalityMatchTerm();
						solution = new SerializationMatchTermGreaterThan(solution, new SerializationMatchTermInteger(0));
	...
	//
	@Override
	public boolean analyzeTrivial(@NonNull SerializationRuleAnalysis serializationRuleAnalysis, boolean mayBeMany) {
		Integer trivialVariable = null;
		for (@NonNull List<@NonNull CardinalityVariable> product : sumOfProducts) {
			List<@NonNull Integer> unknownVariables = getUnknownVariables(serializationRuleAnalysis, product);
		...
		SerializationMatchTerm resultsMatchTerm = createMatchTerm(serializationRuleAnalysis, trivialVariable, mayBeMany);
		serializationRuleAnalysis.addMatchTerm(trivialVariable, resultsMatchTerm);
		return true;
	}
...
/*	public void gatherRuntimeProblems(@NonNull PreSerializer preSerializer,
	 ...
	 */
	public @NonNull SerializationMatchTerm createMatchTerm(@NonNull SerializationRuleAnalysis serializationRuleAnalysis, @Nullable Integer solvedVariable, boolean mayBeMany) {
		//
	...
	protected @Nullable Set<@NonNull CardinalityVariable> getKnownCommonVariables(@NonNull SerializationRuleAnalysis serializationRuleAnalysis, @NonNull Iterable<? extends @NonNull Iterable<@NonNull CardinalityVariable>> sumOfProducts2) {
		Set<@NonNull CardinalityVariable> intersection = null;
	...
	protected @Nullable List<@NonNull CardinalityVariable> getKnownVariables(@NonNull SerializationRuleAnalysis serializationRuleAnalysis, @NonNull Iterable<@NonNull CardinalityVariable> product) {
	...
	protected @Nullable Set<@NonNull Integer> getUnknownCommonVariables(@NonNull SerializationRuleAnalysis serializationRuleAnalysis, @NonNull Iterable<? extends @NonNull Iterable<@NonNull CardinalityVariable>> sumOfProducts2) {
	 ...
	 */
	@Override
	public @Nullable List<@NonNull Integer> getUnknownVariables(@NonNull SerializationRuleAnalysis serializationRuleAnalysis) {
	...
	@Override
	public @Nullable List<@NonNull Integer> getUnknownVariables(@NonNull SerializationRuleAnalysis serializationRuleAnalysis, @NonNull Iterable<@NonNull CardinalityVariable> product) {
		List<@NonNull Integer> unknownVariables = null;
		for (@NonNull CardinalityVariable variable : product) {
			SerializationMatchTerm solution = serializationRuleAnalysis.basicGetMatchTerm(variable);
			if (solution == null) {
	 ...
	 */
	public Object resolveProduct(@NonNull SerializationRuleAnalysis serializationRuleAnalysis, @NonNull List<@NonNull CardinalityVariable> product) {
