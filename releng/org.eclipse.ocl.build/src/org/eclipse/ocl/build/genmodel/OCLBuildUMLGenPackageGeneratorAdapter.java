 ...
 *******************************************************************************/
package org.eclipse.ocl.build.genmodel;
...
public class OCLBuildUMLGenPackageGeneratorAdapter extends GenPackageGeneratorAdapter
{
	...
	protected JETEmitterDescriptor[] getJETEmitterDescriptors() {
		if (JET_EMITTER_DESCRIPTORS == null) {		// NB The overrides here are not overridden by UML.
			...
			JET_EMITTER_DESCRIPTORS[PACKAGE_CLASS_ID] = new JETEmitterDescriptor("model/PackageClass.javajet", "org.eclipse.ocl.build.templates.model.PackageClass");  // FIXME BUG 485764
			JET_EMITTER_DESCRIPTORS[SWITCH_CLASS_ID] = new JETEmitterDescriptor("model/SwitchClass.javajet", "org.eclipse.ocl.build.templates.model.SwitchClass");  // FIXME BUG 485089
			JET_EMITTER_DESCRIPTORS[ADAPTER_FACTORY_CLASS_ID] = new JETEmitterDescriptor("model/AdapterFactoryClass.javajet", "org.eclipse.ocl.build.templates.model.AdapterFactoryClass");  // FIXME BUG 485089
		}
