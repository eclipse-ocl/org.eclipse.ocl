 ...
 *******************************************************************************/
package org.eclipse.ocl.build.modelspecs;
...
import org.eclipse.ocl.codegen.cgmodel.CGLocalVariable;
...
import org.eclipse.ocl.codegen.cgmodel.CGNumber;
...
import org.eclipse.ocl.codegen.cgmodel.CGSettableVariable;
...
import org.eclipse.ocl.codegen.cse.AbstractPlace;
import org.eclipse.ocl.codegen.cse.CatchPlace;
import org.eclipse.ocl.codegen.cse.ControlPlace;
import org.eclipse.ocl.codegen.cse.GlobalPlace;
import org.eclipse.ocl.codegen.cse.IfPlaces;
import org.eclipse.ocl.codegen.cse.InnerStackPlace;
import org.eclipse.ocl.codegen.cse.LetPlaces;
import org.eclipse.ocl.codegen.cse.LocalPlace;
import org.eclipse.ocl.codegen.cse.OuterStackPlace;
import org.eclipse.ocl.codegen.cse.StackPlace;
import org.eclipse.ocl.codegen.cse.ThrowPlace;
...
import org.eclipse.ocl.codegen.utilities.EquivalenceUtil;
...
public class CGValuedElementModelSpec extends ModelSpec
{
	...
	public static interface Eq {
		...
		public static final @NonNull Eq INVLD = new Eq() {
			@Override public @Nullable String generateIsEquivalentTo(@NonNull CGValuedElementModelSpec cgModelSpec, @NonNull GenModel genModel) {
				return "return isEquivalentToInternal(thatValue);";
			}
			@Override public @Nullable String generateIsEquivalentToInternal(@NonNull CGValuedElementModelSpec cgModelSpec, @NonNull GenModel genModel) {
