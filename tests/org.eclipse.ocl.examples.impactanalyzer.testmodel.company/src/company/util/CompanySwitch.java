...
public class CompanySwitch<T> extends Switch<T> {
    ...
    @Override
		...
		switch (classifierID) {
			...
			case CompanyPackage.FREELANCE: {
				Freelance freelance = (Freelance)theEObject;
				T result = caseFreelance(freelance);
				if (result == null) result = caseEmployee(freelance);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
    ...
    /**
	 * Returns the result of interpreting the object as an instance of '<em>Freelance</em>'.
	 * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Freelance</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
    public T caseFreelance(Freelance object) {
		return null;
	}
