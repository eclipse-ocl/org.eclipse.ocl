...
import org.eclipse.ocl.ecore.tests.extlibrary.Borrower;
import org.eclipse.ocl.ecore.tests.extlibrary.EXTLibraryPackage;
import org.eclipse.ocl.ecore.tests.extlibrary.Employee;
import org.eclipse.ocl.ecore.tests.extlibrary.Item;
import org.eclipse.ocl.ecore.tests.extlibrary.Library;
import org.eclipse.ocl.ecore.tests.extlibrary.Writer;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ecore.tests.extlibrary.impl.LibraryImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link org.eclipse.ocl.ecore.tests.extlibrary.impl.LibraryImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.ocl.ecore.tests.extlibrary.impl.LibraryImpl#getWriters <em>Writers</em>}</li>
 *   <li>{@link org.eclipse.ocl.ecore.tests.extlibrary.impl.LibraryImpl#getEmployees <em>Employees</em>}</li>
 *   <li>{@link org.eclipse.ocl.ecore.tests.extlibrary.impl.LibraryImpl#getBorrowers <em>Borrowers</em>}</li>
 *   <li>{@link org.eclipse.ocl.ecore.tests.extlibrary.impl.LibraryImpl#getStock <em>Stock</em>}</li>
 *   <li>{@link org.eclipse.ocl.ecore.tests.extlibrary.impl.LibraryImpl#getBooks <em>Books</em>}</li>
 *   <li>{@link org.eclipse.ocl.ecore.tests.extlibrary.impl.LibraryImpl#getBranches <em>Branches</em>}</li>
 *   <li>{@link org.eclipse.ocl.ecore.tests.extlibrary.impl.LibraryImpl#getParentBranch <em>Parent Branch</em>}</li>
 *   <li>{@link org.eclipse.ocl.ecore.tests.extlibrary.impl.LibraryImpl#getPeople <em>People</em>}</li>
 * </ul>
 *
 * @generated
 */
