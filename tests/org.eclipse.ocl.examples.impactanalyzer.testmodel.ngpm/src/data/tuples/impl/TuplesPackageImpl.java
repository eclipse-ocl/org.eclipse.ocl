 ...
 * @generated
 */
public class TuplesPackageImpl extends EPackageImpl implements TuplesPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see data.tuples.TuplesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TuplesPackageImpl() {
		super(eNS_URI, TuplesFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link TuplesPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TuplesPackage init() {
		if (isInited) return (TuplesPackage)EPackage.Registry.INSTANCE.getEPackage(TuplesPackage.eNS_URI);

		// Obtain or create and register package
		TuplesPackageImpl theTuplesPackage = (TuplesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TuplesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TuplesPackageImpl());
		...
		theTuplesPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TuplesPackage.eNS_URI, theTuplesPackage);
		return theTuplesPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getTupleTypeDefinition_Elements() {
	 ...
	 * @generated
	 */
	public TuplesFactory getTuplesFactory() {
		return (TuplesFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(tupleTypeDefinitionEClass, TUPLE_TYPE_DEFINITION__ELEMENTS);
	...
	public void initializePackageContents() {
		...
		tupleTypeDefinitionEClass.getESuperTypes().add(theClassesPackage.getTypeDefinition());
		tupleElementEClass.getESuperTypes().add(theModelmanagementPackage.getNamedElement());
		tupleElementEClass.getESuperTypes().add(theClassesPackage.getTypedElement());
		...
		initEReference(getTupleTypeDefinition_Elements(), this.getTupleElement(), null, "elements", null, 1, -1, TupleTypeDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
