 ...
 * @generated
 */
public class DocumentsPackageImpl extends EPackageImpl implements DocumentsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see data.documents.DocumentsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DocumentsPackageImpl() {
		super(eNS_URI, DocumentsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link DocumentsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DocumentsPackage init() {
		if (isInited) return (DocumentsPackage)EPackage.Registry.INSTANCE.getEPackage(DocumentsPackage.eNS_URI);

		// Obtain or create and register package
		DocumentsPackageImpl theDocumentsPackage = (DocumentsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DocumentsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new DocumentsPackageImpl());
		...
		theDocumentsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(DocumentsPackage.eNS_URI, theDocumentsPackage);
		return theDocumentsPackage;
	}
	 ...
	 * @generated
	 */
	public DocumentsFactory getDocumentsFactory() {
		return (DocumentsFactory)getEFactoryInstance();
	}
