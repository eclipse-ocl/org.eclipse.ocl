 ...
 * @generated
 */
public class QuantitystructurePackageImpl extends EPackageImpl implements QuantitystructurePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see data.quantitystructure.QuantitystructurePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private QuantitystructurePackageImpl() {
		super(eNS_URI, QuantitystructureFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link QuantitystructurePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static QuantitystructurePackage init() {
		if (isInited) return (QuantitystructurePackage)EPackage.Registry.INSTANCE.getEPackage(QuantitystructurePackage.eNS_URI);

		// Obtain or create and register package
		QuantitystructurePackageImpl theQuantitystructurePackage = (QuantitystructurePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof QuantitystructurePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new QuantitystructurePackageImpl());
		...
		theQuantitystructurePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(QuantitystructurePackage.eNS_URI, theQuantitystructurePackage);
		return theQuantitystructurePackage;
	}
	 ...
	 * @generated
	 */
	public QuantitystructureFactory getQuantitystructureFactory() {
		return (QuantitystructureFactory)getEFactoryInstance();
	}
