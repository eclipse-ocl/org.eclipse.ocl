...
public class ProcessintegrationAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ProcessintegrationSwitch<Adapter> modelSwitch =
		new ProcessintegrationSwitch<Adapter>() {
			@Override
			public Adapter caseIntegrationScenario(IntegrationScenario object) {
				return createIntegrationScenarioAdapter();
			}
			@Override
			public Adapter caseProcessComponentInteraction(ProcessComponentInteraction object) {
				return createProcessComponentInteractionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link integration.processintegration.IntegrationScenario <em>Integration Scenario</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link integration.processintegration.ProcessComponentInteraction <em>Process Component Interaction</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
...
} //ProcessintegrationAdapterFactory
