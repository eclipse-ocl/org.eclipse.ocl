 ...
 * @generated
 */
public class ProcessintegrationPackageImpl extends EPackageImpl implements ProcessintegrationPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass integrationScenarioEClass = null;
	 ...
	 * @generated
	 */
	private EClass processComponentInteractionEClass = null;
	 ...
	 * @see integration.processintegration.ProcessintegrationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ProcessintegrationPackageImpl() {
		super(eNS_URI, ProcessintegrationFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link ProcessintegrationPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static ProcessintegrationPackage init() {
		if (isInited) return (ProcessintegrationPackage)EPackage.Registry.INSTANCE.getEPackage(ProcessintegrationPackage.eNS_URI);

		// Obtain or create and register package
		ProcessintegrationPackageImpl theProcessintegrationPackage = (ProcessintegrationPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ProcessintegrationPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ProcessintegrationPackageImpl());
		...
		theProcessintegrationPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(ProcessintegrationPackage.eNS_URI, theProcessintegrationPackage);
		return theProcessintegrationPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getIntegrationScenario() {
		return integrationScenarioEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getIntegrationScenario_Interactions() {
		return (EReference)integrationScenarioEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getProcessComponentInteraction() {
		return processComponentInteractionEClass;
	}
	 ...
	 * @generated
	 */
	public ProcessintegrationFactory getProcessintegrationFactory() {
		return (ProcessintegrationFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		integrationScenarioEClass = createEClass(INTEGRATION_SCENARIO);
	...
	public void initializePackageContents() {
		...
		integrationScenarioEClass.getESuperTypes().add(theModelmanagementPackage.getNamedElement());

		// Initialize classes and features; add operations and parameters
		initEClass(integrationScenarioEClass, IntegrationScenario.class, "IntegrationScenario", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
