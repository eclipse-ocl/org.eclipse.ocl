...
import configuration.businessconfiguration.experimental.ExperimentalFactory;
...
public class ExperimentalPackageImpl extends EPackageImpl implements ExperimentalPackage {
	 ...
	 * @generated
	 */
	private EClass packageUseEClass = null;
	 ...
	 * @generated
	 */
	private EClass configurationEntityEClass = null;
	 ...
	 * @see configuration.businessconfiguration.experimental.ExperimentalPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getPackageUse() {
		return packageUseEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getPackageUse_Package_() {
		return (EReference)packageUseEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getPackageUse_Setting() {
		return (EReference)packageUseEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EClass getConfigurationEntity() {
		return configurationEntityEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getConfigurationEntity_PickList() {
		return (EReference)configurationEntityEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getConfigurationEntity_ConfigurableItem() {
		return (EReference)configurationEntityEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getConfigurationSetting_Entity() {
		return (EReference)configurationSettingEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getConfigurationSetting_Value() {
		return (EReference)configurationSettingEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		packageUseEClass = createEClass(PACKAGE_USE);
		createEReference(packageUseEClass, PACKAGE_USE__PACKAGE_);
		createEReference(packageUseEClass, PACKAGE_USE__SETTING);

		configurationEntityEClass = createEClass(CONFIGURATION_ENTITY);
		createEReference(configurationEntityEClass, CONFIGURATION_ENTITY__PICK_LIST);
		createEReference(configurationEntityEClass, CONFIGURATION_ENTITY__CONFIGURABLE_ITEM);

		configurationSettingEClass = createEClass(CONFIGURATION_SETTING);
		createEReference(configurationSettingEClass, CONFIGURATION_SETTING__ENTITY);
		createEReference(configurationSettingEClass, CONFIGURATION_SETTING__VALUE);
	}
	...
	public void initializePackageContents() {
		...
		BusinessconfigurationPackage theBusinessconfigurationPackage = (BusinessconfigurationPackage)EPackage.Registry.INSTANCE.getEPackage(BusinessconfigurationPackage.eNS_URI);
		...
		configurationEntityEClass.getESuperTypes().add(theModelmanagementPackage.getNamedElement());

		// Initialize classes and features; add operations and parameters
		initEClass(packageUseEClass, PackageUse.class, "PackageUse", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackageUse_Package_(), theModelmanagementPackage.getPackage(), null, "package_", null, 1, 1, PackageUse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPackageUse_Setting(), this.getConfigurationSetting(), null, "setting", null, 0, -1, PackageUse.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(configurationEntityEClass, ConfigurationEntity.class, "ConfigurationEntity", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getConfigurationEntity_PickList(), theBusinessconfigurationPackage.getValueSet(), null, "pickList", null, 0, 1, ConfigurationEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConfigurationEntity_ConfigurableItem(), theClassesPackage.getAssociationEnd(), null, "configurableItem", null, 1, 1, ConfigurationEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getConfigurationSetting_Entity(), this.getConfigurationEntity(), null, "entity", null, 1, 1, ConfigurationSetting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getConfigurationSetting_Value(), theExpressionsPackage.getExpression(), null, "value", null, 1, 1, ConfigurationSetting.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
