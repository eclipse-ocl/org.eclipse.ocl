 ...
 * @generated
 */
public class Context_driversPackageImpl extends EPackageImpl implements Context_driversPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass contextCategoryEClass = null;
	 ...
	 * @generated
	 */
	private EClass contextCategoryValueEClass = null;
	 ...
	 * @generated
	 */
	private EClass contexConfigurationEClass = null;
	 ...
	 * @see configuration.context_drivers.Context_driversPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Context_driversPackageImpl() {
		super(eNS_URI, Context_driversFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Context_driversPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Context_driversPackage init() {
		if (isInited) return (Context_driversPackage)EPackage.Registry.INSTANCE.getEPackage(Context_driversPackage.eNS_URI);

		// Obtain or create and register package
		Context_driversPackageImpl theContext_driversPackage = (Context_driversPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Context_driversPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Context_driversPackageImpl());
		...
		theContext_driversPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Context_driversPackage.eNS_URI, theContext_driversPackage);
		return theContext_driversPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getContextCategory() {
		return contextCategoryEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getContextCategory_Name() {
		return (EAttribute)contextCategoryEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getContextCategory_RootValue() {
		return (EReference)contextCategoryEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getContextCategory_CategoryConfiguration() {
		return (EReference)contextCategoryEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getContextCategoryValue() {
		return contextCategoryValueEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getContextCategoryValue_Value() {
		return (EAttribute)contextCategoryValueEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getContextCategoryValue_Context() {
		return (EReference)contextCategoryValueEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getContextCategoryValue_IncludedValuesConfiguration() {
		return (EReference)contextCategoryValueEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getContextCategoryValue_Children() {
		return (EReference)contextCategoryValueEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getContextCategoryValue_Parent() {
		return (EReference)contextCategoryValueEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getContextCategoryValue_ExcludedValuesConfiguration() {
		return (EReference)contextCategoryValueEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EReference getContextualElement_ContextualElementConfiguration() {
	 ...
	 * @generated
	 */
	public EClass getContexConfiguration() {
		return contexConfigurationEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getContexConfiguration_Category() {
		return (EReference)contexConfigurationEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getContexConfiguration_IncludedValues() {
		return (EReference)contexConfigurationEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getContexConfiguration_ConfiguredElement() {
		return (EReference)contexConfigurationEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getContexConfiguration_ExcludedValues() {
		return (EReference)contexConfigurationEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public Context_driversFactory getContext_driversFactory() {
		return (Context_driversFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		contextCategoryEClass = createEClass(CONTEXT_CATEGORY);
		createEAttribute(contextCategoryEClass, CONTEXT_CATEGORY__NAME);
		createEReference(contextCategoryEClass, CONTEXT_CATEGORY__ROOT_VALUE);
		createEReference(contextCategoryEClass, CONTEXT_CATEGORY__CATEGORY_CONFIGURATION);

		contextCategoryValueEClass = createEClass(CONTEXT_CATEGORY_VALUE);
		createEAttribute(contextCategoryValueEClass, CONTEXT_CATEGORY_VALUE__VALUE);
		createEReference(contextCategoryValueEClass, CONTEXT_CATEGORY_VALUE__CONTEXT);
		createEReference(contextCategoryValueEClass, CONTEXT_CATEGORY_VALUE__INCLUDED_VALUES_CONFIGURATION);
		createEReference(contextCategoryValueEClass, CONTEXT_CATEGORY_VALUE__CHILDREN);
		createEReference(contextCategoryValueEClass, CONTEXT_CATEGORY_VALUE__PARENT);
		createEReference(contextCategoryValueEClass, CONTEXT_CATEGORY_VALUE__EXCLUDED_VALUES_CONFIGURATION);

		contextualElementEClass = createEClass(CONTEXTUAL_ELEMENT);
		createEReference(contextualElementEClass, CONTEXTUAL_ELEMENT__CONTEXTUAL_ELEMENT_CONFIGURATION);

		contexConfigurationEClass = createEClass(CONTEX_CONFIGURATION);
		createEReference(contexConfigurationEClass, CONTEX_CONFIGURATION__CATEGORY);
		createEReference(contexConfigurationEClass, CONTEX_CONFIGURATION__INCLUDED_VALUES);
		createEReference(contexConfigurationEClass, CONTEX_CONFIGURATION__CONFIGURED_ELEMENT);
		createEReference(contexConfigurationEClass, CONTEX_CONFIGURATION__EXCLUDED_VALUES);
	}
	...
	public void initializePackageContents() {
		...
		contextCategoryValueEClass.getESuperTypes().add(this.getContextCategory());
		...
		initEAttribute(getContextCategory_Name(), theEcorePackage.getEString(), "name", null, 1, 1, ContextCategory.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getContextCategoryValue_Value(), theEcorePackage.getEString(), "value", null, 1, 1, ContextCategoryValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getContextCategoryValue_Parent(), this.getContextCategoryValue(), this.getContextCategoryValue_Children(), "parent", null, 0, 1, ContextCategoryValue.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContextCategoryValue_ExcludedValuesConfiguration(), this.getContexConfiguration(), this.getContexConfiguration_ExcludedValues(), "excludedValuesConfiguration", null, 0, -1, ContextCategoryValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getContextualElement_ContextualElementConfiguration(), this.getContexConfiguration(), this.getContexConfiguration_ConfiguredElement(), "ContextualElementConfiguration", null, 0, -1, ContextualElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(contexConfigurationEClass, ContexConfiguration.class, "ContexConfiguration", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContexConfiguration_Category(), this.getContextCategory(), this.getContextCategory_CategoryConfiguration(), "category", null, 1, 1, ContexConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContexConfiguration_IncludedValues(), this.getContextCategoryValue(), this.getContextCategoryValue_IncludedValuesConfiguration(), "includedValues", null, 0, -1, ContexConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContexConfiguration_ConfiguredElement(), this.getContextualElement(), this.getContextualElement_ContextualElementConfiguration(), "configuredElement", null, 1, 1, ContexConfiguration.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getContexConfiguration_ExcludedValues(), this.getContextCategoryValue(), this.getContextCategoryValue_ExcludedValuesConfiguration(), "excludedValues", null, 0, -1, ContexConfiguration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
