...
import dataaccess.expressions.fp.util.FpValidator;
...
public class FpPackageImpl extends EPackageImpl implements FpPackage {
	 ...
	 * @generated
	 */
	private EClass anonymousFunctionExprEClass = null;
	 ...
	 * @generated
	 */
	private EClass functionFromMethodExprEClass = null;
	 ...
	 * @see dataaccess.expressions.fp.FpPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static FpPackage init() {
		...
		FpPackageImpl theFpPackage = (FpPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof FpPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new FpPackageImpl());
	 ...
	 * @generated
	 */
	public EClass getAnonymousFunctionExpr() {
		return anonymousFunctionExprEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getFunctionFromMethodExpr() {
		return functionFromMethodExprEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getFunctionFromMethodExpr_Method() {
		return (EReference)functionFromMethodExprEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		anonymousFunctionExprEClass = createEClass(ANONYMOUS_FUNCTION_EXPR);

		functionFromMethodExprEClass = createEClass(FUNCTION_FROM_METHOD_EXPR);
		createEReference(functionFromMethodExprEClass, FUNCTION_FROM_METHOD_EXPR__METHOD);
	}
	...
	public void initializePackageContents() {
		...
		anonymousFunctionExprEClass.getESuperTypes().add(theExpressionsPackage.getExpression());
		functionFromMethodExprEClass.getESuperTypes().add(theExpressionsPackage.getObjectBasedExpression());
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (anonymousFunctionExprEClass, 
		   source, 
		   new String[] {
			 "constraints", "TypeMustBeSignatureTypeDefinitionWithImplementation HasToOwnSignatureTypeDefinition SignatureMustBeFunctionSignature"
		   });			
		addAnnotation
