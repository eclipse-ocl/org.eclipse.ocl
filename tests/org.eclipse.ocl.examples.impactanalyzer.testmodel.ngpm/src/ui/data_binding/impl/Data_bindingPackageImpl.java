 ...
 * @generated
 */
public class Data_bindingPackageImpl extends EPackageImpl implements Data_bindingPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ui.data_binding.Data_bindingPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Data_bindingPackageImpl() {
		super(eNS_URI, Data_bindingFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Data_bindingPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Data_bindingPackage init() {
		if (isInited) return (Data_bindingPackage)EPackage.Registry.INSTANCE.getEPackage(Data_bindingPackage.eNS_URI);

		// Obtain or create and register package
		Data_bindingPackageImpl theData_bindingPackage = (Data_bindingPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Data_bindingPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Data_bindingPackageImpl());
		...
		theData_bindingPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Data_bindingPackage.eNS_URI, theData_bindingPackage);
		return theData_bindingPackage;
	}
	 ...
	 * @generated
	 */
	public Data_bindingFactory getData_bindingFactory() {
		return (Data_bindingFactory)getEFactoryInstance();
	}
