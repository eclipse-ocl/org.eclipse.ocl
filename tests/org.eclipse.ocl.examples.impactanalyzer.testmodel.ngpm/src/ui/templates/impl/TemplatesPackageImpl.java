...
import ui.templates.util.TemplatesValidator;
...
public class TemplatesPackageImpl extends EPackageImpl implements TemplatesPackage {
	 ...
	 * @generated
	 */
	private EClass stringTemplateEClass = null;
	 ...
	 * @see ui.templates.TemplatesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EClass getStringTemplate() {
		return stringTemplateEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getStringTemplate_Expressions() {
		return (EReference)stringTemplateEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		stringTemplateEClass = createEClass(STRING_TEMPLATE);
		createEReference(stringTemplateEClass, STRING_TEMPLATE__EXPRESSIONS);
	}
	...
	public void initializePackageContents() {
		...
		stringTemplateEClass.getESuperTypes().add(theClassesPackage.getFunctionSignatureImplementation());

		// Initialize classes and features; add operations and parameters
		initEClass(stringTemplateEClass, StringTemplate.class, "StringTemplate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getStringTemplate_Expressions(), theExpressionsPackage.getExpression(), theExpressionsPackage.getExpression_Template(), "expressions", null, 0, -1, StringTemplate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (stringTemplateEClass, 
		   source, 
		   new String[] {
			 "constraints", "expressionMustBeSideEffectFree"
		   });
	}
    ...
    protected void createOCLAnnotations() {
		...
		addAnnotation
		  (stringTemplateEClass, 
		   source, 
		   new String[] {
			 "expressionMustBeSideEffectFree", "self.expressions->forAll( e | e.isSideEffectFree() )"
		   });	
	}
