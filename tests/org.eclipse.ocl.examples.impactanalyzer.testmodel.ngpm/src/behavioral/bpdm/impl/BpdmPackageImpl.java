 ...
 * @generated
 */
public class BpdmPackageImpl extends EPackageImpl implements BpdmPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see behavioral.bpdm.BpdmPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BpdmPackageImpl() {
		super(eNS_URI, BpdmFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link BpdmPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BpdmPackage init() {
		if (isInited) return (BpdmPackage)EPackage.Registry.INSTANCE.getEPackage(BpdmPackage.eNS_URI);

		// Obtain or create and register package
		BpdmPackageImpl theBpdmPackage = (BpdmPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BpdmPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BpdmPackageImpl());
		...
		theBpdmPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(BpdmPackage.eNS_URI, theBpdmPackage);
		return theBpdmPackage;
	}
	 ...
	 * @generated
	 */
	public BpdmFactory getBpdmFactory() {
		return (BpdmFactory)getEFactoryInstance();
	}
