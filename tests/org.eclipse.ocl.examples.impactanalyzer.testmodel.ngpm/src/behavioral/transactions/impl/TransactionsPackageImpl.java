...
public class TransactionsPackageImpl extends EPackageImpl implements TransactionsPackage {
	 ...
	 * @see behavioral.transactions.TransactionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static TransactionsPackage init() {
		if (isInited) return (TransactionsPackage)EPackage.Registry.INSTANCE.getEPackage(TransactionsPackage.eNS_URI);

		// Obtain or create and register package
		TransactionsPackageImpl theTransactionsPackage = (TransactionsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TransactionsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TransactionsPackageImpl());
