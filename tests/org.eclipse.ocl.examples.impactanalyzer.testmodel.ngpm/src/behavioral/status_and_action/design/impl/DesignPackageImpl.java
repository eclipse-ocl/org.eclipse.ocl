...
public class DesignPackageImpl extends EPackageImpl implements DesignPackage {
	 ...
	 * @generated
	 */
	private EClass statusVariableEClass = null;
	 ...
	 * @generated
	 */
	private EClass statusValueEClass = null;
	 ...
	 * @generated
	 */
	private EClass abstractStatusVariableEClass = null;
	 ...
	 * @generated
	 */
	private EClass abstractStatusValueEClass = null;
	 ...
	 * @see behavioral.status_and_action.design.DesignPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getBusinessObject_Nodes() {
	 ...
	 * @generated
	 */
	public EReference getBusinessObjectNode_Variables() {
		return (EReference)businessObjectNodeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getBusinessObjectNode_Actions() {
	 ...
	 * @generated
	 */
	public EClass getStatusVariable() {
		return statusVariableEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getStatusValue() {
		return statusValueEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getAbstractStatusVariable() {
		return abstractStatusVariableEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getAbstractStatusVariable_IsAgent() {
		return (EAttribute)abstractStatusVariableEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAbstractStatusVariable_IsStateGuarded() {
		return (EAttribute)abstractStatusVariableEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getAbstractStatusVariable_Values() {
		return (EReference)abstractStatusVariableEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EClass getAbstractStatusValue() {
		return abstractStatusValueEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getAbstractStatusValue_IsInitial() {
		return (EAttribute)abstractStatusValueEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAbstractStatusValue_IsInhibiting() {
		return (EAttribute)abstractStatusValueEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAbstractStatusValue_IsStateGuarded() {
		return (EAttribute)abstractStatusValueEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getAbstractAction_IsAgent() {
	 ...
	 * @generated
	 */
	public EAttribute getAbstractAction_IsPreconditionFixed() {
	...
	public void createPackageContents() {
		...
		createEReference(businessObjectEClass, BUSINESS_OBJECT__NODES);

		businessObjectNodeEClass = createEClass(BUSINESS_OBJECT_NODE);
		createEReference(businessObjectNodeEClass, BUSINESS_OBJECT_NODE__VARIABLES);
		createEReference(businessObjectNodeEClass, BUSINESS_OBJECT_NODE__ACTIONS);

		statusVariableEClass = createEClass(STATUS_VARIABLE);

		statusValueEClass = createEClass(STATUS_VALUE);

		actionEClass = createEClass(ACTION);

		abstractStatusVariableEClass = createEClass(ABSTRACT_STATUS_VARIABLE);
		createEAttribute(abstractStatusVariableEClass, ABSTRACT_STATUS_VARIABLE__IS_AGENT);
		createEAttribute(abstractStatusVariableEClass, ABSTRACT_STATUS_VARIABLE__IS_STATE_GUARDED);
		createEReference(abstractStatusVariableEClass, ABSTRACT_STATUS_VARIABLE__VALUES);

		abstractStatusValueEClass = createEClass(ABSTRACT_STATUS_VALUE);
		createEAttribute(abstractStatusValueEClass, ABSTRACT_STATUS_VALUE__IS_INITIAL);
		createEAttribute(abstractStatusValueEClass, ABSTRACT_STATUS_VALUE__IS_INHIBITING);
		createEAttribute(abstractStatusValueEClass, ABSTRACT_STATUS_VALUE__IS_STATE_GUARDED);

		abstractActionEClass = createEClass(ABSTRACT_ACTION);
		createEAttribute(abstractActionEClass, ABSTRACT_ACTION__IS_AGENT);
		createEAttribute(abstractActionEClass, ABSTRACT_ACTION__IS_PRECONDITION_FIXED);
	}
	...
	public void initializePackageContents() {
		...
		businessObjectNodeEClass.getESuperTypes().add(theModelmanagementPackage.getNamedElement());
		statusVariableEClass.getESuperTypes().add(this.getAbstractStatusVariable());
		statusValueEClass.getESuperTypes().add(this.getAbstractStatusValue());
		actionEClass.getESuperTypes().add(this.getAbstractAction());
		abstractStatusVariableEClass.getESuperTypes().add(theModelmanagementPackage.getNamedElement());
		abstractStatusValueEClass.getESuperTypes().add(theModelmanagementPackage.getNamedElement());
		abstractActionEClass.getESuperTypes().add(theModelmanagementPackage.getNamedElement());
		...
		initEReference(getBusinessObject_Nodes(), this.getBusinessObjectNode(), null, "nodes", null, 0, -1, BusinessObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBusinessObjectNode_Variables(), this.getStatusVariable(), null, "variables", null, 0, -1, BusinessObjectNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getBusinessObjectNode_Actions(), this.getAction(), null, "actions", null, 0, -1, BusinessObjectNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(statusVariableEClass, StatusVariable.class, "StatusVariable", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(statusValueEClass, StatusValue.class, "StatusValue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createEmofAnnotations() {
		...
		addAnnotation
		  (getBusinessObject_Nodes(), 
		   source, 
		   new String[] {
			 "Property.oppositeRoleName", "businessObject"
		   });		
		addAnnotation
		  (getBusinessObjectNode_Variables(), 
		   source, 
		   new String[] {
			 "Property.oppositeRoleName", "node"
		   });		
		addAnnotation
		  (getBusinessObjectNode_Actions(), 
		   source, 
		   new String[] {
			 "Property.oppositeRoleName", "node"
		   });		
		addAnnotation
		  (getAbstractStatusVariable_Values(), 
		   source, 
		   new String[] {
			 "Property.oppositeRoleName", "variable"
		   });
	}
