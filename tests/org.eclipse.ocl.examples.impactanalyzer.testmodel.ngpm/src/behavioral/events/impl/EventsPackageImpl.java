...
import behavioral.events.util.EventsValidator;
...
public class EventsPackageImpl extends EPackageImpl implements EventsPackage {
	 ...
	 * @see behavioral.events.EventsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
			...
			(theEventsPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return EventsValidator.INSTANCE;
				 }
			 });
	 ...
	 * @generated
	 */
	public EReference getSubscription_Producer() {
	 ...
	 * @generated
	 */
	public EReference getSubscription_Filters() {
	 ...
	 * @generated
	 */
	public EReference getSubscription_SubscribingClass() {
		return (EReference)subscriptionEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getEventProducer_Subscriptions() {
	 ...
	 * @generated
	 */
	public EReference getEventProducer_NotificationSignatures() {
	 ...
	 * @generated
	 */
	public EReference getEventFilter_Subscription() {
	 ...
	 * @generated
	 */
	public EReference getEventFilter_Test() {
		return (EReference)eventFilterEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(subscriptionEClass, SUBSCRIPTION__PRODUCER);
		createEReference(subscriptionEClass, SUBSCRIPTION__FILTERS);
		createEReference(subscriptionEClass, SUBSCRIPTION__SUBSCRIBING_CLASS);

		eventProducerEClass = createEClass(EVENT_PRODUCER);
		createEReference(eventProducerEClass, EVENT_PRODUCER__SUBSCRIPTIONS);
		createEReference(eventProducerEClass, EVENT_PRODUCER__NOTIFICATION_SIGNATURES);

		eventFilterEClass = createEClass(EVENT_FILTER);
		createEReference(eventFilterEClass, EVENT_FILTER__SUBSCRIPTION);
		createEReference(eventFilterEClass, EVENT_FILTER__TEST);
	}
	...
	public void initializePackageContents() {
		...
		subscriptionEClass.getESuperTypes().add(theModelmanagementPackage.getNamedElement());
		...
		initEReference(getSubscription_Producer(), this.getEventProducer(), this.getEventProducer_Subscriptions(), "producer", null, 1, 1, Subscription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSubscription_Filters(), this.getEventFilter(), this.getEventFilter_Subscription(), "filters", null, 0, -1, Subscription.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSubscription_SubscribingClass(), theClassesPackage.getSapClass(), theClassesPackage.getSapClass_Subscription(), "subscribingClass", null, 1, 1, Subscription.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(eventProducerEClass, EventProducer.class, "EventProducer", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEventProducer_Subscriptions(), this.getSubscription(), this.getSubscription_Producer(), "subscriptions", null, 0, -1, EventProducer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEventProducer_NotificationSignatures(), theClassesPackage.getMethodSignature(), theClassesPackage.getMethodSignature_Producer(), "notificationSignatures", null, 0, -1, EventProducer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(eventFilterEClass, EventFilter.class, "EventFilter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEventFilter_Subscription(), this.getSubscription(), this.getSubscription_Filters(), "subscription", null, 1, 1, EventFilter.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEventFilter_Test(), theActionsPackage.getBlock(), null, "test", null, 1, 1, EventFilter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation
		  (subscriptionEClass, 
		   source, 
		   new String[] {
			 "constraints", "SubscribingClassMatchProducer"
		   });				
		addAnnotation
		  (eventFilterEClass, 
		   source, 
		   new String[] {
			 "constraints", "FilterBlockSignatureMatchNotificationSignature"
		   });	
	}
	...
	protected void createEmofAnnotations() {
		...
		addAnnotation
		  (getEventFilter_Test(), 
		   source, 
		   new String[] {
			 "Property.oppositeRoleName", "filter"
		   });
	}
