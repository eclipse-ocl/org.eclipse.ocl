 ...
 * @generated
 */
public class BusinesstasksPackageImpl extends EPackageImpl implements BusinesstasksPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass taskAgentEClass = null;
	 ...
	 * @see behavioral.businesstasks.BusinesstasksPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private BusinesstasksPackageImpl() {
		super(eNS_URI, BusinesstasksFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link BusinesstasksPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static BusinesstasksPackage init() {
		if (isInited) return (BusinesstasksPackage)EPackage.Registry.INSTANCE.getEPackage(BusinesstasksPackage.eNS_URI);

		// Obtain or create and register package
		BusinesstasksPackageImpl theBusinesstasksPackage = (BusinesstasksPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof BusinesstasksPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new BusinesstasksPackageImpl());
		...
		theBusinesstasksPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(BusinesstasksPackage.eNS_URI, theBusinesstasksPackage);
		return theBusinesstasksPackage;
	}
	 ...
	 * @generated
	 */
	public EClass getTaskAgent() {
		return taskAgentEClass;
	}
	 ...
	 * @generated
	 */
	public BusinesstasksFactory getBusinesstasksFactory() {
		return (BusinesstasksFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		taskAgentEClass = createEClass(TASK_AGENT);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(taskAgentEClass, TaskAgent.class, "TaskAgent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
