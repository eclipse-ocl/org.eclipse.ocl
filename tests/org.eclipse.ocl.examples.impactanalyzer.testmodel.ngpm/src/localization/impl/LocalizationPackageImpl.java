 ...
 * @generated
 */
public class LocalizationPackageImpl extends EPackageImpl implements LocalizationPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see localization.LocalizationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private LocalizationPackageImpl() {
		super(eNS_URI, LocalizationFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link LocalizationPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static LocalizationPackage init() {
		if (isInited) return (LocalizationPackage)EPackage.Registry.INSTANCE.getEPackage(LocalizationPackage.eNS_URI);

		// Obtain or create and register package
		LocalizationPackageImpl theLocalizationPackage = (LocalizationPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof LocalizationPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new LocalizationPackageImpl());
		...
		theLocalizationPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(LocalizationPackage.eNS_URI, theLocalizationPackage);
		return theLocalizationPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getTranslatableText_Text() {
	 ...
	 * @generated
	 */
	public EAttribute getTranslatableText_HintForTranslator() {
	...
	public LocalizationFactory getLocalizationFactory() {
		return (LocalizationFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(translatableTextEClass, TRANSLATABLE_TEXT__TEXT);
		createEAttribute(translatableTextEClass, TRANSLATABLE_TEXT__HINT_FOR_TRANSLATOR);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTranslatableText_Text(), theEcorePackage.getEString(), "text", null, 1, 1, TranslatableText.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getTranslatableText_HintForTranslator(), theEcorePackage.getEString(), "hintForTranslator", null, 1, 1, TranslatableText.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
