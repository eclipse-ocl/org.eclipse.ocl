...
public class LocalizationAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected LocalizationSwitch<Adapter> modelSwitch =
		new LocalizationSwitch<Adapter>() {
			@Override
			public Adapter caseTranslatableText(TranslatableText object) {
				return createTranslatableTextAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link localization.TranslatableText <em>Translatable Text</em>}'.
	 * <!-- begin-user-doc -->
