 ...
 * @generated
 */
public class Ap_runtime_constraintsPackageImpl extends EPackageImpl implements Ap_runtime_constraintsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ap_runtime_constraints.Ap_runtime_constraintsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Ap_runtime_constraintsPackageImpl() {
		super(eNS_URI, Ap_runtime_constraintsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Ap_runtime_constraintsPackage#eINSTANCE} when that field is accessed.
	...
	public static Ap_runtime_constraintsPackage init() {
		if (isInited) return (Ap_runtime_constraintsPackage)EPackage.Registry.INSTANCE.getEPackage(Ap_runtime_constraintsPackage.eNS_URI);

		// Obtain or create and register package
		Ap_runtime_constraintsPackageImpl theAp_runtime_constraintsPackage = (Ap_runtime_constraintsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Ap_runtime_constraintsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Ap_runtime_constraintsPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(Ap_runtime_constraintsPackage.eNS_URI, theAp_runtime_constraintsPackage);
	 ...
	 * @generated
	 */
	public Ap_runtime_constraintsFactory getAp_runtime_constraintsFactory() {
		return (Ap_runtime_constraintsFactory)getEFactoryInstance();
	}
