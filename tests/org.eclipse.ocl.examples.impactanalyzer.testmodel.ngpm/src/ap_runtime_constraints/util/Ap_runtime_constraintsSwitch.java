 ...
 * @generated
 */
public class Ap_runtime_constraintsSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	public Ap_runtime_constraintsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Ap_runtime_constraintsPackage.QUERY_CONSTRAINT: {
