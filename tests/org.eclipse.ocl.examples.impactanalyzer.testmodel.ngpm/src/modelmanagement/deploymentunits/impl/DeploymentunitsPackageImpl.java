 ...
 * @generated
 */
public class DeploymentunitsPackageImpl extends EPackageImpl implements DeploymentunitsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see modelmanagement.deploymentunits.DeploymentunitsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DeploymentunitsPackageImpl() {
		super(eNS_URI, DeploymentunitsFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link DeploymentunitsPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DeploymentunitsPackage init() {
		if (isInited) return (DeploymentunitsPackage)EPackage.Registry.INSTANCE.getEPackage(DeploymentunitsPackage.eNS_URI);

		// Obtain or create and register package
		DeploymentunitsPackageImpl theDeploymentunitsPackage = (DeploymentunitsPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DeploymentunitsPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new DeploymentunitsPackageImpl());
		...
		theDeploymentunitsPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(DeploymentunitsPackage.eNS_URI, theDeploymentunitsPackage);
		return theDeploymentunitsPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getDeploymentUnit_PcsInsideCompany() {
	 ...
	 * @generated
	 */
	public DeploymentunitsFactory getDeploymentunitsFactory() {
		return (DeploymentunitsFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(deploymentUnitEClass, DEPLOYMENT_UNIT__PCS_INSIDE_COMPANY);
	}
	...
	public void initializePackageContents() {
		...
		deploymentUnitEClass.getESuperTypes().add(theModelmanagementPackage.getPackageOwner());
		deploymentUnitEClass.getESuperTypes().add(theModelmanagementPackage.getNamedElement());
		...
		initEReference(getDeploymentUnit_PcsInsideCompany(), theProcesscomponentsPackage.getProcessComponent(), null, "pcsInsideCompany", null, 0, -1, DeploymentUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
