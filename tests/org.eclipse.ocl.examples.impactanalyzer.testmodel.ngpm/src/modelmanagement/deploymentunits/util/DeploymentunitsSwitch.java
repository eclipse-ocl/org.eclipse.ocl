...
public class DeploymentunitsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DeploymentunitsPackage.DEPLOYMENT_UNIT: {
				DeploymentUnit deploymentUnit = (DeploymentUnit)theEObject;
				T result = caseDeploymentUnit(deploymentUnit);
				if (result == null) result = casePackageOwner(deploymentUnit);
				if (result == null) result = caseNamedElement(deploymentUnit);
