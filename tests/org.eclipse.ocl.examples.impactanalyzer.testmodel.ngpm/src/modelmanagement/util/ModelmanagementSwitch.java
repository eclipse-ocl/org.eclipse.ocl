...
public class ModelmanagementSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ModelmanagementPackage.PACKAGE: {
				modelmanagement.Package package_ = (modelmanagement.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = casePackageOwner(package_);
			...
			case ModelmanagementPackage.PACKAGE_OWNER: {
				PackageOwner packageOwner = (PackageOwner)theEObject;
				T result = casePackageOwner(packageOwner);
				if (result == null) result = caseNamedElement(packageOwner);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T casePackage(modelmanagement.Package object) {
		return null;
	}
