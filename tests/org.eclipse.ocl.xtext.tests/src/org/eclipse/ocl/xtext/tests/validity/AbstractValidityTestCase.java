 ...
 *******************************************************************************/
package org.eclipse.ocl.xtext.tests.validity;
...
import org.eclipse.ocl.emf.validation.validity.export.ValidityExporterRegistry;
...
import org.eclipse.ocl.emf.validation.validity.ui.view.IDEValidityManager;
import org.eclipse.ocl.emf.validation.validity.ui.view.ValidityViewRefreshJob;
...
public abstract class AbstractValidityTestCase extends AbstractPivotTestCase
{
	...
	protected static final @NonNull String OCL_CONSTRAINTS_MODEL = "models/validity/ecore.ocl";
	protected static final @NonNull String OCL_CONSTRAINTS_MODEL2 = "models/validity/ecoreTest.ocl";
	protected static final @NonNull String ECORE_MODEL_NAME = "models/validity/ecoreTest.ecore";
