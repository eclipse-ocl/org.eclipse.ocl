...
public class UMLValidateTest extends AbstractValidateTests
{
	...
	protected @NonNull ValidationRegistryAdapter getValidationRegistryAdapter(@NonNull ResourceSet resourceSet) {
	...
	//	validationContext.put(EValidator.SubstitutionLabelProvider.class, LabelUtil.SUBSTITUTION_LABEL_PROVIDER);
		List<Diagnostic> diagnostics = validationContext.createDiagnostics();
	...
	//	PivotUtil.getEnvironmentFactory(null).setOption(PivotValidationOptions.PotentialInvalidResult, StatusCodes.Severity.IGNORE);
		assertValidationDiagnostics("Loading", umlResource, validationContext, getMessages(
	...
	public void test_umlValidation_Bug436945() throws IOException {   // This is org.eclipse.ocl.doc/doc/models/1710-m1.uml
		...
		assertNoResourceErrors("Loading", umlResource);
		ValidationContext validationContext = createValidationContext(ocl.getResourceSet());
		OCLDelegateDomain.initializePivotOnlyDiagnosticianContext(validationContext);
		//		org.eclipse.uml2.uml.Model umlModel = (org.eclipse.uml2.uml.Model)umlResource.getContents().get(0);
	...
	public void test_umlValidation_Bug514353() throws IOException {
		...
		assertUMLOCLValidationDiagnostics(ocl, "UML Load", umlResource/*,
			"\"Parsing error for RootElement::Class1::Attribute1::class2.Attribute1 + 1.0:\n" +
				" Failed to load 'file:/E:/GIT/org.eclipse.ocl/tests/org.eclipse.ocl.xtext.tests/bin/org/eclipse/ocl/examples/pivot/tests/models/Bug514353.uml.oclas' : Unsupported Class::nestedClassifiers for \"Class1\" in UML2ASDeclarationSwitch\""*/);
		disposeResourceSet(resourceSet);
		ocl.dispose();
	}
