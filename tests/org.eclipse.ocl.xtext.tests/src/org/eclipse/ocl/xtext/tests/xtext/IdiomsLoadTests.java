...
//		DeclarativeSerializer.SERIALIZER_FRAGMENTS.setState(true);
	...
	public void testIdiomsLoad_DebugTest_idioms() throws IOException, InterruptedException {
		TestOCL ocl = createOCL();
		URI idiomsURI = URI.createPlatformResourceURI("/org.eclipse.ocl.xtext.tests/models/idioms/DebugTest.idioms", true);
		doLoad_Idioms(ocl, idiomsURI);
		ocl.dispose();
	}
...
//			System.out.println(i);
	...
	public void testIdiomsLoad_Test_idioms() throws IOException, InterruptedException {
		TestOCL ocl = createOCL();
		URI idiomsURI = URI.createPlatformResourceURI("/org.eclipse.ocl.xtext.tests/models/idioms/Test.idioms", true);
		doLoad_Idioms(ocl, idiomsURI);
		ocl.dispose();
	}
	...
	//	SerializationBuilder.SERIALIZATION.setState(true);
		TestOCL ocl = createOCL();
		URI idiomsURI = URI.createPlatformResourceURI("/org.eclipse.ocl.xtext.tests/models/idioms/Xtext.idioms", true);
		doLoad_Idioms(ocl, idiomsURI);
		ocl.dispose();
	}
	...
	public void testIdiomsLoad_Reformat_Tutorial_oclinecore() throws IOException, InterruptedException {
		...
		TestOCL ocl = createOCL();
		URI inputURI = URI.createPlatformResourceURI("/org.eclipse.ocl.xtext.tests/models/documentation/Tutorial.oclinecore", true);
		URI referenceURI = URI.createPlatformResourceURI("/org.eclipse.ocl.xtext.tests/models/documentation/Tutorial.reformatted.oclinecore", true);
