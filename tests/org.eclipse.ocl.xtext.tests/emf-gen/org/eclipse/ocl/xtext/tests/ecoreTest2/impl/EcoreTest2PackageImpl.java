 ...
 *******************************************************************************/
package org.eclipse.ocl.xtext.tests.ecoreTest2.impl;
...
import org.eclipse.ocl.xtext.tests.ecoreTest.impl.EcoreTestPackageImpl;
import org.eclipse.ocl.xtext.tests.ecoreTest2.Eclass5;
import org.eclipse.ocl.xtext.tests.ecoreTest2.EcoreTest2Factory;
...
public class EcoreTest2PackageImpl extends EPackageImpl implements EcoreTest2Package {
	 ...
	 * @see org.eclipse.ocl.xtext.tests.ecoreTest2.EcoreTest2Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static EcoreTest2Package init() {
		...
		Object registeredEcoreTest2Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		EcoreTest2PackageImpl theEcoreTest2Package = registeredEcoreTest2Package instanceof EcoreTest2PackageImpl ? (EcoreTest2PackageImpl)registeredEcoreTest2Package : new EcoreTest2PackageImpl();

		isInited = true;

		// Obtain or create and register interdependencies
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(EcoreTestPackage.eNS_URI);
		EcoreTestPackageImpl theEcoreTestPackage = (EcoreTestPackageImpl)(registeredPackage instanceof EcoreTestPackageImpl ? registeredPackage : EcoreTestPackage.eINSTANCE);
