 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.Employee#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.Employee#getManager <em>Manager</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.Employee#getCompany <em>Company</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.Employee#getDirectReports <em>Direct Reports</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.Employee#getAllReports <em>All Reports</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.Employee#getReportingChain <em>Reporting Chain</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.Employee#isHasNameAsAttribute <em>Has Name As Attribute</em>}</li>
 * </ul>
 *
 * @see org.eclipse.ocl.xtext.tests.company.CompanyPackage#getEmployee()
...
public interface Employee extends EObject {
	 ...
	 * @see #setName(String)
	 * @see org.eclipse.ocl.xtext.tests.company.CompanyPackage#getEmployee_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ocl.xtext.tests.company.Employee#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.ocl.xtext.tests.company.CompanyPackage#getEmployee_Manager()
	 * @model
	 * @generated
	 */
	Employee getManager();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ocl.xtext.tests.company.Employee#getManager <em>Manager</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link org.eclipse.ocl.xtext.tests.company.Company#getEmployees <em>Employees</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.ocl.xtext.tests.company.CompanyPackage#getEmployee_Company()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ocl.xtext.tests.company.Employee#getCompany <em>Company</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link org.eclipse.ocl.xtext.tests.company.Employee}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.ocl.xtext.tests.company.CompanyPackage#getEmployee_DirectReports()
	 ...
	 * @see org.eclipse.ocl.xtext.tests.company.CompanyPackage#getEmployee_AllReports()
	 ...
	 * @see org.eclipse.ocl.xtext.tests.company.CompanyPackage#getEmployee_ReportingChain()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see org.eclipse.ocl.xtext.tests.company.CompanyPackage#getEmployee_HasNameAsAttribute()
