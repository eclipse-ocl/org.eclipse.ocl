 ...
 * <copyright>
 *******************************************************************************/
package org.eclipse.ocl.xtext.tests.company.impl;
...
import org.eclipse.ocl.xtext.tests.company.Company;
import org.eclipse.ocl.xtext.tests.company.CompanyPackage;
import org.eclipse.ocl.xtext.tests.company.Employee;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.impl.EmployeeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.impl.EmployeeImpl#getManager <em>Manager</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.impl.EmployeeImpl#getCompany <em>Company</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.impl.EmployeeImpl#getDirectReports <em>Direct Reports</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.impl.EmployeeImpl#getAllReports <em>All Reports</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.impl.EmployeeImpl#getReportingChain <em>Reporting Chain</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.company.impl.EmployeeImpl#isHasNameAsAttribute <em>Has Name As Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EmployeeImpl extends EObjectImpl implements Employee {
	...
	/**
	 * The cached invocation delegate for the '{@link #reportsTo(org.eclipse.ocl.xtext.tests.company.Employee) <em>Reports To</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #reportsTo(org.eclipse.ocl.xtext.tests.company.Employee)
	 * @generated
	 * @ordered
	 */
