/**
 */
package org.eclipse.ocl.xtext.tests.dummy.impl;
...
import org.eclipse.ocl.xtext.tests.dummy.Dummy;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.xtext.tests.dummy.impl.DummyImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DummyImpl extends MinimalEObjectImpl.Container implements Dummy {
	...
	protected EClass eStaticClass() {
		return DummyPackage.Literals.DUMMY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DummyPackage.DUMMY__NAME, oldName, name));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DummyPackage.DUMMY___DUMMY_INVARIANT__DIAGNOSTICCHAIN_MAP:
