 ...
 * <copyright>
 *******************************************************************************/
package org.eclipse.ocl.xtext.tests.noreflectioncompany.impl;
...
import org.eclipse.ocl.xtext.tests.noreflectioncompany.Company;
import org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.impl.EmployeeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.impl.EmployeeImpl#getManager <em>Manager</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.impl.EmployeeImpl#getCompany <em>Company</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.impl.EmployeeImpl#getDirectReports <em>Direct Reports</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.impl.EmployeeImpl#getAllReports <em>All Reports</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.impl.EmployeeImpl#getReportingChain <em>Reporting Chain</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.impl.EmployeeImpl#isHasNameAsAttribute <em>Has Name As Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EmployeeImpl extends EObjectImpl implements Employee {
	...
	/**
	 * The cached invocation delegate for the '{@link #reportsTo(org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee) <em>Reports To</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #reportsTo(org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee)
	 * @generated
	 * @ordered
	 */
