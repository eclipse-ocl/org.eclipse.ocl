 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee#getManager <em>Manager</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee#getCompany <em>Company</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee#getDirectReports <em>Direct Reports</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee#getAllReports <em>All Reports</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee#getReportingChain <em>Reporting Chain</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee#isHasNameAsAttribute <em>Has Name As Attribute</em>}</li>
 * </ul>
 *
 * @see org.eclipse.ocl.xtext.tests.noreflectioncompany.NoreflectioncompanyPackage#getEmployee()
...
public interface Employee extends EObject {
	 ...
	 * @see #setName(String)
	 * @see org.eclipse.ocl.xtext.tests.noreflectioncompany.NoreflectioncompanyPackage#getEmployee_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.ocl.xtext.tests.noreflectioncompany.NoreflectioncompanyPackage#getEmployee_Manager()
	 * @model
	 * @generated
	 */
	Employee getManager();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee#getManager <em>Manager</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.Company#getEmployees <em>Employees</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.ocl.xtext.tests.noreflectioncompany.NoreflectioncompanyPackage#getEmployee_Company()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee#getCompany <em>Company</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link org.eclipse.ocl.xtext.tests.noreflectioncompany.Employee}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.ocl.xtext.tests.noreflectioncompany.NoreflectioncompanyPackage#getEmployee_DirectReports()
	 ...
	 * @see org.eclipse.ocl.xtext.tests.noreflectioncompany.NoreflectioncompanyPackage#getEmployee_AllReports()
	 ...
	 * @see org.eclipse.ocl.xtext.tests.noreflectioncompany.NoreflectioncompanyPackage#getEmployee_ReportingChain()
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see org.eclipse.ocl.xtext.tests.noreflectioncompany.NoreflectioncompanyPackage#getEmployee_HasNameAsAttribute()
