...
public class CodegencompanyTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ @NonNull PartId PARTid__2 = IdManager.getPartId(1, "status", TypeId.BOOLEAN, true);
	...
	public static class Operations {
		...
		public static final @NonNull ExecutorOperation _Employee__hasNameAsOperation = new ExecutorOperation("hasNameAsOperation", ParameterTypes.EMPTY_LIST, Types._Employee,
