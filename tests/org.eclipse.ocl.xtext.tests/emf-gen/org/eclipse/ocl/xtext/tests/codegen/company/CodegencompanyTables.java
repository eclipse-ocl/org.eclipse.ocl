...
public class CodegencompanyTables extends AbstractTables
{
	...
	public static class Properties {
		...
		public static final @NonNull Property _Employee__Employee__allReports = LIBRARY.createOppositeProperty(Types._Employee, "Employee", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Employee, false), 7 | IsImplicit | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Employee__Employee__directReports = LIBRARY.createOppositeProperty(Types._Employee, "Employee", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Employee, false), 8 | IsImplicit | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Employee__Employee__manager = LIBRARY.createOppositeProperty(Types._Employee, "Employee", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Employee, false), 9 | IsImplicit | IsRequired | IsResolveProxies);
		public static final @NonNull Property _Employee__Employee__reportingChain = LIBRARY.createOppositeProperty(Types._Employee, "Employee", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Employee, false), 10 | IsImplicit | IsRequired | IsResolveProxies);
