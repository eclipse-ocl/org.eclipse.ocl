...
public class CodegencompanyTables extends AbstractTables
{
	...
	public static class Properties {
		...
		public static final @NonNull Property _Company__employees = LIBRARY.createProperty(Types._Company, CodegencompanyPackage.Literals.COMPANY__EMPLOYEES, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Employee, false), 0 | IsComposite | IsRequired | IsResolveProxies);
		...
		public static final @NonNull Property _Employee__allReports = LIBRARY.createProperty(Types._Employee, CodegencompanyPackage.Literals.EMPLOYEE__ALL_REPORTS, MODEL.getCollectionType(OCLstdlibTables.Types._Set, Types._Employee, false), 0 | IsDerived | IsReadOnly | IsRequired | IsResolveProxies | IsTransient | IsVolatile);
		...
		public static final @NonNull Property _Employee__reportingChain = LIBRARY.createProperty(Types._Employee, CodegencompanyPackage.Literals.EMPLOYEE__REPORTING_CHAIN, MODEL.getCollectionType(OCLstdlibTables.Types._OrderedSet, Types._Employee, false), 6 | IsDerived | IsReadOnly | IsRequired | IsResolveProxies | IsTransient | IsVolatile);
		public static final @NonNull Property _Employee__Employee__allReports = LIBRARY.createOppositeProperty(Types._Employee, "Employee", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Employee, false), 7 | IsImplicit | IsRequired | IsResolveProxies, CodegencompanyPackage.Literals.EMPLOYEE__ALL_REPORTS);
		public static final @NonNull Property _Employee__Employee__directReports = LIBRARY.createOppositeProperty(Types._Employee, "Employee", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Employee, false), 8 | IsImplicit | IsRequired | IsResolveProxies, CodegencompanyPackage.Literals.EMPLOYEE__DIRECT_REPORTS);
		public static final @NonNull Property _Employee__Employee__manager = LIBRARY.createOppositeProperty(Types._Employee, "Employee", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Employee, false), 9 | IsImplicit | IsRequired | IsResolveProxies, CodegencompanyPackage.Literals.EMPLOYEE__MANAGER);
		public static final @NonNull Property _Employee__Employee__reportingChain = LIBRARY.createOppositeProperty(Types._Employee, "Employee", MODEL.getCollectionType(OCLstdlibTables.Types._Bag, Types._Employee, false), 10 | IsImplicit | IsRequired | IsResolveProxies, CodegencompanyPackage.Literals.EMPLOYEE__REPORTING_CHAIN);
