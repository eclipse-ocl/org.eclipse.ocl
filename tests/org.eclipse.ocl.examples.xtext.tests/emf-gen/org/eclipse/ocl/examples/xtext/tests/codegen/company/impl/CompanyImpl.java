...
public class CompanyImpl extends EObjectImpl implements Company {
	...
	public CompanySizeKind getSize() {
		...
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull EnumerationLiteralId size = (@NonNull EnumerationLiteralId)any.getValue(1/*size*/);
		@SuppressWarnings("null")
		final /*@NonInvalid*/ @NonNull CompanySizeKind ECORE_size = (@NonNull CompanySizeKind)idResolver.ecoreValueOf(Enumerator.class, size);
		return ECORE_size;
	}
