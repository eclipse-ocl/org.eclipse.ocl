...
public class CodegencompanyTables extends AbstractTables
{
	...
	public static final /*@NonInvalid*/ @NonNull TuplePartId PARTid__2 = IdManager.getTuplePartId(0, "message", TypeId.STRING);
	public static final /*@NonInvalid*/ @NonNull TuplePartId PARTid__1 = IdManager.getTuplePartId(1, "status", TypeId.BOOLEAN);
	...
	public static final /*@NonInvalid*/ @NonNull IntegerRange RNG_0 = ValueUtil.createRange(CodegencompanyTables.INT_0, CodegencompanyTables.INT_49);
	public static final /*@NonInvalid*/ @NonNull IntegerRange RNG_1 = ValueUtil.createRange(CodegencompanyTables.INT_1000, CodegencompanyTables.INT_1000000);
	public static final /*@NonInvalid*/ @NonNull IntegerRange RNG = ValueUtil.createRange(CodegencompanyTables.INT_50, CodegencompanyTables.INT_999);
	...
	public static final /*@NonInvalid*/ @NonNull TupleTypeId TUPLid__0 = IdManager.getTupleTypeId("Tuple", CodegencompanyTables.PARTid__2, CodegencompanyTables.PARTid__1);
	...
	public static final /*@NonInvalid*/ @NonNull SequenceValue Sequence_0 = ValueUtil.createSequenceRange(CodegencompanyTables.SEQ_PRIMid_Integer, CodegencompanyTables.RNG_0);
	public static final /*@NonInvalid*/ @NonNull SequenceValue Sequence = ValueUtil.createSequenceRange(CodegencompanyTables.SEQ_PRIMid_Integer, CodegencompanyTables.RNG_1);
	public static final /*@NonInvalid*/ @NonNull SequenceValue Sequence_1 = ValueUtil.createSequenceRange(CodegencompanyTables.SEQ_PRIMid_Integer, CodegencompanyTables.RNG);
	...
	public static final /*@NonInvalid*/ @NonNull TupleValue TUP__0 = ValueUtil.createTupleOfEach(CodegencompanyTables.TUPLid_, CodegencompanyTables.Sequence_0, CodegencompanyTables.ELITid_small);
	public static final /*@NonInvalid*/ @NonNull TupleValue TUP__1 = ValueUtil.createTupleOfEach(CodegencompanyTables.TUPLid_, CodegencompanyTables.Sequence, CodegencompanyTables.ELITid_large);
	public static final /*@NonInvalid*/ @NonNull TupleValue TUP_ = ValueUtil.createTupleOfEach(CodegencompanyTables.TUPLid_, CodegencompanyTables.Sequence_1, CodegencompanyTables.ELITid_medium);
	public static final /*@NonInvalid*/ @NonNull SetValue table = ValueUtil.createSetOfEach(CodegencompanyTables.SET_TUPLid_, CodegencompanyTables.TUP__0, CodegencompanyTables.TUP_, CodegencompanyTables.TUP__1);
