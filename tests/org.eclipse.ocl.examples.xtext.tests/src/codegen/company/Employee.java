...
public interface Employee extends EObject {
	 ...
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='/**\n * Employee.allInstances()-&gt;select(reportsTo(self))\n \052/\nfinal /*@NonInvalid\052/ org.eclipse.ocl.pivot.evaluation.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; Executor executor = &lt;%org.eclipse.ocl.pivot.internal.utilities.PivotUtilInternal%&gt;.getExecutor(this);\nfinal /*@NonInvalid\052/ org.eclipse.ocl.pivot.ids.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; IdResolver idResolver = executor.getIdResolver();\nfinal /*@NonInvalid\052/ org.eclipse.ocl.pivot.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; Class TYP_company_c_c_Employee = idResolver.getClass(&lt;%codegen.company.CodegencompanyTables%&gt;.CLSSid_Employee, null);\nfinal /*@NonInvalid\052/ org.eclipse.ocl.pivot.values.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; CollectionValue allInstances = &lt;%org.eclipse.ocl.pivot.library.classifier.ClassifierAllInstancesOperation%&gt;.INSTANCE.evaluate(executor, &lt;%codegen.company.CodegencompanyTables%&gt;.SET_CLSSid_Employee, TYP_company_c_c_Employee);\n/*@Thrown\052/ &lt;%org.eclipse.ocl.pivot.values.CollectionValue%&gt;.@org.eclipse.jdt.annotation.NonNull Accumulator accumulator = &lt;%org.eclipse.ocl.pivot.utilities.ValueUtil%&gt;.createSetAccumulatorValue(&lt;%codegen.company.CodegencompanyTables%&gt;.SET_CLSSid_Employee);\n@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; &lt;%java.util.Iterator%&gt;&lt;&lt;%java.lang.Object%&gt;&gt; ITERATOR__1 = &lt;%org.eclipse.ocl.pivot.utilities.ValueUtil%&gt;.lazyIterator(allInstances);\n/*@NonInvalid\052/ org.eclipse.ocl.pivot.values.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; CollectionValue select;\nwhile (true) {\n\tif (!ITERATOR__1.hasNext()) {\n\t\tselect = accumulator;\n\t\tbreak;\n\t}\n\t@SuppressWarnings(\"null\")\n\t/*@NonInvalid\052/ codegen.company.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; Employee _1 = (&lt;%codegen.company.Employee%&gt;)ITERATOR__1.next();\n\t/**\n\t * reportsTo(self)\n\t \052/\n\tfinal /*@NonInvalid\052/ boolean reportsTo = _1.reportsTo(this);\n\t//\n\tif (reportsTo == &lt;%org.eclipse.ocl.pivot.utilities.ValueUtil%&gt;.TRUE_VALUE) {\n\t\taccumulator.add(_1);\n\t}\n}\nfinal /*@NonInvalid\052/ java.util.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; List&lt;&lt;%codegen.company.Employee%&gt;&gt; ECORE_select = ((&lt;%org.eclipse.ocl.pivot.ids.IdResolver%&gt;.IdResolverExtension)idResolver).ecoreValueOfAll(&lt;%codegen.company.Employee%&gt;.class, select);\nreturn (&lt;%org.eclipse.emf.common.util.EList%&gt;&lt;&lt;%codegen.company.Employee%&gt;&gt;)ECORE_select;'"
	 * @generated
	 */
	 ...
	 * @model transient="true" changeable="false" volatile="true" derived="true"
	 *        annotation="http://www.eclipse.org/emf/2002/GenModel get='/**\n *\n * if manager.oclIsUndefined()\n * then OrderedSet{}\n * else manager?.reportingChain-&gt;prepend(manager)\n * endif\n \052/\nfinal /*@NonInvalid\052/ org.eclipse.ocl.pivot.evaluation.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; Executor executor = &lt;%org.eclipse.ocl.pivot.internal.utilities.PivotUtilInternal%&gt;.getExecutor(this);\nfinal /*@NonInvalid\052/ org.eclipse.ocl.pivot.ids.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; IdResolver idResolver = executor.getIdResolver();\nfinal /*@NonInvalid\052/ codegen.company.@&lt;%org.eclipse.jdt.annotation.Nullable%&gt; Employee manager_2 = this.getManager();\nfinal /*@NonInvalid\052/ boolean symbol_6 = manager_2 == null;\n/*@Thrown\052/ org.eclipse.ocl.pivot.values.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; CollectionValue symbol_8;\nif (symbol_6) {\n\tsymbol_8 = &lt;%codegen.company.CodegencompanyTables%&gt;.OrderedSet;\n}\nelse {\n\tfinal /*@NonInvalid\052/ @&lt;%org.eclipse.jdt.annotation.NonNull%&gt; &lt;%java.lang.Object%&gt; symbol_7 = manager_2 == null;\n\t/*@Thrown\052/ org.eclipse.ocl.pivot.values.@&lt;%org.eclipse.jdt.annotation.Nullable%&gt; CollectionValue safe_reportingChain_source;\n\tif (symbol_7 == Boolean.TRUE) {\n\t\tsafe_reportingChain_source = null;\n\t}\n\telse {\n\t\tassert manager_2 != null;\n\t\t@SuppressWarnings(\"null\")\n\t\tfinal /*@Thrown\052/ java.util.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; List&lt;&lt;%codegen.company.Employee%&gt;&gt; reportingChain = manager_2.getReportingChain();\n\t\tfinal /*@Thrown\052/ org.eclipse.ocl.pivot.values.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; CollectionValue BOXED_reportingChain = idResolver.createOrderedSetOfAll(&lt;%codegen.company.CodegencompanyTables%&gt;.ORD_CLSSid_Employee, reportingChain);\n\t\tsafe_reportingChain_source = BOXED_reportingChain;\n\t}\n\tfinal /*@Thrown\052/ org.eclipse.ocl.pivot.values.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; CollectionValue prepend = &lt;%org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation%&gt;.INSTANCE.evaluate(safe_reportingChain_source, manager_2);\n\tsymbol_8 = prepend;\n}\nfinal /*@Thrown\052/ java.util.@&lt;%org.eclipse.jdt.annotation.NonNull%&gt; List&lt;&lt;%codegen.company.Employee%&gt;&gt; ECORE_symbol_8 = ((&lt;%org.eclipse.ocl.pivot.ids.IdResolver%&gt;.IdResolverExtension)idResolver).ecoreValueOfAll(&lt;%codegen.company.Employee%&gt;.class, symbol_8);\nreturn (&lt;%org.eclipse.emf.common.util.EList%&gt;&lt;&lt;%codegen.company.Employee%&gt;&gt;)ECORE_symbol_8;'"
	 * @generated
	 */
