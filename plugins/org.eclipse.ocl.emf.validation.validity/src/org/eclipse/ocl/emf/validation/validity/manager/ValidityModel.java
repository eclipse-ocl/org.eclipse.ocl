 ...
 *******************************************************************************/
package org.eclipse.ocl.emf.validation.validity.manager;
...
import org.eclipse.ocl.emf.validation.validity.ValidityFactory;
...
public class ValidityModel
{
	...
	public void init(@NonNull Monitor monitor) {
		...
		EList<@NonNull RootConstrainingNode> constrainingNodes = rootNode.getConstrainingNodes();
		...
		EList<@NonNull RootValidatableNode> validatableNodes = rootNode.getValidatableNodes();
