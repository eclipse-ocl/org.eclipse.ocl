 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.emf.validation.validity.LeafConstrainingNode#getConstraintLocator <em>Constraint Locator</em>}</li>
 *   <li>{@link org.eclipse.ocl.emf.validation.validity.LeafConstrainingNode#getConstraintResource <em>Constraint Resource</em>}</li>
 *   <li>{@link org.eclipse.ocl.emf.validation.validity.LeafConstrainingNode#getConstraintString <em>Constraint String</em>}</li>
 * </ul>
 *
 * @see org.eclipse.ocl.emf.validation.validity.ValidityPackage#getLeafConstrainingNode()
 * @model
 * @generated
 */
public interface LeafConstrainingNode extends ConstrainingNode {
	 ...
	 * @see org.eclipse.ocl.emf.validation.validity.ValidityPackage#getLeafConstrainingNode_ConstraintLocator()
	 * @model dataType="org.eclipse.ocl.emf.validation.validity.ConstraintLocator" required="true" transient="true"
	 * @generated
	 */
	ConstraintLocator getConstraintLocator();

	/**
	 * Sets the value of the '{@link org.eclipse.ocl.emf.validation.validity.LeafConstrainingNode#getConstraintLocator <em>Constraint Locator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.ocl.emf.validation.validity.ValidityPackage#getLeafConstrainingNode_ConstraintResource()
	 * @model dataType="org.eclipse.ocl.emf.validation.validity.Resource" transient="true" changeable="false" volatile="true" derived="true"
	 * @generated
	 */
	 ...
	 * @see org.eclipse.ocl.emf.validation.validity.ValidityPackage#getLeafConstrainingNode_ConstraintString()
