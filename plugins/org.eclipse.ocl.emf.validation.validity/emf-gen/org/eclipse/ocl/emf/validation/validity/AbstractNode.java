 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.emf.validation.validity.AbstractNode#isEnabled <em>Enabled</em>}</li>
 *   <li>{@link org.eclipse.ocl.emf.validation.validity.AbstractNode#isGrayed <em>Grayed</em>}</li>
 *   <li>{@link org.eclipse.ocl.emf.validation.validity.AbstractNode#isVisible <em>Visible</em>}</li>
 *   <li>{@link org.eclipse.ocl.emf.validation.validity.AbstractNode#getLabel <em>Label</em>}</li>
 *   <li>{@link org.eclipse.ocl.emf.validation.validity.AbstractNode#getWorstResult <em>Worst Result</em>}</li>
 * </ul>
 *
 * @see org.eclipse.ocl.emf.validation.validity.ValidityPackage#getAbstractNode()
 * @model abstract="true"
 * @generated
 */
public interface AbstractNode extends EObject {
	 ...
	 * @see org.eclipse.ocl.emf.validation.validity.ValidityPackage#getAbstractNode_Enabled()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ocl.emf.validation.validity.AbstractNode#isEnabled <em>Enabled</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.ocl.emf.validation.validity.ValidityPackage#getAbstractNode_Grayed()
	 ...
	 * @see org.eclipse.ocl.emf.validation.validity.ValidityPackage#getAbstractNode_Visible()
	 ...
	 * @see #setLabel(String)
	 * @see org.eclipse.ocl.emf.validation.validity.ValidityPackage#getAbstractNode_Label()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ocl.emf.validation.validity.AbstractNode#getLabel <em>Label</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.ocl.emf.validation.validity.ValidityPackage#getAbstractNode_WorstResult()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ocl.emf.validation.validity.AbstractNode#getWorstResult <em>Worst Result</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
