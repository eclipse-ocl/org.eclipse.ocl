		...
		if (selection instanceof StructuredSelection) {
			...
			if (resultConstrainingNode != null) {
				...
				if (eParent instanceof LeafConstrainingNode) {
					...
					org.eclipse.ocl.emf.validation.validity.locator.ConstraintLocator constraintLocator = ((LeafConstrainingNode)eParent).getConstraintLocator();
					if (constraintLocator instanceof org.eclipse.ocl.emf.validation.validity.ui.locator.ConstraintUILocator) {
						final org.eclipse.ocl.emf.validation.validity.ui.locator.ConstraintUILocator uiConstraintLocator = (org.eclipse.ocl.emf.validation.validity.ui.locator.ConstraintUILocator)constraintLocator;
