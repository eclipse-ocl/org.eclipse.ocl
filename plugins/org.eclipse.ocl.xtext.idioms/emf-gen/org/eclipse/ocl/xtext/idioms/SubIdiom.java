 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.xtext.idioms.SubIdiom#isAll <em>All</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.idioms.SubIdiom#getOwnedLocator <em>Owned Locator</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.idioms.SubIdiom#getOwnedSegments <em>Owned Segments</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.idioms.SubIdiom#getOwningIdiom <em>Owning Idiom</em>}</li>
 * </ul>
 *
 * @see org.eclipse.ocl.xtext.idioms.IdiomsPackage#getSubIdiom()
 * @model
 * @generated
 */
public interface SubIdiom
	 ...
	 * @see #setAll(boolean)
	 * @see org.eclipse.ocl.xtext.idioms.IdiomsPackage#getSubIdiom_All()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ocl.xtext.idioms.SubIdiom#isAll <em>All</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link org.eclipse.ocl.xtext.idioms.Locator#getOwningSubIdiom <em>Owning Sub Idiom</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.ocl.xtext.idioms.IdiomsPackage#getSubIdiom_OwnedLocator()
	 * @see org.eclipse.ocl.xtext.idioms.Locator#getOwningSubIdiom
	 * @model opposite="owningSubIdiom" containment="true"
	 * @generated
	 */
	Locator getOwnedLocator();

	/**
	 * Sets the value of the '{@link org.eclipse.ocl.xtext.idioms.SubIdiom#getOwnedLocator <em>Owned Locator</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link org.eclipse.ocl.xtext.idioms.Segment}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.ocl.xtext.idioms.IdiomsPackage#getSubIdiom_OwnedSegments()
	 ...
	 * It is bidirectional and its opposite is '{@link org.eclipse.ocl.xtext.idioms.Idiom#getOwnedSubIdioms <em>Owned Sub Idioms</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Owning Idiom</em>' container reference.
	 * @see #setOwningIdiom(Idiom)
	 * @see org.eclipse.ocl.xtext.idioms.IdiomsPackage#getSubIdiom_OwningIdiom()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.ocl.xtext.idioms.SubIdiom#getOwningIdiom <em>Owning Idiom</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
