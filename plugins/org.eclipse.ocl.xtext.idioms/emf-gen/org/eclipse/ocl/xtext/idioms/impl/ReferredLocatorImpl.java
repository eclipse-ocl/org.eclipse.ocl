 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.xtext.idioms.impl.ReferredLocatorImpl#getIdiomsModel <em>Idioms Model</em>}</li>
 *   <li>{@link org.eclipse.ocl.xtext.idioms.impl.ReferredLocatorImpl#getLocatorDeclaration <em>Locator Declaration</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReferredLocatorImpl
	...
	public LocatorDeclaration getLocatorDeclaration() {
		if (locatorDeclaration != null && locatorDeclaration.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 2, oldLocatorDeclaration, locatorDeclaration));
			}
		}
	...
	public void setLocatorDeclaration(
		...
		locatorDeclaration = newLocatorDeclaration;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 2, oldLocatorDeclaration, locatorDeclaration));
	}
