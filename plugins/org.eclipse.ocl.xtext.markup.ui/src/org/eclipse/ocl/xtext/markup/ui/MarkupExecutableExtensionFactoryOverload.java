 ...
 */
public class MarkupExecutableExtensionFactoryOverload extends MarkupExecutableExtensionFactory
{
	@Override
	public Object create() throws CoreException {
		...
		Object object = extensionToFactoryMap.get("markup");
		if (object instanceof Resource.Factory.Descriptor) {	// OOPS EcorePlugin.ExtensionProcessor has installed an object requiring OSGI getBundle() support.
			new MarkupStandaloneSetup().register(getInjector());
			object = extensionToFactoryMap.get("markup");
		}
		return object;
	}
	...
	protected Injector getInjector() {
		...
		if (injector == null) {
			injector = MarkupStandaloneSetup.getInjector();
		}
		return injector;
	}
}
