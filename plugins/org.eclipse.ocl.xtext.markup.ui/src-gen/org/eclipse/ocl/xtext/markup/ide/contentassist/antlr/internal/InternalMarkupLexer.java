...
public class InternalMarkupLexer extends Lexer {
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            // InternalMarkup.g:2734:22: ( '0' .. '9' )
            // InternalMarkup.g:2734:24: '0' .. '9'
            {
            matchRange('0','9');
    ...
    public final void mRULE_LETTER() throws RecognitionException {
        try {
            // InternalMarkup.g:2736:22: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) )
            // InternalMarkup.g:2736:24: ( 'a' .. 'z' | 'A' .. 'Z' | '_' )
            {
    ...
    public final void mRULE_ESCAPED() throws RecognitionException {
        try {
            // InternalMarkup.g:2738:23: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' | '<' | '>' | '[' | ']' ) )
            // InternalMarkup.g:2738:25: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\"' | '\\'' | '\\\\' | '<' | '>' | '[' | ']' )
            {
            match('\\');
    ...
    public final void mRULE_VERTICAL_WS() throws RecognitionException {
        try {
            // InternalMarkup.g:2740:27: ( ( '\\n' | '\\r' ) )
            // InternalMarkup.g:2740:29: ( '\\n' | '\\r' )
            {
            if ( input.LA(1)=='\n'||input.LA(1)=='\r' ) {
                input.consume();
    ...
    public final void mRULE_HORIZONTAL_WS() throws RecognitionException {
        try {
            // InternalMarkup.g:2742:29: ( ( ' ' | '\\t' ) )
            // InternalMarkup.g:2742:31: ( ' ' | '\\t' )
            {
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMarkup.g:2744:10: ( ( RULE_NUMBER )+ )
            // InternalMarkup.g:2744:12: ( RULE_NUMBER )+
            {
            // InternalMarkup.g:2744:12: ( RULE_NUMBER )+
            int cnt1=0;
            loop1:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMarkup.g:2746:13: ( '\"' ( RULE_ESCAPED | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalMarkup.g:2746:15: '\"' ( RULE_ESCAPED | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"');
            // InternalMarkup.g:2746:19: ( RULE_ESCAPED | ~ ( ( '\\\\' | '\"' ) ) )*
            loop2:
            do {
                int alt2=3;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalMarkup.g:2746:20: RULE_ESCAPED
            	    {
            	    mRULE_ESCAPED();
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMarkup.g:2748:9: ( RULE_LETTER ( RULE_LETTER | RULE_NUMBER )* )
            // InternalMarkup.g:2748:11: RULE_LETTER ( RULE_LETTER | RULE_NUMBER )*
            {
            mRULE_LETTER();
            // InternalMarkup.g:2748:23: ( RULE_LETTER | RULE_NUMBER )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_WORD() throws RecognitionException {
        try {
            int _type = RULE_WORD;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMarkup.g:2750:11: ( ( RULE_ESCAPED | ~ ( ( '\\\\' | '\"' | '[' | ']' | ':' | '#' | ',' | RULE_HORIZONTAL_WS | RULE_VERTICAL_WS ) ) )+ )
            // InternalMarkup.g:2750:13: ( RULE_ESCAPED | ~ ( ( '\\\\' | '\"' | '[' | ']' | ':' | '#' | ',' | RULE_HORIZONTAL_WS | RULE_VERTICAL_WS ) ) )+
            {
            // InternalMarkup.g:2750:13: ( RULE_ESCAPED | ~ ( ( '\\\\' | '\"' | '[' | ']' | ':' | '#' | ',' | RULE_HORIZONTAL_WS | RULE_VERTICAL_WS ) ) )+
            int cnt4=0;
            loop4:
            do {
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalMarkup.g:2750:14: RULE_ESCAPED
            	    {
            	    mRULE_ESCAPED();
            	    ...
            	    break;
            	case 2 :
            	    // InternalMarkup.g:2750:27: ~ ( ( '\\\\' | '\"' | '[' | ']' | ':' | '#' | ',' | RULE_HORIZONTAL_WS | RULE_VERTICAL_WS ) )
            	    {
    ...
    public final void mRULE_NL() throws RecognitionException {
        try {
            int _type = RULE_NL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMarkup.g:2752:9: ( ( ( RULE_HORIZONTAL_WS )* RULE_VERTICAL_WS )+ )
            // InternalMarkup.g:2752:11: ( ( RULE_HORIZONTAL_WS )* RULE_VERTICAL_WS )+
            {
            // InternalMarkup.g:2752:11: ( ( RULE_HORIZONTAL_WS )* RULE_VERTICAL_WS )+
            int cnt6=0;
            loop6:
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalMarkup.g:2752:12: ( RULE_HORIZONTAL_WS )* RULE_VERTICAL_WS
            	    {
            	    // InternalMarkup.g:2752:12: ( RULE_HORIZONTAL_WS )*
            	    loop5:
            	    do {
            	        int alt5=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMarkup.g:2754:9: ( ( RULE_HORIZONTAL_WS )+ )
            // InternalMarkup.g:2754:11: ( RULE_HORIZONTAL_WS )+
            {
            // InternalMarkup.g:2754:11: ( RULE_HORIZONTAL_WS )+
            int cnt7=0;
            loop7:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMarkup.g:2756:16: ( . )
            // InternalMarkup.g:2756:18: .
            {
            matchAny();
    ...
    private static final class DFA8_transitionS_ {
        static final String[] DFA8_transitionS = {
                "\11\17\1\20\1\21\2\17\1\21\22\17\1\20\1\17\1\14\1\7\10\17\1\10\3\17\12\13\1\6\6\17\32\15\1\11\1\16\1\12\1\17\1\15\1\17\1\15\1\1\2\15\1\2\1\3\1\15\1\4\6\15\1\5\13\15\uff85\17",
