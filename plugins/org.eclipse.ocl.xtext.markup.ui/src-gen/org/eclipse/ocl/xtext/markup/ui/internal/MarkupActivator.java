...
import org.eclipse.ocl.xtext.markup.ui.MarkupUiModule;
...
public class MarkupActivator extends AbstractUIPlugin {
	...
	public static final String PLUGIN_ID = "org.eclipse.ocl.xtext.markup.ui";
	...
	protected com.google.inject.Module getRuntimeModule(String grammar) {
		if (ORG_ECLIPSE_OCL_XTEXT_MARKUP_MARKUP.equals(grammar)) {
			return new MarkupRuntimeModule();
		}
	...
	protected com.google.inject.Module getUiModule(String grammar) {
		if (ORG_ECLIPSE_OCL_XTEXT_MARKUP_MARKUP.equals(grammar)) {
			return new MarkupUiModule(this);
		}
		throw new IllegalArgumentException(grammar);
	}
