 ...
 *******************************************************************************/
package org.eclipse.ocl.debug.vm.core;
...
import org.eclipse.ocl.debug.vm.BreakpointError;
import org.eclipse.ocl.debug.vm.IVMVirtualMachineShell;
import org.eclipse.ocl.debug.vm.VMEventListener;
import org.eclipse.ocl.debug.vm.VMVirtualMachine;
import org.eclipse.ocl.debug.vm.data.VMNewBreakpointData;
import org.eclipse.ocl.debug.vm.data.VMSuspension;
import org.eclipse.ocl.debug.vm.event.VMDisconnectEvent;
import org.eclipse.ocl.debug.vm.event.VMEvent;
import org.eclipse.ocl.debug.vm.event.VMResumeEvent;
import org.eclipse.ocl.debug.vm.event.VMStartEvent;
import org.eclipse.ocl.debug.vm.event.VMSuspendEvent;
...
import org.eclipse.ocl.debug.vm.request.VMResumeRequest;
import org.eclipse.ocl.debug.vm.request.VMStartRequest;
import org.eclipse.ocl.debug.vm.request.VMSuspendRequest;
import org.eclipse.ocl.debug.vm.request.VMTerminateRequest;
