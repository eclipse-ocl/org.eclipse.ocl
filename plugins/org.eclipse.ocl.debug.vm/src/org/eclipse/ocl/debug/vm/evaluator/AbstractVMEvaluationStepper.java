...
import org.eclipse.ocl.debug.vm.ConditionChecker;
...
import org.eclipse.ocl.debug.vm.VMBreakpointManager;
...
import org.eclipse.ocl.debug.vm.utils.CompiledUnit;
import org.eclipse.ocl.debug.vm.utils.DebugOptions;
import org.eclipse.ocl.debug.vm.utils.VMInterruptedExecutionException;
...
public abstract class AbstractVMEvaluationStepper implements VMEvaluationStepper
{
	...
	protected AbstractVMEvaluationStepper(@NonNull EvaluationVisitor evaluationVisitor, @NonNull IVMContext vmContext, @NonNull IStepperVisitor stepperVisitor) {
		...
		invalidVariable.setType(vmExecutor.getEnvironmentFactory().getASClass(typeName));
	}
