 ...
 *******************************************************************************/
package org.eclipse.ocl.debug.vm;
...
import org.eclipse.ocl.debug.vm.core.VMLocalValue;
import org.eclipse.ocl.debug.vm.core.VMLocalValue.LocalValue;
import org.eclipse.ocl.debug.vm.data.VMBreakpointData;
import org.eclipse.ocl.debug.vm.data.VMNewBreakpointData;
import org.eclipse.ocl.debug.vm.data.VMStackFrameData;
import org.eclipse.ocl.debug.vm.evaluator.IDebuggableRunnerFactory;
...
import org.eclipse.ocl.debug.vm.event.VMEvent;
import org.eclipse.ocl.debug.vm.event.VMStartEvent;
import org.eclipse.ocl.debug.vm.event.VMTerminateEvent;
import org.eclipse.ocl.debug.vm.launching.DebuggableRunner;
import org.eclipse.ocl.debug.vm.launching.VMDebuggableExecutorAdapter;
import org.eclipse.ocl.debug.vm.request.VMBreakpointRequest;
import org.eclipse.ocl.debug.vm.request.VMDetailRequest;
import org.eclipse.ocl.debug.vm.request.VMRequest;
import org.eclipse.ocl.debug.vm.request.VMStackFrameRequest;
import org.eclipse.ocl.debug.vm.request.VMStartRequest;
import org.eclipse.ocl.debug.vm.request.VMVariableRequest;
import org.eclipse.ocl.debug.vm.request.VMBreakpointRequest.ActionKind;
import org.eclipse.ocl.debug.vm.response.VMBreakpointResponse;
import org.eclipse.ocl.debug.vm.response.VMDetailResponse;
import org.eclipse.ocl.debug.vm.response.VMResponse;
import org.eclipse.ocl.debug.vm.response.VMStackFrameResponse;
import org.eclipse.ocl.debug.vm.utils.DebugOptions;
