 ...
 */
public class EssentialOCLExecutableExtensionFactoryOverload extends EssentialOCLExecutableExtensionFactory
{
	@Override
	public Object create() throws CoreException {
		...
		Object object = extensionToFactoryMap.get("essentialocl");
		if (object instanceof Resource.Factory.Descriptor) {	// OOPS EcorePlugin.ExtensionProcessor has installed an object requiring OSGI getBundle() support.
			new EssentialOCLStandaloneSetup().register(getInjector());
			object = extensionToFactoryMap.get("essentialocl");
		}
		return object;
	}
	...
	protected Injector getInjector() {
		...
		if (injector == null) {
			injector = EssentialOCLStandaloneSetup.getInjector();
		}
		return injector;
	}
}
