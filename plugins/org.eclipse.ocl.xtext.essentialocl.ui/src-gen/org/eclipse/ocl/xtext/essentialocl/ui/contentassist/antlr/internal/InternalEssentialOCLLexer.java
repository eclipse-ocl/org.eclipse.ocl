...
public class InternalEssentialOCLLexer extends Lexer {
    ...
    public final void mRULE_LETTER_CHARACTER() throws RecognitionException {
        try {
            // InternalEssentialOCL.g:12966:32: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) )
            // InternalEssentialOCL.g:12966:34: ( 'a' .. 'z' | 'A' .. 'Z' | '_' )
            {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // InternalEssentialOCL.g:12968:57: ~ ( ( '\\\\' | '\"' ) )
            	    {
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    break;
            	case 2 :
            	    // InternalEssentialOCL.g:12970:58: ~ ( ( '\\\\' | '\\'' ) )
            	    {
            	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
            	        input.consume();
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEssentialOCL.g:12978:10: ( ( '0' .. '9' )+ )
            // InternalEssentialOCL.g:12978:12: ( '0' .. '9' )+
            {
            // InternalEssentialOCL.g:12978:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            // InternalEssentialOCL.g:12982:40: ( ( '\\r' )? '\\n' )?
            int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEssentialOCL.g:12984:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalEssentialOCL.g:12984:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalEssentialOCL.g:12984:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt10=0;
            loop10:
