...
import org.eclipse.ocl.xtext.console.actions.CloseAction;
import org.eclipse.ocl.xtext.console.actions.DebugAction;
import org.eclipse.ocl.xtext.console.actions.LoadExpressionAction;
import org.eclipse.ocl.xtext.console.actions.SaveExpressionAction;
import org.eclipse.ocl.xtext.console.messages.ConsoleMessages;
import org.eclipse.ocl.xtext.console.xtfo.EmbeddedXtextEditor;
		...
		try {
			editorDocument.modify(new IUnitOfWork<Object, XtextResource>()
			{
				...
				public Value exec(@Nullable XtextResource resource) throws Exception {
					...
					if (csResource != null) {
						if (contextObject != null) {
							csResource.getCS2AS(environmentFactory);
						}
