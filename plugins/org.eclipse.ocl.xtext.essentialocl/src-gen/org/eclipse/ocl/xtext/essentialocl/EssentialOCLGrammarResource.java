 ...
 * from: C:\GIT\org.eclipse.ocl\examples..\..\plugins\org.eclipse.ocl.xtext.essentialocl\src-gen\org\eclipse\ocl\xtext\essentialocl\EssentialOCL.xtextbin
		...
		private static void initParserRules() {
			...
			PR_MultiplicityCS.setAlternatives(
				createGroup(
					...
					setCardinality("?", createAlternatives(
						createAssignment("isNonNullFree", "?=", createKeyword("|?")),
