...
public class EssentialOCLSerializationMetaData extends AbstractSerializationMetaData
{
	...
	private final @NonNull GrammarRuleVector @NonNull [] grammarRuleVectors = new @NonNull GrammarRuleVector[48];
	private final @NonNull SerializationMatchStep @NonNull [] serializationMatchSteps = new @NonNull SerializationMatchStep[180];
	private final @NonNull SerializationMatchTerm @NonNull [] serializationMatchTerms = new @NonNull SerializationMatchTerm[159];
	private final @NonNull SerializationRule @NonNull [] serializationRules = new @NonNull SerializationRule[82];
	...
	private final @NonNull SerializationStep @NonNull [] serializationSteps = new @NonNull SerializationStep[144];
		...
		eClassValues[4] = new EClassValue(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS,
			...
			new @NonNull EReference_TargetGrammarRuleVector [] {
				...
				createEReference_TargetGrammarRuleVector(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_TYPE,
					33) /* CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */
			}
		);
		...
		eClassValues[26] = new EClassValue(BaseCSPackage.Literals.PATH_NAME_CS,
			...
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS,
					39) /* FirstPathElementCS|NextPathElementCS|URIFirstPathElementCS */
			}
		);
		...
		eClassValues[36] = new EClassValue(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS,
			...
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS__OWNED_ACTUAL_PARAMETER,
					47) /* TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS */
			}
		);
	...
	private void initGrammarRuleValues() {
		...
		grammarRuleValues[20] = createParserRuleValue(20, "ExpCS", 44 /* BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				17	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				19	/* CollectionLiteralExpCS-0: CollectionLiteralExpCS::ownedType=CollectionTypeCS '{' (CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS (',' CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS)[V1:*])[V0:?] '}' */,
				26	/* ExpCS-18: InfixExpCS::ownedLeft=PrefixedPrimaryExpCS NamedElementCS::name=BinaryOperatorName OperatorExpCS::ownedRight=ExpCS */,
		...
		grammarRuleValues[45] = createParserRuleValue(45, "NavigatingArgExpCS", 45 /* BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				17	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				19	/* CollectionLiteralExpCS-0: CollectionLiteralExpCS::ownedType=CollectionTypeCS '{' (CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS (',' CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS)[V1:*])[V0:?] '}' */,
				26	/* ExpCS-18: InfixExpCS::ownedLeft=PrefixedPrimaryExpCS NamedElementCS::name=BinaryOperatorName OperatorExpCS::ownedRight=ExpCS */,
		...
		grammarRuleValues[57] = createParserRuleValue(57, "PrefixedPrimaryExpCS", 42 /* BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				17	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				19	/* CollectionLiteralExpCS-0: CollectionLiteralExpCS::ownedType=CollectionTypeCS '{' (CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS (',' CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS)[V1:*])[V0:?] '}' */,
				27	/* IfExpCS-0: 'if' IfExpCS::ownedCondition=ExpCS|PatternExpCS 'then' IfExpCS::ownedThenExpression=ExpCS (IfExpCS::ownedIfThenExpressions+=ElseIfThenExpCS)[V0:*] 'else' IfExpCS::ownedElseExpression=ExpCS 'endif' */,
		...
		grammarRuleValues[59] = createParserRuleValue(59, "PrimitiveLiteralExpCS", 40 /* BooleanLiteralExpCS|InvalidLiteralExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrimitiveLiteralExpCS|StringLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				17	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				28	/* InvalidLiteralExpCS-0: 'invalid' */,
				49	/* NullLiteralExpCS-0: 'null' */,
		...
		grammarRuleValues[80] = createParserRuleValue(80, "TypeExpWithoutMultiplicityCS", 33 /* CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
			createSerializationRules(
				22	/* CollectionPatternCS-0: CollectionPatternCS::ownedType=CollectionTypeCS '{' (CollectionPatternCS::ownedParts+=PatternExpCS (',' CollectionPatternCS::ownedParts+=PatternExpCS)[V1:*] '++' CollectionPatternCS::restVariableName=Identifier)[V0:?] '}' */,
				23	/* CollectionTypeCS-0: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] */,
				34	/* MapTypeCS-0: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] */,
		...
		grammarRuleValues[86] = createParserRuleValue(86, "TypeRefCS", 47 /* TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS */,
			createSerializationRules(
				15	/* TypedTypeRefCS-0: TypedTypeRefCS::ownedPathName=PathNameCS ('(' TypedTypeRefCS::ownedBinding=TemplateBindingCS ')')[V0:?] */,
				16	/* WildcardTypeRefCS-0: '?' ('extends' WildcardTypeRefCS::ownedExtends=TypedRefCS)[V0:?] */
			),
		...
		grammarRuleValues[87] = createParserRuleValue(87, "TypedRefCS", 37 /* TypedRefCS|TypedTypeRefCS */,
			createSerializationRules(
				15	/* TypedTypeRefCS-0: TypedTypeRefCS::ownedPathName=PathNameCS ('(' TypedTypeRefCS::ownedBinding=TemplateBindingCS ')')[V0:?] */
			),
	...
	private void initGrammarRuleVectors() {
		...
		// 31: CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS
		...
		// 33: CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS
		grammarRuleVectors[33] = new GrammarRuleVector(0x10000020000000c0L,0x134000L);
		// 34: TypeParameterCS
		...
		// 37: TypedRefCS|TypedTypeRefCS
		grammarRuleVectors[37] = new GrammarRuleVector(0x0L,0x1800000L);
		// 38: NextPathElementCS|URIFirstPathElementCS
		grammarRuleVectors[38] = new GrammarRuleVector(0x8000000000000L,0x8000000L);
		// 39: FirstPathElementCS|NextPathElementCS|URIFirstPathElementCS
		grammarRuleVectors[39] = new GrammarRuleVector(0x8000000200000L,0x8000000L);
		// 40: BooleanLiteralExpCS|InvalidLiteralExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrimitiveLiteralExpCS|StringLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[40] = new GrammarRuleVector(0x830000008000004L,0x40000080L);
		// 41: BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[41] = new GrammarRuleVector(0xc3408084a000014L,0x40040884L);
		// 42: BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[42] = new GrammarRuleVector(0xe3408084a000014L,0x40040884L);
		// 43: BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[43] = new GrammarRuleVector(0xf340808ca000014L,0x40040884L);
		// 44: BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[44] = new GrammarRuleVector(0xf340808ca100014L,0x40040884L);
		// 45: BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[45] = new GrammarRuleVector(0xf342808ca100014L,0x40040884L);
		// 46: BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[46] = new GrammarRuleVector(0xfb40808ca100014L,0x40040884L);
		// 47: TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS
		grammarRuleVectors[47] = new GrammarRuleVector(0x0L,0x401c00000L);
	}
	...
	private void initMatchSteps() {
		...
		// 74: assign V0 = (|SquareBracketedClauseCS::ownedTerms| - 1)
		serializationMatchSteps[74] = createMatchStep_Assign(0, 144);
		// 75: assign V0 = (|TemplateBindingCS::ownedSubstitutions| - 1)
		serializationMatchSteps[75] = createMatchStep_Assign(0, 145);
		// 76: assign V0 = (|TemplateSignatureCS::ownedParameters| - 1)
		serializationMatchSteps[76] = createMatchStep_Assign(0, 147);
		// 77: assign V0 = (|TupleLiteralExpCS::ownedParts| - 1)
		serializationMatchSteps[77] = createMatchStep_Assign(0, 148);
		// 78: assign V0 = (|TupleTypeCS::ownedParts| > 0)
		serializationMatchSteps[78] = createMatchStep_Assign(0, 151);
		// 79: assign V0 = (|TypeParameterCS::ownedExtends| > 0)
		serializationMatchSteps[79] = createMatchStep_Assign(0, 155);
		// 80: assign V0 = |AbstractNameExpCS::ownedSquareBracketedClauses|
		serializationMatchSteps[80] = createMatchStep_Assign(0, 7);
		// 81: assign V0 = |CollectionLiteralPartCS::ownedLastExpression|
		serializationMatchSteps[81] = createMatchStep_Assign(0, 12);
		// 82: assign V0 = |CollectionPatternCS::restVariableName|
		serializationMatchSteps[82] = createMatchStep_Assign(0, 16);
		// 83: assign V0 = |CollectionTypeCS::ownedType|
		serializationMatchSteps[83] = createMatchStep_Assign(0, 19);
		// 84: assign V0 = |IfExpCS::ownedIfThenExpressions|
		serializationMatchSteps[84] = createMatchStep_Assign(0, 26);
		// 85: assign V0 = |LetVariableCS::ownedRoundBracketedClause|
		serializationMatchSteps[85] = createMatchStep_Assign(0, 35);
		// 86: assign V0 = |MapTypeCS::ownedValueType|
		serializationMatchSteps[86] = createMatchStep_Assign(0, 42);
		// 87: assign V0 = |MultiplicityBoundsCS::upperBound|
		serializationMatchSteps[87] = createMatchStep_Assign(0, 45);
		// 88: assign V0 = |NavigatingArgCS::ownedCoIterator|
		serializationMatchSteps[88] = createMatchStep_Assign(0, 50);
		// 89: assign V0 = |NavigatingArgCS::ownedInitExpression|
		serializationMatchSteps[89] = createMatchStep_Assign(0, 51);
		// 90: assign V0 = |NavigatingArgCS::ownedType|
		serializationMatchSteps[90] = createMatchStep_Assign(0, 53);
		// 91: assign V0 = |PatternExpCS::patternVariableName|
		serializationMatchSteps[91] = createMatchStep_Assign(0, 64);
		// 92: assign V0 = |StringLiteralExpCS::segments|
		serializationMatchSteps[92] = createMatchStep_Assign(0, 71);
		// 93: assign V0 = |TypeNameExpCS::ownedCurlyBracketedClause|
		serializationMatchSteps[93] = createMatchStep_Assign(0, 81);
		// 94: assign V0 = |TypedRefCS::ownedMultiplicity|
		serializationMatchSteps[94] = createMatchStep_Assign(0, 88);
		// 95: assign V0 = |TypedTypeRefCS::ownedBinding|
		serializationMatchSteps[95] = createMatchStep_Assign(0, 90);
		// 96: assign V0 = |VariableCS::ownedType|
		serializationMatchSteps[96] = createMatchStep_Assign(0, 93);
		// 97: assign V0 = |WildcardTypeRefCS::ownedExtends|
		serializationMatchSteps[97] = createMatchStep_Assign(0, 94);
		// 98: assign V1 = (|CollectionLiteralExpCS::ownedParts| - 1)
		serializationMatchSteps[98] = createMatchStep_Assign(1, 98);
		// 99: assign V1 = (|CollectionPatternCS::ownedParts| - 1)
		serializationMatchSteps[99] = createMatchStep_Assign(1, 102);
		// 100: assign V1 = (|CurlyBracketedClauseCS::ownedParts| - 1)
		serializationMatchSteps[100] = createMatchStep_Assign(1, 106);
		// 101: assign V1 = (|MapLiteralExpCS::ownedParts| - 1)
		serializationMatchSteps[101] = createMatchStep_Assign(1, 117);
		// 102: assign V1 = (|TupleTypeCS::ownedParts| > 0)
		serializationMatchSteps[102] = createMatchStep_Assign(1, 151);
		// 103: assign V1 = (|TypeParameterCS::ownedExtends| - 1)
		serializationMatchSteps[103] = createMatchStep_Assign(1, 154);
		// 104: assign V1 = |AbstractNameExpCS::ownedRoundBracketedClause|
		serializationMatchSteps[104] = createMatchStep_Assign(1, 6);
		// 105: assign V1 = |CollectionTypeCS::ownedCollectionMultiplicity|
		serializationMatchSteps[105] = createMatchStep_Assign(1, 18);
		// 106: assign V1 = |NavigatingArgCS::ownedCoIterator|
		serializationMatchSteps[106] = createMatchStep_Assign(1, 50);
		// 107: assign V1 = |NavigatingArgCS::ownedInitExpression|
		serializationMatchSteps[107] = createMatchStep_Assign(1, 51);
		// 108: assign V1 = |TemplateBindingCS::ownedMultiplicity|
		serializationMatchSteps[108] = createMatchStep_Assign(1, 72);
		// 109: assign V1 = |TypeNameExpCS::ownedPatternGuard|
		serializationMatchSteps[109] = createMatchStep_Assign(1, 83);
		// 110: assign V1 = |TypedRefCS::ownedMultiplicity|
		serializationMatchSteps[110] = createMatchStep_Assign(1, 88);
		// 111: assign V1 = |VariableCS::ownedType|
		serializationMatchSteps[111] = createMatchStep_Assign(1, 93);
		// 112: assign V2 = (|TupleTypeCS::ownedParts| - 1)
		serializationMatchSteps[112] = createMatchStep_Assign(2, 150);
		// 113: assign V2 = |AbstractNameExpCS::ownedCurlyBracketedClause|
		serializationMatchSteps[113] = createMatchStep_Assign(2, 4);
		// 114: assign V2 = |TypedRefCS::ownedMultiplicity|
		serializationMatchSteps[114] = createMatchStep_Assign(2, 88);
		// 115: assign V3 = |AbstractNameExpCS::isPre.'@'|
		serializationMatchSteps[115] = createMatchStep_Assign(3, 3);
		// 116: assign V3 = |TypedRefCS::ownedMultiplicity|
		serializationMatchSteps[116] = createMatchStep_Assign(3, 88);
		// 117: check-rule basecs::PathNameCS.ownedPathElements : 21
		serializationMatchSteps[117] = createMatchStep_RuleCheck(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 6/*FirstPathElementCS*/);
		// 118: check-rule basecs::TemplateBindingCS.ownedMultiplicity : 40
		serializationMatchSteps[118] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_BINDING_CS__OWNED_MULTIPLICITY, 10/*MultiplicityCS*/);
		// 119: check-rule basecs::TemplateBindingCS.ownedSubstitutions : 73
		serializationMatchSteps[119] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_BINDING_CS__OWNED_SUBSTITUTIONS, 26/*TemplateParameterSubstitutionCS*/);
		// 120: check-rule basecs::TemplateParameterSubstitutionCS.ownedActualParameter : 86|87|88|98
		serializationMatchSteps[120] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS__OWNED_ACTUAL_PARAMETER, 47/*TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS*/);
		// 121: check-rule basecs::TemplateSignatureCS.ownedParameters : 85
		serializationMatchSteps[121] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_SIGNATURE_CS__OWNED_PARAMETERS, 34/*TypeParameterCS*/);
		// 122: check-rule basecs::TupleTypeCS.ownedParts : 77
		serializationMatchSteps[122] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TUPLE_TYPE_CS__OWNED_PARTS, 28/*TuplePartCS*/);
		// 123: check-rule basecs::TypeParameterCS.ownedExtends : 87|88
		serializationMatchSteps[123] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPE_PARAMETER_CS__OWNED_EXTENDS, 37/*TypedRefCS|TypedTypeRefCS*/);
		// 124: check-rule basecs::TypedElementCS.ownedType : 79
		serializationMatchSteps[124] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE, 29/*TypeExpCS*/);
		// 125: check-rule basecs::TypedRefCS.ownedMultiplicity : 40
		serializationMatchSteps[125] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_REF_CS__OWNED_MULTIPLICITY, 10/*MultiplicityCS*/);
		// 126: check-rule basecs::TypedTypeRefCS.ownedBinding : 72
		serializationMatchSteps[126] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__OWNED_BINDING, 25/*TemplateBindingCS*/);
		// 127: check-rule basecs::TypedTypeRefCS.ownedPathName : 54
		serializationMatchSteps[127] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__OWNED_PATH_NAME, 15/*PathNameCS*/);
		// 128: check-rule basecs::WildcardTypeRefCS.ownedExtends : 87|88
		serializationMatchSteps[128] = createMatchStep_RuleCheck(BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS__OWNED_EXTENDS, 37/*TypedRefCS|TypedTypeRefCS*/);
		// 129: check-rule essentialoclcs::AbstractNameExpCS.ownedCurlyBracketedClause : 9
		serializationMatchSteps[129] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_CURLY_BRACKETED_CLAUSE, 3/*CurlyBracketedClauseCS*/);
		// 130: check-rule essentialoclcs::AbstractNameExpCS.ownedPathName : 54
		serializationMatchSteps[130] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_PATH_NAME, 15/*PathNameCS*/);
		// 131: check-rule essentialoclcs::AbstractNameExpCS.ownedRoundBracketedClause : 62
		serializationMatchSteps[131] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_ROUND_BRACKETED_CLAUSE, 21/*RoundBracketedClauseCS*/);
		// 132: check-rule essentialoclcs::AbstractNameExpCS.ownedSquareBracketedClauses : 69
		serializationMatchSteps[132] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_SQUARE_BRACKETED_CLAUSES, 23/*SquareBracketedClauseCS*/);
		// 133: check-rule essentialoclcs::CollectionLiteralExpCS.ownedParts : 5
		serializationMatchSteps[133] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_EXP_CS__OWNED_PARTS, 1/*CollectionLiteralPartCS*/);
		// 134: check-rule essentialoclcs::CollectionLiteralExpCS.ownedType : 7
		serializationMatchSteps[134] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_EXP_CS__OWNED_TYPE, 2/*CollectionTypeCS*/);
		// 135: check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[135] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_EXPRESSION, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 136: check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : 55
		serializationMatchSteps[136] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_EXPRESSION, 16/*PatternExpCS*/);
		// 137: check-rule essentialoclcs::CollectionLiteralPartCS.ownedLastExpression : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[137] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_LAST_EXPRESSION, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 138: check-rule essentialoclcs::CollectionPatternCS.ownedParts : 55
		serializationMatchSteps[138] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__OWNED_PARTS, 16/*PatternExpCS*/);
		// 139: check-rule essentialoclcs::CollectionPatternCS.ownedType : 7
		serializationMatchSteps[139] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__OWNED_TYPE, 2/*CollectionTypeCS*/);
		// 140: check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : 40
		serializationMatchSteps[140] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_COLLECTION_MULTIPLICITY, 10/*MultiplicityCS*/);
		// 141: check-rule essentialoclcs::CollectionTypeCS.ownedType : 6|7|37|60|78|80|81|84
		serializationMatchSteps[141] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_TYPE, 33/*CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS*/);
		// 142: check-rule essentialoclcs::ContextCS.ownedExpression : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[142] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.CONTEXT_CS__OWNED_EXPRESSION, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 143: check-rule essentialoclcs::CurlyBracketedClauseCS.ownedParts : 67
		serializationMatchSteps[143] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.CURLY_BRACKETED_CLAUSE_CS__OWNED_PARTS, 22/*ShadowPartCS*/);
		// 144: check-rule essentialoclcs::IfExpCS.ownedCondition : 2|4|20|25|27|30|31|35|43|50|52|53|55|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[144] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_CONDITION, 46/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 145: check-rule essentialoclcs::IfExpCS.ownedElseExpression : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[145] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_ELSE_EXPRESSION, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 146: check-rule essentialoclcs::IfExpCS.ownedIfThenExpressions : 13
		serializationMatchSteps[146] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_IF_THEN_EXPRESSIONS, 4/*ElseIfThenExpCS*/);
		// 147: check-rule essentialoclcs::IfExpCS.ownedThenExpression : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[147] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_THEN_EXPRESSION, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 148: check-rule essentialoclcs::IfThenExpCS.ownedCondition : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[148] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_THEN_EXP_CS__OWNED_CONDITION, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 149: check-rule essentialoclcs::IfThenExpCS.ownedThenExpression : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[149] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_THEN_EXP_CS__OWNED_THEN_EXPRESSION, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 150: check-rule essentialoclcs::InfixExpCS.ownedLeft : 2|4|25|27|30|35|43|50|52|53|57|58|59|66|71|75|82|94
		serializationMatchSteps[150] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.INFIX_EXP_CS__OWNED_LEFT, 42/*BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 151: check-rule essentialoclcs::LambdaLiteralExpCS.ownedExpressionCS : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[151] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LAMBDA_LITERAL_EXP_CS__OWNED_EXPRESSION_CS, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 152: check-rule essentialoclcs::LetExpCS.ownedInExpression : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[152] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LET_EXP_CS__OWNED_IN_EXPRESSION, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 153: check-rule essentialoclcs::LetExpCS.ownedVariables : 32
		serializationMatchSteps[153] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LET_EXP_CS__OWNED_VARIABLES, 7/*LetVariableCS*/);
		// 154: check-rule essentialoclcs::LetVariableCS.ownedRoundBracketedClause : 62
		serializationMatchSteps[154] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LET_VARIABLE_CS__OWNED_ROUND_BRACKETED_CLAUSE, 21/*RoundBracketedClauseCS*/);
		// 155: check-rule essentialoclcs::MapLiteralExpCS.ownedParts : 36
		serializationMatchSteps[155] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_EXP_CS__OWNED_PARTS, 8/*MapLiteralPartCS*/);
		// 156: check-rule essentialoclcs::MapLiteralExpCS.ownedType : 37
		serializationMatchSteps[156] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_EXP_CS__OWNED_TYPE, 9/*MapTypeCS*/);
		// 157: check-rule essentialoclcs::MapLiteralPartCS.ownedKey : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[157] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_PART_CS__OWNED_KEY, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 158: check-rule essentialoclcs::MapLiteralPartCS.ownedValue : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[158] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_PART_CS__OWNED_VALUE, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 159: check-rule essentialoclcs::MapTypeCS.ownedKeyType : 79
		serializationMatchSteps[159] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_KEY_TYPE, 29/*TypeExpCS*/);
		// 160: check-rule essentialoclcs::MapTypeCS.ownedValueType : 79
		serializationMatchSteps[160] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_VALUE_TYPE, 29/*TypeExpCS*/);
		// 161: check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : 3
		serializationMatchSteps[161] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_CO_ITERATOR, 0/*CoIteratorVariableCS*/);
		// 162: check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[162] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_INIT_EXPRESSION, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 163: check-rule essentialoclcs::NavigatingArgCS.ownedNameExpression : 2|4|20|25|27|30|31|35|43|45|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[163] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_NAME_EXPRESSION, 45/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 164: check-rule essentialoclcs::NavigatingArgCS.ownedType : 79
		serializationMatchSteps[164] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_TYPE, 29/*TypeExpCS*/);
		// 165: check-rule essentialoclcs::NestedExpCS.ownedExpression : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[165] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NESTED_EXP_CS__OWNED_EXPRESSION, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 166: check-rule essentialoclcs::OperatorExpCS.ownedRight : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[166] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 167: check-rule essentialoclcs::OperatorExpCS.ownedRight : 2|4|25|27|30|35|43|50|52|53|57|58|59|66|71|75|82|94
		serializationMatchSteps[167] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 42/*BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 168: check-rule essentialoclcs::OperatorExpCS.ownedRight : 31|56
		serializationMatchSteps[168] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 19/*LetExpCS|PrefixedLetExpCS*/);
		// 169: check-rule essentialoclcs::PatternExpCS.ownedPatternType : 79
		serializationMatchSteps[169] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS__OWNED_PATTERN_TYPE, 29/*TypeExpCS*/);
		// 170: check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : 2|4|20|25|27|30|31|35|43|50|52|53|55|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[170] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 46/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 171: check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : 71
		serializationMatchSteps[171] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 24/*StringLiteralExpCS*/);
		// 172: check-rule essentialoclcs::SquareBracketedClauseCS.ownedTerms : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[172] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.SQUARE_BRACKETED_CLAUSE_CS__OWNED_TERMS, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 173: check-rule essentialoclcs::TupleLiteralExpCS.ownedParts : 76
		serializationMatchSteps[173] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TUPLE_LITERAL_EXP_CS__OWNED_PARTS, 27/*TupleLiteralPartCS*/);
		// 174: check-rule essentialoclcs::TypeLiteralExpCS.ownedType : 83
		serializationMatchSteps[174] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_LITERAL_EXP_CS__OWNED_TYPE, 32/*TypeLiteralWithMultiplicityCS*/);
		// 175: check-rule essentialoclcs::TypeNameExpCS.ownedCurlyBracketedClause : 9
		serializationMatchSteps[175] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_CURLY_BRACKETED_CLAUSE, 3/*CurlyBracketedClauseCS*/);
		// 176: check-rule essentialoclcs::TypeNameExpCS.ownedPathName : 54
		serializationMatchSteps[176] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_PATH_NAME, 15/*PathNameCS*/);
		// 177: check-rule essentialoclcs::TypeNameExpCS.ownedPatternGuard : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[177] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_PATTERN_GUARD, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 178: check-rule essentialoclcs::VariableCS.ownedInitExpression : 2|4|20|25|27|30|31|35|43|50|52|53|56|57|58|59|66|71|75|82|94
		serializationMatchSteps[178] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_INIT_EXPRESSION, 44/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 179: check-rule essentialoclcs::VariableCS.ownedType : 79
		serializationMatchSteps[179] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_TYPE, 29/*TypeExpCS*/);
	}
	...
	private void initSerializationRules0() {
		...
		serializationRules[0] = createSerializationRule("FirstPathElementCS-0", 21,
			...
			createSerializationSteps(
				143		/* PathElementCS::referredElement=UnrestrictedName || soft-space value soft-space */
			),
		...
		serializationRules[1] = createSerializationRule("MultiplicityBoundsCS-0", 39,
			...
			createSerializationSteps(
				...
				112		/* V00*2-steps || value */,
				84		/* '..' || no-space value no-space */,
		...
		serializationRules[9] = createSerializationRule("NextPathElementCS-0", 51,
			...
			createSerializationSteps(
				142		/* PathElementCS::referredElement=UnreservedName || soft-space value soft-space */
			),
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, -1
				)
		...
		serializationRules[10] = createSerializationRule("PathNameCS-0", 54,
			...
			createSerializationSteps(
				135		/* PathNameCS::ownedPathElements+=FirstPathElementCS || value */,
				113		/* V00*2-steps || value */,
				86		/* '::' || no-space value no-space */,
				136		/* PathNameCS::ownedPathElements+=NextPathElementCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 14/* FirstPathElementCS,NextPathElementCS */,
		...
		serializationRules[11] = createSerializationRule("TemplateBindingCS-0", 72,
			createSerializationMatchSteps(
				118		/* check-rule basecs::TemplateBindingCS.ownedMultiplicity : MultiplicityCS */,
				119		/* check-rule basecs::TemplateBindingCS.ownedSubstitutions : TemplateParameterSubstitutionCS */,
				108		/* assign V1 = |TemplateBindingCS::ownedMultiplicity| */,
				75		/* assign V0 = (|TemplateBindingCS::ownedSubstitutions| - 1) */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.TEMPLATE_BINDING_CS__OWNED_SUBSTITUTIONS, 26/* TemplateParameterSubstitutionCS */,
		...
		serializationRules[12] = createSerializationRule("TemplateParameterSubstitutionCS-0", 73,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				120		/* check-rule basecs::TemplateParameterSubstitutionCS.ownedActualParameter : TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS */,
				40		/* assert (|TemplateParameterSubstitutionCS::ownedActualParameter| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS__OWNED_ACTUAL_PARAMETER, 35/* TypeRefCS */,
					(86/*TypeRefCS*/ << 4) | 0 /*[1]*/
				)
			});
		...
		serializationRules[13] = createSerializationRule("TemplateSignatureCS-0", 74,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				121		/* check-rule basecs::TemplateSignatureCS.ownedParameters : TypeParameterCS */,
				76		/* assign V0 = (|TemplateSignatureCS::ownedParameters| - 1) */
			),
			createSerializationSteps(
				129		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.TEMPLATE_SIGNATURE_CS__OWNED_PARAMETERS, 34/* TypeParameterCS */,
		...
		serializationRules[14] = createSerializationRule("TypeParameterCS-0", 85,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				123		/* check-rule basecs::TypeParameterCS.ownedExtends : TypedRefCS|TypedTypeRefCS */,
				23		/* assert (|NamedElementCS::name| - 1) == 0 */,
				79		/* assign V0 = (|TypeParameterCS::ownedExtends| > 0) */,
				103		/* assign V1 = (|TypeParameterCS::ownedExtends| - 1) */
			),
			createSerializationSteps(
				129		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				132		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				116		/* V00*5-steps || value */,
				97		/* 'extends' || soft-space value soft-space */,
				21		/* TypeParameterCS::ownedExtends+=TypedRefCS || value */,
				122		/* V01*2-steps || value */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.TYPE_PARAMETER_CS__OWNED_EXTENDS, 36/* TypedRefCS */,
					(87/*TypedRefCS*/ << 4) | 2 /*[*]*/
				)
			});
		...
		serializationRules[15] = createSerializationRule("TypedTypeRefCS-0", 88,
			createSerializationMatchSteps(
				67		/* assert |TypedTypeRefCS::isTypeof| == 0 */,
				66		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				126		/* check-rule basecs::TypedTypeRefCS.ownedBinding : TemplateBindingCS */,
				127		/* check-rule basecs::TypedTypeRefCS.ownedPathName : PathNameCS */,
				95		/* assign V0 = |TypedTypeRefCS::ownedBinding| */,
				45		/* assert (|TypedTypeRefCS::ownedPathName| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__OWNED_BINDING, 25/* TemplateBindingCS */,
					(72/*TemplateBindingCS*/ << 4) | 1 /*[?]*/
				),
				createSerializationReference(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__OWNED_PATH_NAME, 15/* PathNameCS */,
					(54/*PathNameCS*/ << 4) | 0 /*[1]*/
				)
			});
		// Base::WildcardTypeRefCS-0(basecs::WildcardTypeRefCS): { "?" { "extends" ownedExtends=TypedRefCS }[?] }
		serializationRules[16] = createSerializationRule("WildcardTypeRefCS-0", 98,
			createSerializationMatchSteps(
				69		/* assert |WildcardTypeRefCS::ownedSuper| == 0 */,
				128		/* check-rule basecs::WildcardTypeRefCS.ownedExtends : TypedRefCS|TypedTypeRefCS */,
				97		/* assign V0 = |WildcardTypeRefCS::ownedExtends| */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS__OWNED_EXTENDS, 36/* TypedRefCS */,
					(87/*TypedRefCS*/ << 4) | 1 /*[?]*/
				)
			});
		// EssentialOCL::BooleanLiteralExpCS-0(essentialoclcs::BooleanLiteralExpCS): symbol={'false|true'}
		serializationRules[17] = createSerializationRule("BooleanLiteralExpCS-0", 2,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				1		/* assert (|BooleanLiteralExpCS::symbol.'false|true'| - 1) == 0 */
			),
		...
		serializationRules[18] = createSerializationRule("CoIteratorVariableCS-0", 3,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				68		/* assert |VariableCS::ownedInitExpression| == 0 */,
				179		/* check-rule essentialoclcs::VariableCS.ownedType : TypeExpCS */,
				96		/* assign V0 = |VariableCS::ownedType| */,
				23		/* assert (|NamedElementCS::name| - 1) == 0 */
			),
			createSerializationSteps(
				...
				132		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				112		/* V00*2-steps || value */,
				85		/* ':' || soft-space value soft-space */,
				63		/* VariableCS::ownedType=TypeExpCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_TYPE, 29/* TypeExpCS */,
					(79/*TypeExpCS*/ << 4) | 1 /*[?]*/
				)
			});
		...
		serializationRules[19] = createSerializationRule("CollectionLiteralExpCS-0", 4,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				133		/* check-rule essentialoclcs::CollectionLiteralExpCS.ownedParts : CollectionLiteralPartCS */,
				134		/* check-rule essentialoclcs::CollectionLiteralExpCS.ownedType : CollectionTypeCS */,
				2		/* assert (|CollectionLiteralExpCS::ownedType| - 1) == 0 */,
				70		/* assign V0 = (|CollectionLiteralExpCS::ownedParts| > 0) */,
				98		/* assign V1 = (|CollectionLiteralExpCS::ownedParts| - 1) */
			),
		...
		serializationRules[20] = createSerializationRule("CollectionLiteralPartCS-0", 5,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				135		/* check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				137		/* check-rule essentialoclcs::CollectionLiteralPartCS.ownedLastExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				81		/* assign V0 = |CollectionLiteralPartCS::ownedLastExpression| */,
				3		/* assert (|CollectionLiteralPartCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[21] = createSerializationRule("CollectionLiteralPartCS-1", 5,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				47		/* assert |CollectionLiteralPartCS::ownedLastExpression| == 0 */,
				136		/* check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : PatternExpCS */,
				3		/* assert (|CollectionLiteralPartCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_EXPRESSION, 16/* PatternExpCS */,
		...
		serializationRules[22] = createSerializationRule("CollectionPatternCS-0", 6,
			createSerializationMatchSteps(
				66		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				48		/* assert |CollectionPatternCS::ownedPatternGuard| == 0 */,
				138		/* check-rule essentialoclcs::CollectionPatternCS.ownedParts : PatternExpCS */,
				139		/* check-rule essentialoclcs::CollectionPatternCS.ownedType : CollectionTypeCS */,
				82		/* assign V0 = |CollectionPatternCS::restVariableName| */,
				99		/* assign V1 = (|CollectionPatternCS::ownedParts| - 1) */,
				4		/* assert (|CollectionPatternCS::ownedType| - 1) == 0 */
			),
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__OWNED_PARTS, 16/* PatternExpCS */,
					(55/*PatternExpCS*/ << 4) | 2 /*[*]*/
				),
		...
		serializationRules[23] = createSerializationRule("CollectionTypeCS-0", 7,
			createSerializationMatchSteps(
				66		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				140		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				141		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
				83		/* assign V0 = |CollectionTypeCS::ownedType| */,
				5		/* assert (|CollectionTypeCS::name| - 1) == 0 */,
				105		/* assign V1 = |CollectionTypeCS::ownedCollectionMultiplicity| */
			),
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_TYPE, 30/* TypeExpWithoutMultiplicityCS */,
		...
		serializationRules[24] = createSerializationRule("CurlyBracketedClauseCS-0", 9,
			createSerializationMatchSteps(
				49		/* assert |CurlyBracketedClauseCS::value| == 0 */,
				143		/* check-rule essentialoclcs::CurlyBracketedClauseCS.ownedParts : ShadowPartCS */,
				71		/* assign V0 = (|CurlyBracketedClauseCS::ownedParts| > 0) */,
				100		/* assign V1 = (|CurlyBracketedClauseCS::ownedParts| - 1) */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.CURLY_BRACKETED_CLAUSE_CS__OWNED_PARTS, 22/* ShadowPartCS */,
					(67/*ShadowPartCS*/ << 4) | 2 /*[*]*/
				)
			});
		// EssentialOCL::ElseIfThenExpCS-0(essentialoclcs::IfThenExpCS): { "elseif" ownedCondition=ExpCS "then" ownedThenExpression=ExpCS }
		serializationRules[25] = createSerializationRule("ElseIfThenExpCS-0", 13,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				148		/* check-rule essentialoclcs::IfThenExpCS.ownedCondition : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				149		/* check-rule essentialoclcs::IfThenExpCS.ownedThenExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				11		/* assert (|IfThenExpCS::ownedThenExpression| - 1) == 0 */,
				10		/* assert (|IfThenExpCS::ownedCondition| - 1) == 0 */
			),
			createSerializationSteps(
				129		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				95		/* 'elseif' || soft-space value soft-space */,
				12		/* IfThenExpCS::ownedCondition=ExpCS || value */,
				105		/* 'then' || soft-space value soft-space */,
		...
		serializationRules[26] = createSerializationRule("ExpCS-18", 20,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				150		/* check-rule essentialoclcs::InfixExpCS.ownedLeft : BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				166		/* check-rule essentialoclcs::OperatorExpCS.ownedRight : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				33		/* assert (|OperatorExpCS::ownedRight| - 1) == 0 */,
				23		/* assert (|NamedElementCS::name| - 1) == 0 */,
				12		/* assert (|InfixExpCS::ownedLeft| - 1) == 0 */
			),
			createSerializationSteps(
				...
				130		/* NamedElementCS::name=BinaryOperatorName || soft-space value soft-space */,
				138		/* OperatorExpCS::ownedRight=ExpCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(EssentialOCLCSPackage.Literals.INFIX_EXP_CS__OWNED_LEFT, 20/* PrefixedPrimaryExpCS */,
		...
		serializationRules[27] = createSerializationRule("IfExpCS-0", 25,
			createSerializationMatchSteps(
				50		/* assert |IfExpCS::isImplicit| == 0 */,
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				144		/* check-rule essentialoclcs::IfExpCS.ownedCondition : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				145		/* check-rule essentialoclcs::IfExpCS.ownedElseExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				146		/* check-rule essentialoclcs::IfExpCS.ownedIfThenExpressions : ElseIfThenExpCS */,
				147		/* check-rule essentialoclcs::IfExpCS.ownedThenExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				8		/* assert (|IfExpCS::ownedElseExpression| - 1) == 0 */,
				84		/* assign V0 = |IfExpCS::ownedIfThenExpressions| */,
				9		/* assert (|IfExpCS::ownedThenExpression| - 1) == 0 */,
				7		/* assert (|IfExpCS::ownedCondition| - 1) == 0 */
			...
			createSerializationSteps(
				129		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				98		/* 'if' || soft-space value soft-space */,
				11		/* IfExpCS::ownedCondition=ExpCS|PatternExpCS || value */,
				105		/* 'then' || soft-space value soft-space */,
				54		/* IfExpCS::ownedThenExpression=ExpCS || value */,
				110		/* V00*1-steps || value */,
				23		/* IfExpCS::ownedIfThenExpressions+=ElseIfThenExpCS || value */,
				94		/* 'else' || soft-space value soft-space */,
				15		/* IfExpCS::ownedElseExpression=ExpCS || value */,
				96		/* 'endif' || soft-space value soft-space */
			),
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_CONDITION, 17/* ExpCS,PatternExpCS */,
					(20/*ExpCS*/ << 4) | 0 /*[1]*/,
					(55/*PatternExpCS*/ << 4) | 0 /*[1]*/
				),
		...
		serializationRules[28] = createSerializationRule("InvalidLiteralExpCS-0", 27,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				100		/* 'invalid' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		// EssentialOCL::LambdaLiteralExpCS-0(essentialoclcs::LambdaLiteralExpCS): { "Lambda" "{" ownedExpressionCS=ExpCS "}" }
		serializationRules[29] = createSerializationRule("LambdaLiteralExpCS-0", 30,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				151		/* check-rule essentialoclcs::LambdaLiteralExpCS.ownedExpressionCS : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				13		/* assert (|LambdaLiteralExpCS::ownedExpressionCS| - 1) == 0 */
			),
			createSerializationSteps(
				129		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				90		/* 'Lambda' || soft-space value soft-space */,
				106		/* '{' || soft-space value push soft-new-line */,
		...
		serializationRules[30] = createSerializationRule("LetExpCS-0", 31,
			createSerializationMatchSteps(
				51		/* assert |LetExpCS::isImplicit| == 0 */,
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				152		/* check-rule essentialoclcs::LetExpCS.ownedInExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				153		/* check-rule essentialoclcs::LetExpCS.ownedVariables : LetVariableCS */,
				14		/* assert (|LetExpCS::ownedInExpression| - 1) == 0 */,
				72		/* assign V0 = (|LetExpCS::ownedVariables| - 1) */
			),
			createSerializationSteps(
				129		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				101		/* 'let' || soft-space value soft-space */,
				66		/* LetExpCS::ownedVariables+=LetVariableCS || value */,
				113		/* V00*2-steps || value */,
				83		/* ',' || no-space value soft-space */,
				66		/* LetExpCS::ownedVariables+=LetVariableCS || value */,
				99		/* 'in' || soft-space value soft-space */,
		...
		serializationRules[31] = createSerializationRule("LetVariableCS-0", 32,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				178		/* check-rule essentialoclcs::VariableCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				154		/* check-rule essentialoclcs::LetVariableCS.ownedRoundBracketedClause : RoundBracketedClauseCS */,
				179		/* check-rule essentialoclcs::VariableCS.ownedType : TypeExpCS */,
				46		/* assert (|VariableCS::ownedInitExpression| - 1) == 0 */,
				111		/* assign V1 = |VariableCS::ownedType| */,
				85		/* assign V0 = |LetVariableCS::ownedRoundBracketedClause| */,
			...
			createSerializationSteps(
				129		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				132		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				109		/* V00*1-steps || value */,
				50		/* LetVariableCS::ownedRoundBracketedClause=RoundBracketedClauseCS || value */,
				121		/* V01*2-steps || value */,
				85		/* ':' || soft-space value soft-space */,
				63		/* VariableCS::ownedType=TypeExpCS || value */,
				88		/* '=' || soft-space value soft-space */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.LET_VARIABLE_CS__OWNED_ROUND_BRACKETED_CLAUSE, 21/* RoundBracketedClauseCS */,
		...
		serializationRules[32] = createSerializationRule("MapLiteralExpCS-0", 35,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				155		/* check-rule essentialoclcs::MapLiteralExpCS.ownedParts : MapLiteralPartCS */,
				156		/* check-rule essentialoclcs::MapLiteralExpCS.ownedType : MapTypeCS */,
				15		/* assert (|MapLiteralExpCS::ownedType| - 1) == 0 */,
				73		/* assign V0 = (|MapLiteralExpCS::ownedParts| > 0) */,
				101		/* assign V1 = (|MapLiteralExpCS::ownedParts| - 1) */
			),
		...
		serializationRules[33] = createSerializationRule("MapLiteralPartCS-0", 36,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				157		/* check-rule essentialoclcs::MapLiteralPartCS.ownedKey : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				158		/* check-rule essentialoclcs::MapLiteralPartCS.ownedValue : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				17		/* assert (|MapLiteralPartCS::ownedValue| - 1) == 0 */,
				16		/* assert (|MapLiteralPartCS::ownedKey| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[34] = createSerializationRule("MapTypeCS-0", 37,
			createSerializationMatchSteps(
				66		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				159		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				160		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
				86		/* assign V0 = |MapTypeCS::ownedValueType| */,
				19		/* assert (|MapTypeCS::ownedKeyType| - V0) == 0 */,
				18		/* assert (|MapTypeCS::name.'Map'| - 1) == 0 */
			),
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_KEY_TYPE, 29/* TypeExpCS */,
					(79/*TypeExpCS*/ << 4) | 1 /*[?]*/
				),
				createSerializationReference(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_VALUE_TYPE, 29/* TypeExpCS */,
					(79/*TypeExpCS*/ << 4) | 1 /*[?]*/
				)
			});
		// EssentialOCL::Model-0(essentialoclcs::ContextCS): ownedExpression=ExpCS
		serializationRules[35] = createSerializationRule("Model-0", 38,
			createSerializationMatchSteps(
				54		/* assert |NamedElementCS::name| == 0 */,
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				60		/* assert |RootCS::ownedImports| == 0 */,
				142		/* check-rule essentialoclcs::ContextCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				6		/* assert (|ContextCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[36] = createSerializationRule("NameExpCS-0", 43,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				129		/* check-rule essentialoclcs::AbstractNameExpCS.ownedCurlyBracketedClause : CurlyBracketedClauseCS */,
				130		/* check-rule essentialoclcs::AbstractNameExpCS.ownedPathName : PathNameCS */,
				131		/* check-rule essentialoclcs::AbstractNameExpCS.ownedRoundBracketedClause : RoundBracketedClauseCS */,
				132		/* check-rule essentialoclcs::AbstractNameExpCS.ownedSquareBracketedClauses : SquareBracketedClauseCS */,
				115		/* assign V3 = |AbstractNameExpCS::isPre.'@'| */,
				113		/* assign V2 = |AbstractNameExpCS::ownedCurlyBracketedClause| */,
				104		/* assign V1 = |AbstractNameExpCS::ownedRoundBracketedClause| */,
				80		/* assign V0 = |AbstractNameExpCS::ownedSquareBracketedClauses| */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_PATH_NAME, 15/* PathNameCS */,
					(54/*PathNameCS*/ << 4) | 0 /*[1]*/
				),
				createSerializationReference(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_ROUND_BRACKETED_CLAUSE, 21/* RoundBracketedClauseCS */,
					(62/*RoundBracketedClauseCS*/ << 4) | 1 /*[?]*/
				),
				createSerializationReference(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_SQUARE_BRACKETED_CLAUSES, 23/* SquareBracketedClauseCS */,
					(69/*SquareBracketedClauseCS*/ << 4) | 2 /*[*]*/
				)
			});
		// EssentialOCL::NavigatingArgCS-0(essentialoclcs::NavigatingArgCS): { ":" ownedType=TypeExpCS }
		serializationRules[37] = createSerializationRule("NavigatingArgCS-0", 44,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				55		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				56		/* assert |NavigatingArgCS::ownedInitExpression| == 0 */,
				57		/* assert |NavigatingArgCS::ownedNameExpression| == 0 */,
				59		/* assert |NavigatingArgCS::prefix| == 0 */,
				164		/* check-rule essentialoclcs::NavigatingArgCS.ownedType : TypeExpCS */,
				27		/* assert (|NavigatingArgCS::ownedType| - 1) == 0 */
			),
			createSerializationSteps(
				129		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_TYPE, 29/* TypeExpCS */,
					(79/*TypeExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		...
		serializationRules[38] = createSerializationRule("NavigatingArgCS-1", 44,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				59		/* assert |NavigatingArgCS::prefix| == 0 */,
				161		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
				162		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				163		/* check-rule essentialoclcs::NavigatingArgCS.ownedNameExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				164		/* check-rule essentialoclcs::NavigatingArgCS.ownedType : TypeExpCS */,
				107		/* assign V1 = |NavigatingArgCS::ownedInitExpression| */,
				88		/* assign V0 = |NavigatingArgCS::ownedCoIterator| */,
				27		/* assert (|NavigatingArgCS::ownedType| - 1) == 0 */,
		...
		serializationRules[39] = createSerializationRule("NavigatingArgCS-2", 44,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				58		/* assert |NavigatingArgCS::ownedType| == 0 */,
				59		/* assert |NavigatingArgCS::prefix| == 0 */,
		...
		serializationRules[40] = createSerializationRule("NavigatingArgCS-3", 44,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				59		/* assert |NavigatingArgCS::prefix| == 0 */,
				161		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
		...
		serializationRules[41] = createSerializationRule("NavigatingArgCS-4", 44,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				55		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				56		/* assert |NavigatingArgCS::ownedInitExpression| == 0 */,
		...
		serializationRules[42] = createSerializationRule("NavigatingBarArgCS-0", 46,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				55		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				162		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		serializationRules[43] = createSerializationRule("NavigatingCommaArgCS-0", 47,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				161		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
				162		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		serializationRules[44] = createSerializationRule("NavigatingCommaArgCS-1", 47,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				58		/* assert |NavigatingArgCS::ownedType| == 0 */,
				161		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
		...
		serializationRules[45] = createSerializationRule("NavigatingCommaArgCS-2", 47,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				161		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
				162		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		serializationRules[46] = createSerializationRule("NavigatingCommaArgCS-3", 47,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				55		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				56		/* assert |NavigatingArgCS::ownedInitExpression| == 0 */,
		...
		serializationRules[47] = createSerializationRule("NavigatingSemiArgCS-0", 48,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				55		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				162		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		serializationRules[48] = createSerializationRule("NestedExpCS-0", 50,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				165		/* check-rule essentialoclcs::NestedExpCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				31		/* assert (|NestedExpCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
				129		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
		...
		serializationRules[49] = createSerializationRule("NullLiteralExpCS-0", 52,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				102		/* 'null' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		// EssentialOCL::NumberLiteralExpCS-0(essentialoclcs::NumberLiteralExpCS): symbol=NUMBER_LITERAL
		serializationRules[50] = createSerializationRule("NumberLiteralExpCS-0", 53,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				32		/* assert (|NumberLiteralExpCS::symbol| - 1) == 0 */
			),
		...
		serializationRules[51] = createSerializationRule("PatternExpCS-0", 55,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				169		/* check-rule essentialoclcs::PatternExpCS.ownedPatternType : TypeExpCS */,
				36		/* assert (|PatternExpCS::ownedPatternType| - 1) == 0 */,
				91		/* assign V0 = |PatternExpCS::patternVariableName| */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS__OWNED_PATTERN_TYPE, 29/* TypeExpCS */,
					(79/*TypeExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::PrefixedLetExpCS-1(essentialoclcs::PrefixExpCS): { name=UnaryOperatorName ownedRight=PrefixedLetExpCS }
		serializationRules[52] = createSerializationRule("PrefixedLetExpCS-1", 56,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				168		/* check-rule essentialoclcs::OperatorExpCS.ownedRight : LetExpCS|PrefixedLetExpCS */,
				33		/* assert (|OperatorExpCS::ownedRight| - 1) == 0 */,
				23		/* assert (|NamedElementCS::name| - 1) == 0 */
			),
			createSerializationSteps(
				129		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				131		/* NamedElementCS::name=UnaryOperatorName || soft-space value soft-space */,
				139		/* OperatorExpCS::ownedRight=PrefixedLetExpCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 18/* PrefixedLetExpCS */,
		...
		serializationRules[53] = createSerializationRule("PrefixedPrimaryExpCS-15", 57,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				167		/* check-rule essentialoclcs::OperatorExpCS.ownedRight : BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				33		/* assert (|OperatorExpCS::ownedRight| - 1) == 0 */,
				23		/* assert (|NamedElementCS::name| - 1) == 0 */
			),
			createSerializationSteps(
				129		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				131		/* NamedElementCS::name=UnaryOperatorName || soft-space value soft-space */,
				140		/* OperatorExpCS::ownedRight=PrefixedPrimaryExpCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 20/* PrefixedPrimaryExpCS */,
					(57/*PrefixedPrimaryExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::PrimitiveTypeCS-0(basecs::PrimitiveTypeRefCS): name=PrimitiveTypeIdentifier
		serializationRules[54] = createSerializationRule("PrimitiveTypeCS-0", 60,
			createSerializationMatchSteps(
				66		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				37		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
			),
		...
		serializationRules[55] = createSerializationRule("RoundBracketedClauseCS-0", 62,
			null,	// run-time resolution using SerializationSteps
			createSerializationSteps(
				79		/* '(' || no-space value no-space */,
				114		/* V00*3-steps || value */,
				133		/* RoundBracketedClauseCS::ownedArguments+=NavigatingArgCS || value */,
				120		/* V01*1-steps || value */,
				134		/* RoundBracketedClauseCS::ownedArguments+=NavigatingCommaArgCS|NavigatingSemiArgCS|NavigatingBarArgCS || value */,
				80		/* ')' || no-space value */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[56] = createSerializationRule("SelfExpCS-0", 66,
			createSerializationMatchSteps(
				61		/* assert |SelfExpCS::name| == 0 */,
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				104		/* 'self' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		...
		serializationRules[57] = createSerializationRule("ShadowPartCS-0", 67,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				170		/* check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				38		/* assert (|ShadowPartCS::ownedInitExpression| - 1) == 0 */,
				39		/* assert (|ShadowPartCS::referredProperty| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 17/* ExpCS,PatternExpCS */,
					(20/*ExpCS*/ << 4) | 0 /*[1]*/,
					(55/*PatternExpCS*/ << 4) | 0 /*[1]*/
				),
		...
		serializationRules[58] = createSerializationRule("ShadowPartCS-1", 67,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				62		/* assert |ShadowPartCS::referredProperty| == 0 */,
				171		/* check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : StringLiteralExpCS */,
				38		/* assert (|ShadowPartCS::ownedInitExpression| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 24/* StringLiteralExpCS */,
					(71/*StringLiteralExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::SimplePathNameCS-0(basecs::PathNameCS): ownedPathElements+=FirstPathElementCS
		serializationRules[59] = createSerializationRule("SimplePathNameCS-0", 68,
			createSerializationMatchSteps(
				117		/* check-rule basecs::PathNameCS.ownedPathElements : FirstPathElementCS */,
				35		/* assert (|PathNameCS::ownedPathElements| - 1) == 0 */
			),
			createSerializationSteps(
				135		/* PathNameCS::ownedPathElements+=FirstPathElementCS || value */
		...
		serializationRules[60] = createSerializationRule("SquareBracketedClauseCS-0", 69,
			createSerializationMatchSteps(
				172		/* check-rule essentialoclcs::SquareBracketedClauseCS.ownedTerms : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				74		/* assign V0 = (|SquareBracketedClauseCS::ownedTerms| - 1) */
			),
			createSerializationSteps(
				92		/* '[' || no-space value no-space */,
		...
		serializationRules[61] = createSerializationRule("StringLiteralExpCS-0", 71,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				92		/* assign V0 = |StringLiteralExpCS::segments| */
			),
			createSerializationSteps(
				111		/* V00*1-steps || value */,
		...
		serializationRules[62] = createSerializationRule("TupleLiteralExpCS-0", 75,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				173		/* check-rule essentialoclcs::TupleLiteralExpCS.ownedParts : TupleLiteralPartCS */,
				77		/* assign V0 = (|TupleLiteralExpCS::ownedParts| - 1) */
			),
			createSerializationSteps(
				129		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				91		/* 'Tuple' || soft-space value soft-space */,
				106		/* '{' || soft-space value push soft-new-line */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.TUPLE_LITERAL_EXP_CS__OWNED_PARTS, 27/* TupleLiteralPartCS */,
		...
		serializationRules[63] = createSerializationRule("TupleLiteralPartCS-0", 76,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				178		/* check-rule essentialoclcs::VariableCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				179		/* check-rule essentialoclcs::VariableCS.ownedType : TypeExpCS */,
	...
	private void initSerializationRules1() {
		...
		serializationRules[64] = createSerializationRule("TuplePartCS-0", 77,
			createSerializationMatchSteps(
				64		/* assert |TypedElementCS::isOptional| == 0 */,
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				65		/* assert |TypedElementCS::qualifiers| == 0 */,
				124		/* check-rule basecs::TypedElementCS.ownedType : TypeExpCS */,
				44		/* assert (|TypedElementCS::ownedType| - 1) == 0 */,
				23		/* assert (|NamedElementCS::name| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE, 29/* TypeExpCS */,
					(79/*TypeExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::TupleTypeCS-0(basecs::TupleTypeCS): { name="Tuple" { "(" { ownedParts+=TuplePartCS { "," ownedParts+=TuplePartCS }[*] }[?] ")" }[?] }
		serializationRules[65] = createSerializationRule("TupleTypeCS-0", 78,
			createSerializationMatchSteps(
				66		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				122		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				41		/* assert (|TupleTypeCS::name.'Tuple'| - 1) == 0 */,
				78		/* assign V0 = (|TupleTypeCS::ownedParts| > 0) */,
				102		/* assign V1 = (|TupleTypeCS::ownedParts| > 0) */,
				112		/* assign V2 = (|TupleTypeCS::ownedParts| - 1) */
			...
			createSerializationSteps(
				...
				118		/* V00*7-steps || value */,
				79		/* '(' || no-space value no-space */,
				124		/* V01*4-steps || value */,
				43		/* TupleTypeCS::ownedParts+=TuplePartCS || value */,
				126		/* V02*2-steps || value */,
				83		/* ',' || no-space value soft-space */,
				43		/* TupleTypeCS::ownedParts+=TuplePartCS || value */,
				80		/* ')' || no-space value */
			),
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.TUPLE_TYPE_CS__OWNED_PARTS, 28/* TuplePartCS */,
					(77/*TuplePartCS*/ << 4) | 2 /*[*]*/
				)
			});
		// EssentialOCL::TypeExpCS-0(basecs::PrimitiveTypeRefCS): { name=PrimitiveTypeIdentifier ownedMultiplicity=MultiplicityCS[?] }
		serializationRules[66] = createSerializationRule("TypeExpCS-0", 79,
			createSerializationMatchSteps(
				125		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				94		/* assign V0 = |TypedRefCS::ownedMultiplicity| */,
				37		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[67] = createSerializationRule("TypeExpCS-1", 79,
			createSerializationMatchSteps(
				140		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				125		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				141		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
		...
		serializationRules[68] = createSerializationRule("TypeExpCS-2", 79,
			createSerializationMatchSteps(
				159		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				125		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				160		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
		...
		serializationRules[69] = createSerializationRule("TypeExpCS-3", 79,
			createSerializationMatchSteps(
				175		/* check-rule essentialoclcs::TypeNameExpCS.ownedCurlyBracketedClause : CurlyBracketedClauseCS */,
				125		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				176		/* check-rule essentialoclcs::TypeNameExpCS.ownedPathName : PathNameCS */,
				177		/* check-rule essentialoclcs::TypeNameExpCS.ownedPatternGuard : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				114		/* assign V2 = |TypedRefCS::ownedMultiplicity| */,
				93		/* assign V0 = |TypeNameExpCS::ownedCurlyBracketedClause| */,
				43		/* assert (|TypeNameExpCS::ownedPathName| - 1) == 0 */,
				109		/* assign V1 = |TypeNameExpCS::ownedPatternGuard| */
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_PATH_NAME, 15/* PathNameCS */,
					(54/*PathNameCS*/ << 4) | 0 /*[1]*/
				),
		...
		serializationRules[70] = createSerializationRule("TypeExpCS-4", 79,
			createSerializationMatchSteps(
				48		/* assert |CollectionPatternCS::ownedPatternGuard| == 0 */,
				125		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				138		/* check-rule essentialoclcs::CollectionPatternCS.ownedParts : PatternExpCS */,
		...
		serializationRules[71] = createSerializationRule("TypeExpCS-5", 79,
			createSerializationMatchSteps(
				125		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				122		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				116		/* assign V3 = |TypedRefCS::ownedMultiplicity| */,
		...
		serializationRules[72] = createSerializationRule("TypeLiteralExpCS-0", 82,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				63		/* assert |TypeLiteralExpCS::ownedPathName| == 0 */,
				174		/* check-rule essentialoclcs::TypeLiteralExpCS.ownedType : TypeLiteralWithMultiplicityCS */,
				42		/* assert (|TypeLiteralExpCS::ownedType| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.TYPE_LITERAL_EXP_CS__OWNED_TYPE, 32/* TypeLiteralWithMultiplicityCS */,
		...
		serializationRules[73] = createSerializationRule("TypeLiteralWithMultiplicityCS-0", 83,
			createSerializationMatchSteps(
				125		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				94		/* assign V0 = |TypedRefCS::ownedMultiplicity| */,
				37		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
		...
		serializationRules[74] = createSerializationRule("TypeLiteralWithMultiplicityCS-1", 83,
			createSerializationMatchSteps(
				140		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				125		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				141		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
		...
		serializationRules[75] = createSerializationRule("TypeLiteralWithMultiplicityCS-2", 83,
			createSerializationMatchSteps(
				159		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				125		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				160		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
		...
		serializationRules[76] = createSerializationRule("TypeLiteralWithMultiplicityCS-3", 83,
			createSerializationMatchSteps(
				125		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				122		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				116		/* assign V3 = |TypedRefCS::ownedMultiplicity| */,
		...
		serializationRules[77] = createSerializationRule("TypeNameExpCS-0", 84,
			createSerializationMatchSteps(
				66		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				175		/* check-rule essentialoclcs::TypeNameExpCS.ownedCurlyBracketedClause : CurlyBracketedClauseCS */,
				176		/* check-rule essentialoclcs::TypeNameExpCS.ownedPathName : PathNameCS */,
		...
		serializationRules[78] = createSerializationRule("URIFirstPathElementCS-0", 91,
			createSerializationMatchSteps(
				34		/* assert (|PathElementCS::referredElement| - 1) == 0 */
			),
			createSerializationSteps(
				141		/* PathElementCS::referredElement=URI || soft-space value soft-space */
			),
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, -1
				)
		...
		serializationRules[79] = createSerializationRule("URIFirstPathElementCS-1", 91,
			createSerializationMatchSteps(
				34		/* assert (|PathElementCS::referredElement| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[80] = createSerializationRule("URIPathNameCS-0", 92,
			null,	// run-time resolution using SerializationSteps
			createSerializationSteps(
				137		/* PathNameCS::ownedPathElements+=URIFirstPathElementCS || value */,
				113		/* V00*2-steps || value */,
				86		/* '::' || no-space value no-space */,
				136		/* PathNameCS::ownedPathElements+=NextPathElementCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 38/* NextPathElementCS,URIFirstPathElementCS */,
					(51/*NextPathElementCS*/ << 4) | 2 /*[*]*/,
					(91/*URIFirstPathElementCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::UnlimitedNaturalLiteralExpCS-0(essentialoclcs::UnlimitedNaturalLiteralExpCS): "*"
		serializationRules[81] = createSerializationRule("UnlimitedNaturalLiteralExpCS-0", 94,
			createSerializationMatchSteps(
				52		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				81		/* '*' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
	}
	...
	private void initSerializationSteps() {
		// 0: MultiplicityCS::isNullFree?='|1' || no-space value no-space
		serializationSteps[0] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.MULTIPLICITY_CS__IS_NULL_FREE, 8 /* '|1' */, 3);
		// 1: AbstractNameExpCS::isPre?='@' || soft-space value soft-space
		serializationSteps[1] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__IS_PRE, 3 /* '@' */, 6);
		// 2: MultiplicityBoundsCS::lowerBound=LOWER || soft-space value soft-space
		serializationSteps[2] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.MULTIPLICITY_BOUNDS_CS__LOWER_BOUND, 29 /*LOWER*/, 6);
		// 3: CollectionTypeCS::name=CollectionTypeIdentifier || soft-space value soft-space
		serializationSteps[3] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__NAME, 8 /*CollectionTypeIdentifier*/, 6);
		// 4: MapTypeCS::name='Map' || soft-space value soft-space
		serializationSteps[4] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__NAME, 4 /* 'Map' */, 6);
		// 5: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier || soft-space value soft-space
		serializationSteps[5] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PRIMITIVE_TYPE_REF_CS__NAME, 61 /*PrimitiveTypeIdentifier*/, 6);
		// 6: TupleTypeCS::name='Tuple' || soft-space value soft-space
		serializationSteps[6] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.TUPLE_TYPE_CS__NAME, 5 /* 'Tuple' */, 6);
		// 7: TemplateParameterSubstitutionCS::ownedActualParameter=TypeRefCS || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		...
		// 67: PatternExpCS::patternVariableName=UnrestrictedName || soft-space value soft-space
		serializationSteps[67] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS__PATTERN_VARIABLE_NAME, 96 /*UnrestrictedName*/, 6);
		// 68: NavigatingArgCS::prefix=';' || no-space value soft-new-line
		serializationSteps[68] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__PREFIX, 2 /* ';' */, 4);
		// 69: NavigatingArgCS::prefix=',' || no-space value soft-space
		serializationSteps[69] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__PREFIX, 1 /* ',' */, 5);
		// 70: NavigatingArgCS::prefix='|' || soft-space value soft-space
		serializationSteps[70] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__PREFIX, 7 /* '|' */, 6);
		// 71: ShadowPartCS::referredProperty=UnrestrictedName || soft-space value soft-space
		serializationSteps[71] = createSerializationStepCrossReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__REFERRED_PROPERTY, getCrossReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__REFERRED_PROPERTY, "UnrestrictedName"), 96, 6);
		// 72: CollectionPatternCS::restVariableName=Identifier || soft-space value soft-space
		serializationSteps[72] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__REST_VARIABLE_NAME, 24 /*Identifier*/, 6);
		// 73: StringLiteralExpCS::segments+=StringLiteral || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		...
		// 74: MultiplicityStringCS::stringBounds='*|+|?' || soft-space value soft-space
		serializationSteps[74] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.MULTIPLICITY_STRING_CS__STRING_BOUNDS, 0 /* '*|+|?' */, 6);
		// 75: BooleanLiteralExpCS::symbol='false|true' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		...
		// 77: MultiplicityBoundsCS::upperBound=UPPER || soft-space value soft-space
		serializationSteps[77] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.MULTIPLICITY_BOUNDS_CS__UPPER_BOUND, 89 /*UPPER*/, 6);
		// 78: '&&' || soft-space value soft-space
		serializationSteps[78] = createSerializationStepKeyword("&&", 6);
		// 79: '(' || no-space value no-space
		serializationSteps[79] = createSerializationStepKeyword("(", 3);
		// 80: ')' || no-space value
		serializationSteps[80] = createSerializationStepKeyword(")", 1);
		// 81: '*' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[81] = createSerializationStepKeyword("*", 2);
		// 82: '++' || soft-space value soft-space
		serializationSteps[82] = createSerializationStepKeyword("++", 6);
		// 83: ',' || no-space value soft-space
		serializationSteps[83] = createSerializationStepKeyword(",", 5);
		// 84: '..' || no-space value no-space
		serializationSteps[84] = createSerializationStepKeyword("..", 3);
		// 85: ':' || soft-space value soft-space
		serializationSteps[85] = createSerializationStepKeyword(":", 6);
		// 86: '::' || no-space value no-space
		serializationSteps[86] = createSerializationStepKeyword("::", 3);
		// 87: '<-' || soft-space value soft-space
		serializationSteps[87] = createSerializationStepKeyword("<-", 6);
		// 88: '=' || soft-space value soft-space
		serializationSteps[88] = createSerializationStepKeyword("=", 6);
		// 89: '?' || soft-space value soft-space
		serializationSteps[89] = createSerializationStepKeyword("?", 6);
		// 90: 'Lambda' || soft-space value soft-space
		serializationSteps[90] = createSerializationStepKeyword("Lambda", 6);
		// 91: 'Tuple' || soft-space value soft-space
		serializationSteps[91] = createSerializationStepKeyword("Tuple", 6);
		// 92: '[' || no-space value no-space
		serializationSteps[92] = createSerializationStepKeyword("[", 3);
		// 93: ']' || no-space value
		serializationSteps[93] = createSerializationStepKeyword("]", 1);
		// 94: 'else' || soft-space value soft-space
		serializationSteps[94] = createSerializationStepKeyword("else", 6);
		// 95: 'elseif' || soft-space value soft-space
		serializationSteps[95] = createSerializationStepKeyword("elseif", 6);
		// 96: 'endif' || soft-space value soft-space
		serializationSteps[96] = createSerializationStepKeyword("endif", 6);
		// 97: 'extends' || soft-space value soft-space
		serializationSteps[97] = createSerializationStepKeyword("extends", 6);
		// 98: 'if' || soft-space value soft-space
		serializationSteps[98] = createSerializationStepKeyword("if", 6);
		// 99: 'in' || soft-space value soft-space
		serializationSteps[99] = createSerializationStepKeyword("in", 6);
		// 100: 'invalid' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[100] = createSerializationStepKeyword("invalid", 2);
		// 101: 'let' || soft-space value soft-space
		serializationSteps[101] = createSerializationStepKeyword("let", 6);
		// 102: 'null' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[102] = createSerializationStepKeyword("null", 2);
		// 103: 'pre' || soft-space value soft-space
		serializationSteps[103] = createSerializationStepKeyword("pre", 6);
		// 104: 'self' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[104] = createSerializationStepKeyword("self", 2);
		// 105: 'then' || soft-space value soft-space
		serializationSteps[105] = createSerializationStepKeyword("then", 6);
		// 106: '{' || soft-space value push soft-new-line
		serializationSteps[106] = createSerializationStepKeyword("{", 8);
		// 107: '|?' || no-space value no-space
		serializationSteps[107] = createSerializationStepKeyword("|?", 3);
		// 108: '}' || pop soft-space value soft-new-line
		serializationSteps[108] = createSerializationStepKeyword("}", 7);
		// 109: V00*1-steps || value
		serializationSteps[109] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 1, 0);
		// 110: V00*1-steps || value
		serializationSteps[110] = createSerializationStepSequence((0/*V0*/ << 4) | 2/*[*]*/, 1, 0);
		// 111: V00*1-steps || value
		serializationSteps[111] = createSerializationStepSequence((0/*V0*/ << 4) | 3/*[+]*/, 1, 0);
		// 112: V00*2-steps || value
		serializationSteps[112] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 2, 0);
		// 113: V00*2-steps || value
		serializationSteps[113] = createSerializationStepSequence((0/*V0*/ << 4) | 2/*[*]*/, 2, 0);
		// 114: V00*3-steps || value
		serializationSteps[114] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 3, 0);
		// 115: V00*4-steps || value
		serializationSteps[115] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 4, 0);
		// 116: V00*5-steps || value
		serializationSteps[116] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 5, 0);
		// 117: V00*6-steps || value
		serializationSteps[117] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 6, 0);
		// 118: V00*7-steps || value
		serializationSteps[118] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 7, 0);
		// 119: V01*1-steps || value
		serializationSteps[119] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 1, 0);
		// 120: V01*1-steps || value
		serializationSteps[120] = createSerializationStepSequence((1/*V1*/ << 4) | 2/*[*]*/, 1, 0);
		// 121: V01*2-steps || value
		serializationSteps[121] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 2, 0);
		// 122: V01*2-steps || value
		serializationSteps[122] = createSerializationStepSequence((1/*V1*/ << 4) | 2/*[*]*/, 2, 0);
		// 123: V01*3-steps || value
		serializationSteps[123] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 3, 0);
		// 124: V01*4-steps || value
		serializationSteps[124] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 4, 0);
		// 125: V02*1-steps || value
		serializationSteps[125] = createSerializationStepSequence((2/*V2*/ << 4) | 1/*[?]*/, 1, 0);
		// 126: V02*2-steps || value
		serializationSteps[126] = createSerializationStepSequence((2/*V2*/ << 4) | 2/*[*]*/, 2, 0);
		// 127: V03*1-steps || value
		serializationSteps[127] = createSerializationStepSequence((3/*V3*/ << 4) | 1/*[?]*/, 1, 0);
		// 128: V03*2-steps || value
		serializationSteps[128] = createSerializationStepSequence((3/*V3*/ << 4) | 1/*[?]*/, 2, 0);
		// 129: wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[129] = createSerializationStepWrapper(2);
		// 130: NamedElementCS::name=BinaryOperatorName || soft-space value soft-space
		serializationSteps[130] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 1 /*BinaryOperatorName*/, 6);
		// 131: NamedElementCS::name=UnaryOperatorName || soft-space value soft-space
		serializationSteps[131] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 93 /*UnaryOperatorName*/, 6);
		// 132: NamedElementCS::name=UnrestrictedName || soft-space value soft-space
		serializationSteps[132] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 96 /*UnrestrictedName*/, 6);
		// 133: RoundBracketedClauseCS::ownedArguments+=NavigatingArgCS || value
		serializationSteps[133] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.ROUND_BRACKETED_CLAUSE_CS__OWNED_ARGUMENTS, 44 /*NavigatingArgCS*/, 0);
		// 134: RoundBracketedClauseCS::ownedArguments+=NavigatingCommaArgCS|NavigatingSemiArgCS|NavigatingBarArgCS || value
		serializationSteps[134] = createSerializationStepAssigns(EssentialOCLCSPackage.Literals.ROUND_BRACKETED_CLAUSE_CS__OWNED_ARGUMENTS, -1, new int[] { 47/*NavigatingCommaArgCS*/,48/*NavigatingSemiArgCS*/,46/*NavigatingBarArgCS*/}, 0);
		// 135: PathNameCS::ownedPathElements+=FirstPathElementCS || value
		serializationSteps[135] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 21 /*FirstPathElementCS*/, 0);
		// 136: PathNameCS::ownedPathElements+=NextPathElementCS || value
		serializationSteps[136] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 51 /*NextPathElementCS*/, 0);
		// 137: PathNameCS::ownedPathElements+=URIFirstPathElementCS || value
		serializationSteps[137] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 91 /*URIFirstPathElementCS*/, 0);
		// 138: OperatorExpCS::ownedRight=ExpCS || value
		serializationSteps[138] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 20 /*ExpCS*/, 0);
		// 139: OperatorExpCS::ownedRight=PrefixedLetExpCS || value
		serializationSteps[139] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 56 /*PrefixedLetExpCS*/, 0);
		// 140: OperatorExpCS::ownedRight=PrefixedPrimaryExpCS || value
		serializationSteps[140] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 57 /*PrefixedPrimaryExpCS*/, 0);
		// 141: PathElementCS::referredElement=URI || soft-space value soft-space
		serializationSteps[141] = createSerializationStepCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, getCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, "URI"), 90, 6);
		// 142: PathElementCS::referredElement=UnreservedName || soft-space value soft-space
		serializationSteps[142] = createSerializationStepCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, getCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, "UnreservedName"), 95, 6);
		// 143: PathElementCS::referredElement=UnrestrictedName || soft-space value soft-space
		serializationSteps[143] = createSerializationStepCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, getCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, "UnrestrictedName"), 96, 6);
	}
}
