...
import org.eclipse.ocl.xtext.base.cs2as.BaseCSPostOrderVisitor;
...
public abstract class AbstractEssentialOCLCSPostOrderVisitor
	extends BaseCSPostOrderVisitor
	implements EssentialOCLCSVisitor<Continuation<?>>
{
	 ...
	 */
	protected AbstractEssentialOCLCSPostOrderVisitor(@NonNull CS2ASConversion context) {
		super(context);
	}
