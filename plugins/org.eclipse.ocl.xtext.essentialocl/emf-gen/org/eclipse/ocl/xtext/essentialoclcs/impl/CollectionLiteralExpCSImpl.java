...
public class CollectionLiteralExpCSImpl
	 ...
	 * @ordered
	 */
	public static final int COLLECTION_LITERAL_EXP_CS_FEATURE_COUNT = LiteralExpCSImpl.LITERAL_EXP_CS_FEATURE_COUNT + 2;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOwnedType(CollectionTypeCS newOwnedType,
	...
	public EList<CollectionLiteralPartCS> getOwnedParts() {
		if (ownedParts == null)
		{
			ownedParts = new EObjectContainmentEList<CollectionLiteralPartCS>(CollectionLiteralPartCS.class, this, ModelElementCSImpl.MODEL_ELEMENT_CS_FEATURE_COUNT + 8);
		}
		return ownedParts;
	}
