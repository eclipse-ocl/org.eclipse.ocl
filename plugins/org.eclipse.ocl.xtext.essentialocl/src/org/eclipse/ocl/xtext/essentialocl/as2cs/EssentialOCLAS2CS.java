...
public class EssentialOCLAS2CS extends BaseAS2CS
{
	...
	public EssentialOCLAS2CS(@NonNull Map<@NonNull ? extends BaseCSResource, @NonNull ? extends ASResource> cs2asResourceMap, @NonNull EnvironmentFactory environmentFactory) {
