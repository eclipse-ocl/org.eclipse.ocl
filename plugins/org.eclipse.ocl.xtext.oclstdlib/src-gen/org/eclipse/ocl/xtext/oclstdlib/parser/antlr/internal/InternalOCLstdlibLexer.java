...
public class InternalOCLstdlibLexer extends Lexer {
    ...
    public final void mRULE_ESCAPED_CHARACTER() throws RecognitionException {
        try {
            // InternalOCLstdlib.g:9575:33: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) )
            // InternalOCLstdlib.g:9575:35: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
            {
            match('\\');
    ...
    public final void mRULE_LETTER_CHARACTER() throws RecognitionException {
        try {
            // InternalOCLstdlib.g:9577:32: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) )
            // InternalOCLstdlib.g:9577:34: ( 'a' .. 'z' | 'A' .. 'Z' | '_' )
            {
    ...
    public final void mRULE_DOUBLE_QUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOCLstdlib.g:9579:27: ( '\"' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalOCLstdlib.g:9579:29: '\"' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"');
            // InternalOCLstdlib.g:9579:33: ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )*
            loop1:
            do {
                int alt1=3;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalOCLstdlib.g:9579:34: RULE_ESCAPED_CHARACTER
            	    {
    ...
    public final void mRULE_SINGLE_QUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOCLstdlib.g:9581:27: ( '\\'' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            // InternalOCLstdlib.g:9581:29: '\\'' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
            {
            match('\'');
            // InternalOCLstdlib.g:9581:34: ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop2:
            do {
                int alt2=3;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalOCLstdlib.g:9581:35: RULE_ESCAPED_CHARACTER
            	    {
            	    mRULE_ESCAPED_CHARACTER();
    ...
    public final void mRULE_ML_SINGLE_QUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOCLstdlib.g:9583:30: ( '/\\'' ( options {greedy=false; } : . )* '\\'/' )
            // InternalOCLstdlib.g:9583:32: '/\\'' ( options {greedy=false; } : . )* '\\'/'
            {
            match("/'");

            // InternalOCLstdlib.g:9583:38: ( options {greedy=false; } : . )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_SIMPLE_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOCLstdlib.g:9585:16: ( RULE_LETTER_CHARACTER ( RULE_LETTER_CHARACTER | '0' .. '9' )* )
            // InternalOCLstdlib.g:9585:18: RULE_LETTER_CHARACTER ( RULE_LETTER_CHARACTER | '0' .. '9' )*
            {
            mRULE_LETTER_CHARACTER();
            // InternalOCLstdlib.g:9585:40: ( RULE_LETTER_CHARACTER | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_ESCAPED_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOCLstdlib.g:9587:17: ( '_' RULE_SINGLE_QUOTED_STRING )
            // InternalOCLstdlib.g:9587:19: '_' RULE_SINGLE_QUOTED_STRING
            {
            match('_');
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOCLstdlib.g:9589:10: ( ( '0' .. '9' )+ )
            // InternalOCLstdlib.g:9589:12: ( '0' .. '9' )+
            {
            // InternalOCLstdlib.g:9589:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalOCLstdlib.g:9589:13: '0' .. '9'
            	    {
            	    matchRange('0','9');
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOCLstdlib.g:9591:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalOCLstdlib.g:9591:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*");

            // InternalOCLstdlib.g:9591:24: ( options {greedy=false; } : . )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOCLstdlib.g:9593:17: ( '--' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalOCLstdlib.g:9593:19: '--' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("--");

            // InternalOCLstdlib.g:9593:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOCLstdlib.g:9595:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalOCLstdlib.g:9595:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalOCLstdlib.g:9595:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt10=0;
            loop10:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOCLstdlib.g:9597:16: ( . )
            // InternalOCLstdlib.g:9597:18: .
            {
            matchAny();
