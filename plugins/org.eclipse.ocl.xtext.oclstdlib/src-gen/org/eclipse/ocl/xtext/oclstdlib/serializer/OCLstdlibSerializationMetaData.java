...
public class OCLstdlibSerializationMetaData extends AbstractSerializationMetaData
{
	...
	private final @NonNull GrammarRuleVector @NonNull [] grammarRuleVectors = new @NonNull GrammarRuleVector[77];
	private final @NonNull SerializationMatchStep @NonNull [] serializationMatchSteps = new @NonNull SerializationMatchStep[298];
	private final @NonNull SerializationMatchTerm @NonNull [] serializationMatchTerms = new @NonNull SerializationMatchTerm[238];
	private final @NonNull SerializationRule @NonNull [] serializationRules = new @NonNull SerializationRule[119];
	...
	private void initEClassValues() {
		eClassValues[0] = new EClassValue(BaseCSPackage.Literals.ANNOTATION_CS,
			createSerializationRules(
				81 /* AnnotationCS-0: 'annotation' NamedElementCS::name=Identifier|SINGLE_QUOTED_STRING ('(' AnnotationElementCS::ownedDetails+=DetailCS (',' AnnotationElementCS::ownedDetails+=DetailCS)[V1:*] ')')[V0:?] ';' */,
				82 /* AnnotationCS-1: 'annotation' NamedElementCS::name=Identifier|SINGLE_QUOTED_STRING ('(' AnnotationElementCS::ownedDetails+=DetailCS (',' AnnotationElementCS::ownedDetails+=DetailCS)[V1:*] ')')[V0:?] '{' ModelElementCS::ownedAnnotations+=AnnotationElementCS '}' */
			),
		...
		eClassValues[5] = new EClassValue(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS,
			...
			new @NonNull EReference_TargetGrammarRuleVector [] {
				...
				createEReference_TargetGrammarRuleVector(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_TYPE,
					60) /* CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */
			}
		);
		...
		eClassValues[8] = new EClassValue(BaseCSPackage.Literals.DETAIL_CS,
			createSerializationRules(
				83 /* DetailCS-0: NamedElementCS::name=Name|SINGLE_QUOTED_STRING '=' (DetailCS::values+=SINGLE_QUOTED_STRING|ML_SINGLE_QUOTED_STRING)[V0:*] */
			), null
		);
		eClassValues[9] = new EClassValue(BaseCSPackage.Literals.DOCUMENTATION_CS,
			createSerializationRules(
				84 /* DocumentationCS-0: 'documentation' (DocumentationCS::value=SINGLE_QUOTED_STRING)[V0:?] ('(' AnnotationElementCS::ownedDetails+=DetailCS (',' AnnotationElementCS::ownedDetails+=DetailCS)[V2:*] ')')[V1:?] ';' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.ANNOTATION_ELEMENT_CS__OWNED_DETAILS,
					7) /* DetailCS */
		...
		eClassValues[10] = new EClassValue(EssentialOCLCSPackage.Literals.EXP_SPECIFICATION_CS,
			createSerializationRules(
				110 /* SpecificationCS-0: ExpSpecificationCS::ownedExpression=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[13] = new EClassValue(BaseCSPackage.Literals.IMPORT_CS,
			createSerializationRules(
				85 /* ImportCS-0: 'import' (NamedElementCS::name=Identifier ':')[V0:?] ImportCS::ownedPathName=URIPathNameCS (ImportCS::isAll?='::*')[V1:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[20] = new EClassValue(OCLstdlibCSPackage.Literals.LIB_CLASS_CS,
			createSerializationRules(
				90 /* LibClassCS-0: (StructuredClassCS::isAbstract?='abstract')[V0:?] 'type' NamedElementCS::name=AnyName (TemplateableElementCS::ownedSignature=TemplateSignatureCS)[V1:?] (':' LibClassCS::metaclassName=AnyName)[V2:?] ('conformsTo' StructuredClassCS::ownedSuperTypes+=TypedRefCS (',' StructuredClassCS::ownedSuperTypes+=TypedRefCS)[V4:*])[V3:?] '{' (StructuredClassCS::ownedOperations+=OperationCS)[V5:*] (StructuredClassCS::ownedProperties+=LibPropertyCS)[V6:*] (ClassCS::ownedConstraints+=InvCS)[V7:*] (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V8:*] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.MODEL_ELEMENT_CS__OWNED_ANNOTATIONS,
					8) /* AnnotationCS|AnnotationElementCS|DocumentationCS */,
		...
		eClassValues[21] = new EClassValue(OCLstdlibCSPackage.Literals.LIB_COERCION_CS,
			createSerializationRules(
				91 /* LibCoercionCS-0: 'coercion' NamedElementCS::name=Name '(' ')' ':' TypedElementCS::ownedType=TypedMultiplicityRefCS ('=>' JavaImplementationCS::implementation=SINGLE_QUOTED_STRING)[V0:?] ';' */,
				92 /* LibCoercionCS-1: 'coercion' NamedElementCS::name=Name '(' ')' ':' TypedElementCS::ownedType=TypedMultiplicityRefCS ('=>' JavaImplementationCS::implementation=SINGLE_QUOTED_STRING)[V0:?] '{' (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V1:*] (OperationCS::ownedPreconditions+=PostCS)[V2:*] (OperationCS::ownedPostconditions+=PreCS)[V3:*] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.MODEL_ELEMENT_CS__OWNED_ANNOTATIONS,
					8) /* AnnotationCS|AnnotationElementCS|DocumentationCS */,
		...
		eClassValues[22] = new EClassValue(OCLstdlibCSPackage.Literals.LIB_CONSTRAINT_CS,
			createSerializationRules(
				86 /* InvCS-0: ConstraintCS::stereotype='inv' (NamedElementCS::name=UnrestrictedName ('(' ConstraintCS::ownedMessageSpecification=SpecificationCS ')')[V1:?])[V0:?] ':' ConstraintCS::ownedSpecification=SpecificationCS ';' */,
				106 /* PostCS-0: ConstraintCS::stereotype='post' (NamedElementCS::name=UnrestrictedName ('(' ConstraintCS::ownedMessageSpecification=SpecificationCS ')')[V1:?])[V0:?] ':' ConstraintCS::ownedSpecification=SpecificationCS ';' */,
				107 /* PreCS-0: ConstraintCS::stereotype='pre' (NamedElementCS::name=UnrestrictedName ('(' ConstraintCS::ownedMessageSpecification=SpecificationCS ')')[V1:?])[V0:?] ':' ConstraintCS::ownedSpecification=SpecificationCS ';' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[25] = new EClassValue(OCLstdlibCSPackage.Literals.LIB_OPPOSITE_CS,
			createSerializationRules(
				97 /* LibOppositeCS-0: 'opposite' NamedElementCS::name=Name ':' TypedElementCS::ownedType=TypedMultiplicityRefCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE,
					63) /* TypedMultiplicityRefCS */
		...
		eClassValues[26] = new EClassValue(OCLstdlibCSPackage.Literals.LIB_PACKAGE_CS,
			createSerializationRules(
				98 /* LibPackageCS-0: 'library' NamedElementCS::name=Name (':' PackageCS::nsPrefix=Identifier '=' PackageCS::nsURI=URI)[V0:?] '{' ('precedence' (LibPackageCS::ownedPrecedences+=PrecedenceCS)[V2:+] ';')[V1:*] (PackageOwnerCS::ownedPackages+=PackageCS)[V3:*] (PackageCS::ownedClasses+=ClassCS)[V4:*] (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V5:*] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.MODEL_ELEMENT_CS__OWNED_ANNOTATIONS,
					8) /* AnnotationCS|AnnotationElementCS|DocumentationCS */,
		...
		eClassValues[27] = new EClassValue(OCLstdlibCSPackage.Literals.LIB_PROPERTY_CS,
			createSerializationRules(
				101 /* LibPropertyCS-0: (LibPropertyCS::isStatic?='static')[V0:?] 'property' NamedElementCS::name=Name ':' TypedElementCS::ownedType=TypedMultiplicityRefCS (LibPropertyCS::ownedOpposite=LibOppositeCS)[V1:?] ('=>' JavaImplementationCS::implementation=SINGLE_QUOTED_STRING)[V2:?] ';' */,
				102 /* LibPropertyCS-1: (LibPropertyCS::isStatic?='static')[V0:?] 'property' NamedElementCS::name=Name ':' TypedElementCS::ownedType=TypedMultiplicityRefCS (LibPropertyCS::ownedOpposite=LibOppositeCS)[V1:?] ('=>' JavaImplementationCS::implementation=SINGLE_QUOTED_STRING)[V2:?] '{' (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V3:*] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.MODEL_ELEMENT_CS__OWNED_ANNOTATIONS,
					8) /* AnnotationCS|AnnotationElementCS|DocumentationCS */,
		...
		eClassValues[28] = new EClassValue(OCLstdlibCSPackage.Literals.LIB_ROOT_PACKAGE_CS,
			createSerializationRules(
				103 /* Library-0: (RootCS::ownedImports+=ImportCS ';')[V0:*] (PackageOwnerCS::ownedPackages+=LibPackageCS)[V1:*] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[31] = new EClassValue(EssentialOCLCSPackage.Literals.MAP_TYPE_CS,
			createSerializationRules(
				...
				113 /* TypedMultiplicityRefCS-1: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V1:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[39] = new EClassValue(BaseCSPackage.Literals.PACKAGE_CS,
			createSerializationRules(
				104 /* PackageCS-0: 'package' NamedElementCS::name=Name (':' PackageCS::nsPrefix=Identifier '=' PackageCS::nsURI=URI)[V0:?] '{' (PackageOwnerCS::ownedPackages+=PackageCS)[V1:*] (PackageCS::ownedClasses+=ClassCS)[V2:*] (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V3:*] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.MODEL_ELEMENT_CS__OWNED_ANNOTATIONS,
					8) /* AnnotationCS|AnnotationElementCS|DocumentationCS */,
		...
		eClassValues[40] = new EClassValue(BaseCSPackage.Literals.PARAMETER_CS,
			createSerializationRules(
				80 /* AccumulatorCS-0: NamedElementCS::name=Identifier ':' TypedElementCS::ownedType=TypedMultiplicityRefCS */,
				87 /* IteratorCS-0: NamedElementCS::name=Identifier ':' TypedElementCS::ownedType=TypedMultiplicityRefCS */,
				105 /* ParameterCS-0: NamedElementCS::name=Identifier ':' TypedElementCS::ownedType=TypedMultiplicityRefCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE,
					63) /* TypedMultiplicityRefCS */
		...
		eClassValues[41] = new EClassValue(BaseCSPackage.Literals.PATH_ELEMENT_CS,
			createSerializationRules(
				...
				99 /* LibPathElementCS-0: PathElementCS::referredElement=Name */
			), null
		);
		...
		eClassValues[43] = new EClassValue(BaseCSPackage.Literals.PATH_NAME_CS,
			createSerializationRules(
				...
				100 /* LibPathNameCS-0: PathNameCS::ownedPathElements+=LibPathElementCS ('::' PathNameCS::ownedPathElements+=LibPathElementCS)[V0:*] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS,
					67) /* FirstPathElementCS|LibPathElementCS|NextPathElementCS|URIFirstPathElementCS */
			}
		);
		...
		eClassValues[45] = new EClassValue(OCLstdlibCSPackage.Literals.PRECEDENCE_CS,
			createSerializationRules(
				108 /* PrecedenceCS-0: 'left' ':' NamedElementCS::name=Name */,
				109 /* PrecedenceCS-1: PrecedenceCS::isRightAssociative?='right' ':' NamedElementCS::name=Name */
			), null
		);
		...
		eClassValues[54] = new EClassValue(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS,
			...
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS__OWNED_ACTUAL_PARAMETER,
					76) /* LambdaTypeCS|MapTypeCS|TupleTypeCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS */
			}
		);
		...
		eClassValues[58] = new EClassValue(BaseCSPackage.Literals.TUPLE_PART_CS,
			createSerializationRules(
				111 /* TuplePartCS-0: NamedElementCS::name=Identifier ':' TypedElementCS::ownedType=TypedMultiplicityRefCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE,
					63) /* TypedMultiplicityRefCS */
		...
		eClassValues[59] = new EClassValue(BaseCSPackage.Literals.TUPLE_TYPE_CS,
			createSerializationRules(
				...
				114 /* TypedMultiplicityRefCS-2: TupleTypeCS::name='Tuple' ('(' (TupleTypeCS::ownedParts+=TuplePartCS (',' TupleTypeCS::ownedParts+=TuplePartCS)[V2:*])[V1:?] ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V3:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TYPED_REF_CS__OWNED_MULTIPLICITY,
					25) /* MultiplicityCS */,
		...
		eClassValues[63] = new EClassValue(BaseCSPackage.Literals.TYPED_TYPE_REF_CS,
			createSerializationRules(
				117 /* TypedTypeRefCS-0: TypedTypeRefCS::isTypeof?='typeof' '(' TypedTypeRefCS::ownedPathName=LibPathNameCS ')' */,
				118 /* TypedTypeRefCS-1: TypedTypeRefCS::ownedPathName=LibPathNameCS ('(' TypedTypeRefCS::ownedBinding=TemplateBindingCS ')')[V0:?] */,
				88 /* LambdaContextTypeRefCS-0: TypedTypeRefCS::ownedPathName=LibPathNameCS */,
				115 /* TypedMultiplicityRefCS-3: TypedTypeRefCS::isTypeof?='typeof' '(' TypedTypeRefCS::ownedPathName=LibPathNameCS ')' (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V0:?] */,
				116 /* TypedMultiplicityRefCS-4: TypedTypeRefCS::ownedPathName=LibPathNameCS ('(' TypedTypeRefCS::ownedBinding=TemplateBindingCS ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V1:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
	...
	private void initGrammarRuleValues() {
		...
		grammarRuleValues[27] = createParserRuleValue(27, "ExpCS", 73 /* BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				16	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				18	/* CollectionLiteralExpCS-0: CollectionLiteralExpCS::ownedType=CollectionTypeCS '{' (CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS (',' CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS)[V1:*])[V0:?] '}' */,
				25	/* ExpCS-18: InfixExpCS::ownedLeft=PrefixedPrimaryExpCS NamedElementCS::name=BinaryOperatorName OperatorExpCS::ownedRight=ExpCS */,
		...
		grammarRuleValues[68] = createParserRuleValue(68, "NavigatingArgExpCS", 74 /* BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				16	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				18	/* CollectionLiteralExpCS-0: CollectionLiteralExpCS::ownedType=CollectionTypeCS '{' (CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS (',' CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS)[V1:*])[V0:?] '}' */,
				25	/* ExpCS-18: InfixExpCS::ownedLeft=PrefixedPrimaryExpCS NamedElementCS::name=BinaryOperatorName OperatorExpCS::ownedRight=ExpCS */,
		...
		grammarRuleValues[86] = createParserRuleValue(86, "PrefixedPrimaryExpCS", 71 /* BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				16	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				18	/* CollectionLiteralExpCS-0: CollectionLiteralExpCS::ownedType=CollectionTypeCS '{' (CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS (',' CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS)[V1:*])[V0:?] '}' */,
				26	/* IfExpCS-0: 'if' IfExpCS::ownedCondition=ExpCS|PatternExpCS 'then' IfExpCS::ownedThenExpression=ExpCS (IfExpCS::ownedIfThenExpressions+=ElseIfThenExpCS)[V0:*] 'else' IfExpCS::ownedElseExpression=ExpCS 'endif' */,
		...
		grammarRuleValues[88] = createParserRuleValue(88, "PrimitiveLiteralExpCS", 69 /* BooleanLiteralExpCS|InvalidLiteralExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrimitiveLiteralExpCS|StringLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				16	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				27	/* InvalidLiteralExpCS-0: 'invalid' */,
				48	/* NullLiteralExpCS-0: 'null' */,
		...
		grammarRuleValues[111] = createParserRuleValue(111, "TypeExpWithoutMultiplicityCS", 60 /* CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
			createSerializationRules(
				21	/* CollectionPatternCS-0: CollectionPatternCS::ownedType=CollectionTypeCS '{' (CollectionPatternCS::ownedParts+=PatternExpCS (',' CollectionPatternCS::ownedParts+=PatternExpCS)[V1:*] '++' CollectionPatternCS::restVariableName=Identifier)[V0:?] '}' */,
				22	/* CollectionTypeCS-0: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] */,
				33	/* MapTypeCS-0: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] */,
		...
		grammarRuleValues[117] = createParserRuleValue(117, "TypeRefCS", 76 /* LambdaTypeCS|MapTypeCS|TupleTypeCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS */,
			createSerializationRules(
				89	/* LambdaTypeCS-0: LambdaTypeCS::name='Lambda' (TemplateableElementCS::ownedSignature=TemplateSignatureCS)[V0:?] LambdaTypeCS::ownedContextType=LambdaContextTypeRefCS '(' (LambdaTypeCS::ownedParameterTypes+=TypedMultiplicityRefCS (',' LambdaTypeCS::ownedParameterTypes+=TypedMultiplicityRefCS)[V2:*])[V1:?] ')' ':' LambdaTypeCS::ownedResultType=TypedRefCS */,
				33	/* MapTypeCS-0: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] */,
				63	/* TupleTypeCS-0: TupleTypeCS::name='Tuple' ('(' (TupleTypeCS::ownedParts+=TuplePartCS (',' TupleTypeCS::ownedParts+=TuplePartCS)[V2:*])[V1:?] ')')[V0:?] */,
		...
		grammarRuleValues[119] = createParserRuleValue(119, "TypedRefCS", 65 /* LambdaTypeCS|MapTypeCS|TupleTypeCS|TypedRefCS|TypedTypeRefCS */,
			createSerializationRules(
				89	/* LambdaTypeCS-0: LambdaTypeCS::name='Lambda' (TemplateableElementCS::ownedSignature=TemplateSignatureCS)[V0:?] LambdaTypeCS::ownedContextType=LambdaContextTypeRefCS '(' (LambdaTypeCS::ownedParameterTypes+=TypedMultiplicityRefCS (',' LambdaTypeCS::ownedParameterTypes+=TypedMultiplicityRefCS)[V2:*])[V1:?] ')' ':' LambdaTypeCS::ownedResultType=TypedRefCS */,
				33	/* MapTypeCS-0: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] */,
				63	/* TupleTypeCS-0: TupleTypeCS::name='Tuple' ('(' (TupleTypeCS::ownedParts+=TuplePartCS (',' TupleTypeCS::ownedParts+=TuplePartCS)[V2:*])[V1:?] ')')[V0:?] */,
	...
	private void initGrammarRuleVectors() {
		...
		// 58: CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS
		...
		// 60: CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS
		grammarRuleVectors[60] = new GrammarRuleVector(0x800000000001800L,0x9a00002000000L);
		// 61: TypeParameterCS
		grammarRuleVectors[61] = new GrammarRuleVector(0x0L,0x10000000000000L);
		// 62: TypeRefCS
		grammarRuleVectors[62] = new GrammarRuleVector(0x0L,0x20000000000000L);
		// 63: TypedMultiplicityRefCS
		...
		// 65: LambdaTypeCS|MapTypeCS|TupleTypeCS|TypedRefCS|TypedTypeRefCS
		grammarRuleVectors[65] = new GrammarRuleVector(0x800040000000000L,0x180200000000000L);
		// 66: NextPathElementCS|URIFirstPathElementCS
		grammarRuleVectors[66] = new GrammarRuleVector(0x0L,0x800000000000400L);
		// 67: FirstPathElementCS|LibPathElementCS|NextPathElementCS|URIFirstPathElementCS
		grammarRuleVectors[67] = new GrammarRuleVector(0x8000010000000L,0x800000000000400L);
		// 68: URIPathNameCS
		grammarRuleVectors[68] = new GrammarRuleVector(0x0L,0x1000000000000000L);
		// 69: BooleanLiteralExpCS|InvalidLiteralExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrimitiveLiteralExpCS|StringLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[69] = new GrammarRuleVector(0x1000000040L,0x4000004001001800L);
		// 70: BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[70] = new GrammarRuleVector(0x200021100000240L,0x4002044101801a04L);
		// 71: BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[71] = new GrammarRuleVector(0x200021100000240L,0x4002044101c01a04L);
		// 72: BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[72] = new GrammarRuleVector(0x2000a1100000240L,0x4002044101e01a04L);
		// 73: BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[73] = new GrammarRuleVector(0x2000a1108000240L,0x4002044101e01a04L);
		// 74: BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[74] = new GrammarRuleVector(0x2000a1108000240L,0x4002044101e01a14L);
		// 75: BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[75] = new GrammarRuleVector(0x2000a1108000240L,0x4002044101e21a04L);
		// 76: LambdaTypeCS|MapTypeCS|TupleTypeCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS
		grammarRuleVectors[76] = new GrammarRuleVector(0x800040000000000L,0x1a0200000000000L,0x4L);
	}
	...
	private void initMatchSteps() {
		...
		// 193: assign V5 = |LibOperationCS::isInvalidating.'invalidating'|
		serializationMatchSteps[193] = createMatchStep_Assign(5, 61);
		// 194: assign V5 = |ModelElementCS::ownedAnnotations|
		serializationMatchSteps[194] = createMatchStep_Assign(5, 75);
		// 195: assign V5 = |StructuredClassCS::ownedOperations|
		serializationMatchSteps[195] = createMatchStep_Assign(5, 121);
		...
		// 198: assign V6 = |StructuredClassCS::ownedProperties|
		serializationMatchSteps[198] = createMatchStep_Assign(6, 122);
		// 199: assign V7 = |ClassCS::ownedConstraints|
		serializationMatchSteps[199] = createMatchStep_Assign(7, 13);
		// 200: assign V7 = |JavaImplementationCS::implementation|
		serializationMatchSteps[200] = createMatchStep_Assign(7, 46);
		// 201: assign V7 = |LibIterationCS::isValidating.'validating'|
		serializationMatchSteps[201] = createMatchStep_Assign(7, 58);
		// 202: assign V8 = |JavaImplementationCS::implementation|
		serializationMatchSteps[202] = createMatchStep_Assign(8, 46);
		// 203: assign V8 = |ModelElementCS::ownedAnnotations|
		serializationMatchSteps[203] = createMatchStep_Assign(8, 75);
		...
		serializationMatchSteps[208] = createMatchStep_RuleCheck(BaseCSPackage.Literals.CONSTRAINT_CS__OWNED_MESSAGE_SPECIFICATION, 48/*SpecificationCS*/);
		// 209: check-rule basecs::ConstraintCS.ownedSpecification : 99
		serializationMatchSteps[209] = createMatchStep_RuleCheck(BaseCSPackage.Literals.CONSTRAINT_CS__OWNED_SPECIFICATION, 48/*SpecificationCS*/);
		// 210: check-rule basecs::ImportCS.ownedPathName : 124
		serializationMatchSteps[210] = createMatchStep_RuleCheck(BaseCSPackage.Literals.IMPORT_CS__OWNED_PATH_NAME, 68/*URIPathNameCS*/);
		...
		serializationMatchSteps[212] = createMatchStep_RuleCheck(BaseCSPackage.Literals.LAMBDA_TYPE_CS__OWNED_PARAMETER_TYPES, 63/*TypedMultiplicityRefCS*/);
		// 213: check-rule basecs::LambdaTypeCS.ownedResultType : 42|59|109|119|120
		serializationMatchSteps[213] = createMatchStep_RuleCheck(BaseCSPackage.Literals.LAMBDA_TYPE_CS__OWNED_RESULT_TYPE, 65/*LambdaTypeCS|MapTypeCS|TupleTypeCS|TypedRefCS|TypedTypeRefCS*/);
		...
		serializationMatchSteps[215] = createMatchStep_RuleCheck(BaseCSPackage.Literals.OPERATION_CS__OWNED_BODY_EXPRESSIONS, 48/*SpecificationCS*/);
		// 216: check-rule basecs::OperationCS.ownedParameters : 79
		serializationMatchSteps[216] = createMatchStep_RuleCheck(BaseCSPackage.Literals.OPERATION_CS__OWNED_PARAMETERS, 33/*ParameterCS*/);
		// 217: check-rule basecs::OperationCS.ownedPostconditions : 82
		serializationMatchSteps[217] = createMatchStep_RuleCheck(BaseCSPackage.Literals.OPERATION_CS__OWNED_POSTCONDITIONS, 37/*PostCS*/);
		// 218: check-rule basecs::OperationCS.ownedPostconditions : 83
		serializationMatchSteps[218] = createMatchStep_RuleCheck(BaseCSPackage.Literals.OPERATION_CS__OWNED_POSTCONDITIONS, 38/*PreCS*/);
		// 219: check-rule basecs::OperationCS.ownedPreconditions : 82
		serializationMatchSteps[219] = createMatchStep_RuleCheck(BaseCSPackage.Literals.OPERATION_CS__OWNED_PRECONDITIONS, 37/*PostCS*/);
		// 220: check-rule basecs::OperationCS.ownedPreconditions : 83
		serializationMatchSteps[220] = createMatchStep_RuleCheck(BaseCSPackage.Literals.OPERATION_CS__OWNED_PRECONDITIONS, 38/*PreCS*/);
		...
		serializationMatchSteps[223] = createMatchStep_RuleCheck(BaseCSPackage.Literals.PACKAGE_OWNER_CS__OWNED_PACKAGES, 32/*PackageCS*/);
		...
		// 226: check-rule basecs::RootCS.ownedImports : 33
		serializationMatchSteps[226] = createMatchStep_RuleCheck(BaseCSPackage.Literals.ROOT_CS__OWNED_IMPORTS, 12/*ImportCS*/);
		// 227: check-rule basecs::StructuredClassCS.ownedOperations : 46|47|48|77
		serializationMatchSteps[227] = createMatchStep_RuleCheck(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__OWNED_OPERATIONS, 31/*LibCoercionCS|LibIterationCS|LibOperationCS|OperationCS*/);
		// 228: check-rule basecs::StructuredClassCS.ownedProperties : 53
		serializationMatchSteps[228] = createMatchStep_RuleCheck(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__OWNED_PROPERTIES, 22/*LibPropertyCS*/);
		// 229: check-rule basecs::StructuredClassCS.ownedSuperTypes : 42|59|109|119|120
		serializationMatchSteps[229] = createMatchStep_RuleCheck(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__OWNED_SUPER_TYPES, 65/*LambdaTypeCS|MapTypeCS|TupleTypeCS|TypedRefCS|TypedTypeRefCS*/);
		// 230: check-rule basecs::TemplateBindingCS.ownedMultiplicity : 62
		serializationMatchSteps[230] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_BINDING_CS__OWNED_MULTIPLICITY, 25/*MultiplicityCS*/);
		// 231: check-rule basecs::TemplateBindingCS.ownedSubstitutions : 104
		serializationMatchSteps[231] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_BINDING_CS__OWNED_SUBSTITUTIONS, 52/*TemplateParameterSubstitutionCS*/);
		// 232: check-rule basecs::TemplateParameterSubstitutionCS.ownedActualParameter : 42|59|109|117|119|120|130
		serializationMatchSteps[232] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS__OWNED_ACTUAL_PARAMETER, 76/*LambdaTypeCS|MapTypeCS|TupleTypeCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS*/);
		// 233: check-rule basecs::TemplateSignatureCS.ownedParameters : 116
		serializationMatchSteps[233] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_SIGNATURE_CS__OWNED_PARAMETERS, 61/*TypeParameterCS*/);
		// 234: check-rule basecs::TemplateableElementCS.ownedSignature : 105
		serializationMatchSteps[234] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATEABLE_ELEMENT_CS__OWNED_SIGNATURE, 53/*TemplateSignatureCS*/);
		// 235: check-rule basecs::TupleTypeCS.ownedParts : 108
		serializationMatchSteps[235] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TUPLE_TYPE_CS__OWNED_PARTS, 55/*TuplePartCS*/);
		// 236: check-rule basecs::TypeParameterCS.ownedExtends : 42|59|109|119|120
		serializationMatchSteps[236] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPE_PARAMETER_CS__OWNED_EXTENDS, 65/*LambdaTypeCS|MapTypeCS|TupleTypeCS|TypedRefCS|TypedTypeRefCS*/);
		// 237: check-rule basecs::TypedElementCS.ownedType : 118
		serializationMatchSteps[237] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE, 63/*TypedMultiplicityRefCS*/);
		// 238: check-rule basecs::TypedRefCS.ownedMultiplicity : 62
		serializationMatchSteps[238] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_REF_CS__OWNED_MULTIPLICITY, 25/*MultiplicityCS*/);
		// 239: check-rule basecs::TypedTypeRefCS.ownedBinding : 103
		serializationMatchSteps[239] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__OWNED_BINDING, 51/*TemplateBindingCS*/);
		// 240: check-rule basecs::TypedTypeRefCS.ownedPathName : 52
		serializationMatchSteps[240] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__OWNED_PATH_NAME, 21/*LibPathNameCS*/);
		// 241: check-rule basecs::WildcardTypeRefCS.ownedExtends : 42|59|109|119|120
		serializationMatchSteps[241] = createMatchStep_RuleCheck(BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS__OWNED_EXTENDS, 65/*LambdaTypeCS|MapTypeCS|TupleTypeCS|TypedRefCS|TypedTypeRefCS*/);
		// 242: check-rule essentialoclcs::AbstractNameExpCS.ownedCurlyBracketedClause : 14
		serializationMatchSteps[242] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_CURLY_BRACKETED_CLAUSE, 6/*CurlyBracketedClauseCS*/);
		// 243: check-rule essentialoclcs::AbstractNameExpCS.ownedPathName : 80
		serializationMatchSteps[243] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_PATH_NAME, 34/*PathNameCS*/);
		// 244: check-rule essentialoclcs::AbstractNameExpCS.ownedRoundBracketedClause : 92
		serializationMatchSteps[244] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_ROUND_BRACKETED_CLAUSE, 43/*RoundBracketedClauseCS*/);
		// 245: check-rule essentialoclcs::AbstractNameExpCS.ownedSquareBracketedClauses : 100
		serializationMatchSteps[245] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_SQUARE_BRACKETED_CLAUSES, 49/*SquareBracketedClauseCS*/);
		// 246: check-rule essentialoclcs::CollectionLiteralExpCS.ownedParts : 10
		serializationMatchSteps[246] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_EXP_CS__OWNED_PARTS, 4/*CollectionLiteralPartCS*/);
		// 247: check-rule essentialoclcs::CollectionLiteralExpCS.ownedType : 12
		serializationMatchSteps[247] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_EXP_CS__OWNED_TYPE, 5/*CollectionTypeCS*/);
		// 248: check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[248] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_EXPRESSION, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 249: check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : 81
		serializationMatchSteps[249] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_EXPRESSION, 35/*PatternExpCS*/);
		// 250: check-rule essentialoclcs::CollectionLiteralPartCS.ownedLastExpression : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[250] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_LAST_EXPRESSION, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 251: check-rule essentialoclcs::CollectionPatternCS.ownedParts : 81
		serializationMatchSteps[251] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__OWNED_PARTS, 35/*PatternExpCS*/);
		// 252: check-rule essentialoclcs::CollectionPatternCS.ownedType : 12
		serializationMatchSteps[252] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__OWNED_TYPE, 5/*CollectionTypeCS*/);
		// 253: check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : 62
		serializationMatchSteps[253] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_COLLECTION_MULTIPLICITY, 25/*MultiplicityCS*/);
		// 254: check-rule essentialoclcs::CollectionTypeCS.ownedType : 11|12|59|89|109|111|112|115
		serializationMatchSteps[254] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_TYPE, 60/*CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS*/);
		// 255: check-rule essentialoclcs::ContextCS.ownedExpression : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[255] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.CONTEXT_CS__OWNED_EXPRESSION, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 256: check-rule essentialoclcs::CurlyBracketedClauseCS.ownedParts : 97
		serializationMatchSteps[256] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.CURLY_BRACKETED_CLAUSE_CS__OWNED_PARTS, 47/*ShadowPartCS*/);
		// 257: check-rule essentialoclcs::ExpSpecificationCS.ownedExpression : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[257] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.EXP_SPECIFICATION_CS__OWNED_EXPRESSION, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 258: check-rule essentialoclcs::IfExpCS.ownedCondition : 6|9|27|32|36|41|43|57|66|73|75|76|81|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[258] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_CONDITION, 75/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 259: check-rule essentialoclcs::IfExpCS.ownedElseExpression : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[259] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_ELSE_EXPRESSION, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 260: check-rule essentialoclcs::IfExpCS.ownedIfThenExpressions : 20
		serializationMatchSteps[260] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_IF_THEN_EXPRESSIONS, 9/*ElseIfThenExpCS*/);
		// 261: check-rule essentialoclcs::IfExpCS.ownedThenExpression : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[261] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_THEN_EXPRESSION, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 262: check-rule essentialoclcs::IfThenExpCS.ownedCondition : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[262] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_THEN_EXP_CS__OWNED_CONDITION, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 263: check-rule essentialoclcs::IfThenExpCS.ownedThenExpression : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[263] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_THEN_EXP_CS__OWNED_THEN_EXPRESSION, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 264: check-rule essentialoclcs::InfixExpCS.ownedLeft : 6|9|32|36|41|57|66|73|75|76|86|87|88|96|102|106|113|126
		serializationMatchSteps[264] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.INFIX_EXP_CS__OWNED_LEFT, 71/*BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 265: check-rule essentialoclcs::LambdaLiteralExpCS.ownedExpressionCS : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[265] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LAMBDA_LITERAL_EXP_CS__OWNED_EXPRESSION_CS, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 266: check-rule essentialoclcs::LetExpCS.ownedInExpression : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[266] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LET_EXP_CS__OWNED_IN_EXPRESSION, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 267: check-rule essentialoclcs::LetExpCS.ownedVariables : 44
		serializationMatchSteps[267] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LET_EXP_CS__OWNED_VARIABLES, 16/*LetVariableCS*/);
		// 268: check-rule essentialoclcs::LetVariableCS.ownedRoundBracketedClause : 92
		serializationMatchSteps[268] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LET_VARIABLE_CS__OWNED_ROUND_BRACKETED_CLAUSE, 43/*RoundBracketedClauseCS*/);
		// 269: check-rule essentialoclcs::MapLiteralExpCS.ownedParts : 58
		serializationMatchSteps[269] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_EXP_CS__OWNED_PARTS, 23/*MapLiteralPartCS*/);
		// 270: check-rule essentialoclcs::MapLiteralExpCS.ownedType : 59
		serializationMatchSteps[270] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_EXP_CS__OWNED_TYPE, 24/*MapTypeCS*/);
		// 271: check-rule essentialoclcs::MapLiteralPartCS.ownedKey : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[271] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_PART_CS__OWNED_KEY, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 272: check-rule essentialoclcs::MapLiteralPartCS.ownedValue : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[272] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_PART_CS__OWNED_VALUE, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 273: check-rule essentialoclcs::MapTypeCS.ownedKeyType : 110
		serializationMatchSteps[273] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_KEY_TYPE, 56/*TypeExpCS*/);
		// 274: check-rule essentialoclcs::MapTypeCS.ownedValueType : 110
		serializationMatchSteps[274] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_VALUE_TYPE, 56/*TypeExpCS*/);
		// 275: check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : 8
		serializationMatchSteps[275] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_CO_ITERATOR, 3/*CoIteratorVariableCS*/);
		// 276: check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[276] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_INIT_EXPRESSION, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 277: check-rule essentialoclcs::NavigatingArgCS.ownedNameExpression : 6|9|27|32|36|41|43|57|66|68|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[277] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_NAME_EXPRESSION, 74/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 278: check-rule essentialoclcs::NavigatingArgCS.ownedType : 110
		serializationMatchSteps[278] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_TYPE, 56/*TypeExpCS*/);
		// 279: check-rule essentialoclcs::NestedExpCS.ownedExpression : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[279] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NESTED_EXP_CS__OWNED_EXPRESSION, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 280: check-rule essentialoclcs::OperatorExpCS.ownedRight : 43|85
		serializationMatchSteps[280] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 41/*LetExpCS|PrefixedLetExpCS*/);
		// 281: check-rule essentialoclcs::OperatorExpCS.ownedRight : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[281] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 282: check-rule essentialoclcs::OperatorExpCS.ownedRight : 6|9|32|36|41|57|66|73|75|76|86|87|88|96|102|106|113|126
		serializationMatchSteps[282] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 71/*BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 283: check-rule essentialoclcs::PatternExpCS.ownedPatternType : 110
		serializationMatchSteps[283] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS__OWNED_PATTERN_TYPE, 56/*TypeExpCS*/);
		// 284: check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : 102
		serializationMatchSteps[284] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 50/*StringLiteralExpCS*/);
		// 285: check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : 6|9|27|32|36|41|43|57|66|73|75|76|81|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[285] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 75/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 286: check-rule essentialoclcs::SquareBracketedClauseCS.ownedTerms : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[286] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.SQUARE_BRACKETED_CLAUSE_CS__OWNED_TERMS, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 287: check-rule essentialoclcs::TupleLiteralExpCS.ownedParts : 107
		serializationMatchSteps[287] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TUPLE_LITERAL_EXP_CS__OWNED_PARTS, 54/*TupleLiteralPartCS*/);
		// 288: check-rule essentialoclcs::TypeLiteralExpCS.ownedType : 114
		serializationMatchSteps[288] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_LITERAL_EXP_CS__OWNED_TYPE, 59/*TypeLiteralWithMultiplicityCS*/);
		// 289: check-rule essentialoclcs::TypeNameExpCS.ownedCurlyBracketedClause : 14
		serializationMatchSteps[289] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_CURLY_BRACKETED_CLAUSE, 6/*CurlyBracketedClauseCS*/);
		// 290: check-rule essentialoclcs::TypeNameExpCS.ownedPathName : 80
		serializationMatchSteps[290] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_PATH_NAME, 34/*PathNameCS*/);
		// 291: check-rule essentialoclcs::TypeNameExpCS.ownedPatternGuard : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[291] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_PATTERN_GUARD, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 292: check-rule essentialoclcs::VariableCS.ownedInitExpression : 6|9|27|32|36|41|43|57|66|73|75|76|85|86|87|88|96|102|106|113|126
		serializationMatchSteps[292] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_INIT_EXPRESSION, 73/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 293: check-rule essentialoclcs::VariableCS.ownedType : 110
		serializationMatchSteps[293] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_TYPE, 56/*TypeExpCS*/);
		// 294: check-rule oclstdlibcs::LibIterationCS.ownedAccumulators : 1
		serializationMatchSteps[294] = createMatchStep_RuleCheck(OCLstdlibCSPackage.Literals.LIB_ITERATION_CS__OWNED_ACCUMULATORS, 0/*AccumulatorCS*/);
		// 295: check-rule oclstdlibcs::LibIterationCS.ownedIterators : 37
		serializationMatchSteps[295] = createMatchStep_RuleCheck(OCLstdlibCSPackage.Literals.LIB_ITERATION_CS__OWNED_ITERATORS, 14/*IteratorCS*/);
		// 296: check-rule oclstdlibcs::LibPackageCS.ownedPrecedences : 84
		serializationMatchSteps[296] = createMatchStep_RuleCheck(OCLstdlibCSPackage.Literals.LIB_PACKAGE_CS__OWNED_PRECEDENCES, 39/*PrecedenceCS*/);
		// 297: check-rule oclstdlibcs::LibPropertyCS.ownedOpposite : 49
		serializationMatchSteps[297] = createMatchStep_RuleCheck(OCLstdlibCSPackage.Literals.LIB_PROPERTY_CS__OWNED_OPPOSITE, 18/*LibOppositeCS*/);
	}
	...
	private void initSerializationRules0() {
		...
		serializationRules[10] = createSerializationRule("PathNameCS-0", 80,
			...
			createSerializationSteps(
				...
				171		/* V00*2-steps || value */,
				126		/* '::' || no-space value no-space */,
				232		/* PathNameCS::ownedPathElements+=NextPathElementCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 29/* FirstPathElementCS,NextPathElementCS */,
		...
		serializationRules[11] = createSerializationRule("TemplateBindingCS-0", 103,
			createSerializationMatchSteps(
				230		/* check-rule basecs::TemplateBindingCS.ownedMultiplicity : MultiplicityCS */,
				231		/* check-rule basecs::TemplateBindingCS.ownedSubstitutions : TemplateParameterSubstitutionCS */,
				159		/* assign V1 = |TemplateBindingCS::ownedMultiplicity| */,
				106		/* assign V0 = (|TemplateBindingCS::ownedSubstitutions| - 1) */
			),
			createSerializationSteps(
				...
				171		/* V00*2-steps || value */,
				123		/* ',' || no-space value soft-space */,
				88		/* TemplateBindingCS::ownedSubstitutions+=TemplateParameterSubstitutionCS || value */,
				177		/* V01*1-steps || value */,
		...
		serializationRules[12] = createSerializationRule("TemplateParameterSubstitutionCS-0", 104,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				232		/* check-rule basecs::TemplateParameterSubstitutionCS.ownedActualParameter : LambdaTypeCS|MapTypeCS|TupleTypeCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS */,
				52		/* assert (|TemplateParameterSubstitutionCS::ownedActualParameter| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS__OWNED_ACTUAL_PARAMETER, 62/* TypeRefCS */,
					(117/*TypeRefCS*/ << 4) | 0 /*[1]*/
				)
			});
		...
		serializationRules[13] = createSerializationRule("TemplateSignatureCS-0", 105,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				233		/* check-rule basecs::TemplateSignatureCS.ownedParameters : TypeParameterCS */,
				107		/* assign V0 = (|TemplateSignatureCS::ownedParameters| - 1) */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.TEMPLATE_SIGNATURE_CS__OWNED_PARAMETERS, 61/* TypeParameterCS */,
		...
		serializationRules[14] = createSerializationRule("TypeParameterCS-0", 116,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				236		/* check-rule basecs::TypeParameterCS.ownedExtends : LambdaTypeCS|MapTypeCS|TupleTypeCS|TypedRefCS|TypedTypeRefCS */,
				33		/* assert (|NamedElementCS::name| - 1) == 0 */,
				110		/* assign V0 = (|TypeParameterCS::ownedExtends| > 0) */,
				149		/* assign V1 = (|TypeParameterCS::ownedExtends| - 1) */
			),
			createSerializationSteps(
				...
				174		/* V00*5-steps || value */,
				144		/* 'extends' || soft-space value soft-space */,
				44		/* TypeParameterCS::ownedExtends+=TypedRefCS || value */,
				180		/* V01*2-steps || value */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.TYPE_PARAMETER_CS__OWNED_EXTENDS, 64/* TypedRefCS */,
					(119/*TypedRefCS*/ << 4) | 2 /*[*]*/
				)
			});
		...
		serializationRules[15] = createSerializationRule("WildcardTypeRefCS-0", 130,
			createSerializationMatchSteps(
				98		/* assert |WildcardTypeRefCS::ownedSuper| == 0 */,
				241		/* check-rule basecs::WildcardTypeRefCS.ownedExtends : LambdaTypeCS|MapTypeCS|TupleTypeCS|TypedRefCS|TypedTypeRefCS */,
				138		/* assign V0 = |WildcardTypeRefCS::ownedExtends| */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS__OWNED_EXTENDS, 64/* TypedRefCS */,
					(119/*TypedRefCS*/ << 4) | 1 /*[?]*/
				)
			});
		// EssentialOCL::BooleanLiteralExpCS-0(essentialoclcs::BooleanLiteralExpCS): symbol={'false|true'}
		serializationRules[16] = createSerializationRule("BooleanLiteralExpCS-0", 6,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				1		/* assert (|BooleanLiteralExpCS::symbol.'false|true'| - 1) == 0 */
			),
		...
		serializationRules[17] = createSerializationRule("CoIteratorVariableCS-0", 8,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				97		/* assert |VariableCS::ownedInitExpression| == 0 */,
				293		/* check-rule essentialoclcs::VariableCS.ownedType : TypeExpCS */,
				137		/* assign V0 = |VariableCS::ownedType| */,
				33		/* assert (|NamedElementCS::name| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_TYPE, 56/* TypeExpCS */,
					(110/*TypeExpCS*/ << 4) | 1 /*[?]*/
				)
			});
		...
		serializationRules[18] = createSerializationRule("CollectionLiteralExpCS-0", 9,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				246		/* check-rule essentialoclcs::CollectionLiteralExpCS.ownedParts : CollectionLiteralPartCS */,
				247		/* check-rule essentialoclcs::CollectionLiteralExpCS.ownedType : CollectionTypeCS */,
				2		/* assert (|CollectionLiteralExpCS::ownedType| - 1) == 0 */,
				100		/* assign V0 = (|CollectionLiteralExpCS::ownedParts| > 0) */,
				141		/* assign V1 = (|CollectionLiteralExpCS::ownedParts| - 1) */
			),
			createSerializationSteps(
				...
				163		/* '{' || soft-space value push soft-new-line */,
				173		/* V00*4-steps || value */,
				68		/* CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS || value */,
				180		/* V01*2-steps || value */,
				123		/* ',' || no-space value soft-space */,
				68		/* CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS || value */,
				166		/* '}' || pop soft-space value soft-new-line */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[19] = createSerializationRule("CollectionLiteralPartCS-0", 10,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				248		/* check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				250		/* check-rule essentialoclcs::CollectionLiteralPartCS.ownedLastExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				112		/* assign V0 = |CollectionLiteralPartCS::ownedLastExpression| */,
				3		/* assert (|CollectionLiteralPartCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[20] = createSerializationRule("CollectionLiteralPartCS-1", 10,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				63		/* assert |CollectionLiteralPartCS::ownedLastExpression| == 0 */,
				249		/* check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : PatternExpCS */,
				3		/* assert (|CollectionLiteralPartCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_EXPRESSION, 35/* PatternExpCS */,
		...
		serializationRules[21] = createSerializationRule("CollectionPatternCS-0", 11,
			createSerializationMatchSteps(
				94		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				64		/* assert |CollectionPatternCS::ownedPatternGuard| == 0 */,
				251		/* check-rule essentialoclcs::CollectionPatternCS.ownedParts : PatternExpCS */,
				252		/* check-rule essentialoclcs::CollectionPatternCS.ownedType : CollectionTypeCS */,
				113		/* assign V0 = |CollectionPatternCS::restVariableName| */,
				142		/* assign V1 = (|CollectionPatternCS::ownedParts| - 1) */,
				4		/* assert (|CollectionPatternCS::ownedType| - 1) == 0 */
			),
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__OWNED_PARTS, 35/* PatternExpCS */,
					(81/*PatternExpCS*/ << 4) | 2 /*[*]*/
				),
		...
		serializationRules[22] = createSerializationRule("CollectionTypeCS-0", 12,
			createSerializationMatchSteps(
				94		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				253		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				254		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
				114		/* assign V0 = |CollectionTypeCS::ownedType| */,
				5		/* assert (|CollectionTypeCS::name| - 1) == 0 */,
				151		/* assign V1 = |CollectionTypeCS::ownedCollectionMultiplicity| */
			),
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_TYPE, 57/* TypeExpWithoutMultiplicityCS */,
		...
		serializationRules[23] = createSerializationRule("CurlyBracketedClauseCS-0", 14,
			createSerializationMatchSteps(
				65		/* assert |CurlyBracketedClauseCS::value| == 0 */,
				256		/* check-rule essentialoclcs::CurlyBracketedClauseCS.ownedParts : ShadowPartCS */,
				101		/* assign V0 = (|CurlyBracketedClauseCS::ownedParts| > 0) */,
				143		/* assign V1 = (|CurlyBracketedClauseCS::ownedParts| - 1) */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.CURLY_BRACKETED_CLAUSE_CS__OWNED_PARTS, 47/* ShadowPartCS */,
					(97/*ShadowPartCS*/ << 4) | 2 /*[*]*/
				)
			});
		...
		serializationRules[24] = createSerializationRule("ElseIfThenExpCS-0", 20,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				262		/* check-rule essentialoclcs::IfThenExpCS.ownedCondition : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				263		/* check-rule essentialoclcs::IfThenExpCS.ownedThenExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				16		/* assert (|IfThenExpCS::ownedThenExpression| - 1) == 0 */,
				15		/* assert (|IfThenExpCS::ownedCondition| - 1) == 0 */
			),
			createSerializationSteps(
				...
				161		/* 'then' || soft-space value soft-space */,
		...
		serializationRules[25] = createSerializationRule("ExpCS-18", 27,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				264		/* check-rule essentialoclcs::InfixExpCS.ownedLeft : BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(EssentialOCLCSPackage.Literals.INFIX_EXP_CS__OWNED_LEFT, 42/* PrefixedPrimaryExpCS */,
		...
		serializationRules[26] = createSerializationRule("IfExpCS-0", 32,
			createSerializationMatchSteps(
				66		/* assert |IfExpCS::isImplicit| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				258		/* check-rule essentialoclcs::IfExpCS.ownedCondition : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				259		/* check-rule essentialoclcs::IfExpCS.ownedElseExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				260		/* check-rule essentialoclcs::IfExpCS.ownedIfThenExpressions : ElseIfThenExpCS */,
				261		/* check-rule essentialoclcs::IfExpCS.ownedThenExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				13		/* assert (|IfExpCS::ownedElseExpression| - 1) == 0 */,
				117		/* assign V0 = |IfExpCS::ownedIfThenExpressions| */,
				14		/* assert (|IfExpCS::ownedThenExpression| - 1) == 0 */,
				12		/* assert (|IfExpCS::ownedCondition| - 1) == 0 */
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_CONDITION, 36/* ExpCS,PatternExpCS */,
					(27/*ExpCS*/ << 4) | 0 /*[1]*/,
					(81/*PatternExpCS*/ << 4) | 0 /*[1]*/
				),
		...
		serializationRules[27] = createSerializationRule("InvalidLiteralExpCS-0", 36,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				148		/* 'invalid' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		// EssentialOCL::LambdaLiteralExpCS-0(essentialoclcs::LambdaLiteralExpCS): { "Lambda" "{" ownedExpressionCS=ExpCS "}" }
		serializationRules[28] = createSerializationRule("LambdaLiteralExpCS-0", 41,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				265		/* check-rule essentialoclcs::LambdaLiteralExpCS.ownedExpressionCS : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				19		/* assert (|LambdaLiteralExpCS::ownedExpressionCS| - 1) == 0 */
			),
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				132		/* 'Lambda' || soft-space value soft-space */,
				163		/* '{' || soft-space value push soft-new-line */,
		...
		serializationRules[29] = createSerializationRule("LetExpCS-0", 43,
			createSerializationMatchSteps(
				67		/* assert |LetExpCS::isImplicit| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				266		/* check-rule essentialoclcs::LetExpCS.ownedInExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				267		/* check-rule essentialoclcs::LetExpCS.ownedVariables : LetVariableCS */,
				23		/* assert (|LetExpCS::ownedInExpression| - 1) == 0 */,
				102		/* assign V0 = (|LetExpCS::ownedVariables| - 1) */
			),
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				151		/* 'let' || soft-space value soft-space */,
				103		/* LetExpCS::ownedVariables+=LetVariableCS || value */,
				171		/* V00*2-steps || value */,
				123		/* ',' || no-space value soft-space */,
				103		/* LetExpCS::ownedVariables+=LetVariableCS || value */,
				147		/* 'in' || soft-space value soft-space */,
		...
		serializationRules[30] = createSerializationRule("LetVariableCS-0", 44,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				292		/* check-rule essentialoclcs::VariableCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				268		/* check-rule essentialoclcs::LetVariableCS.ownedRoundBracketedClause : RoundBracketedClauseCS */,
				293		/* check-rule essentialoclcs::VariableCS.ownedType : TypeExpCS */,
				59		/* assert (|VariableCS::ownedInitExpression| - 1) == 0 */,
				163		/* assign V1 = |VariableCS::ownedType| */,
				119		/* assign V0 = |LetVariableCS::ownedRoundBracketedClause| */,
			...
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				218		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				167		/* V00*1-steps || value */,
				84		/* LetVariableCS::ownedRoundBracketedClause=RoundBracketedClauseCS || value */,
				179		/* V01*2-steps || value */,
				125		/* ':' || soft-space value soft-space */,
				100		/* VariableCS::ownedType=TypeExpCS || value */,
				129		/* '=' || soft-space value soft-space */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.LET_VARIABLE_CS__OWNED_ROUND_BRACKETED_CLAUSE, 43/* RoundBracketedClauseCS */,
		...
		serializationRules[31] = createSerializationRule("MapLiteralExpCS-0", 57,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				269		/* check-rule essentialoclcs::MapLiteralExpCS.ownedParts : MapLiteralPartCS */,
				270		/* check-rule essentialoclcs::MapLiteralExpCS.ownedType : MapTypeCS */,
				24		/* assert (|MapLiteralExpCS::ownedType| - 1) == 0 */,
				103		/* assign V0 = (|MapLiteralExpCS::ownedParts| > 0) */,
				147		/* assign V1 = (|MapLiteralExpCS::ownedParts| - 1) */
			),
		...
		serializationRules[32] = createSerializationRule("MapLiteralPartCS-0", 58,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				271		/* check-rule essentialoclcs::MapLiteralPartCS.ownedKey : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				272		/* check-rule essentialoclcs::MapLiteralPartCS.ownedValue : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				26		/* assert (|MapLiteralPartCS::ownedValue| - 1) == 0 */,
				25		/* assert (|MapLiteralPartCS::ownedKey| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[33] = createSerializationRule("MapTypeCS-0", 59,
			createSerializationMatchSteps(
				94		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				273		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				274		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
				122		/* assign V0 = |MapTypeCS::ownedValueType| */,
				28		/* assert (|MapTypeCS::ownedKeyType| - V0) == 0 */,
				27		/* assert (|MapTypeCS::name.'Map'| - 1) == 0 */
			),
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_KEY_TYPE, 56/* TypeExpCS */,
					(110/*TypeExpCS*/ << 4) | 1 /*[?]*/
				),
				createSerializationReference(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_VALUE_TYPE, 56/* TypeExpCS */,
					(110/*TypeExpCS*/ << 4) | 1 /*[?]*/
				)
			});
		// EssentialOCL::Model-0(essentialoclcs::ContextCS): ownedExpression=ExpCS
		serializationRules[34] = createSerializationRule("Model-0", 60,
			createSerializationMatchSteps(
				70		/* assert |NamedElementCS::name| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				82		/* assert |RootCS::ownedImports| == 0 */,
				255		/* check-rule essentialoclcs::ContextCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				10		/* assert (|ContextCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[35] = createSerializationRule("NameExpCS-0", 66,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				242		/* check-rule essentialoclcs::AbstractNameExpCS.ownedCurlyBracketedClause : CurlyBracketedClauseCS */,
				243		/* check-rule essentialoclcs::AbstractNameExpCS.ownedPathName : PathNameCS */,
				244		/* check-rule essentialoclcs::AbstractNameExpCS.ownedRoundBracketedClause : RoundBracketedClauseCS */,
				245		/* check-rule essentialoclcs::AbstractNameExpCS.ownedSquareBracketedClauses : SquareBracketedClauseCS */,
				183		/* assign V3 = |AbstractNameExpCS::isPre.'@'| */,
				173		/* assign V2 = |AbstractNameExpCS::ownedCurlyBracketedClause| */,
				150		/* assign V1 = |AbstractNameExpCS::ownedRoundBracketedClause| */,
				111		/* assign V0 = |AbstractNameExpCS::ownedSquareBracketedClauses| */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_PATH_NAME, 34/* PathNameCS */,
					(80/*PathNameCS*/ << 4) | 0 /*[1]*/
				),
				createSerializationReference(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_ROUND_BRACKETED_CLAUSE, 43/* RoundBracketedClauseCS */,
					(92/*RoundBracketedClauseCS*/ << 4) | 1 /*[?]*/
				),
				createSerializationReference(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_SQUARE_BRACKETED_CLAUSES, 49/* SquareBracketedClauseCS */,
					(100/*SquareBracketedClauseCS*/ << 4) | 2 /*[*]*/
				)
			});
		// EssentialOCL::NavigatingArgCS-0(essentialoclcs::NavigatingArgCS): { ":" ownedType=TypeExpCS }
		serializationRules[36] = createSerializationRule("NavigatingArgCS-0", 67,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				71		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				72		/* assert |NavigatingArgCS::ownedInitExpression| == 0 */,
				73		/* assert |NavigatingArgCS::ownedNameExpression| == 0 */,
				75		/* assert |NavigatingArgCS::prefix| == 0 */,
				278		/* check-rule essentialoclcs::NavigatingArgCS.ownedType : TypeExpCS */,
				37		/* assert (|NavigatingArgCS::ownedType| - 1) == 0 */
			),
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_TYPE, 56/* TypeExpCS */,
					(110/*TypeExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		...
		serializationRules[37] = createSerializationRule("NavigatingArgCS-1", 67,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				75		/* assert |NavigatingArgCS::prefix| == 0 */,
				275		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
				276		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				277		/* check-rule essentialoclcs::NavigatingArgCS.ownedNameExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				278		/* check-rule essentialoclcs::NavigatingArgCS.ownedType : TypeExpCS */,
				157		/* assign V1 = |NavigatingArgCS::ownedInitExpression| */,
				125		/* assign V0 = |NavigatingArgCS::ownedCoIterator| */,
				37		/* assert (|NavigatingArgCS::ownedType| - 1) == 0 */,
		...
		serializationRules[38] = createSerializationRule("NavigatingArgCS-2", 67,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				74		/* assert |NavigatingArgCS::ownedType| == 0 */,
				75		/* assert |NavigatingArgCS::prefix| == 0 */,
		...
		serializationRules[39] = createSerializationRule("NavigatingArgCS-3", 67,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				75		/* assert |NavigatingArgCS::prefix| == 0 */,
				275		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
		...
		serializationRules[40] = createSerializationRule("NavigatingArgCS-4", 67,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				71		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				72		/* assert |NavigatingArgCS::ownedInitExpression| == 0 */,
		...
		serializationRules[41] = createSerializationRule("NavigatingBarArgCS-0", 69,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				71		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				276		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			...
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				108		/* NavigatingArgCS::prefix='|' || soft-space value soft-space */,
				61		/* NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS || value */,
				174		/* V00*5-steps || value */,
				125		/* ':' || soft-space value soft-space */,
				97		/* NavigatingArgCS::ownedType=TypeExpCS || value */,
		...
		serializationRules[42] = createSerializationRule("NavigatingCommaArgCS-0", 70,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				275		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
				276		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		serializationRules[43] = createSerializationRule("NavigatingCommaArgCS-1", 70,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				74		/* assert |NavigatingArgCS::ownedType| == 0 */,
				275		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
		...
		serializationRules[44] = createSerializationRule("NavigatingCommaArgCS-2", 70,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				275		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
				276		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		serializationRules[45] = createSerializationRule("NavigatingCommaArgCS-3", 70,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				71		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				72		/* assert |NavigatingArgCS::ownedInitExpression| == 0 */,
		...
		serializationRules[46] = createSerializationRule("NavigatingSemiArgCS-0", 71,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				71		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				276		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		serializationRules[47] = createSerializationRule("NestedExpCS-0", 73,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				279		/* check-rule essentialoclcs::NestedExpCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				41		/* assert (|NestedExpCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
		...
		serializationRules[48] = createSerializationRule("NullLiteralExpCS-0", 75,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				153		/* 'null' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		// EssentialOCL::NumberLiteralExpCS-0(essentialoclcs::NumberLiteralExpCS): symbol=NUMBER_LITERAL
		serializationRules[49] = createSerializationRule("NumberLiteralExpCS-0", 76,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				42		/* assert (|NumberLiteralExpCS::symbol| - 1) == 0 */
			),
		...
		serializationRules[50] = createSerializationRule("PatternExpCS-0", 81,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				283		/* check-rule essentialoclcs::PatternExpCS.ownedPatternType : TypeExpCS */,
				47		/* assert (|PatternExpCS::ownedPatternType| - 1) == 0 */,
				129		/* assign V0 = |PatternExpCS::patternVariableName| */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS__OWNED_PATTERN_TYPE, 56/* TypeExpCS */,
					(110/*TypeExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::PrefixedLetExpCS-1(essentialoclcs::PrefixExpCS): { name=UnaryOperatorName ownedRight=PrefixedLetExpCS }
		serializationRules[51] = createSerializationRule("PrefixedLetExpCS-1", 85,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				280		/* check-rule essentialoclcs::OperatorExpCS.ownedRight : LetExpCS|PrefixedLetExpCS */,
				43		/* assert (|OperatorExpCS::ownedRight| - 1) == 0 */,
				33		/* assert (|NamedElementCS::name| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 40/* PrefixedLetExpCS */,
		...
		serializationRules[52] = createSerializationRule("PrefixedPrimaryExpCS-15", 86,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 42/* PrefixedPrimaryExpCS */,
					(86/*PrefixedPrimaryExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::PrimitiveTypeCS-0(basecs::PrimitiveTypeRefCS): name=PrimitiveTypeIdentifier
		serializationRules[53] = createSerializationRule("PrimitiveTypeCS-0", 89,
			createSerializationMatchSteps(
				94		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				49		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
			),
		...
		serializationRules[54] = createSerializationRule("RoundBracketedClauseCS-0", 92,
			null,	// run-time resolution using SerializationSteps
			createSerializationSteps(
				119		/* '(' || no-space value no-space */,
				172		/* V00*3-steps || value */,
				225		/* RoundBracketedClauseCS::ownedArguments+=NavigatingArgCS || value */,
				178		/* V01*1-steps || value */,
		...
		serializationRules[55] = createSerializationRule("SelfExpCS-0", 96,
			createSerializationMatchSteps(
				83		/* assert |SelfExpCS::name| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				160		/* 'self' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		...
		serializationRules[56] = createSerializationRule("ShadowPartCS-0", 97,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				285		/* check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				50		/* assert (|ShadowPartCS::ownedInitExpression| - 1) == 0 */,
				51		/* assert (|ShadowPartCS::referredProperty| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 36/* ExpCS,PatternExpCS */,
					(27/*ExpCS*/ << 4) | 0 /*[1]*/,
					(81/*PatternExpCS*/ << 4) | 0 /*[1]*/
				),
		...
		serializationRules[57] = createSerializationRule("ShadowPartCS-1", 97,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				84		/* assert |ShadowPartCS::referredProperty| == 0 */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 50/* StringLiteralExpCS */,
					(102/*StringLiteralExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::SimplePathNameCS-0(basecs::PathNameCS): ownedPathElements+=FirstPathElementCS
		serializationRules[58] = createSerializationRule("SimplePathNameCS-0", 98,
			createSerializationMatchSteps(
		...
		serializationRules[59] = createSerializationRule("SquareBracketedClauseCS-0", 100,
			createSerializationMatchSteps(
				286		/* check-rule essentialoclcs::SquareBracketedClauseCS.ownedTerms : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				105		/* assign V0 = (|SquareBracketedClauseCS::ownedTerms| - 1) */
			),
			createSerializationSteps(
				134		/* '[' || no-space value no-space */,
		...
		serializationRules[60] = createSerializationRule("StringLiteralExpCS-0", 102,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				131		/* assign V0 = |StringLiteralExpCS::segments| */
			),
			createSerializationSteps(
				169		/* V00*1-steps || value */,
		...
		serializationRules[61] = createSerializationRule("TupleLiteralExpCS-0", 106,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				287		/* check-rule essentialoclcs::TupleLiteralExpCS.ownedParts : TupleLiteralPartCS */,
				108		/* assign V0 = (|TupleLiteralExpCS::ownedParts| - 1) */
			),
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				133		/* 'Tuple' || soft-space value soft-space */,
				163		/* '{' || soft-space value push soft-new-line */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.TUPLE_LITERAL_EXP_CS__OWNED_PARTS, 54/* TupleLiteralPartCS */,
		...
		serializationRules[62] = createSerializationRule("TupleLiteralPartCS-0", 107,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				292		/* check-rule essentialoclcs::VariableCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				293		/* check-rule essentialoclcs::VariableCS.ownedType : TypeExpCS */,
		...
		serializationRules[63] = createSerializationRule("TupleTypeCS-0", 109,
			createSerializationMatchSteps(
				94		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				235		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				53		/* assert (|TupleTypeCS::name.'Tuple'| - 1) == 0 */,
				109		/* assign V0 = (|TupleTypeCS::ownedParts| > 0) */,
				148		/* assign V1 = (|TupleTypeCS::ownedParts| > 0) */,
				172		/* assign V2 = (|TupleTypeCS::ownedParts| - 1) */
			...
			createSerializationSteps(
				...
				176		/* V00*7-steps || value */,
				119		/* '(' || no-space value no-space */,
				182		/* V01*4-steps || value */,
				73		/* TupleTypeCS::ownedParts+=TuplePartCS || value */,
				191		/* V02*2-steps || value */,
				123		/* ',' || no-space value soft-space */,
				73		/* TupleTypeCS::ownedParts+=TuplePartCS || value */,
				120		/* ')' || no-space value */
			),
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.TUPLE_TYPE_CS__OWNED_PARTS, 55/* TuplePartCS */,
					(108/*TuplePartCS*/ << 4) | 2 /*[*]*/
				)
			});
	}
	private void initSerializationRules1() {
		...
		serializationRules[64] = createSerializationRule("TypeExpCS-0", 110,
			createSerializationMatchSteps(
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				135		/* assign V0 = |TypedRefCS::ownedMultiplicity| */,
				49		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[65] = createSerializationRule("TypeExpCS-1", 110,
			createSerializationMatchSteps(
				253		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				254		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
		...
		serializationRules[66] = createSerializationRule("TypeExpCS-2", 110,
			createSerializationMatchSteps(
				273		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				274		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
		...
		serializationRules[67] = createSerializationRule("TypeExpCS-3", 110,
			createSerializationMatchSteps(
				289		/* check-rule essentialoclcs::TypeNameExpCS.ownedCurlyBracketedClause : CurlyBracketedClauseCS */,
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				290		/* check-rule essentialoclcs::TypeNameExpCS.ownedPathName : PathNameCS */,
				291		/* check-rule essentialoclcs::TypeNameExpCS.ownedPatternGuard : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				179		/* assign V2 = |TypedRefCS::ownedMultiplicity| */,
				134		/* assign V0 = |TypeNameExpCS::ownedCurlyBracketedClause| */,
				55		/* assert (|TypeNameExpCS::ownedPathName| - 1) == 0 */,
				161		/* assign V1 = |TypeNameExpCS::ownedPatternGuard| */
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_PATH_NAME, 34/* PathNameCS */,
					(80/*PathNameCS*/ << 4) | 0 /*[1]*/
				),
		...
		serializationRules[68] = createSerializationRule("TypeExpCS-4", 110,
			createSerializationMatchSteps(
				64		/* assert |CollectionPatternCS::ownedPatternGuard| == 0 */,
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				251		/* check-rule essentialoclcs::CollectionPatternCS.ownedParts : PatternExpCS */,
		...
		serializationRules[69] = createSerializationRule("TypeExpCS-5", 110,
			createSerializationMatchSteps(
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				235		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				187		/* assign V3 = |TypedRefCS::ownedMultiplicity| */,
		...
		serializationRules[70] = createSerializationRule("TypeLiteralExpCS-0", 113,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				91		/* assert |TypeLiteralExpCS::ownedPathName| == 0 */,
				288		/* check-rule essentialoclcs::TypeLiteralExpCS.ownedType : TypeLiteralWithMultiplicityCS */,
				54		/* assert (|TypeLiteralExpCS::ownedType| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.TYPE_LITERAL_EXP_CS__OWNED_TYPE, 59/* TypeLiteralWithMultiplicityCS */,
		...
		serializationRules[71] = createSerializationRule("TypeLiteralWithMultiplicityCS-0", 114,
			createSerializationMatchSteps(
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				135		/* assign V0 = |TypedRefCS::ownedMultiplicity| */,
				49		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
		...
		serializationRules[72] = createSerializationRule("TypeLiteralWithMultiplicityCS-1", 114,
			createSerializationMatchSteps(
				253		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				254		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
		...
		serializationRules[73] = createSerializationRule("TypeLiteralWithMultiplicityCS-2", 114,
			createSerializationMatchSteps(
				273		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				274		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
		...
		serializationRules[74] = createSerializationRule("TypeLiteralWithMultiplicityCS-3", 114,
			createSerializationMatchSteps(
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				235		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				187		/* assign V3 = |TypedRefCS::ownedMultiplicity| */,
		...
		serializationRules[75] = createSerializationRule("TypeNameExpCS-0", 115,
			createSerializationMatchSteps(
				94		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				289		/* check-rule essentialoclcs::TypeNameExpCS.ownedCurlyBracketedClause : CurlyBracketedClauseCS */,
				290		/* check-rule essentialoclcs::TypeNameExpCS.ownedPathName : PathNameCS */,
		...
		serializationRules[76] = createSerializationRule("URIFirstPathElementCS-0", 123,
			createSerializationMatchSteps(
				45		/* assert (|PathElementCS::referredElement| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[77] = createSerializationRule("URIFirstPathElementCS-1", 123,
			createSerializationMatchSteps(
				45		/* assert (|PathElementCS::referredElement| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[78] = createSerializationRule("URIPathNameCS-0", 124,
			null,	// run-time resolution using SerializationSteps
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 66/* NextPathElementCS,URIFirstPathElementCS */,
					(74/*NextPathElementCS*/ << 4) | 2 /*[*]*/,
					(123/*URIFirstPathElementCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::UnlimitedNaturalLiteralExpCS-0(essentialoclcs::UnlimitedNaturalLiteralExpCS): "*"
		serializationRules[79] = createSerializationRule("UnlimitedNaturalLiteralExpCS-0", 126,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[80] = createSerializationRule("AccumulatorCS-0", 1,
			createSerializationMatchSteps(
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				93		/* assert |TypedElementCS::qualifiers| == 0 */,
				237		/* check-rule basecs::TypedElementCS.ownedType : TypedMultiplicityRefCS */,
				56		/* assert (|TypedElementCS::ownedType| - 1) == 0 */,
				33		/* assert (|NamedElementCS::name| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE, 63/* TypedMultiplicityRefCS */,
		...
		serializationRules[81] = createSerializationRule("AnnotationCS-0", 2,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				60		/* assert |AnnotationCS::ownedContents| == 0 */,
				61		/* assert |AnnotationCS::ownedReferences| == 0 */,
			...
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				136		/* 'annotation' || soft-space value soft-space */,
				...
				36		/* AnnotationElementCS::ownedDetails+=DetailCS || value */,
				120		/* ')' || no-space value */,
				127		/* ';' || no-space value soft-new-line */
			),
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
		...
		serializationRules[82] = createSerializationRule("AnnotationCS-1", 2,
			createSerializationMatchSteps(
				60		/* assert |AnnotationCS::ownedContents| == 0 */,
				61		/* assert |AnnotationCS::ownedReferences| == 0 */,
		...
		serializationRules[83] = createSerializationRule("DetailCS-0", 16,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				115		/* assign V0 = |DetailCS::values| */,
				33		/* assert (|NamedElementCS::name| - 1) == 0 */
		...
		serializationRules[84] = createSerializationRule("DocumentationCS-0", 17,
			createSerializationMatchSteps(
				70		/* assert |NamedElementCS::name| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				206		/* check-rule basecs::AnnotationElementCS.ownedDetails : DetailCS */,
		...
		serializationRules[85] = createSerializationRule("ImportCS-0", 33,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
			...
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				146		/* 'import' || soft-space value soft-space */,
				170		/* V00*2-steps || value */,
				219		/* NamedElementCS::name=Identifier || soft-space value soft-space */,
				125		/* ':' || soft-space value soft-space */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.IMPORT_CS__OWNED_PATH_NAME, 68/* URIPathNameCS */,
		...
		serializationRules[86] = createSerializationRule("InvCS-0", 35,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.CONSTRAINT_CS__OWNED_MESSAGE_SPECIFICATION, 48/* SpecificationCS */,
					(99/*SpecificationCS*/ << 4) | 1 /*[?]*/
				),
				createSerializationReference(BaseCSPackage.Literals.CONSTRAINT_CS__OWNED_SPECIFICATION, 48/* SpecificationCS */,
					(99/*SpecificationCS*/ << 4) | 0 /*[1]*/
				)
			});
		// OCLstdlib::IteratorCS-0(basecs::ParameterCS): { name=Identifier ":" ownedType=TypedMultiplicityRefCS }
		serializationRules[87] = createSerializationRule("IteratorCS-0", 37,
			createSerializationMatchSteps(
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				93		/* assert |TypedElementCS::qualifiers| == 0 */,
		...
		serializationRules[88] = createSerializationRule("LambdaContextTypeRefCS-0", 40,
			createSerializationMatchSteps(
				95		/* assert |TypedTypeRefCS::isTypeof| == 0 */,
				96		/* assert |TypedTypeRefCS::ownedBinding| == 0 */,
				94		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				240		/* check-rule basecs::TypedTypeRefCS.ownedPathName : LibPathNameCS */,
				58		/* assert (|TypedTypeRefCS::ownedPathName| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[89] = createSerializationRule("LambdaTypeCS-0", 42,
			createSerializationMatchSteps(
				94		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				...
				234		/* check-rule basecs::TemplateableElementCS.ownedSignature : TemplateSignatureCS */,
				22		/* assert (|LambdaTypeCS::ownedResultType| - 1) == 0 */,
				21		/* assert (|LambdaTypeCS::ownedContextType| - 1) == 0 */,
				133		/* assign V0 = |TemplateableElementCS::ownedSignature| */,
				20		/* assert (|LambdaTypeCS::name.'Lambda'| - 1) == 0 */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.LAMBDA_TYPE_CS__OWNED_PARAMETER_TYPES, 63/* TypedMultiplicityRefCS */,
					(118/*TypedMultiplicityRefCS*/ << 4) | 2 /*[*]*/
				),
				createSerializationReference(BaseCSPackage.Literals.LAMBDA_TYPE_CS__OWNED_RESULT_TYPE, 64/* TypedRefCS */,
		...
		// OCLstdlib::LibClassCS-0(oclstdlibcs::LibClassCS): { isAbstract?="abstract"[?] "type" name=AnyName ownedSignature=TemplateSignatureCS[?] { ":" metaclassName=AnyName }[?] { "conformsTo" ownedSuperTypes+=TypedRefCS { "," ownedSuperTypes+=TypedRefCS }[*] }[?] "{" { ownedOperations+=OperationCS[*] ownedProperties+=LibPropertyCS[*] ownedConstraints+=InvCS[*] ownedAnnotations+=AnnotationElementCS[*] } "}" }
		serializationRules[90] = createSerializationRule("LibClassCS-0", 45,
			createSerializationMatchSteps(
				62		/* assert |ClassCS::instanceClassName| == 0 */,
				88		/* assert |StructuredClassCS::isInterface| == 0 */,
				89		/* assert |StructuredClassCS::ownedMetaclass| == 0 */,
				...
				227		/* check-rule basecs::StructuredClassCS.ownedOperations : LibCoercionCS|LibIterationCS|LibOperationCS|OperationCS */,
				228		/* check-rule basecs::StructuredClassCS.ownedProperties : LibPropertyCS */,
				234		/* check-rule basecs::TemplateableElementCS.ownedSignature : TemplateSignatureCS */,
				229		/* check-rule basecs::StructuredClassCS.ownedSuperTypes : LambdaTypeCS|MapTypeCS|TupleTypeCS|TypedRefCS|TypedTypeRefCS */,
				203		/* assign V8 = |ModelElementCS::ownedAnnotations| */,
				199		/* assign V7 = |ClassCS::ownedConstraints| */,
				198		/* assign V6 = |StructuredClassCS::ownedProperties| */,
				195		/* assign V5 = |StructuredClassCS::ownedOperations| */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__OWNED_OPERATIONS, 30/* OperationCS */,
					(77/*OperationCS*/ << 4) | 2 /*[*]*/
				),
				...
				createSerializationReference(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__OWNED_SUPER_TYPES, 64/* TypedRefCS */,
					(119/*TypedRefCS*/ << 4) | 2 /*[*]*/
				)
			});
		...
		serializationRules[91] = createSerializationRule("LibCoercionCS-0", 46,
			createSerializationMatchSteps(
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				76		/* assert |OperationCS::ownedBodyExpressions| == 0 */,
			...
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				138		/* 'coercion' || soft-space value soft-space */,
		...
		serializationRules[92] = createSerializationRule("LibCoercionCS-1", 46,
			createSerializationMatchSteps(
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				76		/* assert |OperationCS::ownedBodyExpressions| == 0 */,
				77		/* assert |OperationCS::ownedExceptions| == 0 */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.OPERATION_CS__OWNED_POSTCONDITIONS, 38/* PreCS */,
					(83/*PreCS*/ << 4) | 2 /*[*]*/
				),
				createSerializationReference(BaseCSPackage.Literals.OPERATION_CS__OWNED_PRECONDITIONS, 37/* PostCS */,
					(82/*PostCS*/ << 4) | 2 /*[*]*/
				),
				createSerializationReference(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE, 63/* TypedMultiplicityRefCS */,
					(118/*TypedMultiplicityRefCS*/ << 4) | 0 /*[1]*/
		...
		serializationRules[93] = createSerializationRule("LibIterationCS-0", 47,
			createSerializationMatchSteps(
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				76		/* assert |OperationCS::ownedBodyExpressions| == 0 */,
				...
				80		/* assert |OperationCS::ownedPreconditions| == 0 */,
				93		/* assert |TypedElementCS::qualifiers| == 0 */,
				294		/* check-rule oclstdlibcs::LibIterationCS.ownedAccumulators : AccumulatorCS */,
				295		/* check-rule oclstdlibcs::LibIterationCS.ownedIterators : IteratorCS */,
			...
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				149		/* 'iteration' || soft-space value soft-space */,
				223		/* NamedElementCS::name=Name || soft-space value soft-space */,
				167		/* V00*1-steps || value */,
				85		/* TemplateableElementCS::ownedSignature=TemplateSignatureCS || value */,
				119		/* '(' || no-space value no-space */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.OPERATION_CS__OWNED_PARAMETERS, 33/* ParameterCS */,
					(79/*ParameterCS*/ << 4) | 2 /*[*]*/
				),
				createSerializationReference(BaseCSPackage.Literals.TEMPLATEABLE_ELEMENT_CS__OWNED_SIGNATURE, 53/* TemplateSignatureCS */,
					(105/*TemplateSignatureCS*/ << 4) | 1 /*[?]*/
		...
		serializationRules[94] = createSerializationRule("LibIterationCS-1", 47,
			createSerializationMatchSteps(
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				76		/* assert |OperationCS::ownedBodyExpressions| == 0 */,
				77		/* assert |OperationCS::ownedExceptions| == 0 */,
			...
			createSerializationSteps(
				...
				24		/* ModelElementCS::ownedAnnotations+=AnnotationElementCS || value */,
				185		/* V10*1-steps || value */,
				235		/* OperationCS::ownedPreconditions+=PostCS || value */,
				186		/* V11*1-steps || value */,
				234		/* OperationCS::ownedPostconditions+=PreCS || value */,
				166		/* '}' || pop soft-space value soft-new-line */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[95] = createSerializationRule("LibOperationCS-0", 48,
			createSerializationMatchSteps(
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				76		/* assert |OperationCS::ownedBodyExpressions| == 0 */,
			...
			createSerializationSteps(
				...
				154		/* 'operation' || soft-space value soft-space */,
				223		/* NamedElementCS::name=Name || soft-space value soft-space */,
				177		/* V01*1-steps || value */,
				85		/* TemplateableElementCS::ownedSignature=TemplateSignatureCS || value */,
				119		/* '(' || no-space value no-space */,
				192		/* V02*4-steps || value */,
				66		/* OperationCS::ownedParameters+=ParameterCS || value */,
				197		/* V03*2-steps || value */,
				123		/* ',' || no-space value soft-space */,
				66		/* OperationCS::ownedParameters+=ParameterCS || value */,
		...
		serializationRules[96] = createSerializationRule("LibOperationCS-1", 48,
			createSerializationMatchSteps(
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				77		/* assert |OperationCS::ownedExceptions| == 0 */,
				93		/* assert |TypedElementCS::qualifiers| == 0 */,
			...
			createSerializationSteps(
				...
				137		/* 'body' || soft-space value soft-space */,
				125		/* ':' || soft-space value soft-space */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.OPERATION_CS__OWNED_BODY_EXPRESSIONS, 48/* SpecificationCS */,
					(99/*SpecificationCS*/ << 4) | 2 /*[*]*/
				),
				createSerializationReference(BaseCSPackage.Literals.OPERATION_CS__OWNED_PARAMETERS, 33/* ParameterCS */,
					(79/*ParameterCS*/ << 4) | 2 /*[*]*/
				),
				createSerializationReference(BaseCSPackage.Literals.OPERATION_CS__OWNED_POSTCONDITIONS, 37/* PostCS */,
					(82/*PostCS*/ << 4) | 2 /*[*]*/
				),
				createSerializationReference(BaseCSPackage.Literals.OPERATION_CS__OWNED_PRECONDITIONS, 38/* PreCS */,
					(83/*PreCS*/ << 4) | 2 /*[*]*/
				),
				createSerializationReference(BaseCSPackage.Literals.TEMPLATEABLE_ELEMENT_CS__OWNED_SIGNATURE, 53/* TemplateSignatureCS */,
					(105/*TemplateSignatureCS*/ << 4) | 1 /*[?]*/
		...
		serializationRules[97] = createSerializationRule("LibOppositeCS-0", 49,
			createSerializationMatchSteps(
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				93		/* assert |TypedElementCS::qualifiers| == 0 */,
			...
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				155		/* 'opposite' || soft-space value soft-space */,
				223		/* NamedElementCS::name=Name || soft-space value soft-space */,
				125		/* ':' || soft-space value soft-space */,
				99		/* TypedElementCS::ownedType=TypedMultiplicityRefCS || value */
			),
		...
		serializationRules[98] = createSerializationRule("LibPackageCS-0", 50,
			createSerializationMatchSteps(
				214		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS */,
				...
				296		/* check-rule oclstdlibcs::LibPackageCS.ownedPrecedences : PrecedenceCS */,
				194		/* assign V5 = |ModelElementCS::ownedAnnotations| */,
				191		/* assign V4 = |PackageCS::ownedClasses| */,
				186		/* assign V3 = |PackageOwnerCS::ownedPackages| */,
				128		/* assign V0 = |PackageCS::nsURI| */,
			...
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				152		/* 'library' || soft-space value soft-space */,
				223		/* NamedElementCS::name=Name || soft-space value soft-space */,
				173		/* V00*4-steps || value */,
				125		/* ':' || soft-space value soft-space */,
				...
				163		/* '{' || soft-space value push soft-new-line */,
				183		/* V01*4-steps || value */,
				158		/* 'precedence' || soft-space value soft-space */,
				189		/* V02*1-steps || value */,
				80		/* LibPackageCS::ownedPrecedences+=PrecedenceCS || value */,
				127		/* ';' || no-space value soft-new-line */,
				195		/* V03*1-steps || value */,
				228		/* PackageOwnerCS::ownedPackages+=PackageCS || value */,
				200		/* V04*1-steps || value */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.PACKAGE_OWNER_CS__OWNED_PACKAGES, 32/* PackageCS */,
					(78/*PackageCS*/ << 4) | 2 /*[*]*/
				),
				createSerializationReference(OCLstdlibCSPackage.Literals.LIB_PACKAGE_CS__OWNED_PRECEDENCES, 39/* PrecedenceCS */,
					(84/*PrecedenceCS*/ << 4) | 2 /*[*]*/
				)
			});
		// OCLstdlib::LibPathElementCS-0(basecs::PathElementCS): referredElement=Name
		serializationRules[99] = createSerializationRule("LibPathElementCS-0", 51,
			createSerializationMatchSteps(
				45		/* assert (|PathElementCS::referredElement| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[100] = createSerializationRule("LibPathNameCS-0", 52,
			createSerializationMatchSteps(
		...
		serializationRules[101] = createSerializationRule("LibPropertyCS-0", 53,
			createSerializationMatchSteps(
				86		/* assert |StructuralFeatureCS::default| == 0 */,
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				87		/* assert |StructuralFeatureCS::ownedDefaultExpressions| == 0 */,
				93		/* assert |TypedElementCS::qualifiers| == 0 */,
				297		/* check-rule oclstdlibcs::LibPropertyCS.ownedOpposite : LibOppositeCS */,
				237		/* check-rule basecs::TypedElementCS.ownedType : TypedMultiplicityRefCS */,
				174		/* assign V2 = |JavaImplementationCS::implementation| */,
				154		/* assign V1 = |LibPropertyCS::ownedOpposite| */,
				56		/* assert (|TypedElementCS::ownedType| - 1) == 0 */,
			...
			createSerializationSteps(
				...
				159		/* 'property' || soft-space value soft-space */,
				223		/* NamedElementCS::name=Name || soft-space value soft-space */,
				125		/* ':' || soft-space value soft-space */,
				99		/* TypedElementCS::ownedType=TypedMultiplicityRefCS || value */,
				177		/* V01*1-steps || value */,
		...
		serializationRules[102] = createSerializationRule("LibPropertyCS-1", 53,
			createSerializationMatchSteps(
				86		/* assert |StructuralFeatureCS::default| == 0 */,
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				87		/* assert |StructuralFeatureCS::ownedDefaultExpressions| == 0 */,
		...
		serializationRules[103] = createSerializationRule("Library-0", 54,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				226		/* check-rule basecs::RootCS.ownedImports : ImportCS */,
			...
			createSerializationSteps(
				...
				127		/* ';' || no-space value soft-new-line */,
				178		/* V01*1-steps || value */,
				227		/* PackageOwnerCS::ownedPackages+=LibPackageCS || value */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[104] = createSerializationRule("PackageCS-0", 78,
			createSerializationMatchSteps(
				214		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS */,
				221		/* check-rule basecs::PackageCS.ownedClasses : ClassCS|LibClassCS */,
				223		/* check-rule basecs::PackageOwnerCS.ownedPackages : PackageCS */,
			...
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				156		/* 'package' || soft-space value soft-space */,
				223		/* NamedElementCS::name=Name || soft-space value soft-space */,
				173		/* V00*4-steps || value */,
				125		/* ':' || soft-space value soft-space */,
				20		/* PackageCS::nsPrefix=Identifier || soft-space value soft-space */,
		...
		serializationRules[105] = createSerializationRule("ParameterCS-0", 79,
			createSerializationMatchSteps(
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				93		/* assert |TypedElementCS::qualifiers| == 0 */,
		...
		serializationRules[106] = createSerializationRule("PostCS-0", 82,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				208		/* check-rule basecs::ConstraintCS.ownedMessageSpecification : SpecificationCS */,
				209		/* check-rule basecs::ConstraintCS.ownedSpecification : SpecificationCS */,
		...
		serializationRules[107] = createSerializationRule("PreCS-0", 83,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				208		/* check-rule basecs::ConstraintCS.ownedMessageSpecification : SpecificationCS */,
				209		/* check-rule basecs::ConstraintCS.ownedSpecification : SpecificationCS */,
		...
		serializationRules[108] = createSerializationRule("PrecedenceCS-0", 84,
			createSerializationMatchSteps(
				81		/* assert |PrecedenceCS::isRightAssociative| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				33		/* assert (|NamedElementCS::name| - 1) == 0 */
			...
			createSerializationSteps(
				216		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				150		/* 'left' || soft-space value soft-space */,
				125		/* ':' || soft-space value soft-space */,
				223		/* NamedElementCS::name=Name || soft-space value soft-space */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[109] = createSerializationRule("PrecedenceCS-1", 84,
			createSerializationMatchSteps(
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				33		/* assert (|NamedElementCS::name| - 1) == 0 */,
				48		/* assert (|PrecedenceCS::isRightAssociative.'right'| - 1) == 0 */
		...
		serializationRules[110] = createSerializationRule("SpecificationCS-0", 99,
			createSerializationMatchSteps(
				85		/* assert |SpecificationCS::exprString| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				257		/* check-rule essentialoclcs::ExpSpecificationCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				11		/* assert (|ExpSpecificationCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[111] = createSerializationRule("TuplePartCS-0", 108,
			createSerializationMatchSteps(
				92		/* assert |TypedElementCS::isOptional| == 0 */,
				68		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				93		/* assert |TypedElementCS::qualifiers| == 0 */,
		...
		serializationRules[112] = createSerializationRule("TypedMultiplicityRefCS-0", 118,
			createSerializationMatchSteps(
				211		/* check-rule basecs::LambdaTypeCS.ownedContextType : LambdaContextTypeRefCS */,
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				212		/* check-rule basecs::LambdaTypeCS.ownedParameterTypes : TypedMultiplicityRefCS */,
		...
		serializationRules[113] = createSerializationRule("TypedMultiplicityRefCS-1", 118,
			createSerializationMatchSteps(
				273		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				274		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
		...
		serializationRules[114] = createSerializationRule("TypedMultiplicityRefCS-2", 118,
			createSerializationMatchSteps(
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				235		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				187		/* assign V3 = |TypedRefCS::ownedMultiplicity| */,
		...
		serializationRules[115] = createSerializationRule("TypedMultiplicityRefCS-3", 118,
			createSerializationMatchSteps(
				96		/* assert |TypedTypeRefCS::ownedBinding| == 0 */,
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				240		/* check-rule basecs::TypedTypeRefCS.ownedPathName : LibPathNameCS */,
		...
		serializationRules[116] = createSerializationRule("TypedMultiplicityRefCS-4", 118,
			createSerializationMatchSteps(
				95		/* assert |TypedTypeRefCS::isTypeof| == 0 */,
				239		/* check-rule basecs::TypedTypeRefCS.ownedBinding : TemplateBindingCS */,
				238		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				240		/* check-rule basecs::TypedTypeRefCS.ownedPathName : LibPathNameCS */,
				162		/* assign V1 = |TypedRefCS::ownedMultiplicity| */,
				136		/* assign V0 = |TypedTypeRefCS::ownedBinding| */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__OWNED_BINDING, 51/* TemplateBindingCS */,
		...
		serializationRules[117] = createSerializationRule("TypedTypeRefCS-0", 120,
			createSerializationMatchSteps(
				96		/* assert |TypedTypeRefCS::ownedBinding| == 0 */,
				94		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				240		/* check-rule basecs::TypedTypeRefCS.ownedPathName : LibPathNameCS */,
		...
		serializationRules[118] = createSerializationRule("TypedTypeRefCS-1", 120,
			createSerializationMatchSteps(
				95		/* assert |TypedTypeRefCS::isTypeof| == 0 */,
				94		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				239		/* check-rule basecs::TypedTypeRefCS.ownedBinding : TemplateBindingCS */,
	...
	private void initSerializationSteps() {
		// 0: JavaImplementationCS::implementation=SINGLE_QUOTED_STRING || soft-space value soft-space
		serializationSteps[0] = createSerializationStepCrossReference(OCLstdlibCSPackage.Literals.JAVA_IMPLEMENTATION_CS__IMPLEMENTATION, getCrossReference(OCLstdlibCSPackage.Literals.JAVA_IMPLEMENTATION_CS__IMPLEMENTATION, "SINGLE_QUOTED_STRING"), 94, 7);
		// 1: StructuredClassCS::isAbstract?='abstract' || soft-space value soft-space
		serializationSteps[1] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__IS_ABSTRACT, 8 /* 'abstract' */, 7);
		// 2: ImportCS::isAll?='::*' || soft-space value soft-space
		serializationSteps[2] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.IMPORT_CS__IS_ALL, 2 /* '::*' */, 7);
		// 3: LibIterationCS::isInvalidating?='invalidating' || soft-space value soft-space
		serializationSteps[3] = createSerializationStepAssignKeyword(OCLstdlibCSPackage.Literals.LIB_ITERATION_CS__IS_INVALIDATING, 11 /* 'invalidating' */, 7);
		// 4: LibOperationCS::isInvalidating?='invalidating' || soft-space value soft-space
		serializationSteps[4] = createSerializationStepAssignKeyword(OCLstdlibCSPackage.Literals.LIB_OPERATION_CS__IS_INVALIDATING, 11 /* 'invalidating' */, 7);
		// 5: MultiplicityCS::isNullFree?='|1' || no-space value no-space
		serializationSteps[5] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.MULTIPLICITY_CS__IS_NULL_FREE, 19 /* '|1' */, 4);
		// 6: AbstractNameExpCS::isPre?='@' || soft-space value soft-space
		serializationSteps[6] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__IS_PRE, 4 /* '@' */, 7);
		// 7: PrecedenceCS::isRightAssociative?='right' || soft-space value soft-space
		serializationSteps[7] = createSerializationStepAssignKeyword(OCLstdlibCSPackage.Literals.PRECEDENCE_CS__IS_RIGHT_ASSOCIATIVE, 14 /* 'right' */, 7);
		// 8: LibOperationCS::isStatic?='static' || soft-space value soft-space
		serializationSteps[8] = createSerializationStepAssignKeyword(OCLstdlibCSPackage.Literals.LIB_OPERATION_CS__IS_STATIC, 15 /* 'static' */, 7);
		// 9: LibPropertyCS::isStatic?='static' || soft-space value soft-space
		serializationSteps[9] = createSerializationStepAssignKeyword(OCLstdlibCSPackage.Literals.LIB_PROPERTY_CS__IS_STATIC, 15 /* 'static' */, 7);
		// 10: TypedTypeRefCS::isTypeof?='typeof' || soft-space value soft-space
		serializationSteps[10] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__IS_TYPEOF, 16 /* 'typeof' */, 7);
		// 11: LibIterationCS::isValidating?='validating' || soft-space value soft-space
		serializationSteps[11] = createSerializationStepAssignKeyword(OCLstdlibCSPackage.Literals.LIB_ITERATION_CS__IS_VALIDATING, 17 /* 'validating' */, 7);
		// 12: LibOperationCS::isValidating?='validating' || soft-space value soft-space
		serializationSteps[12] = createSerializationStepAssignKeyword(OCLstdlibCSPackage.Literals.LIB_OPERATION_CS__IS_VALIDATING, 17 /* 'validating' */, 7);
		// 13: MultiplicityBoundsCS::lowerBound=LOWER || soft-space value soft-space
		serializationSteps[13] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.MULTIPLICITY_BOUNDS_CS__LOWER_BOUND, 39 /*LOWER*/, 7);
		// 14: LibClassCS::metaclassName=AnyName || soft-space value soft-space
		serializationSteps[14] = createSerializationStepCrossReference(OCLstdlibCSPackage.Literals.LIB_CLASS_CS__METACLASS_NAME, getCrossReference(OCLstdlibCSPackage.Literals.LIB_CLASS_CS__METACLASS_NAME, "AnyName"), 4, 7);
		// 15: CollectionTypeCS::name=CollectionTypeIdentifier || soft-space value soft-space
		serializationSteps[15] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__NAME, 13 /*CollectionTypeIdentifier*/, 7);
		// 16: LambdaTypeCS::name='Lambda' || soft-space value soft-space
		serializationSteps[16] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.LAMBDA_TYPE_CS__NAME, 5 /* 'Lambda' */, 7);
		// 17: MapTypeCS::name='Map' || soft-space value soft-space
		serializationSteps[17] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__NAME, 6 /* 'Map' */, 7);
		// 18: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier || soft-space value soft-space
		serializationSteps[18] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PRIMITIVE_TYPE_REF_CS__NAME, 90 /*PrimitiveTypeIdentifier*/, 7);
		// 19: TupleTypeCS::name='Tuple' || soft-space value soft-space
		serializationSteps[19] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.TUPLE_TYPE_CS__NAME, 7 /* 'Tuple' */, 7);
		// 20: PackageCS::nsPrefix=Identifier || soft-space value soft-space
		serializationSteps[20] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PACKAGE_CS__NS_PREFIX, 31 /*Identifier*/, 7);
		// 21: PackageCS::nsURI=URI || soft-space value soft-space
		serializationSteps[21] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PACKAGE_CS__NS_URI, 122 /*URI*/, 7);
		// 22: LibIterationCS::ownedAccumulators+=AccumulatorCS || value
		...
		// 27: PackageCS::ownedClasses+=ClassCS || half-new-line value half-new-line
		serializationSteps[27] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PACKAGE_CS__OWNED_CLASSES, 7 /*ClassCS*/, 3);
		// 28: NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS || value
		...
		// 47: RootCS::ownedImports+=ImportCS || value
		serializationSteps[47] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.ROOT_CS__OWNED_IMPORTS, 33 /*ImportCS*/, 0);
		// 48: LetExpCS::ownedInExpression=ExpCS || value
		...
		// 104: PatternExpCS::patternVariableName=UnrestrictedName || soft-space value soft-space
		serializationSteps[104] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS__PATTERN_VARIABLE_NAME, 128 /*UnrestrictedName*/, 7);
		// 105: LibOperationCS::precedence=Name || soft-space value soft-space
		serializationSteps[105] = createSerializationStepCrossReference(OCLstdlibCSPackage.Literals.LIB_OPERATION_CS__PRECEDENCE, getCrossReference(OCLstdlibCSPackage.Literals.LIB_OPERATION_CS__PRECEDENCE, "Name"), 65, 7);
		// 106: NavigatingArgCS::prefix=';' || no-space value soft-new-line
		serializationSteps[106] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__PREFIX, 3 /* ';' */, 5);
		// 107: NavigatingArgCS::prefix=',' || no-space value soft-space
		serializationSteps[107] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__PREFIX, 1 /* ',' */, 6);
		// 108: NavigatingArgCS::prefix='|' || soft-space value soft-space
		serializationSteps[108] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__PREFIX, 18 /* '|' */, 7);
		// 109: ShadowPartCS::referredProperty=UnrestrictedName || soft-space value soft-space
		serializationSteps[109] = createSerializationStepCrossReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__REFERRED_PROPERTY, getCrossReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__REFERRED_PROPERTY, "UnrestrictedName"), 128, 7);
		// 110: CollectionPatternCS::restVariableName=Identifier || soft-space value soft-space
		serializationSteps[110] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__REST_VARIABLE_NAME, 31 /*Identifier*/, 7);
		// 111: StringLiteralExpCS::segments+=StringLiteral || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		...
		// 112: MultiplicityStringCS::stringBounds='*|+|?' || soft-space value soft-space
		serializationSteps[112] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.MULTIPLICITY_STRING_CS__STRING_BOUNDS, 0 /* '*|+|?' */, 7);
		// 113: BooleanLiteralExpCS::symbol='false|true' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		...
		// 115: MultiplicityBoundsCS::upperBound=UPPER || soft-space value soft-space
		serializationSteps[115] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.MULTIPLICITY_BOUNDS_CS__UPPER_BOUND, 121 /*UPPER*/, 7);
		// 116: DocumentationCS::value=SINGLE_QUOTED_STRING || soft-space value soft-space
		serializationSteps[116] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.DOCUMENTATION_CS__VALUE, 94 /*SINGLE_QUOTED_STRING*/, 7);
		// 117: DetailCS::values+=SINGLE_QUOTED_STRING|ML_SINGLE_QUOTED_STRING || soft-space value soft-space
		serializationSteps[117] = createSerializationStepAssigns(BaseCSPackage.Literals.DETAIL_CS__VALUES, -1, new int[] { 94/*SINGLE_QUOTED_STRING*/,56/*ML_SINGLE_QUOTED_STRING*/}, 7);
		// 118: '&&' || soft-space value soft-space
		...
		// 123: ',' || no-space value soft-space
		serializationSteps[123] = createSerializationStepKeyword(",", 6);
		// 124: '..' || no-space value no-space
		serializationSteps[124] = createSerializationStepKeyword("..", 4);
		// 125: ':' || soft-space value soft-space
		serializationSteps[125] = createSerializationStepKeyword(":", 7);
		// 126: '::' || no-space value no-space
		serializationSteps[126] = createSerializationStepKeyword("::", 4);
		// 127: ';' || no-space value soft-new-line
		serializationSteps[127] = createSerializationStepKeyword(";", 5);
		// 128: '<-' || soft-space value soft-space
		...
		// 131: '?' || soft-space value soft-space
		serializationSteps[131] = createSerializationStepKeyword("?", 7);
		// 132: 'Lambda' || soft-space value soft-space
		serializationSteps[132] = createSerializationStepKeyword("Lambda", 7);
		// 133: 'Tuple' || soft-space value soft-space
		serializationSteps[133] = createSerializationStepKeyword("Tuple", 7);
		// 134: '[' || no-space value no-space
		serializationSteps[134] = createSerializationStepKeyword("[", 4);
		// 135: ']' || no-space value
		serializationSteps[135] = createSerializationStepKeyword("]", 1);
		// 136: 'annotation' || soft-space value soft-space
		serializationSteps[136] = createSerializationStepKeyword("annotation", 7);
		// 137: 'body' || soft-space value soft-space
		serializationSteps[137] = createSerializationStepKeyword("body", 7);
		// 138: 'coercion' || soft-space value soft-space
		serializationSteps[138] = createSerializationStepKeyword("coercion", 7);
		// 139: 'conformsTo' || soft-space value soft-space
		serializationSteps[139] = createSerializationStepKeyword("conformsTo", 7);
		// 140: 'documentation' || soft-space value soft-space
		...
		// 144: 'extends' || soft-space value soft-space
		serializationSteps[144] = createSerializationStepKeyword("extends", 7);
		// 145: 'if' || soft-space value soft-space
		serializationSteps[145] = createSerializationStepKeyword("if", 7);
		// 146: 'import' || soft-space value soft-space
		serializationSteps[146] = createSerializationStepKeyword("import", 7);
		// 147: 'in' || soft-space value soft-space
		serializationSteps[147] = createSerializationStepKeyword("in", 7);
		// 148: 'invalid' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[148] = createSerializationStepKeyword("invalid", 2);
		// 149: 'iteration' || soft-space value soft-space
		serializationSteps[149] = createSerializationStepKeyword("iteration", 7);
		// 150: 'left' || soft-space value soft-space
		serializationSteps[150] = createSerializationStepKeyword("left", 7);
		// 151: 'let' || soft-space value soft-space
		serializationSteps[151] = createSerializationStepKeyword("let", 7);
		// 152: 'library' || soft-space value soft-space
		serializationSteps[152] = createSerializationStepKeyword("library", 7);
		// 153: 'null' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[153] = createSerializationStepKeyword("null", 2);
		// 154: 'operation' || soft-space value soft-space
		serializationSteps[154] = createSerializationStepKeyword("operation", 7);
		// 155: 'opposite' || soft-space value soft-space
		serializationSteps[155] = createSerializationStepKeyword("opposite", 7);
		// 156: 'package' || soft-space value soft-space
		serializationSteps[156] = createSerializationStepKeyword("package", 7);
		// 157: 'pre' || soft-space value soft-space
		serializationSteps[157] = createSerializationStepKeyword("pre", 7);
		// 158: 'precedence' || soft-space value soft-space
		serializationSteps[158] = createSerializationStepKeyword("precedence", 7);
		// 159: 'property' || soft-space value soft-space
		serializationSteps[159] = createSerializationStepKeyword("property", 7);
		// 160: 'self' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[160] = createSerializationStepKeyword("self", 2);
		// 161: 'then' || soft-space value soft-space
		serializationSteps[161] = createSerializationStepKeyword("then", 7);
		// 162: 'type' || soft-space value soft-space
		serializationSteps[162] = createSerializationStepKeyword("type", 7);
		// 163: '{' || soft-space value push soft-new-line
		serializationSteps[163] = createSerializationStepKeyword("{", 9);
		// 164: '|' || soft-space value soft-space
		serializationSteps[164] = createSerializationStepKeyword("|", 7);
		// 165: '|?' || no-space value no-space
		serializationSteps[165] = createSerializationStepKeyword("|?", 4);
		// 166: '}' || pop soft-space value soft-new-line
		serializationSteps[166] = createSerializationStepKeyword("}", 8);
		// 167: V00*1-steps || value
		serializationSteps[167] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 1, 0);
		// 168: V00*1-steps || value
		serializationSteps[168] = createSerializationStepSequence((0/*V0*/ << 4) | 2/*[*]*/, 1, 0);
		// 169: V00*1-steps || value
		serializationSteps[169] = createSerializationStepSequence((0/*V0*/ << 4) | 3/*[+]*/, 1, 0);
		// 170: V00*2-steps || value
		serializationSteps[170] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 2, 0);
		// 171: V00*2-steps || value
		serializationSteps[171] = createSerializationStepSequence((0/*V0*/ << 4) | 2/*[*]*/, 2, 0);
		// 172: V00*3-steps || value
		serializationSteps[172] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 3, 0);
		// 173: V00*4-steps || value
		serializationSteps[173] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 4, 0);
		// 174: V00*5-steps || value
		serializationSteps[174] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 5, 0);
		// 175: V00*6-steps || value
		serializationSteps[175] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 6, 0);
		// 176: V00*7-steps || value
		serializationSteps[176] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 7, 0);
		// 177: V01*1-steps || value
		serializationSteps[177] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 1, 0);
		// 178: V01*1-steps || value
		serializationSteps[178] = createSerializationStepSequence((1/*V1*/ << 4) | 2/*[*]*/, 1, 0);
		// 179: V01*2-steps || value
		serializationSteps[179] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 2, 0);
		// 180: V01*2-steps || value
		serializationSteps[180] = createSerializationStepSequence((1/*V1*/ << 4) | 2/*[*]*/, 2, 0);
		// 181: V01*3-steps || value
		serializationSteps[181] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 3, 0);
		// 182: V01*4-steps || value
		serializationSteps[182] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 4, 0);
		// 183: V01*4-steps || value
		serializationSteps[183] = createSerializationStepSequence((1/*V1*/ << 4) | 2/*[*]*/, 4, 0);
		// 184: V01*6-steps || value
		serializationSteps[184] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 6, 0);
		// 185: V10*1-steps || value
		serializationSteps[185] = createSerializationStepSequence((10/*V10*/ << 4) | 2/*[*]*/, 1, 0);
		// 186: V11*1-steps || value
		serializationSteps[186] = createSerializationStepSequence((11/*V11*/ << 4) | 2/*[*]*/, 1, 0);
		// 187: V02*1-steps || value
		serializationSteps[187] = createSerializationStepSequence((2/*V2*/ << 4) | 1/*[?]*/, 1, 0);
		// 188: V02*1-steps || value
		serializationSteps[188] = createSerializationStepSequence((2/*V2*/ << 4) | 2/*[*]*/, 1, 0);
		// 189: V02*1-steps || value
		serializationSteps[189] = createSerializationStepSequence((2/*V2*/ << 4) | 3/*[+]*/, 1, 0);
		// 190: V02*2-steps || value
		serializationSteps[190] = createSerializationStepSequence((2/*V2*/ << 4) | 1/*[?]*/, 2, 0);
		// 191: V02*2-steps || value
		serializationSteps[191] = createSerializationStepSequence((2/*V2*/ << 4) | 2/*[*]*/, 2, 0);
		// 192: V02*4-steps || value
		serializationSteps[192] = createSerializationStepSequence((2/*V2*/ << 4) | 1/*[?]*/, 4, 0);
		// 193: V02*5-steps || value
		serializationSteps[193] = createSerializationStepSequence((2/*V2*/ << 4) | 1/*[?]*/, 5, 0);
		// 194: V03*1-steps || value
		serializationSteps[194] = createSerializationStepSequence((3/*V3*/ << 4) | 1/*[?]*/, 1, 0);
		// 195: V03*1-steps || value
		serializationSteps[195] = createSerializationStepSequence((3/*V3*/ << 4) | 2/*[*]*/, 1, 0);
		// 196: V03*2-steps || value
		serializationSteps[196] = createSerializationStepSequence((3/*V3*/ << 4) | 1/*[?]*/, 2, 0);
		// 197: V03*2-steps || value
		serializationSteps[197] = createSerializationStepSequence((3/*V3*/ << 4) | 2/*[*]*/, 2, 0);
		// 198: V03*5-steps || value
		serializationSteps[198] = createSerializationStepSequence((3/*V3*/ << 4) | 1/*[?]*/, 5, 0);
		// 199: V04*1-steps || value
		serializationSteps[199] = createSerializationStepSequence((4/*V4*/ << 4) | 1/*[?]*/, 1, 0);
		// 200: V04*1-steps || value
		serializationSteps[200] = createSerializationStepSequence((4/*V4*/ << 4) | 2/*[*]*/, 1, 0);
		// 201: V04*2-steps || value
		serializationSteps[201] = createSerializationStepSequence((4/*V4*/ << 4) | 2/*[*]*/, 2, 0);
		// 202: V04*5-steps || value
		serializationSteps[202] = createSerializationStepSequence((4/*V4*/ << 4) | 1/*[?]*/, 5, 0);
		// 203: V05*1-steps || value
		serializationSteps[203] = createSerializationStepSequence((5/*V5*/ << 4) | 1/*[?]*/, 1, 0);
		// 204: V05*1-steps || value
		serializationSteps[204] = createSerializationStepSequence((5/*V5*/ << 4) | 2/*[*]*/, 1, 0);
		// 205: V05*2-steps || value
		serializationSteps[205] = createSerializationStepSequence((5/*V5*/ << 4) | 2/*[*]*/, 2, 0);
		// 206: V06*1-steps || value
		serializationSteps[206] = createSerializationStepSequence((6/*V6*/ << 4) | 1/*[?]*/, 1, 0);
		// 207: V06*1-steps || value
		serializationSteps[207] = createSerializationStepSequence((6/*V6*/ << 4) | 2/*[*]*/, 1, 0);
		// 208: V06*3-steps || value
		serializationSteps[208] = createSerializationStepSequence((6/*V6*/ << 4) | 1/*[?]*/, 3, 0);
		// 209: V07*1-steps || value
		serializationSteps[209] = createSerializationStepSequence((7/*V7*/ << 4) | 1/*[?]*/, 1, 0);
		// 210: V07*1-steps || value
		serializationSteps[210] = createSerializationStepSequence((7/*V7*/ << 4) | 2/*[*]*/, 1, 0);
		// 211: V07*2-steps || value
		serializationSteps[211] = createSerializationStepSequence((7/*V7*/ << 4) | 1/*[?]*/, 2, 0);
		// 212: V08*1-steps || value
		serializationSteps[212] = createSerializationStepSequence((8/*V8*/ << 4) | 2/*[*]*/, 1, 0);
		// 213: V08*2-steps || value
		serializationSteps[213] = createSerializationStepSequence((8/*V8*/ << 4) | 1/*[?]*/, 2, 0);
		// 214: V08*4-steps || value
		...
		// 217: NamedElementCS::name=UnaryOperatorName || soft-space value soft-space
		serializationSteps[217] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 125 /*UnaryOperatorName*/, 7);
		// 218: NamedElementCS::name=UnrestrictedName || soft-space value soft-space
		serializationSteps[218] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 128 /*UnrestrictedName*/, 7);
		// 219: NamedElementCS::name=Identifier || soft-space value soft-space
		serializationSteps[219] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 31 /*Identifier*/, 7);
		// 220: NamedElementCS::name=Identifier|SINGLE_QUOTED_STRING || soft-space value soft-space
		serializationSteps[220] = createSerializationStepAssigns(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, -1, new int[] { 31/*Identifier*/,94/*SINGLE_QUOTED_STRING*/}, 7);
		// 221: NamedElementCS::name=AnyName || soft-space value soft-space
		serializationSteps[221] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 4 /*AnyName*/, 7);
		// 222: NamedElementCS::name=BinaryOperatorName || soft-space value soft-space
		serializationSteps[222] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 5 /*BinaryOperatorName*/, 7);
		// 223: NamedElementCS::name=Name || soft-space value soft-space
		serializationSteps[223] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 65 /*Name*/, 7);
		// 224: NamedElementCS::name=Name|SINGLE_QUOTED_STRING || soft-space value soft-space
		serializationSteps[224] = createSerializationStepAssigns(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, -1, new int[] { 65/*Name*/,94/*SINGLE_QUOTED_STRING*/}, 7);
		// 225: RoundBracketedClauseCS::ownedArguments+=NavigatingArgCS || value
		...
		// 227: PackageOwnerCS::ownedPackages+=LibPackageCS || value
		serializationSteps[227] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PACKAGE_OWNER_CS__OWNED_PACKAGES, 50 /*LibPackageCS*/, 0);
		// 228: PackageOwnerCS::ownedPackages+=PackageCS || value
		serializationSteps[228] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PACKAGE_OWNER_CS__OWNED_PACKAGES, 78 /*PackageCS*/, 0);
		// 229: PathNameCS::ownedPathElements+=URIFirstPathElementCS || value
		...
		// 240: PathElementCS::referredElement=Name || soft-space value soft-space
		serializationSteps[240] = createSerializationStepCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, getCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, "Name"), 65, 7);
		// 241: PathElementCS::referredElement=URI || soft-space value soft-space
		serializationSteps[241] = createSerializationStepCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, getCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, "URI"), 122, 7);
		// 242: PathElementCS::referredElement=UnreservedName || soft-space value soft-space
		serializationSteps[242] = createSerializationStepCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, getCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, "UnreservedName"), 127, 7);
		// 243: PathElementCS::referredElement=UnrestrictedName || soft-space value soft-space
		serializationSteps[243] = createSerializationStepCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, getCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, "UnrestrictedName"), 128, 7);
		// 244: ConstraintCS::stereotype='inv' || soft-space value soft-space
		serializationSteps[244] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.CONSTRAINT_CS__STEREOTYPE, 10 /* 'inv' */, 7);
		// 245: ConstraintCS::stereotype='post' || soft-space value soft-space
		serializationSteps[245] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.CONSTRAINT_CS__STEREOTYPE, 12 /* 'post' */, 7);
		// 246: ConstraintCS::stereotype='pre' || soft-space value soft-space
		serializationSteps[246] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.CONSTRAINT_CS__STEREOTYPE, 13 /* 'pre' */, 7);
	}
}
