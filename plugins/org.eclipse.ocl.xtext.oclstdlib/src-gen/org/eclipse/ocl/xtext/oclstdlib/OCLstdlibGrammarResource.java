...
public class OCLstdlibGrammarResource extends AbstractGrammarResource
{
	...
	private static class _OCLstdlib
	{
		...
		private static void initParserRules() {
			...
			PR_LibPackageCS.setAlternatives(createGroup(createKeyword("library"), createAssignment("name", "=", createRuleCall(PR_Name)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("nsPrefix", "=", createRuleCall(PR_Identifier)), createKeyword("="), createAssignment("nsURI", "=", createRuleCall(_Base.PR_URI)))), createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedPackages", "+=", createRuleCall(PR_PackageCS)), createGroup(createKeyword("precedence"), setCardinality("+", createAssignment("ownedPrecedences", "+=", createRuleCall(PR_PrecedenceCS))), createKeyword(";")), createAssignment("ownedClasses", "+=", createRuleCall(PR_ClassCS)), createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS)))), createKeyword("}")));
			...
			PR_PostCS.setAlternatives(createGroup(createAssignment("stereotype", "=", createKeyword("post")), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(_EssentialOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedMessageSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(")"))))), createKeyword(":"), createAssignment("ownedSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(";")));
			PR_PreCS.setAlternatives(createGroup(createAssignment("stereotype", "=", createKeyword("pre")), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(_EssentialOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedMessageSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(")"))))), createKeyword(":"), createAssignment("ownedSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(";")));
