...
public class OCLstdlibGrammarResource extends AbstractGrammarResource
{
	...
	private static class _OCLstdlib
	{
		...
		private static void initParserRules() {
			...
			PR_AnnotationCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("annotation"), createAssignment("name", "=", createAlternatives(createRuleCall(PR_Identifier), createRuleCall(_Base.TR_SINGLE_QUOTED_STRING))), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedDetails", "+=", createRuleCall(PR_DetailCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedDetails", "+=", createRuleCall(PR_DetailCS)))), createKeyword(")"))), createAlternatives(createGroup(createKeyword("{"), createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS)), createKeyword("}")), createKeyword(";"))));
			PR_AnnotationElementCS.setAlternatives(createAlternatives(createRuleCall(PR_AnnotationCS), createRuleCall(PR_DocumentationCS)));
			PR_AnyName.setAlternatives(createAlternatives(createRuleCall(PR_Name), createKeyword("Lambda"), createKeyword("Map"), createKeyword("Tuple")));
			PR_ClassCS.setAlternatives(createRuleCall(PR_LibClassCS));
			...
			PR_ImportCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("import"), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(PR_Identifier)), createKeyword(":"))), createAssignment("ownedPathName", "=", createRuleCall(_EssentialOCL.PR_URIPathNameCS)), setCardinality("?", createAssignment("isAll", "?=", createKeyword("::*")))));
			PR_InvCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createAssignment("stereotype", "=", createKeyword("inv")), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(_EssentialOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedMessageSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(")"))))), createKeyword(":"), createAssignment("ownedSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(";")));
			...
			PR_LambdaTypeCS.setAlternatives(createGroup(createAssignment("name", "=", createKeyword("Lambda")), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(_Base.PR_TemplateSignatureCS))), createAssignment("ownedContextType", "=", createRuleCall(PR_LambdaContextTypeRefCS)), createKeyword("("), setCardinality("?", createGroup(createAssignment("ownedParameterTypes", "+=", createRuleCall(PR_TypedMultiplicityRefCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedParameterTypes", "+=", createRuleCall(PR_TypedMultiplicityRefCS)))))), createKeyword(")"), createKeyword(":"), createAssignment("ownedResultType", "=", createRuleCall(PR_TypedRefCS))));
			PR_LibClassCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), setCardinality("?", createAssignment("isAbstract", "?=", createKeyword("abstract"))), createKeyword("type"), createAssignment("name", "=", createRuleCall(PR_AnyName)), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(_Base.PR_TemplateSignatureCS))), setCardinality("?", createGroup(createKeyword(":"), createAssignment("metaclassName", "=", createCrossReference(createTypeRef(MM, org.eclipse.ocl.xtext.oclstdlibcs.OCLstdlibCSPackage.Literals.METACLASS_NAME_CS), createRuleCall(PR_AnyName))))), setCardinality("?", createGroup(createKeyword("conformsTo"), createAssignment("ownedSuperTypes", "+=", createRuleCall(PR_TypedRefCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedSuperTypes", "+=", createRuleCall(PR_TypedRefCS)))))), createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedOperations", "+=", createRuleCall(PR_OperationCS)), createAssignment("ownedProperties", "+=", createRuleCall(PR_LibPropertyCS)), createAssignment("ownedConstraints", "+=", createRuleCall(PR_InvCS)), createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS)))), createKeyword("}")));
			PR_LibCoercionCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("coercion"), createAssignment("name", "=", createRuleCall(PR_Name)), createKeyword("("), createKeyword(")"), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypedMultiplicityRefCS)), setCardinality("?", createGroup(createKeyword("=>"), createAssignment("implementation", "=", createCrossReference(createTypeRef(MM, org.eclipse.ocl.xtext.oclstdlibcs.OCLstdlibCSPackage.Literals.JAVA_CLASS_CS), createRuleCall(_Base.TR_SINGLE_QUOTED_STRING))))), createAlternatives(createGroup(createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS)), createAssignment("ownedPreconditions", "+=", createRuleCall(PR_PostCS)), createAssignment("ownedPostconditions", "+=", createRuleCall(PR_PreCS)))), createKeyword("}")), createKeyword(";"))));
			PR_LibIterationCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("iteration"), createAssignment("name", "=", createRuleCall(PR_Name)), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(_Base.PR_TemplateSignatureCS))), createKeyword("("), createAssignment("ownedIterators", "+=", createRuleCall(PR_IteratorCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedIterators", "+=", createRuleCall(PR_IteratorCS)))), setCardinality("?", createGroup(createKeyword(";"), createAssignment("ownedAccumulators", "+=", createRuleCall(PR_AccumulatorCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedAccumulators", "+=", createRuleCall(PR_AccumulatorCS)))))), setCardinality("?", createGroup(createKeyword("|"), createAssignment("ownedParameters", "+=", createRuleCall(PR_ParameterCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedParameters", "+=", createRuleCall(PR_ParameterCS)))))), createKeyword(")"), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypedMultiplicityRefCS)), setCardinality("?", createAssignment("isInvalidating", "?=", createKeyword("invalidating"))), setCardinality("?", createAssignment("isValidating", "?=", createKeyword("validating"))), setCardinality("?", createGroup(createKeyword("=>"), createAssignment("implementation", "=", createCrossReference(createTypeRef(MM, org.eclipse.ocl.xtext.oclstdlibcs.OCLstdlibCSPackage.Literals.JAVA_CLASS_CS), createRuleCall(_Base.TR_SINGLE_QUOTED_STRING))))), createAlternatives(createGroup(createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS)), createAssignment("ownedPreconditions", "+=", createRuleCall(PR_PostCS)), createAssignment("ownedPostconditions", "+=", createRuleCall(PR_PreCS)))), createKeyword("}")), createKeyword(";"))));
			PR_LibOperationCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), setCardinality("?", createAssignment("isStatic", "?=", createKeyword("static"))), createKeyword("operation"), createAssignment("name", "=", createRuleCall(PR_Name)), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(_Base.PR_TemplateSignatureCS))), createKeyword("("), setCardinality("?", createGroup(createAssignment("ownedParameters", "+=", createRuleCall(PR_ParameterCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedParameters", "+=", createRuleCall(PR_ParameterCS)))))), createKeyword(")"), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypedMultiplicityRefCS)), setCardinality("?", createAssignment("isValidating", "?=", createKeyword("validating"))), setCardinality("?", createAssignment("isInvalidating", "?=", createKeyword("invalidating"))), setCardinality("?", createGroup(createKeyword("precedence"), createKeyword("="), createAssignment("precedence", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PRECEDENCE), createRuleCall(PR_Name))))), setCardinality("?", createGroup(createKeyword("=>"), createAssignment("implementation", "=", createCrossReference(createTypeRef(MM, org.eclipse.ocl.xtext.oclstdlibcs.OCLstdlibCSPackage.Literals.JAVA_CLASS_CS), createRuleCall(_Base.TR_SINGLE_QUOTED_STRING))))), createAlternatives(createGroup(createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS)), createGroup(createKeyword("body"), setCardinality("?", createRuleCall(_EssentialOCL.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedBodyExpressions", "+=", createRuleCall(PR_SpecificationCS)), createKeyword(";")), createAssignment("ownedPostconditions", "+=", createRuleCall(PR_PostCS)), createAssignment("ownedPreconditions", "+=", createRuleCall(PR_PreCS)))), createKeyword("}")), createKeyword(";"))));
			PR_LibOppositeCS.setAlternatives(createGroup(createKeyword("opposite"), createAssignment("name", "=", createRuleCall(PR_Name)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypedMultiplicityRefCS))));
			PR_LibPackageCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("library"), createAssignment("name", "=", createRuleCall(PR_Name)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("nsPrefix", "=", createRuleCall(PR_Identifier)), createKeyword("="), createAssignment("nsURI", "=", createRuleCall(_Base.PR_URI)))), createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedPackages", "+=", createRuleCall(PR_PackageCS)), createGroup(createKeyword("precedence"), setCardinality("+", createAssignment("ownedPrecedences", "+=", createRuleCall(PR_PrecedenceCS))), createKeyword(";")), createAssignment("ownedClasses", "+=", createRuleCall(PR_ClassCS)), createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS)))), createKeyword("}")));
			...
			PR_LibPropertyCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), setCardinality("?", createAssignment("isStatic", "?=", createKeyword("static"))), createKeyword("property"), createAssignment("name", "=", createRuleCall(PR_Name)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypedMultiplicityRefCS)), setCardinality("?", createAssignment("ownedOpposite", "=", createRuleCall(PR_LibOppositeCS))), setCardinality("?", createGroup(createKeyword("=>"), createAssignment("implementation", "=", createCrossReference(createTypeRef(MM, org.eclipse.ocl.xtext.oclstdlibcs.OCLstdlibCSPackage.Literals.JAVA_CLASS_CS), createRuleCall(_Base.TR_SINGLE_QUOTED_STRING))))), createAlternatives(createGroup(createKeyword("{"), setCardinality("*", createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS))), createKeyword("}")), createKeyword(";"))));
			PR_Library.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), setCardinality("*", createGroup(createAssignment("ownedImports", "+=", createRuleCall(PR_ImportCS)), createKeyword(";"))), setCardinality("*", createAssignment("ownedPackages", "+=", createRuleCall(PR_LibPackageCS)))));
			...
			PR_PackageCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("package"), createAssignment("name", "=", createRuleCall(PR_Name)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("nsPrefix", "=", createRuleCall(PR_Identifier)), createKeyword("="), createAssignment("nsURI", "=", createRuleCall(_Base.PR_URI)))), createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedPackages", "+=", createRuleCall(PR_PackageCS)), createAssignment("ownedClasses", "+=", createRuleCall(PR_ClassCS)), createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS)))), createKeyword("}")));
			PR_ParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_Identifier)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypedMultiplicityRefCS))));
			PR_PostCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createAssignment("stereotype", "=", createKeyword("post")), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(_EssentialOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedMessageSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(")"))))), createKeyword(":"), createAssignment("ownedSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(";")));
			PR_PreCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createAssignment("stereotype", "=", createKeyword("pre")), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(_EssentialOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedMessageSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(")"))))), createKeyword(":"), createAssignment("ownedSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(";")));
			PR_PrecedenceCS.setAlternatives(createGroup(createAlternatives(createKeyword("left"), createAssignment("isRightAssociative", "?=", createKeyword("right"))), createKeyword(":"), createAssignment("name", "=", createRuleCall(PR_Name))));
			PR_RestrictedKeywords.setAlternatives(createAlternatives(createKeyword("abstract"), createKeyword("annotation"), createKeyword("conformsTo"), createKeyword("documentation"), createKeyword("extends"), createKeyword("import"), createKeyword("inv"), createKeyword("invalidating"), createKeyword("iteration"), createKeyword("left"), createKeyword("library"), createKeyword("operation"), createKeyword("opposite"), createKeyword("package"), createKeyword("post"), createKeyword("pre"), createKeyword("precedence"), createKeyword("property"), createKeyword("right"), createKeyword("static"), createKeyword("type"), createKeyword("validating")));
			PR_SpecificationCS.setAlternatives(createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)));
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_Identifier)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypedMultiplicityRefCS))));
			PR_TypedMultiplicityRefCS.setAlternatives(createGroup(createAlternatives(createRuleCall(_EssentialOCL.PR_MapTypeCS), createRuleCall(_EssentialOCL.PR_TupleTypeCS), createRuleCall(PR_TypedTypeRefCS), createRuleCall(PR_LambdaTypeCS)), setCardinality("?", createAssignment("ownedMultiplicity", "=", createRuleCall(_Base.PR_MultiplicityCS)))));
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_CoIteratorVariableCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS))))));
			...
			PR_EssentialOCLInfixOperatorName.setAlternatives(createAlternatives(createKeyword("*"), createKeyword("/"), createKeyword("+"), createKeyword("-"), createKeyword(">"), createKeyword("<"), createKeyword(">="), createKeyword("<="), createKeyword("="), createKeyword("<>"), createKeyword("and"), createKeyword("and2"), createKeyword("implies"), createKeyword("implies2"), createKeyword("or"), createKeyword("or2"), createKeyword("xor"), createKeyword("xor2")));
			...
			PR_EssentialOCLReservedKeyword.setAlternatives(createAlternatives(createKeyword("and"), createKeyword("and2"), createKeyword("else"), createKeyword("endif"), createKeyword("if"), createKeyword("implies"), createKeyword("implies2"), createKeyword("in"), createKeyword("let"), createKeyword("not"), createKeyword("not2"), createKeyword("or"), createKeyword("or2"), createKeyword("then"), createKeyword("xor"), createKeyword("xor2")));
			PR_EssentialOCLUnaryOperatorName.setAlternatives(createAlternatives(createKeyword("-"), createKeyword("not"), createKeyword("not2")));
			...
			PR_EssentialOCLUnrestrictedName.setAlternatives(createRuleCall(_OCLstdlib.PR_Identifier));
			...
			PR_NavigatingArgCS.setAlternatives(createAlternatives(createGroup(createAssignment("ownedNameExpression", "=", createRuleCall(PR_NavigatingArgExpCS)), setCardinality("?", createAlternatives(createGroup(createKeyword("<-"), createAssignment("ownedCoIterator", "=", createRuleCall(PR_CoIteratorVariableCS)), setCardinality("?", createGroup(createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))))), createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)), setCardinality("?", createGroup(createKeyword("<-"), createAssignment("ownedCoIterator", "=", createRuleCall(PR_CoIteratorVariableCS)))), setCardinality("?", createGroup(createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))))), createGroup(setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)))), setCardinality("?", createGroup(createKeyword("<-"), createAssignment("ownedCoIterator", "=", createRuleCall(PR_CoIteratorVariableCS)))), createKeyword("in"), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS)))))), createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)))));
			...
			PR_NavigatingCommaArgCS.setAlternatives(createGroup(createAssignment("prefix", "=", createKeyword(",")), createAssignment("ownedNameExpression", "=", createRuleCall(PR_NavigatingArgExpCS)), setCardinality("?", createAlternatives(createGroup(createKeyword("<-"), createAssignment("ownedCoIterator", "=", createRuleCall(PR_CoIteratorVariableCS)), setCardinality("?", createGroup(createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))))), createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)), setCardinality("?", createGroup(createKeyword("<-"), createAssignment("ownedCoIterator", "=", createRuleCall(PR_CoIteratorVariableCS)))), setCardinality("?", createGroup(createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))))), createGroup(setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)))), setCardinality("?", createGroup(createKeyword("<-"), createAssignment("ownedCoIterator", "=", createRuleCall(PR_CoIteratorVariableCS)))), createKeyword("in"), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS)))))));
			...
			PR_RoundBracketedClauseCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.ocl.xtext.essentialoclcs.EssentialOCLCSPackage.Literals.ROUND_BRACKETED_CLAUSE_CS)), createKeyword("("), setCardinality("?", createGroup(createAssignment("ownedArguments", "+=", createRuleCall(PR_NavigatingArgCS)), setCardinality("*", createAssignment("ownedArguments", "+=", createAlternatives(createRuleCall(PR_NavigatingCommaArgCS), createRuleCall(PR_NavigatingSemiArgCS), createRuleCall(PR_NavigatingBarArgCS)))))), createKeyword(")")));
			...
			PR_SimplePathNameCS.setAlternatives(createAssignment("ownedPathElements", "+=", createRuleCall(_Base.PR_FirstPathElementCS)));
			...
			PR_TupleTypeCS.setAlternatives(createGroup(createAssignment("name", "=", createKeyword("Tuple")), setCardinality("?", createGroup(createKeyword("("), setCardinality("?", createGroup(createAssignment("ownedParts", "+=", createRuleCall(_OCLstdlib.PR_TuplePartCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedParts", "+=", createRuleCall(_OCLstdlib.PR_TuplePartCS)))))), createKeyword(")")))));
			...
			PR_TypeExpWithoutMultiplicityCS.setAlternatives(createAlternatives(createRuleCall(PR_TypeNameExpCS), createRuleCall(PR_TypeLiteralCS), createRuleCall(PR_CollectionPatternCS)));
	...
	private static class _Base
	{
		...
		private static void initParserRules() {
			...
			PR_TypeParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_EssentialOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedExtends", "+=", createRuleCall(_OCLstdlib.PR_TypedRefCS)), setCardinality("*", createGroup(createKeyword("&&"), createAssignment("ownedExtends", "+=", createRuleCall(_OCLstdlib.PR_TypedRefCS))))))));
			PR_TypeRefCS.setAlternatives(createAlternatives(createRuleCall(_OCLstdlib.PR_TypedRefCS), createRuleCall(PR_WildcardTypeRefCS)));
			PR_TypedRefCS.setAlternatives(createRuleCall(_OCLstdlib.PR_TypedTypeRefCS));
