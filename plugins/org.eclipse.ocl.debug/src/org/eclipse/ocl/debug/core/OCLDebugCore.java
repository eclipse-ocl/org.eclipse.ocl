 ...
 *******************************************************************************/
package org.eclipse.ocl.debug.core;
...
import org.eclipse.ocl.debug.OCLDebugPlugin;
import org.eclipse.ocl.debug.vm.core.VMDebugCore;
import org.eclipse.ocl.debug.vm.utils.Trace;
...
public class OCLDebugCore extends VMDebugCore
{
	...
	public static final @NonNull String BREAKPOINT_MARKER_ID = "org.eclipse.ocl.debug.OCLBreakpointMarker"; //$NON-NLS-1
	public static final @NonNull String MODEL_ID = "org.eclipse.ocl.debug"; //$NON-NLS-1$
	public static final @NonNull String DEBUGGER_ACTIVE_PROPERTY = "org.eclipse.ocl.debug.debuggerActive"; //$NON-NLS-1$
