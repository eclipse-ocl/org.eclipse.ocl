...
public class Id2EClassVisitor implements IdVisitor<@Nullable EClass>
{
	...
	@Override
	public @Nullable EClass visitCompletePackageId(@NonNull CompletePackageId id) {
		return null;
	}
	...
	@Override
	public @Nullable EClass visitPartId(@NonNull PartId id) {
		return null;
	}
	...
	@Override
	public @Nullable EClass visitWildcardId(@NonNull WildcardId id) {
		return visiting(id);
	}
