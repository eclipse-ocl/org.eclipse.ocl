...
/**
 * A BytePrimitiveDescriptor describes the byte type and any associated irregular code generation patterns.
 */
public class BytePrimitiveDescriptor extends AbstractPrimitiveDescriptor
{
	public BytePrimitiveDescriptor(@NonNull ElementId elementId) {
		super(elementId, byte.class, Byte.class);
	}
