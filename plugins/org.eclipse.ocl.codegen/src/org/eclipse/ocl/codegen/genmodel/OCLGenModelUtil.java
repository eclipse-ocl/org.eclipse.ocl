 ...
 *******************************************************************************/
package org.eclipse.ocl.codegen.genmodel;
...
import org.eclipse.ocl.codegen.oclinecore.OCLinEcoreGeneratorAdapterFactory;
...
public abstract class OCLGenModelUtil
{
	...
	public static @NonNull Iterable<GeneratorAdapterFactory.@NonNull Descriptor> getGeneratorAdapterFactoryDescriptors() {
		...
		@SuppressWarnings("deprecation") GeneratorAdapterFactory.@NonNull Descriptor betterEstructureDescriptor = org.eclipse.ocl.codegen.genmodel.OCLGenModelGeneratorAdapterFactory.DESCRIPTOR;
