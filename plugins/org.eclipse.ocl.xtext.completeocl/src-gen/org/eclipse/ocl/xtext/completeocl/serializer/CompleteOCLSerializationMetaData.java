...
public class CompleteOCLSerializationMetaData extends AbstractSerializationMetaData
{
	...
	private final @NonNull SerializationMatchStep @NonNull [] serializationMatchSteps = new @NonNull SerializationMatchStep[232];
	...
	private void initEClassValues() {
		eClassValues[0] = new EClassValue(EssentialOCLCSPackage.Literals.BOOLEAN_LITERAL_EXP_CS,
			createSerializationRules(
				33 /* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */
			), null
		);
		eClassValues[1] = new EClassValue(CompleteOCLCSPackage.Literals.CLASSIFIER_CONTEXT_DECL_CS,
			createSerializationRules(
				16 /* ClassifierContextDeclCS-0: 'context' (TemplateableElementCS::ownedSignature=TemplateSignatureCS)[V0:?] (ClassifierContextDeclCS::selfName=UnrestrictedName)[V1:?] PathNameDeclCS::ownedPathName=PathNameCS ('inv' ClassifierContextDeclCS::ownedInvariants+=ConstraintCS)[V2:+] (ClassifierContextDeclCS::ownedDefinitions+=DefCS)[V3:*] */,
				17 /* ClassifierContextDeclCS-1: 'context' (TemplateableElementCS::ownedSignature=TemplateSignatureCS)[V0:?] (ClassifierContextDeclCS::selfName=UnrestrictedName)[V1:?] PathNameDeclCS::ownedPathName=PathNameCS ('inv' ClassifierContextDeclCS::ownedInvariants+=ConstraintCS)[V2:*] (ClassifierContextDeclCS::ownedDefinitions+=DefCS)[V3:+] */
			),
		...
		eClassValues[2] = new EClassValue(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_EXP_CS,
			createSerializationRules(
				35 /* CollectionLiteralExpCS-0: CollectionLiteralExpCS::ownedType=CollectionTypeCS '{' (CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS (',' CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS)[V1:*])[V0:?] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[3] = new EClassValue(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS,
			createSerializationRules(
				37 /* CollectionLiteralPartCS-1: CollectionLiteralPartCS::ownedExpression=PatternExpCS */,
				36 /* CollectionLiteralPartCS-0: CollectionLiteralPartCS::ownedExpression=ExpCS ('..' CollectionLiteralPartCS::ownedLastExpression=ExpCS)[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[4] = new EClassValue(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS,
			createSerializationRules(
				38 /* CollectionPatternCS-0: CollectionPatternCS::ownedType=CollectionTypeCS '{' (CollectionPatternCS::ownedParts+=PatternExpCS (',' CollectionPatternCS::ownedParts+=PatternExpCS)[V1:*] '++' CollectionPatternCS::restVariableName=Identifier)[V0:?] '}' */,
				86 /* TypeExpCS-4: CollectionPatternCS::ownedType=CollectionTypeCS '{' (CollectionPatternCS::ownedParts+=PatternExpCS (',' CollectionPatternCS::ownedParts+=PatternExpCS)[V1:*] '++' CollectionPatternCS::restVariableName=Identifier)[V0:?] '}' (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V2:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[5] = new EClassValue(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS,
			createSerializationRules(
				39 /* CollectionTypeCS-0: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] */,
				83 /* TypeExpCS-1: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V2:?] */,
				90 /* TypeLiteralWithMultiplicityCS-1: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V2:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[6] = new EClassValue(CompleteOCLCSPackage.Literals.COMPLETE_OCL_DOCUMENT_CS,
			createSerializationRules(
				18 /* CompleteOCLDocumentCS-0: (RootCS::ownedImports+=ImportCS)[V0:*] (CompleteOCLDocumentCS::ownedPackages+=PackageDeclarationCS)[V1:*] (CompleteOCLDocumentCS::ownedContexts+=ContextDeclCS)[V2:*] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[7] = new EClassValue(BaseCSPackage.Literals.CONSTRAINT_CS,
			createSerializationRules(
				19 /* ConstraintCS-0: (NamedElementCS::name=UnrestrictedName ('(' ConstraintCS::ownedMessageSpecification=SpecificationCS ')')[V1:?])[V0:?] ':' ConstraintCS::ownedSpecification=SpecificationCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[8] = new EClassValue(EssentialOCLCSPackage.Literals.CONTEXT_CS,
			createSerializationRules(
				51 /* Model-0: ContextCS::ownedExpression=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[9] = new EClassValue(EssentialOCLCSPackage.Literals.CURLY_BRACKETED_CLAUSE_CS,
			createSerializationRules(
				40 /* CurlyBracketedClauseCS-0: '{' (CurlyBracketedClauseCS::ownedParts+=ShadowPartCS (',' CurlyBracketedClauseCS::ownedParts+=ShadowPartCS)[V1:*])[V0:?] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[13] = new EClassValue(EssentialOCLCSPackage.Literals.IF_EXP_CS,
			createSerializationRules(
				43 /* IfExpCS-0: 'if' IfExpCS::ownedCondition=ExpCS|PatternExpCS 'then' IfExpCS::ownedThenExpression=ExpCS (IfExpCS::ownedIfThenExpressions+=ElseIfThenExpCS)[V0:*] 'else' IfExpCS::ownedElseExpression=ExpCS 'endif' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[14] = new EClassValue(EssentialOCLCSPackage.Literals.IF_THEN_EXP_CS,
			createSerializationRules(
				41 /* ElseIfThenExpCS-0: 'elseif' IfThenExpCS::ownedCondition=ExpCS 'then' IfThenExpCS::ownedThenExpression=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[16] = new EClassValue(EssentialOCLCSPackage.Literals.INFIX_EXP_CS,
			createSerializationRules(
				42 /* ExpCS-18: InfixExpCS::ownedLeft=PrefixedPrimaryExpCS NamedElementCS::name=BinaryOperatorName OperatorExpCS::ownedRight=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[17] = new EClassValue(EssentialOCLCSPackage.Literals.INVALID_LITERAL_EXP_CS,
			createSerializationRules(
				44 /* InvalidLiteralExpCS-0: 'invalid' */
			), null
		);
		eClassValues[18] = new EClassValue(EssentialOCLCSPackage.Literals.LAMBDA_LITERAL_EXP_CS,
			createSerializationRules(
				45 /* LambdaLiteralExpCS-0: 'Lambda' '{' LambdaLiteralExpCS::ownedExpressionCS=ExpCS '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[19] = new EClassValue(EssentialOCLCSPackage.Literals.LET_EXP_CS,
			createSerializationRules(
				46 /* LetExpCS-0: 'let' LetExpCS::ownedVariables+=LetVariableCS (',' LetExpCS::ownedVariables+=LetVariableCS)[V0:*] 'in' LetExpCS::ownedInExpression=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[20] = new EClassValue(EssentialOCLCSPackage.Literals.LET_VARIABLE_CS,
			createSerializationRules(
				47 /* LetVariableCS-0: NamedElementCS::name=UnrestrictedName (LetVariableCS::ownedRoundBracketedClause=RoundBracketedClauseCS)[V0:?] (':' VariableCS::ownedType=TypeExpCS)[V1:?] '=' VariableCS::ownedInitExpression=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[21] = new EClassValue(EssentialOCLCSPackage.Literals.MAP_LITERAL_EXP_CS,
			createSerializationRules(
				48 /* MapLiteralExpCS-0: MapLiteralExpCS::ownedType=MapTypeCS '{' (MapLiteralExpCS::ownedParts+=MapLiteralPartCS (',' MapLiteralExpCS::ownedParts+=MapLiteralPartCS)[V1:*])[V0:?] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[22] = new EClassValue(EssentialOCLCSPackage.Literals.MAP_LITERAL_PART_CS,
			createSerializationRules(
				49 /* MapLiteralPartCS-0: MapLiteralPartCS::ownedKey=ExpCS '<-' MapLiteralPartCS::ownedValue=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[23] = new EClassValue(EssentialOCLCSPackage.Literals.MAP_TYPE_CS,
			createSerializationRules(
				50 /* MapTypeCS-0: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] */,
				84 /* TypeExpCS-2: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V1:?] */,
				91 /* TypeLiteralWithMultiplicityCS-2: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V1:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[26] = new EClassValue(EssentialOCLCSPackage.Literals.NAME_EXP_CS,
			createSerializationRules(
				52 /* NameExpCS-0: AbstractNameExpCS::ownedPathName=PathNameCS (AbstractNameExpCS::ownedSquareBracketedClauses+=SquareBracketedClauseCS)[V0:*] (AbstractNameExpCS::ownedRoundBracketedClause=RoundBracketedClauseCS)[V1:?] (AbstractNameExpCS::ownedCurlyBracketedClause=CurlyBracketedClauseCS)[V2:?] (AbstractNameExpCS::isPre?='@' 'pre')[V3:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[27] = new EClassValue(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS,
			createSerializationRules(
				57 /* NavigatingArgCS-4: NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS */,
				53 /* NavigatingArgCS-0: ':' NavigatingArgCS::ownedType=TypeExpCS */,
				55 /* NavigatingArgCS-2: NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS '<-' NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS ('=' NavigatingArgCS::ownedInitExpression=ExpCS)[V0:?] */,
				54 /* NavigatingArgCS-1: NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS ':' NavigatingArgCS::ownedType=TypeExpCS ('<-' NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS)[V0:?] ('=' NavigatingArgCS::ownedInitExpression=ExpCS)[V1:?] */,
				56 /* NavigatingArgCS-3: NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS (':' NavigatingArgCS::ownedType=TypeExpCS)[V0:?] ('<-' NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS)[V1:?] 'in' NavigatingArgCS::ownedInitExpression=ExpCS */,
				58 /* NavigatingBarArgCS-0: NavigatingArgCS::prefix='|' NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS (':' NavigatingArgCS::ownedType=TypeExpCS ('=' NavigatingArgCS::ownedInitExpression=ExpCS)[V1:?])[V0:?] */,
				62 /* NavigatingCommaArgCS-3: NavigatingArgCS::prefix=',' NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS */,
				60 /* NavigatingCommaArgCS-1: NavigatingArgCS::prefix=',' NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS '<-' NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS ('=' NavigatingArgCS::ownedInitExpression=ExpCS)[V0:?] */,
				59 /* NavigatingCommaArgCS-0: NavigatingArgCS::prefix=',' NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS ':' NavigatingArgCS::ownedType=TypeExpCS ('<-' NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS)[V0:?] ('=' NavigatingArgCS::ownedInitExpression=ExpCS)[V1:?] */,
				61 /* NavigatingCommaArgCS-2: NavigatingArgCS::prefix=',' NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS (':' NavigatingArgCS::ownedType=TypeExpCS)[V0:?] ('<-' NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS)[V1:?] 'in' NavigatingArgCS::ownedInitExpression=ExpCS */,
				63 /* NavigatingSemiArgCS-0: NavigatingArgCS::prefix=';' NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS (':' NavigatingArgCS::ownedType=TypeExpCS ('=' NavigatingArgCS::ownedInitExpression=ExpCS)[V1:?])[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[28] = new EClassValue(EssentialOCLCSPackage.Literals.NESTED_EXP_CS,
			createSerializationRules(
				64 /* NestedExpCS-0: '(' NestedExpCS::ownedExpression=ExpCS ')' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[29] = new EClassValue(EssentialOCLCSPackage.Literals.NULL_LITERAL_EXP_CS,
			createSerializationRules(
				65 /* NullLiteralExpCS-0: 'null' */
			), null
		);
		eClassValues[30] = new EClassValue(EssentialOCLCSPackage.Literals.NUMBER_LITERAL_EXP_CS,
			createSerializationRules(
				66 /* NumberLiteralExpCS-0: NumberLiteralExpCS::symbol=NUMBER_LITERAL */
			), null
		);
		...
		eClassValues[32] = new EClassValue(CompleteOCLCSPackage.Literals.OPERATION_CONTEXT_DECL_CS,
			createSerializationRules(
				25 /* OperationContextDeclCS-0: 'context' (TemplateableElementCS::ownedSignature=TemplateSignatureCS)[V0:?] PathNameDeclCS::ownedPathName=PathNameCS '(' (OperationContextDeclCS::ownedParameters+=ParameterCS (',' OperationContextDeclCS::ownedParameters+=ParameterCS)[V2:*])[V1:?] ')' ':' (FeatureContextDeclCS::ownedType=TypeExpCS)[V3:?] ('body' ':' OperationContextDeclCS::ownedBodies+=SpecificationCS)[V4:*] ('post' OperationContextDeclCS::ownedPostconditions+=ConstraintCS)[V5:*] ('pre' OperationContextDeclCS::ownedPreconditions+=ConstraintCS)[V6:*] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[33] = new EClassValue(CompleteOCLCSPackage.Literals.PACKAGE_DECLARATION_CS,
			createSerializationRules(
				26 /* PackageDeclarationCS-0: 'package' PathNameDeclCS::ownedPathName=PathNameCS ('inv' PackageDeclarationCS::ownedInvariants+=ConstraintCS)[V0:*] (PackageDeclarationCS::ownedContexts+=ContextDeclCS)[V1:*] 'endpackage' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[35] = new EClassValue(BaseCSPackage.Literals.PATH_ELEMENT_CS,
			createSerializationRules(
				...
				95 /* URIFirstPathElementCS-1: PathElementCS::referredElement=UnrestrictedName */
			), null
		);
		eClassValues[36] = new EClassValue(BaseCSPackage.Literals.PATH_ELEMENT_WITH_URICS,
			createSerializationRules(
				94 /* URIFirstPathElementCS-0: PathElementCS::referredElement=URI */
			), null
		);
		eClassValues[37] = new EClassValue(BaseCSPackage.Literals.PATH_NAME_CS,
			createSerializationRules(
				...
				75 /* SimplePathNameCS-0: PathNameCS::ownedPathElements+=FirstPathElementCS */,
				96 /* URIPathNameCS-0: PathNameCS::ownedPathElements+=URIFirstPathElementCS ('::' PathNameCS::ownedPathElements+=NextPathElementCS)[V0:*] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[38] = new EClassValue(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS,
			createSerializationRules(
				67 /* PatternExpCS-0: (PatternExpCS::patternVariableName=UnrestrictedName)[V0:?] ':' PatternExpCS::ownedPatternType=TypeExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[39] = new EClassValue(EssentialOCLCSPackage.Literals.PREFIX_EXP_CS,
			createSerializationRules(
				68 /* PrefixedLetExpCS-1: NamedElementCS::name=UnaryOperatorName OperatorExpCS::ownedRight=PrefixedLetExpCS */,
				69 /* PrefixedPrimaryExpCS-15: NamedElementCS::name=UnaryOperatorName OperatorExpCS::ownedRight=PrefixedPrimaryExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT,
		...
		eClassValues[40] = new EClassValue(BaseCSPackage.Literals.PRIMITIVE_TYPE_REF_CS,
			createSerializationRules(
				70 /* PrimitiveTypeCS-0: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier */,
				82 /* TypeExpCS-0: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V0:?] */,
				89 /* TypeLiteralWithMultiplicityCS-0: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TYPED_REF_CS__OWNED_MULTIPLICITY,
					16) /* MultiplicityCS */
		...
		eClassValues[41] = new EClassValue(CompleteOCLCSPackage.Literals.PROPERTY_CONTEXT_DECL_CS,
			createSerializationRules(
				28 /* PropertyContextDeclCS-0: 'context' PathNameDeclCS::ownedPathName=PathNameCS ':' FeatureContextDeclCS::ownedType=TypeExpCS ('derive' ':' PropertyContextDeclCS::ownedDefaultExpressions+=SpecificationCS)[V0:*] ('init' ':' PropertyContextDeclCS::ownedDefaultExpressions+=SpecificationCS)[V1:*] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[42] = new EClassValue(EssentialOCLCSPackage.Literals.ROUND_BRACKETED_CLAUSE_CS,
			createSerializationRules(
				71 /* RoundBracketedClauseCS-0: '(' (RoundBracketedClauseCS::ownedArguments+=NavigatingArgCS (RoundBracketedClauseCS::ownedArguments+=NavigatingCommaArgCS|NavigatingSemiArgCS|NavigatingBarArgCS)[V1:*])[V0:?] ')' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[44] = new EClassValue(EssentialOCLCSPackage.Literals.SHADOW_PART_CS,
			createSerializationRules(
				74 /* ShadowPartCS-1: ShadowPartCS::ownedInitExpression=StringLiteralExpCS */,
				73 /* ShadowPartCS-0: ShadowPartCS::referredProperty=UnrestrictedName '=' ShadowPartCS::ownedInitExpression=ExpCS|PatternExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[45] = new EClassValue(EssentialOCLCSPackage.Literals.SQUARE_BRACKETED_CLAUSE_CS,
			createSerializationRules(
				76 /* SquareBracketedClauseCS-0: '[' SquareBracketedClauseCS::ownedTerms+=ExpCS (',' SquareBracketedClauseCS::ownedTerms+=ExpCS)[V0:*] ']' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[46] = new EClassValue(EssentialOCLCSPackage.Literals.STRING_LITERAL_EXP_CS,
			createSerializationRules(
				77 /* StringLiteralExpCS-0: (StringLiteralExpCS::segments+=StringLiteral)[V0:+] */
			), null
		);
		...
		eClassValues[50] = new EClassValue(EssentialOCLCSPackage.Literals.TUPLE_LITERAL_EXP_CS,
			createSerializationRules(
				78 /* TupleLiteralExpCS-0: 'Tuple' '{' TupleLiteralExpCS::ownedParts+=TupleLiteralPartCS (',' TupleLiteralExpCS::ownedParts+=TupleLiteralPartCS)[V0:*] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[51] = new EClassValue(EssentialOCLCSPackage.Literals.TUPLE_LITERAL_PART_CS,
			createSerializationRules(
				79 /* TupleLiteralPartCS-0: NamedElementCS::name=UnrestrictedName (':' VariableCS::ownedType=TypeExpCS)[V0:?] '=' VariableCS::ownedInitExpression=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_INIT_EXPRESSION,
					56) /* BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		eClassValues[52] = new EClassValue(BaseCSPackage.Literals.TUPLE_PART_CS,
			createSerializationRules(
				80 /* TuplePartCS-0: NamedElementCS::name=UnrestrictedName ':' TypedElementCS::ownedType=TypeExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE,
					40) /* TypeExpCS */
		...
		eClassValues[53] = new EClassValue(BaseCSPackage.Literals.TUPLE_TYPE_CS,
			createSerializationRules(
				81 /* TupleTypeCS-0: TupleTypeCS::name='Tuple' ('(' (TupleTypeCS::ownedParts+=TuplePartCS (',' TupleTypeCS::ownedParts+=TuplePartCS)[V2:*])[V1:?] ')')[V0:?] */,
				87 /* TypeExpCS-5: TupleTypeCS::name='Tuple' ('(' (TupleTypeCS::ownedParts+=TuplePartCS (',' TupleTypeCS::ownedParts+=TuplePartCS)[V2:*])[V1:?] ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V3:?] */,
				92 /* TypeLiteralWithMultiplicityCS-3: TupleTypeCS::name='Tuple' ('(' (TupleTypeCS::ownedParts+=TuplePartCS (',' TupleTypeCS::ownedParts+=TuplePartCS)[V2:*])[V1:?] ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V3:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TYPED_REF_CS__OWNED_MULTIPLICITY,
					16) /* MultiplicityCS */,
		...
		eClassValues[54] = new EClassValue(EssentialOCLCSPackage.Literals.TYPE_LITERAL_EXP_CS,
			createSerializationRules(
				88 /* TypeLiteralExpCS-0: TypeLiteralExpCS::ownedType=TypeLiteralWithMultiplicityCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[55] = new EClassValue(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS,
			createSerializationRules(
				85 /* TypeExpCS-3: TypeNameExpCS::ownedPathName=PathNameCS (TypeNameExpCS::ownedCurlyBracketedClause=CurlyBracketedClauseCS ('{' TypeNameExpCS::ownedPatternGuard=ExpCS '}')[V1:?])[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V2:?] */,
				93 /* TypeNameExpCS-0: TypeNameExpCS::ownedPathName=PathNameCS (TypeNameExpCS::ownedCurlyBracketedClause=CurlyBracketedClauseCS ('{' TypeNameExpCS::ownedPatternGuard=ExpCS '}')[V1:?])[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[58] = new EClassValue(EssentialOCLCSPackage.Literals.UNLIMITED_NATURAL_LITERAL_EXP_CS,
			createSerializationRules(
				97 /* UnlimitedNaturalLiteralExpCS-0: '*' */
			), null
		);
		eClassValues[59] = new EClassValue(EssentialOCLCSPackage.Literals.VARIABLE_CS,
			createSerializationRules(
				34 /* CoIteratorVariableCS-0: NamedElementCS::name=UnrestrictedName (':' VariableCS::ownedType=TypeExpCS)[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_TYPE,
					40) /* TypeExpCS */
	...
	private void initGrammarRuleValues() {
		...
		grammarRuleValues[29] = createParserRuleValue(29, "ExpCS", 56 /* BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				33	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				35	/* CollectionLiteralExpCS-0: CollectionLiteralExpCS::ownedType=CollectionTypeCS '{' (CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS (',' CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS)[V1:*])[V0:?] '}' */,
				42	/* ExpCS-18: InfixExpCS::ownedLeft=PrefixedPrimaryExpCS NamedElementCS::name=BinaryOperatorName OperatorExpCS::ownedRight=ExpCS */,
		...
		grammarRuleValues[72] = createParserRuleValue(72, "PrimitiveLiteralExpCS", 52 /* BooleanLiteralExpCS|InvalidLiteralExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrimitiveLiteralExpCS|StringLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				33	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				44	/* InvalidLiteralExpCS-0: 'invalid' */,
				65	/* NullLiteralExpCS-0: 'null' */,
		...
		grammarRuleValues[95] = createParserRuleValue(95, "TypeExpWithoutMultiplicityCS", 44 /* CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
			createSerializationRules(
				38	/* CollectionPatternCS-0: CollectionPatternCS::ownedType=CollectionTypeCS '{' (CollectionPatternCS::ownedParts+=PatternExpCS (',' CollectionPatternCS::ownedParts+=PatternExpCS)[V1:*] '++' CollectionPatternCS::restVariableName=Identifier)[V0:?] '}' */,
				39	/* CollectionTypeCS-0: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] */,
				50	/* MapTypeCS-0: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] */,
		...
		grammarRuleValues[101] = createParserRuleValue(101, "TypeRefCS", 59 /* CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS */,
			createSerializationRules(
				39	/* CollectionTypeCS-0: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] */,
				50	/* MapTypeCS-0: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] */,
				70	/* PrimitiveTypeCS-0: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier */,
		...
		grammarRuleValues[102] = createParserRuleValue(102, "TypedRefCS", 48 /* CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS */,
			createSerializationRules(
				39	/* CollectionTypeCS-0: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] */,
				50	/* MapTypeCS-0: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] */,
				70	/* PrimitiveTypeCS-0: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier */,
	...
	private void initGrammarRuleVectors() {
		...
		// 44: CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS
		grammarRuleVectors[44] = new GrammarRuleVector(0x800000000180L,0x9a0000200L);
		// 45: TypeParameterCS
		...
		// 47: TypedRefCS
		grammarRuleVectors[47] = new GrammarRuleVector(0x0L,0x4000000000L);
		// 48: CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS
		grammarRuleVectors[48] = new GrammarRuleVector(0x800000000100L,0xc120000200L);
		// 49: NextPathElementCS|URIFirstPathElementCS
		grammarRuleVectors[49] = new GrammarRuleVector(0x2000000000000000L,0x80000000000L);
		// 50: FirstPathElementCS|NextPathElementCS|URIFirstPathElementCS
		grammarRuleVectors[50] = new GrammarRuleVector(0x2000000040000000L,0x80000000000L);
		// 51: URIPathNameCS
		grammarRuleVectors[51] = new GrammarRuleVector(0x0L,0x100000000000L);
		...
		grammarRuleVectors[52] = new GrammarRuleVector(0xc000002000000004L,0x400000400100L);
		...
		grammarRuleVectors[53] = new GrammarRuleVector(0xd020212400000024L,0x400204410180L);
		// 54: BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[54] = new GrammarRuleVector(0xd020212400000024L,0x4002044101c0L);
		// 55: BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[55] = new GrammarRuleVector(0xd020232400000024L,0x4002044101e0L);
		// 56: BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[56] = new GrammarRuleVector(0xd020232420000024L,0x4002044101e0L);
		// 57: BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[57] = new GrammarRuleVector(0xd0a0232420000024L,0x4002044101e0L);
		// 58: BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[58] = new GrammarRuleVector(0xd020232420000024L,0x4002044101f0L);
		// 59: CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS
		grammarRuleVectors[59] = new GrammarRuleVector(0x800000000100L,0x400e120000200L);
	}
	...
	private void initMatchSteps() {
		...
		// 83: assign V0 = (|SquareBracketedClauseCS::ownedTerms| - 1)
		serializationMatchSteps[83] = createMatchStep_Assign(0, 178);
		// 84: assign V0 = (|TemplateBindingCS::ownedSubstitutions| - 1)
		serializationMatchSteps[84] = createMatchStep_Assign(0, 179);
		// 85: assign V0 = (|TemplateSignatureCS::ownedParameters| - 1)
		serializationMatchSteps[85] = createMatchStep_Assign(0, 181);
		// 86: assign V0 = (|TupleLiteralExpCS::ownedParts| - 1)
		serializationMatchSteps[86] = createMatchStep_Assign(0, 182);
		// 87: assign V0 = (|TupleTypeCS::ownedParts| > 0)
		serializationMatchSteps[87] = createMatchStep_Assign(0, 185);
		// 88: assign V0 = (|TypeParameterCS::ownedExtends| > 0)
		serializationMatchSteps[88] = createMatchStep_Assign(0, 189);
		// 89: assign V0 = |AbstractNameExpCS::ownedSquareBracketedClauses|
		serializationMatchSteps[89] = createMatchStep_Assign(0, 7);
		// 90: assign V0 = |CollectionLiteralPartCS::ownedLastExpression|
		serializationMatchSteps[90] = createMatchStep_Assign(0, 15);
		// 91: assign V0 = |CollectionPatternCS::restVariableName|
		serializationMatchSteps[91] = createMatchStep_Assign(0, 19);
		// 92: assign V0 = |CollectionTypeCS::ownedType|
		serializationMatchSteps[92] = createMatchStep_Assign(0, 22);
		// 93: assign V0 = |DefCS::isStatic.'static'|
		serializationMatchSteps[93] = createMatchStep_Assign(0, 31);
		// 94: assign V0 = |IfExpCS::ownedIfThenExpressions|
		serializationMatchSteps[94] = createMatchStep_Assign(0, 39);
		// 95: assign V0 = |LetVariableCS::ownedRoundBracketedClause|
		serializationMatchSteps[95] = createMatchStep_Assign(0, 50);
		// 96: assign V0 = |MapTypeCS::ownedValueType|
		serializationMatchSteps[96] = createMatchStep_Assign(0, 57);
		// 97: assign V0 = |MultiplicityBoundsCS::upperBound|
		serializationMatchSteps[97] = createMatchStep_Assign(0, 60);
		// 98: assign V0 = |NamedElementCS::name|
		serializationMatchSteps[98] = createMatchStep_Assign(0, 64);
		// 99: assign V0 = |NavigatingArgCS::ownedCoIterator|
		serializationMatchSteps[99] = createMatchStep_Assign(0, 65);
		// 100: assign V0 = |NavigatingArgCS::ownedInitExpression|
		serializationMatchSteps[100] = createMatchStep_Assign(0, 66);
		// 101: assign V0 = |NavigatingArgCS::ownedType|
		serializationMatchSteps[101] = createMatchStep_Assign(0, 68);
		// 102: assign V0 = |PackageDeclarationCS::ownedInvariants|
		serializationMatchSteps[102] = createMatchStep_Assign(0, 81);
		// 103: assign V0 = |PatternExpCS::patternVariableName|
		serializationMatchSteps[103] = createMatchStep_Assign(0, 86);
		// 104: assign V0 = |RootCS::ownedImports|
		serializationMatchSteps[104] = createMatchStep_Assign(0, 88);
		// 105: assign V0 = |StringLiteralExpCS::segments|
		serializationMatchSteps[105] = createMatchStep_Assign(0, 94);
		// 106: assign V0 = |TemplateableElementCS::ownedSignature|
		serializationMatchSteps[106] = createMatchStep_Assign(0, 99);
		// 107: assign V0 = |TypeNameExpCS::ownedCurlyBracketedClause|
		serializationMatchSteps[107] = createMatchStep_Assign(0, 105);
		// 108: assign V0 = |TypedRefCS::ownedMultiplicity|
		serializationMatchSteps[108] = createMatchStep_Assign(0, 112);
		// 109: assign V0 = |TypedTypeRefCS::ownedBinding|
		serializationMatchSteps[109] = createMatchStep_Assign(0, 114);
		// 110: assign V0 = |VariableCS::ownedType|
		serializationMatchSteps[110] = createMatchStep_Assign(0, 117);
		// 111: assign V0 = |WildcardTypeRefCS::ownedExtends|
		serializationMatchSteps[111] = createMatchStep_Assign(0, 118);
		// 112: assign V1 = (|CollectionLiteralExpCS::ownedParts| - 1)
		serializationMatchSteps[112] = createMatchStep_Assign(1, 122);
		// 113: assign V1 = (|CollectionPatternCS::ownedParts| - 1)
		serializationMatchSteps[113] = createMatchStep_Assign(1, 126);
		// 114: assign V1 = (|CurlyBracketedClauseCS::ownedParts| - 1)
		serializationMatchSteps[114] = createMatchStep_Assign(1, 131);
		// 115: assign V1 = (|MapLiteralExpCS::ownedParts| - 1)
		serializationMatchSteps[115] = createMatchStep_Assign(1, 147);
		// 116: assign V1 = (|OperationContextDeclCS::ownedParameters| > 0)
		serializationMatchSteps[116] = createMatchStep_Assign(1, 168);
		// 117: assign V1 = (|TupleTypeCS::ownedParts| > 0)
		serializationMatchSteps[117] = createMatchStep_Assign(1, 185);
		// 118: assign V1 = (|TypeParameterCS::ownedExtends| - 1)
		serializationMatchSteps[118] = createMatchStep_Assign(1, 188);
		// 119: assign V1 = |AbstractNameExpCS::ownedRoundBracketedClause|
		serializationMatchSteps[119] = createMatchStep_Assign(1, 6);
		// 120: assign V1 = |ClassifierContextDeclCS::selfName|
		serializationMatchSteps[120] = createMatchStep_Assign(1, 11);
		// 121: assign V1 = |CollectionTypeCS::ownedCollectionMultiplicity|
		serializationMatchSteps[121] = createMatchStep_Assign(1, 21);
		// 122: assign V1 = |CompleteOCLDocumentCS::ownedPackages|
		serializationMatchSteps[122] = createMatchStep_Assign(1, 24);
		// 123: assign V1 = |ConstraintCS::ownedMessageSpecification|
		serializationMatchSteps[123] = createMatchStep_Assign(1, 25);
		// 124: assign V1 = |ImportCS::isAll.'::*'|
		serializationMatchSteps[124] = createMatchStep_Assign(1, 43);
		// 125: assign V1 = |NavigatingArgCS::ownedCoIterator|
		serializationMatchSteps[125] = createMatchStep_Assign(1, 65);
		// 126: assign V1 = |NavigatingArgCS::ownedInitExpression|
		serializationMatchSteps[126] = createMatchStep_Assign(1, 66);
		// 127: assign V1 = |PackageDeclarationCS::ownedContexts|
		serializationMatchSteps[127] = createMatchStep_Assign(1, 80);
		// 128: assign V1 = |TemplateBindingCS::ownedMultiplicity|
		serializationMatchSteps[128] = createMatchStep_Assign(1, 95);
		// 129: assign V1 = |TemplateableElementCS::ownedSignature|
		serializationMatchSteps[129] = createMatchStep_Assign(1, 99);
		// 130: assign V1 = |TypeNameExpCS::ownedPatternGuard|
		serializationMatchSteps[130] = createMatchStep_Assign(1, 107);
		// 131: assign V1 = |TypedRefCS::ownedMultiplicity|
		serializationMatchSteps[131] = createMatchStep_Assign(1, 112);
		// 132: assign V1 = |VariableCS::ownedType|
		serializationMatchSteps[132] = createMatchStep_Assign(1, 117);
		// 133: assign V2 = (|DefOperationCS::ownedParameters| > 0)
		serializationMatchSteps[133] = createMatchStep_Assign(2, 135);
		// 134: assign V2 = (|OperationContextDeclCS::ownedParameters| - 1)
		serializationMatchSteps[134] = createMatchStep_Assign(2, 167);
		// 135: assign V2 = (|TupleTypeCS::ownedParts| - 1)
		serializationMatchSteps[135] = createMatchStep_Assign(2, 184);
		// 136: assign V2 = |AbstractNameExpCS::ownedCurlyBracketedClause|
		serializationMatchSteps[136] = createMatchStep_Assign(2, 4);
		// 137: assign V2 = |ClassifierContextDeclCS::ownedInvariants|
		serializationMatchSteps[137] = createMatchStep_Assign(2, 10);
		// 138: assign V2 = |CompleteOCLDocumentCS::ownedContexts|
		serializationMatchSteps[138] = createMatchStep_Assign(2, 23);
		// 139: assign V2 = |TypedRefCS::ownedMultiplicity|
		serializationMatchSteps[139] = createMatchStep_Assign(2, 112);
		// 140: assign V3 = (|DefOperationCS::ownedParameters| - 1)
		serializationMatchSteps[140] = createMatchStep_Assign(3, 134);
		// 141: assign V3 = |AbstractNameExpCS::isPre.'@'|
		serializationMatchSteps[141] = createMatchStep_Assign(3, 3);
		// 142: assign V3 = |ClassifierContextDeclCS::ownedDefinitions|
		serializationMatchSteps[142] = createMatchStep_Assign(3, 9);
		// 143: assign V3 = |FeatureContextDeclCS::ownedType|
		serializationMatchSteps[143] = createMatchStep_Assign(3, 35);
		// 144: assign V3 = |TypedRefCS::ownedMultiplicity|
		serializationMatchSteps[144] = createMatchStep_Assign(3, 112);
		// 145: assign V4 = |OperationContextDeclCS::ownedBodies|
		serializationMatchSteps[145] = createMatchStep_Assign(4, 75);
		// 146: assign V4 = |TypedElementCS::ownedType|
		serializationMatchSteps[146] = createMatchStep_Assign(4, 110);
		// 147: assign V5 = |OperationContextDeclCS::ownedPostconditions|
		serializationMatchSteps[147] = createMatchStep_Assign(5, 77);
		// 148: assign V6 = |OperationContextDeclCS::ownedPreconditions|
		serializationMatchSteps[148] = createMatchStep_Assign(6, 78);
		// 149: check-rule basecs::ConstraintCS.ownedMessageSpecification : 83
		serializationMatchSteps[149] = createMatchStep_RuleCheck(BaseCSPackage.Literals.CONSTRAINT_CS__OWNED_MESSAGE_SPECIFICATION, 32/*SpecificationCS*/);
		// 150: check-rule basecs::ConstraintCS.ownedSpecification : 83
		serializationMatchSteps[150] = createMatchStep_RuleCheck(BaseCSPackage.Literals.CONSTRAINT_CS__OWNED_SPECIFICATION, 32/*SpecificationCS*/);
		// 151: check-rule basecs::ImportCS.ownedPathName : 108
		serializationMatchSteps[151] = createMatchStep_RuleCheck(BaseCSPackage.Literals.IMPORT_CS__OWNED_PATH_NAME, 51/*URIPathNameCS*/);
		// 152: check-rule basecs::PathNameCS.ownedPathElements : 30
		serializationMatchSteps[152] = createMatchStep_RuleCheck(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 11/*FirstPathElementCS*/);
		// 153: check-rule basecs::RootCS.ownedImports : 35
		serializationMatchSteps[153] = createMatchStep_RuleCheck(BaseCSPackage.Literals.ROOT_CS__OWNED_IMPORTS, 12/*ImportCS*/);
		// 154: check-rule basecs::TemplateBindingCS.ownedMultiplicity : 50
		serializationMatchSteps[154] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_BINDING_CS__OWNED_MULTIPLICITY, 16/*MultiplicityCS*/);
		// 155: check-rule basecs::TemplateBindingCS.ownedSubstitutions : 88
		serializationMatchSteps[155] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_BINDING_CS__OWNED_SUBSTITUTIONS, 36/*TemplateParameterSubstitutionCS*/);
		// 156: check-rule basecs::TemplateParameterSubstitutionCS.ownedActualParameter : 8|47|73|93|96|101|102|103|114
		serializationMatchSteps[156] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS__OWNED_ACTUAL_PARAMETER, 59/*CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS*/);
		// 157: check-rule basecs::TemplateSignatureCS.ownedParameters : 100
		serializationMatchSteps[157] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_SIGNATURE_CS__OWNED_PARAMETERS, 45/*TypeParameterCS*/);
		// 158: check-rule basecs::TemplateableElementCS.ownedSignature : 89
		serializationMatchSteps[158] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATEABLE_ELEMENT_CS__OWNED_SIGNATURE, 37/*TemplateSignatureCS*/);
		// 159: check-rule basecs::TupleTypeCS.ownedParts : 92
		serializationMatchSteps[159] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TUPLE_TYPE_CS__OWNED_PARTS, 39/*TuplePartCS*/);
		// 160: check-rule basecs::TypeParameterCS.ownedExtends : 8|47|73|93|96|102|103
		serializationMatchSteps[160] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPE_PARAMETER_CS__OWNED_EXTENDS, 48/*CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS*/);
		// 161: check-rule basecs::TypedElementCS.ownedType : 94
		serializationMatchSteps[161] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE, 40/*TypeExpCS*/);
		// 162: check-rule basecs::TypedRefCS.ownedMultiplicity : 50
		serializationMatchSteps[162] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_REF_CS__OWNED_MULTIPLICITY, 16/*MultiplicityCS*/);
		// 163: check-rule basecs::TypedTypeRefCS.ownedBinding : 87
		serializationMatchSteps[163] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__OWNED_BINDING, 35/*TemplateBindingCS*/);
		// 164: check-rule basecs::TypedTypeRefCS.ownedPathName : 67
		serializationMatchSteps[164] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__OWNED_PATH_NAME, 23/*PathNameCS*/);
		// 165: check-rule basecs::WildcardTypeRefCS.ownedExtends : 8|47|73|93|96|102|103
		serializationMatchSteps[165] = createMatchStep_RuleCheck(BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS__OWNED_EXTENDS, 48/*CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS*/);
		// 166: check-rule completeoclcs::ClassifierContextDeclCS.ownedDefinitions : 16|17|19
		serializationMatchSteps[166] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.CLASSIFIER_CONTEXT_DECL_CS__OWNED_DEFINITIONS, 8/*DefCS|DefOperationCS|DefPropertyCS*/);
		// 167: check-rule completeoclcs::ClassifierContextDeclCS.ownedInvariants : 12
		serializationMatchSteps[167] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.CLASSIFIER_CONTEXT_DECL_CS__OWNED_INVARIANTS, 3/*ConstraintCS*/);
		// 168: check-rule completeoclcs::CompleteOCLDocumentCS.ownedContexts : 3|13|64|75
		serializationMatchSteps[168] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.COMPLETE_OCL_DOCUMENT_CS__OWNED_CONTEXTS, 29/*ClassifierContextDeclCS|ContextDeclCS|OperationContextDeclCS|PropertyContextDeclCS*/);
		// 169: check-rule completeoclcs::CompleteOCLDocumentCS.ownedPackages : 65
		serializationMatchSteps[169] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.COMPLETE_OCL_DOCUMENT_CS__OWNED_PACKAGES, 21/*PackageDeclarationCS*/);
		// 170: check-rule completeoclcs::DefCS.ownedSpecification : 83
		serializationMatchSteps[170] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.DEF_CS__OWNED_SPECIFICATION, 32/*SpecificationCS*/);
		// 171: check-rule completeoclcs::DefOperationCS.ownedParameters : 18
		serializationMatchSteps[171] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.DEF_OPERATION_CS__OWNED_PARAMETERS, 7/*DefParameterCS*/);
		// 172: check-rule completeoclcs::FeatureContextDeclCS.ownedType : 94
		serializationMatchSteps[172] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.FEATURE_CONTEXT_DECL_CS__OWNED_TYPE, 40/*TypeExpCS*/);
		// 173: check-rule completeoclcs::OperationContextDeclCS.ownedBodies : 83
		serializationMatchSteps[173] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.OPERATION_CONTEXT_DECL_CS__OWNED_BODIES, 32/*SpecificationCS*/);
		// 174: check-rule completeoclcs::OperationContextDeclCS.ownedParameters : 66
		serializationMatchSteps[174] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.OPERATION_CONTEXT_DECL_CS__OWNED_PARAMETERS, 22/*ParameterCS*/);
		// 175: check-rule completeoclcs::OperationContextDeclCS.ownedPostconditions : 12
		serializationMatchSteps[175] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.OPERATION_CONTEXT_DECL_CS__OWNED_POSTCONDITIONS, 3/*ConstraintCS*/);
		// 176: check-rule completeoclcs::OperationContextDeclCS.ownedPreconditions : 12
		serializationMatchSteps[176] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.OPERATION_CONTEXT_DECL_CS__OWNED_PRECONDITIONS, 3/*ConstraintCS*/);
		// 177: check-rule completeoclcs::PackageDeclarationCS.ownedContexts : 3|13|64|75
		serializationMatchSteps[177] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.PACKAGE_DECLARATION_CS__OWNED_CONTEXTS, 29/*ClassifierContextDeclCS|ContextDeclCS|OperationContextDeclCS|PropertyContextDeclCS*/);
		// 178: check-rule completeoclcs::PackageDeclarationCS.ownedInvariants : 12
		serializationMatchSteps[178] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.PACKAGE_DECLARATION_CS__OWNED_INVARIANTS, 3/*ConstraintCS*/);
		// 179: check-rule completeoclcs::PathNameDeclCS.ownedPathName : 67
		serializationMatchSteps[179] = createMatchStep_RuleCheck(CompleteOCLCSPackage.Literals.PATH_NAME_DECL_CS__OWNED_PATH_NAME, 23/*PathNameCS*/);
		// 180: check-rule essentialoclcs::AbstractNameExpCS.ownedCurlyBracketedClause : 14
		serializationMatchSteps[180] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_CURLY_BRACKETED_CLAUSE, 5/*CurlyBracketedClauseCS*/);
		// 181: check-rule essentialoclcs::AbstractNameExpCS.ownedPathName : 67
		serializationMatchSteps[181] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_PATH_NAME, 23/*PathNameCS*/);
		// 182: check-rule essentialoclcs::AbstractNameExpCS.ownedRoundBracketedClause : 76
		serializationMatchSteps[182] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_ROUND_BRACKETED_CLAUSE, 30/*RoundBracketedClauseCS*/);
		// 183: check-rule essentialoclcs::AbstractNameExpCS.ownedSquareBracketedClauses : 84
		serializationMatchSteps[183] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_SQUARE_BRACKETED_CLAUSES, 33/*SquareBracketedClauseCS*/);
		// 184: check-rule essentialoclcs::CollectionLiteralExpCS.ownedParts : 6
		serializationMatchSteps[184] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_EXP_CS__OWNED_PARTS, 1/*CollectionLiteralPartCS*/);
		// 185: check-rule essentialoclcs::CollectionLiteralExpCS.ownedType : 8
		serializationMatchSteps[185] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_EXP_CS__OWNED_TYPE, 2/*CollectionTypeCS*/);
		// 186: check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[186] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_EXPRESSION, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 187: check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : 68
		serializationMatchSteps[187] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_EXPRESSION, 24/*PatternExpCS*/);
		// 188: check-rule essentialoclcs::CollectionLiteralPartCS.ownedLastExpression : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		...
		// 189: check-rule essentialoclcs::CollectionPatternCS.ownedParts : 68
		serializationMatchSteps[189] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__OWNED_PARTS, 24/*PatternExpCS*/);
		// 190: check-rule essentialoclcs::CollectionPatternCS.ownedType : 8
		serializationMatchSteps[190] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__OWNED_TYPE, 2/*CollectionTypeCS*/);
		// 191: check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : 50
		serializationMatchSteps[191] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_COLLECTION_MULTIPLICITY, 16/*MultiplicityCS*/);
		// 192: check-rule essentialoclcs::CollectionTypeCS.ownedType : 7|8|47|73|93|95|96|99
		serializationMatchSteps[192] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_TYPE, 44/*CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS*/);
		// 193: check-rule essentialoclcs::ContextCS.ownedExpression : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[193] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.CONTEXT_CS__OWNED_EXPRESSION, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 194: check-rule essentialoclcs::CurlyBracketedClauseCS.ownedParts : 81
		serializationMatchSteps[194] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.CURLY_BRACKETED_CLAUSE_CS__OWNED_PARTS, 31/*ShadowPartCS*/);
		// 195: check-rule essentialoclcs::ExpSpecificationCS.ownedExpression : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[195] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.EXP_SPECIFICATION_CS__OWNED_EXPRESSION, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 196: check-rule essentialoclcs::IfExpCS.ownedCondition : 2|5|29|34|37|40|41|45|53|60|62|63|68|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[196] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_CONDITION, 58/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 197: check-rule essentialoclcs::IfExpCS.ownedElseExpression : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[197] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_ELSE_EXPRESSION, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 198: check-rule essentialoclcs::IfExpCS.ownedIfThenExpressions : 22
		serializationMatchSteps[198] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_IF_THEN_EXPRESSIONS, 9/*ElseIfThenExpCS*/);
		// 199: check-rule essentialoclcs::IfExpCS.ownedThenExpression : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[199] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_THEN_EXPRESSION, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 200: check-rule essentialoclcs::IfThenExpCS.ownedCondition : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[200] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_THEN_EXP_CS__OWNED_CONDITION, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 201: check-rule essentialoclcs::IfThenExpCS.ownedThenExpression : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[201] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_THEN_EXP_CS__OWNED_THEN_EXPRESSION, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 202: check-rule essentialoclcs::InfixExpCS.ownedLeft : 2|5|34|37|40|45|53|60|62|63|70|71|72|80|86|90|97|110
		serializationMatchSteps[202] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.INFIX_EXP_CS__OWNED_LEFT, 54/*BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 203: check-rule essentialoclcs::LambdaLiteralExpCS.ownedExpressionCS : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[203] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LAMBDA_LITERAL_EXP_CS__OWNED_EXPRESSION_CS, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 204: check-rule essentialoclcs::LetExpCS.ownedInExpression : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[204] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LET_EXP_CS__OWNED_IN_EXPRESSION, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 205: check-rule essentialoclcs::LetExpCS.ownedVariables : 42
		serializationMatchSteps[205] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LET_EXP_CS__OWNED_VARIABLES, 13/*LetVariableCS*/);
		// 206: check-rule essentialoclcs::LetVariableCS.ownedRoundBracketedClause : 76
		serializationMatchSteps[206] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LET_VARIABLE_CS__OWNED_ROUND_BRACKETED_CLAUSE, 30/*RoundBracketedClauseCS*/);
		// 207: check-rule essentialoclcs::MapLiteralExpCS.ownedParts : 46
		serializationMatchSteps[207] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_EXP_CS__OWNED_PARTS, 14/*MapLiteralPartCS*/);
		// 208: check-rule essentialoclcs::MapLiteralExpCS.ownedType : 47
		serializationMatchSteps[208] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_EXP_CS__OWNED_TYPE, 15/*MapTypeCS*/);
		// 209: check-rule essentialoclcs::MapLiteralPartCS.ownedKey : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[209] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_PART_CS__OWNED_KEY, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 210: check-rule essentialoclcs::MapLiteralPartCS.ownedValue : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[210] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_PART_CS__OWNED_VALUE, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 211: check-rule essentialoclcs::MapTypeCS.ownedKeyType : 94
		serializationMatchSteps[211] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_KEY_TYPE, 40/*TypeExpCS*/);
		// 212: check-rule essentialoclcs::MapTypeCS.ownedValueType : 94
		serializationMatchSteps[212] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_VALUE_TYPE, 40/*TypeExpCS*/);
		// 213: check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : 4
		serializationMatchSteps[213] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_CO_ITERATOR, 0/*CoIteratorVariableCS*/);
		// 214: check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[214] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_INIT_EXPRESSION, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 215: check-rule essentialoclcs::NavigatingArgCS.ownedNameExpression : 2|5|29|34|37|40|41|45|53|55|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[215] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_NAME_EXPRESSION, 57/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 216: check-rule essentialoclcs::NavigatingArgCS.ownedType : 94
		serializationMatchSteps[216] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_TYPE, 40/*TypeExpCS*/);
		// 217: check-rule essentialoclcs::NestedExpCS.ownedExpression : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[217] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NESTED_EXP_CS__OWNED_EXPRESSION, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 218: check-rule essentialoclcs::OperatorExpCS.ownedRight : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[218] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 219: check-rule essentialoclcs::OperatorExpCS.ownedRight : 2|5|34|37|40|45|53|60|62|63|70|71|72|80|86|90|97|110
		serializationMatchSteps[219] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 54/*BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 220: check-rule essentialoclcs::OperatorExpCS.ownedRight : 41|69
		serializationMatchSteps[220] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 27/*LetExpCS|PrefixedLetExpCS*/);
		// 221: check-rule essentialoclcs::PatternExpCS.ownedPatternType : 94
		serializationMatchSteps[221] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS__OWNED_PATTERN_TYPE, 40/*TypeExpCS*/);
		// 222: check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : 2|5|29|34|37|40|41|45|53|60|62|63|68|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[222] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 58/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 223: check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : 86
		serializationMatchSteps[223] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 34/*StringLiteralExpCS*/);
		// 224: check-rule essentialoclcs::SquareBracketedClauseCS.ownedTerms : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[224] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.SQUARE_BRACKETED_CLAUSE_CS__OWNED_TERMS, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 225: check-rule essentialoclcs::TupleLiteralExpCS.ownedParts : 91
		serializationMatchSteps[225] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TUPLE_LITERAL_EXP_CS__OWNED_PARTS, 38/*TupleLiteralPartCS*/);
		// 226: check-rule essentialoclcs::TypeLiteralExpCS.ownedType : 98
		serializationMatchSteps[226] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_LITERAL_EXP_CS__OWNED_TYPE, 43/*TypeLiteralWithMultiplicityCS*/);
		// 227: check-rule essentialoclcs::TypeNameExpCS.ownedCurlyBracketedClause : 14
		serializationMatchSteps[227] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_CURLY_BRACKETED_CLAUSE, 5/*CurlyBracketedClauseCS*/);
		// 228: check-rule essentialoclcs::TypeNameExpCS.ownedPathName : 67
		serializationMatchSteps[228] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_PATH_NAME, 23/*PathNameCS*/);
		// 229: check-rule essentialoclcs::TypeNameExpCS.ownedPatternGuard : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[229] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_PATTERN_GUARD, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 230: check-rule essentialoclcs::VariableCS.ownedInitExpression : 2|5|29|34|37|40|41|45|53|60|62|63|69|70|71|72|80|86|90|97|110
		serializationMatchSteps[230] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_INIT_EXPRESSION, 56/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 231: check-rule essentialoclcs::VariableCS.ownedType : 94
		serializationMatchSteps[231] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_TYPE, 40/*TypeExpCS*/);
	}
	...
	private void initSerializationRules0() {
		...
		serializationRules[11] = createSerializationRule("TemplateBindingCS-0", 87,
			createSerializationMatchSteps(
				154		/* check-rule basecs::TemplateBindingCS.ownedMultiplicity : MultiplicityCS */,
				155		/* check-rule basecs::TemplateBindingCS.ownedSubstitutions : TemplateParameterSubstitutionCS */,
				128		/* assign V1 = |TemplateBindingCS::ownedMultiplicity| */,
				84		/* assign V0 = (|TemplateBindingCS::ownedSubstitutions| - 1) */
			),
			createSerializationSteps(
		...
		serializationRules[12] = createSerializationRule("TemplateParameterSubstitutionCS-0", 88,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				156		/* check-rule basecs::TemplateParameterSubstitutionCS.ownedActualParameter : CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS */,
				46		/* assert (|TemplateParameterSubstitutionCS::ownedActualParameter| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[13] = createSerializationRule("TypeParameterCS-0", 100,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				160		/* check-rule basecs::TypeParameterCS.ownedExtends : CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS */,
				27		/* assert (|NamedElementCS::name| - 1) == 0 */,
				88		/* assign V0 = (|TypeParameterCS::ownedExtends| > 0) */,
				118		/* assign V1 = (|TypeParameterCS::ownedExtends| - 1) */
			),
		...
		serializationRules[14] = createSerializationRule("TypedTypeRefCS-0", 103,
			createSerializationMatchSteps(
				76		/* assert |TypedTypeRefCS::isTypeof| == 0 */,
				75		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				163		/* check-rule basecs::TypedTypeRefCS.ownedBinding : TemplateBindingCS */,
				164		/* check-rule basecs::TypedTypeRefCS.ownedPathName : PathNameCS */,
				109		/* assign V0 = |TypedTypeRefCS::ownedBinding| */,
				51		/* assert (|TypedTypeRefCS::ownedPathName| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[15] = createSerializationRule("WildcardTypeRefCS-0", 114,
			createSerializationMatchSteps(
				78		/* assert |WildcardTypeRefCS::ownedSuper| == 0 */,
				165		/* check-rule basecs::WildcardTypeRefCS.ownedExtends : CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS */,
				111		/* assign V0 = |WildcardTypeRefCS::ownedExtends| */
			),
			createSerializationSteps(
		...
		// CompleteOCL::ClassifierContextDeclCS-0(completeoclcs::ClassifierContextDeclCS): { "context" ownedSignature=TemplateSignatureCS[?] selfName=UnrestrictedName[?] ownedPathName=PathNameCS { { "inv" ownedInvariants+=ConstraintCS }[+] ownedDefinitions+=DefCS[*] } }
		serializationRules[16] = createSerializationRule("ClassifierContextDeclCS-0", 3,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				166		/* check-rule completeoclcs::ClassifierContextDeclCS.ownedDefinitions : DefCS|DefOperationCS|DefPropertyCS */,
				167		/* check-rule completeoclcs::ClassifierContextDeclCS.ownedInvariants : ConstraintCS */,
				179		/* check-rule completeoclcs::PathNameDeclCS.ownedPathName : PathNameCS */,
				158		/* check-rule basecs::TemplateableElementCS.ownedSignature : TemplateSignatureCS */,
				142		/* assign V3 = |ClassifierContextDeclCS::ownedDefinitions| */,
				137		/* assign V2 = |ClassifierContextDeclCS::ownedInvariants| */,
				40		/* assert (|PathNameDeclCS::ownedPathName| - 1) == 0 */,
				120		/* assign V1 = |ClassifierContextDeclCS::selfName| */,
			...
			createSerializationSteps(
				179		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				123		/* 'context' || soft-space value soft-space */,
				...
				62		/* PathNameDeclCS::ownedPathName=PathNameCS || value */,
				168		/* V02*2-steps || value */,
				135		/* 'inv' || soft-space value soft-space */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(CompleteOCLCSPackage.Literals.PATH_NAME_DECL_CS__OWNED_PATH_NAME, 23/* PathNameCS */,
					(67/*PathNameCS*/ << 4) | 0 /*[1]*/
				),
		...
		// CompleteOCL::ClassifierContextDeclCS-1(completeoclcs::ClassifierContextDeclCS): { "context" ownedSignature=TemplateSignatureCS[?] selfName=UnrestrictedName[?] ownedPathName=PathNameCS { { "inv" ownedInvariants+=ConstraintCS }[*] ownedDefinitions+=DefCS[+] } }
		serializationRules[17] = createSerializationRule("ClassifierContextDeclCS-1", 3,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				166		/* check-rule completeoclcs::ClassifierContextDeclCS.ownedDefinitions : DefCS|DefOperationCS|DefPropertyCS */,
				167		/* check-rule completeoclcs::ClassifierContextDeclCS.ownedInvariants : ConstraintCS */,
		...
		serializationRules[18] = createSerializationRule("CompleteOCLDocumentCS-0", 10,
			createSerializationMatchSteps(
				62		/* assert |NamedElementCS::name| == 0 */,
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				168		/* check-rule completeoclcs::CompleteOCLDocumentCS.ownedContexts : ClassifierContextDeclCS|ContextDeclCS|OperationContextDeclCS|PropertyContextDeclCS */,
				153		/* check-rule basecs::RootCS.ownedImports : ImportCS */,
				169		/* check-rule completeoclcs::CompleteOCLDocumentCS.ownedPackages : PackageDeclarationCS */,
				138		/* assign V2 = |CompleteOCLDocumentCS::ownedContexts| */,
				122		/* assign V1 = |CompleteOCLDocumentCS::ownedPackages| */,
				104		/* assign V0 = |RootCS::ownedImports| */
			),
		...
		serializationRules[19] = createSerializationRule("ConstraintCS-0", 12,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				55		/* assert |ConstraintCS::stereotype| == 0 */,
				149		/* check-rule basecs::ConstraintCS.ownedMessageSpecification : SpecificationCS */,
				150		/* check-rule basecs::ConstraintCS.ownedSpecification : SpecificationCS */,
				6		/* assert (|ConstraintCS::ownedSpecification| - 1) == 0 */,
				98		/* assign V0 = |NamedElementCS::name| */,
				123		/* assign V1 = |ConstraintCS::ownedMessageSpecification| */
			),
		...
		serializationRules[20] = createSerializationRule("DefOperationCS-0", 17,
			createSerializationMatchSteps(
				73		/* assert |TypedElementCS::isOptional| == 0 */,
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				74		/* assert |TypedElementCS::qualifiers| == 0 */,
				171		/* check-rule completeoclcs::DefOperationCS.ownedParameters : DefParameterCS */,
				158		/* check-rule basecs::TemplateableElementCS.ownedSignature : TemplateSignatureCS */,
				170		/* check-rule completeoclcs::DefCS.ownedSpecification : SpecificationCS */,
				161		/* check-rule basecs::TypedElementCS.ownedType : TypeExpCS */,
				8		/* assert (|DefCS::ownedSpecification| - 1) == 0 */,
				146		/* assign V4 = |TypedElementCS::ownedType| */,
				27		/* assert (|NamedElementCS::name| - 1) == 0 */,
				129		/* assign V1 = |TemplateableElementCS::ownedSignature| */,
			...
			createSerializationSteps(
				...
				124		/* 'def' || soft-space value soft-space */,
				110		/* ':' || soft-space value soft-space */,
				158		/* V01*1-steps || value */,
				71		/* TemplateableElementCS::ownedSignature=TemplateSignatureCS || value */,
				182		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
		...
		serializationRules[21] = createSerializationRule("DefParameterCS-0", 18,
			createSerializationMatchSteps(
				73		/* assert |TypedElementCS::isOptional| == 0 */,
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				74		/* assert |TypedElementCS::qualifiers| == 0 */,
		...
		serializationRules[22] = createSerializationRule("DefPropertyCS-0", 19,
			createSerializationMatchSteps(
				73		/* assert |TypedElementCS::isOptional| == 0 */,
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				74		/* assert |TypedElementCS::qualifiers| == 0 */,
		...
		serializationRules[23] = createSerializationRule("ImportCS-0", 35,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				151		/* check-rule basecs::ImportCS.ownedPathName : URIPathNameCS */,
				124		/* assign V1 = |ImportCS::isAll.'::*'| */,
				15		/* assert (|ImportCS::ownedPathName| - 1) == 0 */,
				98		/* assign V0 = |NamedElementCS::name| */
			),
		...
		serializationRules[24] = createSerializationRule("NavigatingArgExpCS-0", 55,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				116		/* '?' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		...
		serializationRules[25] = createSerializationRule("OperationContextDeclCS-0", 64,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				173		/* check-rule completeoclcs::OperationContextDeclCS.ownedBodies : SpecificationCS */,
				174		/* check-rule completeoclcs::OperationContextDeclCS.ownedParameters : ParameterCS */,
				179		/* check-rule completeoclcs::PathNameDeclCS.ownedPathName : PathNameCS */,
				175		/* check-rule completeoclcs::OperationContextDeclCS.ownedPostconditions : ConstraintCS */,
				176		/* check-rule completeoclcs::OperationContextDeclCS.ownedPreconditions : ConstraintCS */,
				158		/* check-rule basecs::TemplateableElementCS.ownedSignature : TemplateSignatureCS */,
				172		/* check-rule completeoclcs::FeatureContextDeclCS.ownedType : TypeExpCS */,
				148		/* assign V6 = |OperationContextDeclCS::ownedPreconditions| */,
				147		/* assign V5 = |OperationContextDeclCS::ownedPostconditions| */,
				145		/* assign V4 = |OperationContextDeclCS::ownedBodies| */,
				143		/* assign V3 = |FeatureContextDeclCS::ownedType| */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(CompleteOCLCSPackage.Literals.OPERATION_CONTEXT_DECL_CS__OWNED_BODIES, 32/* SpecificationCS */,
		...
		// CompleteOCL::PackageDeclarationCS-0(completeoclcs::PackageDeclarationCS): { "package" ownedPathName=PathNameCS { "inv" ownedInvariants+=ConstraintCS }[*] ownedContexts+=ContextDeclCS[*] "endpackage" }
		serializationRules[26] = createSerializationRule("PackageDeclarationCS-0", 65,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				177		/* check-rule completeoclcs::PackageDeclarationCS.ownedContexts : ClassifierContextDeclCS|ContextDeclCS|OperationContextDeclCS|PropertyContextDeclCS */,
				178		/* check-rule completeoclcs::PackageDeclarationCS.ownedInvariants : ConstraintCS */,
				179		/* check-rule completeoclcs::PathNameDeclCS.ownedPathName : PathNameCS */,
				127		/* assign V1 = |PackageDeclarationCS::ownedContexts| */,
				102		/* assign V0 = |PackageDeclarationCS::ownedInvariants| */,
				40		/* assert (|PathNameDeclCS::ownedPathName| - 1) == 0 */
			...
			createSerializationSteps(
				179		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				139		/* 'package' || soft-space value soft-space */,
				62		/* PathNameDeclCS::ownedPathName=PathNameCS || value */,
				151		/* V00*2-steps || value */,
				135		/* 'inv' || soft-space value soft-space */,
				...
				129		/* 'endpackage' || soft-space value soft-space */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[27] = createSerializationRule("ParameterCS-0", 66,
			createSerializationMatchSteps(
				73		/* assert |TypedElementCS::isOptional| == 0 */,
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				74		/* assert |TypedElementCS::qualifiers| == 0 */,
		...
		// CompleteOCL::PropertyContextDeclCS-0(completeoclcs::PropertyContextDeclCS): { "context" ownedPathName=PathNameCS ":" ownedType=TypeExpCS { { "derive" ":" ownedDefaultExpressions+=SpecificationCS }[*] { "init" ":" ownedDefaultExpressions+=SpecificationCS }[*] } }
		serializationRules[28] = createSerializationRule("PropertyContextDeclCS-0", 75,
			null,	// run-time resolution using SerializationSteps
			createSerializationSteps(
				179		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				123		/* 'context' || soft-space value soft-space */,
				...
				125		/* 'derive' || soft-space value soft-space */,
				110		/* ':' || soft-space value soft-space */,
				21		/* PropertyContextDeclCS::ownedDefaultExpressions+=SpecificationCS || value */,
				163		/* V01*3-steps || value */,
				134		/* 'init' || soft-space value soft-space */,
				110		/* ':' || soft-space value soft-space */,
				21		/* PropertyContextDeclCS::ownedDefaultExpressions+=SpecificationCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationReference(CompleteOCLCSPackage.Literals.PROPERTY_CONTEXT_DECL_CS__OWNED_DEFAULT_EXPRESSIONS, 32/* SpecificationCS */,
					(83/*SpecificationCS*/ << 4) | 2 /*[*]*/
				),
				createSerializationReference(CompleteOCLCSPackage.Literals.PATH_NAME_DECL_CS__OWNED_PATH_NAME, 23/* PathNameCS */,
					(67/*PathNameCS*/ << 4) | 0 /*[1]*/
		...
		serializationRules[29] = createSerializationRule("SpecificationCS-0", 83,
			createSerializationMatchSteps(
				71		/* assert |SpecificationCS::exprString| == 0 */,
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				195		/* check-rule essentialoclcs::ExpSpecificationCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				9		/* assert (|ExpSpecificationCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[30] = createSerializationRule("SpecificationCS-1", 83,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				57		/* assert |ExpSpecificationCS::ownedExpression| == 0 */,
				45		/* assert (|SpecificationCS::exprString| - 1) == 0 */
		...
		serializationRules[31] = createSerializationRule("TemplateSignatureCS-0", 89,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				157		/* check-rule basecs::TemplateSignatureCS.ownedParameters : TypeParameterCS */,
				85		/* assign V0 = (|TemplateSignatureCS::ownedParameters| - 1) */
			),
			createSerializationSteps(
				179		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
		...
		serializationRules[32] = createSerializationRule("TemplateSignatureCS-1", 89,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				157		/* check-rule basecs::TemplateSignatureCS.ownedParameters : TypeParameterCS */,
				85		/* assign V0 = (|TemplateSignatureCS::ownedParameters| - 1) */
		...
		serializationRules[33] = createSerializationRule("BooleanLiteralExpCS-0", 2,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				1		/* assert (|BooleanLiteralExpCS::symbol.'false|true'| - 1) == 0 */
			),
		...
		serializationRules[34] = createSerializationRule("CoIteratorVariableCS-0", 4,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				77		/* assert |VariableCS::ownedInitExpression| == 0 */,
				231		/* check-rule essentialoclcs::VariableCS.ownedType : TypeExpCS */,
				110		/* assign V0 = |VariableCS::ownedType| */,
				27		/* assert (|NamedElementCS::name| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[35] = createSerializationRule("CollectionLiteralExpCS-0", 5,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				184		/* check-rule essentialoclcs::CollectionLiteralExpCS.ownedParts : CollectionLiteralPartCS */,
				185		/* check-rule essentialoclcs::CollectionLiteralExpCS.ownedType : CollectionTypeCS */,
				2		/* assert (|CollectionLiteralExpCS::ownedType| - 1) == 0 */,
				79		/* assign V0 = (|CollectionLiteralExpCS::ownedParts| > 0) */,
				112		/* assign V1 = (|CollectionLiteralExpCS::ownedParts| - 1) */
			),
		...
		serializationRules[36] = createSerializationRule("CollectionLiteralPartCS-0", 6,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				186		/* check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				188		/* check-rule essentialoclcs::CollectionLiteralPartCS.ownedLastExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				90		/* assign V0 = |CollectionLiteralPartCS::ownedLastExpression| */,
				3		/* assert (|CollectionLiteralPartCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[37] = createSerializationRule("CollectionLiteralPartCS-1", 6,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				53		/* assert |CollectionLiteralPartCS::ownedLastExpression| == 0 */,
				187		/* check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : PatternExpCS */,
				3		/* assert (|CollectionLiteralPartCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[38] = createSerializationRule("CollectionPatternCS-0", 7,
			createSerializationMatchSteps(
				75		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				54		/* assert |CollectionPatternCS::ownedPatternGuard| == 0 */,
				189		/* check-rule essentialoclcs::CollectionPatternCS.ownedParts : PatternExpCS */,
				190		/* check-rule essentialoclcs::CollectionPatternCS.ownedType : CollectionTypeCS */,
				91		/* assign V0 = |CollectionPatternCS::restVariableName| */,
				113		/* assign V1 = (|CollectionPatternCS::ownedParts| - 1) */,
				4		/* assert (|CollectionPatternCS::ownedType| - 1) == 0 */
			),
		...
		serializationRules[39] = createSerializationRule("CollectionTypeCS-0", 8,
			createSerializationMatchSteps(
				75		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				191		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				192		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
				92		/* assign V0 = |CollectionTypeCS::ownedType| */,
				5		/* assert (|CollectionTypeCS::name| - 1) == 0 */,
				121		/* assign V1 = |CollectionTypeCS::ownedCollectionMultiplicity| */
			),
		...
		serializationRules[40] = createSerializationRule("CurlyBracketedClauseCS-0", 14,
			createSerializationMatchSteps(
				56		/* assert |CurlyBracketedClauseCS::value| == 0 */,
				194		/* check-rule essentialoclcs::CurlyBracketedClauseCS.ownedParts : ShadowPartCS */,
				80		/* assign V0 = (|CurlyBracketedClauseCS::ownedParts| > 0) */,
				114		/* assign V1 = (|CurlyBracketedClauseCS::ownedParts| - 1) */
			),
			createSerializationSteps(
		...
		serializationRules[41] = createSerializationRule("ElseIfThenExpCS-0", 22,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				200		/* check-rule essentialoclcs::IfThenExpCS.ownedCondition : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				201		/* check-rule essentialoclcs::IfThenExpCS.ownedThenExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				14		/* assert (|IfThenExpCS::ownedThenExpression| - 1) == 0 */,
				13		/* assert (|IfThenExpCS::ownedCondition| - 1) == 0 */
			),
			createSerializationSteps(
				179		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				127		/* 'elseif' || soft-space value soft-space */,
				16		/* IfThenExpCS::ownedCondition=ExpCS || value */,
				143		/* 'then' || soft-space value soft-space */,
		...
		serializationRules[42] = createSerializationRule("ExpCS-18", 29,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				202		/* check-rule essentialoclcs::InfixExpCS.ownedLeft : BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				218		/* check-rule essentialoclcs::OperatorExpCS.ownedRight : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				37		/* assert (|OperatorExpCS::ownedRight| - 1) == 0 */,
				27		/* assert (|NamedElementCS::name| - 1) == 0 */,
				16		/* assert (|InfixExpCS::ownedLeft| - 1) == 0 */
			),
		...
		serializationRules[43] = createSerializationRule("IfExpCS-0", 34,
			createSerializationMatchSteps(
				58		/* assert |IfExpCS::isImplicit| == 0 */,
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				196		/* check-rule essentialoclcs::IfExpCS.ownedCondition : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				197		/* check-rule essentialoclcs::IfExpCS.ownedElseExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				198		/* check-rule essentialoclcs::IfExpCS.ownedIfThenExpressions : ElseIfThenExpCS */,
				199		/* check-rule essentialoclcs::IfExpCS.ownedThenExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				11		/* assert (|IfExpCS::ownedElseExpression| - 1) == 0 */,
				94		/* assign V0 = |IfExpCS::ownedIfThenExpressions| */,
				12		/* assert (|IfExpCS::ownedThenExpression| - 1) == 0 */,
				10		/* assert (|IfExpCS::ownedCondition| - 1) == 0 */
			...
			createSerializationSteps(
				...
				126		/* 'else' || soft-space value soft-space */,
				23		/* IfExpCS::ownedElseExpression=ExpCS || value */,
				128		/* 'endif' || soft-space value soft-space */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[44] = createSerializationRule("InvalidLiteralExpCS-0", 37,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[45] = createSerializationRule("LambdaLiteralExpCS-0", 40,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				203		/* check-rule essentialoclcs::LambdaLiteralExpCS.ownedExpressionCS : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				17		/* assert (|LambdaLiteralExpCS::ownedExpressionCS| - 1) == 0 */
			),
			createSerializationSteps(
				179		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
		...
		serializationRules[46] = createSerializationRule("LetExpCS-0", 41,
			createSerializationMatchSteps(
				59		/* assert |LetExpCS::isImplicit| == 0 */,
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				204		/* check-rule essentialoclcs::LetExpCS.ownedInExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				205		/* check-rule essentialoclcs::LetExpCS.ownedVariables : LetVariableCS */,
				18		/* assert (|LetExpCS::ownedInExpression| - 1) == 0 */,
				81		/* assign V0 = (|LetExpCS::ownedVariables| - 1) */
			),
			createSerializationSteps(
		...
		serializationRules[47] = createSerializationRule("LetVariableCS-0", 42,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				230		/* check-rule essentialoclcs::VariableCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				206		/* check-rule essentialoclcs::LetVariableCS.ownedRoundBracketedClause : RoundBracketedClauseCS */,
				231		/* check-rule essentialoclcs::VariableCS.ownedType : TypeExpCS */,
				52		/* assert (|VariableCS::ownedInitExpression| - 1) == 0 */,
				132		/* assign V1 = |VariableCS::ownedType| */,
				95		/* assign V0 = |LetVariableCS::ownedRoundBracketedClause| */,
		...
		serializationRules[48] = createSerializationRule("MapLiteralExpCS-0", 45,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				207		/* check-rule essentialoclcs::MapLiteralExpCS.ownedParts : MapLiteralPartCS */,
				208		/* check-rule essentialoclcs::MapLiteralExpCS.ownedType : MapTypeCS */,
				19		/* assert (|MapLiteralExpCS::ownedType| - 1) == 0 */,
				82		/* assign V0 = (|MapLiteralExpCS::ownedParts| > 0) */,
				115		/* assign V1 = (|MapLiteralExpCS::ownedParts| - 1) */
			),
		...
		serializationRules[49] = createSerializationRule("MapLiteralPartCS-0", 46,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				209		/* check-rule essentialoclcs::MapLiteralPartCS.ownedKey : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				210		/* check-rule essentialoclcs::MapLiteralPartCS.ownedValue : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				21		/* assert (|MapLiteralPartCS::ownedValue| - 1) == 0 */,
				20		/* assert (|MapLiteralPartCS::ownedKey| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[50] = createSerializationRule("MapTypeCS-0", 47,
			createSerializationMatchSteps(
				75		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				211		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				212		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
				96		/* assign V0 = |MapTypeCS::ownedValueType| */,
				23		/* assert (|MapTypeCS::ownedKeyType| - V0) == 0 */,
				22		/* assert (|MapTypeCS::name.'Map'| - 1) == 0 */
			),
		...
		serializationRules[51] = createSerializationRule("Model-0", 48,
			createSerializationMatchSteps(
				62		/* assert |NamedElementCS::name| == 0 */,
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				68		/* assert |RootCS::ownedImports| == 0 */,
				193		/* check-rule essentialoclcs::ContextCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				7		/* assert (|ContextCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[52] = createSerializationRule("NameExpCS-0", 53,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				180		/* check-rule essentialoclcs::AbstractNameExpCS.ownedCurlyBracketedClause : CurlyBracketedClauseCS */,
				181		/* check-rule essentialoclcs::AbstractNameExpCS.ownedPathName : PathNameCS */,
				182		/* check-rule essentialoclcs::AbstractNameExpCS.ownedRoundBracketedClause : RoundBracketedClauseCS */,
				183		/* check-rule essentialoclcs::AbstractNameExpCS.ownedSquareBracketedClauses : SquareBracketedClauseCS */,
				141		/* assign V3 = |AbstractNameExpCS::isPre.'@'| */,
				136		/* assign V2 = |AbstractNameExpCS::ownedCurlyBracketedClause| */,
				119		/* assign V1 = |AbstractNameExpCS::ownedRoundBracketedClause| */,
				89		/* assign V0 = |AbstractNameExpCS::ownedSquareBracketedClauses| */,
		...
		serializationRules[53] = createSerializationRule("NavigatingArgCS-0", 54,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				63		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				64		/* assert |NavigatingArgCS::ownedInitExpression| == 0 */,
				65		/* assert |NavigatingArgCS::ownedNameExpression| == 0 */,
				67		/* assert |NavigatingArgCS::prefix| == 0 */,
				216		/* check-rule essentialoclcs::NavigatingArgCS.ownedType : TypeExpCS */,
				31		/* assert (|NavigatingArgCS::ownedType| - 1) == 0 */
			),
			createSerializationSteps(
				179		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
		...
		serializationRules[54] = createSerializationRule("NavigatingArgCS-1", 54,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				67		/* assert |NavigatingArgCS::prefix| == 0 */,
				213		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
				214		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				215		/* check-rule essentialoclcs::NavigatingArgCS.ownedNameExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				216		/* check-rule essentialoclcs::NavigatingArgCS.ownedType : TypeExpCS */,
				126		/* assign V1 = |NavigatingArgCS::ownedInitExpression| */,
				99		/* assign V0 = |NavigatingArgCS::ownedCoIterator| */,
				31		/* assert (|NavigatingArgCS::ownedType| - 1) == 0 */,
		...
		serializationRules[55] = createSerializationRule("NavigatingArgCS-2", 54,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				66		/* assert |NavigatingArgCS::ownedType| == 0 */,
				67		/* assert |NavigatingArgCS::prefix| == 0 */,
		...
		serializationRules[56] = createSerializationRule("NavigatingArgCS-3", 54,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				67		/* assert |NavigatingArgCS::prefix| == 0 */,
				213		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
		...
		serializationRules[57] = createSerializationRule("NavigatingArgCS-4", 54,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				63		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				64		/* assert |NavigatingArgCS::ownedInitExpression| == 0 */,
		...
		serializationRules[58] = createSerializationRule("NavigatingBarArgCS-0", 56,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				63		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				214		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		serializationRules[59] = createSerializationRule("NavigatingCommaArgCS-0", 57,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				213		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
				214		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		serializationRules[60] = createSerializationRule("NavigatingCommaArgCS-1", 57,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				66		/* assert |NavigatingArgCS::ownedType| == 0 */,
				213		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
		...
		serializationRules[61] = createSerializationRule("NavigatingCommaArgCS-2", 57,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				213		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
				214		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		serializationRules[62] = createSerializationRule("NavigatingCommaArgCS-3", 57,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				63		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				64		/* assert |NavigatingArgCS::ownedInitExpression| == 0 */,
		...
		serializationRules[63] = createSerializationRule("NavigatingSemiArgCS-0", 58,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				63		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				214		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
	...
	private void initSerializationRules1() {
		...
		serializationRules[64] = createSerializationRule("NestedExpCS-0", 60,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				217		/* check-rule essentialoclcs::NestedExpCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				35		/* assert (|NestedExpCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
				179		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
		...
		serializationRules[65] = createSerializationRule("NullLiteralExpCS-0", 62,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				138		/* 'null' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		// EssentialOCL::NumberLiteralExpCS-0(essentialoclcs::NumberLiteralExpCS): symbol=NUMBER_LITERAL
		serializationRules[66] = createSerializationRule("NumberLiteralExpCS-0", 63,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				36		/* assert (|NumberLiteralExpCS::symbol| - 1) == 0 */
			),
		...
		serializationRules[67] = createSerializationRule("PatternExpCS-0", 68,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				221		/* check-rule essentialoclcs::PatternExpCS.ownedPatternType : TypeExpCS */,
				41		/* assert (|PatternExpCS::ownedPatternType| - 1) == 0 */,
				103		/* assign V0 = |PatternExpCS::patternVariableName| */
			),
			createSerializationSteps(
		...
		serializationRules[68] = createSerializationRule("PrefixedLetExpCS-1", 69,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				220		/* check-rule essentialoclcs::OperatorExpCS.ownedRight : LetExpCS|PrefixedLetExpCS */,
				37		/* assert (|OperatorExpCS::ownedRight| - 1) == 0 */,
				27		/* assert (|NamedElementCS::name| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[69] = createSerializationRule("PrefixedPrimaryExpCS-15", 70,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
		...
		serializationRules[70] = createSerializationRule("PrimitiveTypeCS-0", 73,
			createSerializationMatchSteps(
				75		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				42		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
			),
		...
		serializationRules[71] = createSerializationRule("RoundBracketedClauseCS-0", 76,
			null,	// run-time resolution using SerializationSteps
			createSerializationSteps(
				104		/* '(' || no-space value no-space */,
				152		/* V00*3-steps || value */,
		...
		serializationRules[72] = createSerializationRule("SelfExpCS-0", 80,
			createSerializationMatchSteps(
				69		/* assert |SelfExpCS::name| == 0 */,
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				142		/* 'self' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		...
		serializationRules[73] = createSerializationRule("ShadowPartCS-0", 81,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				222		/* check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				43		/* assert (|ShadowPartCS::ownedInitExpression| - 1) == 0 */,
				44		/* assert (|ShadowPartCS::referredProperty| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[74] = createSerializationRule("ShadowPartCS-1", 81,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				70		/* assert |ShadowPartCS::referredProperty| == 0 */,
				223		/* check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : StringLiteralExpCS */,
				43		/* assert (|ShadowPartCS::ownedInitExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[75] = createSerializationRule("SimplePathNameCS-0", 82,
			createSerializationMatchSteps(
				152		/* check-rule basecs::PathNameCS.ownedPathElements : FirstPathElementCS */,
				39		/* assert (|PathNameCS::ownedPathElements| - 1) == 0 */
			),
			createSerializationSteps(
				187		/* PathNameCS::ownedPathElements+=FirstPathElementCS || value */
		...
		serializationRules[76] = createSerializationRule("SquareBracketedClauseCS-0", 84,
			createSerializationMatchSteps(
				224		/* check-rule essentialoclcs::SquareBracketedClauseCS.ownedTerms : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				83		/* assign V0 = (|SquareBracketedClauseCS::ownedTerms| - 1) */
			),
			createSerializationSteps(
				120		/* '[' || no-space value no-space */,
		...
		serializationRules[77] = createSerializationRule("StringLiteralExpCS-0", 86,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				105		/* assign V0 = |StringLiteralExpCS::segments| */
			),
		...
		serializationRules[78] = createSerializationRule("TupleLiteralExpCS-0", 90,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				225		/* check-rule essentialoclcs::TupleLiteralExpCS.ownedParts : TupleLiteralPartCS */,
				86		/* assign V0 = (|TupleLiteralExpCS::ownedParts| - 1) */
			),
			createSerializationSteps(
				179		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
		...
		serializationRules[79] = createSerializationRule("TupleLiteralPartCS-0", 91,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				230		/* check-rule essentialoclcs::VariableCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				231		/* check-rule essentialoclcs::VariableCS.ownedType : TypeExpCS */,
		...
		serializationRules[80] = createSerializationRule("TuplePartCS-0", 92,
			createSerializationMatchSteps(
				73		/* assert |TypedElementCS::isOptional| == 0 */,
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				74		/* assert |TypedElementCS::qualifiers| == 0 */,
		...
		serializationRules[81] = createSerializationRule("TupleTypeCS-0", 93,
			createSerializationMatchSteps(
				75		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				159		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				47		/* assert (|TupleTypeCS::name.'Tuple'| - 1) == 0 */,
				87		/* assign V0 = (|TupleTypeCS::ownedParts| > 0) */,
				117		/* assign V1 = (|TupleTypeCS::ownedParts| > 0) */,
				135		/* assign V2 = (|TupleTypeCS::ownedParts| - 1) */
		...
		serializationRules[82] = createSerializationRule("TypeExpCS-0", 94,
			createSerializationMatchSteps(
				162		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				108		/* assign V0 = |TypedRefCS::ownedMultiplicity| */,
				42		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[83] = createSerializationRule("TypeExpCS-1", 94,
			createSerializationMatchSteps(
				191		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				162		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				192		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
		...
		serializationRules[84] = createSerializationRule("TypeExpCS-2", 94,
			createSerializationMatchSteps(
				211		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				162		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				212		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
		...
		serializationRules[85] = createSerializationRule("TypeExpCS-3", 94,
			createSerializationMatchSteps(
				227		/* check-rule essentialoclcs::TypeNameExpCS.ownedCurlyBracketedClause : CurlyBracketedClauseCS */,
				162		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				228		/* check-rule essentialoclcs::TypeNameExpCS.ownedPathName : PathNameCS */,
				229		/* check-rule essentialoclcs::TypeNameExpCS.ownedPatternGuard : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				139		/* assign V2 = |TypedRefCS::ownedMultiplicity| */,
				107		/* assign V0 = |TypeNameExpCS::ownedCurlyBracketedClause| */,
				49		/* assert (|TypeNameExpCS::ownedPathName| - 1) == 0 */,
				130		/* assign V1 = |TypeNameExpCS::ownedPatternGuard| */
		...
		serializationRules[86] = createSerializationRule("TypeExpCS-4", 94,
			createSerializationMatchSteps(
				54		/* assert |CollectionPatternCS::ownedPatternGuard| == 0 */,
				162		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				189		/* check-rule essentialoclcs::CollectionPatternCS.ownedParts : PatternExpCS */,
		...
		serializationRules[87] = createSerializationRule("TypeExpCS-5", 94,
			createSerializationMatchSteps(
				162		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				159		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				144		/* assign V3 = |TypedRefCS::ownedMultiplicity| */,
		...
		serializationRules[88] = createSerializationRule("TypeLiteralExpCS-0", 97,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				72		/* assert |TypeLiteralExpCS::ownedPathName| == 0 */,
				226		/* check-rule essentialoclcs::TypeLiteralExpCS.ownedType : TypeLiteralWithMultiplicityCS */,
				48		/* assert (|TypeLiteralExpCS::ownedType| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[89] = createSerializationRule("TypeLiteralWithMultiplicityCS-0", 98,
			createSerializationMatchSteps(
				162		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				108		/* assign V0 = |TypedRefCS::ownedMultiplicity| */,
				42		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
		...
		serializationRules[90] = createSerializationRule("TypeLiteralWithMultiplicityCS-1", 98,
			createSerializationMatchSteps(
				191		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				162		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				192		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
		...
		serializationRules[91] = createSerializationRule("TypeLiteralWithMultiplicityCS-2", 98,
			createSerializationMatchSteps(
				211		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				162		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				212		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
		...
		serializationRules[92] = createSerializationRule("TypeLiteralWithMultiplicityCS-3", 98,
			createSerializationMatchSteps(
				162		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				159		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				144		/* assign V3 = |TypedRefCS::ownedMultiplicity| */,
		...
		serializationRules[93] = createSerializationRule("TypeNameExpCS-0", 99,
			createSerializationMatchSteps(
				75		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				227		/* check-rule essentialoclcs::TypeNameExpCS.ownedCurlyBracketedClause : CurlyBracketedClauseCS */,
				228		/* check-rule essentialoclcs::TypeNameExpCS.ownedPathName : PathNameCS */,
		...
		serializationRules[94] = createSerializationRule("URIFirstPathElementCS-0", 107,
			createSerializationMatchSteps(
				38		/* assert (|PathElementCS::referredElement| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[95] = createSerializationRule("URIFirstPathElementCS-1", 107,
			createSerializationMatchSteps(
				38		/* assert (|PathElementCS::referredElement| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[96] = createSerializationRule("URIPathNameCS-0", 108,
			null,	// run-time resolution using SerializationSteps
			createSerializationSteps(
		...
		serializationRules[97] = createSerializationRule("UnlimitedNaturalLiteralExpCS-0", 110,
			createSerializationMatchSteps(
				60		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
	...
	private void initSerializationSteps() {
		...
		// 62: PathNameDeclCS::ownedPathName=PathNameCS || value
		serializationSteps[62] = createSerializationStepAssignedRuleCall(CompleteOCLCSPackage.Literals.PATH_NAME_DECL_CS__OWNED_PATH_NAME, 67 /*PathNameCS*/, 0);
		// 63: TypeNameExpCS::ownedPathName=PathNameCS || value
		...
		// 91: PatternExpCS::patternVariableName=UnrestrictedName || soft-space value soft-space
		serializationSteps[91] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS__PATTERN_VARIABLE_NAME, 112 /*UnrestrictedName*/, 6);
		// 92: NavigatingArgCS::prefix=';' || no-space value soft-new-line
		...
		// 95: ShadowPartCS::referredProperty=UnrestrictedName || soft-space value soft-space
		serializationSteps[95] = createSerializationStepCrossReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__REFERRED_PROPERTY, getCrossReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__REFERRED_PROPERTY, "UnrestrictedName"), 112, 6);
		// 96: CollectionPatternCS::restVariableName=Identifier || soft-space value soft-space
		...
		// 98: ClassifierContextDeclCS::selfName=UnrestrictedName || soft-space value soft-space
		serializationSteps[98] = createSerializationStepAssignedRuleCall(CompleteOCLCSPackage.Literals.CLASSIFIER_CONTEXT_DECL_CS__SELF_NAME, 112 /*UnrestrictedName*/, 6);
		// 99: MultiplicityStringCS::stringBounds='*|+|?' || soft-space value soft-space
		...
		// 116: '?' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[116] = createSerializationStepKeyword("?", 2);
		// 117: '?' || soft-space value soft-space
		...
		// 122: 'body' || soft-space value soft-space
		serializationSteps[122] = createSerializationStepKeyword("body", 6);
		// 123: 'context' || soft-space value soft-space
		serializationSteps[123] = createSerializationStepKeyword("context", 6);
		// 124: 'def' || soft-space value soft-space
		serializationSteps[124] = createSerializationStepKeyword("def", 6);
		// 125: 'derive' || soft-space value soft-space
		serializationSteps[125] = createSerializationStepKeyword("derive", 6);
		// 126: 'else' || soft-space value soft-space
		serializationSteps[126] = createSerializationStepKeyword("else", 6);
		// 127: 'elseif' || soft-space value soft-space
		serializationSteps[127] = createSerializationStepKeyword("elseif", 6);
		// 128: 'endif' || soft-space value soft-space
		serializationSteps[128] = createSerializationStepKeyword("endif", 6);
		// 129: 'endpackage' || soft-space value soft-space
		serializationSteps[129] = createSerializationStepKeyword("endpackage", 6);
		// 130: 'extends' || soft-space value soft-space
		serializationSteps[130] = createSerializationStepKeyword("extends", 6);
		// 131: 'if' || soft-space value soft-space
		serializationSteps[131] = createSerializationStepKeyword("if", 6);
		// 132: 'import' || value
		serializationSteps[132] = createSerializationStepKeyword("import", 0);
		// 133: 'in' || soft-space value soft-space
		serializationSteps[133] = createSerializationStepKeyword("in", 6);
		// 134: 'init' || soft-space value soft-space
		serializationSteps[134] = createSerializationStepKeyword("init", 6);
		// 135: 'inv' || soft-space value soft-space
		serializationSteps[135] = createSerializationStepKeyword("inv", 6);
		// 136: 'invalid' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		...
		// 138: 'null' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[138] = createSerializationStepKeyword("null", 2);
		// 139: 'package' || soft-space value soft-space
		serializationSteps[139] = createSerializationStepKeyword("package", 6);
		// 140: 'post' || soft-space value soft-space
		serializationSteps[140] = createSerializationStepKeyword("post", 6);
		// 141: 'pre' || soft-space value soft-space
		serializationSteps[141] = createSerializationStepKeyword("pre", 6);
		// 142: 'self' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[142] = createSerializationStepKeyword("self", 2);
		// 143: 'then' || soft-space value soft-space
		serializationSteps[143] = createSerializationStepKeyword("then", 6);
		// 144: '{' || soft-space value push soft-new-line
		...
		// 182: NamedElementCS::name=UnrestrictedName || soft-space value soft-space
		serializationSteps[182] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 112 /*UnrestrictedName*/, 6);
		// 183: NamedElementCS::name=Identifier || soft-space value soft-space
		...
		// 194: PathElementCS::referredElement=UnrestrictedName || soft-space value soft-space
		serializationSteps[194] = createSerializationStepCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, getCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, "UnrestrictedName"), 112, 6);
	}
}
