...
public class InternalCompleteOCLLexer extends Lexer {
    ...
    public final void mRULE_UNQUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7409:22: ( '\\u00A3$%^\\u00A3$%^' )
            // InternalCompleteOCL.g:7409:24: '\\u00A3$%^\\u00A3$%^'
            {
            match("\u00A3$%^\u00A3$%^");
    ...
    public final void mRULE_ESCAPED_CHARACTER() throws RecognitionException {
        try {
            // InternalCompleteOCL.g:7411:33: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) )
            // InternalCompleteOCL.g:7411:35: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
            {
            match('\\');
    ...
    public final void mRULE_LETTER_CHARACTER() throws RecognitionException {
        try {
            // InternalCompleteOCL.g:7413:32: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) )
            // InternalCompleteOCL.g:7413:34: ( 'a' .. 'z' | 'A' .. 'Z' | '_' )
            {
    ...
    public final void mRULE_DOUBLE_QUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7415:27: ( '\"' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalCompleteOCL.g:7415:29: '\"' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"');
            // InternalCompleteOCL.g:7415:33: ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )*
            loop1:
            do {
                int alt1=3;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalCompleteOCL.g:7415:34: RULE_ESCAPED_CHARACTER
            	    {
    ...
    public final void mRULE_SINGLE_QUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7417:27: ( '\\'' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            // InternalCompleteOCL.g:7417:29: '\\'' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
            {
            match('\'');
            // InternalCompleteOCL.g:7417:34: ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop2:
            do {
                int alt2=3;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalCompleteOCL.g:7417:35: RULE_ESCAPED_CHARACTER
            	    {
            	    mRULE_ESCAPED_CHARACTER();
    ...
    public final void mRULE_ML_SINGLE_QUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7419:30: ( '/\\'' ( options {greedy=false; } : . )* '\\'/' )
            // InternalCompleteOCL.g:7419:32: '/\\'' ( options {greedy=false; } : . )* '\\'/'
            {
            match("/'");

            // InternalCompleteOCL.g:7419:38: ( options {greedy=false; } : . )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_SIMPLE_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7421:16: ( RULE_LETTER_CHARACTER ( RULE_LETTER_CHARACTER | '0' .. '9' )* )
            // InternalCompleteOCL.g:7421:18: RULE_LETTER_CHARACTER ( RULE_LETTER_CHARACTER | '0' .. '9' )*
            {
            mRULE_LETTER_CHARACTER();
            // InternalCompleteOCL.g:7421:40: ( RULE_LETTER_CHARACTER | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_ESCAPED_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7423:17: ( '_' RULE_SINGLE_QUOTED_STRING )
            // InternalCompleteOCL.g:7423:19: '_' RULE_SINGLE_QUOTED_STRING
            {
            match('_');
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7425:10: ( ( '0' .. '9' )+ )
            // InternalCompleteOCL.g:7425:12: ( '0' .. '9' )+
            {
            // InternalCompleteOCL.g:7425:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalCompleteOCL.g:7425:13: '0' .. '9'
            	    {
            	    matchRange('0','9');
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7427:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalCompleteOCL.g:7427:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*");

            // InternalCompleteOCL.g:7427:24: ( options {greedy=false; } : . )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7429:17: ( '--' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalCompleteOCL.g:7429:19: '--' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("--");

            // InternalCompleteOCL.g:7429:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop7:
            do {
                int alt7=2;
            ...
            // InternalCompleteOCL.g:7429:40: ( ( '\\r' )? '\\n' )?
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalCompleteOCL.g:7429:41: ( '\\r' )? '\\n'
                    {
                    // InternalCompleteOCL.g:7429:41: ( '\\r' )?
                    int alt8=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7431:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalCompleteOCL.g:7431:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalCompleteOCL.g:7431:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt10=0;
            loop10:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7433:16: ( . )
            // InternalCompleteOCL.g:7433:18: .
            {
            matchAny();
