...
public class InternalCompleteOCLLexer extends Lexer {
    ...
    public final void mRULE_UNQUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7384:22: ( '\\u00A3$%^\\u00A3$%^' )
            // InternalCompleteOCL.g:7384:24: '\\u00A3$%^\\u00A3$%^'
            {
            match("\u00A3$%^\u00A3$%^");
    ...
    public final void mRULE_ESCAPED_CHARACTER() throws RecognitionException {
        try {
            // InternalCompleteOCL.g:7386:33: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) )
            // InternalCompleteOCL.g:7386:35: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
            {
            match('\\');
    ...
    public final void mRULE_LETTER_CHARACTER() throws RecognitionException {
        try {
            // InternalCompleteOCL.g:7388:32: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) )
            // InternalCompleteOCL.g:7388:34: ( 'a' .. 'z' | 'A' .. 'Z' | '_' )
            {
    ...
    public final void mRULE_DOUBLE_QUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7390:27: ( '\"' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalCompleteOCL.g:7390:29: '\"' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"');
            // InternalCompleteOCL.g:7390:33: ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\"' ) ) )*
            loop1:
            do {
                int alt1=3;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalCompleteOCL.g:7390:34: RULE_ESCAPED_CHARACTER
            	    {
    ...
    public final void mRULE_SINGLE_QUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7392:27: ( '\\'' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            // InternalCompleteOCL.g:7392:29: '\\'' ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
            {
            match('\'');
            // InternalCompleteOCL.g:7392:34: ( RULE_ESCAPED_CHARACTER | ~ ( ( '\\\\' | '\\'' ) ) )*
            loop2:
            do {
                int alt2=3;
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalCompleteOCL.g:7392:35: RULE_ESCAPED_CHARACTER
            	    {
            	    mRULE_ESCAPED_CHARACTER();
    ...
    public final void mRULE_ML_SINGLE_QUOTED_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7394:30: ( '/\\'' ( options {greedy=false; } : . )* '\\'/' )
            // InternalCompleteOCL.g:7394:32: '/\\'' ( options {greedy=false; } : . )* '\\'/'
            {
            match("/'");

            // InternalCompleteOCL.g:7394:38: ( options {greedy=false; } : . )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_SIMPLE_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7396:16: ( RULE_LETTER_CHARACTER ( RULE_LETTER_CHARACTER | '0' .. '9' )* )
            // InternalCompleteOCL.g:7396:18: RULE_LETTER_CHARACTER ( RULE_LETTER_CHARACTER | '0' .. '9' )*
            {
            mRULE_LETTER_CHARACTER();
            // InternalCompleteOCL.g:7396:40: ( RULE_LETTER_CHARACTER | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_ESCAPED_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7398:17: ( '_' RULE_SINGLE_QUOTED_STRING )
            // InternalCompleteOCL.g:7398:19: '_' RULE_SINGLE_QUOTED_STRING
            {
            match('_');
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7400:10: ( ( '0' .. '9' )+ )
            // InternalCompleteOCL.g:7400:12: ( '0' .. '9' )+
            {
            // InternalCompleteOCL.g:7400:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalCompleteOCL.g:7400:13: '0' .. '9'
            	    {
            	    matchRange('0','9');
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7402:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalCompleteOCL.g:7402:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*");

            // InternalCompleteOCL.g:7402:24: ( options {greedy=false; } : . )*
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7404:17: ( '--' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalCompleteOCL.g:7404:19: '--' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("--");

            // InternalCompleteOCL.g:7404:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop7:
            do {
                int alt7=2;
            ...
            // InternalCompleteOCL.g:7404:40: ( ( '\\r' )? '\\n' )?
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalCompleteOCL.g:7404:41: ( '\\r' )? '\\n'
                    {
                    // InternalCompleteOCL.g:7404:41: ( '\\r' )?
                    int alt8=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7406:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalCompleteOCL.g:7406:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalCompleteOCL.g:7406:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt10=0;
            loop10:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCompleteOCL.g:7408:16: ( . )
            // InternalCompleteOCL.g:7408:18: .
            {
            matchAny();
