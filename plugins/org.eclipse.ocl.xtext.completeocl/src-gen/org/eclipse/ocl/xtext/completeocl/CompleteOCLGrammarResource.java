...
public class CompleteOCLGrammarResource extends AbstractGrammarResource
{
	...
	private static class _CompleteOCL
	{
		...
		private static void initParserRules() {
			PR_BodySpecificationCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("body"), setCardinality("?", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAlternatives(createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createAssignment("exprString", "=", createRuleCall(TR_UNQUOTED_STRING)))));
			PR_ClassifierContextDeclCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("context"), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(PR_TemplateSignatureCS))), setCardinality("?", createAssignment("selfName", "=", createRuleCall(PR_UnrestrictedName))), createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("+", createAlternatives(createAssignment("ownedInvariants", "+=", createRuleCall(PR_InvConstraintCS)), createAssignment("ownedDefinitions", "+=", createRuleCall(PR_DefCS))))));
			PR_CompleteOCLDocumentCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), setCardinality("*", createAssignment("ownedImports", "+=", createRuleCall(PR_ImportCS))), setCardinality("*", createAlternatives(createAssignment("ownedPackages", "+=", createRuleCall(PR_PackageDeclarationCS)), createAssignment("ownedContexts", "+=", createRuleCall(PR_ContextDeclCS))))));
			...
			PR_DefPropertyCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), setCardinality("?", createAssignment("isStatic", "?=", createKeyword("static"))), createKeyword("def"), setCardinality("?", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)), createKeyword("="), createAssignment("ownedSpecification", "=", createRuleCall(PR_SpecificationCS))));
			PR_DeriveSpecificationCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("derive"), setCardinality("?", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAlternatives(createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createAssignment("exprString", "=", createRuleCall(TR_UNQUOTED_STRING)))));
			PR_ImportCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createAlternatives(createKeyword("import"), createKeyword("include"), createKeyword("library")), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(_Base.PR_Identifier)), createKeyword(":"))), createAssignment("ownedPathName", "=", createRuleCall(_EssentialOCL.PR_URIPathNameCS)), setCardinality("?", createAssignment("isAll", "?=", createKeyword("::*")))));
			PR_InitSpecificationCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("init"), setCardinality("?", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAlternatives(createAssignment("ownedExpression", "=", createRuleCall(_EssentialOCL.PR_ExpCS)), createAssignment("exprString", "=", createRuleCall(TR_UNQUOTED_STRING)))));
			PR_InvConstraintCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("inv"), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedMessageSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(")"))))), createKeyword(":"), createAssignment("ownedSpecification", "=", createRuleCall(PR_SpecificationCS))));
			...
			PR_OperationContextDeclCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("context"), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(PR_TemplateSignatureCS))), createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)), createKeyword("("), setCardinality("?", createGroup(createAssignment("ownedParameters", "+=", createRuleCall(PR_ParameterCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedParameters", "+=", createRuleCall(PR_ParameterCS)))))), createKeyword(")"), createKeyword(":"), setCardinality("?", createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS))), setCardinality("*", createAlternatives(createAssignment("ownedPreconditions", "+=", createRuleCall(PR_PreConstraintCS)), createAssignment("ownedPostconditions", "+=", createRuleCall(PR_PostConstraintCS)), createAssignment("ownedBodies", "+=", createRuleCall(PR_BodySpecificationCS))))));
			PR_PackageDeclarationCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("package"), createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)), setCardinality("*", createAssignment("ownedInvariants", "+=", createRuleCall(PR_InvConstraintCS))), setCardinality("*", createAssignment("ownedContexts", "+=", createRuleCall(PR_ContextDeclCS))), createKeyword("endpackage")));
			...
			PR_PostConstraintCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("post"), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedMessageSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(")"))))), createKeyword(":"), createAssignment("ownedSpecification", "=", createRuleCall(PR_SpecificationCS))));
			PR_PreConstraintCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("pre"), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedMessageSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(")"))))), createKeyword(":"), createAssignment("ownedSpecification", "=", createRuleCall(PR_SpecificationCS))));
			...
			PR_PropertyContextDeclCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("context"), createAssignment("ownedPathName", "=", createRuleCall(_Base.PR_PathNameCS)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(_EssentialOCL.PR_TypeExpCS)), setCardinality("*", createAlternatives(createAssignment("ownedDefaultExpressions", "+=", createRuleCall(PR_DeriveSpecificationCS)), createAssignment("ownedDefaultExpressions", "+=", createRuleCall(PR_InitSpecificationCS))))));
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_CoIteratorVariableCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_CompleteOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS))))));
			...
			PR_EssentialOCLUnreservedName.setAlternatives(createAlternatives(createRuleCall(_CompleteOCL.PR_UnrestrictedName), createRuleCall(PR_CollectionTypeIdentifier), createRuleCall(_CompleteOCL.PR_PrimitiveTypeIdentifier), createKeyword("Map"), createKeyword("Tuple")));
			...
			PR_NavigatingArgCS.setAlternatives(createAlternatives(createGroup(createAssignment("ownedNameExpression", "=", createRuleCall(_CompleteOCL.PR_NavigatingArgExpCS)), setCardinality("?", createAlternatives(createGroup(createKeyword("<-"), createAssignment("ownedCoIterator", "=", createRuleCall(PR_CoIteratorVariableCS)), setCardinality("?", createGroup(createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))))), createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)), setCardinality("?", createGroup(createKeyword("<-"), createAssignment("ownedCoIterator", "=", createRuleCall(PR_CoIteratorVariableCS)))), setCardinality("?", createGroup(createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))))), createGroup(setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)))), setCardinality("?", createGroup(createKeyword("<-"), createAssignment("ownedCoIterator", "=", createRuleCall(PR_CoIteratorVariableCS)))), createKeyword("in"), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS)))))), createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)))));
			PR_NavigatingArgExpCS.setAlternatives(createRuleCall(PR_ExpCS));
			PR_NavigatingBarArgCS.setAlternatives(createGroup(createAssignment("prefix", "=", createKeyword("|")), createAssignment("ownedNameExpression", "=", createRuleCall(_CompleteOCL.PR_NavigatingArgExpCS)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)), setCardinality("?", createGroup(createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))))))));
			PR_NavigatingCommaArgCS.setAlternatives(createGroup(createAssignment("prefix", "=", createKeyword(",")), createAssignment("ownedNameExpression", "=", createRuleCall(_CompleteOCL.PR_NavigatingArgExpCS)), setCardinality("?", createAlternatives(createGroup(createKeyword("<-"), createAssignment("ownedCoIterator", "=", createRuleCall(PR_CoIteratorVariableCS)), setCardinality("?", createGroup(createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))))), createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)), setCardinality("?", createGroup(createKeyword("<-"), createAssignment("ownedCoIterator", "=", createRuleCall(PR_CoIteratorVariableCS)))), setCardinality("?", createGroup(createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))))), createGroup(setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)))), setCardinality("?", createGroup(createKeyword("<-"), createAssignment("ownedCoIterator", "=", createRuleCall(PR_CoIteratorVariableCS)))), createKeyword("in"), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS)))))));
			PR_NavigatingSemiArgCS.setAlternatives(createGroup(createAssignment("prefix", "=", createKeyword(";")), createAssignment("ownedNameExpression", "=", createRuleCall(_CompleteOCL.PR_NavigatingArgExpCS)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)), setCardinality("?", createGroup(createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))))))));
			...
			PR_PatternExpCS.setAlternatives(createGroup(setCardinality("?", createAssignment("patternVariableName", "=", createRuleCall(_CompleteOCL.PR_UnrestrictedName))), createKeyword(":"), createAssignment("ownedPatternType", "=", createRuleCall(PR_TypeExpCS))));
			...
			PR_PrimitiveTypeCS.setAlternatives(createAssignment("name", "=", createRuleCall(_CompleteOCL.PR_PrimitiveTypeIdentifier)));
			...
			PR_TupleLiteralPartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_CompleteOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)))), createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))));
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_CompleteOCL.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS))));
	...
	private static class _Base
	{
		...
		private static void initParserRules() {
			...
			PR_TypeParameterCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_CompleteOCL.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("extends"), createAssignment("ownedExtends", "+=", createRuleCall(_CompleteOCL.PR_TypedRefCS)), setCardinality("*", createGroup(createKeyword("&&"), createAssignment("ownedExtends", "+=", createRuleCall(_CompleteOCL.PR_TypedRefCS))))))));
			PR_TypeRefCS.setAlternatives(createAlternatives(createRuleCall(_CompleteOCL.PR_TypedRefCS), createRuleCall(PR_WildcardTypeRefCS)));
			...
			PR_UnreservedName.setAlternatives(createRuleCall(_CompleteOCL.PR_UnrestrictedName));
