...
/**
 * This is the item provider adapter for a {@link org.eclipse.ocl.expressions.VariableExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableExpItemProvider
	...
	protected void addReferredVariablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
				"_UI_VariableExp_referredVariable_feature", //$NON-NLS-1$
				"_UI_VariableExp_type"), //$NON-NLS-1$
			ExpressionsPackage.Literals.VARIABLE_EXP__REFERRED_VARIABLE, true,
	...
	public String getText(Object object) {
		VariableExp<?, ?> variableExp = (VariableExp<?, ?>) object;
		return getString("_UI_VariableExp_type") + " " //$NON-NLS-1$//$NON-NLS-2$
			+ variableExp.getStartPosition();
	}
