 ...
 */
public class CompleteOCLExecutableExtensionFactoryOverload extends CompleteOCLExecutableExtensionFactory
{
	@Override
	public Object create() throws CoreException {
		...
		Object object = extensionToFactoryMap.get("ocl");
		if (object instanceof Resource.Factory.Descriptor) {	// OOPS EcorePlugin.ExtensionProcessor has installed an object requiring OSGI getBundle() support.
			new CompleteOCLStandaloneSetup().register(getInjector());
			object = extensionToFactoryMap.get("ocl");
		}
		return object;
	}
	...
	protected Injector getInjector() {
		...
		if (injector == null) {
			injector = CompleteOCLStandaloneSetup.getInjector();
		}
		return injector;
	}
