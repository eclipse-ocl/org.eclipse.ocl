	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getCompleteOCLDocumentCSAccess().getAlternatives_2(), "rule__CompleteOCLDocumentCS__Alternatives_2");
					...
					put(grammarAccess.getClassifierContextDeclCSAccess().getAlternatives_5(), "rule__ClassifierContextDeclCS__Alternatives_5");
					...
					put(grammarAccess.getImportCSAccess().getAlternatives_1(), "rule__ImportCS__Alternatives_1");
					put(grammarAccess.getOperationContextDeclCSAccess().getAlternatives_9(), "rule__OperationContextDeclCS__Alternatives_9");
					put(grammarAccess.getPropertyContextDeclCSAccess().getAlternatives_5(), "rule__PropertyContextDeclCS__Alternatives_5");
					put(grammarAccess.getSpecificationCSAccess().getAlternatives(), "rule__SpecificationCS__Alternatives");
					put(grammarAccess.getBodySpecificationCSAccess().getAlternatives_4(), "rule__BodySpecificationCS__Alternatives_4");
					put(grammarAccess.getDeriveSpecificationCSAccess().getAlternatives_4(), "rule__DeriveSpecificationCS__Alternatives_4");
					put(grammarAccess.getInitSpecificationCSAccess().getAlternatives_4(), "rule__InitSpecificationCS__Alternatives_4");
					...
					put(grammarAccess.getInvConstraintCSAccess().getGroup(), "rule__InvConstraintCS__Group__0");
					put(grammarAccess.getInvConstraintCSAccess().getGroup_2(), "rule__InvConstraintCS__Group_2__0");
					put(grammarAccess.getInvConstraintCSAccess().getGroup_2_1(), "rule__InvConstraintCS__Group_2_1__0");
					put(grammarAccess.getPostConstraintCSAccess().getGroup(), "rule__PostConstraintCS__Group__0");
					put(grammarAccess.getPostConstraintCSAccess().getGroup_2(), "rule__PostConstraintCS__Group_2__0");
					put(grammarAccess.getPostConstraintCSAccess().getGroup_2_1(), "rule__PostConstraintCS__Group_2_1__0");
					put(grammarAccess.getPreConstraintCSAccess().getGroup(), "rule__PreConstraintCS__Group__0");
					put(grammarAccess.getPreConstraintCSAccess().getGroup_2(), "rule__PreConstraintCS__Group_2__0");
					put(grammarAccess.getPreConstraintCSAccess().getGroup_2_1(), "rule__PreConstraintCS__Group_2_1__0");
					put(grammarAccess.getDefOperationCSAccess().getGroup(), "rule__DefOperationCS__Group__0");
					put(grammarAccess.getDefOperationCSAccess().getGroup_8(), "rule__DefOperationCS__Group_8__0");
					put(grammarAccess.getDefOperationCSAccess().getGroup_8_1(), "rule__DefOperationCS__Group_8_1__0");
					...
					put(grammarAccess.getImportCSAccess().getGroup_2(), "rule__ImportCS__Group_2__0");
					put(grammarAccess.getOperationContextDeclCSAccess().getGroup(), "rule__OperationContextDeclCS__Group__0");
					put(grammarAccess.getOperationContextDeclCSAccess().getGroup_5(), "rule__OperationContextDeclCS__Group_5__0");
					put(grammarAccess.getOperationContextDeclCSAccess().getGroup_5_1(), "rule__OperationContextDeclCS__Group_5_1__0");
					...
					put(grammarAccess.getBodySpecificationCSAccess().getGroup(), "rule__BodySpecificationCS__Group__0");
					put(grammarAccess.getDeriveSpecificationCSAccess().getGroup(), "rule__DeriveSpecificationCS__Group__0");
					put(grammarAccess.getInitSpecificationCSAccess().getGroup(), "rule__InitSpecificationCS__Group__0");
					...
					put(grammarAccess.getCompleteOCLDocumentCSAccess().getOwnedAnnotationsAssignment_0(), "rule__CompleteOCLDocumentCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getCompleteOCLDocumentCSAccess().getOwnedImportsAssignment_1(), "rule__CompleteOCLDocumentCS__OwnedImportsAssignment_1");
					put(grammarAccess.getCompleteOCLDocumentCSAccess().getOwnedPackagesAssignment_2_0(), "rule__CompleteOCLDocumentCS__OwnedPackagesAssignment_2_0");
					put(grammarAccess.getCompleteOCLDocumentCSAccess().getOwnedContextsAssignment_2_1(), "rule__CompleteOCLDocumentCS__OwnedContextsAssignment_2_1");
					put(grammarAccess.getClassifierContextDeclCSAccess().getOwnedAnnotationsAssignment_0(), "rule__ClassifierContextDeclCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getClassifierContextDeclCSAccess().getOwnedSignatureAssignment_2(), "rule__ClassifierContextDeclCS__OwnedSignatureAssignment_2");
					put(grammarAccess.getClassifierContextDeclCSAccess().getSelfNameAssignment_3(), "rule__ClassifierContextDeclCS__SelfNameAssignment_3");
					put(grammarAccess.getClassifierContextDeclCSAccess().getOwnedPathNameAssignment_4(), "rule__ClassifierContextDeclCS__OwnedPathNameAssignment_4");
					put(grammarAccess.getClassifierContextDeclCSAccess().getOwnedInvariantsAssignment_5_0(), "rule__ClassifierContextDeclCS__OwnedInvariantsAssignment_5_0");
					put(grammarAccess.getClassifierContextDeclCSAccess().getOwnedDefinitionsAssignment_5_1(), "rule__ClassifierContextDeclCS__OwnedDefinitionsAssignment_5_1");
					put(grammarAccess.getInvConstraintCSAccess().getOwnedAnnotationsAssignment_0(), "rule__InvConstraintCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getInvConstraintCSAccess().getNameAssignment_2_0(), "rule__InvConstraintCS__NameAssignment_2_0");
					put(grammarAccess.getInvConstraintCSAccess().getOwnedMessageSpecificationAssignment_2_1_1(), "rule__InvConstraintCS__OwnedMessageSpecificationAssignment_2_1_1");
					put(grammarAccess.getInvConstraintCSAccess().getOwnedSpecificationAssignment_4(), "rule__InvConstraintCS__OwnedSpecificationAssignment_4");
					put(grammarAccess.getPostConstraintCSAccess().getOwnedAnnotationsAssignment_0(), "rule__PostConstraintCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getPostConstraintCSAccess().getNameAssignment_2_0(), "rule__PostConstraintCS__NameAssignment_2_0");
					put(grammarAccess.getPostConstraintCSAccess().getOwnedMessageSpecificationAssignment_2_1_1(), "rule__PostConstraintCS__OwnedMessageSpecificationAssignment_2_1_1");
					put(grammarAccess.getPostConstraintCSAccess().getOwnedSpecificationAssignment_4(), "rule__PostConstraintCS__OwnedSpecificationAssignment_4");
					put(grammarAccess.getPreConstraintCSAccess().getOwnedAnnotationsAssignment_0(), "rule__PreConstraintCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getPreConstraintCSAccess().getNameAssignment_2_0(), "rule__PreConstraintCS__NameAssignment_2_0");
					put(grammarAccess.getPreConstraintCSAccess().getOwnedMessageSpecificationAssignment_2_1_1(), "rule__PreConstraintCS__OwnedMessageSpecificationAssignment_2_1_1");
					put(grammarAccess.getPreConstraintCSAccess().getOwnedSpecificationAssignment_4(), "rule__PreConstraintCS__OwnedSpecificationAssignment_4");
					put(grammarAccess.getDefOperationCSAccess().getOwnedAnnotationsAssignment_0(), "rule__DefOperationCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getDefOperationCSAccess().getIsStaticAssignment_1(), "rule__DefOperationCS__IsStaticAssignment_1");
					put(grammarAccess.getDefOperationCSAccess().getOwnedSignatureAssignment_5(), "rule__DefOperationCS__OwnedSignatureAssignment_5");
					put(grammarAccess.getDefOperationCSAccess().getNameAssignment_6(), "rule__DefOperationCS__NameAssignment_6");
					put(grammarAccess.getDefOperationCSAccess().getOwnedParametersAssignment_8_0(), "rule__DefOperationCS__OwnedParametersAssignment_8_0");
					put(grammarAccess.getDefOperationCSAccess().getOwnedParametersAssignment_8_1_1(), "rule__DefOperationCS__OwnedParametersAssignment_8_1_1");
					put(grammarAccess.getDefOperationCSAccess().getOwnedTypeAssignment_11(), "rule__DefOperationCS__OwnedTypeAssignment_11");
					put(grammarAccess.getDefOperationCSAccess().getOwnedSpecificationAssignment_13(), "rule__DefOperationCS__OwnedSpecificationAssignment_13");
					...
					put(grammarAccess.getDefPropertyCSAccess().getOwnedAnnotationsAssignment_0(), "rule__DefPropertyCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getDefPropertyCSAccess().getIsStaticAssignment_1(), "rule__DefPropertyCS__IsStaticAssignment_1");
					put(grammarAccess.getDefPropertyCSAccess().getNameAssignment_5(), "rule__DefPropertyCS__NameAssignment_5");
					put(grammarAccess.getDefPropertyCSAccess().getOwnedTypeAssignment_7(), "rule__DefPropertyCS__OwnedTypeAssignment_7");
					put(grammarAccess.getDefPropertyCSAccess().getOwnedSpecificationAssignment_9(), "rule__DefPropertyCS__OwnedSpecificationAssignment_9");
					put(grammarAccess.getImportCSAccess().getOwnedAnnotationsAssignment_0(), "rule__ImportCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getImportCSAccess().getNameAssignment_2_0(), "rule__ImportCS__NameAssignment_2_0");
					put(grammarAccess.getImportCSAccess().getOwnedPathNameAssignment_3(), "rule__ImportCS__OwnedPathNameAssignment_3");
					put(grammarAccess.getImportCSAccess().getIsAllAssignment_4(), "rule__ImportCS__IsAllAssignment_4");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedAnnotationsAssignment_0(), "rule__OperationContextDeclCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedSignatureAssignment_2(), "rule__OperationContextDeclCS__OwnedSignatureAssignment_2");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedPathNameAssignment_3(), "rule__OperationContextDeclCS__OwnedPathNameAssignment_3");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedParametersAssignment_5_0(), "rule__OperationContextDeclCS__OwnedParametersAssignment_5_0");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedParametersAssignment_5_1_1(), "rule__OperationContextDeclCS__OwnedParametersAssignment_5_1_1");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedTypeAssignment_8(), "rule__OperationContextDeclCS__OwnedTypeAssignment_8");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedPreconditionsAssignment_9_0(), "rule__OperationContextDeclCS__OwnedPreconditionsAssignment_9_0");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedPostconditionsAssignment_9_1(), "rule__OperationContextDeclCS__OwnedPostconditionsAssignment_9_1");
					put(grammarAccess.getOperationContextDeclCSAccess().getOwnedBodiesAssignment_9_2(), "rule__OperationContextDeclCS__OwnedBodiesAssignment_9_2");
					put(grammarAccess.getPackageDeclarationCSAccess().getOwnedAnnotationsAssignment_0(), "rule__PackageDeclarationCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getPackageDeclarationCSAccess().getOwnedPathNameAssignment_2(), "rule__PackageDeclarationCS__OwnedPathNameAssignment_2");
					put(grammarAccess.getPackageDeclarationCSAccess().getOwnedInvariantsAssignment_3(), "rule__PackageDeclarationCS__OwnedInvariantsAssignment_3");
					put(grammarAccess.getPackageDeclarationCSAccess().getOwnedContextsAssignment_4(), "rule__PackageDeclarationCS__OwnedContextsAssignment_4");
					...
					put(grammarAccess.getPropertyContextDeclCSAccess().getOwnedAnnotationsAssignment_0(), "rule__PropertyContextDeclCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getPropertyContextDeclCSAccess().getOwnedPathNameAssignment_2(), "rule__PropertyContextDeclCS__OwnedPathNameAssignment_2");
					put(grammarAccess.getPropertyContextDeclCSAccess().getOwnedTypeAssignment_4(), "rule__PropertyContextDeclCS__OwnedTypeAssignment_4");
					put(grammarAccess.getPropertyContextDeclCSAccess().getOwnedDefaultExpressionsAssignment_5_0(), "rule__PropertyContextDeclCS__OwnedDefaultExpressionsAssignment_5_0");
					put(grammarAccess.getPropertyContextDeclCSAccess().getOwnedDefaultExpressionsAssignment_5_1(), "rule__PropertyContextDeclCS__OwnedDefaultExpressionsAssignment_5_1");
					...
					put(grammarAccess.getBodySpecificationCSAccess().getOwnedAnnotationsAssignment_0(), "rule__BodySpecificationCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getBodySpecificationCSAccess().getOwnedExpressionAssignment_4_0(), "rule__BodySpecificationCS__OwnedExpressionAssignment_4_0");
					put(grammarAccess.getBodySpecificationCSAccess().getExprStringAssignment_4_1(), "rule__BodySpecificationCS__ExprStringAssignment_4_1");
					put(grammarAccess.getDeriveSpecificationCSAccess().getOwnedAnnotationsAssignment_0(), "rule__DeriveSpecificationCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getDeriveSpecificationCSAccess().getOwnedExpressionAssignment_4_0(), "rule__DeriveSpecificationCS__OwnedExpressionAssignment_4_0");
					put(grammarAccess.getDeriveSpecificationCSAccess().getExprStringAssignment_4_1(), "rule__DeriveSpecificationCS__ExprStringAssignment_4_1");
					put(grammarAccess.getInitSpecificationCSAccess().getOwnedAnnotationsAssignment_0(), "rule__InitSpecificationCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getInitSpecificationCSAccess().getOwnedExpressionAssignment_4_0(), "rule__InitSpecificationCS__OwnedExpressionAssignment_4_0");
					put(grammarAccess.getInitSpecificationCSAccess().getExprStringAssignment_4_1(), "rule__InitSpecificationCS__ExprStringAssignment_4_1");
