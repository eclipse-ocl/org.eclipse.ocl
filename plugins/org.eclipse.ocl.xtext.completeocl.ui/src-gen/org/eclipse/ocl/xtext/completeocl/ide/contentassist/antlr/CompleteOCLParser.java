...
public class CompleteOCLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CompleteOCLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBodySpecificationCSAccess().getAlternatives(), "rule__BodySpecificationCS__Alternatives");
			builder.put(grammarAccess.getDeriveSpecificationCSAccess().getAlternatives(), "rule__DeriveSpecificationCS__Alternatives");
			builder.put(grammarAccess.getInitSpecificationCSAccess().getAlternatives(), "rule__InitSpecificationCS__Alternatives");
			...
			builder.put(grammarAccess.getBodySpecificationCSAccess().getGroup_0(), "rule__BodySpecificationCS__Group_0__0");
			builder.put(grammarAccess.getDeriveSpecificationCSAccess().getGroup_0(), "rule__DeriveSpecificationCS__Group_0__0");
			builder.put(grammarAccess.getInitSpecificationCSAccess().getGroup_0(), "rule__InitSpecificationCS__Group_0__0");
			...
			builder.put(grammarAccess.getPropertyContextDeclCSAccess().getOwnedDefaultExpressionsAssignment_4_0(), "rule__PropertyContextDeclCS__OwnedDefaultExpressionsAssignment_4_0");
			builder.put(grammarAccess.getPropertyContextDeclCSAccess().getOwnedDefaultExpressionsAssignment_4_1(), "rule__PropertyContextDeclCS__OwnedDefaultExpressionsAssignment_4_1");
			...
			builder.put(grammarAccess.getBodySpecificationCSAccess().getOwnedExpressionAssignment_0_3(), "rule__BodySpecificationCS__OwnedExpressionAssignment_0_3");
			builder.put(grammarAccess.getBodySpecificationCSAccess().getExprStringAssignment_1(), "rule__BodySpecificationCS__ExprStringAssignment_1");
			builder.put(grammarAccess.getDeriveSpecificationCSAccess().getOwnedExpressionAssignment_0_3(), "rule__DeriveSpecificationCS__OwnedExpressionAssignment_0_3");
			builder.put(grammarAccess.getDeriveSpecificationCSAccess().getExprStringAssignment_1(), "rule__DeriveSpecificationCS__ExprStringAssignment_1");
			builder.put(grammarAccess.getInitSpecificationCSAccess().getOwnedExpressionAssignment_0_3(), "rule__InitSpecificationCS__OwnedExpressionAssignment_0_3");
			builder.put(grammarAccess.getInitSpecificationCSAccess().getExprStringAssignment_1(), "rule__InitSpecificationCS__ExprStringAssignment_1");
