...
:
	(
		...
		RULE_SINGLE_QUOTED_STRING
		{ after(grammarAccess.getEnumerationLiteralCSAccess().getLiteralSINGLE_QUOTED_STRINGTerminalRuleCall_1_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleSIGNED
		{ after(grammarAccess.getEnumerationLiteralCSAccess().getValueSIGNEDParserRuleCall_2_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleAnnotationElementCS
		{ after(grammarAccess.getEnumerationLiteralCSAccess().getOwnedAnnotationsAnnotationElementCSParserRuleCall_3_0_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleUnrestrictedName
		{ after(grammarAccess.getImplicitOppositeCSAccess().getNameUnrestrictedNameParserRuleCall_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleTypedMultiplicityRefCS
		{ after(grammarAccess.getImplicitOppositeCSAccess().getOwnedTypeTypedMultiplicityRefCSParserRuleCall_3_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleImplicitOppositeCS
		{ after(grammarAccess.getReferenceCSAccess().getOwnedImplicitOppositesImplicitOppositeCSParserRuleCall_7_0_1_4_0_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
