 ...
 */
public class OCLstdlibExecutableExtensionFactoryOverload extends OCLstdlibExecutableExtensionFactory
{
	@Override
	public Object create() throws CoreException {
		...
		Object object = extensionToFactoryMap.get("oclstdlib");
		if (object instanceof Resource.Factory.Descriptor) {	// OOPS EcorePlugin.ExtensionProcessor has installed an object requiring OSGI getBundle() support.
			new OCLstdlibStandaloneSetup().register(getInjector());
			object = extensionToFactoryMap.get("oclstdlib");
		}
		return object;
	}
	...
	protected Injector getInjector() {
		...
		if (injector == null) {
			injector = OCLstdlibStandaloneSetup.getInjector();
		}
		return injector;
	}
}
