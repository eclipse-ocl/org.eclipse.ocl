...
import org.eclipse.ocl.xtext.oclstdlib.ide.contentassist.antlr.OCLstdlibParser;
import org.eclipse.ocl.xtext.oclstdlib.ide.contentassist.antlr.PartialOCLstdlibContentAssistParser;
import org.eclipse.ocl.xtext.oclstdlib.ide.contentassist.antlr.internal.InternalOCLstdlibLexer;
import org.eclipse.ocl.xtext.oclstdlib.ui.contentassist.OCLstdlibProposalProvider;
import org.eclipse.ocl.xtext.oclstdlib.ui.labeling.OCLstdlibDescriptionLabelProvider;
import org.eclipse.ocl.xtext.oclstdlib.ui.labeling.OCLstdlibLabelProvider;
import org.eclipse.ocl.xtext.oclstdlib.ui.outline.OCLstdlibOutlineTreeProvider;
import org.eclipse.ocl.xtext.oclstdlib.ui.quickfix.OCLstdlibQuickfixProvider;
...
/**
 * Manual modifications go to {@link OCLstdlibUiModule}.
 */
...
public abstract class AbstractOCLstdlibUiModule extends DefaultUiModule {
	...
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(Lexer.class)
			...
			.to(InternalOCLstdlibLexer.class);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.eclipse.ocl.xtext.oclstdlib.parser.antlr.internal.InternalOCLstdlibLexer.class);
	}
	...
	public Class<? extends IContentAssistParser> bindIContentAssistParser() {
		return OCLstdlibParser.class;
	}

	// contributed by org.eclipse.xtext.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment2
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalOCLstdlibLexer.class).toProvider(LexerProvider.create(InternalOCLstdlibLexer.class));
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return OCLstdlibLabelProvider.class;
	}

	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(OCLstdlibDescriptionLabelProvider.class);
	}

	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return OCLstdlibOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return OCLstdlibQuickfixProvider.class;
	}

	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return OCLstdlibProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialOCLstdlibContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("OCLstdlib Compare");
	}
