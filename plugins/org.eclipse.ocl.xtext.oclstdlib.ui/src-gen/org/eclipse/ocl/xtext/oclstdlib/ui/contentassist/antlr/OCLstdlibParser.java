		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLibCoercionCSAccess().getAlternatives_8(), "rule__LibCoercionCS__Alternatives_8");
					put(grammarAccess.getLibCoercionCSAccess().getAlternatives_8_0_1(), "rule__LibCoercionCS__Alternatives_8_0_1");
					put(grammarAccess.getLibIterationCSAccess().getAlternatives_15(), "rule__LibIterationCS__Alternatives_15");
					put(grammarAccess.getLibIterationCSAccess().getAlternatives_15_0_1(), "rule__LibIterationCS__Alternatives_15_0_1");
					put(grammarAccess.getOperationCSAccess().getAlternatives(), "rule__OperationCS__Alternatives");
					put(grammarAccess.getLibOperationCSAccess().getAlternatives_14(), "rule__LibOperationCS__Alternatives_14");
					put(grammarAccess.getLibOperationCSAccess().getAlternatives_14_0_1(), "rule__LibOperationCS__Alternatives_14_0_1");
					put(grammarAccess.getLibPackageCSAccess().getAlternatives_5(), "rule__LibPackageCS__Alternatives_5");
					put(grammarAccess.getPackageCSAccess().getAlternatives_5(), "rule__PackageCS__Alternatives_5");
					put(grammarAccess.getLibPropertyCSAccess().getAlternatives_8(), "rule__LibPropertyCS__Alternatives_8");
					...
					put(grammarAccess.getLibraryAccess().getGroup_1(), "rule__Library__Group_1__0");
					...
					put(grammarAccess.getLibClassCSAccess().getGroup_6_2(), "rule__LibClassCS__Group_6_2__0");
					...
					put(grammarAccess.getInvCSAccess().getGroup_2(), "rule__InvCS__Group_2__0");
					put(grammarAccess.getInvCSAccess().getGroup_2_1(), "rule__InvCS__Group_2_1__0");
					put(grammarAccess.getLibCoercionCSAccess().getGroup(), "rule__LibCoercionCS__Group__0");
					put(grammarAccess.getLibCoercionCSAccess().getGroup_7(), "rule__LibCoercionCS__Group_7__0");
					put(grammarAccess.getLibCoercionCSAccess().getGroup_8_0(), "rule__LibCoercionCS__Group_8_0__0");
					...
					put(grammarAccess.getLibIterationCSAccess().getGroup_8(), "rule__LibIterationCS__Group_8__0");
					put(grammarAccess.getLibIterationCSAccess().getGroup_8_2(), "rule__LibIterationCS__Group_8_2__0");
					put(grammarAccess.getLibIterationCSAccess().getGroup_14(), "rule__LibIterationCS__Group_14__0");
					put(grammarAccess.getLibIterationCSAccess().getGroup_15_0(), "rule__LibIterationCS__Group_15_0__0");
					...
					put(grammarAccess.getLibOperationCSAccess().getGroup_6(), "rule__LibOperationCS__Group_6__0");
					put(grammarAccess.getLibOperationCSAccess().getGroup_6_1(), "rule__LibOperationCS__Group_6_1__0");
					put(grammarAccess.getLibOperationCSAccess().getGroup_12(), "rule__LibOperationCS__Group_12__0");
					put(grammarAccess.getLibOperationCSAccess().getGroup_13(), "rule__LibOperationCS__Group_13__0");
					put(grammarAccess.getLibOperationCSAccess().getGroup_14_0(), "rule__LibOperationCS__Group_14_0__0");
					put(grammarAccess.getLibOperationCSAccess().getGroup_14_0_1_1(), "rule__LibOperationCS__Group_14_0_1_1__0");
					...
					put(grammarAccess.getLibPackageCSAccess().getGroup_3(), "rule__LibPackageCS__Group_3__0");
					put(grammarAccess.getLibPackageCSAccess().getGroup_5_1(), "rule__LibPackageCS__Group_5_1__0");
					...
					put(grammarAccess.getLibPropertyCSAccess().getGroup_7(), "rule__LibPropertyCS__Group_7__0");
					put(grammarAccess.getLibPropertyCSAccess().getGroup_8_0(), "rule__LibPropertyCS__Group_8_0__0");
					put(grammarAccess.getPostCSAccess().getGroup(), "rule__PostCS__Group__0");
					put(grammarAccess.getPostCSAccess().getGroup_2(), "rule__PostCS__Group_2__0");
					put(grammarAccess.getPostCSAccess().getGroup_2_1(), "rule__PostCS__Group_2_1__0");
					put(grammarAccess.getPreCSAccess().getGroup(), "rule__PreCS__Group__0");
					put(grammarAccess.getPreCSAccess().getGroup_2(), "rule__PreCS__Group_2__0");
					put(grammarAccess.getPreCSAccess().getGroup_2_1(), "rule__PreCS__Group_2_1__0");
					...
					put(grammarAccess.getLibraryAccess().getOwnedAnnotationsAssignment_0(), "rule__Library__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getLibraryAccess().getOwnedImportsAssignment_1_0(), "rule__Library__OwnedImportsAssignment_1_0");
					put(grammarAccess.getLibraryAccess().getOwnedPackagesAssignment_2(), "rule__Library__OwnedPackagesAssignment_2");
					...
					put(grammarAccess.getAnnotationCSAccess().getOwnedAnnotationsAssignment_0(), "rule__AnnotationCS__OwnedAnnotationsAssignment_0");
					...
					put(grammarAccess.getAnnotationCSAccess().getOwnedAnnotationsAssignment_4_0_1(), "rule__AnnotationCS__OwnedAnnotationsAssignment_4_0_1");
					put(grammarAccess.getLibClassCSAccess().getOwnedAnnotationsAssignment_0(), "rule__LibClassCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getLibClassCSAccess().getIsAbstractAssignment_1(), "rule__LibClassCS__IsAbstractAssignment_1");
					put(grammarAccess.getLibClassCSAccess().getNameAssignment_3(), "rule__LibClassCS__NameAssignment_3");
					put(grammarAccess.getLibClassCSAccess().getOwnedSignatureAssignment_4(), "rule__LibClassCS__OwnedSignatureAssignment_4");
					put(grammarAccess.getLibClassCSAccess().getMetaclassNameAssignment_5_1(), "rule__LibClassCS__MetaclassNameAssignment_5_1");
					put(grammarAccess.getLibClassCSAccess().getOwnedSuperTypesAssignment_6_1(), "rule__LibClassCS__OwnedSuperTypesAssignment_6_1");
					put(grammarAccess.getLibClassCSAccess().getOwnedSuperTypesAssignment_6_2_1(), "rule__LibClassCS__OwnedSuperTypesAssignment_6_2_1");
					...
					put(grammarAccess.getInvCSAccess().getOwnedAnnotationsAssignment_0(), "rule__InvCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getInvCSAccess().getStereotypeAssignment_1(), "rule__InvCS__StereotypeAssignment_1");
					put(grammarAccess.getInvCSAccess().getNameAssignment_2_0(), "rule__InvCS__NameAssignment_2_0");
					put(grammarAccess.getInvCSAccess().getOwnedMessageSpecificationAssignment_2_1_1(), "rule__InvCS__OwnedMessageSpecificationAssignment_2_1_1");
					put(grammarAccess.getInvCSAccess().getOwnedSpecificationAssignment_4(), "rule__InvCS__OwnedSpecificationAssignment_4");
					put(grammarAccess.getLibCoercionCSAccess().getOwnedAnnotationsAssignment_0(), "rule__LibCoercionCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getLibCoercionCSAccess().getNameAssignment_2(), "rule__LibCoercionCS__NameAssignment_2");
					put(grammarAccess.getLibCoercionCSAccess().getOwnedTypeAssignment_6(), "rule__LibCoercionCS__OwnedTypeAssignment_6");
					put(grammarAccess.getLibCoercionCSAccess().getImplementationAssignment_7_1(), "rule__LibCoercionCS__ImplementationAssignment_7_1");
					put(grammarAccess.getLibCoercionCSAccess().getOwnedAnnotationsAssignment_8_0_1_0(), "rule__LibCoercionCS__OwnedAnnotationsAssignment_8_0_1_0");
					put(grammarAccess.getLibCoercionCSAccess().getOwnedPreconditionsAssignment_8_0_1_1(), "rule__LibCoercionCS__OwnedPreconditionsAssignment_8_0_1_1");
					put(grammarAccess.getLibCoercionCSAccess().getOwnedPostconditionsAssignment_8_0_1_2(), "rule__LibCoercionCS__OwnedPostconditionsAssignment_8_0_1_2");
					put(grammarAccess.getLibIterationCSAccess().getOwnedAnnotationsAssignment_0(), "rule__LibIterationCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getLibIterationCSAccess().getNameAssignment_2(), "rule__LibIterationCS__NameAssignment_2");
					put(grammarAccess.getLibIterationCSAccess().getOwnedSignatureAssignment_3(), "rule__LibIterationCS__OwnedSignatureAssignment_3");
					put(grammarAccess.getLibIterationCSAccess().getOwnedIteratorsAssignment_5(), "rule__LibIterationCS__OwnedIteratorsAssignment_5");
					put(grammarAccess.getLibIterationCSAccess().getOwnedIteratorsAssignment_6_1(), "rule__LibIterationCS__OwnedIteratorsAssignment_6_1");
					put(grammarAccess.getLibIterationCSAccess().getOwnedAccumulatorsAssignment_7_1(), "rule__LibIterationCS__OwnedAccumulatorsAssignment_7_1");
					put(grammarAccess.getLibIterationCSAccess().getOwnedAccumulatorsAssignment_7_2_1(), "rule__LibIterationCS__OwnedAccumulatorsAssignment_7_2_1");
					put(grammarAccess.getLibIterationCSAccess().getOwnedParametersAssignment_8_1(), "rule__LibIterationCS__OwnedParametersAssignment_8_1");
					put(grammarAccess.getLibIterationCSAccess().getOwnedParametersAssignment_8_2_1(), "rule__LibIterationCS__OwnedParametersAssignment_8_2_1");
					put(grammarAccess.getLibIterationCSAccess().getOwnedTypeAssignment_11(), "rule__LibIterationCS__OwnedTypeAssignment_11");
					put(grammarAccess.getLibIterationCSAccess().getIsInvalidatingAssignment_12(), "rule__LibIterationCS__IsInvalidatingAssignment_12");
					put(grammarAccess.getLibIterationCSAccess().getIsValidatingAssignment_13(), "rule__LibIterationCS__IsValidatingAssignment_13");
					put(grammarAccess.getLibIterationCSAccess().getImplementationAssignment_14_1(), "rule__LibIterationCS__ImplementationAssignment_14_1");
					put(grammarAccess.getLibIterationCSAccess().getOwnedAnnotationsAssignment_15_0_1_0(), "rule__LibIterationCS__OwnedAnnotationsAssignment_15_0_1_0");
					put(grammarAccess.getLibIterationCSAccess().getOwnedPreconditionsAssignment_15_0_1_1(), "rule__LibIterationCS__OwnedPreconditionsAssignment_15_0_1_1");
					put(grammarAccess.getLibIterationCSAccess().getOwnedPostconditionsAssignment_15_0_1_2(), "rule__LibIterationCS__OwnedPostconditionsAssignment_15_0_1_2");
					...
					put(grammarAccess.getLibOperationCSAccess().getOwnedAnnotationsAssignment_0(), "rule__LibOperationCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getLibOperationCSAccess().getIsStaticAssignment_1(), "rule__LibOperationCS__IsStaticAssignment_1");
					put(grammarAccess.getLibOperationCSAccess().getNameAssignment_3(), "rule__LibOperationCS__NameAssignment_3");
					put(grammarAccess.getLibOperationCSAccess().getOwnedSignatureAssignment_4(), "rule__LibOperationCS__OwnedSignatureAssignment_4");
					put(grammarAccess.getLibOperationCSAccess().getOwnedParametersAssignment_6_0(), "rule__LibOperationCS__OwnedParametersAssignment_6_0");
					put(grammarAccess.getLibOperationCSAccess().getOwnedParametersAssignment_6_1_1(), "rule__LibOperationCS__OwnedParametersAssignment_6_1_1");
					put(grammarAccess.getLibOperationCSAccess().getOwnedTypeAssignment_9(), "rule__LibOperationCS__OwnedTypeAssignment_9");
					put(grammarAccess.getLibOperationCSAccess().getIsValidatingAssignment_10(), "rule__LibOperationCS__IsValidatingAssignment_10");
					put(grammarAccess.getLibOperationCSAccess().getIsInvalidatingAssignment_11(), "rule__LibOperationCS__IsInvalidatingAssignment_11");
					put(grammarAccess.getLibOperationCSAccess().getPrecedenceAssignment_12_2(), "rule__LibOperationCS__PrecedenceAssignment_12_2");
					put(grammarAccess.getLibOperationCSAccess().getImplementationAssignment_13_1(), "rule__LibOperationCS__ImplementationAssignment_13_1");
					put(grammarAccess.getLibOperationCSAccess().getOwnedAnnotationsAssignment_14_0_1_0(), "rule__LibOperationCS__OwnedAnnotationsAssignment_14_0_1_0");
					put(grammarAccess.getLibOperationCSAccess().getOwnedBodyExpressionsAssignment_14_0_1_1_3(), "rule__LibOperationCS__OwnedBodyExpressionsAssignment_14_0_1_1_3");
					put(grammarAccess.getLibOperationCSAccess().getOwnedPostconditionsAssignment_14_0_1_2(), "rule__LibOperationCS__OwnedPostconditionsAssignment_14_0_1_2");
					put(grammarAccess.getLibOperationCSAccess().getOwnedPreconditionsAssignment_14_0_1_3(), "rule__LibOperationCS__OwnedPreconditionsAssignment_14_0_1_3");
					...
					put(grammarAccess.getLibPackageCSAccess().getOwnedAnnotationsAssignment_0(), "rule__LibPackageCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getLibPackageCSAccess().getNameAssignment_2(), "rule__LibPackageCS__NameAssignment_2");
					put(grammarAccess.getLibPackageCSAccess().getNsPrefixAssignment_3_1(), "rule__LibPackageCS__NsPrefixAssignment_3_1");
					put(grammarAccess.getLibPackageCSAccess().getNsURIAssignment_3_3(), "rule__LibPackageCS__NsURIAssignment_3_3");
					put(grammarAccess.getLibPackageCSAccess().getOwnedPackagesAssignment_5_0(), "rule__LibPackageCS__OwnedPackagesAssignment_5_0");
					put(grammarAccess.getLibPackageCSAccess().getOwnedPrecedencesAssignment_5_1_1(), "rule__LibPackageCS__OwnedPrecedencesAssignment_5_1_1");
					put(grammarAccess.getLibPackageCSAccess().getOwnedClassesAssignment_5_2(), "rule__LibPackageCS__OwnedClassesAssignment_5_2");
					put(grammarAccess.getLibPackageCSAccess().getOwnedAnnotationsAssignment_5_3(), "rule__LibPackageCS__OwnedAnnotationsAssignment_5_3");
					...
					put(grammarAccess.getPackageCSAccess().getNsURIAssignment_3_3(), "rule__PackageCS__NsURIAssignment_3_3");
					put(grammarAccess.getPackageCSAccess().getOwnedPackagesAssignment_5_0(), "rule__PackageCS__OwnedPackagesAssignment_5_0");
					put(grammarAccess.getPackageCSAccess().getOwnedClassesAssignment_5_1(), "rule__PackageCS__OwnedClassesAssignment_5_1");
					put(grammarAccess.getPackageCSAccess().getOwnedAnnotationsAssignment_5_2(), "rule__PackageCS__OwnedAnnotationsAssignment_5_2");
					...
					put(grammarAccess.getLibPropertyCSAccess().getOwnedAnnotationsAssignment_0(), "rule__LibPropertyCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getLibPropertyCSAccess().getIsStaticAssignment_1(), "rule__LibPropertyCS__IsStaticAssignment_1");
					put(grammarAccess.getLibPropertyCSAccess().getNameAssignment_3(), "rule__LibPropertyCS__NameAssignment_3");
					put(grammarAccess.getLibPropertyCSAccess().getOwnedTypeAssignment_5(), "rule__LibPropertyCS__OwnedTypeAssignment_5");
					put(grammarAccess.getLibPropertyCSAccess().getOwnedOppositeAssignment_6(), "rule__LibPropertyCS__OwnedOppositeAssignment_6");
					put(grammarAccess.getLibPropertyCSAccess().getImplementationAssignment_7_1(), "rule__LibPropertyCS__ImplementationAssignment_7_1");
					put(grammarAccess.getLibPropertyCSAccess().getOwnedAnnotationsAssignment_8_0_1(), "rule__LibPropertyCS__OwnedAnnotationsAssignment_8_0_1");
					put(grammarAccess.getPostCSAccess().getOwnedAnnotationsAssignment_0(), "rule__PostCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getPostCSAccess().getStereotypeAssignment_1(), "rule__PostCS__StereotypeAssignment_1");
					put(grammarAccess.getPostCSAccess().getNameAssignment_2_0(), "rule__PostCS__NameAssignment_2_0");
					put(grammarAccess.getPostCSAccess().getOwnedMessageSpecificationAssignment_2_1_1(), "rule__PostCS__OwnedMessageSpecificationAssignment_2_1_1");
					put(grammarAccess.getPostCSAccess().getOwnedSpecificationAssignment_4(), "rule__PostCS__OwnedSpecificationAssignment_4");
					put(grammarAccess.getPreCSAccess().getOwnedAnnotationsAssignment_0(), "rule__PreCS__OwnedAnnotationsAssignment_0");
					put(grammarAccess.getPreCSAccess().getStereotypeAssignment_1(), "rule__PreCS__StereotypeAssignment_1");
					put(grammarAccess.getPreCSAccess().getNameAssignment_2_0(), "rule__PreCS__NameAssignment_2_0");
					put(grammarAccess.getPreCSAccess().getOwnedMessageSpecificationAssignment_2_1_1(), "rule__PreCS__OwnedMessageSpecificationAssignment_2_1_1");
					put(grammarAccess.getPreCSAccess().getOwnedSpecificationAssignment_4(), "rule__PreCS__OwnedSpecificationAssignment_4");
