...
public class OCLstdlibParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OCLstdlibGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getLibClassCSAccess().getAlternatives_9(), "rule__LibClassCS__Alternatives_9");
			...
			builder.put(grammarAccess.getLibClassCSAccess().getGroup_6_2(), "rule__LibClassCS__Group_6_2__0");
			builder.put(grammarAccess.getLibClassCSAccess().getGroup_7(), "rule__LibClassCS__Group_7__0");
			...
			builder.put(grammarAccess.getLibClassCSAccess().getIsInterfaceAssignment_1(), "rule__LibClassCS__IsInterfaceAssignment_1");
			builder.put(grammarAccess.getLibClassCSAccess().getNameAssignment_3(), "rule__LibClassCS__NameAssignment_3");
			builder.put(grammarAccess.getLibClassCSAccess().getOwnedSignatureAssignment_4(), "rule__LibClassCS__OwnedSignatureAssignment_4");
			builder.put(grammarAccess.getLibClassCSAccess().getMetaclassNameAssignment_5_1(), "rule__LibClassCS__MetaclassNameAssignment_5_1");
			builder.put(grammarAccess.getLibClassCSAccess().getOwnedSuperTypesAssignment_6_1(), "rule__LibClassCS__OwnedSuperTypesAssignment_6_1");
			builder.put(grammarAccess.getLibClassCSAccess().getOwnedSuperTypesAssignment_6_2_1(), "rule__LibClassCS__OwnedSuperTypesAssignment_6_2_1");
			builder.put(grammarAccess.getLibClassCSAccess().getImplementationAssignment_7_1(), "rule__LibClassCS__ImplementationAssignment_7_1");
			builder.put(grammarAccess.getLibClassCSAccess().getOwnedOperationsAssignment_9_0(), "rule__LibClassCS__OwnedOperationsAssignment_9_0");
			builder.put(grammarAccess.getLibClassCSAccess().getOwnedPropertiesAssignment_9_1(), "rule__LibClassCS__OwnedPropertiesAssignment_9_1");
			builder.put(grammarAccess.getLibClassCSAccess().getOwnedConstraintsAssignment_9_2(), "rule__LibClassCS__OwnedConstraintsAssignment_9_2");
			builder.put(grammarAccess.getLibClassCSAccess().getOwnedAnnotationsAssignment_9_3(), "rule__LibClassCS__OwnedAnnotationsAssignment_9_3");
			...
			builder.put(grammarAccess.getMultiplicityCSAccess().getIsNonNullFreeAssignment_2_0(), "rule__MultiplicityCS__IsNonNullFreeAssignment_2_0");
