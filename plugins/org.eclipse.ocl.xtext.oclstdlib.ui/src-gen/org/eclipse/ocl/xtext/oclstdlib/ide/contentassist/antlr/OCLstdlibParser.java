...
public class OCLstdlibParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, OCLstdlibGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getLibClassCSAccess().getAlternatives_7(), "rule__LibClassCS__Alternatives_7");
			...
			builder.put(grammarAccess.getLibClassCSAccess().getOwnedOperationsAssignment_7_0(), "rule__LibClassCS__OwnedOperationsAssignment_7_0");
			builder.put(grammarAccess.getLibClassCSAccess().getOwnedPropertiesAssignment_7_1(), "rule__LibClassCS__OwnedPropertiesAssignment_7_1");
			builder.put(grammarAccess.getLibClassCSAccess().getOwnedConstraintsAssignment_7_2(), "rule__LibClassCS__OwnedConstraintsAssignment_7_2");
			builder.put(grammarAccess.getLibClassCSAccess().getOwnedAnnotationsAssignment_7_3(), "rule__LibClassCS__OwnedAnnotationsAssignment_7_3");
