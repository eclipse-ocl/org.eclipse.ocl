...
public class ControlFactoryImpl extends EFactoryImpl implements ControlFactory {
	 ...
	 * @generated
	 */
	public static @NonNull ControlFactory init() {
		try {
	...
	public @NonNull EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case 1: return createControlModel();
			case 2: return createControlSettings();
			default:
	 ...
	 */
	@Override
	public @NonNull ControlModel createControlModel() {
		ControlModelImpl controlModel = new ControlModelImpl();
		return controlModel;
	}
	 ...
	 */
	@Override
	public @NonNull ControlSettings createControlSettings() {
		ControlSettingsImpl controlSettings = new ControlSettingsImpl();
	...
	@Override
	public @NonNull ControlPackage getControlPackage() {
