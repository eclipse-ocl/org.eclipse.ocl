...
public class OCLinEcoreGrammarResource extends AbstractGrammarResource
{
	...
	private static class _OCLinEcore
	{
		...
		private static void initParserRules() {
			...
			PR_ImportCS.setAlternatives(createGroup(createAlternatives(createKeyword("import"), createKeyword("library")), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"))), createAssignment("ownedPathName", "=", createRuleCall(_EssentialOCL.PR_URIPathNameCS)), setCardinality("?", createAssignment("isAll", "?=", createKeyword("::*"))), createKeyword(";")));
