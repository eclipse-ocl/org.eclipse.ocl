...
public class OCLinEcoreGrammarResource extends AbstractGrammarResource
{
	...
	private static class _OCLinEcore
	{
		...
		private static void initParserRules() {
			...
			PR_DataTypeCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), setCardinality("?", createAssignment("isPrimitive", "?=", createKeyword("primitive"))), createKeyword("datatype"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(PR_TemplateSignatureCS))), setCardinality("?", createGroup(createKeyword(":"), createAssignment("instanceClassName", "=", createRuleCall(_Base.TR_SINGLE_QUOTED_STRING)))), setCardinality("?", createGroup(createKeyword("{"), setCardinality("?", createAlternatives(createAssignment("isSerializable", "?=", createKeyword("serializable")), createKeyword("!serializable"))), createKeyword("}"))), createAlternatives(createGroup(createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS)), createAssignment("ownedConstraints", "+=", createRuleCall(PR_InvariantConstraintCS)))), createKeyword("}")), createKeyword(";"))));
			PR_DetailCS.setAlternatives(createGroup(createAssignment("name", "=", createAlternatives(createRuleCall(PR_UnrestrictedName), createRuleCall(_Base.TR_SINGLE_QUOTED_STRING))), createKeyword("="), setCardinality("*", createAssignment("values", "+=", createAlternatives(createRuleCall(_Base.TR_SINGLE_QUOTED_STRING), createRuleCall(_Base.TR_ML_SINGLE_QUOTED_STRING))))));
			PR_DocumentationCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM_base, org.eclipse.ocl.xtext.basecs.BaseCSPackage.Literals.DOCUMENTATION_CS)), setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("documentation"), setCardinality("?", createAssignment("value", "=", createRuleCall(_Base.TR_SINGLE_QUOTED_STRING))), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedDetails", "+=", createRuleCall(PR_DetailCS)), setCardinality("*", createGroup(createKeyword(","), createAssignment("ownedDetails", "+=", createRuleCall(PR_DetailCS)))), createKeyword(")"))), createKeyword(";")));
			PR_EnumerationCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("enum"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createAssignment("ownedSignature", "=", createRuleCall(PR_TemplateSignatureCS))), setCardinality("?", createGroup(createKeyword(":"), createAssignment("instanceClassName", "=", createRuleCall(_Base.TR_SINGLE_QUOTED_STRING)))), setCardinality("?", createGroup(createKeyword("{"), setCardinality("?", createAlternatives(createAssignment("isSerializable", "?=", createKeyword("serializable")), createKeyword("!serializable"))), createKeyword("}"))), createAlternatives(createGroup(createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS)), createAssignment("ownedLiterals", "+=", createRuleCall(PR_EnumerationLiteralCS)), createAssignment("ownedConstraints", "+=", createRuleCall(PR_InvariantConstraintCS)))), createKeyword("}")), createKeyword(";"))));
			PR_EnumerationLiteralCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createAlternatives(createGroup(createKeyword("literal"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName))), createAssignment("name", "=", createRuleCall(PR_EnumerationLiteralName))), setCardinality("?", createGroup(createKeyword(":"), createAssignment("literal", "=", createRuleCall(_Base.TR_SINGLE_QUOTED_STRING)))), setCardinality("?", createGroup(createKeyword("="), createAssignment("value", "=", createRuleCall(PR_SIGNED)))), createAlternatives(createGroup(createKeyword("{"), setCardinality("*", createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS))), createKeyword("}")), createKeyword(";"))));
			PR_EnumerationLiteralName.setAlternatives(createAlternatives(createRuleCall(_EssentialOCL.PR_EssentialOCLUnrestrictedName), createKeyword("abstract"), createKeyword("attribute"), createKeyword("body"), createKeyword("callable"), createKeyword("class"), createKeyword("composes"), createKeyword("datatype"), createKeyword("definition"), createKeyword("derivation"), createKeyword("derived"), createKeyword("enum"), createKeyword("extends"), createKeyword("id"), createKeyword("import"), createKeyword("initial"), createKeyword("interface"), createKeyword("key"), createKeyword("library"), createKeyword("module"), createKeyword("operation"), createKeyword("ordered"), createKeyword("package"), createKeyword("postcondition"), createKeyword("precondition"), createKeyword("primitive"), createKeyword("property"), createKeyword("readonly"), createKeyword("reference"), createKeyword("resolve"), createKeyword("static"), createKeyword("throws"), createKeyword("transient"), createKeyword("unique"), createKeyword("unsettable"), createKeyword("volatile")));
			PR_INTEGER.setAlternatives(createRuleCall(_Base.TR_INT));
			PR_ImplicitOppositeCS.setAlternatives(createGroup(createKeyword("opposite"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypedMultiplicityRefCS)), setCardinality("?", createGroup(createKeyword("{"), setCardinality("+", createGroup(createAlternatives(createAssignment("qualifiers", "+=", createKeyword("ordered")), createAssignment("qualifiers", "+=", createKeyword("!ordered")), createAssignment("qualifiers", "+=", createKeyword("unique")), createAssignment("qualifiers", "+=", createKeyword("!unique"))), setCardinality("?", createKeyword(",")))), createKeyword("}")))));
			PR_ImportCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createAlternatives(createKeyword("import"), createKeyword("library")), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), createKeyword(":"))), createAssignment("ownedPathName", "=", createRuleCall(_EssentialOCL.PR_URIPathNameCS)), setCardinality("?", createAssignment("isAll", "?=", createKeyword("::*"))), createKeyword(";")));
			...
			PR_PreconditionConstraintCS.setAlternatives(createGroup(createAssignment("stereotype", "=", createKeyword("precondition")), setCardinality("?", createGroup(createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("("), createAssignment("ownedMessageSpecification", "=", createRuleCall(PR_SpecificationCS)), createKeyword(")"))))), createKeyword(":"), setCardinality("?", createAssignment("ownedSpecification", "=", createRuleCall(PR_SpecificationCS))), createKeyword(";")));
			PR_ReferenceCS.setAlternatives(createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), setCardinality("?", createAlternatives(createGroup(createAssignment("qualifiers", "+=", createKeyword("static")), setCardinality("?", createAssignment("qualifiers", "+=", createKeyword("definition")))), createGroup(createAssignment("qualifiers", "+=", createKeyword("definition")), setCardinality("?", createAssignment("qualifiers", "+=", createKeyword("static")))))), createKeyword("property"), createAssignment("name", "=", createRuleCall(PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword("#"), createAssignment("referredOpposite", "=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PROPERTY), createRuleCall(PR_UnrestrictedName))))), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypedMultiplicityRefCS)))), setCardinality("?", createGroup(createKeyword("="), createAssignment("default", "=", createRuleCall(_Base.TR_SINGLE_QUOTED_STRING)))), setCardinality("?", createGroup(createKeyword("{"), setCardinality("+", createGroup(createAlternatives(createAssignment("qualifiers", "+=", createKeyword("composes")), createAssignment("qualifiers", "+=", createKeyword("!composes")), createAssignment("qualifiers", "+=", createKeyword("derived")), createAssignment("qualifiers", "+=", createKeyword("!derived")), createAssignment("qualifiers", "+=", createKeyword("ordered")), createAssignment("qualifiers", "+=", createKeyword("!ordered")), createAssignment("qualifiers", "+=", createKeyword("readonly")), createAssignment("qualifiers", "+=", createKeyword("!readonly")), createAssignment("qualifiers", "+=", createKeyword("resolve")), createAssignment("qualifiers", "+=", createKeyword("!resolve")), createAssignment("qualifiers", "+=", createKeyword("transient")), createAssignment("qualifiers", "+=", createKeyword("!transient")), createAssignment("qualifiers", "+=", createKeyword("unique")), createAssignment("qualifiers", "+=", createKeyword("!unique")), createAssignment("qualifiers", "+=", createKeyword("unsettable")), createAssignment("qualifiers", "+=", createKeyword("!unsettable")), createAssignment("qualifiers", "+=", createKeyword("volatile")), createAssignment("qualifiers", "+=", createKeyword("!volatile"))), setCardinality("?", createKeyword(",")))), createKeyword("}"))), createAlternatives(createGroup(createKeyword("{"), setCardinality("*", createAlternatives(createAssignment("ownedAnnotations", "+=", createRuleCall(PR_AnnotationElementCS)), createGroup(createKeyword("key"), createAssignment("referredKeys", "+=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PROPERTY), createRuleCall(PR_UnrestrictedName))), setCardinality("*", createGroup(createKeyword(","), createAssignment("referredKeys", "+=", createCrossReference(createTypeRef(MM_pivot, org.eclipse.ocl.pivot.PivotPackage.Literals.PROPERTY), createRuleCall(PR_UnrestrictedName))))), createKeyword(";")), createGroup(createKeyword("initial"), setCardinality("?", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), setCardinality("?", createAssignment("ownedDefaultExpressions", "+=", createRuleCall(PR_SpecificationCS))), createKeyword(";")), createGroup(createKeyword("derivation"), setCardinality("?", createRuleCall(PR_UnrestrictedName)), createKeyword(":"), setCardinality("?", createAssignment("ownedDefaultExpressions", "+=", createRuleCall(PR_SpecificationCS))), createKeyword(";")), createGroup(createAssignment("ownedImplicitOpposites", "+=", createRuleCall(PR_ImplicitOppositeCS)), createKeyword(";")))), createKeyword("}")), createKeyword(";"))));
			...
			PR_TopLevelCS.setAlternatives(createGroup(createAction(null, null, createTypeRef(MM, org.eclipse.ocl.xtext.oclinecorecs.OCLinEcoreCSPackage.Literals.TOP_LEVEL_CS)), setCardinality("?", createGroup(setCardinality("?", createAssignment("ownedAnnotations", "+=", createRuleCall(_Base.PR_CommentCS))), createKeyword("module"), createRuleCall(PR_UnrestrictedName))), setCardinality("*", createAssignment("ownedImports", "+=", createRuleCall(PR_ImportCS))), setCardinality("*", createAssignment("ownedPackages", "+=", createRuleCall(PR_PackageCS)))));
			...
			PR_UnrestrictedName.setAlternatives(createAlternatives(createRuleCall(PR_EnumerationLiteralName), createKeyword("annotation"), createKeyword("documentation"), createKeyword("invariant"), createKeyword("literal"), createKeyword("opposite"), createKeyword("serializable"), createKeyword("sysml")));
		}
	...
	private static class _EssentialOCL
	{
		...
		private static void initParserRules() {
			...
			PR_CoIteratorVariableCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS))))));
			...
			PR_EssentialOCLUnreservedName.setAlternatives(createAlternatives(createRuleCall(_OCLinEcore.PR_UnrestrictedName), createRuleCall(PR_CollectionTypeIdentifier), createRuleCall(PR_PrimitiveTypeIdentifier), createKeyword("Map"), createKeyword("Tuple")));
			...
			PR_PatternExpCS.setAlternatives(createGroup(setCardinality("?", createAssignment("patternVariableName", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName))), createKeyword(":"), createAssignment("ownedPatternType", "=", createRuleCall(PR_TypeExpCS))));
			...
			PR_TupleLiteralPartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)), setCardinality("?", createGroup(createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS)))), createKeyword("="), createAssignment("ownedInitExpression", "=", createRuleCall(PR_ExpCS))));
			PR_TuplePartCS.setAlternatives(createGroup(createAssignment("name", "=", createRuleCall(_OCLinEcore.PR_UnrestrictedName)), createKeyword(":"), createAssignment("ownedType", "=", createRuleCall(PR_TypeExpCS))));
