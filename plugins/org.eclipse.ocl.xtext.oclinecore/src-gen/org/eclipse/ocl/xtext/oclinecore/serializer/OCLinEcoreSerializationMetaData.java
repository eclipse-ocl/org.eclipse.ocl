...
public class OCLinEcoreSerializationMetaData extends AbstractSerializationMetaData
{
	...
	private void initSerializationRules0() {
		...
		serializationRules[13] = createSerializationRule("TypeParameterCS-0", 114,
			...
			createSerializationSteps(
				...
				152		/* 'extends' || soft-space value soft-space */,
		...
		serializationRules[24] = createSerializationRule("ElseIfThenExpCS-0", 20,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				149		/* 'elseif' || soft-space value soft-space */,
		...
		serializationRules[26] = createSerializationRule("IfExpCS-0", 36,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				153		/* 'if' || soft-space value soft-space */,
				...
				148		/* 'else' || soft-space value soft-space */,
				35		/* IfExpCS::ownedElseExpression=ExpCS || value */,
				150		/* 'endif' || soft-space value soft-space */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[27] = createSerializationRule("InvalidLiteralExpCS-0", 40,
			...
			createSerializationSteps(
				157		/* 'invalid' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		...
		serializationRules[28] = createSerializationRule("LambdaLiteralExpCS-0", 44,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				137		/* 'Lambda' || soft-space value soft-space */,
				175		/* '{' || soft-space value push soft-new-line */,
		...
		serializationRules[29] = createSerializationRule("LetExpCS-0", 45,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				159		/* 'let' || soft-space value soft-space */,
				103		/* LetExpCS::ownedVariables+=LetVariableCS || value */,
				183		/* V00*2-steps || value */,
				127		/* ',' || no-space value soft-space */,
				103		/* LetExpCS::ownedVariables+=LetVariableCS || value */,
				155		/* 'in' || soft-space value soft-space */,
		...
		serializationRules[35] = createSerializationRule("NameExpCS-0", 59,
			...
			createSerializationSteps(
				...
				166		/* 'pre' || soft-space value soft-space */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[48] = createSerializationRule("NullLiteralExpCS-0", 68,
			...
			createSerializationSteps(
				162		/* 'null' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		...
		serializationRules[55] = createSerializationRule("SelfExpCS-0", 89,
			...
			createSerializationSteps(
				169		/* 'self' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		...
		serializationRules[61] = createSerializationRule("TupleLiteralExpCS-0", 103,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				138		/* 'Tuple' || soft-space value soft-space */,
				175		/* '{' || soft-space value push soft-new-line */,
	...
	private void initSerializationRules1() {
		...
		serializationRules[81] = createSerializationRule("AnnotationCS-0", 1,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				141		/* 'annotation' || soft-space value soft-space */,
				179		/* V00*1-steps || value */,
		...
		serializationRules[85] = createSerializationRule("AttributeCS-0", 3,
			...
			createSerializationSteps(
				...
				142		/* 'attribute' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				192		/* V01*2-steps || value */,
				130		/* ':' || soft-space value soft-space */,
		...
		serializationRules[91] = createSerializationRule("DataTypeCS-0", 15,
			...
			createSerializationSteps(
				...
				145		/* 'datatype' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				189		/* V01*1-steps || value */,
		...
		serializationRules[98] = createSerializationRule("DocumentationCS-0", 17,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				147		/* 'documentation' || soft-space value soft-space */,
				179		/* V00*1-steps || value */,
		...
		serializationRules[99] = createSerializationRule("EnumerationCS-0", 21,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				151		/* 'enum' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				179		/* V00*1-steps || value */,
				86		/* TemplateableElementCS::ownedSignature=TemplateSignatureCS || value */,
				192		/* V01*2-steps || value */,
		...
		serializationRules[105] = createSerializationRule("EnumerationLiteralCS-0", 22,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				160		/* 'literal' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				182		/* V00*2-steps || value */,
				130		/* ':' || soft-space value soft-space */,
		...
		serializationRules[109] = createSerializationRule("ImplicitOppositeCS-0", 37,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				164		/* 'opposite' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				130		/* ':' || soft-space value soft-space */,
				267		/* TypedElementCS::ownedType=TypedMultiplicityRefCS || value */,
				185		/* V00*4-steps || value */,
		...
		serializationRules[113] = createSerializationRule("ModelElementRefCS-0", 54,
			...
			createSerializationSteps(
				168		/* 'reference' || soft-space value soft-space */,
		...
		serializationRules[114] = createSerializationRule("OperationCS-0", 70,
			...
			createSerializationSteps(
				...
				179		/* V00*1-steps || value */,
				273		/* TypedElementCS::qualifiers+='static' || soft-space value soft-space */,
				163		/* 'operation' || soft-space value soft-space */,
				189		/* V01*1-steps || value */,
				86		/* TemplateableElementCS::ownedSignature=TemplateSignatureCS || value */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				123		/* '(' || no-space value no-space */,
		...
		serializationRules[115] = createSerializationRule("OperationCS-1", 70,
			...
			createSerializationSteps(
				...
				143		/* 'body' || soft-space value soft-space */,
				129		/* ':' || no-space value soft-space */,
		...
		serializationRules[120] = createSerializationRule("PackageCS-0", 71,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				165		/* 'package' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				182		/* V00*2-steps || value */,
				130		/* ':' || soft-space value soft-space */,
		...
		serializationRules[125] = createSerializationRule("ReferenceCS-0", 83,
			...
			createSerializationSteps(
				...
				179		/* V00*1-steps || value */,
				273		/* TypedElementCS::qualifiers+='static' || soft-space value soft-space */,
				167		/* 'property' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				192		/* V01*2-steps || value */,
		...
		serializationRules[126] = createSerializationRule("ReferenceCS-1", 83,
			...
			createSerializationSteps(
				...
				158		/* 'key' || soft-space value soft-space */,
	...
	private void initSerializationRules2() {
		...
		serializationRules[133] = createSerializationRule("StructuredClassCS-0", 97,
			...
			createSerializationSteps(
				...
				144		/* 'class' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				189		/* V01*1-steps || value */,
				86		/* TemplateableElementCS::ownedSignature=TemplateSignatureCS || value */,
		...
		serializationRules[139] = createSerializationRule("TopLevelCS-0", 102,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				179		/* V00*1-steps || value */,
				161		/* 'module' || soft-space value soft-space */,
				190		/* V01*1-steps || value */,
	...
	private void initSerializationSteps() {
		...
		// 18: PackageCS::nsPrefix=UnrestrictedName || soft-space value soft-space
		serializationSteps[18] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PACKAGE_CS__NS_PREFIX, 128 /*UnrestrictedName*/, 7);
		// 19: PackageCS::nsURI=URI || soft-space value soft-space
		...
		// 108: ReferenceCS::referredKeys+=UnrestrictedName || soft-space value soft-space
		serializationSteps[108] = createSerializationStepCrossReference(BaseCSPackage.Literals.REFERENCE_CS__REFERRED_KEYS, getCrossReference(BaseCSPackage.Literals.REFERENCE_CS__REFERRED_KEYS, "UnrestrictedName"), 128, 7);
		// 109: ReferenceCS::referredOpposite=UnrestrictedName || soft-space value soft-space
		serializationSteps[109] = createSerializationStepCrossReference(BaseCSPackage.Literals.REFERENCE_CS__REFERRED_OPPOSITE, getCrossReference(BaseCSPackage.Literals.REFERENCE_CS__REFERRED_OPPOSITE, "UnrestrictedName"), 128, 7);
		// 110: ShadowPartCS::referredProperty=UnrestrictedName || soft-space value soft-space
		serializationSteps[110] = createSerializationStepCrossReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__REFERRED_PROPERTY, getCrossReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__REFERRED_PROPERTY, "UnrestrictedName"), 128, 7);
		// 111: CollectionPatternCS::restVariableName=Identifier || soft-space value soft-space
		...
		// 137: 'Lambda' || soft-space value soft-space
		serializationSteps[137] = createSerializationStepKeyword("Lambda", 7);
		// 138: 'Tuple' || soft-space value soft-space
		serializationSteps[138] = createSerializationStepKeyword("Tuple", 7);
		// 139: '[' || no-space value no-space
		serializationSteps[139] = createSerializationStepKeyword("[", 4);
		// 140: ']' || no-space value
		serializationSteps[140] = createSerializationStepKeyword("]", 1);
		// 141: 'annotation' || soft-space value soft-space
		serializationSteps[141] = createSerializationStepKeyword("annotation", 7);
		// 142: 'attribute' || soft-space value soft-space
		serializationSteps[142] = createSerializationStepKeyword("attribute", 7);
		// 143: 'body' || soft-space value soft-space
		serializationSteps[143] = createSerializationStepKeyword("body", 7);
		// 144: 'class' || soft-space value soft-space
		serializationSteps[144] = createSerializationStepKeyword("class", 7);
		// 145: 'datatype' || soft-space value soft-space
		serializationSteps[145] = createSerializationStepKeyword("datatype", 7);
		// 146: 'derivation' || soft-space value soft-space
		serializationSteps[146] = createSerializationStepKeyword("derivation", 7);
		// 147: 'documentation' || soft-space value soft-space
		serializationSteps[147] = createSerializationStepKeyword("documentation", 7);
		// 148: 'else' || soft-space value soft-space
		serializationSteps[148] = createSerializationStepKeyword("else", 7);
		// 149: 'elseif' || soft-space value soft-space
		serializationSteps[149] = createSerializationStepKeyword("elseif", 7);
		// 150: 'endif' || soft-space value soft-space
		serializationSteps[150] = createSerializationStepKeyword("endif", 7);
		// 151: 'enum' || soft-space value soft-space
		serializationSteps[151] = createSerializationStepKeyword("enum", 7);
		// 152: 'extends' || soft-space value soft-space
		serializationSteps[152] = createSerializationStepKeyword("extends", 7);
		// 153: 'if' || soft-space value soft-space
		serializationSteps[153] = createSerializationStepKeyword("if", 7);
		// 154: 'import' || value
		serializationSteps[154] = createSerializationStepKeyword("import", 0);
		// 155: 'in' || soft-space value soft-space
		serializationSteps[155] = createSerializationStepKeyword("in", 7);
		// 156: 'initial' || soft-space value soft-space
		serializationSteps[156] = createSerializationStepKeyword("initial", 7);
		// 157: 'invalid' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[157] = createSerializationStepKeyword("invalid", 2);
		// 158: 'key' || soft-space value soft-space
		serializationSteps[158] = createSerializationStepKeyword("key", 7);
		// 159: 'let' || soft-space value soft-space
		serializationSteps[159] = createSerializationStepKeyword("let", 7);
		// 160: 'literal' || soft-space value soft-space
		serializationSteps[160] = createSerializationStepKeyword("literal", 7);
		// 161: 'module' || soft-space value soft-space
		serializationSteps[161] = createSerializationStepKeyword("module", 7);
		// 162: 'null' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[162] = createSerializationStepKeyword("null", 2);
		// 163: 'operation' || soft-space value soft-space
		serializationSteps[163] = createSerializationStepKeyword("operation", 7);
		// 164: 'opposite' || soft-space value soft-space
		serializationSteps[164] = createSerializationStepKeyword("opposite", 7);
		// 165: 'package' || soft-space value soft-space
		serializationSteps[165] = createSerializationStepKeyword("package", 7);
		// 166: 'pre' || soft-space value soft-space
		serializationSteps[166] = createSerializationStepKeyword("pre", 7);
		// 167: 'property' || soft-space value soft-space
		serializationSteps[167] = createSerializationStepKeyword("property", 7);
		// 168: 'reference' || soft-space value soft-space
		serializationSteps[168] = createSerializationStepKeyword("reference", 7);
		// 169: 'self' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[169] = createSerializationStepKeyword("self", 2);
		// 170: 'sysml' || soft-space value soft-space
		...
		// 173: 'with' || value
		serializationSteps[173] = createSerializationStepKeyword("with", 0);
		// 174: '{' || soft-space value soft-space
		...
		// 254: NamedElementCS::name=UnrestrictedName || soft-space value soft-space
		serializationSteps[254] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 128 /*UnrestrictedName*/, 7);
		// 255: NamedElementCS::name=UnrestrictedName|SINGLE_QUOTED_STRING || soft-space value soft-space
		serializationSteps[255] = createSerializationStepAssigns(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, -1, new int[] { 128/*UnrestrictedName*/,87/*SINGLE_QUOTED_STRING*/}, 7);
		// 256: NamedElementCS::name=EnumerationLiteralName || soft-space value soft-space
		...
		// 276: PathElementCS::referredElement=UnrestrictedName || soft-space value soft-space
		serializationSteps[276] = createSerializationStepCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, getCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, "UnrestrictedName"), 128, 7);
		// 277: ConstraintCS::stereotype='invariant' || soft-space value soft-space
