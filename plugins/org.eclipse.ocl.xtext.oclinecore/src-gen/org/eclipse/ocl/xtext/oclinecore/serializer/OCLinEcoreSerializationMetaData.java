...
public class OCLinEcoreSerializationMetaData extends AbstractSerializationMetaData
{
	...
	private final @NonNull GrammarRuleVector @NonNull [] grammarRuleVectors = new @NonNull GrammarRuleVector[73];
	private final @NonNull SerializationMatchStep @NonNull [] serializationMatchSteps = new @NonNull SerializationMatchStep[354];
	private final @NonNull SerializationMatchTerm @NonNull [] serializationMatchTerms = new @NonNull SerializationMatchTerm[242];
	private final @NonNull SerializationRule @NonNull [] serializationRules = new @NonNull SerializationRule[149];
	...
	private void initEClassValues() {
		eClassValues[0] = new EClassValue(BaseCSPackage.Literals.ANNOTATION_CS,
			createSerializationRules(
				80 /* AnnotationCS-0: 'annotation' (NamedElementCS::name=UnrestrictedName|SINGLE_QUOTED_STRING)[V0:?] ('(' AnnotationElementCS::ownedDetails+=DetailCS (',' AnnotationElementCS::ownedDetails+=DetailCS)[V2:*] ')')[V1:?] ';' */,
				81 /* AnnotationCS-1: 'annotation' (NamedElementCS::name=UnrestrictedName|SINGLE_QUOTED_STRING)[V0:?] ('(' AnnotationElementCS::ownedDetails+=DetailCS (',' AnnotationElementCS::ownedDetails+=DetailCS)[V2:*] ')')[V1:?] '{' (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V3:+] (AnnotationCS::ownedContents+=ModelElementCS)[V4:*] (AnnotationCS::ownedReferences+=ModelElementRefCS)[V5:*] '}' */,
				82 /* AnnotationCS-2: 'annotation' (NamedElementCS::name=UnrestrictedName|SINGLE_QUOTED_STRING)[V0:?] ('(' AnnotationElementCS::ownedDetails+=DetailCS (',' AnnotationElementCS::ownedDetails+=DetailCS)[V2:*] ')')[V1:?] '{' (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V3:*] (AnnotationCS::ownedContents+=ModelElementCS)[V4:+] (AnnotationCS::ownedReferences+=ModelElementRefCS)[V5:*] '}' */,
				83 /* AnnotationCS-3: 'annotation' (NamedElementCS::name=UnrestrictedName|SINGLE_QUOTED_STRING)[V0:?] ('(' AnnotationElementCS::ownedDetails+=DetailCS (',' AnnotationElementCS::ownedDetails+=DetailCS)[V2:*] ')')[V1:?] '{' (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V3:*] (AnnotationCS::ownedContents+=ModelElementCS)[V4:*] (AnnotationCS::ownedReferences+=ModelElementRefCS)[V5:+] '}' */
			),
		...
		eClassValues[1] = new EClassValue(BaseCSPackage.Literals.ATTRIBUTE_CS,
			...
			new @NonNull EReference_TargetGrammarRuleVector [] {
				...
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE,
					58) /* TypedMultiplicityRefCS */
			}
		);
		eClassValues[2] = new EClassValue(EssentialOCLCSPackage.Literals.BOOLEAN_LITERAL_EXP_CS,
			createSerializationRules(
				15 /* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */
			), null
		);
		eClassValues[3] = new EClassValue(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_EXP_CS,
			createSerializationRules(
				17 /* CollectionLiteralExpCS-0: CollectionLiteralExpCS::ownedType=CollectionTypeCS '{' (CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS (',' CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS)[V1:*])[V0:?] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[4] = new EClassValue(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS,
			createSerializationRules(
				19 /* CollectionLiteralPartCS-1: CollectionLiteralPartCS::ownedExpression=PatternExpCS */,
				18 /* CollectionLiteralPartCS-0: CollectionLiteralPartCS::ownedExpression=ExpCS ('..' CollectionLiteralPartCS::ownedLastExpression=ExpCS)[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				...
				createEReference_TargetGrammarRuleVector(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_LAST_EXPRESSION,
					68) /* BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */
			}
		);
		eClassValues[5] = new EClassValue(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS,
			createSerializationRules(
				20 /* CollectionPatternCS-0: CollectionPatternCS::ownedType=CollectionTypeCS '{' (CollectionPatternCS::ownedParts+=PatternExpCS (',' CollectionPatternCS::ownedParts+=PatternExpCS)[V1:*] '++' CollectionPatternCS::restVariableName=Identifier)[V0:?] '}' */,
				68 /* TypeExpCS-4: CollectionPatternCS::ownedType=CollectionTypeCS '{' (CollectionPatternCS::ownedParts+=PatternExpCS (',' CollectionPatternCS::ownedParts+=PatternExpCS)[V1:*] '++' CollectionPatternCS::restVariableName=Identifier)[V0:?] '}' (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V2:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[6] = new EClassValue(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS,
			createSerializationRules(
				21 /* CollectionTypeCS-0: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] */,
				65 /* TypeExpCS-1: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V2:?] */,
				72 /* TypeLiteralWithMultiplicityCS-1: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V2:?] */,
				143 /* TypedMultiplicityRefCS-4: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V2:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				...
				createEReference_TargetGrammarRuleVector(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_TYPE,
					55) /* CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */
			}
		);
		eClassValues[7] = new EClassValue(EssentialOCLCSPackage.Literals.CONTEXT_CS,
			createSerializationRules(
				33 /* Model-0: ContextCS::ownedExpression=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[8] = new EClassValue(EssentialOCLCSPackage.Literals.CURLY_BRACKETED_CLAUSE_CS,
			createSerializationRules(
				22 /* CurlyBracketedClauseCS-0: '{' (CurlyBracketedClauseCS::ownedParts+=ShadowPartCS (',' CurlyBracketedClauseCS::ownedParts+=ShadowPartCS)[V1:*])[V0:?] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[10] = new EClassValue(BaseCSPackage.Literals.DETAIL_CS,
			createSerializationRules(
				96 /* DetailCS-0: NamedElementCS::name=UnrestrictedName|SINGLE_QUOTED_STRING '=' (DetailCS::values+=SINGLE_QUOTED_STRING|ML_SINGLE_QUOTED_STRING)[V0:*] */
			), null
		);
		eClassValues[11] = new EClassValue(BaseCSPackage.Literals.DOCUMENTATION_CS,
			createSerializationRules(
				97 /* DocumentationCS-0: 'documentation' (DocumentationCS::value=SINGLE_QUOTED_STRING)[V0:?] ('(' AnnotationElementCS::ownedDetails+=DetailCS (',' AnnotationElementCS::ownedDetails+=DetailCS)[V2:*] ')')[V1:?] ';' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.ANNOTATION_ELEMENT_CS__OWNED_DETAILS,
					6) /* DetailCS */
		...
		eClassValues[12] = new EClassValue(BaseCSPackage.Literals.ENUMERATION_CS,
			createSerializationRules(
				102 /* EnumerationCS-4: 'enum' NamedElementCS::name=UnrestrictedName (TemplateableElementCS::ownedSignature=TemplateSignatureCS)[V0:?] (':' ClassCS::instanceClassName=SINGLE_QUOTED_STRING)[V1:?] ('{' '}')[V2:?] ';' */,
				98 /* EnumerationCS-0: 'enum' NamedElementCS::name=UnrestrictedName (TemplateableElementCS::ownedSignature=TemplateSignatureCS)[V0:?] (':' ClassCS::instanceClassName=SINGLE_QUOTED_STRING)[V1:?] ('{' '!serializable' '}')[V2:?] ';' */,
				100 /* EnumerationCS-2: 'enum' NamedElementCS::name=UnrestrictedName (TemplateableElementCS::ownedSignature=TemplateSignatureCS)[V0:?] (':' ClassCS::instanceClassName=SINGLE_QUOTED_STRING)[V1:?] ('{' EnumerationCS::isSerializable?='serializable' '}')[V2:?] ';' */,
				103 /* EnumerationCS-5: 'enum' NamedElementCS::name=UnrestrictedName (TemplateableElementCS::ownedSignature=TemplateSignatureCS)[V0:?] (':' ClassCS::instanceClassName=SINGLE_QUOTED_STRING)[V1:?] ('{' '}')[V2:?] '{' (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V3:*] (EnumerationCS::ownedLiterals+=EnumerationLiteralCS)[V4:*] (ClassCS::ownedConstraints+=InvariantConstraintCS)[V5:*] '}' */,
				99 /* EnumerationCS-1: 'enum' NamedElementCS::name=UnrestrictedName (TemplateableElementCS::ownedSignature=TemplateSignatureCS)[V0:?] (':' ClassCS::instanceClassName=SINGLE_QUOTED_STRING)[V1:?] ('{' '!serializable' '}')[V2:?] '{' (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V3:*] (EnumerationCS::ownedLiterals+=EnumerationLiteralCS)[V4:*] (ClassCS::ownedConstraints+=InvariantConstraintCS)[V5:*] '}' */,
				101 /* EnumerationCS-3: 'enum' NamedElementCS::name=UnrestrictedName (TemplateableElementCS::ownedSignature=TemplateSignatureCS)[V0:?] (':' ClassCS::instanceClassName=SINGLE_QUOTED_STRING)[V1:?] ('{' EnumerationCS::isSerializable?='serializable' '}')[V2:?] '{' (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V3:*] (EnumerationCS::ownedLiterals+=EnumerationLiteralCS)[V4:*] (ClassCS::ownedConstraints+=InvariantConstraintCS)[V5:*] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.MODEL_ELEMENT_CS__OWNED_ANNOTATIONS,
					45) /* AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
		...
		eClassValues[13] = new EClassValue(BaseCSPackage.Literals.ENUMERATION_LITERAL_CS,
			createSerializationRules(
				106 /* EnumerationLiteralCS-2: NamedElementCS::name=EnumerationLiteralName (':' EnumerationLiteralCS::literal=SINGLE_QUOTED_STRING)[V0:?] ('=' EnumerationLiteralCS::value=SIGNED)[V1:?] ';' */,
				104 /* EnumerationLiteralCS-0: 'literal' NamedElementCS::name=UnrestrictedName (':' EnumerationLiteralCS::literal=SINGLE_QUOTED_STRING)[V0:?] ('=' EnumerationLiteralCS::value=SIGNED)[V1:?] ';' */,
				107 /* EnumerationLiteralCS-3: NamedElementCS::name=EnumerationLiteralName (':' EnumerationLiteralCS::literal=SINGLE_QUOTED_STRING)[V0:?] ('=' EnumerationLiteralCS::value=SIGNED)[V1:?] '{' (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V2:*] '}' */,
				105 /* EnumerationLiteralCS-1: 'literal' NamedElementCS::name=UnrestrictedName (':' EnumerationLiteralCS::literal=SINGLE_QUOTED_STRING)[V0:?] ('=' EnumerationLiteralCS::value=SIGNED)[V1:?] '{' (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V2:*] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.MODEL_ELEMENT_CS__OWNED_ANNOTATIONS,
					45) /* AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */
		...
		eClassValues[14] = new EClassValue(EssentialOCLCSPackage.Literals.EXP_SPECIFICATION_CS,
			createSerializationRules(
				130 /* SpecificationCS-0: ExpSpecificationCS::ownedExpression=ExpCS */,
				131 /* SpecificationCS-1: SpecificationCS::exprString=UNQUOTED_STRING */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[15] = new EClassValue(EssentialOCLCSPackage.Literals.IF_EXP_CS,
			createSerializationRules(
				25 /* IfExpCS-0: 'if' IfExpCS::ownedCondition=ExpCS|PatternExpCS 'then' IfExpCS::ownedThenExpression=ExpCS (IfExpCS::ownedIfThenExpressions+=ElseIfThenExpCS)[V0:*] 'else' IfExpCS::ownedElseExpression=ExpCS 'endif' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[16] = new EClassValue(EssentialOCLCSPackage.Literals.IF_THEN_EXP_CS,
			createSerializationRules(
				23 /* ElseIfThenExpCS-0: 'elseif' IfThenExpCS::ownedCondition=ExpCS 'then' IfThenExpCS::ownedThenExpression=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[17] = new EClassValue(BaseCSPackage.Literals.IMPLICIT_OPPOSITE_CS,
			createSerializationRules(
				108 /* ImplicitOppositeCS-0: 'opposite' NamedElementCS::name=UnrestrictedName ':' TypedElementCS::ownedType=TypedMultiplicityRefCS ('{' (TypedElementCS::qualifiers+='!ordered|!unique|ordered|unique')[V1:+] '}')[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE,
					58) /* TypedMultiplicityRefCS */
		...
		eClassValues[18] = new EClassValue(BaseCSPackage.Literals.IMPORT_CS,
			createSerializationRules(
				109 /* ImportCS-0: 'import' (NamedElementCS::name=UnrestrictedName ':')[V0:?] ImportCS::ownedPathName=URIPathNameCS (ImportCS::isAll?='::*')[V1:?] ';' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[19] = new EClassValue(EssentialOCLCSPackage.Literals.INFIX_EXP_CS,
			createSerializationRules(
				24 /* ExpCS-18: InfixExpCS::ownedLeft=PrefixedPrimaryExpCS NamedElementCS::name=BinaryOperatorName OperatorExpCS::ownedRight=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[20] = new EClassValue(EssentialOCLCSPackage.Literals.INVALID_LITERAL_EXP_CS,
			createSerializationRules(
				26 /* InvalidLiteralExpCS-0: 'invalid' */
			), null
		);
		eClassValues[21] = new EClassValue(EssentialOCLCSPackage.Literals.LAMBDA_LITERAL_EXP_CS,
			createSerializationRules(
				27 /* LambdaLiteralExpCS-0: 'Lambda' '{' LambdaLiteralExpCS::ownedExpressionCS=ExpCS '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[22] = new EClassValue(EssentialOCLCSPackage.Literals.LET_EXP_CS,
			createSerializationRules(
				28 /* LetExpCS-0: 'let' LetExpCS::ownedVariables+=LetVariableCS (',' LetExpCS::ownedVariables+=LetVariableCS)[V0:*] 'in' LetExpCS::ownedInExpression=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[23] = new EClassValue(EssentialOCLCSPackage.Literals.LET_VARIABLE_CS,
			createSerializationRules(
				29 /* LetVariableCS-0: NamedElementCS::name=UnrestrictedName (LetVariableCS::ownedRoundBracketedClause=RoundBracketedClauseCS)[V0:?] (':' VariableCS::ownedType=TypeExpCS)[V1:?] '=' VariableCS::ownedInitExpression=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[24] = new EClassValue(EssentialOCLCSPackage.Literals.MAP_LITERAL_EXP_CS,
			createSerializationRules(
				30 /* MapLiteralExpCS-0: MapLiteralExpCS::ownedType=MapTypeCS '{' (MapLiteralExpCS::ownedParts+=MapLiteralPartCS (',' MapLiteralExpCS::ownedParts+=MapLiteralPartCS)[V1:*])[V0:?] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[25] = new EClassValue(EssentialOCLCSPackage.Literals.MAP_LITERAL_PART_CS,
			createSerializationRules(
				31 /* MapLiteralPartCS-0: MapLiteralPartCS::ownedKey=ExpCS '<-' MapLiteralPartCS::ownedValue=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[26] = new EClassValue(EssentialOCLCSPackage.Literals.MAP_TYPE_CS,
			createSerializationRules(
				32 /* MapTypeCS-0: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] */,
				66 /* TypeExpCS-2: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V1:?] */,
				73 /* TypeLiteralWithMultiplicityCS-2: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V1:?] */,
				144 /* TypedMultiplicityRefCS-5: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V1:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[27] = new EClassValue(BaseCSPackage.Literals.MODEL_ELEMENT_REF_CS,
			createSerializationRules(
				112 /* ModelElementRefCS-0: 'reference' ModelElementRefCS::ownedPathName=PathNameCS ';' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[30] = new EClassValue(EssentialOCLCSPackage.Literals.NAME_EXP_CS,
			createSerializationRules(
				34 /* NameExpCS-0: AbstractNameExpCS::ownedPathName=PathNameCS (AbstractNameExpCS::ownedSquareBracketedClauses+=SquareBracketedClauseCS)[V0:*] (AbstractNameExpCS::ownedRoundBracketedClause=RoundBracketedClauseCS)[V1:?] (AbstractNameExpCS::ownedCurlyBracketedClause=CurlyBracketedClauseCS)[V2:?] (AbstractNameExpCS::isPre?='@' 'pre')[V3:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[31] = new EClassValue(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS,
			createSerializationRules(
				39 /* NavigatingArgCS-4: NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS */,
				35 /* NavigatingArgCS-0: ':' NavigatingArgCS::ownedType=TypeExpCS */,
				37 /* NavigatingArgCS-2: NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS '<-' NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS ('=' NavigatingArgCS::ownedInitExpression=ExpCS)[V0:?] */,
				36 /* NavigatingArgCS-1: NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS ':' NavigatingArgCS::ownedType=TypeExpCS ('<-' NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS)[V0:?] ('=' NavigatingArgCS::ownedInitExpression=ExpCS)[V1:?] */,
				38 /* NavigatingArgCS-3: NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS (':' NavigatingArgCS::ownedType=TypeExpCS)[V0:?] ('<-' NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS)[V1:?] 'in' NavigatingArgCS::ownedInitExpression=ExpCS */,
				40 /* NavigatingBarArgCS-0: NavigatingArgCS::prefix='|' NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS (':' NavigatingArgCS::ownedType=TypeExpCS ('=' NavigatingArgCS::ownedInitExpression=ExpCS)[V1:?])[V0:?] */,
				44 /* NavigatingCommaArgCS-3: NavigatingArgCS::prefix=',' NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS */,
				42 /* NavigatingCommaArgCS-1: NavigatingArgCS::prefix=',' NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS '<-' NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS ('=' NavigatingArgCS::ownedInitExpression=ExpCS)[V0:?] */,
				41 /* NavigatingCommaArgCS-0: NavigatingArgCS::prefix=',' NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS ':' NavigatingArgCS::ownedType=TypeExpCS ('<-' NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS)[V0:?] ('=' NavigatingArgCS::ownedInitExpression=ExpCS)[V1:?] */,
				43 /* NavigatingCommaArgCS-2: NavigatingArgCS::prefix=',' NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS (':' NavigatingArgCS::ownedType=TypeExpCS)[V0:?] ('<-' NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS)[V1:?] 'in' NavigatingArgCS::ownedInitExpression=ExpCS */,
				45 /* NavigatingSemiArgCS-0: NavigatingArgCS::prefix=';' NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS (':' NavigatingArgCS::ownedType=TypeExpCS ('=' NavigatingArgCS::ownedInitExpression=ExpCS)[V1:?])[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[32] = new EClassValue(EssentialOCLCSPackage.Literals.NESTED_EXP_CS,
			createSerializationRules(
				46 /* NestedExpCS-0: '(' NestedExpCS::ownedExpression=ExpCS ')' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[33] = new EClassValue(EssentialOCLCSPackage.Literals.NULL_LITERAL_EXP_CS,
			createSerializationRules(
				47 /* NullLiteralExpCS-0: 'null' */
			), null
		);
		eClassValues[34] = new EClassValue(EssentialOCLCSPackage.Literals.NUMBER_LITERAL_EXP_CS,
			createSerializationRules(
				48 /* NumberLiteralExpCS-0: NumberLiteralExpCS::symbol=NUMBER_LITERAL */
			), null
		);
		eClassValues[35] = new EClassValue(OCLinEcoreCSPackage.Literals.OC_LIN_ECORE_CONSTRAINT_CS,
			createSerializationRules(
				110 /* InvariantConstraintCS-0: (OCLinEcoreConstraintCS::isCallable?='callable')[V0:?] ConstraintCS::stereotype='invariant' (NamedElementCS::name=UnrestrictedName ('(' ConstraintCS::ownedMessageSpecification=SpecificationCS ')')[V2:?])[V1:?] ';' */,
				111 /* InvariantConstraintCS-1: (OCLinEcoreConstraintCS::isCallable?='callable')[V0:?] ConstraintCS::stereotype='invariant' (NamedElementCS::name=UnrestrictedName ('(' ConstraintCS::ownedMessageSpecification=SpecificationCS ')')[V2:?])[V1:?] ':' (ConstraintCS::ownedSpecification=SpecificationCS)[V3:?] ';' */,
				122 /* PostconditionConstraintCS-0: ConstraintCS::stereotype='postcondition' (NamedElementCS::name=UnrestrictedName ('(' ConstraintCS::ownedMessageSpecification=SpecificationCS ')')[V1:?])[V0:?] ':' (ConstraintCS::ownedSpecification=SpecificationCS)[V2:?] ';' */,
				123 /* PreconditionConstraintCS-0: ConstraintCS::stereotype='precondition' (NamedElementCS::name=UnrestrictedName ('(' ConstraintCS::ownedMessageSpecification=SpecificationCS ')')[V1:?])[V0:?] ':' (ConstraintCS::ownedSpecification=SpecificationCS)[V2:?] ';' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[36] = new EClassValue(BaseCSPackage.Literals.OPERATION_CS,
			...
			new @NonNull EReference_TargetGrammarRuleVector [] {
				...
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.OPERATION_CS__OWNED_EXCEPTIONS,
					60) /* CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS */,
		...
		eClassValues[37] = new EClassValue(BaseCSPackage.Literals.PACKAGE_CS,
			createSerializationRules(
				119 /* PackageCS-0: 'package' NamedElementCS::name=UnrestrictedName (':' PackageCS::nsPrefix=UnrestrictedName)[V0:?] ('=' PackageCS::nsURI=URI)[V1:?] ';' */,
				120 /* PackageCS-1: 'package' NamedElementCS::name=UnrestrictedName (':' PackageCS::nsPrefix=UnrestrictedName)[V0:?] ('=' PackageCS::nsURI=URI)[V1:?] '{' (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V2:*] (PackageOwnerCS::ownedPackages+=PackageCS)[V3:*] (PackageCS::ownedClasses+=ClassCS)[V4:*] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.MODEL_ELEMENT_CS__OWNED_ANNOTATIONS,
					45) /* AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
		...
		eClassValues[38] = new EClassValue(BaseCSPackage.Literals.PARAMETER_CS,
			createSerializationRules(
				121 /* ParameterCS-0: NamedElementCS::name=UnrestrictedName (':' TypedElementCS::ownedType=TypedMultiplicityRefCS)[V0:?] ('{' (TypedElementCS::qualifiers+='!ordered|!unique|ordered|unique')[V2:+] '}')[V1:?] ('{' (ModelElementCS::ownedAnnotations+=AnnotationElementCS)[V4:*] '}')[V3:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.MODEL_ELEMENT_CS__OWNED_ANNOTATIONS,
					45) /* AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
		...
		eClassValues[39] = new EClassValue(BaseCSPackage.Literals.PATH_ELEMENT_CS,
			createSerializationRules(
				...
				77 /* URIFirstPathElementCS-1: PathElementCS::referredElement=UnrestrictedName */
			), null
		);
		eClassValues[40] = new EClassValue(BaseCSPackage.Literals.PATH_ELEMENT_WITH_URICS,
			createSerializationRules(
				76 /* URIFirstPathElementCS-0: PathElementCS::referredElement=URI */
			), null
		);
		eClassValues[41] = new EClassValue(BaseCSPackage.Literals.PATH_NAME_CS,
			createSerializationRules(
				...
				57 /* SimplePathNameCS-0: PathNameCS::ownedPathElements+=FirstPathElementCS */,
				78 /* URIPathNameCS-0: PathNameCS::ownedPathElements+=URIFirstPathElementCS ('::' PathNameCS::ownedPathElements+=NextPathElementCS)[V0:*] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS,
					62) /* FirstPathElementCS|NextPathElementCS|URIFirstPathElementCS */
			}
		);
		eClassValues[42] = new EClassValue(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS,
			createSerializationRules(
				49 /* PatternExpCS-0: (PatternExpCS::patternVariableName=UnrestrictedName)[V0:?] ':' PatternExpCS::ownedPatternType=TypeExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[43] = new EClassValue(EssentialOCLCSPackage.Literals.PREFIX_EXP_CS,
			createSerializationRules(
				50 /* PrefixedLetExpCS-1: NamedElementCS::name=UnaryOperatorName OperatorExpCS::ownedRight=PrefixedLetExpCS */,
				51 /* PrefixedPrimaryExpCS-15: NamedElementCS::name=UnaryOperatorName OperatorExpCS::ownedRight=PrefixedPrimaryExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT,
		...
		eClassValues[44] = new EClassValue(BaseCSPackage.Literals.PRIMITIVE_TYPE_REF_CS,
			createSerializationRules(
				52 /* PrimitiveTypeCS-0: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier */,
				64 /* TypeExpCS-0: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V0:?] */,
				71 /* TypeLiteralWithMultiplicityCS-0: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V0:?] */,
				139 /* TypedMultiplicityRefCS-0: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TYPED_REF_CS__OWNED_MULTIPLICITY,
					19) /* MultiplicityCS */
		...
		eClassValues[46] = new EClassValue(EssentialOCLCSPackage.Literals.ROUND_BRACKETED_CLAUSE_CS,
			createSerializationRules(
				53 /* RoundBracketedClauseCS-0: '(' (RoundBracketedClauseCS::ownedArguments+=NavigatingArgCS (RoundBracketedClauseCS::ownedArguments+=NavigatingCommaArgCS|NavigatingSemiArgCS|NavigatingBarArgCS)[V1:*])[V0:?] ')' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[48] = new EClassValue(EssentialOCLCSPackage.Literals.SHADOW_PART_CS,
			createSerializationRules(
				56 /* ShadowPartCS-1: ShadowPartCS::ownedInitExpression=StringLiteralExpCS */,
				55 /* ShadowPartCS-0: ShadowPartCS::referredProperty=UnrestrictedName '=' ShadowPartCS::ownedInitExpression=ExpCS|PatternExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[49] = new EClassValue(EssentialOCLCSPackage.Literals.SQUARE_BRACKETED_CLAUSE_CS,
			createSerializationRules(
				58 /* SquareBracketedClauseCS-0: '[' SquareBracketedClauseCS::ownedTerms+=ExpCS (',' SquareBracketedClauseCS::ownedTerms+=ExpCS)[V0:*] ']' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[52] = new EClassValue(OCLinEcoreCSPackage.Literals.SYS_MLCS,
			createSerializationRules(
				135 /* SysMLCS-1: 'sysml' AnnotationElementCS::ownedDetails+=DetailCS ';' */,
				134 /* SysMLCS-0: 'sysml' '{' (AnnotationElementCS::ownedDetails+=DetailCS ';')[V0:*] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.ANNOTATION_ELEMENT_CS__OWNED_DETAILS,
					6) /* DetailCS */
		...
		eClassValues[54] = new EClassValue(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS,
			...
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS__OWNED_ACTUAL_PARAMETER,
					72) /* CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS */
			}
		);
		eClassValues[55] = new EClassValue(BaseCSPackage.Literals.TEMPLATE_SIGNATURE_CS,
			createSerializationRules(
				136 /* TemplateSignatureCS-0: '(' TemplateSignatureCS::ownedParameters+=TypeParameterCS (',' TemplateSignatureCS::ownedParameters+=TypeParameterCS)[V0:*] ')' */,
				137 /* TemplateSignatureCS-1: '<' TemplateSignatureCS::ownedParameters+=TypeParameterCS (',' TemplateSignatureCS::ownedParameters+=TypeParameterCS)[V0:*] '>' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[56] = new EClassValue(OCLinEcoreCSPackage.Literals.TOP_LEVEL_CS,
			createSerializationRules(
				138 /* TopLevelCS-0: ('module')[V0:?] (RootCS::ownedImports+=ImportCS)[V1:*] (PackageOwnerCS::ownedPackages+=PackageCS)[V2:*] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[57] = new EClassValue(EssentialOCLCSPackage.Literals.TUPLE_LITERAL_EXP_CS,
			createSerializationRules(
				60 /* TupleLiteralExpCS-0: 'Tuple' '{' TupleLiteralExpCS::ownedParts+=TupleLiteralPartCS (',' TupleLiteralExpCS::ownedParts+=TupleLiteralPartCS)[V0:*] '}' */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[58] = new EClassValue(EssentialOCLCSPackage.Literals.TUPLE_LITERAL_PART_CS,
			createSerializationRules(
				61 /* TupleLiteralPartCS-0: NamedElementCS::name=UnrestrictedName (':' VariableCS::ownedType=TypeExpCS)[V0:?] '=' VariableCS::ownedInitExpression=ExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_INIT_EXPRESSION,
					68) /* BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		eClassValues[59] = new EClassValue(BaseCSPackage.Literals.TUPLE_PART_CS,
			createSerializationRules(
				62 /* TuplePartCS-0: NamedElementCS::name=UnrestrictedName ':' TypedElementCS::ownedType=TypeExpCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE,
					51) /* TypeExpCS */
		...
		eClassValues[60] = new EClassValue(BaseCSPackage.Literals.TUPLE_TYPE_CS,
			createSerializationRules(
				63 /* TupleTypeCS-0: TupleTypeCS::name='Tuple' ('(' (TupleTypeCS::ownedParts+=TuplePartCS (',' TupleTypeCS::ownedParts+=TuplePartCS)[V2:*])[V1:?] ')')[V0:?] */,
				69 /* TypeExpCS-5: TupleTypeCS::name='Tuple' ('(' (TupleTypeCS::ownedParts+=TuplePartCS (',' TupleTypeCS::ownedParts+=TuplePartCS)[V2:*])[V1:?] ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V3:?] */,
				74 /* TypeLiteralWithMultiplicityCS-3: TupleTypeCS::name='Tuple' ('(' (TupleTypeCS::ownedParts+=TuplePartCS (',' TupleTypeCS::ownedParts+=TuplePartCS)[V2:*])[V1:?] ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V3:?] */,
				145 /* TypedMultiplicityRefCS-6: TupleTypeCS::name='Tuple' ('(' (TupleTypeCS::ownedParts+=TuplePartCS (',' TupleTypeCS::ownedParts+=TuplePartCS)[V2:*])[V1:?] ')')[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V3:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(BaseCSPackage.Literals.TYPED_REF_CS__OWNED_MULTIPLICITY,
					19) /* MultiplicityCS */,
		...
		eClassValues[61] = new EClassValue(EssentialOCLCSPackage.Literals.TYPE_LITERAL_EXP_CS,
			createSerializationRules(
				70 /* TypeLiteralExpCS-0: TypeLiteralExpCS::ownedType=TypeLiteralWithMultiplicityCS */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[62] = new EClassValue(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS,
			createSerializationRules(
				67 /* TypeExpCS-3: TypeNameExpCS::ownedPathName=PathNameCS (TypeNameExpCS::ownedCurlyBracketedClause=CurlyBracketedClauseCS ('{' TypeNameExpCS::ownedPatternGuard=ExpCS '}')[V1:?])[V0:?] (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V2:?] */,
				75 /* TypeNameExpCS-0: TypeNameExpCS::ownedPathName=PathNameCS (TypeNameExpCS::ownedCurlyBracketedClause=CurlyBracketedClauseCS ('{' TypeNameExpCS::ownedPatternGuard=ExpCS '}')[V1:?])[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[64] = new EClassValue(BaseCSPackage.Literals.TYPED_TYPE_REF_CS,
			createSerializationRules(
				148 /* TypedTypeRefCS-2: TypedTypeRefCS::ownedPathName=PathNameCS */,
				146 /* TypedTypeRefCS-0: TypedTypeRefCS::ownedPathName=PathNameCS '(' TypedTypeRefCS::ownedBinding=TemplateBindingCS ')' */,
				147 /* TypedTypeRefCS-1: TypedTypeRefCS::ownedPathName=PathNameCS '<' TypedTypeRefCS::ownedBinding=TemplateBindingCS '>' */,
				140 /* TypedMultiplicityRefCS-1: TypedTypeRefCS::ownedPathName=PathNameCS (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V0:?] */,
				141 /* TypedMultiplicityRefCS-2: TypedTypeRefCS::ownedPathName=PathNameCS '(' TypedTypeRefCS::ownedBinding=TemplateBindingCS ')' (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V0:?] */,
				142 /* TypedMultiplicityRefCS-3: TypedTypeRefCS::ownedPathName=PathNameCS '<' TypedTypeRefCS::ownedBinding=TemplateBindingCS '>' (TypedRefCS::ownedMultiplicity=MultiplicityCS)[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
		...
		eClassValues[65] = new EClassValue(EssentialOCLCSPackage.Literals.UNLIMITED_NATURAL_LITERAL_EXP_CS,
			createSerializationRules(
				79 /* UnlimitedNaturalLiteralExpCS-0: '*' */
			), null
		);
		eClassValues[66] = new EClassValue(EssentialOCLCSPackage.Literals.VARIABLE_CS,
			createSerializationRules(
				16 /* CoIteratorVariableCS-0: NamedElementCS::name=UnrestrictedName (':' VariableCS::ownedType=TypeExpCS)[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
				createEReference_TargetGrammarRuleVector(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_TYPE,
					51) /* TypeExpCS */
		...
		eClassValues[67] = new EClassValue(BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS,
			createSerializationRules(
				14 /* WildcardTypeRefCS-0: '?' ('extends' WildcardTypeRefCS::ownedExtends=TypedRefCS)[V0:?] */
			),
			new @NonNull EReference_TargetGrammarRuleVector [] {
	...
	private void initGrammarRuleValues() {
		...
		grammarRuleValues[30] = createParserRuleValue(30, "ExpCS", 68 /* BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				15	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				17	/* CollectionLiteralExpCS-0: CollectionLiteralExpCS::ownedType=CollectionTypeCS '{' (CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS (',' CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS)[V1:*])[V0:?] '}' */,
				24	/* ExpCS-18: InfixExpCS::ownedLeft=PrefixedPrimaryExpCS NamedElementCS::name=BinaryOperatorName OperatorExpCS::ownedRight=ExpCS */,
		...
		grammarRuleValues[61] = createParserRuleValue(61, "NavigatingArgExpCS", 69 /* BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				15	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				17	/* CollectionLiteralExpCS-0: CollectionLiteralExpCS::ownedType=CollectionTypeCS '{' (CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS (',' CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS)[V1:*])[V0:?] '}' */,
				24	/* ExpCS-18: InfixExpCS::ownedLeft=PrefixedPrimaryExpCS NamedElementCS::name=BinaryOperatorName OperatorExpCS::ownedRight=ExpCS */,
		...
		grammarRuleValues[78] = createParserRuleValue(78, "PrefixedPrimaryExpCS", 66 /* BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				15	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				17	/* CollectionLiteralExpCS-0: CollectionLiteralExpCS::ownedType=CollectionTypeCS '{' (CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS (',' CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS)[V1:*])[V0:?] '}' */,
				25	/* IfExpCS-0: 'if' IfExpCS::ownedCondition=ExpCS|PatternExpCS 'then' IfExpCS::ownedThenExpression=ExpCS (IfExpCS::ownedIfThenExpressions+=ElseIfThenExpCS)[V0:*] 'else' IfExpCS::ownedElseExpression=ExpCS 'endif' */,
		...
		grammarRuleValues[80] = createParserRuleValue(80, "PrimitiveLiteralExpCS", 64 /* BooleanLiteralExpCS|InvalidLiteralExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrimitiveLiteralExpCS|StringLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			createSerializationRules(
				15	/* BooleanLiteralExpCS-0: BooleanLiteralExpCS::symbol='false|true' */,
				26	/* InvalidLiteralExpCS-0: 'invalid' */,
				47	/* NullLiteralExpCS-0: 'null' */,
		...
		grammarRuleValues[108] = createParserRuleValue(108, "TypeExpWithoutMultiplicityCS", 55 /* CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
			createSerializationRules(
				20	/* CollectionPatternCS-0: CollectionPatternCS::ownedType=CollectionTypeCS '{' (CollectionPatternCS::ownedParts+=PatternExpCS (',' CollectionPatternCS::ownedParts+=PatternExpCS)[V1:*] '++' CollectionPatternCS::restVariableName=Identifier)[V0:?] '}' */,
				21	/* CollectionTypeCS-0: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] */,
				32	/* MapTypeCS-0: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] */,
		...
		grammarRuleValues[115] = createParserRuleValue(115, "TypeRefCS", 72 /* CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS */,
			createSerializationRules(
				21	/* CollectionTypeCS-0: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] */,
				32	/* MapTypeCS-0: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] */,
				52	/* PrimitiveTypeCS-0: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier */,
		...
		grammarRuleValues[117] = createParserRuleValue(117, "TypedRefCS", 60 /* CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS */,
			createSerializationRules(
				21	/* CollectionTypeCS-0: CollectionTypeCS::name=CollectionTypeIdentifier ('(' CollectionTypeCS::ownedType=TypeExpWithoutMultiplicityCS (CollectionTypeCS::ownedCollectionMultiplicity=MultiplicityCS)[V1:?] ')')[V0:?] */,
				32	/* MapTypeCS-0: MapTypeCS::name='Map' ('(' MapTypeCS::ownedKeyType=TypeExpCS ',' MapTypeCS::ownedValueType=TypeExpCS ')')[V0:?] */,
				52	/* PrimitiveTypeCS-0: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier */,
	...
	private void initGrammarRuleVectors() {
		...
		// 36: ML_SINGLE_QUOTED_STRING|SINGLE_QUOTED_STRING
		...
		// 53: CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS
		...
		// 55: CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS
		grammarRuleVectors[55] = new GrammarRuleVector(0x8000000000c00L,0x2540000020000L);
		// 56: TypeParameterCS
		grammarRuleVectors[56] = new GrammarRuleVector(0x0L,0x4000000000000L);
		// 57: TypeRefCS
		...
		// 59: TypedRefCS
		grammarRuleVectors[59] = new GrammarRuleVector(0x0L,0x20000000000000L);
		// 60: CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS
		grammarRuleVectors[60] = new GrammarRuleVector(0x8000000000800L,0x60440000020000L);
		// 61: NextPathElementCS|URIFirstPathElementCS
		grammarRuleVectors[61] = new GrammarRuleVector(0x0L,0x400000000000008L);
		// 62: FirstPathElementCS|NextPathElementCS|URIFirstPathElementCS
		grammarRuleVectors[62] = new GrammarRuleVector(0x80000000L,0x400000000000008L);
		// 63: URIPathNameCS
		grammarRuleVectors[63] = new GrammarRuleVector(0x0L,0x800000000000000L);
		// 64: BooleanLiteralExpCS|InvalidLiteralExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrimitiveLiteralExpCS|StringLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[64] = new GrammarRuleVector(0x10000000020L,0x2000000080010030L);
		// 65: BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[65] = new GrammarRuleVector(0x802111000000120L,0x2000808082018034L);
		// 66: BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[66] = new GrammarRuleVector(0x802111000000120L,0x200080808201c034L);
		// 67: BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[67] = new GrammarRuleVector(0x802311000000120L,0x200080808201e034L);
		// 68: BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[68] = new GrammarRuleVector(0x802311040000120L,0x200080808201e034L);
		// 69: BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[69] = new GrammarRuleVector(0x2802311040000120L,0x200080808201e034L);
		// 70: BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS
		grammarRuleVectors[70] = new GrammarRuleVector(0x802311040000120L,0x200080808201e434L);
		// 71: SINGLE_QUOTED_STRING|UnrestrictedName
		grammarRuleVectors[71] = new GrammarRuleVector(0x0L,0x8000000000800000L);
		// 72: CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS
		grammarRuleVectors[72] = new GrammarRuleVector(0x8000000000800L,0x68440000020000L,0x2L);
	}
	...
	private void initMatchSteps() {
		...
		serializationMatchSteps[108] = createMatchStep_Assign(0, 216);
		// 109: assign V0 = (|TemplateBindingCS::ownedSubstitutions| - 1)
		serializationMatchSteps[109] = createMatchStep_Assign(0, 221);
		// 110: assign V0 = (|TemplateSignatureCS::ownedParameters| - 1)
		serializationMatchSteps[110] = createMatchStep_Assign(0, 223);
		// 111: assign V0 = (|TupleLiteralExpCS::ownedParts| - 1)
		serializationMatchSteps[111] = createMatchStep_Assign(0, 224);
		// 112: assign V0 = (|TupleTypeCS::ownedParts| > 0)
		serializationMatchSteps[112] = createMatchStep_Assign(0, 227);
		// 113: assign V0 = (|TypeParameterCS::ownedExtends| > 0)
		serializationMatchSteps[113] = createMatchStep_Assign(0, 231);
		// 114: assign V0 = (|TypedElementCS::qualifiers.'!ordered|!unique|ordered|unique'| > 0)
		serializationMatchSteps[114] = createMatchStep_Assign(0, 236);
		// 115: assign V0 = 0
		...
		serializationMatchSteps[141] = createMatchStep_Assign(0, 135);
		// 142: assign V0 = |TypedElementCS::qualifiers.'definition'|
		serializationMatchSteps[142] = createMatchStep_Assign(0, 140);
		// 143: assign V0 = |TypedElementCS::qualifiers.'static'|
		serializationMatchSteps[143] = createMatchStep_Assign(0, 141);
		// 144: assign V0 = |TypedRefCS::ownedMultiplicity|
		serializationMatchSteps[144] = createMatchStep_Assign(0, 143);
		// 145: assign V0 = |VariableCS::ownedType|
		serializationMatchSteps[145] = createMatchStep_Assign(0, 148);
		// 146: assign V0 = |WildcardTypeRefCS::ownedExtends|
		serializationMatchSteps[146] = createMatchStep_Assign(0, 149);
		// 147: assign V1 = (|AnnotationElementCS::ownedDetails| > 0)
		serializationMatchSteps[147] = createMatchStep_Assign(1, 153);
		// 148: assign V1 = (|CollectionLiteralExpCS::ownedParts| - 1)
		serializationMatchSteps[148] = createMatchStep_Assign(1, 155);
		// 149: assign V1 = (|CollectionPatternCS::ownedParts| - 1)
		serializationMatchSteps[149] = createMatchStep_Assign(1, 159);
		// 150: assign V1 = (|CurlyBracketedClauseCS::ownedParts| - 1)
		serializationMatchSteps[150] = createMatchStep_Assign(1, 166);
		// 151: assign V1 = (|MapLiteralExpCS::ownedParts| - 1)
		serializationMatchSteps[151] = createMatchStep_Assign(1, 179);
		// 152: assign V1 = (|OperationCS::ownedParameters| > 0)
		serializationMatchSteps[152] = createMatchStep_Assign(1, 205);
		// 153: assign V1 = (|TupleTypeCS::ownedParts| > 0)
		serializationMatchSteps[153] = createMatchStep_Assign(1, 227);
		// 154: assign V1 = (|TypeParameterCS::ownedExtends| - 1)
		serializationMatchSteps[154] = createMatchStep_Assign(1, 230);
		// 155: assign V1 = (|TypedElementCS::qualifiers.'!ordered|!unique|ordered|unique'| > 0)
		serializationMatchSteps[155] = createMatchStep_Assign(1, 236);
		...
		serializationMatchSteps[172] = createMatchStep_Assign(1, 135);
		// 173: assign V1 = |TypedElementCS::qualifiers.'!ordered|!unique|ordered|unique'|
		serializationMatchSteps[173] = createMatchStep_Assign(1, 139);
		// 174: assign V1 = |TypedRefCS::ownedMultiplicity|
		serializationMatchSteps[174] = createMatchStep_Assign(1, 143);
		// 175: assign V1 = |VariableCS::ownedType|
		serializationMatchSteps[175] = createMatchStep_Assign(1, 148);
		// 176: assign V10 = (|ReferenceCS::referredKeys| - 1)
		serializationMatchSteps[176] = createMatchStep_Assign(10, 211);
		// 177: assign V10 = (|ReferenceCS::referredKeys| > 0)
		serializationMatchSteps[177] = createMatchStep_Assign(10, 212);
		...
		serializationMatchSteps[181] = createMatchStep_Assign(11, 211);
		...
		serializationMatchSteps[191] = createMatchStep_Assign(2, 152);
		// 192: assign V2 = (|OperationCS::ownedParameters| - 1)
		serializationMatchSteps[192] = createMatchStep_Assign(2, 204);
		// 193: assign V2 = (|OperationCS::ownedParameters| > 0)
		serializationMatchSteps[193] = createMatchStep_Assign(2, 205);
		// 194: assign V2 = (|StructuredClassCS::ownedSuperTypes| > 0)
		serializationMatchSteps[194] = createMatchStep_Assign(2, 220);
		// 195: assign V2 = (|TupleTypeCS::ownedParts| - 1)
		serializationMatchSteps[195] = createMatchStep_Assign(2, 226);
		...
		serializationMatchSteps[196] = createMatchStep_Assign(2, 234);
		// 197: assign V2 = 0
		...
		serializationMatchSteps[206] = createMatchStep_Assign(2, 135);
		// 207: assign V2 = |TypedElementCS::qualifiers.'!ordered|!unique|ordered|unique'|
		serializationMatchSteps[207] = createMatchStep_Assign(2, 139);
		// 208: assign V2 = |TypedRefCS::ownedMultiplicity|
		serializationMatchSteps[208] = createMatchStep_Assign(2, 143);
		// 209: assign V3 = (|ModelElementCS::ownedAnnotations| > 0)
		serializationMatchSteps[209] = createMatchStep_Assign(3, 186);
		// 210: assign V3 = (|OperationCS::ownedParameters| - 1)
		serializationMatchSteps[210] = createMatchStep_Assign(3, 204);
		// 211: assign V3 = (|StructuredClassCS::ownedSuperTypes| - 1)
		serializationMatchSteps[211] = createMatchStep_Assign(3, 219);
		...
		serializationMatchSteps[212] = createMatchStep_Assign(3, 233);
		...
		serializationMatchSteps[213] = createMatchStep_Assign(3, 234);
		// 214: assign V3 = 0
		...
		serializationMatchSteps[221] = createMatchStep_Assign(3, 135);
		...
		serializationMatchSteps[222] = createMatchStep_Assign(3, 137);
		// 223: assign V3 = |TypedRefCS::ownedMultiplicity|
		serializationMatchSteps[223] = createMatchStep_Assign(3, 143);
		// 224: assign V4 = (|OperationCS::ownedExceptions| > 0)
		serializationMatchSteps[224] = createMatchStep_Assign(4, 203);
		...
		serializationMatchSteps[225] = createMatchStep_Assign(4, 233);
		...
		serializationMatchSteps[232] = createMatchStep_Assign(4, 135);
		...
		serializationMatchSteps[233] = createMatchStep_Assign(4, 136);
		...
		serializationMatchSteps[234] = createMatchStep_Assign(4, 137);
		// 235: assign V5 = (|OperationCS::ownedExceptions| - 1)
		serializationMatchSteps[235] = createMatchStep_Assign(5, 202);
		// 236: assign V5 = (|OperationCS::ownedExceptions| > 0)
		serializationMatchSteps[236] = createMatchStep_Assign(5, 203);
		// 237: assign V5 = (|StructuralFeatureCS::ownedDefaultExpressions| > 0)
		serializationMatchSteps[237] = createMatchStep_Assign(5, 217);
		// 238: assign V5 = (|StructuredClassCS::isInterface.'interface'| > 0)
		serializationMatchSteps[238] = createMatchStep_Assign(5, 218);
		...
		serializationMatchSteps[242] = createMatchStep_Assign(5, 136);
		// 243: assign V6 = (|OperationCS::ownedExceptions| - 1)
		serializationMatchSteps[243] = createMatchStep_Assign(6, 202);
		// 244: assign V6 = (|StructuralFeatureCS::ownedDefaultExpressions| > 0)
		serializationMatchSteps[244] = createMatchStep_Assign(6, 217);
		// 245: assign V6 = (|TypedElementCS::qualifiers.'!derived|!ordered|!transient|!unique|derived|ordered|transient|unique'| > 0)
		serializationMatchSteps[245] = createMatchStep_Assign(6, 235);
		// 246: assign V6 = 0
		...
		serializationMatchSteps[249] = createMatchStep_Assign(7, 217);
		// 250: assign V7 = (|TypedElementCS::qualifiers.'!derived|!ordered|!transient|!unique|derived|ordered|transient|unique'| > 0)
		serializationMatchSteps[250] = createMatchStep_Assign(7, 235);
		// 251: assign V7 = 0
		...
		serializationMatchSteps[253] = createMatchStep_Assign(7, 138);
		// 254: assign V8 = (|OperationCS::ownedBodyExpressions| > 0)
		serializationMatchSteps[254] = createMatchStep_Assign(8, 201);
		// 255: assign V8 = 0
		...
		serializationMatchSteps[258] = createMatchStep_Assign(8, 138);
		// 259: assign V9 = (|OperationCS::ownedBodyExpressions| > 0)
		serializationMatchSteps[259] = createMatchStep_Assign(9, 201);
		// 260: assign V9 = (|ReferenceCS::referredKeys| > 0)
		serializationMatchSteps[260] = createMatchStep_Assign(9, 212);
		// 261: assign V9 = 0
		...
		serializationMatchSteps[265] = createMatchStep_RuleCheck(BaseCSPackage.Literals.ANNOTATION_CS__OWNED_CONTENTS, 44/*AttributeCS|ClassCS|DataTypeCS|EnumerationCS|EnumerationLiteralCS|ModelElementCS|OperationCS|PackageCS|ReferenceCS|StructuralFeatureCS|StructuredClassCS*/);
		...
		serializationMatchSteps[269] = createMatchStep_RuleCheck(BaseCSPackage.Literals.CONSTRAINT_CS__OWNED_MESSAGE_SPECIFICATION, 38/*SpecificationCS*/);
		// 270: check-rule basecs::ConstraintCS.ownedSpecification : 92
		serializationMatchSteps[270] = createMatchStep_RuleCheck(BaseCSPackage.Literals.CONSTRAINT_CS__OWNED_SPECIFICATION, 38/*SpecificationCS*/);
		...
		serializationMatchSteps[272] = createMatchStep_RuleCheck(BaseCSPackage.Literals.IMPORT_CS__OWNED_PATH_NAME, 63/*URIPathNameCS*/);
		// 273: check-rule basecs::ModelElementCS.ownedAnnotations : 1|2|17|98
		serializationMatchSteps[273] = createMatchStep_RuleCheck(BaseCSPackage.Literals.MODEL_ELEMENT_CS__OWNED_ANNOTATIONS, 45/*AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS*/);
		// 274: check-rule basecs::ModelElementRefCS.ownedPathName : 73
		serializationMatchSteps[274] = createMatchStep_RuleCheck(BaseCSPackage.Literals.MODEL_ELEMENT_REF_CS__OWNED_PATH_NAME, 27/*PathNameCS*/);
		// 275: check-rule basecs::OperationCS.ownedBodyExpressions : 92
		serializationMatchSteps[275] = createMatchStep_RuleCheck(BaseCSPackage.Literals.OPERATION_CS__OWNED_BODY_EXPRESSIONS, 38/*SpecificationCS*/);
		// 276: check-rule basecs::OperationCS.ownedExceptions : 11|51|81|106|110|117|118
		serializationMatchSteps[276] = createMatchStep_RuleCheck(BaseCSPackage.Literals.OPERATION_CS__OWNED_EXCEPTIONS, 60/*CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS*/);
		// 277: check-rule basecs::OperationCS.ownedParameters : 72
		serializationMatchSteps[277] = createMatchStep_RuleCheck(BaseCSPackage.Literals.OPERATION_CS__OWNED_PARAMETERS, 26/*ParameterCS*/);
		// 278: check-rule basecs::OperationCS.ownedPostconditions : 75
		serializationMatchSteps[278] = createMatchStep_RuleCheck(BaseCSPackage.Literals.OPERATION_CS__OWNED_POSTCONDITIONS, 30/*PostconditionConstraintCS*/);
		// 279: check-rule basecs::OperationCS.ownedPreconditions : 76
		serializationMatchSteps[279] = createMatchStep_RuleCheck(BaseCSPackage.Literals.OPERATION_CS__OWNED_PRECONDITIONS, 31/*PreconditionConstraintCS*/);
		// 280: check-rule basecs::PackageCS.ownedClasses : 6|15|21|97
		serializationMatchSteps[280] = createMatchStep_RuleCheck(BaseCSPackage.Literals.PACKAGE_CS__OWNED_CLASSES, 43/*ClassCS|DataTypeCS|EnumerationCS|StructuredClassCS*/);
		// 281: check-rule basecs::PackageOwnerCS.ownedPackages : 71
		serializationMatchSteps[281] = createMatchStep_RuleCheck(BaseCSPackage.Literals.PACKAGE_OWNER_CS__OWNED_PACKAGES, 25/*PackageCS*/);
		...
		// 283: check-rule basecs::ReferenceCS.ownedImplicitOpposites : 37
		serializationMatchSteps[283] = createMatchStep_RuleCheck(BaseCSPackage.Literals.REFERENCE_CS__OWNED_IMPLICIT_OPPOSITES, 11/*ImplicitOppositeCS*/);
		// 284: check-rule basecs::RootCS.ownedImports : 38
		serializationMatchSteps[284] = createMatchStep_RuleCheck(BaseCSPackage.Literals.ROOT_CS__OWNED_IMPORTS, 12/*ImportCS*/);
		// 285: check-rule basecs::StructuralFeatureCS.ownedDefaultExpressions : 92
		serializationMatchSteps[285] = createMatchStep_RuleCheck(BaseCSPackage.Literals.STRUCTURAL_FEATURE_CS__OWNED_DEFAULT_EXPRESSIONS, 38/*SpecificationCS*/);
		// 286: check-rule basecs::StructuredClassCS.ownedOperations : 70
		serializationMatchSteps[286] = createMatchStep_RuleCheck(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__OWNED_OPERATIONS, 24/*OperationCS*/);
		// 287: check-rule basecs::StructuredClassCS.ownedProperties : 3|83|96
		serializationMatchSteps[287] = createMatchStep_RuleCheck(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__OWNED_PROPERTIES, 42/*AttributeCS|ReferenceCS|StructuralFeatureCS*/);
		// 288: check-rule basecs::StructuredClassCS.ownedSuperTypes : 11|51|81|106|110|117|118
		serializationMatchSteps[288] = createMatchStep_RuleCheck(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__OWNED_SUPER_TYPES, 60/*CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS*/);
		// 289: check-rule basecs::TemplateBindingCS.ownedMultiplicity : 56
		serializationMatchSteps[289] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_BINDING_CS__OWNED_MULTIPLICITY, 19/*MultiplicityCS*/);
		// 290: check-rule basecs::TemplateBindingCS.ownedSubstitutions : 100
		serializationMatchSteps[290] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_BINDING_CS__OWNED_SUBSTITUTIONS, 47/*TemplateParameterSubstitutionCS*/);
		// 291: check-rule basecs::TemplateParameterSubstitutionCS.ownedActualParameter : 11|51|81|106|110|115|117|118|129
		serializationMatchSteps[291] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS__OWNED_ACTUAL_PARAMETER, 72/*CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS*/);
		// 292: check-rule basecs::TemplateSignatureCS.ownedParameters : 114
		serializationMatchSteps[292] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATE_SIGNATURE_CS__OWNED_PARAMETERS, 56/*TypeParameterCS*/);
		// 293: check-rule basecs::TemplateableElementCS.ownedSignature : 101
		serializationMatchSteps[293] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TEMPLATEABLE_ELEMENT_CS__OWNED_SIGNATURE, 48/*TemplateSignatureCS*/);
		// 294: check-rule basecs::TupleTypeCS.ownedParts : 105
		serializationMatchSteps[294] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TUPLE_TYPE_CS__OWNED_PARTS, 50/*TuplePartCS*/);
		// 295: check-rule basecs::TypeParameterCS.ownedExtends : 11|51|81|106|110|117|118
		serializationMatchSteps[295] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPE_PARAMETER_CS__OWNED_EXTENDS, 60/*CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS*/);
		// 296: check-rule basecs::TypedElementCS.ownedType : 107
		serializationMatchSteps[296] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE, 51/*TypeExpCS*/);
		// 297: check-rule basecs::TypedElementCS.ownedType : 116
		serializationMatchSteps[297] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE, 58/*TypedMultiplicityRefCS*/);
		// 298: check-rule basecs::TypedRefCS.ownedMultiplicity : 56
		serializationMatchSteps[298] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_REF_CS__OWNED_MULTIPLICITY, 19/*MultiplicityCS*/);
		// 299: check-rule basecs::TypedTypeRefCS.ownedBinding : 99
		serializationMatchSteps[299] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__OWNED_BINDING, 46/*TemplateBindingCS*/);
		// 300: check-rule basecs::TypedTypeRefCS.ownedPathName : 73
		serializationMatchSteps[300] = createMatchStep_RuleCheck(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__OWNED_PATH_NAME, 27/*PathNameCS*/);
		// 301: check-rule basecs::WildcardTypeRefCS.ownedExtends : 11|51|81|106|110|117|118
		serializationMatchSteps[301] = createMatchStep_RuleCheck(BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS__OWNED_EXTENDS, 60/*CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS*/);
		// 302: check-rule essentialoclcs::AbstractNameExpCS.ownedCurlyBracketedClause : 13
		serializationMatchSteps[302] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_CURLY_BRACKETED_CLAUSE, 5/*CurlyBracketedClauseCS*/);
		// 303: check-rule essentialoclcs::AbstractNameExpCS.ownedPathName : 73
		serializationMatchSteps[303] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_PATH_NAME, 27/*PathNameCS*/);
		// 304: check-rule essentialoclcs::AbstractNameExpCS.ownedRoundBracketedClause : 84
		serializationMatchSteps[304] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_ROUND_BRACKETED_CLAUSE, 35/*RoundBracketedClauseCS*/);
		// 305: check-rule essentialoclcs::AbstractNameExpCS.ownedSquareBracketedClauses : 93
		serializationMatchSteps[305] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_SQUARE_BRACKETED_CLAUSES, 39/*SquareBracketedClauseCS*/);
		// 306: check-rule essentialoclcs::CollectionLiteralExpCS.ownedParts : 9
		serializationMatchSteps[306] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_EXP_CS__OWNED_PARTS, 3/*CollectionLiteralPartCS*/);
		// 307: check-rule essentialoclcs::CollectionLiteralExpCS.ownedType : 11
		serializationMatchSteps[307] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_EXP_CS__OWNED_TYPE, 4/*CollectionTypeCS*/);
		// 308: check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[308] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_EXPRESSION, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 309: check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : 74
		serializationMatchSteps[309] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_EXPRESSION, 28/*PatternExpCS*/);
		// 310: check-rule essentialoclcs::CollectionLiteralPartCS.ownedLastExpression : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[310] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_LITERAL_PART_CS__OWNED_LAST_EXPRESSION, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 311: check-rule essentialoclcs::CollectionPatternCS.ownedParts : 74
		serializationMatchSteps[311] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__OWNED_PARTS, 28/*PatternExpCS*/);
		// 312: check-rule essentialoclcs::CollectionPatternCS.ownedType : 11
		serializationMatchSteps[312] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__OWNED_TYPE, 4/*CollectionTypeCS*/);
		// 313: check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : 56
		serializationMatchSteps[313] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_COLLECTION_MULTIPLICITY, 19/*MultiplicityCS*/);
		// 314: check-rule essentialoclcs::CollectionTypeCS.ownedType : 10|11|51|81|106|108|110|113
		serializationMatchSteps[314] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_TYPE, 55/*CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS*/);
		// 315: check-rule essentialoclcs::ContextCS.ownedExpression : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[315] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.CONTEXT_CS__OWNED_EXPRESSION, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 316: check-rule essentialoclcs::CurlyBracketedClauseCS.ownedParts : 90
		serializationMatchSteps[316] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.CURLY_BRACKETED_CLAUSE_CS__OWNED_PARTS, 37/*ShadowPartCS*/);
		// 317: check-rule essentialoclcs::ExpSpecificationCS.ownedExpression : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[317] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.EXP_SPECIFICATION_CS__OWNED_EXPRESSION, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 318: check-rule essentialoclcs::IfExpCS.ownedCondition : 5|8|30|36|40|44|45|49|59|66|68|69|74|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[318] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_CONDITION, 70/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 319: check-rule essentialoclcs::IfExpCS.ownedElseExpression : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[319] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_ELSE_EXPRESSION, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 320: check-rule essentialoclcs::IfExpCS.ownedIfThenExpressions : 20
		serializationMatchSteps[320] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_IF_THEN_EXPRESSIONS, 7/*ElseIfThenExpCS*/);
		// 321: check-rule essentialoclcs::IfExpCS.ownedThenExpression : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[321] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_EXP_CS__OWNED_THEN_EXPRESSION, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 322: check-rule essentialoclcs::IfThenExpCS.ownedCondition : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[322] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_THEN_EXP_CS__OWNED_CONDITION, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 323: check-rule essentialoclcs::IfThenExpCS.ownedThenExpression : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[323] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.IF_THEN_EXP_CS__OWNED_THEN_EXPRESSION, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 324: check-rule essentialoclcs::InfixExpCS.ownedLeft : 5|8|36|40|44|49|59|66|68|69|78|79|80|89|95|103|111|125
		serializationMatchSteps[324] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.INFIX_EXP_CS__OWNED_LEFT, 66/*BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 325: check-rule essentialoclcs::LambdaLiteralExpCS.ownedExpressionCS : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[325] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LAMBDA_LITERAL_EXP_CS__OWNED_EXPRESSION_CS, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 326: check-rule essentialoclcs::LetExpCS.ownedInExpression : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[326] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LET_EXP_CS__OWNED_IN_EXPRESSION, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 327: check-rule essentialoclcs::LetExpCS.ownedVariables : 46
		serializationMatchSteps[327] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LET_EXP_CS__OWNED_VARIABLES, 14/*LetVariableCS*/);
		// 328: check-rule essentialoclcs::LetVariableCS.ownedRoundBracketedClause : 84
		serializationMatchSteps[328] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.LET_VARIABLE_CS__OWNED_ROUND_BRACKETED_CLAUSE, 35/*RoundBracketedClauseCS*/);
		// 329: check-rule essentialoclcs::MapLiteralExpCS.ownedParts : 50
		serializationMatchSteps[329] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_EXP_CS__OWNED_PARTS, 15/*MapLiteralPartCS*/);
		// 330: check-rule essentialoclcs::MapLiteralExpCS.ownedType : 51
		serializationMatchSteps[330] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_EXP_CS__OWNED_TYPE, 16/*MapTypeCS*/);
		// 331: check-rule essentialoclcs::MapLiteralPartCS.ownedKey : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[331] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_PART_CS__OWNED_KEY, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 332: check-rule essentialoclcs::MapLiteralPartCS.ownedValue : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[332] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_LITERAL_PART_CS__OWNED_VALUE, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 333: check-rule essentialoclcs::MapTypeCS.ownedKeyType : 107
		serializationMatchSteps[333] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_KEY_TYPE, 51/*TypeExpCS*/);
		// 334: check-rule essentialoclcs::MapTypeCS.ownedValueType : 107
		serializationMatchSteps[334] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_VALUE_TYPE, 51/*TypeExpCS*/);
		// 335: check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : 7
		serializationMatchSteps[335] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_CO_ITERATOR, 2/*CoIteratorVariableCS*/);
		// 336: check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[336] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_INIT_EXPRESSION, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 337: check-rule essentialoclcs::NavigatingArgCS.ownedNameExpression : 5|8|30|36|40|44|45|49|59|61|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[337] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_NAME_EXPRESSION, 69/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 338: check-rule essentialoclcs::NavigatingArgCS.ownedType : 107
		serializationMatchSteps[338] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_TYPE, 51/*TypeExpCS*/);
		// 339: check-rule essentialoclcs::NestedExpCS.ownedExpression : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[339] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.NESTED_EXP_CS__OWNED_EXPRESSION, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 340: check-rule essentialoclcs::OperatorExpCS.ownedRight : 45|77
		serializationMatchSteps[340] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 33/*LetExpCS|PrefixedLetExpCS*/);
		// 341: check-rule essentialoclcs::OperatorExpCS.ownedRight : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[341] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 342: check-rule essentialoclcs::OperatorExpCS.ownedRight : 5|8|36|40|44|49|59|66|68|69|78|79|80|89|95|103|111|125
		serializationMatchSteps[342] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 66/*BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 343: check-rule essentialoclcs::PatternExpCS.ownedPatternType : 107
		serializationMatchSteps[343] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS__OWNED_PATTERN_TYPE, 51/*TypeExpCS*/);
		// 344: check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : 5|8|30|36|40|44|45|49|59|66|68|69|74|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[344] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 70/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 345: check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : 95
		serializationMatchSteps[345] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 40/*StringLiteralExpCS*/);
		// 346: check-rule essentialoclcs::SquareBracketedClauseCS.ownedTerms : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[346] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.SQUARE_BRACKETED_CLAUSE_CS__OWNED_TERMS, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 347: check-rule essentialoclcs::TupleLiteralExpCS.ownedParts : 104
		serializationMatchSteps[347] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TUPLE_LITERAL_EXP_CS__OWNED_PARTS, 49/*TupleLiteralPartCS*/);
		// 348: check-rule essentialoclcs::TypeLiteralExpCS.ownedType : 112
		serializationMatchSteps[348] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_LITERAL_EXP_CS__OWNED_TYPE, 54/*TypeLiteralWithMultiplicityCS*/);
		// 349: check-rule essentialoclcs::TypeNameExpCS.ownedCurlyBracketedClause : 13
		serializationMatchSteps[349] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_CURLY_BRACKETED_CLAUSE, 5/*CurlyBracketedClauseCS*/);
		// 350: check-rule essentialoclcs::TypeNameExpCS.ownedPathName : 73
		serializationMatchSteps[350] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_PATH_NAME, 27/*PathNameCS*/);
		// 351: check-rule essentialoclcs::TypeNameExpCS.ownedPatternGuard : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[351] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.TYPE_NAME_EXP_CS__OWNED_PATTERN_GUARD, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 352: check-rule essentialoclcs::VariableCS.ownedInitExpression : 5|8|30|36|40|44|45|49|59|66|68|69|77|78|79|80|89|95|103|111|125
		serializationMatchSteps[352] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_INIT_EXPRESSION, 68/*BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS*/);
		// 353: check-rule essentialoclcs::VariableCS.ownedType : 107
		serializationMatchSteps[353] = createMatchStep_RuleCheck(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_TYPE, 51/*TypeExpCS*/);
	}
	...
	private void initSerializationRules0() {
		...
		serializationRules[0] = createSerializationRule("FirstPathElementCS-0", 31,
			...
			createSerializationSteps(
				276		/* PathElementCS::referredElement=UnrestrictedName || soft-space value soft-space */
			),
		...
		serializationRules[2] = createSerializationRule("MultiplicityCS-0", 56,
			...
			createSerializationSteps(
				140		/* '[' || no-space value no-space */,
				13		/* MultiplicityBoundsCS::lowerBound=LOWER || soft-space value soft-space */,
				182		/* V00*2-steps || value */,
				128		/* '..' || no-space value no-space */,
				116		/* MultiplicityBoundsCS::upperBound=UPPER || soft-space value soft-space */,
				176		/* '|?' || no-space value no-space */,
				141		/* ']' || no-space value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.MULTIPLICITY_BOUNDS_CS__LOWER_BOUND, true, GrammarCardinality.ONE),
		...
		serializationRules[9] = createSerializationRule("NextPathElementCS-0", 67,
			...
			createSerializationSteps(
				275		/* PathElementCS::referredElement=UnreservedName || soft-space value soft-space */
			),
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, -1
				)
		...
		serializationRules[10] = createSerializationRule("PathNameCS-0", 73,
			...
			createSerializationSteps(
				261		/* PathNameCS::ownedPathElements+=FirstPathElementCS || value */,
				183		/* V00*2-steps || value */,
				131		/* '::' || no-space value no-space */,
				262		/* PathNameCS::ownedPathElements+=NextPathElementCS || value */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[11] = createSerializationRule("TemplateBindingCS-0", 99,
			createSerializationMatchSteps(
				289		/* check-rule basecs::TemplateBindingCS.ownedMultiplicity : MultiplicityCS */,
				290		/* check-rule basecs::TemplateBindingCS.ownedSubstitutions : TemplateParameterSubstitutionCS */,
				169		/* assign V1 = |TemplateBindingCS::ownedMultiplicity| */,
				109		/* assign V0 = (|TemplateBindingCS::ownedSubstitutions| - 1) */
			),
			createSerializationSteps(
				...
				183		/* V00*2-steps || value */,
				127		/* ',' || no-space value soft-space */,
				89		/* TemplateBindingCS::ownedSubstitutions+=TemplateParameterSubstitutionCS || value */,
				189		/* V01*1-steps || value */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.TEMPLATE_BINDING_CS__OWNED_SUBSTITUTIONS, 47/* TemplateParameterSubstitutionCS */,
		...
		serializationRules[12] = createSerializationRule("TemplateParameterSubstitutionCS-0", 100,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				291		/* check-rule basecs::TemplateParameterSubstitutionCS.ownedActualParameter : CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypeRefCS|TypedRefCS|TypedTypeRefCS|WildcardTypeRefCS */,
				48		/* assert (|TemplateParameterSubstitutionCS::ownedActualParameter| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION_CS__OWNED_ACTUAL_PARAMETER, 57/* TypeRefCS */,
					(115/*TypeRefCS*/ << 4) | 0 /*[1]*/
				)
			});
		...
		serializationRules[13] = createSerializationRule("TypeParameterCS-0", 114,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				295		/* check-rule basecs::TypeParameterCS.ownedExtends : CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS */,
				30		/* assert (|NamedElementCS::name| - 1) == 0 */,
				113		/* assign V0 = (|TypeParameterCS::ownedExtends| > 0) */,
				154		/* assign V1 = (|TypeParameterCS::ownedExtends| - 1) */
			),
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				186		/* V00*5-steps || value */,
				153		/* 'extends' || soft-space value soft-space */,
				43		/* TypeParameterCS::ownedExtends+=TypedRefCS || value */,
				193		/* V01*2-steps || value */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.TYPE_PARAMETER_CS__OWNED_EXTENDS, 59/* TypedRefCS */,
					(117/*TypedRefCS*/ << 4) | 2 /*[*]*/
				)
			});
		// Base::WildcardTypeRefCS-0(basecs::WildcardTypeRefCS): { "?" { "extends" ownedExtends=TypedRefCS }[?] }
		serializationRules[14] = createSerializationRule("WildcardTypeRefCS-0", 129,
			createSerializationMatchSteps(
				103		/* assert |WildcardTypeRefCS::ownedSuper| == 0 */,
				301		/* check-rule basecs::WildcardTypeRefCS.ownedExtends : CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS */,
				146		/* assign V0 = |WildcardTypeRefCS::ownedExtends| */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.WILDCARD_TYPE_REF_CS__OWNED_EXTENDS, 59/* TypedRefCS */,
					(117/*TypedRefCS*/ << 4) | 1 /*[?]*/
				)
			});
		// EssentialOCL::BooleanLiteralExpCS-0(essentialoclcs::BooleanLiteralExpCS): symbol={'false|true'}
		serializationRules[15] = createSerializationRule("BooleanLiteralExpCS-0", 5,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				2		/* assert (|BooleanLiteralExpCS::symbol.'false|true'| - 1) == 0 */
			),
		...
		serializationRules[16] = createSerializationRule("CoIteratorVariableCS-0", 7,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				102		/* assert |VariableCS::ownedInitExpression| == 0 */,
				353		/* check-rule essentialoclcs::VariableCS.ownedType : TypeExpCS */,
				145		/* assign V0 = |VariableCS::ownedType| */,
				30		/* assert (|NamedElementCS::name| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(EssentialOCLCSPackage.Literals.VARIABLE_CS__OWNED_TYPE, 51/* TypeExpCS */,
					(107/*TypeExpCS*/ << 4) | 1 /*[?]*/
				)
			});
		...
		serializationRules[17] = createSerializationRule("CollectionLiteralExpCS-0", 8,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				306		/* check-rule essentialoclcs::CollectionLiteralExpCS.ownedParts : CollectionLiteralPartCS */,
				307		/* check-rule essentialoclcs::CollectionLiteralExpCS.ownedType : CollectionTypeCS */,
				3		/* assert (|CollectionLiteralExpCS::ownedType| - 1) == 0 */,
				104		/* assign V0 = (|CollectionLiteralExpCS::ownedParts| > 0) */,
				148		/* assign V1 = (|CollectionLiteralExpCS::ownedParts| - 1) */
			),
			createSerializationSteps(
				...
				175		/* '{' || soft-space value push soft-new-line */,
				185		/* V00*4-steps || value */,
				67		/* CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS || value */,
				193		/* V01*2-steps || value */,
				127		/* ',' || no-space value soft-space */,
				67		/* CollectionLiteralExpCS::ownedParts+=CollectionLiteralPartCS || value */,
				178		/* '}' || pop soft-space value soft-new-line */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[18] = createSerializationRule("CollectionLiteralPartCS-0", 9,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				308		/* check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				310		/* check-rule essentialoclcs::CollectionLiteralPartCS.ownedLastExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				118		/* assign V0 = |CollectionLiteralPartCS::ownedLastExpression| */,
				4		/* assert (|CollectionLiteralPartCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[19] = createSerializationRule("CollectionLiteralPartCS-1", 9,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				61		/* assert |CollectionLiteralPartCS::ownedLastExpression| == 0 */,
				309		/* check-rule essentialoclcs::CollectionLiteralPartCS.ownedExpression : PatternExpCS */,
				4		/* assert (|CollectionLiteralPartCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[20] = createSerializationRule("CollectionPatternCS-0", 10,
			createSerializationMatchSteps(
				99		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				62		/* assert |CollectionPatternCS::ownedPatternGuard| == 0 */,
				311		/* check-rule essentialoclcs::CollectionPatternCS.ownedParts : PatternExpCS */,
				312		/* check-rule essentialoclcs::CollectionPatternCS.ownedType : CollectionTypeCS */,
				119		/* assign V0 = |CollectionPatternCS::restVariableName| */,
				149		/* assign V1 = (|CollectionPatternCS::ownedParts| - 1) */,
				5		/* assert (|CollectionPatternCS::ownedType| - 1) == 0 */
			),
			createSerializationSteps(
				...
				175		/* '{' || soft-space value push soft-new-line */,
				187		/* V00*6-steps || value */,
				68		/* CollectionPatternCS::ownedParts+=PatternExpCS || value */,
				193		/* V01*2-steps || value */,
				127		/* ',' || no-space value soft-space */,
				68		/* CollectionPatternCS::ownedParts+=PatternExpCS || value */,
				126		/* '++' || soft-space value soft-space */,
		...
		serializationRules[21] = createSerializationRule("CollectionTypeCS-0", 11,
			createSerializationMatchSteps(
				99		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				313		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				314		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
				120		/* assign V0 = |CollectionTypeCS::ownedType| */,
				6		/* assert (|CollectionTypeCS::name| - 1) == 0 */,
				158		/* assign V1 = |CollectionTypeCS::ownedCollectionMultiplicity| */
			),
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__OWNED_TYPE, 52/* TypeExpWithoutMultiplicityCS */,
		...
		serializationRules[22] = createSerializationRule("CurlyBracketedClauseCS-0", 13,
			createSerializationMatchSteps(
				64		/* assert |CurlyBracketedClauseCS::value| == 0 */,
				316		/* check-rule essentialoclcs::CurlyBracketedClauseCS.ownedParts : ShadowPartCS */,
				105		/* assign V0 = (|CurlyBracketedClauseCS::ownedParts| > 0) */,
				150		/* assign V1 = (|CurlyBracketedClauseCS::ownedParts| - 1) */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.CURLY_BRACKETED_CLAUSE_CS__OWNED_PARTS, 37/* ShadowPartCS */,
					(90/*ShadowPartCS*/ << 4) | 2 /*[*]*/
				)
			});
		// EssentialOCL::ElseIfThenExpCS-0(essentialoclcs::IfThenExpCS): { "elseif" ownedCondition=ExpCS "then" ownedThenExpression=ExpCS }
		serializationRules[23] = createSerializationRule("ElseIfThenExpCS-0", 20,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				322		/* check-rule essentialoclcs::IfThenExpCS.ownedCondition : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				323		/* check-rule essentialoclcs::IfThenExpCS.ownedThenExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				16		/* assert (|IfThenExpCS::ownedThenExpression| - 1) == 0 */,
				15		/* assert (|IfThenExpCS::ownedCondition| - 1) == 0 */
			),
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				150		/* 'elseif' || soft-space value soft-space */,
				28		/* IfThenExpCS::ownedCondition=ExpCS || value */,
				172		/* 'then' || soft-space value soft-space */,
		...
		serializationRules[24] = createSerializationRule("ExpCS-18", 30,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				324		/* check-rule essentialoclcs::InfixExpCS.ownedLeft : BooleanLiteralExpCS|CollectionLiteralExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				341		/* check-rule essentialoclcs::OperatorExpCS.ownedRight : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				40		/* assert (|OperatorExpCS::ownedRight| - 1) == 0 */,
				30		/* assert (|NamedElementCS::name| - 1) == 0 */,
				18		/* assert (|InfixExpCS::ownedLeft| - 1) == 0 */
			),
			createSerializationSteps(
				...
				257		/* NamedElementCS::name=BinaryOperatorName || soft-space value soft-space */,
				263		/* OperatorExpCS::ownedRight=ExpCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
		...
		serializationRules[25] = createSerializationRule("IfExpCS-0", 36,
			createSerializationMatchSteps(
				69		/* assert |IfExpCS::isImplicit| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				318		/* check-rule essentialoclcs::IfExpCS.ownedCondition : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				319		/* check-rule essentialoclcs::IfExpCS.ownedElseExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				320		/* check-rule essentialoclcs::IfExpCS.ownedIfThenExpressions : ElseIfThenExpCS */,
				321		/* check-rule essentialoclcs::IfExpCS.ownedThenExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				13		/* assert (|IfExpCS::ownedElseExpression| - 1) == 0 */,
				125		/* assign V0 = |IfExpCS::ownedIfThenExpressions| */,
				14		/* assert (|IfExpCS::ownedThenExpression| - 1) == 0 */,
				12		/* assert (|IfExpCS::ownedCondition| - 1) == 0 */
		...
		serializationRules[26] = createSerializationRule("InvalidLiteralExpCS-0", 40,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				158		/* 'invalid' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		// EssentialOCL::LambdaLiteralExpCS-0(essentialoclcs::LambdaLiteralExpCS): { "Lambda" "{" ownedExpressionCS=ExpCS "}" }
		serializationRules[27] = createSerializationRule("LambdaLiteralExpCS-0", 44,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				325		/* check-rule essentialoclcs::LambdaLiteralExpCS.ownedExpressionCS : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				19		/* assert (|LambdaLiteralExpCS::ownedExpressionCS| - 1) == 0 */
			),
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				138		/* 'Lambda' || soft-space value soft-space */,
				175		/* '{' || soft-space value push soft-new-line */,
		...
		serializationRules[28] = createSerializationRule("LetExpCS-0", 45,
			createSerializationMatchSteps(
				70		/* assert |LetExpCS::isImplicit| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				326		/* check-rule essentialoclcs::LetExpCS.ownedInExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				327		/* check-rule essentialoclcs::LetExpCS.ownedVariables : LetVariableCS */,
				20		/* assert (|LetExpCS::ownedInExpression| - 1) == 0 */,
				106		/* assign V0 = (|LetExpCS::ownedVariables| - 1) */
			),
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				160		/* 'let' || soft-space value soft-space */,
				103		/* LetExpCS::ownedVariables+=LetVariableCS || value */,
				183		/* V00*2-steps || value */,
				127		/* ',' || no-space value soft-space */,
				103		/* LetExpCS::ownedVariables+=LetVariableCS || value */,
				156		/* 'in' || soft-space value soft-space */,
		...
		serializationRules[29] = createSerializationRule("LetVariableCS-0", 46,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				352		/* check-rule essentialoclcs::VariableCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				328		/* check-rule essentialoclcs::LetVariableCS.ownedRoundBracketedClause : RoundBracketedClauseCS */,
				353		/* check-rule essentialoclcs::VariableCS.ownedType : TypeExpCS */,
				57		/* assert (|VariableCS::ownedInitExpression| - 1) == 0 */,
				175		/* assign V1 = |VariableCS::ownedType| */,
				126		/* assign V0 = |LetVariableCS::ownedRoundBracketedClause| */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.LET_VARIABLE_CS__OWNED_ROUND_BRACKETED_CLAUSE, 35/* RoundBracketedClauseCS */,
		...
		serializationRules[30] = createSerializationRule("MapLiteralExpCS-0", 49,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				329		/* check-rule essentialoclcs::MapLiteralExpCS.ownedParts : MapLiteralPartCS */,
				330		/* check-rule essentialoclcs::MapLiteralExpCS.ownedType : MapTypeCS */,
				21		/* assert (|MapLiteralExpCS::ownedType| - 1) == 0 */,
				107		/* assign V0 = (|MapLiteralExpCS::ownedParts| > 0) */,
				151		/* assign V1 = (|MapLiteralExpCS::ownedParts| - 1) */
			),
		...
		serializationRules[31] = createSerializationRule("MapLiteralPartCS-0", 50,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				331		/* check-rule essentialoclcs::MapLiteralPartCS.ownedKey : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				332		/* check-rule essentialoclcs::MapLiteralPartCS.ownedValue : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				23		/* assert (|MapLiteralPartCS::ownedValue| - 1) == 0 */,
				22		/* assert (|MapLiteralPartCS::ownedKey| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[32] = createSerializationRule("MapTypeCS-0", 51,
			createSerializationMatchSteps(
				99		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				333		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				334		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
				127		/* assign V0 = |MapTypeCS::ownedValueType| */,
				25		/* assert (|MapTypeCS::ownedKeyType| - V0) == 0 */,
				24		/* assert (|MapTypeCS::name.'Map'| - 1) == 0 */
			),
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_KEY_TYPE, 51/* TypeExpCS */,
					(107/*TypeExpCS*/ << 4) | 1 /*[?]*/
				),
				createSerializationReference(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__OWNED_VALUE_TYPE, 51/* TypeExpCS */,
					(107/*TypeExpCS*/ << 4) | 1 /*[?]*/
				)
			});
		// EssentialOCL::Model-0(essentialoclcs::ContextCS): ownedExpression=ExpCS
		serializationRules[33] = createSerializationRule("Model-0", 52,
			createSerializationMatchSteps(
				73		/* assert |NamedElementCS::name| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				87		/* assert |RootCS::ownedImports| == 0 */,
				315		/* check-rule essentialoclcs::ContextCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				10		/* assert (|ContextCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[34] = createSerializationRule("NameExpCS-0", 59,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				302		/* check-rule essentialoclcs::AbstractNameExpCS.ownedCurlyBracketedClause : CurlyBracketedClauseCS */,
				303		/* check-rule essentialoclcs::AbstractNameExpCS.ownedPathName : PathNameCS */,
				304		/* check-rule essentialoclcs::AbstractNameExpCS.ownedRoundBracketedClause : RoundBracketedClauseCS */,
				305		/* check-rule essentialoclcs::AbstractNameExpCS.ownedSquareBracketedClauses : SquareBracketedClauseCS */,
				215		/* assign V3 = |AbstractNameExpCS::isPre.'@'| */,
				198		/* assign V2 = |AbstractNameExpCS::ownedCurlyBracketedClause| */,
				156		/* assign V1 = |AbstractNameExpCS::ownedRoundBracketedClause| */,
				116		/* assign V0 = |AbstractNameExpCS::ownedSquareBracketedClauses| */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_ROUND_BRACKETED_CLAUSE, 35/* RoundBracketedClauseCS */,
					(84/*RoundBracketedClauseCS*/ << 4) | 1 /*[?]*/
				),
				createSerializationReference(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__OWNED_SQUARE_BRACKETED_CLAUSES, 39/* SquareBracketedClauseCS */,
					(93/*SquareBracketedClauseCS*/ << 4) | 2 /*[*]*/
				)
			});
		// EssentialOCL::NavigatingArgCS-0(essentialoclcs::NavigatingArgCS): { ":" ownedType=TypeExpCS }
		serializationRules[35] = createSerializationRule("NavigatingArgCS-0", 60,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				74		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				75		/* assert |NavigatingArgCS::ownedInitExpression| == 0 */,
				76		/* assert |NavigatingArgCS::ownedNameExpression| == 0 */,
				78		/* assert |NavigatingArgCS::prefix| == 0 */,
				338		/* check-rule essentialoclcs::NavigatingArgCS.ownedType : TypeExpCS */,
				34		/* assert (|NavigatingArgCS::ownedType| - 1) == 0 */
			),
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__OWNED_TYPE, 51/* TypeExpCS */,
					(107/*TypeExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		...
		serializationRules[36] = createSerializationRule("NavigatingArgCS-1", 60,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				78		/* assert |NavigatingArgCS::prefix| == 0 */,
				335		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
				336		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				337		/* check-rule essentialoclcs::NavigatingArgCS.ownedNameExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NavigatingArgExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				338		/* check-rule essentialoclcs::NavigatingArgCS.ownedType : TypeExpCS */,
				164		/* assign V1 = |NavigatingArgCS::ownedInitExpression| */,
				130		/* assign V0 = |NavigatingArgCS::ownedCoIterator| */,
				34		/* assert (|NavigatingArgCS::ownedType| - 1) == 0 */,
		...
		serializationRules[37] = createSerializationRule("NavigatingArgCS-2", 60,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				77		/* assert |NavigatingArgCS::ownedType| == 0 */,
				78		/* assert |NavigatingArgCS::prefix| == 0 */,
		...
		serializationRules[38] = createSerializationRule("NavigatingArgCS-3", 60,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				78		/* assert |NavigatingArgCS::prefix| == 0 */,
				335		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
		...
		serializationRules[39] = createSerializationRule("NavigatingArgCS-4", 60,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				74		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				75		/* assert |NavigatingArgCS::ownedInitExpression| == 0 */,
		...
		serializationRules[40] = createSerializationRule("NavigatingBarArgCS-0", 62,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				74		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				336		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		serializationRules[41] = createSerializationRule("NavigatingCommaArgCS-0", 63,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				335		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
				336		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				106		/* NavigatingArgCS::prefix=',' || no-space value soft-space */,
				61		/* NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS || value */,
				130		/* ':' || soft-space value soft-space */,
				98		/* NavigatingArgCS::ownedType=TypeExpCS || value */,
				182		/* V00*2-steps || value */,
		...
		serializationRules[42] = createSerializationRule("NavigatingCommaArgCS-1", 63,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				77		/* assert |NavigatingArgCS::ownedType| == 0 */,
				335		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
		...
		serializationRules[43] = createSerializationRule("NavigatingCommaArgCS-2", 63,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				335		/* check-rule essentialoclcs::NavigatingArgCS.ownedCoIterator : CoIteratorVariableCS */,
				336		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
		...
		serializationRules[44] = createSerializationRule("NavigatingCommaArgCS-3", 63,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				74		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				75		/* assert |NavigatingArgCS::ownedInitExpression| == 0 */,
		...
		serializationRules[45] = createSerializationRule("NavigatingSemiArgCS-0", 64,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				74		/* assert |NavigatingArgCS::ownedCoIterator| == 0 */,
				336		/* check-rule essentialoclcs::NavigatingArgCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				105		/* NavigatingArgCS::prefix=';' || no-space value soft-new-line */,
				61		/* NavigatingArgCS::ownedNameExpression=NavigatingArgExpCS || value */,
				186		/* V00*5-steps || value */,
				130		/* ':' || soft-space value soft-space */,
				98		/* NavigatingArgCS::ownedType=TypeExpCS || value */,
		...
		serializationRules[46] = createSerializationRule("NestedExpCS-0", 66,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				339		/* check-rule essentialoclcs::NestedExpCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				38		/* assert (|NestedExpCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
		...
		serializationRules[47] = createSerializationRule("NullLiteralExpCS-0", 68,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				163		/* 'null' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		// EssentialOCL::NumberLiteralExpCS-0(essentialoclcs::NumberLiteralExpCS): symbol=NUMBER_LITERAL
		serializationRules[48] = createSerializationRule("NumberLiteralExpCS-0", 69,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				39		/* assert (|NumberLiteralExpCS::symbol| - 1) == 0 */
			),
		...
		serializationRules[49] = createSerializationRule("PatternExpCS-0", 74,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				343		/* check-rule essentialoclcs::PatternExpCS.ownedPatternType : TypeExpCS */,
				43		/* assert (|PatternExpCS::ownedPatternType| - 1) == 0 */,
				135		/* assign V0 = |PatternExpCS::patternVariableName| */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS__OWNED_PATTERN_TYPE, 51/* TypeExpCS */,
					(107/*TypeExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::PrefixedLetExpCS-1(essentialoclcs::PrefixExpCS): { name=UnaryOperatorName ownedRight=PrefixedLetExpCS }
		serializationRules[50] = createSerializationRule("PrefixedLetExpCS-1", 77,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				340		/* check-rule essentialoclcs::OperatorExpCS.ownedRight : LetExpCS|PrefixedLetExpCS */,
				40		/* assert (|OperatorExpCS::ownedRight| - 1) == 0 */,
				30		/* assert (|NamedElementCS::name| - 1) == 0 */
			),
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				253		/* NamedElementCS::name=UnaryOperatorName || soft-space value soft-space */,
				264		/* OperatorExpCS::ownedRight=PrefixedLetExpCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
		...
		serializationRules[51] = createSerializationRule("PrefixedPrimaryExpCS-15", 78,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				253		/* NamedElementCS::name=UnaryOperatorName || soft-space value soft-space */,
				265		/* OperatorExpCS::ownedRight=PrefixedPrimaryExpCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
		...
		serializationRules[52] = createSerializationRule("PrimitiveTypeCS-0", 81,
			createSerializationMatchSteps(
				99		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				44		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
			),
		...
		serializationRules[53] = createSerializationRule("RoundBracketedClauseCS-0", 84,
			null,	// run-time resolution using SerializationSteps
			createSerializationSteps(
				123		/* '(' || no-space value no-space */,
				184		/* V00*3-steps || value */,
				258		/* RoundBracketedClauseCS::ownedArguments+=NavigatingArgCS || value */,
				190		/* V01*1-steps || value */,
				259		/* RoundBracketedClauseCS::ownedArguments+=NavigatingCommaArgCS|NavigatingSemiArgCS|NavigatingBarArgCS || value */,
				124		/* ')' || no-space value */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[54] = createSerializationRule("SelfExpCS-0", 89,
			createSerializationMatchSteps(
				88		/* assert |SelfExpCS::name| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				170		/* 'self' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		...
		serializationRules[55] = createSerializationRule("ShadowPartCS-0", 90,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				344		/* check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PatternExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				45		/* assert (|ShadowPartCS::ownedInitExpression| - 1) == 0 */,
				46		/* assert (|ShadowPartCS::referredProperty| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[56] = createSerializationRule("ShadowPartCS-1", 90,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				89		/* assert |ShadowPartCS::referredProperty| == 0 */,
				345		/* check-rule essentialoclcs::ShadowPartCS.ownedInitExpression : StringLiteralExpCS */,
				45		/* assert (|ShadowPartCS::ownedInitExpression| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__OWNED_INIT_EXPRESSION, 40/* StringLiteralExpCS */,
					(95/*StringLiteralExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::SimplePathNameCS-0(basecs::PathNameCS): ownedPathElements+=FirstPathElementCS
		serializationRules[57] = createSerializationRule("SimplePathNameCS-0", 91,
			createSerializationMatchSteps(
		...
		serializationRules[58] = createSerializationRule("SquareBracketedClauseCS-0", 93,
			createSerializationMatchSteps(
				346		/* check-rule essentialoclcs::SquareBracketedClauseCS.ownedTerms : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				108		/* assign V0 = (|SquareBracketedClauseCS::ownedTerms| - 1) */
			),
			createSerializationSteps(
				140		/* '[' || no-space value no-space */,
		...
		serializationRules[59] = createSerializationRule("StringLiteralExpCS-0", 95,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				137		/* assign V0 = |StringLiteralExpCS::segments| */
			),
			createSerializationSteps(
				181		/* V00*1-steps || value */,
		...
		serializationRules[60] = createSerializationRule("TupleLiteralExpCS-0", 103,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				347		/* check-rule essentialoclcs::TupleLiteralExpCS.ownedParts : TupleLiteralPartCS */,
				111		/* assign V0 = (|TupleLiteralExpCS::ownedParts| - 1) */
			),
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				139		/* 'Tuple' || soft-space value soft-space */,
				175		/* '{' || soft-space value push soft-new-line */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.TUPLE_LITERAL_EXP_CS__OWNED_PARTS, 49/* TupleLiteralPartCS */,
		...
		serializationRules[61] = createSerializationRule("TupleLiteralPartCS-0", 104,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				352		/* check-rule essentialoclcs::VariableCS.ownedInitExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				353		/* check-rule essentialoclcs::VariableCS.ownedType : TypeExpCS */,
		...
		serializationRules[62] = createSerializationRule("TuplePartCS-0", 105,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				98		/* assert |TypedElementCS::qualifiers| == 0 */,
				296		/* check-rule basecs::TypedElementCS.ownedType : TypeExpCS */,
				52		/* assert (|TypedElementCS::ownedType| - 1) == 0 */,
				30		/* assert (|NamedElementCS::name| - 1) == 0 */
			),
			createSerializationSteps(
				...
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				130		/* ':' || soft-space value soft-space */,
				266		/* TypedElementCS::ownedType=TypeExpCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE, 51/* TypeExpCS */,
					(107/*TypeExpCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::TupleTypeCS-0(basecs::TupleTypeCS): { name="Tuple" { "(" { ownedParts+=TuplePartCS { "," ownedParts+=TuplePartCS }[*] }[?] ")" }[?] }
		serializationRules[63] = createSerializationRule("TupleTypeCS-0", 106,
			createSerializationMatchSteps(
				99		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				294		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				49		/* assert (|TupleTypeCS::name.'Tuple'| - 1) == 0 */,
				112		/* assign V0 = (|TupleTypeCS::ownedParts| > 0) */,
				153		/* assign V1 = (|TupleTypeCS::ownedParts| > 0) */,
				195		/* assign V2 = (|TupleTypeCS::ownedParts| - 1) */
			...
			createSerializationSteps(
				...
				188		/* V00*7-steps || value */,
				123		/* '(' || no-space value no-space */,
				195		/* V01*4-steps || value */,
				72		/* TupleTypeCS::ownedParts+=TuplePartCS || value */,
				211		/* V02*2-steps || value */,
				127		/* ',' || no-space value soft-space */,
				72		/* TupleTypeCS::ownedParts+=TuplePartCS || value */,
				124		/* ')' || no-space value */
			),
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.TUPLE_TYPE_CS__OWNED_PARTS, 50/* TuplePartCS */,
					(105/*TuplePartCS*/ << 4) | 2 /*[*]*/
				)
			});
	}
	private void initSerializationRules1() {
		...
		serializationRules[64] = createSerializationRule("TypeExpCS-0", 107,
			createSerializationMatchSteps(
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				144		/* assign V0 = |TypedRefCS::ownedMultiplicity| */,
				44		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[65] = createSerializationRule("TypeExpCS-1", 107,
			createSerializationMatchSteps(
				313		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				314		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
		...
		serializationRules[66] = createSerializationRule("TypeExpCS-2", 107,
			createSerializationMatchSteps(
				333		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				334		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
		...
		serializationRules[67] = createSerializationRule("TypeExpCS-3", 107,
			createSerializationMatchSteps(
				349		/* check-rule essentialoclcs::TypeNameExpCS.ownedCurlyBracketedClause : CurlyBracketedClauseCS */,
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				350		/* check-rule essentialoclcs::TypeNameExpCS.ownedPathName : PathNameCS */,
				351		/* check-rule essentialoclcs::TypeNameExpCS.ownedPatternGuard : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				208		/* assign V2 = |TypedRefCS::ownedMultiplicity| */,
				140		/* assign V0 = |TypeNameExpCS::ownedCurlyBracketedClause| */,
				51		/* assert (|TypeNameExpCS::ownedPathName| - 1) == 0 */,
				171		/* assign V1 = |TypeNameExpCS::ownedPatternGuard| */
		...
		serializationRules[68] = createSerializationRule("TypeExpCS-4", 107,
			createSerializationMatchSteps(
				62		/* assert |CollectionPatternCS::ownedPatternGuard| == 0 */,
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				311		/* check-rule essentialoclcs::CollectionPatternCS.ownedParts : PatternExpCS */,
		...
		serializationRules[69] = createSerializationRule("TypeExpCS-5", 107,
			createSerializationMatchSteps(
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				294		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				223		/* assign V3 = |TypedRefCS::ownedMultiplicity| */,
		...
		serializationRules[70] = createSerializationRule("TypeLiteralExpCS-0", 111,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				96		/* assert |TypeLiteralExpCS::ownedPathName| == 0 */,
				348		/* check-rule essentialoclcs::TypeLiteralExpCS.ownedType : TypeLiteralWithMultiplicityCS */,
				50		/* assert (|TypeLiteralExpCS::ownedType| - 1) == 0 */
			),
			createSerializationSteps(
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(EssentialOCLCSPackage.Literals.TYPE_LITERAL_EXP_CS__OWNED_TYPE, 54/* TypeLiteralWithMultiplicityCS */,
		...
		serializationRules[71] = createSerializationRule("TypeLiteralWithMultiplicityCS-0", 112,
			createSerializationMatchSteps(
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				144		/* assign V0 = |TypedRefCS::ownedMultiplicity| */,
				44		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
		...
		serializationRules[72] = createSerializationRule("TypeLiteralWithMultiplicityCS-1", 112,
			createSerializationMatchSteps(
				313		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				314		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
		...
		serializationRules[73] = createSerializationRule("TypeLiteralWithMultiplicityCS-2", 112,
			createSerializationMatchSteps(
				333		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				334		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
		...
		serializationRules[74] = createSerializationRule("TypeLiteralWithMultiplicityCS-3", 112,
			createSerializationMatchSteps(
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				294		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				223		/* assign V3 = |TypedRefCS::ownedMultiplicity| */,
		...
		serializationRules[75] = createSerializationRule("TypeNameExpCS-0", 113,
			createSerializationMatchSteps(
				99		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				349		/* check-rule essentialoclcs::TypeNameExpCS.ownedCurlyBracketedClause : CurlyBracketedClauseCS */,
				350		/* check-rule essentialoclcs::TypeNameExpCS.ownedPathName : PathNameCS */,
		...
		serializationRules[76] = createSerializationRule("URIFirstPathElementCS-0", 122,
			createSerializationMatchSteps(
				41		/* assert (|PathElementCS::referredElement| - 1) == 0 */
			),
			createSerializationSteps(
				274		/* PathElementCS::referredElement=URI || soft-space value soft-space */
			),
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, -1
				)
		...
		serializationRules[77] = createSerializationRule("URIFirstPathElementCS-1", 122,
			createSerializationMatchSteps(
				41		/* assert (|PathElementCS::referredElement| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[78] = createSerializationRule("URIPathNameCS-0", 123,
			null,	// run-time resolution using SerializationSteps
			createSerializationSteps(
				260		/* PathNameCS::ownedPathElements+=URIFirstPathElementCS || value */,
				183		/* V00*2-steps || value */,
				131		/* '::' || no-space value no-space */,
				262		/* PathNameCS::ownedPathElements+=NextPathElementCS || value */
			),
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 61/* NextPathElementCS,URIFirstPathElementCS */,
					(67/*NextPathElementCS*/ << 4) | 2 /*[*]*/,
					(122/*URIFirstPathElementCS*/ << 4) | 0 /*[1]*/
				)
			});
		// EssentialOCL::UnlimitedNaturalLiteralExpCS-0(essentialoclcs::UnlimitedNaturalLiteralExpCS): "*"
		serializationRules[79] = createSerializationRule("UnlimitedNaturalLiteralExpCS-0", 125,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */
			),
			createSerializationSteps(
				125		/* '*' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */
			),
			null);
		...
		serializationRules[80] = createSerializationRule("AnnotationCS-0", 1,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				58		/* assert |AnnotationCS::ownedContents| == 0 */,
				59		/* assert |AnnotationCS::ownedReferences| == 0 */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				142		/* 'annotation' || soft-space value soft-space */,
				179		/* V00*1-steps || value */,
				255		/* NamedElementCS::name=UnrestrictedName|SINGLE_QUOTED_STRING || soft-space value soft-space */,
				197		/* V01*6-steps || value */,
				123		/* '(' || no-space value no-space */,
				...
				34		/* AnnotationElementCS::ownedDetails+=DetailCS || value */,
				124		/* ')' || no-space value */,
				132		/* ';' || no-space value soft-new-line */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[81] = createSerializationRule("AnnotationCS-1", 1,
			createSerializationMatchSteps(
		...
		serializationRules[82] = createSerializationRule("AnnotationCS-2", 1,
			createSerializationMatchSteps(
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				265		/* check-rule basecs::AnnotationCS.ownedContents : AttributeCS|ClassCS|DataTypeCS|EnumerationCS|EnumerationLiteralCS|ModelElementCS|OperationCS|PackageCS|ReferenceCS|StructuralFeatureCS|StructuredClassCS */,
				267		/* check-rule basecs::AnnotationElementCS.ownedDetails : DetailCS */,
			...
			createSerializationSteps(
				...
				124		/* ')' || no-space value */,
				175		/* '{' || soft-space value push soft-new-line */,
				216		/* V03*1-steps || value */,
				21		/* ModelElementCS::ownedAnnotations+=AnnotationElementCS || value */,
				223		/* V04*1-steps || value */,
				30		/* AnnotationCS::ownedContents+=ModelElementCS || value */,
				229		/* V05*1-steps || value */,
				83		/* AnnotationCS::ownedReferences+=ModelElementRefCS || value */,
				178		/* '}' || pop soft-space value soft-new-line */
		...
		serializationRules[83] = createSerializationRule("AnnotationCS-3", 1,
			createSerializationMatchSteps(
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				265		/* check-rule basecs::AnnotationCS.ownedContents : AttributeCS|ClassCS|DataTypeCS|EnumerationCS|EnumerationLiteralCS|ModelElementCS|OperationCS|PackageCS|ReferenceCS|StructuralFeatureCS|StructuredClassCS */,
				267		/* check-rule basecs::AnnotationElementCS.ownedDetails : DetailCS */,
		...
		serializationRules[84] = createSerializationRule("AttributeCS-0", 3,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				91		/* assert |StructuralFeatureCS::ownedDefaultExpressions| == 0 */,
				297		/* check-rule basecs::TypedElementCS.ownedType : TypedMultiplicityRefCS */,
				205		/* assign V2 = |StructuralFeatureCS::default| */,
				172		/* assign V1 = |TypedElementCS::ownedType| */,
				30		/* assert (|NamedElementCS::name| - 1) == 0 */,
				143		/* assign V0 = |TypedElementCS::qualifiers.'static'| */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				272		/* TypedElementCS::qualifiers+='definition' || soft-space value soft-space */,
				179		/* V00*1-steps || value */,
				273		/* TypedElementCS::qualifiers+='static' || soft-space value soft-space */,
				143		/* 'attribute' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				192		/* V01*2-steps || value */,
				130		/* ':' || soft-space value soft-space */,
				267		/* TypedElementCS::ownedType=TypedMultiplicityRefCS || value */,
				210		/* V02*2-steps || value */,
				135		/* '=' || soft-space value soft-space */,
				0		/* StructuralFeatureCS::default=SINGLE_QUOTED_STRING || soft-space value soft-space */,
				221		/* V03*4-steps || value */,
				174		/* '{' || soft-space value soft-space */,
				223		/* V04*1-steps || value */,
				269		/* TypedElementCS::qualifiers+='!derived|!id|!ordered|!readonly|!transient|!unique|!unsettable|!volatile|derived|id|ordered|readonly|transient|unique|unsettable|volatile' || soft-space value soft-space */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE, 58/* TypedMultiplicityRefCS */,
		...
		serializationRules[85] = createSerializationRule("AttributeCS-1", 3,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				285		/* check-rule basecs::StructuralFeatureCS.ownedDefaultExpressions : SpecificationCS */,
				297		/* check-rule basecs::TypedElementCS.ownedType : TypedMultiplicityRefCS */,
				262		/* assign V9 = |ModelElementCS::ownedAnnotations| */,
				205		/* assign V2 = |StructuralFeatureCS::default| */,
				172		/* assign V1 = |TypedElementCS::ownedType| */,
			...
			createSerializationSteps(
				...
				177		/* '}' || soft-space value soft-space */,
				175		/* '{' || soft-space value push soft-new-line */,
				234		/* V05*5-steps || value */,
				147		/* 'derivation' || soft-space value soft-space */,
				130		/* ':' || soft-space value soft-space */,
				235		/* V06*1-steps || value */,
				33		/* StructuralFeatureCS::ownedDefaultExpressions+=SpecificationCS || value */,
				132		/* ';' || no-space value soft-new-line */,
				243		/* V07*5-steps || value */,
				157		/* 'initial' || soft-space value soft-space */,
				130		/* ':' || soft-space value soft-space */,
				244		/* V08*1-steps || value */,
				33		/* StructuralFeatureCS::ownedDefaultExpressions+=SpecificationCS || value */,
				132		/* ';' || no-space value soft-new-line */,
				249		/* V09*1-steps || value */,
				21		/* ModelElementCS::ownedAnnotations+=AnnotationElementCS || value */,
				178		/* '}' || pop soft-space value soft-new-line */
			),
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.STRUCTURAL_FEATURE_CS__OWNED_DEFAULT_EXPRESSIONS, 38/* SpecificationCS */,
		...
		serializationRules[86] = createSerializationRule("AttributeCS-2", 3,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				91		/* assert |StructuralFeatureCS::ownedDefaultExpressions| == 0 */,
		...
		serializationRules[87] = createSerializationRule("AttributeCS-3", 3,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				285		/* check-rule basecs::StructuralFeatureCS.ownedDefaultExpressions : SpecificationCS */,
		...
		serializationRules[88] = createSerializationRule("AttributeCS-4", 3,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				91		/* assert |StructuralFeatureCS::ownedDefaultExpressions| == 0 */,
		...
		serializationRules[89] = createSerializationRule("AttributeCS-5", 3,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				285		/* check-rule basecs::StructuralFeatureCS.ownedDefaultExpressions : SpecificationCS */,
			...
			createSerializationSteps(
				...
				177		/* '}' || soft-space value soft-space */,
				175		/* '{' || soft-space value push soft-new-line */,
				227		/* V04*5-steps || value */,
				147		/* 'derivation' || soft-space value soft-space */,
				130		/* ':' || soft-space value soft-space */,
				228		/* V05*1-steps || value */,
				33		/* StructuralFeatureCS::ownedDefaultExpressions+=SpecificationCS || value */,
				132		/* ';' || no-space value soft-new-line */,
				238		/* V06*5-steps || value */,
				157		/* 'initial' || soft-space value soft-space */,
				130		/* ':' || soft-space value soft-space */,
				239		/* V07*1-steps || value */,
				33		/* StructuralFeatureCS::ownedDefaultExpressions+=SpecificationCS || value */,
				132		/* ';' || no-space value soft-new-line */,
				245		/* V08*1-steps || value */,
				21		/* ModelElementCS::ownedAnnotations+=AnnotationElementCS || value */,
				178		/* '}' || pop soft-space value soft-new-line */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[90] = createSerializationRule("DataTypeCS-0", 15,
			createSerializationMatchSteps(
				...
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				60		/* assert |ClassCS::ownedConstraints| == 0 */,
				293		/* check-rule basecs::TemplateableElementCS.ownedSignature : TemplateSignatureCS */,
				199		/* assign V2 = |ClassCS::instanceClassName| */,
				170		/* assign V1 = |TemplateableElementCS::ownedSignature| */,
				30		/* assert (|NamedElementCS::name| - 1) == 0 */,
				121		/* assign V0 = |DataTypeCS::isPrimitive.'primitive'| */,
			...
			createSerializationSteps(
				...
				146		/* 'datatype' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				189		/* V01*1-steps || value */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
				createSerializationReference(BaseCSPackage.Literals.TEMPLATEABLE_ELEMENT_CS__OWNED_SIGNATURE, 48/* TemplateSignatureCS */,
		...
		serializationRules[96] = createSerializationRule("DetailCS-0", 16,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				122		/* assign V0 = |DetailCS::values| */,
				30		/* assert (|NamedElementCS::name| - 1) == 0 */
		...
		serializationRules[97] = createSerializationRule("DocumentationCS-0", 17,
			createSerializationMatchSteps(
				73		/* assert |NamedElementCS::name| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				267		/* check-rule basecs::AnnotationElementCS.ownedDetails : DetailCS */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				148		/* 'documentation' || soft-space value soft-space */,
				179		/* V00*1-steps || value */,
		...
		serializationRules[98] = createSerializationRule("EnumerationCS-0", 21,
			createSerializationMatchSteps(
				66		/* assert |EnumerationCS::isSerializable| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				60		/* assert |ClassCS::ownedConstraints| == 0 */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				152		/* 'enum' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				179		/* V00*1-steps || value */,
				86		/* TemplateableElementCS::ownedSignature=TemplateSignatureCS || value */,
				192		/* V01*2-steps || value */,
		...
		serializationRules[99] = createSerializationRule("EnumerationCS-1", 21,
			createSerializationMatchSteps(
				66		/* assert |EnumerationCS::isSerializable| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				268		/* check-rule basecs::ClassCS.ownedConstraints : InvariantConstraintCS */,
		...
		serializationRules[100] = createSerializationRule("EnumerationCS-2", 21,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				60		/* assert |ClassCS::ownedConstraints| == 0 */,
				67		/* assert |EnumerationCS::ownedLiterals| == 0 */,
		...
		serializationRules[101] = createSerializationRule("EnumerationCS-3", 21,
			createSerializationMatchSteps(
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				268		/* check-rule basecs::ClassCS.ownedConstraints : InvariantConstraintCS */,
				271		/* check-rule basecs::EnumerationCS.ownedLiterals : EnumerationLiteralCS */,
		...
		serializationRules[102] = createSerializationRule("EnumerationCS-4", 21,
			createSerializationMatchSteps(
				66		/* assert |EnumerationCS::isSerializable| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				60		/* assert |ClassCS::ownedConstraints| == 0 */,
		...
		serializationRules[103] = createSerializationRule("EnumerationCS-5", 21,
			createSerializationMatchSteps(
				66		/* assert |EnumerationCS::isSerializable| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				268		/* check-rule basecs::ClassCS.ownedConstraints : InvariantConstraintCS */,
		...
		serializationRules[104] = createSerializationRule("EnumerationLiteralCS-0", 22,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				160		/* assign V1 = |EnumerationLiteralCS::value| */,
				124		/* assign V0 = |EnumerationLiteralCS::literal| */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				161		/* 'literal' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				182		/* V00*2-steps || value */,
				130		/* ':' || soft-space value soft-space */,
		...
		serializationRules[105] = createSerializationRule("EnumerationLiteralCS-1", 22,
			createSerializationMatchSteps(
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				203		/* assign V2 = |ModelElementCS::ownedAnnotations| */,
				160		/* assign V1 = |EnumerationLiteralCS::value| */,
		...
		serializationRules[106] = createSerializationRule("EnumerationLiteralCS-2", 22,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				160		/* assign V1 = |EnumerationLiteralCS::value| */,
				124		/* assign V0 = |EnumerationLiteralCS::literal| */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				256		/* NamedElementCS::name=EnumerationLiteralName || soft-space value soft-space */,
				182		/* V00*2-steps || value */,
				130		/* ':' || soft-space value soft-space */,
				12		/* EnumerationLiteralCS::literal=SINGLE_QUOTED_STRING || soft-space value soft-space */,
				192		/* V01*2-steps || value */,
		...
		serializationRules[107] = createSerializationRule("EnumerationLiteralCS-3", 22,
			createSerializationMatchSteps(
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				203		/* assign V2 = |ModelElementCS::ownedAnnotations| */,
				160		/* assign V1 = |EnumerationLiteralCS::value| */,
		...
		serializationRules[108] = createSerializationRule("ImplicitOppositeCS-0", 37,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				297		/* check-rule basecs::TypedElementCS.ownedType : TypedMultiplicityRefCS */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				165		/* 'opposite' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				130		/* ':' || soft-space value soft-space */,
				267		/* TypedElementCS::ownedType=TypedMultiplicityRefCS || value */,
				185		/* V00*4-steps || value */,
				175		/* '{' || soft-space value push soft-new-line */,
				191		/* V01*1-steps || value */,
				271		/* TypedElementCS::qualifiers+='!ordered|!unique|ordered|unique' || soft-space value soft-space */,
				178		/* '}' || pop soft-space value soft-new-line */
			),
			new @NonNull SerializationFeature [] {
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, true, GrammarCardinality.ONE),
		...
		serializationRules[109] = createSerializationRule("ImportCS-0", 38,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationSimpleAttribute(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, false, GrammarCardinality.ZERO_OR_ONE),
				createSerializationReference(BaseCSPackage.Literals.IMPORT_CS__OWNED_PATH_NAME, 63/* URIPathNameCS */,
		...
		serializationRules[110] = createSerializationRule("InvariantConstraintCS-0", 41,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				63		/* assert |ConstraintCS::ownedSpecification| == 0 */,
			...
			createSerializationSteps(
				...
				277		/* ConstraintCS::stereotype='invariant' || soft-space value soft-space */,
				196		/* V01*5-steps || value */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				212		/* V02*3-steps || value */,
				123		/* '(' || no-space value no-space */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.CONSTRAINT_CS__OWNED_MESSAGE_SPECIFICATION, 38/* SpecificationCS */,
		...
		serializationRules[111] = createSerializationRule("InvariantConstraintCS-1", 41,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				269		/* check-rule basecs::ConstraintCS.ownedMessageSpecification : SpecificationCS */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.CONSTRAINT_CS__OWNED_SPECIFICATION, 38/* SpecificationCS */,
					(92/*SpecificationCS*/ << 4) | 1 /*[?]*/
				)
			});
		// OCLinEcore::ModelElementRefCS-0(basecs::ModelElementRefCS): { "reference" ownedPathName=PathNameCS ";" }
		serializationRules[112] = createSerializationRule("ModelElementRefCS-0", 54,
			createSerializationMatchSteps(
				274		/* check-rule basecs::ModelElementRefCS.ownedPathName : PathNameCS */,
				26		/* assert (|ModelElementRefCS::ownedPathName| - 1) == 0 */
			),
			createSerializationSteps(
				169		/* 'reference' || soft-space value soft-space */,
				75		/* ModelElementRefCS::ownedPathName=PathNameCS || value */,
				132		/* ';' || no-space value soft-new-line */
			),
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.MODEL_ELEMENT_REF_CS__OWNED_PATH_NAME, 27/* PathNameCS */,
					(73/*PathNameCS*/ << 4) | 0 /*[1]*/
				)
			});
		...
		serializationRules[113] = createSerializationRule("OperationCS-0", 70,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				80		/* assert |OperationCS::ownedBodyExpressions| == 0 */,
			...
			createSerializationSteps(
				...
				179		/* V00*1-steps || value */,
				273		/* TypedElementCS::qualifiers+='static' || soft-space value soft-space */,
				164		/* 'operation' || soft-space value soft-space */,
				189		/* V01*1-steps || value */,
				86		/* TemplateableElementCS::ownedSignature=TemplateSignatureCS || value */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				123		/* '(' || no-space value no-space */,
				...
				219		/* V03*2-steps || value */,
				127		/* ',' || no-space value soft-space */,
				65		/* OperationCS::ownedParameters+=ParameterCS || value */,
				124		/* ')' || no-space value */,
				224		/* V04*2-steps || value */,
				130		/* ':' || soft-space value soft-space */,
				267		/* TypedElementCS::ownedType=TypedMultiplicityRefCS || value */,
				233		/* V05*5-steps || value */,
				173		/* 'throws' || soft-space value soft-space */,
				36		/* OperationCS::ownedExceptions+=TypedRefCS || value */,
				236		/* V06*2-steps || value */,
				127		/* ',' || no-space value soft-space */,
				36		/* OperationCS::ownedExceptions+=TypedRefCS || value */,
				242		/* V07*4-steps || value */,
				174		/* '{' || soft-space value soft-space */,
				246		/* V08*1-steps || value */,
				270		/* TypedElementCS::qualifiers+='!derived|!ordered|!transient|!unique|derived|ordered|transient|unique' || soft-space value soft-space */,
				177		/* '}' || soft-space value soft-space */,
				132		/* ';' || no-space value soft-new-line */
			),
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.OPERATION_CS__OWNED_EXCEPTIONS, 59/* TypedRefCS */,
					(117/*TypedRefCS*/ << 4) | 2 /*[*]*/
				),
		...
		serializationRules[114] = createSerializationRule("OperationCS-1", 70,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
			...
			createSerializationSteps(
				...
				177		/* '}' || soft-space value soft-space */,
				175		/* '{' || soft-space value push soft-new-line */,
				250		/* V09*5-steps || value */,
				144		/* 'body' || soft-space value soft-space */,
				129		/* ':' || no-space value soft-space */,
				198		/* V10*1-steps || value */,
				23		/* OperationCS::ownedBodyExpressions+=SpecificationCS || value */,
				132		/* ';' || no-space value soft-new-line */,
				202		/* V11*1-steps || value */,
				21		/* ModelElementCS::ownedAnnotations+=AnnotationElementCS || value */,
				204		/* V12*1-steps || value */,
				81		/* OperationCS::ownedPreconditions+=PreconditionConstraintCS || value */,
				206		/* V13*1-steps || value */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.OPERATION_CS__OWNED_BODY_EXPRESSIONS, 38/* SpecificationCS */,
					(92/*SpecificationCS*/ << 4) | 2 /*[*]*/
				),
				createSerializationReference(BaseCSPackage.Literals.OPERATION_CS__OWNED_EXCEPTIONS, 59/* TypedRefCS */,
					(117/*TypedRefCS*/ << 4) | 2 /*[*]*/
				...
				createSerializationReference(BaseCSPackage.Literals.OPERATION_CS__OWNED_POSTCONDITIONS, 30/* PostconditionConstraintCS */,
					(75/*PostconditionConstraintCS*/ << 4) | 2 /*[*]*/
				),
				createSerializationReference(BaseCSPackage.Literals.OPERATION_CS__OWNED_PRECONDITIONS, 31/* PreconditionConstraintCS */,
		...
		serializationRules[115] = createSerializationRule("OperationCS-2", 70,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				80		/* assert |OperationCS::ownedBodyExpressions| == 0 */,
		...
		serializationRules[116] = createSerializationRule("OperationCS-3", 70,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				275		/* check-rule basecs::OperationCS.ownedBodyExpressions : SpecificationCS */,
		...
		serializationRules[117] = createSerializationRule("OperationCS-4", 70,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				80		/* assert |OperationCS::ownedBodyExpressions| == 0 */,
			...
			createSerializationSteps(
				...
				130		/* ':' || soft-space value soft-space */,
				267		/* TypedElementCS::ownedType=TypedMultiplicityRefCS || value */,
				226		/* V04*5-steps || value */,
				173		/* 'throws' || soft-space value soft-space */,
				36		/* OperationCS::ownedExceptions+=TypedRefCS || value */,
				231		/* V05*2-steps || value */,
				127		/* ',' || no-space value soft-space */,
				36		/* OperationCS::ownedExceptions+=TypedRefCS || value */,
				237		/* V06*4-steps || value */,
				174		/* '{' || soft-space value soft-space */,
				241		/* V07*1-steps || value */,
				270		/* TypedElementCS::qualifiers+='!derived|!ordered|!transient|!unique|derived|ordered|transient|unique' || soft-space value soft-space */,
				177		/* '}' || soft-space value soft-space */,
				132		/* ';' || no-space value soft-new-line */
			),
		...
		serializationRules[118] = createSerializationRule("OperationCS-5", 70,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				275		/* check-rule basecs::OperationCS.ownedBodyExpressions : SpecificationCS */,
			...
			createSerializationSteps(
				...
				177		/* '}' || soft-space value soft-space */,
				175		/* '{' || soft-space value push soft-new-line */,
				247		/* V08*5-steps || value */,
				144		/* 'body' || soft-space value soft-space */,
				129		/* ':' || no-space value soft-space */,
				248		/* V09*1-steps || value */,
				23		/* OperationCS::ownedBodyExpressions+=SpecificationCS || value */,
				132		/* ';' || no-space value soft-new-line */,
				199		/* V10*1-steps || value */,
				21		/* ModelElementCS::ownedAnnotations+=AnnotationElementCS || value */,
				202		/* V11*1-steps || value */,
				81		/* OperationCS::ownedPreconditions+=PreconditionConstraintCS || value */,
				204		/* V12*1-steps || value */,
		...
		serializationRules[119] = createSerializationRule("PackageCS-0", 71,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				83		/* assert |PackageCS::ownedClasses| == 0 */,
				84		/* assert |PackageOwnerCS::ownedPackages| == 0 */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				166		/* 'package' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				182		/* V00*2-steps || value */,
				130		/* ':' || soft-space value soft-space */,
		...
		serializationRules[120] = createSerializationRule("PackageCS-1", 71,
			createSerializationMatchSteps(
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
			...
			createSerializationSteps(
				...
				21		/* ModelElementCS::ownedAnnotations+=AnnotationElementCS || value */,
				216		/* V03*1-steps || value */,
				64		/* PackageOwnerCS::ownedPackages+=PackageCS || value */,
				222		/* V04*1-steps || value */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.PACKAGE_OWNER_CS__OWNED_PACKAGES, 25/* PackageCS */,
					(71/*PackageCS*/ << 4) | 2 /*[*]*/
				)
			});
		...
		serializationRules[121] = createSerializationRule("ParameterCS-0", 72,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				297		/* check-rule basecs::TypedElementCS.ownedType : TypedMultiplicityRefCS */,
		...
		serializationRules[122] = createSerializationRule("PostconditionConstraintCS-0", 75,
			createSerializationMatchSteps(
				79		/* assert |OCLinEcoreConstraintCS::isCallable| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				269		/* check-rule basecs::ConstraintCS.ownedMessageSpecification : SpecificationCS */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				278		/* ConstraintCS::stereotype='postcondition' || soft-space value soft-space */,
				186		/* V00*5-steps || value */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				194		/* V01*3-steps || value */,
				123		/* '(' || no-space value no-space */,
		...
		serializationRules[123] = createSerializationRule("PreconditionConstraintCS-0", 76,
			createSerializationMatchSteps(
				79		/* assert |OCLinEcoreConstraintCS::isCallable| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				269		/* check-rule basecs::ConstraintCS.ownedMessageSpecification : SpecificationCS */,
		...
		serializationRules[124] = createSerializationRule("ReferenceCS-0", 83,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				91		/* assert |StructuralFeatureCS::ownedDefaultExpressions| == 0 */,
			...
			createSerializationSteps(
				...
				179		/* V00*1-steps || value */,
				273		/* TypedElementCS::qualifiers+='static' || soft-space value soft-space */,
				168		/* 'property' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				192		/* V01*2-steps || value */,
				...
				135		/* '=' || soft-space value soft-space */,
				0		/* StructuralFeatureCS::default=SINGLE_QUOTED_STRING || soft-space value soft-space */,
				225		/* V04*4-steps || value */,
				174		/* '{' || soft-space value soft-space */,
				230		/* V05*1-steps || value */,
				268		/* TypedElementCS::qualifiers+='!composes|!derived|!ordered|!readonly|!resolve|!transient|!unique|!unsettable|!volatile|composes|derived|ordered|readonly|resolve|transient|unique|unsettable|volatile' || soft-space value soft-space */,
				177		/* '}' || soft-space value soft-space */,
				132		/* ';' || no-space value soft-new-line */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[125] = createSerializationRule("ReferenceCS-1", 83,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				285		/* check-rule basecs::StructuralFeatureCS.ownedDefaultExpressions : SpecificationCS */,
				283		/* check-rule basecs::ReferenceCS.ownedImplicitOpposites : ImplicitOppositeCS */,
				297		/* check-rule basecs::TypedElementCS.ownedType : TypedMultiplicityRefCS */,
				189		/* assign V13 = |ModelElementCS::ownedAnnotations| */,
				188		/* assign V12 = |ReferenceCS::ownedImplicitOpposites| */,
				220		/* assign V3 = |StructuralFeatureCS::default| */,
			...
			createSerializationSteps(
				...
				33		/* StructuralFeatureCS::ownedDefaultExpressions+=SpecificationCS || value */,
				132		/* ';' || no-space value soft-new-line */,
				201		/* V10*6-steps || value */,
				159		/* 'key' || soft-space value soft-space */,
				108		/* ReferenceCS::referredKeys+=UnrestrictedName || soft-space value soft-space */,
				203		/* V11*2-steps || value */,
				127		/* ',' || no-space value soft-space */,
				108		/* ReferenceCS::referredKeys+=UnrestrictedName || soft-space value soft-space */,
				132		/* ';' || no-space value soft-new-line */,
				205		/* V12*2-steps || value */,
		...
		serializationRules[126] = createSerializationRule("ReferenceCS-2", 83,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				91		/* assert |StructuralFeatureCS::ownedDefaultExpressions| == 0 */,
		...
		serializationRules[127] = createSerializationRule("ReferenceCS-3", 83,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				285		/* check-rule basecs::StructuralFeatureCS.ownedDefaultExpressions : SpecificationCS */,
	...
	private void initSerializationRules2() {
		...
		serializationRules[128] = createSerializationRule("ReferenceCS-4", 83,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				91		/* assert |StructuralFeatureCS::ownedDefaultExpressions| == 0 */,
		...
		serializationRules[129] = createSerializationRule("ReferenceCS-5", 83,
			createSerializationMatchSteps(
				97		/* assert |TypedElementCS::isOptional| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				285		/* check-rule basecs::StructuralFeatureCS.ownedDefaultExpressions : SpecificationCS */,
			...
			createSerializationSteps(
				...
				33		/* StructuralFeatureCS::ownedDefaultExpressions+=SpecificationCS || value */,
				132		/* ';' || no-space value soft-new-line */,
				251		/* V09*6-steps || value */,
				159		/* 'key' || soft-space value soft-space */,
				108		/* ReferenceCS::referredKeys+=UnrestrictedName || soft-space value soft-space */,
				200		/* V10*2-steps || value */,
				127		/* ',' || no-space value soft-space */,
				108		/* ReferenceCS::referredKeys+=UnrestrictedName || soft-space value soft-space */,
				132		/* ';' || no-space value soft-new-line */,
				203		/* V11*2-steps || value */,
		...
		serializationRules[130] = createSerializationRule("SpecificationCS-0", 92,
			createSerializationMatchSteps(
				90		/* assert |SpecificationCS::exprString| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				317		/* check-rule essentialoclcs::ExpSpecificationCS.ownedExpression : BooleanLiteralExpCS|CollectionLiteralExpCS|ExpCS|IfExpCS|InvalidLiteralExpCS|LambdaLiteralExpCS|LetExpCS|MapLiteralExpCS|NameExpCS|NestedExpCS|NullLiteralExpCS|NumberLiteralExpCS|PrefixedLetExpCS|PrefixedPrimaryExpCS|PrimaryExpCS|PrimitiveLiteralExpCS|SelfExpCS|StringLiteralExpCS|TupleLiteralExpCS|TypeLiteralExpCS|UnlimitedNaturalLiteralExpCS */,
				11		/* assert (|ExpSpecificationCS::ownedExpression| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[131] = createSerializationRule("SpecificationCS-1", 92,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				68		/* assert |ExpSpecificationCS::ownedExpression| == 0 */,
				47		/* assert (|SpecificationCS::exprString| - 1) == 0 */
		...
		serializationRules[132] = createSerializationRule("StructuredClassCS-0", 97,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				60		/* assert |ClassCS::ownedConstraints| == 0 */,
				92		/* assert |StructuredClassCS::ownedMetaclass| == 0 */,
				...
				94		/* assert |StructuredClassCS::ownedProperties| == 0 */,
				293		/* check-rule basecs::TemplateableElementCS.ownedSignature : TemplateSignatureCS */,
				288		/* check-rule basecs::StructuredClassCS.ownedSuperTypes : CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS */,
				227		/* assign V4 = |ClassCS::instanceClassName| */,
				170		/* assign V1 = |TemplateableElementCS::ownedSignature| */,
				30		/* assert (|NamedElementCS::name| - 1) == 0 */,
				138		/* assign V0 = |StructuredClassCS::isAbstract.'abstract'| */,
			...
			createSerializationSteps(
				...
				145		/* 'class' || soft-space value soft-space */,
				254		/* NamedElementCS::name=UnrestrictedName || soft-space value soft-space */,
				189		/* V01*1-steps || value */,
				86		/* TemplateableElementCS::ownedSignature=TemplateSignatureCS || value */,
				214		/* V02*5-steps || value */,
				153		/* 'extends' || soft-space value soft-space */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__OWNED_SUPER_TYPES, 59/* TypedRefCS */,
					(117/*TypedRefCS*/ << 4) | 2 /*[*]*/
				)
			});
		...
		serializationRules[133] = createSerializationRule("StructuredClassCS-1", 97,
			createSerializationMatchSteps(
				92		/* assert |StructuredClassCS::ownedMetaclass| == 0 */,
				273		/* check-rule basecs::ModelElementCS.ownedAnnotations : AnnotationCS|AnnotationElementCS|DocumentationCS|SysMLCS */,
				268		/* check-rule basecs::ClassCS.ownedConstraints : InvariantConstraintCS */,
				286		/* check-rule basecs::StructuredClassCS.ownedOperations : OperationCS */,
				287		/* check-rule basecs::StructuredClassCS.ownedProperties : AttributeCS|ReferenceCS|StructuralFeatureCS */,
				293		/* check-rule basecs::TemplateableElementCS.ownedSignature : TemplateSignatureCS */,
				288		/* check-rule basecs::StructuredClassCS.ownedSuperTypes : CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeLiteralCS|TypedRefCS|TypedTypeRefCS */,
				178		/* assign V10 = |ClassCS::ownedConstraints| */,
				264		/* assign V9 = |StructuredClassCS::ownedProperties| */,
			...
			new @NonNull SerializationFeature [] {
				...
				createSerializationReference(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__OWNED_PROPERTIES, 41/* StructuralFeatureCS */,
		...
		serializationRules[134] = createSerializationRule("SysMLCS-0", 98,
			createSerializationMatchSteps(
				73		/* assert |NamedElementCS::name| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				95		/* assert |SysMLCS::value| == 0 */,
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				171		/* 'sysml' || soft-space value soft-space */,
				175		/* '{' || soft-space value push soft-new-line */,
				183		/* V00*2-steps || value */,
				34		/* AnnotationElementCS::ownedDetails+=DetailCS || value */,
				132		/* ';' || no-space value soft-new-line */,
		...
		serializationRules[135] = createSerializationRule("SysMLCS-1", 98,
			createSerializationMatchSteps(
				73		/* assert |NamedElementCS::name| == 0 */,
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				95		/* assert |SysMLCS::value| == 0 */,
		...
		serializationRules[136] = createSerializationRule("TemplateSignatureCS-0", 101,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				292		/* check-rule basecs::TemplateSignatureCS.ownedParameters : TypeParameterCS */,
				110		/* assign V0 = (|TemplateSignatureCS::ownedParameters| - 1) */
			),
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.TEMPLATE_SIGNATURE_CS__OWNED_PARAMETERS, 56/* TypeParameterCS */,
		...
		serializationRules[137] = createSerializationRule("TemplateSignatureCS-1", 101,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				292		/* check-rule basecs::TemplateSignatureCS.ownedParameters : TypeParameterCS */,
				110		/* assign V0 = (|TemplateSignatureCS::ownedParameters| - 1) */
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				134		/* '<' || soft-space value soft-space */,
				66		/* TemplateSignatureCS::ownedParameters+=TypeParameterCS || value */,
				183		/* V00*2-steps || value */,
				127		/* ',' || no-space value soft-space */,
				66		/* TemplateSignatureCS::ownedParameters+=TypeParameterCS || value */,
		...
		serializationRules[138] = createSerializationRule("TopLevelCS-0", 102,
			createSerializationMatchSteps(
				71		/* assert |ModelElementCS::ownedAnnotations| == 0 */,
				284		/* check-rule basecs::RootCS.ownedImports : ImportCS */,
				281		/* check-rule basecs::PackageOwnerCS.ownedPackages : PackageCS */,
				204		/* assign V2 = |PackageOwnerCS::ownedPackages| */,
				167		/* assign V1 = |RootCS::ownedImports| */,
				115		/* assign V0 = 0 */
			...
			createSerializationSteps(
				252		/* wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value */,
				179		/* V00*1-steps || value */,
				162		/* 'module' || soft-space value soft-space */,
				190		/* V01*1-steps || value */,
				47		/* RootCS::ownedImports+=ImportCS || value */,
				208		/* V02*1-steps || value */,
				64		/* PackageOwnerCS::ownedPackages+=PackageCS || value */
			),
			new @NonNull SerializationFeature [] {
		...
		serializationRules[139] = createSerializationRule("TypedMultiplicityRefCS-0", 116,
			createSerializationMatchSteps(
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				144		/* assign V0 = |TypedRefCS::ownedMultiplicity| */,
				44		/* assert (|PrimitiveTypeRefCS::name| - 1) == 0 */
		...
		serializationRules[140] = createSerializationRule("TypedMultiplicityRefCS-1", 116,
			createSerializationMatchSteps(
				100		/* assert |TypedTypeRefCS::isTypeof| == 0 */,
				101		/* assert |TypedTypeRefCS::ownedBinding| == 0 */,
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				300		/* check-rule basecs::TypedTypeRefCS.ownedPathName : PathNameCS */,
				144		/* assign V0 = |TypedRefCS::ownedMultiplicity| */,
				56		/* assert (|TypedTypeRefCS::ownedPathName| - 1) == 0 */
			),
			createSerializationSteps(
		...
		serializationRules[141] = createSerializationRule("TypedMultiplicityRefCS-2", 116,
			createSerializationMatchSteps(
				100		/* assert |TypedTypeRefCS::isTypeof| == 0 */,
				299		/* check-rule basecs::TypedTypeRefCS.ownedBinding : TemplateBindingCS */,
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				300		/* check-rule basecs::TypedTypeRefCS.ownedPathName : PathNameCS */,
				144		/* assign V0 = |TypedRefCS::ownedMultiplicity| */,
				55		/* assert (|TypedTypeRefCS::ownedBinding| - 1) == 0 */,
			...
			new @NonNull SerializationFeature [] {
				createSerializationReference(BaseCSPackage.Literals.TYPED_TYPE_REF_CS__OWNED_BINDING, 46/* TemplateBindingCS */,
		...
		serializationRules[142] = createSerializationRule("TypedMultiplicityRefCS-3", 116,
			createSerializationMatchSteps(
				100		/* assert |TypedTypeRefCS::isTypeof| == 0 */,
				299		/* check-rule basecs::TypedTypeRefCS.ownedBinding : TemplateBindingCS */,
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
		...
		serializationRules[143] = createSerializationRule("TypedMultiplicityRefCS-4", 116,
			createSerializationMatchSteps(
				313		/* check-rule essentialoclcs::CollectionTypeCS.ownedCollectionMultiplicity : MultiplicityCS */,
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				314		/* check-rule essentialoclcs::CollectionTypeCS.ownedType : CollectionPatternCS|CollectionTypeCS|MapTypeCS|PrimitiveTypeCS|TupleTypeCS|TypeExpWithoutMultiplicityCS|TypeLiteralCS|TypeNameExpCS */,
		...
		serializationRules[144] = createSerializationRule("TypedMultiplicityRefCS-5", 116,
			createSerializationMatchSteps(
				333		/* check-rule essentialoclcs::MapTypeCS.ownedKeyType : TypeExpCS */,
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				334		/* check-rule essentialoclcs::MapTypeCS.ownedValueType : TypeExpCS */,
		...
		serializationRules[145] = createSerializationRule("TypedMultiplicityRefCS-6", 116,
			createSerializationMatchSteps(
				298		/* check-rule basecs::TypedRefCS.ownedMultiplicity : MultiplicityCS */,
				294		/* check-rule basecs::TupleTypeCS.ownedParts : TuplePartCS */,
				223		/* assign V3 = |TypedRefCS::ownedMultiplicity| */,
		...
		serializationRules[146] = createSerializationRule("TypedTypeRefCS-0", 118,
			createSerializationMatchSteps(
				100		/* assert |TypedTypeRefCS::isTypeof| == 0 */,
				99		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				299		/* check-rule basecs::TypedTypeRefCS.ownedBinding : TemplateBindingCS */,
		...
		serializationRules[147] = createSerializationRule("TypedTypeRefCS-1", 118,
			createSerializationMatchSteps(
				100		/* assert |TypedTypeRefCS::isTypeof| == 0 */,
				99		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
				299		/* check-rule basecs::TypedTypeRefCS.ownedBinding : TemplateBindingCS */,
		...
		serializationRules[148] = createSerializationRule("TypedTypeRefCS-2", 118,
			createSerializationMatchSteps(
				100		/* assert |TypedTypeRefCS::isTypeof| == 0 */,
				101		/* assert |TypedTypeRefCS::ownedBinding| == 0 */,
				99		/* assert |TypedRefCS::ownedMultiplicity| == 0 */,
	...
	private void initSerializationSteps() {
		...
		// 3: StructuredClassCS::isAbstract?='abstract' || soft-space value soft-space
		serializationSteps[3] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__IS_ABSTRACT, 11 /* 'abstract' */, 7);
		// 4: ImportCS::isAll?='::*' || soft-space value soft-space
		serializationSteps[4] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.IMPORT_CS__IS_ALL, 6 /* '::*' */, 7);
		// 5: OCLinEcoreConstraintCS::isCallable?='callable' || soft-space value soft-space
		serializationSteps[5] = createSerializationStepAssignKeyword(OCLinEcoreCSPackage.Literals.OC_LIN_ECORE_CONSTRAINT_CS__IS_CALLABLE, 12 /* 'callable' */, 7);
		// 6: StructuredClassCS::isInterface?='interface' || soft-space value soft-space
		serializationSteps[6] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.STRUCTURED_CLASS_CS__IS_INTERFACE, 15 /* 'interface' */, 7);
		// 7: MultiplicityCS::isNullFree?='|1' || no-space value no-space
		serializationSteps[7] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.MULTIPLICITY_CS__IS_NULL_FREE, 23 /* '|1' */, 4);
		// 8: AbstractNameExpCS::isPre?='@' || soft-space value soft-space
		serializationSteps[8] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.ABSTRACT_NAME_EXP_CS__IS_PRE, 8 /* '@' */, 7);
		// 9: DataTypeCS::isPrimitive?='primitive' || soft-space value soft-space
		serializationSteps[9] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.DATA_TYPE_CS__IS_PRIMITIVE, 19 /* 'primitive' */, 7);
		// 10: DataTypeCS::isSerializable?='serializable' || soft-space value soft-space
		serializationSteps[10] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.DATA_TYPE_CS__IS_SERIALIZABLE, 20 /* 'serializable' */, 7);
		// 11: EnumerationCS::isSerializable?='serializable' || soft-space value soft-space
		serializationSteps[11] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.ENUMERATION_CS__IS_SERIALIZABLE, 20 /* 'serializable' */, 7);
		// 12: EnumerationLiteralCS::literal=SINGLE_QUOTED_STRING || soft-space value soft-space
		serializationSteps[12] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.ENUMERATION_LITERAL_CS__LITERAL, 87 /*SINGLE_QUOTED_STRING*/, 7);
		// 13: MultiplicityBoundsCS::lowerBound=LOWER || soft-space value soft-space
		serializationSteps[13] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.MULTIPLICITY_BOUNDS_CS__LOWER_BOUND, 43 /*LOWER*/, 7);
		// 14: CollectionTypeCS::name=CollectionTypeIdentifier || soft-space value soft-space
		serializationSteps[14] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.COLLECTION_TYPE_CS__NAME, 12 /*CollectionTypeIdentifier*/, 7);
		// 15: MapTypeCS::name='Map' || soft-space value soft-space
		serializationSteps[15] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.MAP_TYPE_CS__NAME, 9 /* 'Map' */, 7);
		// 16: PrimitiveTypeRefCS::name=PrimitiveTypeIdentifier || soft-space value soft-space
		serializationSteps[16] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PRIMITIVE_TYPE_REF_CS__NAME, 82 /*PrimitiveTypeIdentifier*/, 7);
		// 17: TupleTypeCS::name='Tuple' || soft-space value soft-space
		serializationSteps[17] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.TUPLE_TYPE_CS__NAME, 10 /* 'Tuple' */, 7);
		// 18: PackageCS::nsPrefix=UnrestrictedName || soft-space value soft-space
		serializationSteps[18] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PACKAGE_CS__NS_PREFIX, 127 /*UnrestrictedName*/, 7);
		// 19: PackageCS::nsURI=URI || soft-space value soft-space
		serializationSteps[19] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PACKAGE_CS__NS_URI, 121 /*URI*/, 7);
		// 20: TemplateParameterSubstitutionCS::ownedActualParameter=TypeRefCS || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		...
		// 24: PackageCS::ownedClasses+=ClassCS || half-new-line value half-new-line
		serializationSteps[24] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PACKAGE_CS__OWNED_CLASSES, 6 /*ClassCS*/, 3);
		// 25: NavigatingArgCS::ownedCoIterator=CoIteratorVariableCS || value
		...
		// 47: RootCS::ownedImports+=ImportCS || value
		serializationSteps[47] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.ROOT_CS__OWNED_IMPORTS, 38 /*ImportCS*/, 0);
		// 48: LetExpCS::ownedInExpression=ExpCS || value
		...
		// 64: PackageOwnerCS::ownedPackages+=PackageCS || value
		serializationSteps[64] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PACKAGE_OWNER_CS__OWNED_PACKAGES, 71 /*PackageCS*/, 0);
		// 65: OperationCS::ownedParameters+=ParameterCS || value
		...
		// 104: PatternExpCS::patternVariableName=UnrestrictedName || soft-space value soft-space
		serializationSteps[104] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.PATTERN_EXP_CS__PATTERN_VARIABLE_NAME, 127 /*UnrestrictedName*/, 7);
		// 105: NavigatingArgCS::prefix=';' || no-space value soft-new-line
		serializationSteps[105] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__PREFIX, 7 /* ';' */, 5);
		// 106: NavigatingArgCS::prefix=',' || no-space value soft-space
		serializationSteps[106] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__PREFIX, 5 /* ',' */, 6);
		// 107: NavigatingArgCS::prefix='|' || soft-space value soft-space
		serializationSteps[107] = createSerializationStepAssignKeyword(EssentialOCLCSPackage.Literals.NAVIGATING_ARG_CS__PREFIX, 22 /* '|' */, 7);
		// 108: ReferenceCS::referredKeys+=UnrestrictedName || soft-space value soft-space
		serializationSteps[108] = createSerializationStepCrossReference(BaseCSPackage.Literals.REFERENCE_CS__REFERRED_KEYS, getCrossReference(BaseCSPackage.Literals.REFERENCE_CS__REFERRED_KEYS, "UnrestrictedName"), 127, 7);
		// 109: ReferenceCS::referredOpposite=UnrestrictedName || soft-space value soft-space
		serializationSteps[109] = createSerializationStepCrossReference(BaseCSPackage.Literals.REFERENCE_CS__REFERRED_OPPOSITE, getCrossReference(BaseCSPackage.Literals.REFERENCE_CS__REFERRED_OPPOSITE, "UnrestrictedName"), 127, 7);
		// 110: ShadowPartCS::referredProperty=UnrestrictedName || soft-space value soft-space
		serializationSteps[110] = createSerializationStepCrossReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__REFERRED_PROPERTY, getCrossReference(EssentialOCLCSPackage.Literals.SHADOW_PART_CS__REFERRED_PROPERTY, "UnrestrictedName"), 127, 7);
		// 111: CollectionPatternCS::restVariableName=Identifier || soft-space value soft-space
		serializationSteps[111] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.COLLECTION_PATTERN_CS__REST_VARIABLE_NAME, 35 /*Identifier*/, 7);
		// 112: StringLiteralExpCS::segments+=StringLiteral || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		...
		// 113: MultiplicityStringCS::stringBounds='*|+|?' || soft-space value soft-space
		serializationSteps[113] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.MULTIPLICITY_STRING_CS__STRING_BOUNDS, 4 /* '*|+|?' */, 7);
		// 114: BooleanLiteralExpCS::symbol='false|true' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		...
		// 116: MultiplicityBoundsCS::upperBound=UPPER || soft-space value soft-space
		serializationSteps[116] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.MULTIPLICITY_BOUNDS_CS__UPPER_BOUND, 120 /*UPPER*/, 7);
		// 117: DocumentationCS::value=SINGLE_QUOTED_STRING || soft-space value soft-space
		serializationSteps[117] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.DOCUMENTATION_CS__VALUE, 87 /*SINGLE_QUOTED_STRING*/, 7);
		// 118: EnumerationLiteralCS::value=SIGNED || soft-space value soft-space
		serializationSteps[118] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.ENUMERATION_LITERAL_CS__VALUE, 85 /*SIGNED*/, 7);
		// 119: DetailCS::values+=SINGLE_QUOTED_STRING|ML_SINGLE_QUOTED_STRING || soft-space value soft-space
		serializationSteps[119] = createSerializationStepAssigns(BaseCSPackage.Literals.DETAIL_CS__VALUES, -1, new int[] { 87/*SINGLE_QUOTED_STRING*/,48/*ML_SINGLE_QUOTED_STRING*/}, 7);
		// 120: '!serializable' || soft-space value soft-space
		serializationSteps[120] = createSerializationStepKeyword("!serializable", 7);
		// 121: '#' || no-space value no-space
		serializationSteps[121] = createSerializationStepKeyword("#", 4);
		// 122: '&&' || soft-space value soft-space
		serializationSteps[122] = createSerializationStepKeyword("&&", 7);
		// 123: '(' || no-space value no-space
		serializationSteps[123] = createSerializationStepKeyword("(", 4);
		// 124: ')' || no-space value
		serializationSteps[124] = createSerializationStepKeyword(")", 1);
		// 125: '*' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[125] = createSerializationStepKeyword("*", 2);
		// 126: '++' || soft-space value soft-space
		serializationSteps[126] = createSerializationStepKeyword("++", 7);
		// 127: ',' || no-space value soft-space
		serializationSteps[127] = createSerializationStepKeyword(",", 6);
		// 128: '..' || no-space value no-space
		serializationSteps[128] = createSerializationStepKeyword("..", 4);
		// 129: ':' || no-space value soft-space
		serializationSteps[129] = createSerializationStepKeyword(":", 6);
		// 130: ':' || soft-space value soft-space
		serializationSteps[130] = createSerializationStepKeyword(":", 7);
		// 131: '::' || no-space value no-space
		serializationSteps[131] = createSerializationStepKeyword("::", 4);
		// 132: ';' || no-space value soft-new-line
		serializationSteps[132] = createSerializationStepKeyword(";", 5);
		// 133: '<-' || soft-space value soft-space
		serializationSteps[133] = createSerializationStepKeyword("<-", 7);
		// 134: '<' || soft-space value soft-space
		serializationSteps[134] = createSerializationStepKeyword("<", 7);
		// 135: '=' || soft-space value soft-space
		serializationSteps[135] = createSerializationStepKeyword("=", 7);
		// 136: '>' || soft-space value soft-space
		serializationSteps[136] = createSerializationStepKeyword(">", 7);
		// 137: '?' || soft-space value soft-space
		serializationSteps[137] = createSerializationStepKeyword("?", 7);
		// 138: 'Lambda' || soft-space value soft-space
		serializationSteps[138] = createSerializationStepKeyword("Lambda", 7);
		// 139: 'Tuple' || soft-space value soft-space
		serializationSteps[139] = createSerializationStepKeyword("Tuple", 7);
		// 140: '[' || no-space value no-space
		serializationSteps[140] = createSerializationStepKeyword("[", 4);
		// 141: ']' || no-space value
		serializationSteps[141] = createSerializationStepKeyword("]", 1);
		// 142: 'annotation' || soft-space value soft-space
		serializationSteps[142] = createSerializationStepKeyword("annotation", 7);
		// 143: 'attribute' || soft-space value soft-space
		serializationSteps[143] = createSerializationStepKeyword("attribute", 7);
		// 144: 'body' || soft-space value soft-space
		serializationSteps[144] = createSerializationStepKeyword("body", 7);
		// 145: 'class' || soft-space value soft-space
		serializationSteps[145] = createSerializationStepKeyword("class", 7);
		// 146: 'datatype' || soft-space value soft-space
		serializationSteps[146] = createSerializationStepKeyword("datatype", 7);
		// 147: 'derivation' || soft-space value soft-space
		serializationSteps[147] = createSerializationStepKeyword("derivation", 7);
		// 148: 'documentation' || soft-space value soft-space
		serializationSteps[148] = createSerializationStepKeyword("documentation", 7);
		// 149: 'else' || soft-space value soft-space
		serializationSteps[149] = createSerializationStepKeyword("else", 7);
		// 150: 'elseif' || soft-space value soft-space
		serializationSteps[150] = createSerializationStepKeyword("elseif", 7);
		// 151: 'endif' || soft-space value soft-space
		serializationSteps[151] = createSerializationStepKeyword("endif", 7);
		// 152: 'enum' || soft-space value soft-space
		serializationSteps[152] = createSerializationStepKeyword("enum", 7);
		// 153: 'extends' || soft-space value soft-space
		serializationSteps[153] = createSerializationStepKeyword("extends", 7);
		// 154: 'if' || soft-space value soft-space
		serializationSteps[154] = createSerializationStepKeyword("if", 7);
		// 155: 'import' || value
		serializationSteps[155] = createSerializationStepKeyword("import", 0);
		// 156: 'in' || soft-space value soft-space
		serializationSteps[156] = createSerializationStepKeyword("in", 7);
		// 157: 'initial' || soft-space value soft-space
		serializationSteps[157] = createSerializationStepKeyword("initial", 7);
		// 158: 'invalid' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[158] = createSerializationStepKeyword("invalid", 2);
		// 159: 'key' || soft-space value soft-space
		serializationSteps[159] = createSerializationStepKeyword("key", 7);
		// 160: 'let' || soft-space value soft-space
		serializationSteps[160] = createSerializationStepKeyword("let", 7);
		// 161: 'literal' || soft-space value soft-space
		serializationSteps[161] = createSerializationStepKeyword("literal", 7);
		// 162: 'module' || soft-space value soft-space
		serializationSteps[162] = createSerializationStepKeyword("module", 7);
		// 163: 'null' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[163] = createSerializationStepKeyword("null", 2);
		// 164: 'operation' || soft-space value soft-space
		serializationSteps[164] = createSerializationStepKeyword("operation", 7);
		// 165: 'opposite' || soft-space value soft-space
		serializationSteps[165] = createSerializationStepKeyword("opposite", 7);
		// 166: 'package' || soft-space value soft-space
		serializationSteps[166] = createSerializationStepKeyword("package", 7);
		// 167: 'pre' || soft-space value soft-space
		serializationSteps[167] = createSerializationStepKeyword("pre", 7);
		// 168: 'property' || soft-space value soft-space
		serializationSteps[168] = createSerializationStepKeyword("property", 7);
		// 169: 'reference' || soft-space value soft-space
		serializationSteps[169] = createSerializationStepKeyword("reference", 7);
		// 170: 'self' || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[170] = createSerializationStepKeyword("self", 2);
		// 171: 'sysml' || soft-space value soft-space
		serializationSteps[171] = createSerializationStepKeyword("sysml", 7);
		// 172: 'then' || soft-space value soft-space
		serializationSteps[172] = createSerializationStepKeyword("then", 7);
		// 173: 'throws' || soft-space value soft-space
		serializationSteps[173] = createSerializationStepKeyword("throws", 7);
		// 174: '{' || soft-space value soft-space
		serializationSteps[174] = createSerializationStepKeyword("{", 7);
		// 175: '{' || soft-space value push soft-new-line
		serializationSteps[175] = createSerializationStepKeyword("{", 9);
		// 176: '|?' || no-space value no-space
		serializationSteps[176] = createSerializationStepKeyword("|?", 4);
		// 177: '}' || soft-space value soft-space
		serializationSteps[177] = createSerializationStepKeyword("}", 7);
		// 178: '}' || pop soft-space value soft-new-line
		serializationSteps[178] = createSerializationStepKeyword("}", 8);
		// 179: V00*1-steps || value
		serializationSteps[179] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 1, 0);
		// 180: V00*1-steps || value
		serializationSteps[180] = createSerializationStepSequence((0/*V0*/ << 4) | 2/*[*]*/, 1, 0);
		// 181: V00*1-steps || value
		serializationSteps[181] = createSerializationStepSequence((0/*V0*/ << 4) | 3/*[+]*/, 1, 0);
		// 182: V00*2-steps || value
		serializationSteps[182] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 2, 0);
		// 183: V00*2-steps || value
		serializationSteps[183] = createSerializationStepSequence((0/*V0*/ << 4) | 2/*[*]*/, 2, 0);
		// 184: V00*3-steps || value
		serializationSteps[184] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 3, 0);
		// 185: V00*4-steps || value
		serializationSteps[185] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 4, 0);
		// 186: V00*5-steps || value
		serializationSteps[186] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 5, 0);
		// 187: V00*6-steps || value
		serializationSteps[187] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 6, 0);
		// 188: V00*7-steps || value
		serializationSteps[188] = createSerializationStepSequence((0/*V0*/ << 4) | 1/*[?]*/, 7, 0);
		// 189: V01*1-steps || value
		serializationSteps[189] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 1, 0);
		// 190: V01*1-steps || value
		serializationSteps[190] = createSerializationStepSequence((1/*V1*/ << 4) | 2/*[*]*/, 1, 0);
		// 191: V01*1-steps || value
		serializationSteps[191] = createSerializationStepSequence((1/*V1*/ << 4) | 3/*[+]*/, 1, 0);
		// 192: V01*2-steps || value
		serializationSteps[192] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 2, 0);
		// 193: V01*2-steps || value
		serializationSteps[193] = createSerializationStepSequence((1/*V1*/ << 4) | 2/*[*]*/, 2, 0);
		// 194: V01*3-steps || value
		serializationSteps[194] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 3, 0);
		// 195: V01*4-steps || value
		serializationSteps[195] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 4, 0);
		// 196: V01*5-steps || value
		serializationSteps[196] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 5, 0);
		// 197: V01*6-steps || value
		serializationSteps[197] = createSerializationStepSequence((1/*V1*/ << 4) | 1/*[?]*/, 6, 0);
		// 198: V10*1-steps || value
		serializationSteps[198] = createSerializationStepSequence((10/*V10*/ << 4) | 1/*[?]*/, 1, 0);
		// 199: V10*1-steps || value
		serializationSteps[199] = createSerializationStepSequence((10/*V10*/ << 4) | 2/*[*]*/, 1, 0);
		// 200: V10*2-steps || value
		serializationSteps[200] = createSerializationStepSequence((10/*V10*/ << 4) | 2/*[*]*/, 2, 0);
		// 201: V10*6-steps || value
		serializationSteps[201] = createSerializationStepSequence((10/*V10*/ << 4) | 2/*[*]*/, 6, 0);
		// 202: V11*1-steps || value
		serializationSteps[202] = createSerializationStepSequence((11/*V11*/ << 4) | 2/*[*]*/, 1, 0);
		// 203: V11*2-steps || value
		serializationSteps[203] = createSerializationStepSequence((11/*V11*/ << 4) | 2/*[*]*/, 2, 0);
		// 204: V12*1-steps || value
		serializationSteps[204] = createSerializationStepSequence((12/*V12*/ << 4) | 2/*[*]*/, 1, 0);
		// 205: V12*2-steps || value
		serializationSteps[205] = createSerializationStepSequence((12/*V12*/ << 4) | 2/*[*]*/, 2, 0);
		// 206: V13*1-steps || value
		serializationSteps[206] = createSerializationStepSequence((13/*V13*/ << 4) | 2/*[*]*/, 1, 0);
		// 207: V02*1-steps || value
		serializationSteps[207] = createSerializationStepSequence((2/*V2*/ << 4) | 1/*[?]*/, 1, 0);
		// 208: V02*1-steps || value
		serializationSteps[208] = createSerializationStepSequence((2/*V2*/ << 4) | 2/*[*]*/, 1, 0);
		// 209: V02*1-steps || value
		serializationSteps[209] = createSerializationStepSequence((2/*V2*/ << 4) | 3/*[+]*/, 1, 0);
		// 210: V02*2-steps || value
		serializationSteps[210] = createSerializationStepSequence((2/*V2*/ << 4) | 1/*[?]*/, 2, 0);
		// 211: V02*2-steps || value
		serializationSteps[211] = createSerializationStepSequence((2/*V2*/ << 4) | 2/*[*]*/, 2, 0);
		// 212: V02*3-steps || value
		serializationSteps[212] = createSerializationStepSequence((2/*V2*/ << 4) | 1/*[?]*/, 3, 0);
		// 213: V02*4-steps || value
		serializationSteps[213] = createSerializationStepSequence((2/*V2*/ << 4) | 1/*[?]*/, 4, 0);
		// 214: V02*5-steps || value
		serializationSteps[214] = createSerializationStepSequence((2/*V2*/ << 4) | 1/*[?]*/, 5, 0);
		// 215: V03*1-steps || value
		serializationSteps[215] = createSerializationStepSequence((3/*V3*/ << 4) | 1/*[?]*/, 1, 0);
		// 216: V03*1-steps || value
		serializationSteps[216] = createSerializationStepSequence((3/*V3*/ << 4) | 2/*[*]*/, 1, 0);
		// 217: V03*1-steps || value
		serializationSteps[217] = createSerializationStepSequence((3/*V3*/ << 4) | 3/*[+]*/, 1, 0);
		// 218: V03*2-steps || value
		serializationSteps[218] = createSerializationStepSequence((3/*V3*/ << 4) | 1/*[?]*/, 2, 0);
		// 219: V03*2-steps || value
		serializationSteps[219] = createSerializationStepSequence((3/*V3*/ << 4) | 2/*[*]*/, 2, 0);
		// 220: V03*3-steps || value
		serializationSteps[220] = createSerializationStepSequence((3/*V3*/ << 4) | 1/*[?]*/, 3, 0);
		// 221: V03*4-steps || value
		serializationSteps[221] = createSerializationStepSequence((3/*V3*/ << 4) | 1/*[?]*/, 4, 0);
		// 222: V04*1-steps || value
		serializationSteps[222] = createSerializationStepSequence((4/*V4*/ << 4) | 2/*[*]*/, 1, 0);
		// 223: V04*1-steps || value
		serializationSteps[223] = createSerializationStepSequence((4/*V4*/ << 4) | 3/*[+]*/, 1, 0);
		// 224: V04*2-steps || value
		serializationSteps[224] = createSerializationStepSequence((4/*V4*/ << 4) | 1/*[?]*/, 2, 0);
		// 225: V04*4-steps || value
		serializationSteps[225] = createSerializationStepSequence((4/*V4*/ << 4) | 1/*[?]*/, 4, 0);
		// 226: V04*5-steps || value
		serializationSteps[226] = createSerializationStepSequence((4/*V4*/ << 4) | 1/*[?]*/, 5, 0);
		// 227: V04*5-steps || value
		serializationSteps[227] = createSerializationStepSequence((4/*V4*/ << 4) | 2/*[*]*/, 5, 0);
		// 228: V05*1-steps || value
		serializationSteps[228] = createSerializationStepSequence((5/*V5*/ << 4) | 1/*[?]*/, 1, 0);
		// 229: V05*1-steps || value
		serializationSteps[229] = createSerializationStepSequence((5/*V5*/ << 4) | 2/*[*]*/, 1, 0);
		// 230: V05*1-steps || value
		serializationSteps[230] = createSerializationStepSequence((5/*V5*/ << 4) | 3/*[+]*/, 1, 0);
		// 231: V05*2-steps || value
		serializationSteps[231] = createSerializationStepSequence((5/*V5*/ << 4) | 2/*[*]*/, 2, 0);
		// 232: V05*4-steps || value
		serializationSteps[232] = createSerializationStepSequence((5/*V5*/ << 4) | 1/*[?]*/, 4, 0);
		// 233: V05*5-steps || value
		serializationSteps[233] = createSerializationStepSequence((5/*V5*/ << 4) | 1/*[?]*/, 5, 0);
		// 234: V05*5-steps || value
		serializationSteps[234] = createSerializationStepSequence((5/*V5*/ << 4) | 2/*[*]*/, 5, 0);
		// 235: V06*1-steps || value
		serializationSteps[235] = createSerializationStepSequence((6/*V6*/ << 4) | 1/*[?]*/, 1, 0);
		// 236: V06*2-steps || value
		serializationSteps[236] = createSerializationStepSequence((6/*V6*/ << 4) | 2/*[*]*/, 2, 0);
		// 237: V06*4-steps || value
		serializationSteps[237] = createSerializationStepSequence((6/*V6*/ << 4) | 1/*[?]*/, 4, 0);
		// 238: V06*5-steps || value
		serializationSteps[238] = createSerializationStepSequence((6/*V6*/ << 4) | 2/*[*]*/, 5, 0);
		// 239: V07*1-steps || value
		serializationSteps[239] = createSerializationStepSequence((7/*V7*/ << 4) | 1/*[?]*/, 1, 0);
		// 240: V07*1-steps || value
		serializationSteps[240] = createSerializationStepSequence((7/*V7*/ << 4) | 2/*[*]*/, 1, 0);
		// 241: V07*1-steps || value
		serializationSteps[241] = createSerializationStepSequence((7/*V7*/ << 4) | 3/*[+]*/, 1, 0);
		// 242: V07*4-steps || value
		serializationSteps[242] = createSerializationStepSequence((7/*V7*/ << 4) | 1/*[?]*/, 4, 0);
		// 243: V07*5-steps || value
		serializationSteps[243] = createSerializationStepSequence((7/*V7*/ << 4) | 2/*[*]*/, 5, 0);
		// 244: V08*1-steps || value
		serializationSteps[244] = createSerializationStepSequence((8/*V8*/ << 4) | 1/*[?]*/, 1, 0);
		// 245: V08*1-steps || value
		serializationSteps[245] = createSerializationStepSequence((8/*V8*/ << 4) | 2/*[*]*/, 1, 0);
		// 246: V08*1-steps || value
		serializationSteps[246] = createSerializationStepSequence((8/*V8*/ << 4) | 3/*[+]*/, 1, 0);
		// 247: V08*5-steps || value
		serializationSteps[247] = createSerializationStepSequence((8/*V8*/ << 4) | 2/*[*]*/, 5, 0);
		// 248: V09*1-steps || value
		serializationSteps[248] = createSerializationStepSequence((9/*V9*/ << 4) | 1/*[?]*/, 1, 0);
		// 249: V09*1-steps || value
		serializationSteps[249] = createSerializationStepSequence((9/*V9*/ << 4) | 2/*[*]*/, 1, 0);
		// 250: V09*5-steps || value
		serializationSteps[250] = createSerializationStepSequence((9/*V9*/ << 4) | 2/*[*]*/, 5, 0);
		// 251: V09*6-steps || value
		serializationSteps[251] = createSerializationStepSequence((9/*V9*/ << 4) | 2/*[*]*/, 6, 0);
		// 252: wrapper || org.eclipse.ocl.xtext.base.serializer.BaseCommentSegmentSupport value
		serializationSteps[252] = createSerializationStepWrapper(2);
		// 253: NamedElementCS::name=UnaryOperatorName || soft-space value soft-space
		serializationSteps[253] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 124 /*UnaryOperatorName*/, 7);
		// 254: NamedElementCS::name=UnrestrictedName || soft-space value soft-space
		serializationSteps[254] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 127 /*UnrestrictedName*/, 7);
		// 255: NamedElementCS::name=UnrestrictedName|SINGLE_QUOTED_STRING || soft-space value soft-space
		serializationSteps[255] = createSerializationStepAssigns(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, -1, new int[] { 127/*UnrestrictedName*/,87/*SINGLE_QUOTED_STRING*/}, 7);
		// 256: NamedElementCS::name=EnumerationLiteralName || soft-space value soft-space
		serializationSteps[256] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 23 /*EnumerationLiteralName*/, 7);
		// 257: NamedElementCS::name=BinaryOperatorName || soft-space value soft-space
		serializationSteps[257] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.NAMED_ELEMENT_CS__NAME, 4 /*BinaryOperatorName*/, 7);
		// 258: RoundBracketedClauseCS::ownedArguments+=NavigatingArgCS || value
		serializationSteps[258] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.ROUND_BRACKETED_CLAUSE_CS__OWNED_ARGUMENTS, 60 /*NavigatingArgCS*/, 0);
		// 259: RoundBracketedClauseCS::ownedArguments+=NavigatingCommaArgCS|NavigatingSemiArgCS|NavigatingBarArgCS || value
		serializationSteps[259] = createSerializationStepAssigns(EssentialOCLCSPackage.Literals.ROUND_BRACKETED_CLAUSE_CS__OWNED_ARGUMENTS, -1, new int[] { 63/*NavigatingCommaArgCS*/,64/*NavigatingSemiArgCS*/,62/*NavigatingBarArgCS*/}, 0);
		// 260: PathNameCS::ownedPathElements+=URIFirstPathElementCS || value
		serializationSteps[260] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 122 /*URIFirstPathElementCS*/, 0);
		// 261: PathNameCS::ownedPathElements+=FirstPathElementCS || value
		serializationSteps[261] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 31 /*FirstPathElementCS*/, 0);
		// 262: PathNameCS::ownedPathElements+=NextPathElementCS || value
		serializationSteps[262] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.PATH_NAME_CS__OWNED_PATH_ELEMENTS, 67 /*NextPathElementCS*/, 0);
		// 263: OperatorExpCS::ownedRight=ExpCS || value
		serializationSteps[263] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 30 /*ExpCS*/, 0);
		// 264: OperatorExpCS::ownedRight=PrefixedLetExpCS || value
		serializationSteps[264] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 77 /*PrefixedLetExpCS*/, 0);
		// 265: OperatorExpCS::ownedRight=PrefixedPrimaryExpCS || value
		serializationSteps[265] = createSerializationStepAssignedRuleCall(EssentialOCLCSPackage.Literals.OPERATOR_EXP_CS__OWNED_RIGHT, 78 /*PrefixedPrimaryExpCS*/, 0);
		// 266: TypedElementCS::ownedType=TypeExpCS || value
		serializationSteps[266] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE, 107 /*TypeExpCS*/, 0);
		// 267: TypedElementCS::ownedType=TypedMultiplicityRefCS || value
		serializationSteps[267] = createSerializationStepAssignedRuleCall(BaseCSPackage.Literals.TYPED_ELEMENT_CS__OWNED_TYPE, 116 /*TypedMultiplicityRefCS*/, 0);
		// 268: TypedElementCS::qualifiers+='!composes|!derived|!ordered|!readonly|!resolve|!transient|!unique|!unsettable|!volatile|composes|derived|ordered|readonly|resolve|transient|unique|unsettable|volatile' || soft-space value soft-space
		serializationSteps[268] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.TYPED_ELEMENT_CS__QUALIFIERS, 0 /* '!composes|!derived|!ordered|!readonly|!resolve|!transient|!unique|!unsettable|!volatile|composes|derived|ordered|readonly|resolve|transient|unique|unsettable|volatile' */, 7);
		// 269: TypedElementCS::qualifiers+='!derived|!id|!ordered|!readonly|!transient|!unique|!unsettable|!volatile|derived|id|ordered|readonly|transient|unique|unsettable|volatile' || soft-space value soft-space
		serializationSteps[269] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.TYPED_ELEMENT_CS__QUALIFIERS, 1 /* '!derived|!id|!ordered|!readonly|!transient|!unique|!unsettable|!volatile|derived|id|ordered|readonly|transient|unique|unsettable|volatile' */, 7);
		// 270: TypedElementCS::qualifiers+='!derived|!ordered|!transient|!unique|derived|ordered|transient|unique' || soft-space value soft-space
		serializationSteps[270] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.TYPED_ELEMENT_CS__QUALIFIERS, 2 /* '!derived|!ordered|!transient|!unique|derived|ordered|transient|unique' */, 7);
		// 271: TypedElementCS::qualifiers+='!ordered|!unique|ordered|unique' || soft-space value soft-space
		serializationSteps[271] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.TYPED_ELEMENT_CS__QUALIFIERS, 3 /* '!ordered|!unique|ordered|unique' */, 7);
		// 272: TypedElementCS::qualifiers+='definition' || soft-space value soft-space
		serializationSteps[272] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.TYPED_ELEMENT_CS__QUALIFIERS, 13 /* 'definition' */, 7);
		// 273: TypedElementCS::qualifiers+='static' || soft-space value soft-space
		serializationSteps[273] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.TYPED_ELEMENT_CS__QUALIFIERS, 21 /* 'static' */, 7);
		// 274: PathElementCS::referredElement=URI || soft-space value soft-space
		serializationSteps[274] = createSerializationStepCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, getCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, "URI"), 121, 7);
		// 275: PathElementCS::referredElement=UnreservedName || soft-space value soft-space
		serializationSteps[275] = createSerializationStepCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, getCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, "UnreservedName"), 126, 7);
		// 276: PathElementCS::referredElement=UnrestrictedName || soft-space value soft-space
		serializationSteps[276] = createSerializationStepCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, getCrossReference(BaseCSPackage.Literals.PATH_ELEMENT_CS__REFERRED_ELEMENT, "UnrestrictedName"), 127, 7);
		// 277: ConstraintCS::stereotype='invariant' || soft-space value soft-space
		serializationSteps[277] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.CONSTRAINT_CS__STEREOTYPE, 16 /* 'invariant' */, 7);
		// 278: ConstraintCS::stereotype='postcondition' || soft-space value soft-space
		serializationSteps[278] = createSerializationStepAssignKeyword(BaseCSPackage.Literals.CONSTRAINT_CS__STEREOTYPE, 17 /* 'postcondition' */, 7);
		// 279: ConstraintCS::stereotype='precondition' || soft-space value soft-space
