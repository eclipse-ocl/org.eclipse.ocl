...
public class OCLinEcoreAS2CS extends EssentialOCLAS2CS
{
	...
	public OCLinEcoreAS2CS(@NonNull Map<@NonNull ? extends BaseCSResource, @NonNull ? extends ASResource> cs2asResourceMap, @NonNull EnvironmentFactoryInternal environmentFactory) {
	...
	public @NonNull BaseReferenceVisitor createDefaultExpressionVisitor(@NonNull AS2CSConversion conversion) {
		return new EssentialOCLExpressionVisitor(conversion);
	}
}
