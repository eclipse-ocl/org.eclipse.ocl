...
import org.eclipse.ocl.xtext.base.serializer.UserSlotAnalysis.CountedSlotAnalysis;
import org.eclipse.ocl.xtext.base.serializer.UserSlotAnalysis.EnumeratedSlotAnalysis;
...
public class UserElementAnalysis implements Nameable
{
	...
	protected final @NonNull EClassValue eClassifierValue;
	protected final @NonNull String name;
	/**
	 * The subset of the static SerializationRules that are compatible with
	...
	public UserElementAnalysis(@NonNull UserModelAnalysis modelAnalysis, @Nullable UserElementAnalysis containingElementAnalysis, @NonNull EObject eObject) {
		...
		this.eClassifierValue = serializationMetaData.getEClassValue(eClass);
...
//	}
	...
	public void toString(@NonNull DiagnosticStringBuilder s, int depth) {
		s.append(getName());
		s.append(" - ");
		EClassifier eClassifier = eClassifierValue.getEClass();
		s.append(SerializationUtils.getName(SerializationUtils.getEPackage(eClassifier)));
		s.append("::");
		s.append(SerializationUtils.getName(eClassifier));
		for (@NonNull SerializationRule serializationRule : serializationRules) {
