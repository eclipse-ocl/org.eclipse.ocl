...
//	}
	...
	/**
	 * Create and use a new serializer to serialize element to the serializationBuilder.
	 */
	public void serializeElement(@NonNull SerializationBuilder serializationBuilder, @NonNull EObject element, @NonNull ParserRuleValue targetRuleValue) {
		modelAnalysis.serialize(serializationBuilder, element, targetRuleValue);
	}
/*	public void serializeElement(@NonNull SerializationBuilder serializationBuilder, Object element, @NonNull DataTypeRuleValue targetRuleValue) {
		modelAnalysis.serialize(serializationBuilder, element, targetRuleValue);
	} */
