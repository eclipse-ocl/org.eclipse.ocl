 ...
 */
public class EAttributeCardinalityExpression0 extends EAttributeCardinalityExpression
{
	public EAttributeCardinalityExpression0(@NonNull String name, @NonNull EAttribute eAttribute, @NonNull EnumerationValue enumerationValue) {
