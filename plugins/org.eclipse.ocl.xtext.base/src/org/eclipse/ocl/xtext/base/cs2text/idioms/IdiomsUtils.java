...
public class IdiomsUtils
{
	...
	private static final @NonNull StringSegment SOFT_NEW_LINE = createStringSegment(IDIOM_MODEL, SerializationBuilder.SOFT_NEW_LINE);
	private static final @NonNull StringSegment SOFT_SPACE = createStringSegment(IDIOM_MODEL, SerializationBuilder.SOFT_SPACE);
	private static final @NonNull ValueSegment VALUE_SEGMENT = createValueSegment(IDIOM_MODEL);
