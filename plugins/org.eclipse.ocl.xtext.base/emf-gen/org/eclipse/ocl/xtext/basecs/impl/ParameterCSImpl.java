...
public class ParameterCSImpl extends TypedElementCSImpl implements ParameterCS {
	...
	public void setOwningOperation(OperationCS newOwningOperation) {
		if (newOwningOperation != eInternalContainer() || (eContainerFeatureID() != (10) && newOwningOperation != null))
		{
			...
			if (newOwningOperation != null)
				msgs = ((InternalEObject)newOwningOperation).eInverseAdd(this, 13, OperationCS.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		{
			case 10:
				return eInternalContainer().eInverseRemove(this, 13, OperationCS.class, msgs);
		}
