...
public class BaseCSSwitch<@Nullable T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID)
		{
			...
			case 19:
			{
				LambdaParameterCS lambdaParameterCS = (LambdaParameterCS)theEObject;
				T result = caseLambdaParameterCS(lambdaParameterCS);
				if (result == null) result = caseParameterCS(lambdaParameterCS);
				if (result == null) result = caseTypedElementCS(lambdaParameterCS);
				if (result == null) result = caseNamedElementCS(lambdaParameterCS);
				if (result == null) result = caseModelElementCS(lambdaParameterCS);
				if (result == null) result = casePivotableElementCS(lambdaParameterCS);
				if (result == null) result = caseElementCS(lambdaParameterCS);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case 20:
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Lambda Parameter CS</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Lambda Parameter CS</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLambdaParameterCS(LambdaParameterCS object)
	{
		return null;
	}
