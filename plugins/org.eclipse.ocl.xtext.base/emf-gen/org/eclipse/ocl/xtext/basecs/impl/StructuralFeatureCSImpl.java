...
public abstract class StructuralFeatureCSImpl extends FeatureCSImpl implements StructuralFeatureCS {
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newOwningClass, 12, msgs);
		return msgs;
	}
	...
	public void setOwningClass(StructuredClassCS newOwningClass) {
		if (newOwningClass != eInternalContainer() || (eContainerFeatureID() != (12) && newOwningClass != null))
		{
			...
			eNotify(new ENotificationImpl(this, Notification.SET, 12, newOwningClass, newOwningClass));
	}
	...
	public void setDefault(String newDefault)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 10, oldDefault, default_));
	}
	...
	public EList<SpecificationCS> getOwnedDefaultExpressions()
	{
		...
		{
			ownedDefaultExpressions = new EObjectContainmentEList<SpecificationCS>(SpecificationCS.class, this, 11);
		}
