...
public class BaseCSPackageImpl extends EPackageImpl implements BaseCSPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPathElementCS_Name(), ecorePackage.getEString(), "name", null, 1, 1, PathElementCS.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
