...
public class BaseCSPackageImpl extends EPackageImpl implements BaseCSPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getMultiplicityCS_IsNullFree(), thePivotPackage.getBoolean(), "isNullFree", "false", 0, 1, MultiplicityCS.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
		...
		initEAttribute(getPathElementCS_Name(), thePivotPackage.getString(), "name", null, 1, 1, PathElementCS.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
