...
public class StructuredClassCSImpl extends ClassCSImpl implements StructuredClassCS {
	...
	public EList<OperationCS> getOwnedOperations() {
		...
		{
			ownedOperations = new EObjectContainmentWithInverseEList<OperationCS>(OperationCS.class, this, 13, 16);
		}
	...
	public EList<StructuralFeatureCS> getOwnedProperties() {
		...
		{
			ownedProperties = new EObjectContainmentWithInverseEList<StructuralFeatureCS>(StructuralFeatureCS.class, this, 14, 12);
		}
