...
public class ReferenceCSImpl extends StructuralFeatureCSImpl implements ReferenceCS
{
		...
		if (referredOpposite != null && referredOpposite.eIsProxy())
		{
			...
			if (referredOpposite != oldReferredOpposite)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 14, oldReferredOpposite, referredOpposite));
			}
		}
	...
	public void setReferredOpposite(Property newReferredOpposite)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 14, oldReferredOpposite, referredOpposite));
	}
	...
	public EList<ImplicitOppositeCS> getOwnedImplicitOpposites()
	{
		...
		{
			ownedImplicitOpposites = new EObjectContainmentEList<ImplicitOppositeCS>(ImplicitOppositeCS.class, this, 15);
		}
	...
	public EList<Property> getReferredKeys()
	{
		...
		{
			referredKeys = new EObjectResolvingEList<Property>(Property.class, this, 13);
		}
		return referredKeys;
	}
