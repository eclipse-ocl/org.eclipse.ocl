...
public class TypesValidator
	...
	protected boolean validate(int classifierID, Object value,
		...
		switch (classifierID) {
			...
			case TypesPackage.MESSAGE_TYPE :
				return validateMessageType((MessageType<?, ?, ?>) value,
					diagnostics, context);
			...
			case TypesPackage.SEQUENCE_TYPE :
				return validateSequenceType((SequenceType<?, ?>) value,
					diagnostics, context);
			...
			case TypesPackage.TYPE_TYPE :
				return validateTypeType((TypeType<?, ?>) value, diagnostics,
					context);
			case TypesPackage.VOID_TYPE :
				return validateVoidType((VoidType<?>) value, diagnostics,
					context);
			default :
				return true;
		}
	...
	public boolean validateBagType(BagType<?, ?> bagType,
		...
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(bagType, diagnostics,
				context);
		if (result || diagnostics != null)
			result &= validateBagType_checkCollectionTypeName(bagType,
				diagnostics, context);
		if (result || diagnostics != null)
			result &= validateCollectionType_checkNoInvalidValues(bagType,
				diagnostics, context);
		return result;
	}
	 ...
	 * @generated NOT
	 */
	public boolean validateBagType_checkCollectionTypeName(
			BagType<?, ?> bagType, DiagnosticChain diagnostics,
	...
	public boolean validateCollectionType(CollectionType<?, ?> collectionType,
		...
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(collectionType, diagnostics,
				context);
		if (result || diagnostics != null)
			result &= validateCollectionType_checkCollectionTypeName(
				collectionType, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateCollectionType_checkNoInvalidValues(
				collectionType, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateCollectionType_checkCollectionTypeName(
	 ...
	 * @generated
	 */
	public boolean validateCollectionType_checkNoInvalidValues(
			CollectionType<?, ?> collectionType, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
	...
	public boolean validateElementType(ElementType elementType,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(elementType, diagnostics,
			context);
	}
	...
	public boolean validateInvalidType(InvalidType<?> invalidType,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(invalidType, diagnostics,
			context);
	}
	...
	public boolean validateMessageType(MessageType<?, ?, ?> messageType,
		...
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(messageType, diagnostics,
				context);
		if (result || diagnostics != null)
			result &= validateMessageType_checkExclusiveSignature(messageType,
				diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMessageType_checkOperationParameters(messageType,
				diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMessageType_checkSignalAttributes(messageType,
				diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateMessageType_checkExclusiveSignature(
	 ...
	 * @generated
	 */
	public boolean validateMessageType_checkOperationParameters(
			MessageType<?, ?, ?> messageType, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateMessageType_checkSignalAttributes(
			MessageType<?, ?, ?> messageType, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
	...
	public boolean validateOrderedSetType(OrderedSetType<?, ?> orderedSetType,
		...
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(orderedSetType, diagnostics,
				context);
		if (result || diagnostics != null)
			result &= validateOrderedSetType_checkCollectionTypeName(
				orderedSetType, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateCollectionType_checkNoInvalidValues(
				orderedSetType, diagnostics, context);
	 ...
	 * @generated NOT
	 */
	public boolean validateOrderedSetType_checkCollectionTypeName(
			OrderedSetType<?, ?> orderedSetType, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
	...
	public boolean validatePrimitiveType(PrimitiveType<?> primitiveType,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(primitiveType, diagnostics,
			context);
	}
	 ...
	 * @generated NOT
	 */
	public boolean validateSequenceType_checkCollectionTypeName(
			SequenceType<?, ?> sequenceType, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
	...
	public boolean validateSetType(SetType<?, ?> setType,
		...
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(setType, diagnostics,
				context);
		if (result || diagnostics != null)
			result &= validateSetType_checkCollectionTypeName(setType,
				diagnostics, context);
		if (result || diagnostics != null)
			result &= validateCollectionType_checkNoInvalidValues(setType,
				diagnostics, context);
		return result;
	}
	 ...
	 * @generated NOT
	 */
	public boolean validateSetType_checkCollectionTypeName(
			SetType<?, ?> setType, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
	...
	public boolean validateTupleType(TupleType<?, ?> tupleType,
		...
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(tupleType, diagnostics,
				context);
		if (result || diagnostics != null)
			result &= validateTupleType_checkTupleTypeName(tupleType,
				diagnostics, context);
		if (result || diagnostics != null)
			result &= validateTupleType_checkPartNamesUnique(tupleType,
				diagnostics, context);
		if (result || diagnostics != null)
			result &= validateTupleType_checkFeaturesOnlyProperties(tupleType,
				diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateTupleType_checkTupleTypeName(
	 ...
	 * @generated
	 */
	public boolean validateTupleType_checkPartNamesUnique(
			TupleType<?, ?> tupleType, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateTupleType_checkFeaturesOnlyProperties(
			TupleType<?, ?> tupleType, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
