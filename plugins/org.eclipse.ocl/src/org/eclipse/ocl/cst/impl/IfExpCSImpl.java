...
public class IfExpCSImpl
	...
	public NotificationChain basicSetThenExpression(
			OCLExpressionCS newThenExpression, NotificationChain msgs) {
		OCLExpressionCS oldThenExpression = thenExpression;
		thenExpression = newThenExpression;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET, CSTPackage.IF_EXP_CS__THEN_EXPRESSION,
	...
	public void setThenExpression(OCLExpressionCS newThenExpression) {
		if (newThenExpression != thenExpression) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				CSTPackage.IF_EXP_CS__THEN_EXPRESSION, newThenExpression,
				newThenExpression));
	}
	...
	public NotificationChain basicSetElseExpression(
			OCLExpressionCS newElseExpression, NotificationChain msgs) {
		OCLExpressionCS oldElseExpression = elseExpression;
		elseExpression = newElseExpression;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET, CSTPackage.IF_EXP_CS__ELSE_EXPRESSION,
	...
	public void setElseExpression(OCLExpressionCS newElseExpression) {
		if (newElseExpression != elseExpression) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				CSTPackage.IF_EXP_CS__ELSE_EXPRESSION, newElseExpression,
				newElseExpression));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCondition(OCLExpressionCS newCondition,
		...
		if (newCondition != condition) {
			...
			if (condition != null)
				msgs = ((InternalEObject) condition).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - CSTPackage.IF_EXP_CS__CONDITION,
					null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				CSTPackage.IF_EXP_CS__CONDITION, newCondition, newCondition));
	}
