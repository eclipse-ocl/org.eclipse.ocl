...
public class MessageExpOperations
	 ...
	 * @generated NOT
	 */
	public static <C, COA, SSA> boolean checkOperationArguments(
			MessageExp<C, COA, SSA> messageExp, DiagnosticChain diagnostics,
		...
		if (env != null) {
			UMLReflection<?, C, Object, ?, ?, ?, ?, COA, SSA, ?> uml = env
				.getUMLReflection();
			...
			Object operation = uml
				.getOperation(messageExp.getCalledOperation());
			if (operation == null) {
				return true;
			}
			...
			if (arguments.size() != parameters.size()) {
				...
				Iterator<OCLExpression<C>> argsIter = arguments.iterator();
	 ...
	 * @generated NOT
	 */
	public static <C, COA, SSA> boolean checkSignalArguments(
			MessageExp<C, COA, SSA> messageExp, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		boolean result = true;
		String message = null;
		...
		if (env != null) {
			UMLReflection<?, C, ?, ?, ?, ?, ?, COA, SSA, ?> uml = env
				.getUMLReflection();
	 ...
	 * @generated NOT
	 */
	public static <C, COA, SSA> boolean checkTargetDefinesOperation(
			MessageExp<C, COA, SSA> messageExp, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		boolean result = true;
		Environment<?, C, Object, ?, ?, ?, ?, COA, SSA, ?, ?, ?> env = OCLUtil
	 ...
	 * @generated NOT
	 */
	public static <C, COA, SSA> boolean checkHasOperationOrSignal(
			MessageExp<C, COA, SSA> messageExp, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		boolean result = true;
		String message = null;
	 ...
	 * @generated NOT
	 */
	public static <C, COA, SSA> boolean checkTargetNotCollection(
			MessageExp<C, COA, SSA> messageExp, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		boolean result = true;
