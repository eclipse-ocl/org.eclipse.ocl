...
public class ExpressionInOCLItemProvider
		extends OpaqueExpressionItemProvider {
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0
			? getString("_UI_ExpressionInOCL_type") //$NON-NLS-1$
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
			UtilitiesPackage.Literals.EXPRESSION_IN_OCL__GENERATED_TYPE,
			org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createConnectorEnd()));
		...
		newChildDescriptors.add(createChildParameter(
			UtilitiesPackage.Literals.EXPRESSION_IN_OCL__GENERATED_TYPE,
			org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createStateMachine()));
		...
		newChildDescriptors.add(createChildParameter(
			UtilitiesPackage.Literals.EXPRESSION_IN_OCL__GENERATED_TYPE,
			org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createPrimitiveType()));
