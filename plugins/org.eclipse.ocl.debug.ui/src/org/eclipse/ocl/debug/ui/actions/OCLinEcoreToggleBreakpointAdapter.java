 ...
 *******************************************************************************/
package org.eclipse.ocl.debug.ui.actions;
...
import org.eclipse.ocl.debug.core.OCLLineBreakpoint;
...
import org.eclipse.ocl.debug.vm.ui.actions.VMToggleBreakpointAdapter;
...
public class OCLinEcoreToggleBreakpointAdapter extends VMToggleBreakpointAdapter
{
	...
	public boolean canToggleLineBreakpoints(IWorkbenchPart part, ISelection selection) {
		return part instanceof OCLinEcoreEditor;
	}
	...
	public void toggleLineBreakpoints(final IWorkbenchPart part, ISelection selection) throws CoreException {
		if (part instanceof OCLinEcoreEditor) {
