...
public class OCLstdlibTables extends AbstractTables
{
	...
	public static class Parameters {
		...
		public static final @NonNull ParameterTypes _Lambda_self_$$0_F_result_$$1_F = TypeUtil.createParameterTypes(new ExecutorLambdaType("Lambda", _self_$$0_F, _result_$$1_F));
		public static final @NonNull ParameterTypes _Lambda_self_$$0_F_result_$$2_F = TypeUtil.createParameterTypes(new ExecutorLambdaType("Lambda", _self_$$0_F, _result_$$2_F));
		public static final @NonNull ParameterTypes _Lambda_self_$$0_F_result_Boolean_F = TypeUtil.createParameterTypes(new ExecutorLambdaType("Lambda", _self_$$0_F, _result_Boolean_F));
