...
public class OCLstdlibTables extends AbstractTables
{
	...
	public static class Operations {
		...
		public static final @NonNull Operation _Collection__product = LIBRARY.createOperation(Types._Collection, "product", Parameters._Collection__$$1__, OCLstdlibTables.Types._OclInvalid,
		...
		static {
			_Collection__product.setType(LIBRARY.getCollectionType(OCLstdlibTables.Types._Set, LIBRARY.getTupleType(LIBRARY.getTuplePart("first", LIBRARY.getTemplateParameter(OCLstdlibTables.Operations._Collection__product, TypeParameters.$$0), false), LIBRARY.getTuplePart("second", LIBRARY.getTemplateParameter(OCLstdlibTables.Operations._Collection__product, TypeParameters.$$1), false))));
