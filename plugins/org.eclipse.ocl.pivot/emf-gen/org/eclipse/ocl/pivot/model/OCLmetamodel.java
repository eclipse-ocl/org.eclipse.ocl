...
public class OCLmetamodel extends ASResourceImpl
{
	...
	private static class Contents extends LibraryContents
	{
		...
		private final @NonNull BagType _Bag_Annotation_F = getBagType(_Bag, _Annotation);
		private final @NonNull BagType _Bag_AssociationClassCallExp_F = getBagType(_Bag, _AssociationClassCallExp);
		private final @NonNull BagType _Bag_CallOperationAction_F = getBagType(_Bag, _CallOperationAction);
		private final @NonNull BagType _Bag_Class_F = getBagType(_Bag, _Class);
		private final @NonNull BagType _Bag_CollectionType_F = getBagType(_Bag, _CollectionType);
		private final @NonNull BagType _Bag_CompleteClass_F = getBagType(_Bag, _CompleteClass);
		private final @NonNull BagType _Bag_CompleteModel_F = getBagType(_Bag, _CompleteModel);
		private final @NonNull BagType _Bag_CompletePackage_F = getBagType(_Bag, _CompletePackage);
		private final @NonNull BagType _Bag_ConnectionPointReference_F = getBagType(_Bag, _ConnectionPointReference);
		private final @NonNull BagType _Bag_Constraint_F = getBagType(_Bag, _Constraint);
		private final @NonNull BagType _Bag_DataType_F = getBagType(_Bag, _DataType);
		private final @NonNull BagType _Bag_DynamicElement_F = getBagType(_Bag, _DynamicElement);
		private final @NonNull BagType _Bag_DynamicProperty_F = getBagType(_Bag, _DynamicProperty);
		private final @NonNull BagType _Bag_ElementExtension_F = getBagType(_Bag, _ElementExtension);
		private final @NonNull BagType _Bag_EnumLiteralExp_F = getBagType(_Bag, _EnumLiteralExp);
		private final @NonNull BagType _Bag_Import_F = getBagType(_Bag, _Import);
		private final @NonNull BagType _Bag_InstanceSpecification_F = getBagType(_Bag, _InstanceSpecification);
		private final @NonNull BagType _Bag_LambdaType_F = getBagType(_Bag, _LambdaType);
		private final @NonNull BagType _Bag_LoopExp_F = getBagType(_Bag, _LoopExp);
		private final @NonNull BagType _Bag_MapType_F = getBagType(_Bag, _MapType);
		private final @NonNull BagType _Bag_MessageType_F = getBagType(_Bag, _MessageType);
		private final @NonNull BagType _Bag_NavigationCallExp_F = getBagType(_Bag, _NavigationCallExp);
		private final @NonNull BagType _Bag_OCLExpression_F = getBagType(_Bag, _OCLExpression);
		private final @NonNull BagType _Bag_Operation_F = getBagType(_Bag, _Operation);
		private final @NonNull BagType _Bag_OperationCallExp_F = getBagType(_Bag, _OperationCallExp);
		private final @NonNull BagType _Bag_OppositePropertyCallExp_F = getBagType(_Bag, _OppositePropertyCallExp);
		private final @NonNull BagType _Bag_Package_F = getBagType(_Bag, _Package);
		private final @NonNull BagType _Bag_PrimitiveType_F = getBagType(_Bag, _PrimitiveType);
		private final @NonNull BagType _Bag_Property_F = getBagType(_Bag, _Property);
		private final @NonNull BagType _Bag_PropertyCallExp_F = getBagType(_Bag, _PropertyCallExp);
		private final @NonNull BagType _Bag_Region_F = getBagType(_Bag, _Region);
		private final @NonNull BagType _Bag_SendSignalAction_F = getBagType(_Bag, _SendSignalAction);
		private final @NonNull BagType _Bag_ShadowPart_F = getBagType(_Bag, _ShadowPart);
		private final @NonNull BagType _Bag_Slot_F = getBagType(_Bag, _Slot);
		private final @NonNull BagType _Bag_State_F = getBagType(_Bag, _State);
		private final @NonNull BagType _Bag_StateExp_F = getBagType(_Bag, _StateExp);
		private final @NonNull BagType _Bag_StateMachine_F = getBagType(_Bag, _StateMachine);
		private final @NonNull BagType _Bag_TemplateBinding_F = getBagType(_Bag, _TemplateBinding);
		private final @NonNull BagType _Bag_TemplateParameter_F = getBagType(_Bag, _TemplateParameter);
		private final @NonNull BagType _Bag_TemplateParameterSubstitution_F = getBagType(_Bag, _TemplateParameterSubstitution);
		private final @NonNull BagType _Bag_TemplateableElement_F = getBagType(_Bag, _TemplateableElement);
		private final @NonNull BagType _Bag_TypeExp_F = getBagType(_Bag, _TypeExp);
		private final @NonNull BagType _Bag_TypedElement_F = getBagType(_Bag, _TypedElement);
		private final @NonNull BagType _Bag_Variable_F = getBagType(_Bag, _Variable);
		private final @NonNull BagType _Bag_VariableDeclaration_F = getBagType(_Bag, _VariableDeclaration);
		private final @NonNull BagType _Bag_VariableExp_F = getBagType(_Bag, _VariableExp);
		private final @NonNull BagType _Bag_WildcardType_F = getBagType(_Bag, _WildcardType);
		private final @NonNull CollectionType _Collection_Annotation_F = getCollectionType(_Collection, _Annotation);
		private final @NonNull CollectionType _Collection_AssociationClassCallExp_F = getCollectionType(_Collection, _AssociationClassCallExp);
		private final @NonNull CollectionType _Collection_Behavior_F = getCollectionType(_Collection, _Behavior);
		private final @NonNull CollectionType _Collection_CallOperationAction_F = getCollectionType(_Collection, _CallOperationAction);
		private final @NonNull CollectionType _Collection_Class_F = getCollectionType(_Collection, _Class);
		private final @NonNull CollectionType _Collection_CollectionLiteralPart_F = getCollectionType(_Collection, _CollectionLiteralPart);
		private final @NonNull CollectionType _Collection_CollectionType_F = getCollectionType(_Collection, _CollectionType);
		private final @NonNull CollectionType _Collection_Comment_F = getCollectionType(_Collection, _Comment);
		private final @NonNull CollectionType _Collection_CompleteClass_F = getCollectionType(_Collection, _CompleteClass);
		private final @NonNull CollectionType _Collection_CompleteModel_F = getCollectionType(_Collection, _CompleteModel);
		private final @NonNull CollectionType _Collection_CompletePackage_F = getCollectionType(_Collection, _CompletePackage);
		private final @NonNull CollectionType _Collection_ConnectionPointReference_F = getCollectionType(_Collection, _ConnectionPointReference);
		private final @NonNull CollectionType _Collection_Constraint_F = getCollectionType(_Collection, _Constraint);
		private final @NonNull CollectionType _Collection_DataType_F = getCollectionType(_Collection, _DataType);
		private final @NonNull CollectionType _Collection_Detail_F = getCollectionType(_Collection, _Detail);
		private final @NonNull CollectionType _Collection_DynamicElement_F = getCollectionType(_Collection, _DynamicElement);
		private final @NonNull CollectionType _Collection_DynamicProperty_F = getCollectionType(_Collection, _DynamicProperty);
		private final @NonNull CollectionType _Collection_Element_F = getCollectionType(_Collection, _Element);
		private final @NonNull CollectionType _Collection_ElementExtension_F = getCollectionType(_Collection, _ElementExtension);
		private final @NonNull CollectionType _Collection_EnumLiteralExp_F = getCollectionType(_Collection, _EnumLiteralExp);
		private final @NonNull CollectionType _Collection_EnumerationLiteral_F = getCollectionType(_Collection, _EnumerationLiteral);
		private final @NonNull CollectionType _Collection_Import_F = getCollectionType(_Collection, _Import);
		private final @NonNull CollectionType _Collection_InstanceSpecification_F = getCollectionType(_Collection, _InstanceSpecification);
		private final @NonNull CollectionType _Collection_IteratorVariable_F = getCollectionType(_Collection, _IteratorVariable);
		private final @NonNull CollectionType _Collection_LambdaType_F = getCollectionType(_Collection, _LambdaType);
		private final @NonNull CollectionType _Collection_LoopExp_F = getCollectionType(_Collection, _LoopExp);
		private final @NonNull CollectionType _Collection_MapLiteralPart_F = getCollectionType(_Collection, _MapLiteralPart);
		private final @NonNull CollectionType _Collection_MapType_F = getCollectionType(_Collection, _MapType);
		private final @NonNull CollectionType _Collection_MessageType_F = getCollectionType(_Collection, _MessageType);
		private final @NonNull CollectionType _Collection_Model_F = getCollectionType(_Collection, _Model);
		private final @NonNull CollectionType _Collection_NavigationCallExp_F = getCollectionType(_Collection, _NavigationCallExp);
		private final @NonNull CollectionType _Collection_OCLExpression_F = getCollectionType(_Collection, _OCLExpression);
		private final @NonNull CollectionType _Collection_Operation_F = getCollectionType(_Collection, _Operation);
		private final @NonNull CollectionType _Collection_OperationCallExp_F = getCollectionType(_Collection, _OperationCallExp);
		private final @NonNull CollectionType _Collection_OppositePropertyCallExp_F = getCollectionType(_Collection, _OppositePropertyCallExp);
		private final @NonNull CollectionType _Collection_Package_F = getCollectionType(_Collection, _Package);
		private final @NonNull CollectionType _Collection_Parameter_F = getCollectionType(_Collection, _Parameter);
		private final @NonNull CollectionType _Collection_Precedence_F = getCollectionType(_Collection, _Precedence);
		private final @NonNull CollectionType _Collection_PrimitiveType_F = getCollectionType(_Collection, _PrimitiveType);
		private final @NonNull CollectionType _Collection_ProfileApplication_F = getCollectionType(_Collection, _ProfileApplication);
		private final @NonNull CollectionType _Collection_Property_F = getCollectionType(_Collection, _Property);
		private final @NonNull CollectionType _Collection_PropertyCallExp_F = getCollectionType(_Collection, _PropertyCallExp);
		private final @NonNull CollectionType _Collection_Pseudostate_F = getCollectionType(_Collection, _Pseudostate);
		private final @NonNull CollectionType _Collection_Region_F = getCollectionType(_Collection, _Region);
		private final @NonNull CollectionType _Collection_SendSignalAction_F = getCollectionType(_Collection, _SendSignalAction);
		private final @NonNull CollectionType _Collection_ShadowPart_F = getCollectionType(_Collection, _ShadowPart);
		private final @NonNull CollectionType _Collection_Slot_F = getCollectionType(_Collection, _Slot);
		private final @NonNull CollectionType _Collection_State_F = getCollectionType(_Collection, _State);
		private final @NonNull CollectionType _Collection_StateExp_F = getCollectionType(_Collection, _StateExp);
		private final @NonNull CollectionType _Collection_StateMachine_F = getCollectionType(_Collection, _StateMachine);
		private final @NonNull CollectionType _Collection_StereotypeExtender_F = getCollectionType(_Collection, _StereotypeExtender);
		private final @NonNull CollectionType _Collection_String_F = getCollectionType(_Collection, _String);
		private final @NonNull CollectionType _Collection_TemplateBinding_F = getCollectionType(_Collection, _TemplateBinding);
		private final @NonNull CollectionType _Collection_TemplateParameter_F = getCollectionType(_Collection, _TemplateParameter);
		private final @NonNull CollectionType _Collection_TemplateParameterSubstitution_F = getCollectionType(_Collection, _TemplateParameterSubstitution);
		private final @NonNull CollectionType _Collection_TemplateableElement_F = getCollectionType(_Collection, _TemplateableElement);
		private final @NonNull CollectionType _Collection_Transition_F = getCollectionType(_Collection, _Transition);
		private final @NonNull CollectionType _Collection_Trigger_F = getCollectionType(_Collection, _Trigger);
		private final @NonNull CollectionType _Collection_TupleLiteralPart_F = getCollectionType(_Collection, _TupleLiteralPart);
		private final @NonNull CollectionType _Collection_Type_F = getCollectionType(_Collection, _Type);
		private final @NonNull CollectionType _Collection_TypeExp_F = getCollectionType(_Collection, _TypeExp);
		private final @NonNull CollectionType _Collection_TypedElement_F = getCollectionType(_Collection, _TypedElement);
		private final @NonNull CollectionType _Collection_ValueSpecification_F = getCollectionType(_Collection, _ValueSpecification);
		private final @NonNull CollectionType _Collection_Variable_F = getCollectionType(_Collection, _Variable);
		private final @NonNull CollectionType _Collection_VariableDeclaration_F = getCollectionType(_Collection, _VariableDeclaration);
		private final @NonNull CollectionType _Collection_VariableExp_F = getCollectionType(_Collection, _VariableExp);
		private final @NonNull CollectionType _Collection_Vertex_F = getCollectionType(_Collection, _Vertex);
		private final @NonNull CollectionType _Collection_WildcardType_F = getCollectionType(_Collection, _WildcardType);
		private final @NonNull CollectionType _OrderedCollection_CollectionLiteralPart_F = getCollectionType(_OrderedCollection, _CollectionLiteralPart);
		private final @NonNull CollectionType _OrderedCollection_Detail_F = getCollectionType(_OrderedCollection, _Detail);
		private final @NonNull CollectionType _OrderedCollection_Element_F = getCollectionType(_OrderedCollection, _Element);
		private final @NonNull CollectionType _OrderedCollection_EnumerationLiteral_F = getCollectionType(_OrderedCollection, _EnumerationLiteral);
		private final @NonNull CollectionType _OrderedCollection_Import_F = getCollectionType(_OrderedCollection, _Import);
		private final @NonNull CollectionType _OrderedCollection_IteratorVariable_F = getCollectionType(_OrderedCollection, _IteratorVariable);
		private final @NonNull CollectionType _OrderedCollection_MapLiteralPart_F = getCollectionType(_OrderedCollection, _MapLiteralPart);
		private final @NonNull CollectionType _OrderedCollection_OCLExpression_F = getCollectionType(_OrderedCollection, _OCLExpression);
		private final @NonNull CollectionType _OrderedCollection_Operation_F = getCollectionType(_OrderedCollection, _Operation);
		private final @NonNull CollectionType _OrderedCollection_Parameter_F = getCollectionType(_OrderedCollection, _Parameter);
		private final @NonNull CollectionType _OrderedCollection_Precedence_F = getCollectionType(_OrderedCollection, _Precedence);
		private final @NonNull CollectionType _OrderedCollection_Property_F = getCollectionType(_OrderedCollection, _Property);
		private final @NonNull CollectionType _OrderedCollection_ShadowPart_F = getCollectionType(_OrderedCollection, _ShadowPart);
		private final @NonNull CollectionType _OrderedCollection_TemplateParameter_F = getCollectionType(_OrderedCollection, _TemplateParameter);
		private final @NonNull CollectionType _OrderedCollection_TupleLiteralPart_F = getCollectionType(_OrderedCollection, _TupleLiteralPart);
		private final @NonNull CollectionType _OrderedCollection_Type_F = getCollectionType(_OrderedCollection, _Type);
		private final @NonNull CollectionType _OrderedCollection_ValueSpecification_F = getCollectionType(_OrderedCollection, _ValueSpecification);
		private final @NonNull CollectionType _OrderedCollection_Variable_F = getCollectionType(_OrderedCollection, _Variable);
		private final @NonNull OrderedSetType _OrderedSet_CollectionLiteralPart_T = getOrderedSetType(_OrderedSet, _CollectionLiteralPart);
		private final @NonNull OrderedSetType _OrderedSet_Detail_T = getOrderedSetType(_OrderedSet, _Detail);
		private final @NonNull OrderedSetType _OrderedSet_Element_T = getOrderedSetType(_OrderedSet, _Element);
		private final @NonNull OrderedSetType _OrderedSet_EnumerationLiteral_T = getOrderedSetType(_OrderedSet, _EnumerationLiteral);
		private final @NonNull OrderedSetType _OrderedSet_Import_T = getOrderedSetType(_OrderedSet, _Import);
		private final @NonNull OrderedSetType _OrderedSet_IteratorVariable_F = getOrderedSetType(_OrderedSet, _IteratorVariable);
		private final @NonNull OrderedSetType _OrderedSet_MapLiteralPart_T = getOrderedSetType(_OrderedSet, _MapLiteralPart);
		private final @NonNull OrderedSetType _OrderedSet_OCLExpression_T = getOrderedSetType(_OrderedSet, _OCLExpression);
		private final @NonNull OrderedSetType _OrderedSet_Operation_T = getOrderedSetType(_OrderedSet, _Operation);
		private final @NonNull OrderedSetType _OrderedSet_Parameter_T = getOrderedSetType(_OrderedSet, _Parameter);
		private final @NonNull OrderedSetType _OrderedSet_Precedence_T = getOrderedSetType(_OrderedSet, _Precedence);
		private final @NonNull OrderedSetType _OrderedSet_Property_T = getOrderedSetType(_OrderedSet, _Property);
		private final @NonNull OrderedSetType _OrderedSet_ShadowPart_T = getOrderedSetType(_OrderedSet, _ShadowPart);
		private final @NonNull OrderedSetType _OrderedSet_TemplateParameter_T_L1 = getOrderedSetType(_OrderedSet, _TemplateParameter);
		private final @NonNull OrderedSetType _OrderedSet_TupleLiteralPart_T = getOrderedSetType(_OrderedSet, _TupleLiteralPart);
		private final @NonNull OrderedSetType _OrderedSet_ValueSpecification_T = getOrderedSetType(_OrderedSet, _ValueSpecification);
		private final @NonNull OrderedSetType _OrderedSet_Variable_T = getOrderedSetType(_OrderedSet, _Variable);
		private final @NonNull SequenceType _Sequence_Type_T = getSequenceType(_Sequence, _Type);
		private final @NonNull SetType _Set_Behavior_T = getSetType(_Set, _Behavior);
		private final @NonNull SetType _Set_Class_T = getSetType(_Set, _Class);
		private final @NonNull SetType _Set_Comment_T = getSetType(_Set, _Comment);
		private final @NonNull SetType _Set_CompleteClass_T = getSetType(_Set, _CompleteClass);
		private final @NonNull SetType _Set_CompletePackage_T = getSetType(_Set, _CompletePackage);
		private final @NonNull SetType _Set_ConnectionPointReference_T = getSetType(_Set, _ConnectionPointReference);
		private final @NonNull SetType _Set_Constraint_T = getSetType(_Set, _Constraint);
		private final @NonNull SetType _Set_DynamicProperty_T = getSetType(_Set, _DynamicProperty);
		private final @NonNull SetType _Set_Element_T = getSetType(_Set, _Element);
		private final @NonNull SetType _Set_ElementExtension_T = getSetType(_Set, _ElementExtension);
		private final @NonNull SetType _Set_InstanceSpecification_T = getSetType(_Set, _InstanceSpecification);
		private final @NonNull SetType _Set_Model_T = getSetType(_Set, _Model);
		private final @NonNull SetType _Set_Operation_T = getSetType(_Set, _Operation);
		private final @NonNull SetType _Set_Package_T = getSetType(_Set, _Package);
		private final @NonNull SetType _Set_ProfileApplication_T = getSetType(_Set, _ProfileApplication);
		private final @NonNull SetType _Set_Property_T = getSetType(_Set, _Property);
		private final @NonNull SetType _Set_Pseudostate_T = getSetType(_Set, _Pseudostate);
		private final @NonNull SetType _Set_Region_T = getSetType(_Set, _Region);
		private final @NonNull SetType _Set_Region_T_L1 = getSetType(_Set, _Region);
		private final @NonNull SetType _Set_Slot_T = getSetType(_Set, _Slot);
		private final @NonNull SetType _Set_State_T = getSetType(_Set, _State);
		private final @NonNull SetType _Set_StateMachine_T = getSetType(_Set, _StateMachine);
		private final @NonNull SetType _Set_StereotypeExtender_T = getSetType(_Set, _StereotypeExtender);
		private final @NonNull SetType _Set_String_T_L1 = getSetType(_Set, _String);
		private final @NonNull SetType _Set_TemplateBinding_T = getSetType(_Set, _TemplateBinding);
		private final @NonNull SetType _Set_TemplateParameterSubstitution_T_L1 = getSetType(_Set, _TemplateParameterSubstitution);
		private final @NonNull SetType _Set_Transition_T = getSetType(_Set, _Transition);
		private final @NonNull SetType _Set_Trigger_T = getSetType(_Set, _Trigger);
		private final @NonNull SetType _Set_Type_T = getSetType(_Set, _Type);
		private final @NonNull SetType _Set_Vertex_T = getSetType(_Set, _Vertex);
		private final @NonNull CollectionType _UniqueCollection_Behavior_F = getCollectionType(_UniqueCollection, _Behavior);
		private final @NonNull CollectionType _UniqueCollection_Class_F = getCollectionType(_UniqueCollection, _Class);
		private final @NonNull CollectionType _UniqueCollection_CollectionLiteralPart_F = getCollectionType(_UniqueCollection, _CollectionLiteralPart);
		private final @NonNull CollectionType _UniqueCollection_Comment_F = getCollectionType(_UniqueCollection, _Comment);
		private final @NonNull CollectionType _UniqueCollection_CompleteClass_F = getCollectionType(_UniqueCollection, _CompleteClass);
		private final @NonNull CollectionType _UniqueCollection_CompletePackage_F = getCollectionType(_UniqueCollection, _CompletePackage);
		private final @NonNull CollectionType _UniqueCollection_ConnectionPointReference_F = getCollectionType(_UniqueCollection, _ConnectionPointReference);
		private final @NonNull CollectionType _UniqueCollection_Constraint_F = getCollectionType(_UniqueCollection, _Constraint);
		private final @NonNull CollectionType _UniqueCollection_Detail_F = getCollectionType(_UniqueCollection, _Detail);
		private final @NonNull CollectionType _UniqueCollection_DynamicProperty_F = getCollectionType(_UniqueCollection, _DynamicProperty);
		private final @NonNull CollectionType _UniqueCollection_Element_F = getCollectionType(_UniqueCollection, _Element);
		private final @NonNull CollectionType _UniqueCollection_ElementExtension_F = getCollectionType(_UniqueCollection, _ElementExtension);
		private final @NonNull CollectionType _UniqueCollection_EnumerationLiteral_F = getCollectionType(_UniqueCollection, _EnumerationLiteral);
		private final @NonNull CollectionType _UniqueCollection_Import_F = getCollectionType(_UniqueCollection, _Import);
		private final @NonNull CollectionType _UniqueCollection_InstanceSpecification_F = getCollectionType(_UniqueCollection, _InstanceSpecification);
		private final @NonNull CollectionType _UniqueCollection_IteratorVariable_F = getCollectionType(_UniqueCollection, _IteratorVariable);
		private final @NonNull CollectionType _UniqueCollection_MapLiteralPart_F = getCollectionType(_UniqueCollection, _MapLiteralPart);
		private final @NonNull CollectionType _UniqueCollection_Model_F = getCollectionType(_UniqueCollection, _Model);
		private final @NonNull CollectionType _UniqueCollection_OCLExpression_F = getCollectionType(_UniqueCollection, _OCLExpression);
		private final @NonNull CollectionType _UniqueCollection_Operation_F = getCollectionType(_UniqueCollection, _Operation);
		private final @NonNull CollectionType _UniqueCollection_Package_F = getCollectionType(_UniqueCollection, _Package);
		private final @NonNull CollectionType _UniqueCollection_Parameter_F = getCollectionType(_UniqueCollection, _Parameter);
		private final @NonNull CollectionType _UniqueCollection_Precedence_F = getCollectionType(_UniqueCollection, _Precedence);
		private final @NonNull CollectionType _UniqueCollection_ProfileApplication_F = getCollectionType(_UniqueCollection, _ProfileApplication);
		private final @NonNull CollectionType _UniqueCollection_Property_F = getCollectionType(_UniqueCollection, _Property);
		private final @NonNull CollectionType _UniqueCollection_Pseudostate_F = getCollectionType(_UniqueCollection, _Pseudostate);
		private final @NonNull CollectionType _UniqueCollection_Region_F = getCollectionType(_UniqueCollection, _Region);
		private final @NonNull CollectionType _UniqueCollection_ShadowPart_F = getCollectionType(_UniqueCollection, _ShadowPart);
		private final @NonNull CollectionType _UniqueCollection_Slot_F = getCollectionType(_UniqueCollection, _Slot);
		private final @NonNull CollectionType _UniqueCollection_State_F = getCollectionType(_UniqueCollection, _State);
		private final @NonNull CollectionType _UniqueCollection_StateMachine_F = getCollectionType(_UniqueCollection, _StateMachine);
		private final @NonNull CollectionType _UniqueCollection_StereotypeExtender_F = getCollectionType(_UniqueCollection, _StereotypeExtender);
		private final @NonNull CollectionType _UniqueCollection_String_F = getCollectionType(_UniqueCollection, _String);
		private final @NonNull CollectionType _UniqueCollection_TemplateBinding_F = getCollectionType(_UniqueCollection, _TemplateBinding);
		private final @NonNull CollectionType _UniqueCollection_TemplateParameter_F = getCollectionType(_UniqueCollection, _TemplateParameter);
		private final @NonNull CollectionType _UniqueCollection_TemplateParameterSubstitution_F = getCollectionType(_UniqueCollection, _TemplateParameterSubstitution);
		private final @NonNull CollectionType _UniqueCollection_Transition_F = getCollectionType(_UniqueCollection, _Transition);
		private final @NonNull CollectionType _UniqueCollection_Trigger_F = getCollectionType(_UniqueCollection, _Trigger);
		private final @NonNull CollectionType _UniqueCollection_TupleLiteralPart_F = getCollectionType(_UniqueCollection, _TupleLiteralPart);
		private final @NonNull CollectionType _UniqueCollection_Type_F = getCollectionType(_UniqueCollection, _Type);
		private final @NonNull CollectionType _UniqueCollection_ValueSpecification_F = getCollectionType(_UniqueCollection, _ValueSpecification);
		private final @NonNull CollectionType _UniqueCollection_Variable_F = getCollectionType(_UniqueCollection, _Variable);
		private final @NonNull CollectionType _UniqueCollection_Vertex_F = getCollectionType(_UniqueCollection, _Vertex);
