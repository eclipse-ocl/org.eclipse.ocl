...
public class OCLmetamodel extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents.AbstractMetamodelContents
	{
		...
		private final @NonNull CollectionType _Collection_TemplateArgument_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_TemplateParameter_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_TemplateParameter_T = createCollectionType(_Collection);
		...
		private void installCollectionTypes() {
			...
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			type = _Collection_TemplateArgument_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			...
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			type = _Collection_TemplateParameter_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			...
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_TemplateParameter_T);
			ownedClasses.add(type);
			...
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_TemplateArgument_T);
			ownedClasses.add(type);
		...
		private void installTemplateArguments() {
			...
			addBinding(_Collection_TemplateArgument_T, _TemplateArgument);
			addBinding(_Collection_TemplateParameter_F, _TemplateParameter);
			addBinding(_Collection_TemplateParameter_T, _TemplateParameter);
