...
public class OCLmetamodel extends ASResourceImpl
{
	...
	private static class Contents extends LibraryContents
	{
		...
		private void installCollectionTypes() {
			...
			addSuperClass(type, _OclAny);
			addBinding(type, _CollectionLiteralPart);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, _EnumerationLiteral);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, _IteratorVariable);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, _MapLiteralPart);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, _Parameter);
			ownedClasses.add(type);
			type = _Collection_Precedence_F;
			addSuperClass(type, _OclAny);
			addBinding(type, _Precedence);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, _ProfileApplication);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, _StereotypeExtender);
			ownedClasses.add(type);
			type = _Collection_String_F;
			addSuperClass(type, _OclAny);
			addBinding(type, _String);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, _Transition);
			ownedClasses.add(type);
			type = _Collection_Trigger_F;
			addSuperClass(type, _OclAny);
			addBinding(type, _Trigger);
			ownedClasses.add(type);
			type = _Collection_TupleLiteralPart_F;
			addSuperClass(type, _OclAny);
			addBinding(type, _TupleLiteralPart);
			ownedClasses.add(type);
			type = _Collection_Type_F;
			addSuperClass(type, _OclAny);
			addBinding(type, _Type);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, _ValueSpecification);
			ownedClasses.add(type);
