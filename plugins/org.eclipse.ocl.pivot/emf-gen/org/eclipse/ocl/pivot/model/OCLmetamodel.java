...
public class OCLmetamodel extends ASResourceImpl
{
	...
	private static class Contents extends LibraryContents
	{
		...
		private final @NonNull NullableType _Nullable = getNullableType(_ocl, "Nullable");
		...
		private void installClassTypes() {
			...
			superClasses.add(_LoopExp);
			superClasses.add(_ReferringElement);
			ownedClasses.add(type = _IteratorVariable);
			superClasses = type.getSuperClasses();
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OCLExpression);
			ownedClasses.add(type = _LetVariable);
			superClasses = type.getSuperClasses();
			superClasses.add(_Variable);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_Namespace);
			ownedClasses.add(type = _ResultVariable);
			superClasses = type.getSuperClasses();
			superClasses.add(_Variable);
		...
		private void installCollectionTypes() {
			...
			ownedClasses.add(type = _Bag_TemplateableElement);
			superClasses = type.getSuperClasses();
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclElement);
			ownedClasses.add(type = _Collection_TemplateableElement);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclElement);
		...
		private final @NonNull NullableType _Nullable_UnlimitedNatural = createNullableType(_Nullable, _UnlimitedNatural);
		private final @NonNull NullableType _Nullable_Bag_Annotation = createNullableType(_Nullable, _Bag_Annotation);
		private final @NonNull NullableType _Nullable_Bag_AssociationClassCallExp = createNullableType(_Nullable, _Bag_AssociationClassCallExp);
		private final @NonNull NullableType _Nullable_Bag_CallOperationAction = createNullableType(_Nullable, _Bag_CallOperationAction);
		private final @NonNull NullableType _Nullable_Bag_Class = createNullableType(_Nullable, _Bag_Class);
		private final @NonNull NullableType _Nullable_Bag_CollectionType = createNullableType(_Nullable, _Bag_CollectionType);
		private final @NonNull NullableType _Nullable_Bag_CompleteClass = createNullableType(_Nullable, _Bag_CompleteClass);
		private final @NonNull NullableType _Nullable_Bag_CompleteModel = createNullableType(_Nullable, _Bag_CompleteModel);
		private final @NonNull NullableType _Nullable_Bag_CompletePackage = createNullableType(_Nullable, _Bag_CompletePackage);
		private final @NonNull NullableType _Nullable_Bag_ConnectionPointReference = createNullableType(_Nullable, _Bag_ConnectionPointReference);
		private final @NonNull NullableType _Nullable_Bag_Constraint = createNullableType(_Nullable, _Bag_Constraint);
		private final @NonNull NullableType _Nullable_Bag_DataType = createNullableType(_Nullable, _Bag_DataType);
		private final @NonNull NullableType _Nullable_Bag_DynamicElement = createNullableType(_Nullable, _Bag_DynamicElement);
		private final @NonNull NullableType _Nullable_Bag_DynamicProperty = createNullableType(_Nullable, _Bag_DynamicProperty);
		private final @NonNull NullableType _Nullable_Bag_ElementExtension = createNullableType(_Nullable, _Bag_ElementExtension);
		private final @NonNull NullableType _Nullable_Bag_EnumLiteralExp = createNullableType(_Nullable, _Bag_EnumLiteralExp);
		private final @NonNull NullableType _Nullable_Bag_Import = createNullableType(_Nullable, _Bag_Import);
		private final @NonNull NullableType _Nullable_Bag_InstanceSpecification = createNullableType(_Nullable, _Bag_InstanceSpecification);
		private final @NonNull NullableType _Nullable_Bag_InvalidableType = createNullableType(_Nullable, _Bag_InvalidableType);
		private final @NonNull NullableType _Nullable_Bag_LambdaType = createNullableType(_Nullable, _Bag_LambdaType);
		private final @NonNull NullableType _Nullable_Bag_LoopExp = createNullableType(_Nullable, _Bag_LoopExp);
		private final @NonNull NullableType _Nullable_Bag_MapType = createNullableType(_Nullable, _Bag_MapType);
		private final @NonNull NullableType _Nullable_Bag_MessageType = createNullableType(_Nullable, _Bag_MessageType);
		private final @NonNull NullableType _Nullable_Bag_NavigationCallExp = createNullableType(_Nullable, _Bag_NavigationCallExp);
		private final @NonNull NullableType _Nullable_Bag_NullableType = createNullableType(_Nullable, _Bag_NullableType);
		private final @NonNull NullableType _Nullable_Bag_OCLExpression = createNullableType(_Nullable, _Bag_OCLExpression);
		private final @NonNull NullableType _Nullable_Bag_OperationCallExp = createNullableType(_Nullable, _Bag_OperationCallExp);
		private final @NonNull NullableType _Nullable_Bag_Operation = createNullableType(_Nullable, _Bag_Operation);
		private final @NonNull NullableType _Nullable_Bag_OppositePropertyCallExp = createNullableType(_Nullable, _Bag_OppositePropertyCallExp);
		private final @NonNull NullableType _Nullable_Bag_Package = createNullableType(_Nullable, _Bag_Package);
		private final @NonNull NullableType _Nullable_Bag_PrimitiveType = createNullableType(_Nullable, _Bag_PrimitiveType);
		private final @NonNull NullableType _Nullable_Bag_PropertyCallExp = createNullableType(_Nullable, _Bag_PropertyCallExp);
		private final @NonNull NullableType _Nullable_Bag_Property = createNullableType(_Nullable, _Bag_Property);
		private final @NonNull NullableType _Nullable_Bag_Region = createNullableType(_Nullable, _Bag_Region);
		private final @NonNull NullableType _Nullable_Bag_SendSignalAction = createNullableType(_Nullable, _Bag_SendSignalAction);
		private final @NonNull NullableType _Nullable_Bag_ShadowPart = createNullableType(_Nullable, _Bag_ShadowPart);
		private final @NonNull NullableType _Nullable_Bag_Slot = createNullableType(_Nullable, _Bag_Slot);
		private final @NonNull NullableType _Nullable_Bag_StateExp = createNullableType(_Nullable, _Bag_StateExp);
		private final @NonNull NullableType _Nullable_Bag_StateMachine = createNullableType(_Nullable, _Bag_StateMachine);
		private final @NonNull NullableType _Nullable_Bag_State = createNullableType(_Nullable, _Bag_State);
		private final @NonNull NullableType _Nullable_Bag_TemplateBinding = createNullableType(_Nullable, _Bag_TemplateBinding);
		private final @NonNull NullableType _Nullable_Bag_TemplateParameterSubstitution = createNullableType(_Nullable, _Bag_TemplateParameterSubstitution);
		private final @NonNull NullableType _Nullable_Bag_TemplateParameter = createNullableType(_Nullable, _Bag_TemplateParameter);
		private final @NonNull NullableType _Nullable_Bag_TemplateableElement = createNullableType(_Nullable, _Bag_TemplateableElement);
		private final @NonNull NullableType _Nullable_Bag_TypeExp = createNullableType(_Nullable, _Bag_TypeExp);
		private final @NonNull NullableType _Nullable_Bag_TypedElement = createNullableType(_Nullable, _Bag_TypedElement);
		private final @NonNull NullableType _Nullable_Bag_VariableDeclaration = createNullableType(_Nullable, _Bag_VariableDeclaration);
		private final @NonNull NullableType _Nullable_Bag_VariableExp = createNullableType(_Nullable, _Bag_VariableExp);
		private final @NonNull NullableType _Nullable_Bag_Variable = createNullableType(_Nullable, _Bag_Variable);
		private final @NonNull NullableType _Nullable_Bag_WildcardType = createNullableType(_Nullable, _Bag_WildcardType);
		private final @NonNull NullableType _Nullable_Collection_String = createNullableType(_Nullable, _Collection_String);
		private final @NonNull NullableType _Nullable_Collection_Annotation = createNullableType(_Nullable, _Collection_Annotation);
		private final @NonNull NullableType _Nullable_Collection_AssociationClassCallExp = createNullableType(_Nullable, _Collection_AssociationClassCallExp);
		private final @NonNull NullableType _Nullable_Collection_Behavior = createNullableType(_Nullable, _Collection_Behavior);
		private final @NonNull NullableType _Nullable_Collection_CallOperationAction = createNullableType(_Nullable, _Collection_CallOperationAction);
		private final @NonNull NullableType _Nullable_Collection_Class = createNullableType(_Nullable, _Collection_Class);
		private final @NonNull NullableType _Nullable_Collection_CollectionLiteralPart = createNullableType(_Nullable, _Collection_CollectionLiteralPart);
		private final @NonNull NullableType _Nullable_Collection_CollectionType = createNullableType(_Nullable, _Collection_CollectionType);
		private final @NonNull NullableType _Nullable_Collection_Comment = createNullableType(_Nullable, _Collection_Comment);
		private final @NonNull NullableType _Nullable_Collection_CompleteClass = createNullableType(_Nullable, _Collection_CompleteClass);
		private final @NonNull NullableType _Nullable_Collection_CompleteModel = createNullableType(_Nullable, _Collection_CompleteModel);
		private final @NonNull NullableType _Nullable_Collection_CompletePackage = createNullableType(_Nullable, _Collection_CompletePackage);
		private final @NonNull NullableType _Nullable_Collection_ConnectionPointReference = createNullableType(_Nullable, _Collection_ConnectionPointReference);
		private final @NonNull NullableType _Nullable_Collection_Constraint = createNullableType(_Nullable, _Collection_Constraint);
		private final @NonNull NullableType _Nullable_Collection_DataType = createNullableType(_Nullable, _Collection_DataType);
		private final @NonNull NullableType _Nullable_Collection_Detail = createNullableType(_Nullable, _Collection_Detail);
		private final @NonNull NullableType _Nullable_Collection_DynamicElement = createNullableType(_Nullable, _Collection_DynamicElement);
		private final @NonNull NullableType _Nullable_Collection_DynamicProperty = createNullableType(_Nullable, _Collection_DynamicProperty);
		private final @NonNull NullableType _Nullable_Collection_ElementExtension = createNullableType(_Nullable, _Collection_ElementExtension);
		private final @NonNull NullableType _Nullable_Collection_Element = createNullableType(_Nullable, _Collection_Element);
		private final @NonNull NullableType _Nullable_Collection_EnumLiteralExp = createNullableType(_Nullable, _Collection_EnumLiteralExp);
		private final @NonNull NullableType _Nullable_Collection_EnumerationLiteral = createNullableType(_Nullable, _Collection_EnumerationLiteral);
		private final @NonNull NullableType _Nullable_Collection_Import = createNullableType(_Nullable, _Collection_Import);
		private final @NonNull NullableType _Nullable_Collection_InstanceSpecification = createNullableType(_Nullable, _Collection_InstanceSpecification);
		private final @NonNull NullableType _Nullable_Collection_InvalidableType = createNullableType(_Nullable, _Collection_InvalidableType);
		private final @NonNull NullableType _Nullable_Collection_LambdaType = createNullableType(_Nullable, _Collection_LambdaType);
		private final @NonNull NullableType _Nullable_Collection_LoopExp = createNullableType(_Nullable, _Collection_LoopExp);
		private final @NonNull NullableType _Nullable_Collection_MapLiteralPart = createNullableType(_Nullable, _Collection_MapLiteralPart);
		private final @NonNull NullableType _Nullable_Collection_MapType = createNullableType(_Nullable, _Collection_MapType);
		private final @NonNull NullableType _Nullable_Collection_MessageType = createNullableType(_Nullable, _Collection_MessageType);
		private final @NonNull NullableType _Nullable_Collection_Model = createNullableType(_Nullable, _Collection_Model);
		private final @NonNull NullableType _Nullable_Collection_NavigationCallExp = createNullableType(_Nullable, _Collection_NavigationCallExp);
		private final @NonNull NullableType _Nullable_Collection_NullableType = createNullableType(_Nullable, _Collection_NullableType);
		private final @NonNull NullableType _Nullable_Collection_OCLExpression = createNullableType(_Nullable, _Collection_OCLExpression);
		private final @NonNull NullableType _Nullable_Collection_OperationCallExp = createNullableType(_Nullable, _Collection_OperationCallExp);
		private final @NonNull NullableType _Nullable_Collection_Operation = createNullableType(_Nullable, _Collection_Operation);
		private final @NonNull NullableType _Nullable_Collection_OppositePropertyCallExp = createNullableType(_Nullable, _Collection_OppositePropertyCallExp);
		private final @NonNull NullableType _Nullable_Collection_Package = createNullableType(_Nullable, _Collection_Package);
		private final @NonNull NullableType _Nullable_Collection_Parameter = createNullableType(_Nullable, _Collection_Parameter);
		private final @NonNull NullableType _Nullable_Collection_Precedence = createNullableType(_Nullable, _Collection_Precedence);
		private final @NonNull NullableType _Nullable_Collection_PrimitiveType = createNullableType(_Nullable, _Collection_PrimitiveType);
		private final @NonNull NullableType _Nullable_Collection_ProfileApplication = createNullableType(_Nullable, _Collection_ProfileApplication);
		private final @NonNull NullableType _Nullable_Collection_PropertyCallExp = createNullableType(_Nullable, _Collection_PropertyCallExp);
		private final @NonNull NullableType _Nullable_Collection_Property = createNullableType(_Nullable, _Collection_Property);
		private final @NonNull NullableType _Nullable_Collection_Pseudostate = createNullableType(_Nullable, _Collection_Pseudostate);
		private final @NonNull NullableType _Nullable_Collection_Region = createNullableType(_Nullable, _Collection_Region);
		private final @NonNull NullableType _Nullable_Collection_SendSignalAction = createNullableType(_Nullable, _Collection_SendSignalAction);
		private final @NonNull NullableType _Nullable_Collection_ShadowPart = createNullableType(_Nullable, _Collection_ShadowPart);
		private final @NonNull NullableType _Nullable_Collection_Slot = createNullableType(_Nullable, _Collection_Slot);
		private final @NonNull NullableType _Nullable_Collection_StateExp = createNullableType(_Nullable, _Collection_StateExp);
		private final @NonNull NullableType _Nullable_Collection_StateMachine = createNullableType(_Nullable, _Collection_StateMachine);
		private final @NonNull NullableType _Nullable_Collection_State = createNullableType(_Nullable, _Collection_State);
		private final @NonNull NullableType _Nullable_Collection_StereotypeExtender = createNullableType(_Nullable, _Collection_StereotypeExtender);
		private final @NonNull NullableType _Nullable_Collection_TemplateBinding = createNullableType(_Nullable, _Collection_TemplateBinding);
		private final @NonNull NullableType _Nullable_Collection_TemplateParameterSubstitution = createNullableType(_Nullable, _Collection_TemplateParameterSubstitution);
		private final @NonNull NullableType _Nullable_Collection_TemplateParameter = createNullableType(_Nullable, _Collection_TemplateParameter);
		private final @NonNull NullableType _Nullable_Collection_TemplateableElement = createNullableType(_Nullable, _Collection_TemplateableElement);
		private final @NonNull NullableType _Nullable_Collection_Transition = createNullableType(_Nullable, _Collection_Transition);
		private final @NonNull NullableType _Nullable_Collection_Trigger = createNullableType(_Nullable, _Collection_Trigger);
		private final @NonNull NullableType _Nullable_Collection_TupleLiteralPart = createNullableType(_Nullable, _Collection_TupleLiteralPart);
		private final @NonNull NullableType _Nullable_Collection_TypeExp = createNullableType(_Nullable, _Collection_TypeExp);
		private final @NonNull NullableType _Nullable_Collection_Type = createNullableType(_Nullable, _Collection_Type);
		private final @NonNull NullableType _Nullable_Collection_TypedElement = createNullableType(_Nullable, _Collection_TypedElement);
		private final @NonNull NullableType _Nullable_Collection_ValueSpecification = createNullableType(_Nullable, _Collection_ValueSpecification);
		private final @NonNull NullableType _Nullable_Collection_VariableDeclaration = createNullableType(_Nullable, _Collection_VariableDeclaration);
		private final @NonNull NullableType _Nullable_Collection_VariableExp = createNullableType(_Nullable, _Collection_VariableExp);
		private final @NonNull NullableType _Nullable_Collection_Variable = createNullableType(_Nullable, _Collection_Variable);
		private final @NonNull NullableType _Nullable_Collection_Vertex = createNullableType(_Nullable, _Collection_Vertex);
		private final @NonNull NullableType _Nullable_Collection_WildcardType = createNullableType(_Nullable, _Collection_WildcardType);
		private final @NonNull NullableType _Nullable_OrderedCollection_CollectionLiteralPart = createNullableType(_Nullable, _OrderedCollection_CollectionLiteralPart);
		private final @NonNull NullableType _Nullable_OrderedCollection_Detail = createNullableType(_Nullable, _OrderedCollection_Detail);
		private final @NonNull NullableType _Nullable_OrderedCollection_Element = createNullableType(_Nullable, _OrderedCollection_Element);
		private final @NonNull NullableType _Nullable_OrderedCollection_EnumerationLiteral = createNullableType(_Nullable, _OrderedCollection_EnumerationLiteral);
		private final @NonNull NullableType _Nullable_OrderedCollection_Import = createNullableType(_Nullable, _OrderedCollection_Import);
		private final @NonNull NullableType _Nullable_OrderedCollection_MapLiteralPart = createNullableType(_Nullable, _OrderedCollection_MapLiteralPart);
		private final @NonNull NullableType _Nullable_OrderedCollection_OCLExpression = createNullableType(_Nullable, _OrderedCollection_OCLExpression);
		private final @NonNull NullableType _Nullable_OrderedCollection_Operation = createNullableType(_Nullable, _OrderedCollection_Operation);
		private final @NonNull NullableType _Nullable_OrderedCollection_Parameter = createNullableType(_Nullable, _OrderedCollection_Parameter);
		private final @NonNull NullableType _Nullable_OrderedCollection_Precedence = createNullableType(_Nullable, _OrderedCollection_Precedence);
		private final @NonNull NullableType _Nullable_OrderedCollection_Property = createNullableType(_Nullable, _OrderedCollection_Property);
		private final @NonNull NullableType _Nullable_OrderedCollection_ShadowPart = createNullableType(_Nullable, _OrderedCollection_ShadowPart);
		private final @NonNull NullableType _Nullable_OrderedCollection_TemplateParameter = createNullableType(_Nullable, _OrderedCollection_TemplateParameter);
		private final @NonNull NullableType _Nullable_OrderedCollection_TupleLiteralPart = createNullableType(_Nullable, _OrderedCollection_TupleLiteralPart);
		private final @NonNull NullableType _Nullable_OrderedCollection_Type = createNullableType(_Nullable, _OrderedCollection_Type);
		private final @NonNull NullableType _Nullable_OrderedCollection_ValueSpecification = createNullableType(_Nullable, _OrderedCollection_ValueSpecification);
		private final @NonNull NullableType _Nullable_OrderedCollection_Variable = createNullableType(_Nullable, _OrderedCollection_Variable);
		private final @NonNull NullableType _Nullable_OrderedSet_CollectionLiteralPart_NullFree = createNullableType(_Nullable, _OrderedSet_CollectionLiteralPart_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Detail_NullFree = createNullableType(_Nullable, _OrderedSet_Detail_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Element_NullFree = createNullableType(_Nullable, _OrderedSet_Element_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_EnumerationLiteral_NullFree = createNullableType(_Nullable, _OrderedSet_EnumerationLiteral_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Import_NullFree = createNullableType(_Nullable, _OrderedSet_Import_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_MapLiteralPart_NullFree = createNullableType(_Nullable, _OrderedSet_MapLiteralPart_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_OCLExpression_NullFree = createNullableType(_Nullable, _OrderedSet_OCLExpression_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Operation_NullFree = createNullableType(_Nullable, _OrderedSet_Operation_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Parameter_NullFree = createNullableType(_Nullable, _OrderedSet_Parameter_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Precedence_NullFree = createNullableType(_Nullable, _OrderedSet_Precedence_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Property_NullFree = createNullableType(_Nullable, _OrderedSet_Property_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_ShadowPart_NullFree = createNullableType(_Nullable, _OrderedSet_ShadowPart_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_TemplateParameter_NullFree = createNullableType(_Nullable, _OrderedSet_TemplateParameter_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_TupleLiteralPart_NullFree = createNullableType(_Nullable, _OrderedSet_TupleLiteralPart_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_ValueSpecification_NullFree = createNullableType(_Nullable, _OrderedSet_ValueSpecification_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Variable_NullFree = createNullableType(_Nullable, _OrderedSet_Variable_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_Type_NullFree = createNullableType(_Nullable, _Sequence_Type_NullFree);
		private final @NonNull NullableType _Nullable_Set_String_NullFree = createNullableType(_Nullable, _Set_String_NullFree);
		private final @NonNull NullableType _Nullable_Set_Behavior_NullFree = createNullableType(_Nullable, _Set_Behavior_NullFree);
		private final @NonNull NullableType _Nullable_Set_Class_NullFree = createNullableType(_Nullable, _Set_Class_NullFree);
		private final @NonNull NullableType _Nullable_Set_Comment_NullFree = createNullableType(_Nullable, _Set_Comment_NullFree);
		private final @NonNull NullableType _Nullable_Set_CompleteClass_NullFree = createNullableType(_Nullable, _Set_CompleteClass_NullFree);
		private final @NonNull NullableType _Nullable_Set_CompletePackage_NullFree = createNullableType(_Nullable, _Set_CompletePackage_NullFree);
		private final @NonNull NullableType _Nullable_Set_ConnectionPointReference_NullFree = createNullableType(_Nullable, _Set_ConnectionPointReference_NullFree);
		private final @NonNull NullableType _Nullable_Set_Constraint_NullFree = createNullableType(_Nullable, _Set_Constraint_NullFree);
		private final @NonNull NullableType _Nullable_Set_DynamicProperty_NullFree = createNullableType(_Nullable, _Set_DynamicProperty_NullFree);
		private final @NonNull NullableType _Nullable_Set_ElementExtension_NullFree = createNullableType(_Nullable, _Set_ElementExtension_NullFree);
		private final @NonNull NullableType _Nullable_Set_Element_NullFree = createNullableType(_Nullable, _Set_Element_NullFree);
		private final @NonNull NullableType _Nullable_Set_InstanceSpecification_NullFree = createNullableType(_Nullable, _Set_InstanceSpecification_NullFree);
		private final @NonNull NullableType _Nullable_Set_Model_NullFree = createNullableType(_Nullable, _Set_Model_NullFree);
		private final @NonNull NullableType _Nullable_Set_Operation_NullFree = createNullableType(_Nullable, _Set_Operation_NullFree);
		private final @NonNull NullableType _Nullable_Set_Package_NullFree = createNullableType(_Nullable, _Set_Package_NullFree);
		private final @NonNull NullableType _Nullable_Set_ProfileApplication_NullFree = createNullableType(_Nullable, _Set_ProfileApplication_NullFree);
		private final @NonNull NullableType _Nullable_Set_Property_NullFree = createNullableType(_Nullable, _Set_Property_NullFree);
		private final @NonNull NullableType _Nullable_Set_Pseudostate_NullFree = createNullableType(_Nullable, _Set_Pseudostate_NullFree);
		private final @NonNull NullableType _Nullable_Set_Region_NullFree = createNullableType(_Nullable, _Set_Region_NullFree);
		private final @NonNull NullableType _Nullable_Set_Region_NullFree_1 = createNullableType(_Nullable, _Set_Region_NullFree_1);
		private final @NonNull NullableType _Nullable_Set_Slot_NullFree = createNullableType(_Nullable, _Set_Slot_NullFree);
		private final @NonNull NullableType _Nullable_Set_StateMachine_NullFree = createNullableType(_Nullable, _Set_StateMachine_NullFree);
		private final @NonNull NullableType _Nullable_Set_State_NullFree = createNullableType(_Nullable, _Set_State_NullFree);
		private final @NonNull NullableType _Nullable_Set_StereotypeExtender_NullFree = createNullableType(_Nullable, _Set_StereotypeExtender_NullFree);
		private final @NonNull NullableType _Nullable_Set_TemplateBinding_NullFree = createNullableType(_Nullable, _Set_TemplateBinding_NullFree);
		private final @NonNull NullableType _Nullable_Set_TemplateParameterSubstitution_NullFree = createNullableType(_Nullable, _Set_TemplateParameterSubstitution_NullFree);
		private final @NonNull NullableType _Nullable_Set_Transition_NullFree = createNullableType(_Nullable, _Set_Transition_NullFree);
		private final @NonNull NullableType _Nullable_Set_Trigger_NullFree = createNullableType(_Nullable, _Set_Trigger_NullFree);
		private final @NonNull NullableType _Nullable_Set_Type_NullFree = createNullableType(_Nullable, _Set_Type_NullFree);
		private final @NonNull NullableType _Nullable_Set_Vertex_NullFree = createNullableType(_Nullable, _Set_Vertex_NullFree);
		private final @NonNull NullableType _Nullable_UniqueCollection_String = createNullableType(_Nullable, _UniqueCollection_String);
		private final @NonNull NullableType _Nullable_UniqueCollection_Behavior = createNullableType(_Nullable, _UniqueCollection_Behavior);
		private final @NonNull NullableType _Nullable_UniqueCollection_Class = createNullableType(_Nullable, _UniqueCollection_Class);
		private final @NonNull NullableType _Nullable_UniqueCollection_CollectionLiteralPart = createNullableType(_Nullable, _UniqueCollection_CollectionLiteralPart);
		private final @NonNull NullableType _Nullable_UniqueCollection_Comment = createNullableType(_Nullable, _UniqueCollection_Comment);
		private final @NonNull NullableType _Nullable_UniqueCollection_CompleteClass = createNullableType(_Nullable, _UniqueCollection_CompleteClass);
		private final @NonNull NullableType _Nullable_UniqueCollection_CompletePackage = createNullableType(_Nullable, _UniqueCollection_CompletePackage);
		private final @NonNull NullableType _Nullable_UniqueCollection_ConnectionPointReference = createNullableType(_Nullable, _UniqueCollection_ConnectionPointReference);
		private final @NonNull NullableType _Nullable_UniqueCollection_Constraint = createNullableType(_Nullable, _UniqueCollection_Constraint);
		private final @NonNull NullableType _Nullable_UniqueCollection_Detail = createNullableType(_Nullable, _UniqueCollection_Detail);
		private final @NonNull NullableType _Nullable_UniqueCollection_DynamicProperty = createNullableType(_Nullable, _UniqueCollection_DynamicProperty);
		private final @NonNull NullableType _Nullable_UniqueCollection_ElementExtension = createNullableType(_Nullable, _UniqueCollection_ElementExtension);
		private final @NonNull NullableType _Nullable_UniqueCollection_Element = createNullableType(_Nullable, _UniqueCollection_Element);
		private final @NonNull NullableType _Nullable_UniqueCollection_EnumerationLiteral = createNullableType(_Nullable, _UniqueCollection_EnumerationLiteral);
		private final @NonNull NullableType _Nullable_UniqueCollection_Import = createNullableType(_Nullable, _UniqueCollection_Import);
		private final @NonNull NullableType _Nullable_UniqueCollection_InstanceSpecification = createNullableType(_Nullable, _UniqueCollection_InstanceSpecification);
		private final @NonNull NullableType _Nullable_UniqueCollection_MapLiteralPart = createNullableType(_Nullable, _UniqueCollection_MapLiteralPart);
		private final @NonNull NullableType _Nullable_UniqueCollection_Model = createNullableType(_Nullable, _UniqueCollection_Model);
		private final @NonNull NullableType _Nullable_UniqueCollection_OCLExpression = createNullableType(_Nullable, _UniqueCollection_OCLExpression);
		private final @NonNull NullableType _Nullable_UniqueCollection_Operation = createNullableType(_Nullable, _UniqueCollection_Operation);
		private final @NonNull NullableType _Nullable_UniqueCollection_Package = createNullableType(_Nullable, _UniqueCollection_Package);
		private final @NonNull NullableType _Nullable_UniqueCollection_Parameter = createNullableType(_Nullable, _UniqueCollection_Parameter);
		private final @NonNull NullableType _Nullable_UniqueCollection_Precedence = createNullableType(_Nullable, _UniqueCollection_Precedence);
		private final @NonNull NullableType _Nullable_UniqueCollection_ProfileApplication = createNullableType(_Nullable, _UniqueCollection_ProfileApplication);
		private final @NonNull NullableType _Nullable_UniqueCollection_Property = createNullableType(_Nullable, _UniqueCollection_Property);
		private final @NonNull NullableType _Nullable_UniqueCollection_Pseudostate = createNullableType(_Nullable, _UniqueCollection_Pseudostate);
		private final @NonNull NullableType _Nullable_UniqueCollection_Region = createNullableType(_Nullable, _UniqueCollection_Region);
		private final @NonNull NullableType _Nullable_UniqueCollection_ShadowPart = createNullableType(_Nullable, _UniqueCollection_ShadowPart);
		private final @NonNull NullableType _Nullable_UniqueCollection_Slot = createNullableType(_Nullable, _UniqueCollection_Slot);
		private final @NonNull NullableType _Nullable_UniqueCollection_StateMachine = createNullableType(_Nullable, _UniqueCollection_StateMachine);
		private final @NonNull NullableType _Nullable_UniqueCollection_State = createNullableType(_Nullable, _UniqueCollection_State);
		private final @NonNull NullableType _Nullable_UniqueCollection_StereotypeExtender = createNullableType(_Nullable, _UniqueCollection_StereotypeExtender);
		private final @NonNull NullableType _Nullable_UniqueCollection_TemplateBinding = createNullableType(_Nullable, _UniqueCollection_TemplateBinding);
		private final @NonNull NullableType _Nullable_UniqueCollection_TemplateParameterSubstitution = createNullableType(_Nullable, _UniqueCollection_TemplateParameterSubstitution);
		private final @NonNull NullableType _Nullable_UniqueCollection_TemplateParameter = createNullableType(_Nullable, _UniqueCollection_TemplateParameter);
		private final @NonNull NullableType _Nullable_UniqueCollection_Transition = createNullableType(_Nullable, _UniqueCollection_Transition);
		private final @NonNull NullableType _Nullable_UniqueCollection_Trigger = createNullableType(_Nullable, _UniqueCollection_Trigger);
		private final @NonNull NullableType _Nullable_UniqueCollection_TupleLiteralPart = createNullableType(_Nullable, _UniqueCollection_TupleLiteralPart);
		private final @NonNull NullableType _Nullable_UniqueCollection_Type = createNullableType(_Nullable, _UniqueCollection_Type);
		private final @NonNull NullableType _Nullable_UniqueCollection_ValueSpecification = createNullableType(_Nullable, _UniqueCollection_ValueSpecification);
		private final @NonNull NullableType _Nullable_UniqueCollection_Variable = createNullableType(_Nullable, _UniqueCollection_Variable);
		private final @NonNull NullableType _Nullable_UniqueCollection_Vertex = createNullableType(_Nullable, _UniqueCollection_Vertex);
		private final @NonNull NullableType _Nullable_Annotation = createNullableType(_Nullable, _Annotation);
		private final @NonNull NullableType _Nullable_AnyType = createNullableType(_Nullable, _AnyType);
		private final @NonNull NullableType _Nullable_AssociationClass = createNullableType(_Nullable, _AssociationClass);
		private final @NonNull NullableType _Nullable_AssociationClassCallExp = createNullableType(_Nullable, _AssociationClassCallExp);
		private final @NonNull NullableType _Nullable_AssociativityKind = createNullableType(_Nullable, _AssociativityKind);
		private final @NonNull NullableType _Nullable_BagType = createNullableType(_Nullable, _BagType);
		private final @NonNull NullableType _Nullable_Behavior = createNullableType(_Nullable, _Behavior);
		private final @NonNull NullableType _Nullable_BooleanLiteralExp = createNullableType(_Nullable, _BooleanLiteralExp);
		private final @NonNull NullableType _Nullable_CallExp = createNullableType(_Nullable, _CallExp);
		private final @NonNull NullableType _Nullable_CallOperationAction = createNullableType(_Nullable, _CallOperationAction);
		private final @NonNull NullableType _Nullable_Class = createNullableType(_Nullable, _Class);
		private final @NonNull NullableType _Nullable_CollectionItem = createNullableType(_Nullable, _CollectionItem);
		private final @NonNull NullableType _Nullable_CollectionKind = createNullableType(_Nullable, _CollectionKind);
		private final @NonNull NullableType _Nullable_CollectionLiteralExp = createNullableType(_Nullable, _CollectionLiteralExp);
		private final @NonNull NullableType _Nullable_CollectionLiteralPart = createNullableType(_Nullable, _CollectionLiteralPart);
		private final @NonNull NullableType _Nullable_CollectionRange = createNullableType(_Nullable, _CollectionRange);
		private final @NonNull NullableType _Nullable_CollectionType = createNullableType(_Nullable, _CollectionType);
		private final @NonNull NullableType _Nullable_Comment = createNullableType(_Nullable, _Comment);
		private final @NonNull NullableType _Nullable_CompleteClass = createNullableType(_Nullable, _CompleteClass);
		private final @NonNull NullableType _Nullable_CompleteEnvironment = createNullableType(_Nullable, _CompleteEnvironment);
		private final @NonNull NullableType _Nullable_CompleteModel = createNullableType(_Nullable, _CompleteModel);
		private final @NonNull NullableType _Nullable_CompletePackage = createNullableType(_Nullable, _CompletePackage);
		private final @NonNull NullableType _Nullable_ConnectionPointReference = createNullableType(_Nullable, _ConnectionPointReference);
		private final @NonNull NullableType _Nullable_Constraint = createNullableType(_Nullable, _Constraint);
		private final @NonNull NullableType _Nullable_DataType = createNullableType(_Nullable, _DataType);
		private final @NonNull NullableType _Nullable_Detail = createNullableType(_Nullable, _Detail);
		private final @NonNull NullableType _Nullable_DynamicBehavior = createNullableType(_Nullable, _DynamicBehavior);
		private final @NonNull NullableType _Nullable_DynamicElement = createNullableType(_Nullable, _DynamicElement);
		private final @NonNull NullableType _Nullable_DynamicProperty = createNullableType(_Nullable, _DynamicProperty);
		private final @NonNull NullableType _Nullable_DynamicType = createNullableType(_Nullable, _DynamicType);
		private final @NonNull NullableType _Nullable_DynamicValueSpecification = createNullableType(_Nullable, _DynamicValueSpecification);
		private final @NonNull NullableType _Nullable_Element = createNullableType(_Nullable, _Element);
		private final @NonNull NullableType _Nullable_ElementExtension = createNullableType(_Nullable, _ElementExtension);
		private final @NonNull NullableType _Nullable_EnumLiteralExp = createNullableType(_Nullable, _EnumLiteralExp);
		private final @NonNull NullableType _Nullable_Enumeration = createNullableType(_Nullable, _Enumeration);
		private final @NonNull NullableType _Nullable_EnumerationLiteral = createNullableType(_Nullable, _EnumerationLiteral);
		private final @NonNull NullableType _Nullable_ExpressionInOCL = createNullableType(_Nullable, _ExpressionInOCL);
		private final @NonNull NullableType _Nullable_Feature = createNullableType(_Nullable, _Feature);
		private final @NonNull NullableType _Nullable_FeatureCallExp = createNullableType(_Nullable, _FeatureCallExp);
		private final @NonNull NullableType _Nullable_FinalState = createNullableType(_Nullable, _FinalState);
		private final @NonNull NullableType _Nullable_IfExp = createNullableType(_Nullable, _IfExp);
		private final @NonNull NullableType _Nullable_Import = createNullableType(_Nullable, _Import);
		private final @NonNull NullableType _Nullable_InstanceSpecification = createNullableType(_Nullable, _InstanceSpecification);
		private final @NonNull NullableType _Nullable_IntegerLiteralExp = createNullableType(_Nullable, _IntegerLiteralExp);
		private final @NonNull NullableType _Nullable_InvalidLiteralExp = createNullableType(_Nullable, _InvalidLiteralExp);
		private final @NonNull NullableType _Nullable_InvalidType = createNullableType(_Nullable, _InvalidType);
		private final @NonNull NullableType _Nullable_InvalidableType = createNullableType(_Nullable, _InvalidableType);
		private final @NonNull NullableType _Nullable_IterateExp = createNullableType(_Nullable, _IterateExp);
		private final @NonNull NullableType _Nullable_Iteration = createNullableType(_Nullable, _Iteration);
		private final @NonNull NullableType _Nullable_IteratorExp = createNullableType(_Nullable, _IteratorExp);
		private final @NonNull NullableType _Nullable_IteratorVariable = createNullableType(_Nullable, _IteratorVariable);
		private final @NonNull NullableType _Nullable_LambdaType = createNullableType(_Nullable, _LambdaType);
		private final @NonNull NullableType _Nullable_LanguageExpression = createNullableType(_Nullable, _LanguageExpression);
		private final @NonNull NullableType _Nullable_LetExp = createNullableType(_Nullable, _LetExp);
		private final @NonNull NullableType _Nullable_LetVariable = createNullableType(_Nullable, _LetVariable);
		private final @NonNull NullableType _Nullable_Library = createNullableType(_Nullable, _Library);
		private final @NonNull NullableType _Nullable_LibraryFeature = createNullableType(_Nullable, _LibraryFeature);
		private final @NonNull NullableType _Nullable_LiteralExp = createNullableType(_Nullable, _LiteralExp);
		private final @NonNull NullableType _Nullable_LoopExp = createNullableType(_Nullable, _LoopExp);
		private final @NonNull NullableType _Nullable_MapLiteralExp = createNullableType(_Nullable, _MapLiteralExp);
		private final @NonNull NullableType _Nullable_MapLiteralPart = createNullableType(_Nullable, _MapLiteralPart);
		private final @NonNull NullableType _Nullable_MapType = createNullableType(_Nullable, _MapType);
		private final @NonNull NullableType _Nullable_MessageExp = createNullableType(_Nullable, _MessageExp);
		private final @NonNull NullableType _Nullable_MessageType = createNullableType(_Nullable, _MessageType);
		private final @NonNull NullableType _Nullable_Model = createNullableType(_Nullable, _Model);
		private final @NonNull NullableType _Nullable_MorePivotable = createNullableType(_Nullable, _MorePivotable);
		private final @NonNull NullableType _Nullable_Nameable = createNullableType(_Nullable, _Nameable);
		private final @NonNull NullableType _Nullable_NamedElement = createNullableType(_Nullable, _NamedElement);
		private final @NonNull NullableType _Nullable_Namespace = createNullableType(_Nullable, _Namespace);
		private final @NonNull NullableType _Nullable_NavigationCallExp = createNullableType(_Nullable, _NavigationCallExp);
		private final @NonNull NullableType _Nullable_NullLiteralExp = createNullableType(_Nullable, _NullLiteralExp);
		private final @NonNull NullableType _Nullable_NullableType = createNullableType(_Nullable, _NullableType);
		private final @NonNull NullableType _Nullable_NumericLiteralExp = createNullableType(_Nullable, _NumericLiteralExp);
		private final @NonNull NullableType _Nullable_OCLExpression = createNullableType(_Nullable, _OCLExpression);
		private final @NonNull NullableType _Nullable_Object = createNullableType(_Nullable, _Object);
		private final @NonNull NullableType _Nullable_Operation = createNullableType(_Nullable, _Operation);
		private final @NonNull NullableType _Nullable_OperationCallExp = createNullableType(_Nullable, _OperationCallExp);
		private final @NonNull NullableType _Nullable_OppositePropertyCallExp = createNullableType(_Nullable, _OppositePropertyCallExp);
		private final @NonNull NullableType _Nullable_OrderedSetType = createNullableType(_Nullable, _OrderedSetType);
		private final @NonNull NullableType _Nullable_OrphanCompletePackage = createNullableType(_Nullable, _OrphanCompletePackage);
		private final @NonNull NullableType _Nullable_Package = createNullableType(_Nullable, _Package);
		private final @NonNull NullableType _Nullable_Parameter = createNullableType(_Nullable, _Parameter);
		private final @NonNull NullableType _Nullable_ParameterVariable = createNullableType(_Nullable, _ParameterVariable);
		private final @NonNull NullableType _Nullable_Pivotable = createNullableType(_Nullable, _Pivotable);
		private final @NonNull NullableType _Nullable_Precedence = createNullableType(_Nullable, _Precedence);
		private final @NonNull NullableType _Nullable_PrimitiveCompletePackage = createNullableType(_Nullable, _PrimitiveCompletePackage);
		private final @NonNull NullableType _Nullable_PrimitiveLiteralExp = createNullableType(_Nullable, _PrimitiveLiteralExp);
		private final @NonNull NullableType _Nullable_PrimitiveType = createNullableType(_Nullable, _PrimitiveType);
		private final @NonNull NullableType _Nullable_Profile = createNullableType(_Nullable, _Profile);
		private final @NonNull NullableType _Nullable_ProfileApplication = createNullableType(_Nullable, _ProfileApplication);
		private final @NonNull NullableType _Nullable_Property = createNullableType(_Nullable, _Property);
		private final @NonNull NullableType _Nullable_PropertyCallExp = createNullableType(_Nullable, _PropertyCallExp);
		private final @NonNull NullableType _Nullable_Pseudostate = createNullableType(_Nullable, _Pseudostate);
		private final @NonNull NullableType _Nullable_PseudostateKind = createNullableType(_Nullable, _PseudostateKind);
		private final @NonNull NullableType _Nullable_RealLiteralExp = createNullableType(_Nullable, _RealLiteralExp);
		private final @NonNull NullableType _Nullable_ReferringElement = createNullableType(_Nullable, _ReferringElement);
		private final @NonNull NullableType _Nullable_Region = createNullableType(_Nullable, _Region);
		private final @NonNull NullableType _Nullable_ResultVariable = createNullableType(_Nullable, _ResultVariable);
		private final @NonNull NullableType _Nullable_SelfType = createNullableType(_Nullable, _SelfType);
		private final @NonNull NullableType _Nullable_SendSignalAction = createNullableType(_Nullable, _SendSignalAction);
		private final @NonNull NullableType _Nullable_SequenceType = createNullableType(_Nullable, _SequenceType);
		private final @NonNull NullableType _Nullable_SetType = createNullableType(_Nullable, _SetType);
		private final @NonNull NullableType _Nullable_ShadowExp = createNullableType(_Nullable, _ShadowExp);
		private final @NonNull NullableType _Nullable_ShadowPart = createNullableType(_Nullable, _ShadowPart);
		private final @NonNull NullableType _Nullable_Signal = createNullableType(_Nullable, _Signal);
		private final @NonNull NullableType _Nullable_Slot = createNullableType(_Nullable, _Slot);
		private final @NonNull NullableType _Nullable_StandardLibrary = createNullableType(_Nullable, _StandardLibrary);
		private final @NonNull NullableType _Nullable_State = createNullableType(_Nullable, _State);
		private final @NonNull NullableType _Nullable_StateExp = createNullableType(_Nullable, _StateExp);
		private final @NonNull NullableType _Nullable_StateMachine = createNullableType(_Nullable, _StateMachine);
		private final @NonNull NullableType _Nullable_Stereotype = createNullableType(_Nullable, _Stereotype);
		private final @NonNull NullableType _Nullable_StereotypeExtender = createNullableType(_Nullable, _StereotypeExtender);
		private final @NonNull NullableType _Nullable_StringLiteralExp = createNullableType(_Nullable, _StringLiteralExp);
		private final @NonNull NullableType _Nullable_TemplateBinding = createNullableType(_Nullable, _TemplateBinding);
		private final @NonNull NullableType _Nullable_TemplateParameter = createNullableType(_Nullable, _TemplateParameter);
		private final @NonNull NullableType _Nullable_TemplateParameterSubstitution = createNullableType(_Nullable, _TemplateParameterSubstitution);
		private final @NonNull NullableType _Nullable_TemplateSignature = createNullableType(_Nullable, _TemplateSignature);
		private final @NonNull NullableType _Nullable_TemplateableElement = createNullableType(_Nullable, _TemplateableElement);
		private final @NonNull NullableType _Nullable_Throwable = createNullableType(_Nullable, _Throwable);
		private final @NonNull NullableType _Nullable_Transition = createNullableType(_Nullable, _Transition);
		private final @NonNull NullableType _Nullable_TransitionKind = createNullableType(_Nullable, _TransitionKind);
		private final @NonNull NullableType _Nullable_Trigger = createNullableType(_Nullable, _Trigger);
		private final @NonNull NullableType _Nullable_TupleLiteralExp = createNullableType(_Nullable, _TupleLiteralExp);
		private final @NonNull NullableType _Nullable_TupleLiteralPart = createNullableType(_Nullable, _TupleLiteralPart);
		private final @NonNull NullableType _Nullable_TupleType = createNullableType(_Nullable, _TupleType);
		private final @NonNull NullableType _Nullable_Type = createNullableType(_Nullable, _Type);
		private final @NonNull NullableType _Nullable_TypeExp = createNullableType(_Nullable, _TypeExp);
		private final @NonNull NullableType _Nullable_TypedElement = createNullableType(_Nullable, _TypedElement);
		private final @NonNull NullableType _Nullable_UnlimitedNaturalLiteralExp = createNullableType(_Nullable, _UnlimitedNaturalLiteralExp);
		private final @NonNull NullableType _Nullable_UnspecifiedValueExp = createNullableType(_Nullable, _UnspecifiedValueExp);
		private final @NonNull NullableType _Nullable_ValueSpecification = createNullableType(_Nullable, _ValueSpecification);
		private final @NonNull NullableType _Nullable_Variable = createNullableType(_Nullable, _Variable);
		private final @NonNull NullableType _Nullable_VariableDeclaration = createNullableType(_Nullable, _VariableDeclaration);
		private final @NonNull NullableType _Nullable_VariableExp = createNullableType(_Nullable, _VariableExp);
		private final @NonNull NullableType _Nullable_Vertex = createNullableType(_Nullable, _Vertex);
		private final @NonNull NullableType _Nullable_Visitable = createNullableType(_Nullable, _Visitable);
		private final @NonNull NullableType _Nullable_VoidType = createNullableType(_Nullable, _VoidType);
		private final @NonNull NullableType _Nullable_WildcardType = createNullableType(_Nullable, _WildcardType);
		...
		private void installNullableTypes() {
			...
			orphanTypes.add(_Nullable_Bag_Annotation);
			orphanTypes.add(_Nullable_Bag_AssociationClassCallExp);
			orphanTypes.add(_Nullable_Bag_CallOperationAction);
			orphanTypes.add(_Nullable_Bag_Class);
			orphanTypes.add(_Nullable_Bag_CollectionType);
			orphanTypes.add(_Nullable_Bag_CompleteClass);
			orphanTypes.add(_Nullable_Bag_CompleteModel);
			orphanTypes.add(_Nullable_Bag_CompletePackage);
			orphanTypes.add(_Nullable_Bag_ConnectionPointReference);
			orphanTypes.add(_Nullable_Bag_Constraint);
			orphanTypes.add(_Nullable_Bag_DataType);
			orphanTypes.add(_Nullable_Bag_DynamicElement);
			orphanTypes.add(_Nullable_Bag_DynamicProperty);
			orphanTypes.add(_Nullable_Bag_ElementExtension);
			orphanTypes.add(_Nullable_Bag_EnumLiteralExp);
			orphanTypes.add(_Nullable_Bag_Import);
			orphanTypes.add(_Nullable_Bag_InstanceSpecification);
			orphanTypes.add(_Nullable_Bag_InvalidableType);
			orphanTypes.add(_Nullable_Bag_LambdaType);
			orphanTypes.add(_Nullable_Bag_LoopExp);
			orphanTypes.add(_Nullable_Bag_MapType);
			orphanTypes.add(_Nullable_Bag_MessageType);
			orphanTypes.add(_Nullable_Bag_NavigationCallExp);
			orphanTypes.add(_Nullable_Bag_NullableType);
			orphanTypes.add(_Nullable_Bag_OCLExpression);
			orphanTypes.add(_Nullable_Bag_OperationCallExp);
			orphanTypes.add(_Nullable_Bag_Operation);
			orphanTypes.add(_Nullable_Bag_OppositePropertyCallExp);
			orphanTypes.add(_Nullable_Bag_Package);
			orphanTypes.add(_Nullable_Bag_PrimitiveType);
			orphanTypes.add(_Nullable_Bag_PropertyCallExp);
			orphanTypes.add(_Nullable_Bag_Property);
			orphanTypes.add(_Nullable_Bag_Region);
			orphanTypes.add(_Nullable_Bag_SendSignalAction);
			orphanTypes.add(_Nullable_Bag_ShadowPart);
			orphanTypes.add(_Nullable_Bag_Slot);
			orphanTypes.add(_Nullable_Bag_StateExp);
			orphanTypes.add(_Nullable_Bag_StateMachine);
			orphanTypes.add(_Nullable_Bag_State);
			orphanTypes.add(_Nullable_Bag_TemplateBinding);
			orphanTypes.add(_Nullable_Bag_TemplateParameterSubstitution);
			orphanTypes.add(_Nullable_Bag_TemplateParameter);
			orphanTypes.add(_Nullable_Bag_TemplateableElement);
			orphanTypes.add(_Nullable_Bag_TypeExp);
			orphanTypes.add(_Nullable_Bag_TypedElement);
			orphanTypes.add(_Nullable_Bag_VariableDeclaration);
			orphanTypes.add(_Nullable_Bag_VariableExp);
			orphanTypes.add(_Nullable_Bag_Variable);
			orphanTypes.add(_Nullable_Bag_WildcardType);
			orphanTypes.add(_Nullable_Collection_String);
			orphanTypes.add(_Nullable_Collection_Annotation);
			orphanTypes.add(_Nullable_Collection_AssociationClassCallExp);
			orphanTypes.add(_Nullable_Collection_Behavior);
			orphanTypes.add(_Nullable_Collection_CallOperationAction);
			orphanTypes.add(_Nullable_Collection_Class);
			orphanTypes.add(_Nullable_Collection_CollectionLiteralPart);
			orphanTypes.add(_Nullable_Collection_CollectionType);
			orphanTypes.add(_Nullable_Collection_Comment);
			orphanTypes.add(_Nullable_Collection_CompleteClass);
			orphanTypes.add(_Nullable_Collection_CompleteModel);
			orphanTypes.add(_Nullable_Collection_CompletePackage);
			orphanTypes.add(_Nullable_Collection_ConnectionPointReference);
			orphanTypes.add(_Nullable_Collection_Constraint);
			orphanTypes.add(_Nullable_Collection_DataType);
			orphanTypes.add(_Nullable_Collection_Detail);
			orphanTypes.add(_Nullable_Collection_DynamicElement);
			orphanTypes.add(_Nullable_Collection_DynamicProperty);
			orphanTypes.add(_Nullable_Collection_ElementExtension);
			orphanTypes.add(_Nullable_Collection_Element);
			orphanTypes.add(_Nullable_Collection_EnumLiteralExp);
			orphanTypes.add(_Nullable_Collection_EnumerationLiteral);
			orphanTypes.add(_Nullable_Collection_Import);
			orphanTypes.add(_Nullable_Collection_InstanceSpecification);
			orphanTypes.add(_Nullable_Collection_InvalidableType);
			orphanTypes.add(_Nullable_Collection_LambdaType);
			orphanTypes.add(_Nullable_Collection_LoopExp);
			orphanTypes.add(_Nullable_Collection_MapLiteralPart);
			orphanTypes.add(_Nullable_Collection_MapType);
			orphanTypes.add(_Nullable_Collection_MessageType);
			orphanTypes.add(_Nullable_Collection_Model);
			orphanTypes.add(_Nullable_Collection_NavigationCallExp);
			orphanTypes.add(_Nullable_Collection_NullableType);
			orphanTypes.add(_Nullable_Collection_OCLExpression);
			orphanTypes.add(_Nullable_Collection_OperationCallExp);
			orphanTypes.add(_Nullable_Collection_Operation);
			orphanTypes.add(_Nullable_Collection_OppositePropertyCallExp);
			orphanTypes.add(_Nullable_Collection_Package);
			orphanTypes.add(_Nullable_Collection_Parameter);
			orphanTypes.add(_Nullable_Collection_Precedence);
			orphanTypes.add(_Nullable_Collection_PrimitiveType);
			orphanTypes.add(_Nullable_Collection_ProfileApplication);
			orphanTypes.add(_Nullable_Collection_PropertyCallExp);
			orphanTypes.add(_Nullable_Collection_Property);
			orphanTypes.add(_Nullable_Collection_Pseudostate);
			orphanTypes.add(_Nullable_Collection_Region);
			orphanTypes.add(_Nullable_Collection_SendSignalAction);
			orphanTypes.add(_Nullable_Collection_ShadowPart);
			orphanTypes.add(_Nullable_Collection_Slot);
			orphanTypes.add(_Nullable_Collection_StateExp);
			orphanTypes.add(_Nullable_Collection_StateMachine);
			orphanTypes.add(_Nullable_Collection_State);
			orphanTypes.add(_Nullable_Collection_StereotypeExtender);
			orphanTypes.add(_Nullable_Collection_TemplateBinding);
			orphanTypes.add(_Nullable_Collection_TemplateParameterSubstitution);
			orphanTypes.add(_Nullable_Collection_TemplateParameter);
			orphanTypes.add(_Nullable_Collection_TemplateableElement);
			orphanTypes.add(_Nullable_Collection_Transition);
			orphanTypes.add(_Nullable_Collection_Trigger);
			orphanTypes.add(_Nullable_Collection_TupleLiteralPart);
			orphanTypes.add(_Nullable_Collection_TypeExp);
			orphanTypes.add(_Nullable_Collection_Type);
			orphanTypes.add(_Nullable_Collection_TypedElement);
			orphanTypes.add(_Nullable_Collection_ValueSpecification);
			orphanTypes.add(_Nullable_Collection_VariableDeclaration);
			orphanTypes.add(_Nullable_Collection_VariableExp);
			orphanTypes.add(_Nullable_Collection_Variable);
			orphanTypes.add(_Nullable_Collection_Vertex);
			orphanTypes.add(_Nullable_Collection_WildcardType);
			orphanTypes.add(_Nullable_OrderedCollection_CollectionLiteralPart);
			orphanTypes.add(_Nullable_OrderedCollection_Detail);
			orphanTypes.add(_Nullable_OrderedCollection_Element);
			orphanTypes.add(_Nullable_OrderedCollection_EnumerationLiteral);
			orphanTypes.add(_Nullable_OrderedCollection_Import);
			orphanTypes.add(_Nullable_OrderedCollection_MapLiteralPart);
			orphanTypes.add(_Nullable_OrderedCollection_OCLExpression);
			orphanTypes.add(_Nullable_OrderedCollection_Operation);
			orphanTypes.add(_Nullable_OrderedCollection_Parameter);
			orphanTypes.add(_Nullable_OrderedCollection_Precedence);
			orphanTypes.add(_Nullable_OrderedCollection_Property);
			orphanTypes.add(_Nullable_OrderedCollection_ShadowPart);
			orphanTypes.add(_Nullable_OrderedCollection_TemplateParameter);
			orphanTypes.add(_Nullable_OrderedCollection_TupleLiteralPart);
			orphanTypes.add(_Nullable_OrderedCollection_Type);
			orphanTypes.add(_Nullable_OrderedCollection_ValueSpecification);
			orphanTypes.add(_Nullable_OrderedCollection_Variable);
			orphanTypes.add(_Nullable_OrderedSet_CollectionLiteralPart_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_Detail_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_Element_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_EnumerationLiteral_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_Import_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_MapLiteralPart_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_OCLExpression_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_Operation_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_Parameter_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_Precedence_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_Property_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_ShadowPart_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_TemplateParameter_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_TupleLiteralPart_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_ValueSpecification_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_Variable_NullFree);
			orphanTypes.add(_Nullable_Sequence_Type_NullFree);
			orphanTypes.add(_Nullable_Set_String_NullFree);
			orphanTypes.add(_Nullable_Set_Behavior_NullFree);
			orphanTypes.add(_Nullable_Set_Class_NullFree);
			orphanTypes.add(_Nullable_Set_Comment_NullFree);
			orphanTypes.add(_Nullable_Set_CompleteClass_NullFree);
			orphanTypes.add(_Nullable_Set_CompletePackage_NullFree);
			orphanTypes.add(_Nullable_Set_ConnectionPointReference_NullFree);
			orphanTypes.add(_Nullable_Set_Constraint_NullFree);
			orphanTypes.add(_Nullable_Set_DynamicProperty_NullFree);
			orphanTypes.add(_Nullable_Set_ElementExtension_NullFree);
			orphanTypes.add(_Nullable_Set_Element_NullFree);
			orphanTypes.add(_Nullable_Set_InstanceSpecification_NullFree);
			orphanTypes.add(_Nullable_Set_Model_NullFree);
			orphanTypes.add(_Nullable_Set_Operation_NullFree);
			orphanTypes.add(_Nullable_Set_Package_NullFree);
			orphanTypes.add(_Nullable_Set_ProfileApplication_NullFree);
			orphanTypes.add(_Nullable_Set_Property_NullFree);
			orphanTypes.add(_Nullable_Set_Pseudostate_NullFree);
			orphanTypes.add(_Nullable_Set_Region_NullFree);
			orphanTypes.add(_Nullable_Set_Region_NullFree_1);
			orphanTypes.add(_Nullable_Set_Slot_NullFree);
			orphanTypes.add(_Nullable_Set_StateMachine_NullFree);
			orphanTypes.add(_Nullable_Set_State_NullFree);
			orphanTypes.add(_Nullable_Set_StereotypeExtender_NullFree);
			orphanTypes.add(_Nullable_Set_TemplateBinding_NullFree);
			orphanTypes.add(_Nullable_Set_TemplateParameterSubstitution_NullFree);
			orphanTypes.add(_Nullable_Set_Transition_NullFree);
			orphanTypes.add(_Nullable_Set_Trigger_NullFree);
			orphanTypes.add(_Nullable_Set_Type_NullFree);
			orphanTypes.add(_Nullable_Set_Vertex_NullFree);
			orphanTypes.add(_Nullable_UniqueCollection_String);
			orphanTypes.add(_Nullable_UniqueCollection_Behavior);
			orphanTypes.add(_Nullable_UniqueCollection_Class);
			orphanTypes.add(_Nullable_UniqueCollection_CollectionLiteralPart);
			orphanTypes.add(_Nullable_UniqueCollection_Comment);
			orphanTypes.add(_Nullable_UniqueCollection_CompleteClass);
			orphanTypes.add(_Nullable_UniqueCollection_CompletePackage);
			orphanTypes.add(_Nullable_UniqueCollection_ConnectionPointReference);
			orphanTypes.add(_Nullable_UniqueCollection_Constraint);
			orphanTypes.add(_Nullable_UniqueCollection_Detail);
			orphanTypes.add(_Nullable_UniqueCollection_DynamicProperty);
			orphanTypes.add(_Nullable_UniqueCollection_ElementExtension);
			orphanTypes.add(_Nullable_UniqueCollection_Element);
			orphanTypes.add(_Nullable_UniqueCollection_EnumerationLiteral);
			orphanTypes.add(_Nullable_UniqueCollection_Import);
			orphanTypes.add(_Nullable_UniqueCollection_InstanceSpecification);
			orphanTypes.add(_Nullable_UniqueCollection_MapLiteralPart);
			orphanTypes.add(_Nullable_UniqueCollection_Model);
			orphanTypes.add(_Nullable_UniqueCollection_OCLExpression);
			orphanTypes.add(_Nullable_UniqueCollection_Operation);
			orphanTypes.add(_Nullable_UniqueCollection_Package);
			orphanTypes.add(_Nullable_UniqueCollection_Parameter);
			orphanTypes.add(_Nullable_UniqueCollection_Precedence);
			orphanTypes.add(_Nullable_UniqueCollection_ProfileApplication);
			orphanTypes.add(_Nullable_UniqueCollection_Property);
			orphanTypes.add(_Nullable_UniqueCollection_Pseudostate);
			orphanTypes.add(_Nullable_UniqueCollection_Region);
			orphanTypes.add(_Nullable_UniqueCollection_ShadowPart);
			orphanTypes.add(_Nullable_UniqueCollection_Slot);
			orphanTypes.add(_Nullable_UniqueCollection_StateMachine);
			orphanTypes.add(_Nullable_UniqueCollection_State);
			orphanTypes.add(_Nullable_UniqueCollection_StereotypeExtender);
			orphanTypes.add(_Nullable_UniqueCollection_TemplateBinding);
			orphanTypes.add(_Nullable_UniqueCollection_TemplateParameterSubstitution);
			orphanTypes.add(_Nullable_UniqueCollection_TemplateParameter);
			orphanTypes.add(_Nullable_UniqueCollection_Transition);
			orphanTypes.add(_Nullable_UniqueCollection_Trigger);
			orphanTypes.add(_Nullable_UniqueCollection_TupleLiteralPart);
			orphanTypes.add(_Nullable_UniqueCollection_Type);
			orphanTypes.add(_Nullable_UniqueCollection_ValueSpecification);
			orphanTypes.add(_Nullable_UniqueCollection_Variable);
			orphanTypes.add(_Nullable_UniqueCollection_Vertex);
			orphanTypes.add(_Nullable_Annotation);
			orphanTypes.add(_Nullable_AnyType);
			orphanTypes.add(_Nullable_AssociationClass);
			orphanTypes.add(_Nullable_AssociationClassCallExp);
			orphanTypes.add(_Nullable_AssociativityKind);
			orphanTypes.add(_Nullable_BagType);
			orphanTypes.add(_Nullable_Behavior);
			orphanTypes.add(_Nullable_BooleanLiteralExp);
			orphanTypes.add(_Nullable_CallExp);
			orphanTypes.add(_Nullable_CallOperationAction);
			orphanTypes.add(_Nullable_Class);
			orphanTypes.add(_Nullable_CollectionItem);
			orphanTypes.add(_Nullable_CollectionKind);
			orphanTypes.add(_Nullable_CollectionLiteralExp);
			orphanTypes.add(_Nullable_CollectionLiteralPart);
			orphanTypes.add(_Nullable_CollectionRange);
			orphanTypes.add(_Nullable_CollectionType);
			orphanTypes.add(_Nullable_Comment);
			orphanTypes.add(_Nullable_CompleteClass);
			orphanTypes.add(_Nullable_CompleteEnvironment);
			orphanTypes.add(_Nullable_CompleteModel);
			orphanTypes.add(_Nullable_CompletePackage);
			orphanTypes.add(_Nullable_ConnectionPointReference);
			orphanTypes.add(_Nullable_Constraint);
			orphanTypes.add(_Nullable_DataType);
			orphanTypes.add(_Nullable_Detail);
			orphanTypes.add(_Nullable_DynamicBehavior);
			orphanTypes.add(_Nullable_DynamicElement);
			orphanTypes.add(_Nullable_DynamicProperty);
			orphanTypes.add(_Nullable_DynamicType);
			orphanTypes.add(_Nullable_DynamicValueSpecification);
			orphanTypes.add(_Nullable_Element);
			orphanTypes.add(_Nullable_ElementExtension);
			orphanTypes.add(_Nullable_EnumLiteralExp);
			orphanTypes.add(_Nullable_Enumeration);
			orphanTypes.add(_Nullable_EnumerationLiteral);
			orphanTypes.add(_Nullable_ExpressionInOCL);
			orphanTypes.add(_Nullable_Feature);
			orphanTypes.add(_Nullable_FeatureCallExp);
			orphanTypes.add(_Nullable_FinalState);
			orphanTypes.add(_Nullable_IfExp);
			orphanTypes.add(_Nullable_Import);
			orphanTypes.add(_Nullable_InstanceSpecification);
			orphanTypes.add(_Nullable_IntegerLiteralExp);
			orphanTypes.add(_Nullable_InvalidLiteralExp);
			orphanTypes.add(_Nullable_InvalidType);
			orphanTypes.add(_Nullable_InvalidableType);
			orphanTypes.add(_Nullable_IterateExp);
			orphanTypes.add(_Nullable_Iteration);
			orphanTypes.add(_Nullable_IteratorExp);
			orphanTypes.add(_Nullable_IteratorVariable);
			orphanTypes.add(_Nullable_LambdaType);
			orphanTypes.add(_Nullable_LanguageExpression);
			orphanTypes.add(_Nullable_LetExp);
			orphanTypes.add(_Nullable_LetVariable);
			orphanTypes.add(_Nullable_Library);
			orphanTypes.add(_Nullable_LibraryFeature);
			orphanTypes.add(_Nullable_LiteralExp);
			orphanTypes.add(_Nullable_LoopExp);
			orphanTypes.add(_Nullable_MapLiteralExp);
			orphanTypes.add(_Nullable_MapLiteralPart);
			orphanTypes.add(_Nullable_MapType);
			orphanTypes.add(_Nullable_MessageExp);
			orphanTypes.add(_Nullable_MessageType);
			orphanTypes.add(_Nullable_Model);
			orphanTypes.add(_Nullable_MorePivotable);
			orphanTypes.add(_Nullable_Nameable);
			orphanTypes.add(_Nullable_NamedElement);
			orphanTypes.add(_Nullable_Namespace);
			orphanTypes.add(_Nullable_NavigationCallExp);
			orphanTypes.add(_Nullable_NullLiteralExp);
			orphanTypes.add(_Nullable_NullableType);
			orphanTypes.add(_Nullable_NumericLiteralExp);
			orphanTypes.add(_Nullable_OCLExpression);
			orphanTypes.add(_Nullable_Object);
			orphanTypes.add(_Nullable_Operation);
			orphanTypes.add(_Nullable_OperationCallExp);
			orphanTypes.add(_Nullable_OppositePropertyCallExp);
			orphanTypes.add(_Nullable_OrderedSetType);
			orphanTypes.add(_Nullable_OrphanCompletePackage);
			orphanTypes.add(_Nullable_Package);
			orphanTypes.add(_Nullable_Parameter);
			orphanTypes.add(_Nullable_ParameterVariable);
			orphanTypes.add(_Nullable_Pivotable);
			orphanTypes.add(_Nullable_Precedence);
			orphanTypes.add(_Nullable_PrimitiveCompletePackage);
			orphanTypes.add(_Nullable_PrimitiveLiteralExp);
			orphanTypes.add(_Nullable_PrimitiveType);
			orphanTypes.add(_Nullable_Profile);
			orphanTypes.add(_Nullable_ProfileApplication);
			orphanTypes.add(_Nullable_Property);
			orphanTypes.add(_Nullable_PropertyCallExp);
			orphanTypes.add(_Nullable_Pseudostate);
			orphanTypes.add(_Nullable_PseudostateKind);
			orphanTypes.add(_Nullable_RealLiteralExp);
			orphanTypes.add(_Nullable_ReferringElement);
			orphanTypes.add(_Nullable_Region);
			orphanTypes.add(_Nullable_ResultVariable);
			orphanTypes.add(_Nullable_SelfType);
			orphanTypes.add(_Nullable_SendSignalAction);
			orphanTypes.add(_Nullable_SequenceType);
			orphanTypes.add(_Nullable_SetType);
			orphanTypes.add(_Nullable_ShadowExp);
			orphanTypes.add(_Nullable_ShadowPart);
			orphanTypes.add(_Nullable_Signal);
			orphanTypes.add(_Nullable_Slot);
			orphanTypes.add(_Nullable_StandardLibrary);
			orphanTypes.add(_Nullable_State);
			orphanTypes.add(_Nullable_StateExp);
			orphanTypes.add(_Nullable_StateMachine);
			orphanTypes.add(_Nullable_Stereotype);
			orphanTypes.add(_Nullable_StereotypeExtender);
			orphanTypes.add(_Nullable_StringLiteralExp);
			orphanTypes.add(_Nullable_TemplateBinding);
			orphanTypes.add(_Nullable_TemplateParameter);
			orphanTypes.add(_Nullable_TemplateParameterSubstitution);
			orphanTypes.add(_Nullable_TemplateSignature);
			orphanTypes.add(_Nullable_TemplateableElement);
			orphanTypes.add(_Nullable_Throwable);
			orphanTypes.add(_Nullable_Transition);
			orphanTypes.add(_Nullable_TransitionKind);
			orphanTypes.add(_Nullable_Trigger);
			orphanTypes.add(_Nullable_TupleLiteralExp);
			orphanTypes.add(_Nullable_TupleLiteralPart);
			orphanTypes.add(_Nullable_TupleType);
			orphanTypes.add(_Nullable_Type);
			orphanTypes.add(_Nullable_TypeExp);
			orphanTypes.add(_Nullable_TypedElement);
			orphanTypes.add(_Nullable_UnlimitedNaturalLiteralExp);
			orphanTypes.add(_Nullable_UnspecifiedValueExp);
			orphanTypes.add(_Nullable_ValueSpecification);
			orphanTypes.add(_Nullable_Variable);
			orphanTypes.add(_Nullable_VariableDeclaration);
			orphanTypes.add(_Nullable_VariableExp);
			orphanTypes.add(_Nullable_Vertex);
			orphanTypes.add(_Nullable_Visitable);
			orphanTypes.add(_Nullable_VoidType);
			orphanTypes.add(_Nullable_WildcardType);
		}
