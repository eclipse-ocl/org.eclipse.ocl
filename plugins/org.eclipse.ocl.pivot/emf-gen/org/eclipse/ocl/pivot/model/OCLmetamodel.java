...
public class OCLmetamodel extends ASResourceImpl
{
	...
	private static class Contents extends LibraryContents
	{
		...
		private void installAggregateTypes0() {
			...
			type = _Collection_String_F = getCollectionType(orphanage, _Collection, _String, false, 0, -1);
			type = _Collection_Annotation_F = getCollectionType(orphanage, _Collection, _Annotation, false, 0, -1);
			type = _Collection_AssociationClassCallExp_F = getCollectionType(orphanage, _Collection, _AssociationClassCallExp, false, 0, -1);
			type = _Collection_Behavior_F = getCollectionType(orphanage, _Collection, _Behavior, false, 0, -1);
			type = _Collection_CallOperationAction_F = getCollectionType(orphanage, _Collection, _CallOperationAction, false, 0, -1);
			type = _Collection_Class_F = getCollectionType(orphanage, _Collection, _Class, false, 0, -1);
			type = _Collection_CollectionLiteralPart_F = getCollectionType(orphanage, _Collection, _CollectionLiteralPart, false, 0, -1);
			type = _Collection_CollectionType_F = getCollectionType(orphanage, _Collection, _CollectionType, false, 0, -1);
			type = _Collection_Comment_F = getCollectionType(orphanage, _Collection, _Comment, false, 0, -1);
			type = _Collection_CompleteClass_F = getCollectionType(orphanage, _Collection, _CompleteClass, false, 0, -1);
			type = _Collection_CompleteModel_F = getCollectionType(orphanage, _Collection, _CompleteModel, false, 0, -1);
			type = _Collection_CompletePackage_F = getCollectionType(orphanage, _Collection, _CompletePackage, false, 0, -1);
			type = _Collection_ConnectionPointReference_F = getCollectionType(orphanage, _Collection, _ConnectionPointReference, false, 0, -1);
			type = _Collection_Constraint_F = getCollectionType(orphanage, _Collection, _Constraint, false, 0, -1);
			type = _Collection_DataType_F = getCollectionType(orphanage, _Collection, _DataType, false, 0, -1);
			type = _Collection_Detail_F = getCollectionType(orphanage, _Collection, _Detail, false, 0, -1);
			type = _Collection_DynamicElement_F = getCollectionType(orphanage, _Collection, _DynamicElement, false, 0, -1);
			type = _Collection_DynamicProperty_F = getCollectionType(orphanage, _Collection, _DynamicProperty, false, 0, -1);
			type = _Collection_ElementExtension_F = getCollectionType(orphanage, _Collection, _ElementExtension, false, 0, -1);
			type = _Collection_Element_F = getCollectionType(orphanage, _Collection, _Element, false, 0, -1);
			type = _Collection_EnumLiteralExp_F = getCollectionType(orphanage, _Collection, _EnumLiteralExp, false, 0, -1);
			type = _Collection_EnumerationLiteral_F = getCollectionType(orphanage, _Collection, _EnumerationLiteral, false, 0, -1);
			type = _Collection_Import_F = getCollectionType(orphanage, _Collection, _Import, false, 0, -1);
			type = _Collection_InstanceSpecification_F = getCollectionType(orphanage, _Collection, _InstanceSpecification, false, 0, -1);
			type = _Collection_IteratorVariable_F = getCollectionType(orphanage, _Collection, _IteratorVariable, false, 0, -1);
			type = _Collection_LambdaType_F = getCollectionType(orphanage, _Collection, _LambdaType, false, 0, -1);
			type = _Collection_LoopExp_F = getCollectionType(orphanage, _Collection, _LoopExp, false, 0, -1);
			type = _Collection_MapLiteralPart_F = getCollectionType(orphanage, _Collection, _MapLiteralPart, false, 0, -1);
			type = _Collection_MapType_F = getCollectionType(orphanage, _Collection, _MapType, false, 0, -1);
			type = _Collection_MessageType_F = getCollectionType(orphanage, _Collection, _MessageType, false, 0, -1);
			type = _Collection_Model_F = getCollectionType(orphanage, _Collection, _Model, false, 0, -1);
			type = _Collection_NavigationCallExp_F = getCollectionType(orphanage, _Collection, _NavigationCallExp, false, 0, -1);
			type = _Collection_OCLExpression_F = getCollectionType(orphanage, _Collection, _OCLExpression, false, 0, -1);
			type = _Collection_OperationCallExp_F = getCollectionType(orphanage, _Collection, _OperationCallExp, false, 0, -1);
			type = _Collection_Operation_F = getCollectionType(orphanage, _Collection, _Operation, false, 0, -1);
			type = _Collection_OppositePropertyCallExp_F = getCollectionType(orphanage, _Collection, _OppositePropertyCallExp, false, 0, -1);
			type = _Collection_Package_F = getCollectionType(orphanage, _Collection, _Package, false, 0, -1);
			type = _Collection_Parameter_F = getCollectionType(orphanage, _Collection, _Parameter, false, 0, -1);
			type = _Collection_Precedence_F = getCollectionType(orphanage, _Collection, _Precedence, false, 0, -1);
			type = _Collection_PrimitiveType_F = getCollectionType(orphanage, _Collection, _PrimitiveType, false, 0, -1);
			type = _Collection_ProfileApplication_F = getCollectionType(orphanage, _Collection, _ProfileApplication, false, 0, -1);
			type = _Collection_PropertyCallExp_F = getCollectionType(orphanage, _Collection, _PropertyCallExp, false, 0, -1);
			type = _Collection_Property_F = getCollectionType(orphanage, _Collection, _Property, false, 0, -1);
			type = _Collection_Pseudostate_F = getCollectionType(orphanage, _Collection, _Pseudostate, false, 0, -1);
			type = _Collection_Region_F = getCollectionType(orphanage, _Collection, _Region, false, 0, -1);
			type = _Collection_SendSignalAction_F = getCollectionType(orphanage, _Collection, _SendSignalAction, false, 0, -1);
			type = _Collection_ShadowPart_F = getCollectionType(orphanage, _Collection, _ShadowPart, false, 0, -1);
			type = _Collection_Slot_F = getCollectionType(orphanage, _Collection, _Slot, false, 0, -1);
			type = _Collection_StateExp_F = getCollectionType(orphanage, _Collection, _StateExp, false, 0, -1);
			type = _Collection_StateMachine_F = getCollectionType(orphanage, _Collection, _StateMachine, false, 0, -1);
			type = _Collection_State_F = getCollectionType(orphanage, _Collection, _State, false, 0, -1);
			type = _Collection_StereotypeExtender_F = getCollectionType(orphanage, _Collection, _StereotypeExtender, false, 0, -1);
			type = _Collection_TemplateBinding_F = getCollectionType(orphanage, _Collection, _TemplateBinding, false, 0, -1);
			type = _Collection_TemplateParameterSubstitution_F = getCollectionType(orphanage, _Collection, _TemplateParameterSubstitution, false, 0, -1);
			type = _Collection_TemplateParameter_F = getCollectionType(orphanage, _Collection, _TemplateParameter, false, 0, -1);
			type = _Collection_TemplateableElement_F = getCollectionType(orphanage, _Collection, _TemplateableElement, false, 0, -1);
			type = _Collection_Transition_F = getCollectionType(orphanage, _Collection, _Transition, false, 0, -1);
			type = _Collection_Trigger_F = getCollectionType(orphanage, _Collection, _Trigger, false, 0, -1);
			type = _Collection_TupleLiteralPart_F = getCollectionType(orphanage, _Collection, _TupleLiteralPart, false, 0, -1);
			type = _Collection_TypeExp_F = getCollectionType(orphanage, _Collection, _TypeExp, false, 0, -1);
			type = _Collection_Type_F = getCollectionType(orphanage, _Collection, _Type, false, 0, -1);
			type = _Collection_TypedElement_F = getCollectionType(orphanage, _Collection, _TypedElement, false, 0, -1);
			type = _Collection_ValueSpecification_F = getCollectionType(orphanage, _Collection, _ValueSpecification, false, 0, -1);
			type = _Collection_VariableDeclaration_F = getCollectionType(orphanage, _Collection, _VariableDeclaration, false, 0, -1);
			type = _Collection_VariableExp_F = getCollectionType(orphanage, _Collection, _VariableExp, false, 0, -1);
			type = _Collection_Variable_F = getCollectionType(orphanage, _Collection, _Variable, false, 0, -1);
			type = _Collection_Vertex_F = getCollectionType(orphanage, _Collection, _Vertex, false, 0, -1);
			type = _Collection_WildcardType_F = getCollectionType(orphanage, _Collection, _WildcardType, false, 0, -1);
		...
		private void installAggregateTypes1() {
			...
			type = _Bag_Annotation_F = getBagType(orphanage, _Bag, _Annotation, false, 0, -1);
			type = _Bag_AssociationClassCallExp_F = getBagType(orphanage, _Bag, _AssociationClassCallExp, false, 0, -1);
			type = _Bag_CallOperationAction_F = getBagType(orphanage, _Bag, _CallOperationAction, false, 0, -1);
			type = _Bag_Class_F = getBagType(orphanage, _Bag, _Class, false, 0, -1);
			type = _Bag_CollectionType_F = getBagType(orphanage, _Bag, _CollectionType, false, 0, -1);
			type = _Bag_CompleteClass_F = getBagType(orphanage, _Bag, _CompleteClass, false, 0, -1);
			type = _Bag_CompleteModel_F = getBagType(orphanage, _Bag, _CompleteModel, false, 0, -1);
			type = _Bag_CompletePackage_F = getBagType(orphanage, _Bag, _CompletePackage, false, 0, -1);
			type = _Bag_ConnectionPointReference_F = getBagType(orphanage, _Bag, _ConnectionPointReference, false, 0, -1);
			type = _Bag_Constraint_F = getBagType(orphanage, _Bag, _Constraint, false, 0, -1);
			type = _Bag_DataType_F = getBagType(orphanage, _Bag, _DataType, false, 0, -1);
			type = _Bag_DynamicElement_F = getBagType(orphanage, _Bag, _DynamicElement, false, 0, -1);
			type = _Bag_DynamicProperty_F = getBagType(orphanage, _Bag, _DynamicProperty, false, 0, -1);
			type = _Bag_ElementExtension_F = getBagType(orphanage, _Bag, _ElementExtension, false, 0, -1);
			type = _Bag_EnumLiteralExp_F = getBagType(orphanage, _Bag, _EnumLiteralExp, false, 0, -1);
			type = _Bag_Import_F = getBagType(orphanage, _Bag, _Import, false, 0, -1);
			type = _Bag_InstanceSpecification_F = getBagType(orphanage, _Bag, _InstanceSpecification, false, 0, -1);
			type = _Bag_LambdaType_F = getBagType(orphanage, _Bag, _LambdaType, false, 0, -1);
			type = _Bag_LoopExp_F = getBagType(orphanage, _Bag, _LoopExp, false, 0, -1);
			type = _Bag_MapType_F = getBagType(orphanage, _Bag, _MapType, false, 0, -1);
			type = _Bag_MessageType_F = getBagType(orphanage, _Bag, _MessageType, false, 0, -1);
			type = _Bag_NavigationCallExp_F = getBagType(orphanage, _Bag, _NavigationCallExp, false, 0, -1);
			type = _Bag_OCLExpression_F = getBagType(orphanage, _Bag, _OCLExpression, false, 0, -1);
			type = _Bag_OperationCallExp_F = getBagType(orphanage, _Bag, _OperationCallExp, false, 0, -1);
			type = _Bag_Operation_F = getBagType(orphanage, _Bag, _Operation, false, 0, -1);
			type = _Bag_OppositePropertyCallExp_F = getBagType(orphanage, _Bag, _OppositePropertyCallExp, false, 0, -1);
			type = _Bag_Package_F = getBagType(orphanage, _Bag, _Package, false, 0, -1);
			type = _Bag_PrimitiveType_F = getBagType(orphanage, _Bag, _PrimitiveType, false, 0, -1);
			type = _Bag_PropertyCallExp_F = getBagType(orphanage, _Bag, _PropertyCallExp, false, 0, -1);
			type = _Bag_Property_F = getBagType(orphanage, _Bag, _Property, false, 0, -1);
			type = _Bag_Region_F = getBagType(orphanage, _Bag, _Region, false, 0, -1);
			type = _Bag_SendSignalAction_F = getBagType(orphanage, _Bag, _SendSignalAction, false, 0, -1);
			type = _Bag_ShadowPart_F = getBagType(orphanage, _Bag, _ShadowPart, false, 0, -1);
			type = _Bag_Slot_F = getBagType(orphanage, _Bag, _Slot, false, 0, -1);
			type = _Bag_StateExp_F = getBagType(orphanage, _Bag, _StateExp, false, 0, -1);
			type = _Bag_StateMachine_F = getBagType(orphanage, _Bag, _StateMachine, false, 0, -1);
			type = _Bag_State_F = getBagType(orphanage, _Bag, _State, false, 0, -1);
			type = _Bag_TemplateBinding_F = getBagType(orphanage, _Bag, _TemplateBinding, false, 0, -1);
			type = _Bag_TemplateParameterSubstitution_F = getBagType(orphanage, _Bag, _TemplateParameterSubstitution, false, 0, -1);
			type = _Bag_TemplateParameter_F = getBagType(orphanage, _Bag, _TemplateParameter, false, 0, -1);
			type = _Bag_TemplateableElement_F = getBagType(orphanage, _Bag, _TemplateableElement, false, 0, -1);
			type = _Bag_TypeExp_F = getBagType(orphanage, _Bag, _TypeExp, false, 0, -1);
			type = _Bag_TypedElement_F = getBagType(orphanage, _Bag, _TypedElement, false, 0, -1);
			type = _Bag_VariableDeclaration_F = getBagType(orphanage, _Bag, _VariableDeclaration, false, 0, -1);
			type = _Bag_VariableExp_F = getBagType(orphanage, _Bag, _VariableExp, false, 0, -1);
			type = _Bag_Variable_F = getBagType(orphanage, _Bag, _Variable, false, 0, -1);
			type = _Bag_WildcardType_F = getBagType(orphanage, _Bag, _WildcardType, false, 0, -1);
			type = _OrderedCollection_CollectionLiteralPart_F = getCollectionType(orphanage, _OrderedCollection, _CollectionLiteralPart, false, 0, -1);
			type = _OrderedCollection_Detail_F = getCollectionType(orphanage, _OrderedCollection, _Detail, false, 0, -1);
			type = _OrderedCollection_Element_F = getCollectionType(orphanage, _OrderedCollection, _Element, false, 0, -1);
			type = _OrderedCollection_EnumerationLiteral_F = getCollectionType(orphanage, _OrderedCollection, _EnumerationLiteral, false, 0, -1);
			type = _OrderedCollection_Import_F = getCollectionType(orphanage, _OrderedCollection, _Import, false, 0, -1);
			type = _OrderedCollection_IteratorVariable_F = getCollectionType(orphanage, _OrderedCollection, _IteratorVariable, false, 0, -1);
			type = _OrderedCollection_MapLiteralPart_F = getCollectionType(orphanage, _OrderedCollection, _MapLiteralPart, false, 0, -1);
			type = _OrderedCollection_OCLExpression_F = getCollectionType(orphanage, _OrderedCollection, _OCLExpression, false, 0, -1);
			type = _OrderedCollection_Operation_F = getCollectionType(orphanage, _OrderedCollection, _Operation, false, 0, -1);
			type = _OrderedCollection_Parameter_F = getCollectionType(orphanage, _OrderedCollection, _Parameter, false, 0, -1);
			type = _OrderedCollection_Precedence_F = getCollectionType(orphanage, _OrderedCollection, _Precedence, false, 0, -1);
			type = _OrderedCollection_Property_F = getCollectionType(orphanage, _OrderedCollection, _Property, false, 0, -1);
			type = _OrderedCollection_ShadowPart_F = getCollectionType(orphanage, _OrderedCollection, _ShadowPart, false, 0, -1);
			type = _OrderedCollection_TemplateParameter_F = getCollectionType(orphanage, _OrderedCollection, _TemplateParameter, false, 0, -1);
			type = _OrderedCollection_TupleLiteralPart_F = getCollectionType(orphanage, _OrderedCollection, _TupleLiteralPart, false, 0, -1);
			type = _OrderedCollection_Type_F = getCollectionType(orphanage, _OrderedCollection, _Type, false, 0, -1);
			type = _OrderedCollection_ValueSpecification_F = getCollectionType(orphanage, _OrderedCollection, _ValueSpecification, false, 0, -1);
			type = _OrderedCollection_Variable_F = getCollectionType(orphanage, _OrderedCollection, _Variable, false, 0, -1);
			type = _UniqueCollection_String_F = getCollectionType(orphanage, _UniqueCollection, _String, false, 0, -1);
			type = _UniqueCollection_Behavior_F = getCollectionType(orphanage, _UniqueCollection, _Behavior, false, 0, -1);
			type = _UniqueCollection_Class_F = getCollectionType(orphanage, _UniqueCollection, _Class, false, 0, -1);
			type = _UniqueCollection_CollectionLiteralPart_F = getCollectionType(orphanage, _UniqueCollection, _CollectionLiteralPart, false, 0, -1);
			type = _UniqueCollection_Comment_F = getCollectionType(orphanage, _UniqueCollection, _Comment, false, 0, -1);
			type = _UniqueCollection_CompleteClass_F = getCollectionType(orphanage, _UniqueCollection, _CompleteClass, false, 0, -1);
			type = _UniqueCollection_CompletePackage_F = getCollectionType(orphanage, _UniqueCollection, _CompletePackage, false, 0, -1);
			type = _UniqueCollection_ConnectionPointReference_F = getCollectionType(orphanage, _UniqueCollection, _ConnectionPointReference, false, 0, -1);
			type = _UniqueCollection_Constraint_F = getCollectionType(orphanage, _UniqueCollection, _Constraint, false, 0, -1);
			type = _UniqueCollection_Detail_F = getCollectionType(orphanage, _UniqueCollection, _Detail, false, 0, -1);
			type = _UniqueCollection_DynamicProperty_F = getCollectionType(orphanage, _UniqueCollection, _DynamicProperty, false, 0, -1);
			type = _UniqueCollection_ElementExtension_F = getCollectionType(orphanage, _UniqueCollection, _ElementExtension, false, 0, -1);
			type = _UniqueCollection_Element_F = getCollectionType(orphanage, _UniqueCollection, _Element, false, 0, -1);
			type = _UniqueCollection_EnumerationLiteral_F = getCollectionType(orphanage, _UniqueCollection, _EnumerationLiteral, false, 0, -1);
			type = _UniqueCollection_Import_F = getCollectionType(orphanage, _UniqueCollection, _Import, false, 0, -1);
			type = _UniqueCollection_InstanceSpecification_F = getCollectionType(orphanage, _UniqueCollection, _InstanceSpecification, false, 0, -1);
			type = _UniqueCollection_IteratorVariable_F = getCollectionType(orphanage, _UniqueCollection, _IteratorVariable, false, 0, -1);
			type = _UniqueCollection_MapLiteralPart_F = getCollectionType(orphanage, _UniqueCollection, _MapLiteralPart, false, 0, -1);
			type = _UniqueCollection_Model_F = getCollectionType(orphanage, _UniqueCollection, _Model, false, 0, -1);
			type = _UniqueCollection_OCLExpression_F = getCollectionType(orphanage, _UniqueCollection, _OCLExpression, false, 0, -1);
			type = _UniqueCollection_Operation_F = getCollectionType(orphanage, _UniqueCollection, _Operation, false, 0, -1);
			type = _UniqueCollection_Package_F = getCollectionType(orphanage, _UniqueCollection, _Package, false, 0, -1);
			type = _UniqueCollection_Parameter_F = getCollectionType(orphanage, _UniqueCollection, _Parameter, false, 0, -1);
			type = _UniqueCollection_Precedence_F = getCollectionType(orphanage, _UniqueCollection, _Precedence, false, 0, -1);
			type = _UniqueCollection_ProfileApplication_F = getCollectionType(orphanage, _UniqueCollection, _ProfileApplication, false, 0, -1);
			type = _UniqueCollection_Property_F = getCollectionType(orphanage, _UniqueCollection, _Property, false, 0, -1);
			type = _UniqueCollection_Pseudostate_F = getCollectionType(orphanage, _UniqueCollection, _Pseudostate, false, 0, -1);
			type = _UniqueCollection_Region_F = getCollectionType(orphanage, _UniqueCollection, _Region, false, 0, -1);
			type = _UniqueCollection_ShadowPart_F = getCollectionType(orphanage, _UniqueCollection, _ShadowPart, false, 0, -1);
			type = _UniqueCollection_Slot_F = getCollectionType(orphanage, _UniqueCollection, _Slot, false, 0, -1);
			type = _UniqueCollection_StateMachine_F = getCollectionType(orphanage, _UniqueCollection, _StateMachine, false, 0, -1);
			type = _UniqueCollection_State_F = getCollectionType(orphanage, _UniqueCollection, _State, false, 0, -1);
			type = _UniqueCollection_StereotypeExtender_F = getCollectionType(orphanage, _UniqueCollection, _StereotypeExtender, false, 0, -1);
			type = _UniqueCollection_TemplateBinding_F = getCollectionType(orphanage, _UniqueCollection, _TemplateBinding, false, 0, -1);
			type = _UniqueCollection_TemplateParameterSubstitution_F = getCollectionType(orphanage, _UniqueCollection, _TemplateParameterSubstitution, false, 0, -1);
			type = _UniqueCollection_TemplateParameter_F = getCollectionType(orphanage, _UniqueCollection, _TemplateParameter, false, 0, -1);
			type = _UniqueCollection_Transition_F = getCollectionType(orphanage, _UniqueCollection, _Transition, false, 0, -1);
			type = _UniqueCollection_Trigger_F = getCollectionType(orphanage, _UniqueCollection, _Trigger, false, 0, -1);
			type = _UniqueCollection_TupleLiteralPart_F = getCollectionType(orphanage, _UniqueCollection, _TupleLiteralPart, false, 0, -1);
			type = _UniqueCollection_Type_F = getCollectionType(orphanage, _UniqueCollection, _Type, false, 0, -1);
			type = _UniqueCollection_ValueSpecification_F = getCollectionType(orphanage, _UniqueCollection, _ValueSpecification, false, 0, -1);
			type = _UniqueCollection_Variable_F = getCollectionType(orphanage, _UniqueCollection, _Variable, false, 0, -1);
			type = _UniqueCollection_Vertex_F = getCollectionType(orphanage, _UniqueCollection, _Vertex, false, 0, -1);
		...
		private void installAggregateTypes2() {
			...
			type = _OrderedSet_CollectionLiteralPart_T = getOrderedSetType(orphanage, _OrderedSet, _CollectionLiteralPart, true, 0, -1);
			type = _OrderedSet_Detail_T = getOrderedSetType(orphanage, _OrderedSet, _Detail, true, 0, -1);
			type = _OrderedSet_Element_T = getOrderedSetType(orphanage, _OrderedSet, _Element, true, 0, -1);
			type = _OrderedSet_EnumerationLiteral_T = getOrderedSetType(orphanage, _OrderedSet, _EnumerationLiteral, true, 0, -1);
			type = _OrderedSet_Import_T = getOrderedSetType(orphanage, _OrderedSet, _Import, true, 0, -1);
			type = _OrderedSet_IteratorVariable_F = getOrderedSetType(orphanage, _OrderedSet, _IteratorVariable, false, 0, -1);
			type = _OrderedSet_MapLiteralPart_T = getOrderedSetType(orphanage, _OrderedSet, _MapLiteralPart, true, 0, -1);
			type = _OrderedSet_OCLExpression_T = getOrderedSetType(orphanage, _OrderedSet, _OCLExpression, true, 0, -1);
			type = _OrderedSet_Operation_T = getOrderedSetType(orphanage, _OrderedSet, _Operation, true, 0, -1);
			type = _OrderedSet_Parameter_T = getOrderedSetType(orphanage, _OrderedSet, _Parameter, true, 0, -1);
			type = _OrderedSet_Precedence_T = getOrderedSetType(orphanage, _OrderedSet, _Precedence, true, 0, -1);
			type = _OrderedSet_Property_T = getOrderedSetType(orphanage, _OrderedSet, _Property, true, 0, -1);
			type = _OrderedSet_ShadowPart_T = getOrderedSetType(orphanage, _OrderedSet, _ShadowPart, true, 0, -1);
			type = _OrderedSet_TemplateParameter_T_L1 = getOrderedSetType(orphanage, _OrderedSet, _TemplateParameter, true, 1, -1);
			type = _OrderedSet_TupleLiteralPart_T = getOrderedSetType(orphanage, _OrderedSet, _TupleLiteralPart, true, 0, -1);
			type = _OrderedSet_ValueSpecification_T = getOrderedSetType(orphanage, _OrderedSet, _ValueSpecification, true, 0, -1);
			type = _OrderedSet_Variable_T = getOrderedSetType(orphanage, _OrderedSet, _Variable, true, 0, -1);
			type = _Sequence_Type_T = getSequenceType(orphanage, _Sequence, _Type, true, 0, -1);
			type = _Set_String_T_L1 = getSetType(orphanage, _Set, _String, true, 1, -1);
			type = _Set_Behavior_T = getSetType(orphanage, _Set, _Behavior, true, 0, -1);
			type = _Set_Class_T = getSetType(orphanage, _Set, _Class, true, 0, -1);
			type = _Set_Comment_T = getSetType(orphanage, _Set, _Comment, true, 0, -1);
			type = _Set_CompleteClass_T = getSetType(orphanage, _Set, _CompleteClass, true, 0, -1);
			type = _Set_CompletePackage_T = getSetType(orphanage, _Set, _CompletePackage, true, 0, -1);
			type = _Set_ConnectionPointReference_T = getSetType(orphanage, _Set, _ConnectionPointReference, true, 0, -1);
			type = _Set_Constraint_T = getSetType(orphanage, _Set, _Constraint, true, 0, -1);
			type = _Set_DynamicProperty_T = getSetType(orphanage, _Set, _DynamicProperty, true, 0, -1);
			type = _Set_ElementExtension_T = getSetType(orphanage, _Set, _ElementExtension, true, 0, -1);
			type = _Set_Element_T = getSetType(orphanage, _Set, _Element, true, 0, -1);
			type = _Set_InstanceSpecification_T = getSetType(orphanage, _Set, _InstanceSpecification, true, 0, -1);
			type = _Set_Model_T = getSetType(orphanage, _Set, _Model, true, 0, -1);
			type = _Set_Operation_T = getSetType(orphanage, _Set, _Operation, true, 0, -1);
			type = _Set_Package_T = getSetType(orphanage, _Set, _Package, true, 0, -1);
			type = _Set_ProfileApplication_T = getSetType(orphanage, _Set, _ProfileApplication, true, 0, -1);
			type = _Set_Property_T = getSetType(orphanage, _Set, _Property, true, 0, -1);
			type = _Set_Pseudostate_T = getSetType(orphanage, _Set, _Pseudostate, true, 0, -1);
			type = _Set_Region_T = getSetType(orphanage, _Set, _Region, true, 0, -1);
			type = _Set_Region_T_L1 = getSetType(orphanage, _Set, _Region, true, 1, -1);
			type = _Set_Slot_T = getSetType(orphanage, _Set, _Slot, true, 0, -1);
			type = _Set_StateMachine_T = getSetType(orphanage, _Set, _StateMachine, true, 0, -1);
			type = _Set_State_T = getSetType(orphanage, _Set, _State, true, 0, -1);
			type = _Set_StereotypeExtender_T = getSetType(orphanage, _Set, _StereotypeExtender, true, 0, -1);
			type = _Set_TemplateBinding_T = getSetType(orphanage, _Set, _TemplateBinding, true, 0, -1);
			type = _Set_TemplateParameterSubstitution_T_L1 = getSetType(orphanage, _Set, _TemplateParameterSubstitution, true, 1, -1);
			type = _Set_Transition_T = getSetType(orphanage, _Set, _Transition, true, 0, -1);
			type = _Set_Trigger_T = getSetType(orphanage, _Set, _Trigger, true, 0, -1);
			type = _Set_Type_T = getSetType(orphanage, _Set, _Type, true, 0, -1);
			type = _Set_Vertex_T = getSetType(orphanage, _Set, _Vertex, true, 0, -1);
