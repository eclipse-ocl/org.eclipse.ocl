...
public class OCLmetamodel extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents.AbstractMetamodelContents
	{
		...
		private final @NonNull Operation op_Iteration_resolveBodyType = createOperation(PivotPackage.Literals.ITERATION___RESOLVE_BODY_TYPE__OCLEXPRESSION, _Type, null, null);
		...
		private void installOperations() {
			...
			ownedOperations = _Iteration.getOwnedOperations();
			ownedOperations.add(operation = op_Iteration_resolveBodyType);
			operation.setIsRequired(true);
			createBodyExpression(operation, _Iteration, "argument.type", _Type);
			ownedParameters = operation.getOwnedParameters();
