...
public class OCLmetamodel extends ASResourceImpl
{
	...
	private static class Contents extends LibraryContents
	{
		...
		private CollectionType _Bag_Annotation_F;
		private CollectionType _Bag_AssociationClassCallExp_F;
		private CollectionType _Bag_CallOperationAction_F;
		private CollectionType _Bag_Class_F;
		private CollectionType _Bag_CollectionType_F;
		private CollectionType _Bag_CompleteClass_F;
		private CollectionType _Bag_CompleteModel_F;
		private CollectionType _Bag_CompletePackage_F;
		private CollectionType _Bag_ConnectionPointReference_F;
		private CollectionType _Bag_Constraint_F;
		private CollectionType _Bag_DataType_F;
		private CollectionType _Bag_DynamicElement_F;
		private CollectionType _Bag_DynamicProperty_F;
		private CollectionType _Bag_ElementExtension_F;
		private CollectionType _Bag_EnumLiteralExp_F;
		private CollectionType _Bag_Import_F;
		private CollectionType _Bag_InstanceSpecification_F;
		private CollectionType _Bag_LambdaType_F;
		private CollectionType _Bag_LoopExp_F;
		private CollectionType _Bag_MapType_F;
		private CollectionType _Bag_MessageType_F;
		private CollectionType _Bag_NavigationCallExp_F;
		private CollectionType _Bag_OCLExpression_F;
		private CollectionType _Bag_OperationCallExp_F;
		private CollectionType _Bag_Operation_F;
		private CollectionType _Bag_OppositePropertyCallExp_F;
		private CollectionType _Bag_Package_F;
		private CollectionType _Bag_PrimitiveType_F;
		private CollectionType _Bag_PropertyCallExp_F;
		private CollectionType _Bag_Property_F;
		private CollectionType _Bag_Region_F;
		private CollectionType _Bag_SendSignalAction_F;
		private CollectionType _Bag_ShadowPart_F;
		private CollectionType _Bag_Slot_F;
		private CollectionType _Bag_StateExp_F;
		private CollectionType _Bag_StateMachine_F;
		private CollectionType _Bag_State_F;
		private CollectionType _Bag_TemplateBinding_F;
		private CollectionType _Bag_TemplateParameterSubstitution_F;
		private CollectionType _Bag_TemplateParameter_F;
		private CollectionType _Bag_TemplateableElement_F;
		private CollectionType _Bag_TypeExp_F;
		private CollectionType _Bag_TypedElement_F;
		private CollectionType _Bag_VariableDeclaration_F;
		private CollectionType _Bag_VariableExp_F;
		private CollectionType _Bag_Variable_F;
		private CollectionType _Bag_WildcardType_F;
		...
		private void installSpecializedAggregateTypes0() {
			...
			type = _Bag_AssociationClassCallExp_F = getCollectionType(_Bag, _AssociationClassCallExp, false, 0, -1);
			type = _Bag_CallOperationAction_F = getCollectionType(_Bag, _CallOperationAction, false, 0, -1);
			type = _Bag_Class_F = getCollectionType(_Bag, _Class, false, 0, -1);
			type = _Bag_CollectionType_F = getCollectionType(_Bag, _CollectionType, false, 0, -1);
			type = _Bag_CompleteClass_F = getCollectionType(_Bag, _CompleteClass, false, 0, -1);
			type = _Bag_CompleteModel_F = getCollectionType(_Bag, _CompleteModel, false, 0, -1);
			type = _Bag_CompletePackage_F = getCollectionType(_Bag, _CompletePackage, false, 0, -1);
			type = _Bag_ConnectionPointReference_F = getCollectionType(_Bag, _ConnectionPointReference, false, 0, -1);
			type = _Bag_Constraint_F = getCollectionType(_Bag, _Constraint, false, 0, -1);
			type = _Bag_DataType_F = getCollectionType(_Bag, _DataType, false, 0, -1);
			type = _Bag_DynamicElement_F = getCollectionType(_Bag, _DynamicElement, false, 0, -1);
			type = _Bag_DynamicProperty_F = getCollectionType(_Bag, _DynamicProperty, false, 0, -1);
			type = _Bag_ElementExtension_F = getCollectionType(_Bag, _ElementExtension, false, 0, -1);
			type = _Bag_EnumLiteralExp_F = getCollectionType(_Bag, _EnumLiteralExp, false, 0, -1);
			type = _Bag_Import_F = getCollectionType(_Bag, _Import, false, 0, -1);
			type = _Bag_InstanceSpecification_F = getCollectionType(_Bag, _InstanceSpecification, false, 0, -1);
			type = _Bag_LambdaType_F = getCollectionType(_Bag, _LambdaType, false, 0, -1);
			type = _Bag_LoopExp_F = getCollectionType(_Bag, _LoopExp, false, 0, -1);
			type = _Bag_MapType_F = getCollectionType(_Bag, _MapType, false, 0, -1);
			type = _Bag_MessageType_F = getCollectionType(_Bag, _MessageType, false, 0, -1);
			type = _Bag_NavigationCallExp_F = getCollectionType(_Bag, _NavigationCallExp, false, 0, -1);
			type = _Bag_OCLExpression_F = getCollectionType(_Bag, _OCLExpression, false, 0, -1);
			type = _Bag_OperationCallExp_F = getCollectionType(_Bag, _OperationCallExp, false, 0, -1);
			type = _Bag_Operation_F = getCollectionType(_Bag, _Operation, false, 0, -1);
			type = _Bag_OppositePropertyCallExp_F = getCollectionType(_Bag, _OppositePropertyCallExp, false, 0, -1);
			type = _Bag_Package_F = getCollectionType(_Bag, _Package, false, 0, -1);
			type = _Bag_PrimitiveType_F = getCollectionType(_Bag, _PrimitiveType, false, 0, -1);
			type = _Bag_PropertyCallExp_F = getCollectionType(_Bag, _PropertyCallExp, false, 0, -1);
			type = _Bag_Property_F = getCollectionType(_Bag, _Property, false, 0, -1);
			type = _Bag_Region_F = getCollectionType(_Bag, _Region, false, 0, -1);
			type = _Bag_SendSignalAction_F = getCollectionType(_Bag, _SendSignalAction, false, 0, -1);
			type = _Bag_ShadowPart_F = getCollectionType(_Bag, _ShadowPart, false, 0, -1);
			type = _Bag_Slot_F = getCollectionType(_Bag, _Slot, false, 0, -1);
			type = _Bag_StateExp_F = getCollectionType(_Bag, _StateExp, false, 0, -1);
			type = _Bag_StateMachine_F = getCollectionType(_Bag, _StateMachine, false, 0, -1);
			type = _Bag_State_F = getCollectionType(_Bag, _State, false, 0, -1);
			type = _Bag_TemplateBinding_F = getCollectionType(_Bag, _TemplateBinding, false, 0, -1);
			type = _Bag_TemplateParameterSubstitution_F = getCollectionType(_Bag, _TemplateParameterSubstitution, false, 0, -1);
			type = _Bag_TemplateParameter_F = getCollectionType(_Bag, _TemplateParameter, false, 0, -1);
			type = _Bag_TemplateableElement_F = getCollectionType(_Bag, _TemplateableElement, false, 0, -1);
			type = _Bag_TypeExp_F = getCollectionType(_Bag, _TypeExp, false, 0, -1);
			type = _Bag_TypedElement_F = getCollectionType(_Bag, _TypedElement, false, 0, -1);
			type = _Bag_VariableDeclaration_F = getCollectionType(_Bag, _VariableDeclaration, false, 0, -1);
			type = _Bag_VariableExp_F = getCollectionType(_Bag, _VariableExp, false, 0, -1);
			type = _Bag_Variable_F = getCollectionType(_Bag, _Variable, false, 0, -1);
			type = _Bag_WildcardType_F = getCollectionType(_Bag, _WildcardType, false, 0, -1);
			type = _Collection_String_F = getCollectionType(_Collection, _String, false, 0, -1);
			type = _Collection_Annotation_F = getCollectionType(_Collection, _Annotation, false, 0, -1);
			type = _Collection_AssociationClassCallExp_F = getCollectionType(_Collection, _AssociationClassCallExp, false, 0, -1);
			type = _Collection_Behavior_F = getCollectionType(_Collection, _Behavior, false, 0, -1);
			type = _Collection_CallOperationAction_F = getCollectionType(_Collection, _CallOperationAction, false, 0, -1);
			type = _Collection_Class_F = getCollectionType(_Collection, _Class, false, 0, -1);
			type = _Collection_CollectionLiteralPart_F = getCollectionType(_Collection, _CollectionLiteralPart, false, 0, -1);
			type = _Collection_CollectionType_F = getCollectionType(_Collection, _CollectionType, false, 0, -1);
			type = _Collection_Comment_F = getCollectionType(_Collection, _Comment, false, 0, -1);
			type = _Collection_CompleteClass_F = getCollectionType(_Collection, _CompleteClass, false, 0, -1);
			type = _Collection_CompleteModel_F = getCollectionType(_Collection, _CompleteModel, false, 0, -1);
			type = _Collection_CompletePackage_F = getCollectionType(_Collection, _CompletePackage, false, 0, -1);
			type = _Collection_ConnectionPointReference_F = getCollectionType(_Collection, _ConnectionPointReference, false, 0, -1);
			type = _Collection_Constraint_F = getCollectionType(_Collection, _Constraint, false, 0, -1);
			type = _Collection_DataType_F = getCollectionType(_Collection, _DataType, false, 0, -1);
			type = _Collection_Detail_F = getCollectionType(_Collection, _Detail, false, 0, -1);
			type = _Collection_DynamicElement_F = getCollectionType(_Collection, _DynamicElement, false, 0, -1);
			type = _Collection_DynamicProperty_F = getCollectionType(_Collection, _DynamicProperty, false, 0, -1);
			type = _Collection_ElementExtension_F = getCollectionType(_Collection, _ElementExtension, false, 0, -1);
			type = _Collection_Element_F = getCollectionType(_Collection, _Element, false, 0, -1);
			type = _Collection_EnumLiteralExp_F = getCollectionType(_Collection, _EnumLiteralExp, false, 0, -1);
			type = _Collection_EnumerationLiteral_F = getCollectionType(_Collection, _EnumerationLiteral, false, 0, -1);
			type = _Collection_Import_F = getCollectionType(_Collection, _Import, false, 0, -1);
			type = _Collection_InstanceSpecification_F = getCollectionType(_Collection, _InstanceSpecification, false, 0, -1);
			type = _Collection_IteratorVariable_F = getCollectionType(_Collection, _IteratorVariable, false, 0, -1);
			type = _Collection_LambdaType_F = getCollectionType(_Collection, _LambdaType, false, 0, -1);
			type = _Collection_LoopExp_F = getCollectionType(_Collection, _LoopExp, false, 0, -1);
			type = _Collection_MapLiteralPart_F = getCollectionType(_Collection, _MapLiteralPart, false, 0, -1);
			type = _Collection_MapType_F = getCollectionType(_Collection, _MapType, false, 0, -1);
			type = _Collection_MessageType_F = getCollectionType(_Collection, _MessageType, false, 0, -1);
			type = _Collection_Model_F = getCollectionType(_Collection, _Model, false, 0, -1);
			type = _Collection_NavigationCallExp_F = getCollectionType(_Collection, _NavigationCallExp, false, 0, -1);
			type = _Collection_OCLExpression_F = getCollectionType(_Collection, _OCLExpression, false, 0, -1);
			type = _Collection_OperationCallExp_F = getCollectionType(_Collection, _OperationCallExp, false, 0, -1);
			type = _Collection_Operation_F = getCollectionType(_Collection, _Operation, false, 0, -1);
			type = _Collection_OppositePropertyCallExp_F = getCollectionType(_Collection, _OppositePropertyCallExp, false, 0, -1);
			type = _Collection_Package_F = getCollectionType(_Collection, _Package, false, 0, -1);
			type = _Collection_Parameter_F = getCollectionType(_Collection, _Parameter, false, 0, -1);
			type = _Collection_Precedence_F = getCollectionType(_Collection, _Precedence, false, 0, -1);
			type = _Collection_PrimitiveType_F = getCollectionType(_Collection, _PrimitiveType, false, 0, -1);
			type = _Collection_ProfileApplication_F = getCollectionType(_Collection, _ProfileApplication, false, 0, -1);
			type = _Collection_PropertyCallExp_F = getCollectionType(_Collection, _PropertyCallExp, false, 0, -1);
			type = _Collection_Property_F = getCollectionType(_Collection, _Property, false, 0, -1);
			type = _Collection_Pseudostate_F = getCollectionType(_Collection, _Pseudostate, false, 0, -1);
			type = _Collection_Region_F = getCollectionType(_Collection, _Region, false, 0, -1);
			type = _Collection_SendSignalAction_F = getCollectionType(_Collection, _SendSignalAction, false, 0, -1);
			type = _Collection_ShadowPart_F = getCollectionType(_Collection, _ShadowPart, false, 0, -1);
			type = _Collection_Slot_F = getCollectionType(_Collection, _Slot, false, 0, -1);
			type = _Collection_StateExp_F = getCollectionType(_Collection, _StateExp, false, 0, -1);
			type = _Collection_StateMachine_F = getCollectionType(_Collection, _StateMachine, false, 0, -1);
			type = _Collection_State_F = getCollectionType(_Collection, _State, false, 0, -1);
			type = _Collection_StereotypeExtender_F = getCollectionType(_Collection, _StereotypeExtender, false, 0, -1);
			type = _Collection_TemplateBinding_F = getCollectionType(_Collection, _TemplateBinding, false, 0, -1);
			type = _Collection_TemplateParameterSubstitution_F = getCollectionType(_Collection, _TemplateParameterSubstitution, false, 0, -1);
			type = _Collection_TemplateParameter_F = getCollectionType(_Collection, _TemplateParameter, false, 0, -1);
			type = _Collection_TemplateableElement_F = getCollectionType(_Collection, _TemplateableElement, false, 0, -1);
			type = _Collection_Transition_F = getCollectionType(_Collection, _Transition, false, 0, -1);
			type = _Collection_Trigger_F = getCollectionType(_Collection, _Trigger, false, 0, -1);
			type = _Collection_TupleLiteralPart_F = getCollectionType(_Collection, _TupleLiteralPart, false, 0, -1);
			type = _Collection_TypeExp_F = getCollectionType(_Collection, _TypeExp, false, 0, -1);
			type = _Collection_Type_F = getCollectionType(_Collection, _Type, false, 0, -1);
			type = _Collection_TypedElement_F = getCollectionType(_Collection, _TypedElement, false, 0, -1);
			type = _Collection_ValueSpecification_F = getCollectionType(_Collection, _ValueSpecification, false, 0, -1);
			type = _Collection_VariableDeclaration_F = getCollectionType(_Collection, _VariableDeclaration, false, 0, -1);
			type = _Collection_VariableExp_F = getCollectionType(_Collection, _VariableExp, false, 0, -1);
			type = _Collection_Variable_F = getCollectionType(_Collection, _Variable, false, 0, -1);
			type = _Collection_Vertex_F = getCollectionType(_Collection, _Vertex, false, 0, -1);
			type = _Collection_WildcardType_F = getCollectionType(_Collection, _WildcardType, false, 0, -1);
			type = _OrderedCollection_CollectionLiteralPart_F = getCollectionType(_OrderedCollection, _CollectionLiteralPart, false, 0, -1);
			type = _OrderedCollection_Detail_F = getCollectionType(_OrderedCollection, _Detail, false, 0, -1);
			type = _OrderedCollection_Element_F = getCollectionType(_OrderedCollection, _Element, false, 0, -1);
			type = _OrderedCollection_EnumerationLiteral_F = getCollectionType(_OrderedCollection, _EnumerationLiteral, false, 0, -1);
			type = _OrderedCollection_Import_F = getCollectionType(_OrderedCollection, _Import, false, 0, -1);
			type = _OrderedCollection_IteratorVariable_F = getCollectionType(_OrderedCollection, _IteratorVariable, false, 0, -1);
			type = _OrderedCollection_MapLiteralPart_F = getCollectionType(_OrderedCollection, _MapLiteralPart, false, 0, -1);
			type = _OrderedCollection_OCLExpression_F = getCollectionType(_OrderedCollection, _OCLExpression, false, 0, -1);
			type = _OrderedCollection_Operation_F = getCollectionType(_OrderedCollection, _Operation, false, 0, -1);
			type = _OrderedCollection_Parameter_F = getCollectionType(_OrderedCollection, _Parameter, false, 0, -1);
			type = _OrderedCollection_Precedence_F = getCollectionType(_OrderedCollection, _Precedence, false, 0, -1);
			type = _OrderedCollection_Property_F = getCollectionType(_OrderedCollection, _Property, false, 0, -1);
			type = _OrderedCollection_ShadowPart_F = getCollectionType(_OrderedCollection, _ShadowPart, false, 0, -1);
			type = _OrderedCollection_TemplateParameter_F = getCollectionType(_OrderedCollection, _TemplateParameter, false, 0, -1);
			type = _OrderedCollection_TupleLiteralPart_F = getCollectionType(_OrderedCollection, _TupleLiteralPart, false, 0, -1);
			type = _OrderedCollection_Type_F = getCollectionType(_OrderedCollection, _Type, false, 0, -1);
			type = _OrderedCollection_ValueSpecification_F = getCollectionType(_OrderedCollection, _ValueSpecification, false, 0, -1);
			type = _OrderedCollection_Variable_F = getCollectionType(_OrderedCollection, _Variable, false, 0, -1);
			...
			type = _UniqueCollection_String_F = getCollectionType(_UniqueCollection, _String, false, 0, -1);
			type = _UniqueCollection_Behavior_F = getCollectionType(_UniqueCollection, _Behavior, false, 0, -1);
			type = _UniqueCollection_Class_F = getCollectionType(_UniqueCollection, _Class, false, 0, -1);
			type = _UniqueCollection_CollectionLiteralPart_F = getCollectionType(_UniqueCollection, _CollectionLiteralPart, false, 0, -1);
			type = _UniqueCollection_Comment_F = getCollectionType(_UniqueCollection, _Comment, false, 0, -1);
			type = _UniqueCollection_CompleteClass_F = getCollectionType(_UniqueCollection, _CompleteClass, false, 0, -1);
			type = _UniqueCollection_CompletePackage_F = getCollectionType(_UniqueCollection, _CompletePackage, false, 0, -1);
			type = _UniqueCollection_ConnectionPointReference_F = getCollectionType(_UniqueCollection, _ConnectionPointReference, false, 0, -1);
			type = _UniqueCollection_Constraint_F = getCollectionType(_UniqueCollection, _Constraint, false, 0, -1);
			type = _UniqueCollection_Detail_F = getCollectionType(_UniqueCollection, _Detail, false, 0, -1);
			type = _UniqueCollection_DynamicProperty_F = getCollectionType(_UniqueCollection, _DynamicProperty, false, 0, -1);
			type = _UniqueCollection_ElementExtension_F = getCollectionType(_UniqueCollection, _ElementExtension, false, 0, -1);
			type = _UniqueCollection_Element_F = getCollectionType(_UniqueCollection, _Element, false, 0, -1);
			type = _UniqueCollection_EnumerationLiteral_F = getCollectionType(_UniqueCollection, _EnumerationLiteral, false, 0, -1);
			type = _UniqueCollection_Import_F = getCollectionType(_UniqueCollection, _Import, false, 0, -1);
			type = _UniqueCollection_InstanceSpecification_F = getCollectionType(_UniqueCollection, _InstanceSpecification, false, 0, -1);
			type = _UniqueCollection_IteratorVariable_F = getCollectionType(_UniqueCollection, _IteratorVariable, false, 0, -1);
			type = _UniqueCollection_MapLiteralPart_F = getCollectionType(_UniqueCollection, _MapLiteralPart, false, 0, -1);
			type = _UniqueCollection_Model_F = getCollectionType(_UniqueCollection, _Model, false, 0, -1);
			type = _UniqueCollection_OCLExpression_F = getCollectionType(_UniqueCollection, _OCLExpression, false, 0, -1);
			type = _UniqueCollection_Operation_F = getCollectionType(_UniqueCollection, _Operation, false, 0, -1);
			type = _UniqueCollection_Package_F = getCollectionType(_UniqueCollection, _Package, false, 0, -1);
			type = _UniqueCollection_Parameter_F = getCollectionType(_UniqueCollection, _Parameter, false, 0, -1);
			type = _UniqueCollection_Precedence_F = getCollectionType(_UniqueCollection, _Precedence, false, 0, -1);
			type = _UniqueCollection_ProfileApplication_F = getCollectionType(_UniqueCollection, _ProfileApplication, false, 0, -1);
			type = _UniqueCollection_Property_F = getCollectionType(_UniqueCollection, _Property, false, 0, -1);
			type = _UniqueCollection_Pseudostate_F = getCollectionType(_UniqueCollection, _Pseudostate, false, 0, -1);
			type = _UniqueCollection_Region_F = getCollectionType(_UniqueCollection, _Region, false, 0, -1);
			type = _UniqueCollection_ShadowPart_F = getCollectionType(_UniqueCollection, _ShadowPart, false, 0, -1);
			type = _UniqueCollection_Slot_F = getCollectionType(_UniqueCollection, _Slot, false, 0, -1);
			type = _UniqueCollection_StateMachine_F = getCollectionType(_UniqueCollection, _StateMachine, false, 0, -1);
			type = _UniqueCollection_State_F = getCollectionType(_UniqueCollection, _State, false, 0, -1);
			type = _UniqueCollection_StereotypeExtender_F = getCollectionType(_UniqueCollection, _StereotypeExtender, false, 0, -1);
			type = _UniqueCollection_TemplateBinding_F = getCollectionType(_UniqueCollection, _TemplateBinding, false, 0, -1);
			type = _UniqueCollection_TemplateParameterSubstitution_F = getCollectionType(_UniqueCollection, _TemplateParameterSubstitution, false, 0, -1);
			type = _UniqueCollection_TemplateParameter_F = getCollectionType(_UniqueCollection, _TemplateParameter, false, 0, -1);
			type = _UniqueCollection_Transition_F = getCollectionType(_UniqueCollection, _Transition, false, 0, -1);
			type = _UniqueCollection_Trigger_F = getCollectionType(_UniqueCollection, _Trigger, false, 0, -1);
			type = _UniqueCollection_TupleLiteralPart_F = getCollectionType(_UniqueCollection, _TupleLiteralPart, false, 0, -1);
			type = _UniqueCollection_Type_F = getCollectionType(_UniqueCollection, _Type, false, 0, -1);
			type = _UniqueCollection_ValueSpecification_F = getCollectionType(_UniqueCollection, _ValueSpecification, false, 0, -1);
			type = _UniqueCollection_Variable_F = getCollectionType(_UniqueCollection, _Variable, false, 0, -1);
			type = _UniqueCollection_Vertex_F = getCollectionType(_UniqueCollection, _Vertex, false, 0, -1);
		}
