...
public class OCLmetamodel extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents.AbstractMetamodelContents
	{
		...
		private final org.eclipse.ocl.pivot.@NonNull Class _TemplateArgument = createClass(PivotPackage.Literals.TEMPLATE_ARGUMENT);
		...
		private final @NonNull BagType _Bag_TemplateArgument_F = createBagType(_Bag);
		...
		private final @NonNull CollectionType _Collection_TemplateArgument_F = createCollectionType(_Collection);
		...
		private final @NonNull CollectionType _OrderedCollection_TemplateParameter_T = createCollectionType(_OrderedCollection);
		...
		private final @NonNull OrderedSetType _OrderedSet_TemplateParameter_T = createOrderedSetType(_OrderedSet);
		...
		private final @NonNull SetType _Set_TemplateArgument_T = createSetType(_Set);
		...
		private final @NonNull CollectionType _UniqueCollection_TemplateArgument_T = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_TemplateParameter_T = createCollectionType(_UniqueCollection);
		...
		private void installCollectionTypes() {
			...
			ownedClasses.add(type);
			type = _Bag_TemplateArgument_F;
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection);
			superClasses.add(_Collection_TemplateArgument_F);
			ownedClasses.add(type);
			...
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			type = _Collection_TemplateArgument_F;
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			...
			superClasses.add(_Collection);
			ownedClasses.add(type);
			type = _OrderedCollection_TemplateParameter_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection);
			ownedClasses.add(type);
			...
			ownedClasses.add(type);
			type = _OrderedSet_TemplateParameter_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection);
			superClasses.add(_UniqueCollection);
			superClasses.add(_OrderedCollection_TemplateParameter_T);
			superClasses.add(_UniqueCollection_TemplateParameter_T);
			ownedClasses.add(type);
			...
			ownedClasses.add(type);
			type = _Set_TemplateArgument_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection);
			superClasses.add(_UniqueCollection_TemplateArgument_T);
			ownedClasses.add(type);
			...
			superClasses.add(_Collection);
			ownedClasses.add(type);
			type = _UniqueCollection_TemplateArgument_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection);
			ownedClasses.add(type);
			type = _UniqueCollection_TemplateParameter_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection);
			ownedClasses.add(type);
		...
		private final @NonNull Operation op_Operation_conformsTo = createOperation(PivotPackage.Literals.OPERATION___CONFORMS_TO__CALLEXP_OCLEXPRESSION_PARAMETER, _Boolean, null, null);
		...
		private final @NonNull Property pr_TemplateArgument_actual = createProperty(PivotPackage.Literals.TEMPLATE_ARGUMENT__ACTUAL, _Type);
		private final @NonNull Property pr_TemplateArgument_actualIsRequired = createProperty(PivotPackage.Literals.TEMPLATE_ARGUMENT__ACTUAL_IS_REQUIRED, _Boolean);
		private final @NonNull Property pr_TemplateArgument_formal = createProperty(PivotPackage.Literals.TEMPLATE_ARGUMENT__FORMAL, _TemplateParameter);
		private final @NonNull Property pr_TemplateArgument_owningTemplateableElement = createProperty(PivotPackage.Literals.TEMPLATE_ARGUMENT__OWNING_TEMPLATEABLE_ELEMENT, _TemplateableElement);
		...
		private final @NonNull Property pr_TemplateParameter_owningTemplateableElement = createProperty(PivotPackage.Literals.TEMPLATE_PARAMETER__OWNING_TEMPLATEABLE_ELEMENT, _TemplateableElement);
		private final @NonNull Property pr_TemplateParameter_TemplateArgument_formal = createProperty("TemplateArgument", _Bag_TemplateArgument_F);
		...
		private final @NonNull Property pr_Type_TemplateArgument_actual = createProperty("TemplateArgument", _Bag_TemplateArgument_F);
		...
		private void installProperties() {
			...
			ownedProperties = _TemplateArgument.getOwnedProperties();
			ownedProperties.add(property = pr_TemplateArgument_actual);
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			property.setOpposite(pr_Type_TemplateArgument_actual);
			ownedProperties.add(property = pr_TemplateArgument_actualIsRequired);
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			property.setDefaultValueString("true");
			ownedProperties.add(property = pr_TemplateArgument_formal);
			property.setIsDerived(true);
			property.setIsReadOnly(true);
			property.setIsRequired(true);
			property.setIsTransient(true);
			property.setIsVolatile(true);
			property.setOpposite(pr_TemplateParameter_TemplateArgument_formal);
			ownedProperties.add(property = pr_TemplateArgument_owningTemplateableElement);
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			property.setOpposite(pr_TemplateableElement_ownedTemplateArguments);
			...
			ownedProperties.add(property = pr_TemplateParameter_owningTemplateableElement);
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			property.setOpposite(pr_TemplateableElement_ownedTemplateParameters);
			ownedProperties.add(property = pr_TemplateParameter_TemplateArgument_formal);
			property.setIsImplicit(true);
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			property.setOpposite(pr_TemplateArgument_formal);

			ownedProperties = _TemplateableElement.getOwnedProperties();
			ownedProperties.add(property = pr_TemplateableElement_generic);
			property.setIsResolveProxies(true);
			property.setOpposite(pr_TemplateableElement_TemplateableElement_generic);
			ownedProperties.add(property = pr_TemplateableElement_ownedTemplateArguments);
			property.setIsComposite(true);
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			property.setOpposite(pr_TemplateArgument_owningTemplateableElement);
			ownedProperties.add(property = pr_TemplateableElement_ownedTemplateParameters);
			property.setIsComposite(true);
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			...
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			property.setOpposite(pr_TemplateableElement_generic);
			...
			ownedProperties.add(property = pr_Type_TemplateArgument_actual);
			property.setIsImplicit(true);
			property.setIsRequired(true);
			property.setIsResolveProxies(true);
			property.setOpposite(pr_TemplateArgument_actual);
		...
		private final @NonNull Constraint iv_LetExp_CompatibleNullityForIn = createInvariant(PivotPackage.Literals.LET_EXP___VALIDATE_COMPATIBLE_NULLITY_FOR_IN__DIAGNOSTICCHAIN_MAP, "CompatibleNullityForIn", "isRequired implies ownedIn.isRequired");
		...
		private final @NonNull Constraint iv_LetVariable_CompatibleNullityForInitializer = createInvariant(PivotPackage.Literals.LET_VARIABLE___VALIDATE_COMPATIBLE_NULLITY_FOR_INITIALIZER__DIAGNOSTICCHAIN_MAP, "CompatibleNullityForInitializer", "isRequired implies ownedInit?.isRequired");
		...
		private void installTemplateArguments() {
			...
			addBinding(_Bag_TemplateArgument_F, _TemplateArgument);
			...
			addBinding(_Collection_TemplateArgument_F, _TemplateArgument);
			...
			addBinding(_OrderedCollection_TemplateParameter_T, _TemplateParameter);
			...
			addBinding(_OrderedSet_TemplateParameter_T, _TemplateParameter);
			...
			addBinding(_Set_TemplateArgument_T, _TemplateArgument);
			...
			addBinding(_UniqueCollection_TemplateArgument_T, _TemplateArgument);
			addBinding(_UniqueCollection_TemplateParameter_T, _TemplateParameter);
		...
		private void installComments() {
			...
			installComment(_TemplateArgument, "A TemplateArgument relates the actual optional type to a formal TemplateParameter by positional equivalence of a TemplateableElement\'s  hierarchy of TemplateParameters and ownedTemplateArguments.");
			installComment(pr_TemplateArgument_actual, "The ParameterableElement that is the actual parameter for this TemplateArgument.");
			installComment(pr_TemplateArgument_actualIsRequired, "Whether the actual type must be non-null rather than nullable.");
			installComment(pr_TemplateArgument_formal, "The formal TemplateParameter that is associated with this TemplateArgument.");
			installComment(pr_TemplateArgument_owningTemplateableElement, "The TemplateBinding that owns this TemplateArgument.");
			installComment(_TemplateParameter, "A TemplateParameter exposes a ParameterableElement as a formal parameter of a template.");
			installComment(pr_TemplateParameter_owningTemplateableElement, "The TemplateSignature that owns this TemplateableElement.");
