...
public class OCLmetamodel extends ASResourceImpl
{
	...
	private static class Contents extends LibraryContents
	{
		...
		private void installClassTypes() {
			...
			type = _Orphanage = createClass(pivot, PivotPackage.Literals.ORPHANAGE);
		...
		private void installSpecializedAggregateTypes0() {
			...
			type = _Bag_Annotation_T_L0 = getCollectionType(_Bag, _Annotation, true, 0, -1);
			type = _Bag_AssociationClassCallExp_T_L0 = getCollectionType(_Bag, _AssociationClassCallExp, true, 0, -1);
			type = _Bag_CallOperationAction_T_L0 = getCollectionType(_Bag, _CallOperationAction, true, 0, -1);
			type = _Bag_Class_T_L0 = getCollectionType(_Bag, _Class, true, 0, -1);
			type = _Bag_CollectionType_T_L0 = getCollectionType(_Bag, _CollectionType, true, 0, -1);
			type = _Bag_CompleteClass_T_L0 = getCollectionType(_Bag, _CompleteClass, true, 0, -1);
			type = _Bag_CompleteModel_T_L0 = getCollectionType(_Bag, _CompleteModel, true, 0, -1);
			type = _Bag_CompletePackage_T_L0 = getCollectionType(_Bag, _CompletePackage, true, 0, -1);
			type = _Bag_ConnectionPointReference_T_L0 = getCollectionType(_Bag, _ConnectionPointReference, true, 0, -1);
			type = _Bag_Constraint_T_L0 = getCollectionType(_Bag, _Constraint, true, 0, -1);
			type = _Bag_DataType_T_L0 = getCollectionType(_Bag, _DataType, true, 0, -1);
			type = _Bag_DynamicElement_T_L0 = getCollectionType(_Bag, _DynamicElement, true, 0, -1);
			type = _Bag_DynamicProperty_T_L0 = getCollectionType(_Bag, _DynamicProperty, true, 0, -1);
			type = _Bag_ElementExtension_T_L0 = getCollectionType(_Bag, _ElementExtension, true, 0, -1);
			type = _Bag_EnumLiteralExp_T_L0 = getCollectionType(_Bag, _EnumLiteralExp, true, 0, -1);
			type = _Bag_Import_T_L0 = getCollectionType(_Bag, _Import, true, 0, -1);
			type = _Bag_InstanceSpecification_T_L0 = getCollectionType(_Bag, _InstanceSpecification, true, 0, -1);
			type = _Bag_LambdaType_T_L0 = getCollectionType(_Bag, _LambdaType, true, 0, -1);
			type = _Bag_LoopExp_T_L0 = getCollectionType(_Bag, _LoopExp, true, 0, -1);
			type = _Bag_MapType_T_L0 = getCollectionType(_Bag, _MapType, true, 0, -1);
			type = _Bag_MessageType_T_L0 = getCollectionType(_Bag, _MessageType, true, 0, -1);
			type = _Bag_NavigationCallExp_T_L0 = getCollectionType(_Bag, _NavigationCallExp, true, 0, -1);
			type = _Bag_OCLExpression_T_L0 = getCollectionType(_Bag, _OCLExpression, true, 0, -1);
			type = _Bag_OperationCallExp_T_L0 = getCollectionType(_Bag, _OperationCallExp, true, 0, -1);
			type = _Bag_Operation_T_L0 = getCollectionType(_Bag, _Operation, true, 0, -1);
			type = _Bag_OppositePropertyCallExp_T_L0 = getCollectionType(_Bag, _OppositePropertyCallExp, true, 0, -1);
			type = _Bag_Package_T_L0 = getCollectionType(_Bag, _Package, true, 0, -1);
			type = _Bag_PrimitiveType_T_L0 = getCollectionType(_Bag, _PrimitiveType, true, 0, -1);
			type = _Bag_PropertyCallExp_T_L0 = getCollectionType(_Bag, _PropertyCallExp, true, 0, -1);
			type = _Bag_Property_T_L0 = getCollectionType(_Bag, _Property, true, 0, -1);
			type = _Bag_Region_T_L0 = getCollectionType(_Bag, _Region, true, 0, -1);
			type = _Bag_SendSignalAction_T_L0 = getCollectionType(_Bag, _SendSignalAction, true, 0, -1);
			type = _Bag_ShadowPart_T_L0 = getCollectionType(_Bag, _ShadowPart, true, 0, -1);
			type = _Bag_Slot_T_L0 = getCollectionType(_Bag, _Slot, true, 0, -1);
			type = _Bag_StateExp_T_L0 = getCollectionType(_Bag, _StateExp, true, 0, -1);
			type = _Bag_StateMachine_T_L0 = getCollectionType(_Bag, _StateMachine, true, 0, -1);
			type = _Bag_State_T_L0 = getCollectionType(_Bag, _State, true, 0, -1);
			type = _Bag_TemplateBinding_T_L0 = getCollectionType(_Bag, _TemplateBinding, true, 0, -1);
			type = _Bag_TemplateParameterSubstitution_T_L0 = getCollectionType(_Bag, _TemplateParameterSubstitution, true, 0, -1);
			type = _Bag_TemplateParameter_T_L0 = getCollectionType(_Bag, _TemplateParameter, true, 0, -1);
			type = _Bag_TemplateableElement_T_L0 = getCollectionType(_Bag, _TemplateableElement, true, 0, -1);
			type = _Bag_TypeExp_T_L0 = getCollectionType(_Bag, _TypeExp, true, 0, -1);
			type = _Bag_TypedElement_T_L0 = getCollectionType(_Bag, _TypedElement, true, 0, -1);
			type = _Bag_VariableDeclaration_T_L0 = getCollectionType(_Bag, _VariableDeclaration, true, 0, -1);
			type = _Bag_VariableExp_T_L0 = getCollectionType(_Bag, _VariableExp, true, 0, -1);
			type = _Bag_Variable_T_L0 = getCollectionType(_Bag, _Variable, true, 0, -1);
			type = _Bag_WildcardType_T_L0 = getCollectionType(_Bag, _WildcardType, true, 0, -1);
			type = _Collection_String_T_L0 = getCollectionType(_Collection, _String, true, 0, -1);
			type = _Collection_Annotation_T_L0 = getCollectionType(_Collection, _Annotation, true, 0, -1);
			type = _Collection_AssociationClassCallExp_T_L0 = getCollectionType(_Collection, _AssociationClassCallExp, true, 0, -1);
			type = _Collection_Behavior_T_L0 = getCollectionType(_Collection, _Behavior, true, 0, -1);
			type = _Collection_CallOperationAction_T_L0 = getCollectionType(_Collection, _CallOperationAction, true, 0, -1);
			type = _Collection_Class_T_L0 = getCollectionType(_Collection, _Class, true, 0, -1);
			type = _Collection_CollectionLiteralPart_T_L0 = getCollectionType(_Collection, _CollectionLiteralPart, true, 0, -1);
			type = _Collection_CollectionType_T_L0 = getCollectionType(_Collection, _CollectionType, true, 0, -1);
			type = _Collection_Comment_T_L0 = getCollectionType(_Collection, _Comment, true, 0, -1);
			type = _Collection_CompleteClass_T_L0 = getCollectionType(_Collection, _CompleteClass, true, 0, -1);
			type = _Collection_CompleteModel_T_L0 = getCollectionType(_Collection, _CompleteModel, true, 0, -1);
			type = _Collection_CompletePackage_T_L0 = getCollectionType(_Collection, _CompletePackage, true, 0, -1);
			type = _Collection_ConnectionPointReference_T_L0 = getCollectionType(_Collection, _ConnectionPointReference, true, 0, -1);
			type = _Collection_Constraint_T_L0 = getCollectionType(_Collection, _Constraint, true, 0, -1);
			type = _Collection_DataType_T_L0 = getCollectionType(_Collection, _DataType, true, 0, -1);
			type = _Collection_Detail_T_L0 = getCollectionType(_Collection, _Detail, true, 0, -1);
			type = _Collection_DynamicElement_T_L0 = getCollectionType(_Collection, _DynamicElement, true, 0, -1);
			type = _Collection_DynamicProperty_T_L0 = getCollectionType(_Collection, _DynamicProperty, true, 0, -1);
			type = _Collection_ElementExtension_T_L0 = getCollectionType(_Collection, _ElementExtension, true, 0, -1);
			type = _Collection_Element_T_L0 = getCollectionType(_Collection, _Element, true, 0, -1);
			type = _Collection_EnumLiteralExp_T_L0 = getCollectionType(_Collection, _EnumLiteralExp, true, 0, -1);
			type = _Collection_EnumerationLiteral_T_L0 = getCollectionType(_Collection, _EnumerationLiteral, true, 0, -1);
			type = _Collection_Import_T_L0 = getCollectionType(_Collection, _Import, true, 0, -1);
			type = _Collection_InstanceSpecification_T_L0 = getCollectionType(_Collection, _InstanceSpecification, true, 0, -1);
			type = _Collection_IteratorVariable_T_L0 = getCollectionType(_Collection, _IteratorVariable, true, 0, -1);
			type = _Collection_LambdaType_T_L0 = getCollectionType(_Collection, _LambdaType, true, 0, -1);
			type = _Collection_LoopExp_T_L0 = getCollectionType(_Collection, _LoopExp, true, 0, -1);
			type = _Collection_MapLiteralPart_T_L0 = getCollectionType(_Collection, _MapLiteralPart, true, 0, -1);
			type = _Collection_MapType_T_L0 = getCollectionType(_Collection, _MapType, true, 0, -1);
			type = _Collection_MessageType_T_L0 = getCollectionType(_Collection, _MessageType, true, 0, -1);
			type = _Collection_Model_T_L0 = getCollectionType(_Collection, _Model, true, 0, -1);
			type = _Collection_NavigationCallExp_T_L0 = getCollectionType(_Collection, _NavigationCallExp, true, 0, -1);
			type = _Collection_OCLExpression_T_L0 = getCollectionType(_Collection, _OCLExpression, true, 0, -1);
			type = _Collection_OperationCallExp_T_L0 = getCollectionType(_Collection, _OperationCallExp, true, 0, -1);
			type = _Collection_Operation_T_L0 = getCollectionType(_Collection, _Operation, true, 0, -1);
			type = _Collection_OppositePropertyCallExp_T_L0 = getCollectionType(_Collection, _OppositePropertyCallExp, true, 0, -1);
			type = _Collection_Package_T_L0 = getCollectionType(_Collection, _Package, true, 0, -1);
			type = _Collection_Parameter_T_L0 = getCollectionType(_Collection, _Parameter, true, 0, -1);
			type = _Collection_Precedence_T_L0 = getCollectionType(_Collection, _Precedence, true, 0, -1);
			type = _Collection_PrimitiveType_T_L0 = getCollectionType(_Collection, _PrimitiveType, true, 0, -1);
			type = _Collection_ProfileApplication_T_L0 = getCollectionType(_Collection, _ProfileApplication, true, 0, -1);
			type = _Collection_PropertyCallExp_T_L0 = getCollectionType(_Collection, _PropertyCallExp, true, 0, -1);
			type = _Collection_Property_T_L0 = getCollectionType(_Collection, _Property, true, 0, -1);
			type = _Collection_Pseudostate_T_L0 = getCollectionType(_Collection, _Pseudostate, true, 0, -1);
			type = _Collection_Region_T_L0 = getCollectionType(_Collection, _Region, true, 0, -1);
			type = _Collection_SendSignalAction_T_L0 = getCollectionType(_Collection, _SendSignalAction, true, 0, -1);
			type = _Collection_ShadowPart_T_L0 = getCollectionType(_Collection, _ShadowPart, true, 0, -1);
			type = _Collection_Slot_T_L0 = getCollectionType(_Collection, _Slot, true, 0, -1);
			type = _Collection_StateExp_T_L0 = getCollectionType(_Collection, _StateExp, true, 0, -1);
			type = _Collection_StateMachine_T_L0 = getCollectionType(_Collection, _StateMachine, true, 0, -1);
			type = _Collection_State_T_L0 = getCollectionType(_Collection, _State, true, 0, -1);
			type = _Collection_StereotypeExtender_T_L0 = getCollectionType(_Collection, _StereotypeExtender, true, 0, -1);
			type = _Collection_TemplateBinding_T_L0 = getCollectionType(_Collection, _TemplateBinding, true, 0, -1);
			type = _Collection_TemplateParameterSubstitution_T_L0 = getCollectionType(_Collection, _TemplateParameterSubstitution, true, 0, -1);
			type = _Collection_TemplateParameter_T_L0 = getCollectionType(_Collection, _TemplateParameter, true, 0, -1);
			type = _Collection_TemplateableElement_T_L0 = getCollectionType(_Collection, _TemplateableElement, true, 0, -1);
			type = _Collection_Transition_T_L0 = getCollectionType(_Collection, _Transition, true, 0, -1);
			type = _Collection_Trigger_T_L0 = getCollectionType(_Collection, _Trigger, true, 0, -1);
			type = _Collection_TupleLiteralPart_T_L0 = getCollectionType(_Collection, _TupleLiteralPart, true, 0, -1);
			type = _Collection_TypeExp_T_L0 = getCollectionType(_Collection, _TypeExp, true, 0, -1);
			type = _Collection_Type_T_L0 = getCollectionType(_Collection, _Type, true, 0, -1);
			type = _Collection_TypedElement_T_L0 = getCollectionType(_Collection, _TypedElement, true, 0, -1);
			type = _Collection_ValueSpecification_T_L0 = getCollectionType(_Collection, _ValueSpecification, true, 0, -1);
			type = _Collection_VariableDeclaration_T_L0 = getCollectionType(_Collection, _VariableDeclaration, true, 0, -1);
			type = _Collection_VariableExp_T_L0 = getCollectionType(_Collection, _VariableExp, true, 0, -1);
			type = _Collection_Variable_T_L0 = getCollectionType(_Collection, _Variable, true, 0, -1);
			type = _Collection_Vertex_T_L0 = getCollectionType(_Collection, _Vertex, true, 0, -1);
			type = _Collection_WildcardType_T_L0 = getCollectionType(_Collection, _WildcardType, true, 0, -1);
			type = _OrderedCollection_CollectionLiteralPart_T_L0 = getCollectionType(_OrderedCollection, _CollectionLiteralPart, true, 0, -1);
			type = _OrderedCollection_Detail_T_L0 = getCollectionType(_OrderedCollection, _Detail, true, 0, -1);
			type = _OrderedCollection_Element_T_L0 = getCollectionType(_OrderedCollection, _Element, true, 0, -1);
			type = _OrderedCollection_EnumerationLiteral_T_L0 = getCollectionType(_OrderedCollection, _EnumerationLiteral, true, 0, -1);
			type = _OrderedCollection_Import_T_L0 = getCollectionType(_OrderedCollection, _Import, true, 0, -1);
			type = _OrderedCollection_IteratorVariable_T_L0 = getCollectionType(_OrderedCollection, _IteratorVariable, true, 0, -1);
			type = _OrderedCollection_MapLiteralPart_T_L0 = getCollectionType(_OrderedCollection, _MapLiteralPart, true, 0, -1);
			type = _OrderedCollection_OCLExpression_T_L0 = getCollectionType(_OrderedCollection, _OCLExpression, true, 0, -1);
			type = _OrderedCollection_Operation_T_L0 = getCollectionType(_OrderedCollection, _Operation, true, 0, -1);
			type = _OrderedCollection_Parameter_T_L0 = getCollectionType(_OrderedCollection, _Parameter, true, 0, -1);
			type = _OrderedCollection_Precedence_T_L0 = getCollectionType(_OrderedCollection, _Precedence, true, 0, -1);
			type = _OrderedCollection_Property_T_L0 = getCollectionType(_OrderedCollection, _Property, true, 0, -1);
			type = _OrderedCollection_ShadowPart_T_L0 = getCollectionType(_OrderedCollection, _ShadowPart, true, 0, -1);
			type = _OrderedCollection_TemplateParameter_T_L0 = getCollectionType(_OrderedCollection, _TemplateParameter, true, 0, -1);
			type = _OrderedCollection_TupleLiteralPart_T_L0 = getCollectionType(_OrderedCollection, _TupleLiteralPart, true, 0, -1);
			type = _OrderedCollection_Type_T_L0 = getCollectionType(_OrderedCollection, _Type, true, 0, -1);
			type = _OrderedCollection_ValueSpecification_T_L0 = getCollectionType(_OrderedCollection, _ValueSpecification, true, 0, -1);
			type = _OrderedCollection_Variable_T_L0 = getCollectionType(_OrderedCollection, _Variable, true, 0, -1);
			type = _OrderedSet_CollectionLiteralPart_T_L0 = getCollectionType(_OrderedSet, _CollectionLiteralPart, true, 0, -1);
			type = _OrderedSet_Detail_T_L0 = getCollectionType(_OrderedSet, _Detail, true, 0, -1);
			type = _OrderedSet_Element_T_L0 = getCollectionType(_OrderedSet, _Element, true, 0, -1);
			type = _OrderedSet_EnumerationLiteral_T_L0 = getCollectionType(_OrderedSet, _EnumerationLiteral, true, 0, -1);
			type = _OrderedSet_Import_T_L0 = getCollectionType(_OrderedSet, _Import, true, 0, -1);
			type = _OrderedSet_IteratorVariable_F_L0 = getCollectionType(_OrderedSet, _IteratorVariable, false, 0, -1);
			type = _OrderedSet_MapLiteralPart_T_L0 = getCollectionType(_OrderedSet, _MapLiteralPart, true, 0, -1);
			type = _OrderedSet_OCLExpression_T_L0 = getCollectionType(_OrderedSet, _OCLExpression, true, 0, -1);
			type = _OrderedSet_Operation_T_L0 = getCollectionType(_OrderedSet, _Operation, true, 0, -1);
			type = _OrderedSet_Parameter_T_L0 = getCollectionType(_OrderedSet, _Parameter, true, 0, -1);
			type = _OrderedSet_Precedence_T_L0 = getCollectionType(_OrderedSet, _Precedence, true, 0, -1);
			type = _OrderedSet_Property_T_L0 = getCollectionType(_OrderedSet, _Property, true, 0, -1);
			type = _OrderedSet_ShadowPart_T_L0 = getCollectionType(_OrderedSet, _ShadowPart, true, 0, -1);
			type = _OrderedSet_TemplateParameter_T_L1 = getCollectionType(_OrderedSet, _TemplateParameter, true, 1, -1);
			type = _OrderedSet_TupleLiteralPart_T_L0 = getCollectionType(_OrderedSet, _TupleLiteralPart, true, 0, -1);
			type = _OrderedSet_ValueSpecification_T_L0 = getCollectionType(_OrderedSet, _ValueSpecification, true, 0, -1);
			type = _OrderedSet_Variable_T_L0 = getCollectionType(_OrderedSet, _Variable, true, 0, -1);
			type = _Sequence_Type_T_L0 = getCollectionType(_Sequence, _Type, true, 0, -1);
			type = _Set_String_T_L1 = getCollectionType(_Set, _String, true, 1, -1);
			type = _Set_Behavior_T_L0 = getCollectionType(_Set, _Behavior, true, 0, -1);
			type = _Set_Class_T_L0 = getCollectionType(_Set, _Class, true, 0, -1);
			type = _Set_Comment_T_L0 = getCollectionType(_Set, _Comment, true, 0, -1);
			type = _Set_CompleteClass_T_L0 = getCollectionType(_Set, _CompleteClass, true, 0, -1);
			type = _Set_CompletePackage_T_L0 = getCollectionType(_Set, _CompletePackage, true, 0, -1);
			type = _Set_ConnectionPointReference_T_L0 = getCollectionType(_Set, _ConnectionPointReference, true, 0, -1);
			type = _Set_Constraint_T_L0 = getCollectionType(_Set, _Constraint, true, 0, -1);
			type = _Set_DynamicProperty_T_L0 = getCollectionType(_Set, _DynamicProperty, true, 0, -1);
			type = _Set_ElementExtension_T_L0 = getCollectionType(_Set, _ElementExtension, true, 0, -1);
			type = _Set_Element_T_L0 = getCollectionType(_Set, _Element, true, 0, -1);
			type = _Set_InstanceSpecification_T_L0 = getCollectionType(_Set, _InstanceSpecification, true, 0, -1);
			type = _Set_Model_T_L0 = getCollectionType(_Set, _Model, true, 0, -1);
			type = _Set_Operation_T_L0 = getCollectionType(_Set, _Operation, true, 0, -1);
			type = _Set_Package_T_L0 = getCollectionType(_Set, _Package, true, 0, -1);
			type = _Set_ProfileApplication_T_L0 = getCollectionType(_Set, _ProfileApplication, true, 0, -1);
			type = _Set_Property_T_L0 = getCollectionType(_Set, _Property, true, 0, -1);
			type = _Set_Pseudostate_T_L0 = getCollectionType(_Set, _Pseudostate, true, 0, -1);
			type = _Set_Region_T_L0 = getCollectionType(_Set, _Region, true, 0, -1);
			type = _Set_Region_T_L1 = getCollectionType(_Set, _Region, true, 1, -1);
			type = _Set_Slot_T_L0 = getCollectionType(_Set, _Slot, true, 0, -1);
			type = _Set_StateMachine_T_L0 = getCollectionType(_Set, _StateMachine, true, 0, -1);
			type = _Set_State_T_L0 = getCollectionType(_Set, _State, true, 0, -1);
			type = _Set_StereotypeExtender_T_L0 = getCollectionType(_Set, _StereotypeExtender, true, 0, -1);
			type = _Set_TemplateBinding_T_L0 = getCollectionType(_Set, _TemplateBinding, true, 0, -1);
			type = _Set_TemplateParameterSubstitution_T_L1 = getCollectionType(_Set, _TemplateParameterSubstitution, true, 1, -1);
			type = _Set_Transition_T_L0 = getCollectionType(_Set, _Transition, true, 0, -1);
			type = _Set_Trigger_T_L0 = getCollectionType(_Set, _Trigger, true, 0, -1);
			type = _Set_Type_T_L0 = getCollectionType(_Set, _Type, true, 0, -1);
			type = _Set_Vertex_T_L0 = getCollectionType(_Set, _Vertex, true, 0, -1);
			type = _UniqueCollection_String_T_L0 = getCollectionType(_UniqueCollection, _String, true, 0, -1);
			type = _UniqueCollection_Behavior_T_L0 = getCollectionType(_UniqueCollection, _Behavior, true, 0, -1);
			type = _UniqueCollection_Class_T_L0 = getCollectionType(_UniqueCollection, _Class, true, 0, -1);
			type = _UniqueCollection_CollectionLiteralPart_T_L0 = getCollectionType(_UniqueCollection, _CollectionLiteralPart, true, 0, -1);
			type = _UniqueCollection_Comment_T_L0 = getCollectionType(_UniqueCollection, _Comment, true, 0, -1);
			type = _UniqueCollection_CompleteClass_T_L0 = getCollectionType(_UniqueCollection, _CompleteClass, true, 0, -1);
			type = _UniqueCollection_CompletePackage_T_L0 = getCollectionType(_UniqueCollection, _CompletePackage, true, 0, -1);
			type = _UniqueCollection_ConnectionPointReference_T_L0 = getCollectionType(_UniqueCollection, _ConnectionPointReference, true, 0, -1);
			type = _UniqueCollection_Constraint_T_L0 = getCollectionType(_UniqueCollection, _Constraint, true, 0, -1);
			type = _UniqueCollection_Detail_T_L0 = getCollectionType(_UniqueCollection, _Detail, true, 0, -1);
			type = _UniqueCollection_DynamicProperty_T_L0 = getCollectionType(_UniqueCollection, _DynamicProperty, true, 0, -1);
			type = _UniqueCollection_ElementExtension_T_L0 = getCollectionType(_UniqueCollection, _ElementExtension, true, 0, -1);
			type = _UniqueCollection_Element_T_L0 = getCollectionType(_UniqueCollection, _Element, true, 0, -1);
			type = _UniqueCollection_EnumerationLiteral_T_L0 = getCollectionType(_UniqueCollection, _EnumerationLiteral, true, 0, -1);
			type = _UniqueCollection_Import_T_L0 = getCollectionType(_UniqueCollection, _Import, true, 0, -1);
			type = _UniqueCollection_InstanceSpecification_T_L0 = getCollectionType(_UniqueCollection, _InstanceSpecification, true, 0, -1);
			type = _UniqueCollection_IteratorVariable_T_L0 = getCollectionType(_UniqueCollection, _IteratorVariable, true, 0, -1);
			type = _UniqueCollection_MapLiteralPart_T_L0 = getCollectionType(_UniqueCollection, _MapLiteralPart, true, 0, -1);
			type = _UniqueCollection_Model_T_L0 = getCollectionType(_UniqueCollection, _Model, true, 0, -1);
			type = _UniqueCollection_OCLExpression_T_L0 = getCollectionType(_UniqueCollection, _OCLExpression, true, 0, -1);
			type = _UniqueCollection_Operation_T_L0 = getCollectionType(_UniqueCollection, _Operation, true, 0, -1);
			type = _UniqueCollection_Package_T_L0 = getCollectionType(_UniqueCollection, _Package, true, 0, -1);
			type = _UniqueCollection_Parameter_T_L0 = getCollectionType(_UniqueCollection, _Parameter, true, 0, -1);
			type = _UniqueCollection_Precedence_T_L0 = getCollectionType(_UniqueCollection, _Precedence, true, 0, -1);
			type = _UniqueCollection_ProfileApplication_T_L0 = getCollectionType(_UniqueCollection, _ProfileApplication, true, 0, -1);
			type = _UniqueCollection_Property_T_L0 = getCollectionType(_UniqueCollection, _Property, true, 0, -1);
			type = _UniqueCollection_Pseudostate_T_L0 = getCollectionType(_UniqueCollection, _Pseudostate, true, 0, -1);
			type = _UniqueCollection_Region_T_L0 = getCollectionType(_UniqueCollection, _Region, true, 0, -1);
			type = _UniqueCollection_ShadowPart_T_L0 = getCollectionType(_UniqueCollection, _ShadowPart, true, 0, -1);
			type = _UniqueCollection_Slot_T_L0 = getCollectionType(_UniqueCollection, _Slot, true, 0, -1);
			type = _UniqueCollection_StateMachine_T_L0 = getCollectionType(_UniqueCollection, _StateMachine, true, 0, -1);
			type = _UniqueCollection_State_T_L0 = getCollectionType(_UniqueCollection, _State, true, 0, -1);
			type = _UniqueCollection_StereotypeExtender_T_L0 = getCollectionType(_UniqueCollection, _StereotypeExtender, true, 0, -1);
			type = _UniqueCollection_TemplateBinding_T_L0 = getCollectionType(_UniqueCollection, _TemplateBinding, true, 0, -1);
			type = _UniqueCollection_TemplateParameterSubstitution_T_L0 = getCollectionType(_UniqueCollection, _TemplateParameterSubstitution, true, 0, -1);
			type = _UniqueCollection_TemplateParameter_T_L0 = getCollectionType(_UniqueCollection, _TemplateParameter, true, 0, -1);
			type = _UniqueCollection_Transition_T_L0 = getCollectionType(_UniqueCollection, _Transition, true, 0, -1);
			type = _UniqueCollection_Trigger_T_L0 = getCollectionType(_UniqueCollection, _Trigger, true, 0, -1);
			type = _UniqueCollection_TupleLiteralPart_T_L0 = getCollectionType(_UniqueCollection, _TupleLiteralPart, true, 0, -1);
			type = _UniqueCollection_Type_T_L0 = getCollectionType(_UniqueCollection, _Type, true, 0, -1);
			type = _UniqueCollection_ValueSpecification_T_L0 = getCollectionType(_UniqueCollection, _ValueSpecification, true, 0, -1);
			type = _UniqueCollection_Variable_T_L0 = getCollectionType(_UniqueCollection, _Variable, true, 0, -1);
			type = _UniqueCollection_Vertex_T_L0 = getCollectionType(_UniqueCollection, _Vertex, true, 0, -1);
		}

		private void installAggregateSuperTypes() {
			addSuperClass(_Bag_Annotation_T_L0, _Collection_Annotation_T_L0);
			addSuperClass(_Bag_AssociationClassCallExp_T_L0, _Collection_AssociationClassCallExp_T_L0);
			addSuperClass(_Bag_CallOperationAction_T_L0, _Collection_CallOperationAction_T_L0);
			addSuperClass(_Bag_Class_T_L0, _Collection_Class_T_L0);
			addSuperClass(_Bag_CollectionType_T_L0, _Collection_CollectionType_T_L0);
			addSuperClass(_Bag_CompleteClass_T_L0, _Collection_CompleteClass_T_L0);
			addSuperClass(_Bag_CompleteModel_T_L0, _Collection_CompleteModel_T_L0);
			addSuperClass(_Bag_CompletePackage_T_L0, _Collection_CompletePackage_T_L0);
			addSuperClass(_Bag_ConnectionPointReference_T_L0, _Collection_ConnectionPointReference_T_L0);
			addSuperClass(_Bag_Constraint_T_L0, _Collection_Constraint_T_L0);
			addSuperClass(_Bag_DataType_T_L0, _Collection_DataType_T_L0);
			addSuperClass(_Bag_DynamicElement_T_L0, _Collection_DynamicElement_T_L0);
			addSuperClass(_Bag_DynamicProperty_T_L0, _Collection_DynamicProperty_T_L0);
			addSuperClass(_Bag_ElementExtension_T_L0, _Collection_ElementExtension_T_L0);
			addSuperClass(_Bag_EnumLiteralExp_T_L0, _Collection_EnumLiteralExp_T_L0);
			addSuperClass(_Bag_Import_T_L0, _Collection_Import_T_L0);
			addSuperClass(_Bag_InstanceSpecification_T_L0, _Collection_InstanceSpecification_T_L0);
			addSuperClass(_Bag_LambdaType_T_L0, _Collection_LambdaType_T_L0);
			addSuperClass(_Bag_LoopExp_T_L0, _Collection_LoopExp_T_L0);
			addSuperClass(_Bag_MapType_T_L0, _Collection_MapType_T_L0);
			addSuperClass(_Bag_MessageType_T_L0, _Collection_MessageType_T_L0);
			addSuperClass(_Bag_NavigationCallExp_T_L0, _Collection_NavigationCallExp_T_L0);
			addSuperClass(_Bag_OCLExpression_T_L0, _Collection_OCLExpression_T_L0);
			addSuperClass(_Bag_OperationCallExp_T_L0, _Collection_OperationCallExp_T_L0);
			addSuperClass(_Bag_Operation_T_L0, _Collection_Operation_T_L0);
			addSuperClass(_Bag_OppositePropertyCallExp_T_L0, _Collection_OppositePropertyCallExp_T_L0);
			addSuperClass(_Bag_Package_T_L0, _Collection_Package_T_L0);
			addSuperClass(_Bag_PrimitiveType_T_L0, _Collection_PrimitiveType_T_L0);
			addSuperClass(_Bag_PropertyCallExp_T_L0, _Collection_PropertyCallExp_T_L0);
			addSuperClass(_Bag_Property_T_L0, _Collection_Property_T_L0);
			addSuperClass(_Bag_Region_T_L0, _Collection_Region_T_L0);
			addSuperClass(_Bag_SendSignalAction_T_L0, _Collection_SendSignalAction_T_L0);
			addSuperClass(_Bag_ShadowPart_T_L0, _Collection_ShadowPart_T_L0);
			addSuperClass(_Bag_Slot_T_L0, _Collection_Slot_T_L0);
			addSuperClass(_Bag_StateExp_T_L0, _Collection_StateExp_T_L0);
			addSuperClass(_Bag_StateMachine_T_L0, _Collection_StateMachine_T_L0);
			addSuperClass(_Bag_State_T_L0, _Collection_State_T_L0);
			addSuperClass(_Bag_TemplateBinding_T_L0, _Collection_TemplateBinding_T_L0);
			addSuperClass(_Bag_TemplateParameterSubstitution_T_L0, _Collection_TemplateParameterSubstitution_T_L0);
			addSuperClass(_Bag_TemplateParameter_T_L0, _Collection_TemplateParameter_T_L0);
			addSuperClass(_Bag_TemplateableElement_T_L0, _Collection_TemplateableElement_T_L0);
			addSuperClass(_Bag_TypeExp_T_L0, _Collection_TypeExp_T_L0);
			addSuperClass(_Bag_TypedElement_T_L0, _Collection_TypedElement_T_L0);
			addSuperClass(_Bag_VariableDeclaration_T_L0, _Collection_VariableDeclaration_T_L0);
			addSuperClass(_Bag_VariableExp_T_L0, _Collection_VariableExp_T_L0);
			addSuperClass(_Bag_Variable_T_L0, _Collection_Variable_T_L0);
			addSuperClass(_Bag_WildcardType_T_L0, _Collection_WildcardType_T_L0);
			addSuperClass(_Collection_String_T_L0, _OclAny);
			addSuperClass(_Collection_Annotation_T_L0, _OclAny);
			addSuperClass(_Collection_AssociationClassCallExp_T_L0, _OclAny);
			addSuperClass(_Collection_Behavior_T_L0, _OclAny);
			addSuperClass(_Collection_CallOperationAction_T_L0, _OclAny);
			addSuperClass(_Collection_Class_T_L0, _OclAny);
			addSuperClass(_Collection_CollectionLiteralPart_T_L0, _OclAny);
			addSuperClass(_Collection_CollectionType_T_L0, _OclAny);
			addSuperClass(_Collection_Comment_T_L0, _OclAny);
			addSuperClass(_Collection_CompleteClass_T_L0, _OclAny);
			addSuperClass(_Collection_CompleteModel_T_L0, _OclAny);
			addSuperClass(_Collection_CompletePackage_T_L0, _OclAny);
			addSuperClass(_Collection_ConnectionPointReference_T_L0, _OclAny);
			addSuperClass(_Collection_Constraint_T_L0, _OclAny);
			addSuperClass(_Collection_DataType_T_L0, _OclAny);
			addSuperClass(_Collection_Detail_T_L0, _OclAny);
			addSuperClass(_Collection_DynamicElement_T_L0, _OclAny);
			addSuperClass(_Collection_DynamicProperty_T_L0, _OclAny);
			addSuperClass(_Collection_ElementExtension_T_L0, _OclAny);
			addSuperClass(_Collection_Element_T_L0, _OclAny);
			addSuperClass(_Collection_EnumLiteralExp_T_L0, _OclAny);
			addSuperClass(_Collection_EnumerationLiteral_T_L0, _OclAny);
			addSuperClass(_Collection_Import_T_L0, _OclAny);
			addSuperClass(_Collection_InstanceSpecification_T_L0, _OclAny);
			addSuperClass(_Collection_IteratorVariable_T_L0, _OclAny);
			addSuperClass(_Collection_LambdaType_T_L0, _OclAny);
			addSuperClass(_Collection_LoopExp_T_L0, _OclAny);
			addSuperClass(_Collection_MapLiteralPart_T_L0, _OclAny);
			addSuperClass(_Collection_MapType_T_L0, _OclAny);
			addSuperClass(_Collection_MessageType_T_L0, _OclAny);
			addSuperClass(_Collection_Model_T_L0, _OclAny);
			addSuperClass(_Collection_NavigationCallExp_T_L0, _OclAny);
			addSuperClass(_Collection_OCLExpression_T_L0, _OclAny);
			addSuperClass(_Collection_OperationCallExp_T_L0, _OclAny);
			addSuperClass(_Collection_Operation_T_L0, _OclAny);
			addSuperClass(_Collection_OppositePropertyCallExp_T_L0, _OclAny);
			addSuperClass(_Collection_Package_T_L0, _OclAny);
			addSuperClass(_Collection_Parameter_T_L0, _OclAny);
			addSuperClass(_Collection_Precedence_T_L0, _OclAny);
			addSuperClass(_Collection_PrimitiveType_T_L0, _OclAny);
			addSuperClass(_Collection_ProfileApplication_T_L0, _OclAny);
			addSuperClass(_Collection_PropertyCallExp_T_L0, _OclAny);
			addSuperClass(_Collection_Property_T_L0, _OclAny);
			addSuperClass(_Collection_Pseudostate_T_L0, _OclAny);
			addSuperClass(_Collection_Region_T_L0, _OclAny);
			addSuperClass(_Collection_SendSignalAction_T_L0, _OclAny);
			addSuperClass(_Collection_ShadowPart_T_L0, _OclAny);
			addSuperClass(_Collection_Slot_T_L0, _OclAny);
			addSuperClass(_Collection_StateExp_T_L0, _OclAny);
			addSuperClass(_Collection_StateMachine_T_L0, _OclAny);
			addSuperClass(_Collection_State_T_L0, _OclAny);
			addSuperClass(_Collection_StereotypeExtender_T_L0, _OclAny);
			addSuperClass(_Collection_TemplateBinding_T_L0, _OclAny);
			addSuperClass(_Collection_TemplateParameterSubstitution_T_L0, _OclAny);
			addSuperClass(_Collection_TemplateParameter_T_L0, _OclAny);
			addSuperClass(_Collection_TemplateableElement_T_L0, _OclAny);
			addSuperClass(_Collection_Transition_T_L0, _OclAny);
			addSuperClass(_Collection_Trigger_T_L0, _OclAny);
			addSuperClass(_Collection_TupleLiteralPart_T_L0, _OclAny);
			addSuperClass(_Collection_TypeExp_T_L0, _OclAny);
			addSuperClass(_Collection_Type_T_L0, _OclAny);
			addSuperClass(_Collection_TypedElement_T_L0, _OclAny);
			addSuperClass(_Collection_ValueSpecification_T_L0, _OclAny);
			addSuperClass(_Collection_VariableDeclaration_T_L0, _OclAny);
			addSuperClass(_Collection_VariableExp_T_L0, _OclAny);
			addSuperClass(_Collection_Variable_T_L0, _OclAny);
			addSuperClass(_Collection_Vertex_T_L0, _OclAny);
			addSuperClass(_Collection_WildcardType_T_L0, _OclAny);
			addSuperClass(_OrderedCollection_CollectionLiteralPart_T_L0, _Collection_CollectionLiteralPart_T_L0);
			addSuperClass(_OrderedCollection_Detail_T_L0, _Collection_Detail_T_L0);
			addSuperClass(_OrderedCollection_Element_T_L0, _Collection_Element_T_L0);
			addSuperClass(_OrderedCollection_EnumerationLiteral_T_L0, _Collection_EnumerationLiteral_T_L0);
			addSuperClass(_OrderedCollection_Import_T_L0, _Collection_Import_T_L0);
			addSuperClass(_OrderedCollection_IteratorVariable_T_L0, _Collection_IteratorVariable_T_L0);
			addSuperClass(_OrderedCollection_MapLiteralPart_T_L0, _Collection_MapLiteralPart_T_L0);
			addSuperClass(_OrderedCollection_OCLExpression_T_L0, _Collection_OCLExpression_T_L0);
			addSuperClass(_OrderedCollection_Operation_T_L0, _Collection_Operation_T_L0);
			addSuperClass(_OrderedCollection_Parameter_T_L0, _Collection_Parameter_T_L0);
			addSuperClass(_OrderedCollection_Precedence_T_L0, _Collection_Precedence_T_L0);
			addSuperClass(_OrderedCollection_Property_T_L0, _Collection_Property_T_L0);
			addSuperClass(_OrderedCollection_ShadowPart_T_L0, _Collection_ShadowPart_T_L0);
			addSuperClass(_OrderedCollection_TemplateParameter_T_L0, _Collection_TemplateParameter_T_L0);
			addSuperClass(_OrderedCollection_TupleLiteralPart_T_L0, _Collection_TupleLiteralPart_T_L0);
			addSuperClass(_OrderedCollection_Type_T_L0, _Collection_Type_T_L0);
			addSuperClass(_OrderedCollection_ValueSpecification_T_L0, _Collection_ValueSpecification_T_L0);
			addSuperClass(_OrderedCollection_Variable_T_L0, _Collection_Variable_T_L0);
			addSuperClass(_OrderedSet_CollectionLiteralPart_T_L0, _OrderedCollection_CollectionLiteralPart_T_L0);
			addSuperClass(_OrderedSet_CollectionLiteralPart_T_L0, _UniqueCollection_CollectionLiteralPart_T_L0);
			addSuperClass(_OrderedSet_Detail_T_L0, _OrderedCollection_Detail_T_L0);
			addSuperClass(_OrderedSet_Detail_T_L0, _UniqueCollection_Detail_T_L0);
			addSuperClass(_OrderedSet_Element_T_L0, _OrderedCollection_Element_T_L0);
			addSuperClass(_OrderedSet_Element_T_L0, _UniqueCollection_Element_T_L0);
			addSuperClass(_OrderedSet_EnumerationLiteral_T_L0, _OrderedCollection_EnumerationLiteral_T_L0);
			addSuperClass(_OrderedSet_EnumerationLiteral_T_L0, _UniqueCollection_EnumerationLiteral_T_L0);
			addSuperClass(_OrderedSet_Import_T_L0, _OrderedCollection_Import_T_L0);
			addSuperClass(_OrderedSet_Import_T_L0, _UniqueCollection_Import_T_L0);
			addSuperClass(_OrderedSet_IteratorVariable_F_L0, _OrderedCollection_IteratorVariable_T_L0);
			addSuperClass(_OrderedSet_IteratorVariable_F_L0, _UniqueCollection_IteratorVariable_T_L0);
			addSuperClass(_OrderedSet_MapLiteralPart_T_L0, _OrderedCollection_MapLiteralPart_T_L0);
			addSuperClass(_OrderedSet_MapLiteralPart_T_L0, _UniqueCollection_MapLiteralPart_T_L0);
			addSuperClass(_OrderedSet_OCLExpression_T_L0, _OrderedCollection_OCLExpression_T_L0);
			addSuperClass(_OrderedSet_OCLExpression_T_L0, _UniqueCollection_OCLExpression_T_L0);
			addSuperClass(_OrderedSet_Operation_T_L0, _OrderedCollection_Operation_T_L0);
			addSuperClass(_OrderedSet_Operation_T_L0, _UniqueCollection_Operation_T_L0);
			addSuperClass(_OrderedSet_Parameter_T_L0, _OrderedCollection_Parameter_T_L0);
			addSuperClass(_OrderedSet_Parameter_T_L0, _UniqueCollection_Parameter_T_L0);
			addSuperClass(_OrderedSet_Precedence_T_L0, _OrderedCollection_Precedence_T_L0);
			addSuperClass(_OrderedSet_Precedence_T_L0, _UniqueCollection_Precedence_T_L0);
			addSuperClass(_OrderedSet_Property_T_L0, _OrderedCollection_Property_T_L0);
			addSuperClass(_OrderedSet_Property_T_L0, _UniqueCollection_Property_T_L0);
			addSuperClass(_OrderedSet_ShadowPart_T_L0, _OrderedCollection_ShadowPart_T_L0);
			addSuperClass(_OrderedSet_ShadowPart_T_L0, _UniqueCollection_ShadowPart_T_L0);
			addSuperClass(_OrderedSet_TemplateParameter_T_L1, _OrderedCollection_TemplateParameter_T_L0);
			addSuperClass(_OrderedSet_TemplateParameter_T_L1, _UniqueCollection_TemplateParameter_T_L0);
			addSuperClass(_OrderedSet_TupleLiteralPart_T_L0, _OrderedCollection_TupleLiteralPart_T_L0);
			addSuperClass(_OrderedSet_TupleLiteralPart_T_L0, _UniqueCollection_TupleLiteralPart_T_L0);
			addSuperClass(_OrderedSet_ValueSpecification_T_L0, _OrderedCollection_ValueSpecification_T_L0);
			addSuperClass(_OrderedSet_ValueSpecification_T_L0, _UniqueCollection_ValueSpecification_T_L0);
			addSuperClass(_OrderedSet_Variable_T_L0, _OrderedCollection_Variable_T_L0);
			addSuperClass(_OrderedSet_Variable_T_L0, _UniqueCollection_Variable_T_L0);
			addSuperClass(_Sequence_Type_T_L0, _OrderedCollection_Type_T_L0);
			addSuperClass(_Set_String_T_L1, _UniqueCollection_String_T_L0);
			addSuperClass(_Set_Behavior_T_L0, _UniqueCollection_Behavior_T_L0);
			addSuperClass(_Set_Class_T_L0, _UniqueCollection_Class_T_L0);
			addSuperClass(_Set_Comment_T_L0, _UniqueCollection_Comment_T_L0);
			addSuperClass(_Set_CompleteClass_T_L0, _UniqueCollection_CompleteClass_T_L0);
			addSuperClass(_Set_CompletePackage_T_L0, _UniqueCollection_CompletePackage_T_L0);
			addSuperClass(_Set_ConnectionPointReference_T_L0, _UniqueCollection_ConnectionPointReference_T_L0);
			addSuperClass(_Set_Constraint_T_L0, _UniqueCollection_Constraint_T_L0);
			addSuperClass(_Set_DynamicProperty_T_L0, _UniqueCollection_DynamicProperty_T_L0);
			addSuperClass(_Set_ElementExtension_T_L0, _UniqueCollection_ElementExtension_T_L0);
			addSuperClass(_Set_Element_T_L0, _UniqueCollection_Element_T_L0);
			addSuperClass(_Set_InstanceSpecification_T_L0, _UniqueCollection_InstanceSpecification_T_L0);
			addSuperClass(_Set_Model_T_L0, _UniqueCollection_Model_T_L0);
			addSuperClass(_Set_Operation_T_L0, _UniqueCollection_Operation_T_L0);
			addSuperClass(_Set_Package_T_L0, _UniqueCollection_Package_T_L0);
			addSuperClass(_Set_ProfileApplication_T_L0, _UniqueCollection_ProfileApplication_T_L0);
			addSuperClass(_Set_Property_T_L0, _UniqueCollection_Property_T_L0);
			addSuperClass(_Set_Pseudostate_T_L0, _UniqueCollection_Pseudostate_T_L0);
			addSuperClass(_Set_Region_T_L0, _UniqueCollection_Region_T_L0);
			addSuperClass(_Set_Region_T_L1, _UniqueCollection_Region_T_L0);
			addSuperClass(_Set_Slot_T_L0, _UniqueCollection_Slot_T_L0);
			addSuperClass(_Set_StateMachine_T_L0, _UniqueCollection_StateMachine_T_L0);
			addSuperClass(_Set_State_T_L0, _UniqueCollection_State_T_L0);
			addSuperClass(_Set_StereotypeExtender_T_L0, _UniqueCollection_StereotypeExtender_T_L0);
			addSuperClass(_Set_TemplateBinding_T_L0, _UniqueCollection_TemplateBinding_T_L0);
			addSuperClass(_Set_TemplateParameterSubstitution_T_L1, _UniqueCollection_TemplateParameterSubstitution_T_L0);
			addSuperClass(_Set_Transition_T_L0, _UniqueCollection_Transition_T_L0);
			addSuperClass(_Set_Trigger_T_L0, _UniqueCollection_Trigger_T_L0);
			addSuperClass(_Set_Type_T_L0, _UniqueCollection_Type_T_L0);
			addSuperClass(_Set_Vertex_T_L0, _UniqueCollection_Vertex_T_L0);
			addSuperClass(_UniqueCollection_String_T_L0, _Collection_String_T_L0);
			addSuperClass(_UniqueCollection_Behavior_T_L0, _Collection_Behavior_T_L0);
			addSuperClass(_UniqueCollection_Class_T_L0, _Collection_Class_T_L0);
			addSuperClass(_UniqueCollection_CollectionLiteralPart_T_L0, _Collection_CollectionLiteralPart_T_L0);
			addSuperClass(_UniqueCollection_Comment_T_L0, _Collection_Comment_T_L0);
			addSuperClass(_UniqueCollection_CompleteClass_T_L0, _Collection_CompleteClass_T_L0);
			addSuperClass(_UniqueCollection_CompletePackage_T_L0, _Collection_CompletePackage_T_L0);
			addSuperClass(_UniqueCollection_ConnectionPointReference_T_L0, _Collection_ConnectionPointReference_T_L0);
			addSuperClass(_UniqueCollection_Constraint_T_L0, _Collection_Constraint_T_L0);
			addSuperClass(_UniqueCollection_Detail_T_L0, _Collection_Detail_T_L0);
			addSuperClass(_UniqueCollection_DynamicProperty_T_L0, _Collection_DynamicProperty_T_L0);
			addSuperClass(_UniqueCollection_ElementExtension_T_L0, _Collection_ElementExtension_T_L0);
			addSuperClass(_UniqueCollection_Element_T_L0, _Collection_Element_T_L0);
			addSuperClass(_UniqueCollection_EnumerationLiteral_T_L0, _Collection_EnumerationLiteral_T_L0);
			addSuperClass(_UniqueCollection_Import_T_L0, _Collection_Import_T_L0);
			addSuperClass(_UniqueCollection_InstanceSpecification_T_L0, _Collection_InstanceSpecification_T_L0);
			addSuperClass(_UniqueCollection_IteratorVariable_T_L0, _Collection_IteratorVariable_T_L0);
			addSuperClass(_UniqueCollection_MapLiteralPart_T_L0, _Collection_MapLiteralPart_T_L0);
			addSuperClass(_UniqueCollection_Model_T_L0, _Collection_Model_T_L0);
			addSuperClass(_UniqueCollection_OCLExpression_T_L0, _Collection_OCLExpression_T_L0);
			addSuperClass(_UniqueCollection_Operation_T_L0, _Collection_Operation_T_L0);
			addSuperClass(_UniqueCollection_Package_T_L0, _Collection_Package_T_L0);
			addSuperClass(_UniqueCollection_Parameter_T_L0, _Collection_Parameter_T_L0);
			addSuperClass(_UniqueCollection_Precedence_T_L0, _Collection_Precedence_T_L0);
			addSuperClass(_UniqueCollection_ProfileApplication_T_L0, _Collection_ProfileApplication_T_L0);
			addSuperClass(_UniqueCollection_Property_T_L0, _Collection_Property_T_L0);
			addSuperClass(_UniqueCollection_Pseudostate_T_L0, _Collection_Pseudostate_T_L0);
			addSuperClass(_UniqueCollection_Region_T_L0, _Collection_Region_T_L0);
			addSuperClass(_UniqueCollection_ShadowPart_T_L0, _Collection_ShadowPart_T_L0);
			addSuperClass(_UniqueCollection_Slot_T_L0, _Collection_Slot_T_L0);
			addSuperClass(_UniqueCollection_StateMachine_T_L0, _Collection_StateMachine_T_L0);
			addSuperClass(_UniqueCollection_State_T_L0, _Collection_State_T_L0);
			addSuperClass(_UniqueCollection_StereotypeExtender_T_L0, _Collection_StereotypeExtender_T_L0);
			addSuperClass(_UniqueCollection_TemplateBinding_T_L0, _Collection_TemplateBinding_T_L0);
			addSuperClass(_UniqueCollection_TemplateParameterSubstitution_T_L0, _Collection_TemplateParameterSubstitution_T_L0);
			addSuperClass(_UniqueCollection_TemplateParameter_T_L0, _Collection_TemplateParameter_T_L0);
			addSuperClass(_UniqueCollection_Transition_T_L0, _Collection_Transition_T_L0);
			addSuperClass(_UniqueCollection_Trigger_T_L0, _Collection_Trigger_T_L0);
			addSuperClass(_UniqueCollection_TupleLiteralPart_T_L0, _Collection_TupleLiteralPart_T_L0);
			addSuperClass(_UniqueCollection_Type_T_L0, _Collection_Type_T_L0);
			addSuperClass(_UniqueCollection_ValueSpecification_T_L0, _Collection_ValueSpecification_T_L0);
			addSuperClass(_UniqueCollection_Variable_T_L0, _Collection_Variable_T_L0);
			addSuperClass(_UniqueCollection_Vertex_T_L0, _Collection_Vertex_T_L0);
		}
		...
		private void installOperationBodies() {
			...
			operation.setType(_Set_Element_T_L0);
			createBodyExpression(operation, _Element, "self->closure(oclContents()->selectByKind(Element))", _Set_Element_T_L0);
		...
		private void installProperties() {
			...
			property.setIsImplicit(true);
			property.setIsResolveProxies(true);
			ownedProperties.add(property = pr_Property_Property_opposite = createProperty("Property", _Bag_Property_T_L0));
			property.setIsImplicit(true);
			property.setIsResolveProxies(true);
			...
			property.setIsRequired(false);
			property.setIsTransient(true);
			ownedProperties.add(property = pr_TemplateableElement_TemplateableElement_unspecializedElement = createProperty("TemplateableElement", _Bag_TemplateableElement_T_L0));
			property.setIsImplicit(true);
			property.setIsResolveProxies(true);
			...
			property.setIsImplicit(true);
			property.setIsResolveProxies(true);
			ownedProperties.add(property = pr_Type_WildcardType_lowerBound = createProperty("WildcardType", _Bag_WildcardType_T_L0));
			property.setIsImplicit(true);
			property.setIsResolveProxies(true);
			ownedProperties.add(property = pr_Type_WildcardType_upperBound = createProperty("WildcardType", _Bag_WildcardType_T_L0));
			property.setIsImplicit(true);
			property.setIsResolveProxies(true);
