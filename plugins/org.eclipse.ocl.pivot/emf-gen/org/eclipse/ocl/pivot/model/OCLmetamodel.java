...
public class OCLmetamodel extends ASResourceImpl
{
	...
	private static class Contents extends LibraryContents
	{
		...
		private final @NonNull NullableType _Nullable_Bag_Annotation = createNullableType(_Bag_Annotation);
		private final @NonNull NullableType _Nullable_Bag_AssociationClassCallExp = createNullableType(_Bag_AssociationClassCallExp);
		private final @NonNull NullableType _Nullable_Bag_CallOperationAction = createNullableType(_Bag_CallOperationAction);
		private final @NonNull NullableType _Nullable_Bag_Class = createNullableType(_Bag_Class);
		private final @NonNull NullableType _Nullable_Bag_CollectionType = createNullableType(_Bag_CollectionType);
		private final @NonNull NullableType _Nullable_Bag_CompleteClass = createNullableType(_Bag_CompleteClass);
		private final @NonNull NullableType _Nullable_Bag_CompleteModel = createNullableType(_Bag_CompleteModel);
		private final @NonNull NullableType _Nullable_Bag_CompletePackage = createNullableType(_Bag_CompletePackage);
		private final @NonNull NullableType _Nullable_Bag_ConnectionPointReference = createNullableType(_Bag_ConnectionPointReference);
		private final @NonNull NullableType _Nullable_Bag_Constraint = createNullableType(_Bag_Constraint);
		private final @NonNull NullableType _Nullable_Bag_DataType = createNullableType(_Bag_DataType);
		private final @NonNull NullableType _Nullable_Bag_DynamicElement = createNullableType(_Bag_DynamicElement);
		private final @NonNull NullableType _Nullable_Bag_DynamicProperty = createNullableType(_Bag_DynamicProperty);
		private final @NonNull NullableType _Nullable_Bag_ElementExtension = createNullableType(_Bag_ElementExtension);
		private final @NonNull NullableType _Nullable_Bag_EnumLiteralExp = createNullableType(_Bag_EnumLiteralExp);
		private final @NonNull NullableType _Nullable_Bag_Import = createNullableType(_Bag_Import);
		private final @NonNull NullableType _Nullable_Bag_InstanceSpecification = createNullableType(_Bag_InstanceSpecification);
		private final @NonNull NullableType _Nullable_Bag_InvalidableType = createNullableType(_Bag_InvalidableType);
		private final @NonNull NullableType _Nullable_Bag_LambdaType = createNullableType(_Bag_LambdaType);
		private final @NonNull NullableType _Nullable_Bag_LoopExp = createNullableType(_Bag_LoopExp);
		private final @NonNull NullableType _Nullable_Bag_MapType = createNullableType(_Bag_MapType);
		private final @NonNull NullableType _Nullable_Bag_MessageType = createNullableType(_Bag_MessageType);
		private final @NonNull NullableType _Nullable_Bag_NavigationCallExp = createNullableType(_Bag_NavigationCallExp);
		private final @NonNull NullableType _Nullable_Bag_NullableType = createNullableType(_Bag_NullableType);
		private final @NonNull NullableType _Nullable_Bag_OCLExpression = createNullableType(_Bag_OCLExpression);
		private final @NonNull NullableType _Nullable_Bag_OperationCallExp = createNullableType(_Bag_OperationCallExp);
		private final @NonNull NullableType _Nullable_Bag_Operation = createNullableType(_Bag_Operation);
		private final @NonNull NullableType _Nullable_Bag_OppositePropertyCallExp = createNullableType(_Bag_OppositePropertyCallExp);
		private final @NonNull NullableType _Nullable_Bag_Package = createNullableType(_Bag_Package);
		private final @NonNull NullableType _Nullable_Bag_PrimitiveType = createNullableType(_Bag_PrimitiveType);
		private final @NonNull NullableType _Nullable_Bag_PropertyCallExp = createNullableType(_Bag_PropertyCallExp);
		private final @NonNull NullableType _Nullable_Bag_Property = createNullableType(_Bag_Property);
		private final @NonNull NullableType _Nullable_Bag_Region = createNullableType(_Bag_Region);
		private final @NonNull NullableType _Nullable_Bag_SendSignalAction = createNullableType(_Bag_SendSignalAction);
		private final @NonNull NullableType _Nullable_Bag_ShadowPart = createNullableType(_Bag_ShadowPart);
		private final @NonNull NullableType _Nullable_Bag_Slot = createNullableType(_Bag_Slot);
		private final @NonNull NullableType _Nullable_Bag_StateExp = createNullableType(_Bag_StateExp);
		private final @NonNull NullableType _Nullable_Bag_StateMachine = createNullableType(_Bag_StateMachine);
		private final @NonNull NullableType _Nullable_Bag_State = createNullableType(_Bag_State);
		private final @NonNull NullableType _Nullable_Bag_TemplateBinding = createNullableType(_Bag_TemplateBinding);
		private final @NonNull NullableType _Nullable_Bag_TemplateParameterSubstitution = createNullableType(_Bag_TemplateParameterSubstitution);
		private final @NonNull NullableType _Nullable_Bag_TemplateParameter = createNullableType(_Bag_TemplateParameter);
		private final @NonNull NullableType _Nullable_Bag_TemplateableElement = createNullableType(_Bag_TemplateableElement);
		private final @NonNull NullableType _Nullable_Bag_TypeExp = createNullableType(_Bag_TypeExp);
		private final @NonNull NullableType _Nullable_Bag_TypedElement = createNullableType(_Bag_TypedElement);
		private final @NonNull NullableType _Nullable_Bag_VariableDeclaration = createNullableType(_Bag_VariableDeclaration);
		private final @NonNull NullableType _Nullable_Bag_VariableExp = createNullableType(_Bag_VariableExp);
		private final @NonNull NullableType _Nullable_Bag_Variable = createNullableType(_Bag_Variable);
		private final @NonNull NullableType _Nullable_Bag_WildcardType = createNullableType(_Bag_WildcardType);
		private final @NonNull NullableType _Nullable_Collection_String = createNullableType(_Collection_String);
		private final @NonNull NullableType _Nullable_Collection_Annotation = createNullableType(_Collection_Annotation);
		private final @NonNull NullableType _Nullable_Collection_AssociationClassCallExp = createNullableType(_Collection_AssociationClassCallExp);
		private final @NonNull NullableType _Nullable_Collection_Behavior = createNullableType(_Collection_Behavior);
		private final @NonNull NullableType _Nullable_Collection_CallOperationAction = createNullableType(_Collection_CallOperationAction);
		private final @NonNull NullableType _Nullable_Collection_Class = createNullableType(_Collection_Class);
		private final @NonNull NullableType _Nullable_Collection_CollectionLiteralPart = createNullableType(_Collection_CollectionLiteralPart);
		private final @NonNull NullableType _Nullable_Collection_CollectionType = createNullableType(_Collection_CollectionType);
		private final @NonNull NullableType _Nullable_Collection_Comment = createNullableType(_Collection_Comment);
		private final @NonNull NullableType _Nullable_Collection_CompleteClass = createNullableType(_Collection_CompleteClass);
		private final @NonNull NullableType _Nullable_Collection_CompleteModel = createNullableType(_Collection_CompleteModel);
		private final @NonNull NullableType _Nullable_Collection_CompletePackage = createNullableType(_Collection_CompletePackage);
		private final @NonNull NullableType _Nullable_Collection_ConnectionPointReference = createNullableType(_Collection_ConnectionPointReference);
		private final @NonNull NullableType _Nullable_Collection_Constraint = createNullableType(_Collection_Constraint);
		private final @NonNull NullableType _Nullable_Collection_DataType = createNullableType(_Collection_DataType);
		private final @NonNull NullableType _Nullable_Collection_Detail = createNullableType(_Collection_Detail);
		private final @NonNull NullableType _Nullable_Collection_DynamicElement = createNullableType(_Collection_DynamicElement);
		private final @NonNull NullableType _Nullable_Collection_DynamicProperty = createNullableType(_Collection_DynamicProperty);
		private final @NonNull NullableType _Nullable_Collection_ElementExtension = createNullableType(_Collection_ElementExtension);
		private final @NonNull NullableType _Nullable_Collection_Element = createNullableType(_Collection_Element);
		private final @NonNull NullableType _Nullable_Collection_EnumLiteralExp = createNullableType(_Collection_EnumLiteralExp);
		...
		private final @NonNull NullableType _Nullable_Collection_Import = createNullableType(_Collection_Import);
		private final @NonNull NullableType _Nullable_Collection_InstanceSpecification = createNullableType(_Collection_InstanceSpecification);
		private final @NonNull NullableType _Nullable_Collection_InvalidableType = createNullableType(_Collection_InvalidableType);
		private final @NonNull NullableType _Nullable_Collection_LambdaType = createNullableType(_Collection_LambdaType);
		private final @NonNull NullableType _Nullable_Collection_LoopExp = createNullableType(_Collection_LoopExp);
		private final @NonNull NullableType _Nullable_Collection_MapLiteralPart = createNullableType(_Collection_MapLiteralPart);
		private final @NonNull NullableType _Nullable_Collection_MapType = createNullableType(_Collection_MapType);
		private final @NonNull NullableType _Nullable_Collection_MessageType = createNullableType(_Collection_MessageType);
		private final @NonNull NullableType _Nullable_Collection_Model = createNullableType(_Collection_Model);
		private final @NonNull NullableType _Nullable_Collection_NavigationCallExp = createNullableType(_Collection_NavigationCallExp);
		private final @NonNull NullableType _Nullable_Collection_NullableType = createNullableType(_Collection_NullableType);
		private final @NonNull NullableType _Nullable_Collection_OCLExpression = createNullableType(_Collection_OCLExpression);
		private final @NonNull NullableType _Nullable_Collection_OperationCallExp = createNullableType(_Collection_OperationCallExp);
		private final @NonNull NullableType _Nullable_Collection_Operation = createNullableType(_Collection_Operation);
		private final @NonNull NullableType _Nullable_Collection_OppositePropertyCallExp = createNullableType(_Collection_OppositePropertyCallExp);
		private final @NonNull NullableType _Nullable_Collection_Package = createNullableType(_Collection_Package);
		private final @NonNull NullableType _Nullable_Collection_Parameter = createNullableType(_Collection_Parameter);
		private final @NonNull NullableType _Nullable_Collection_Precedence = createNullableType(_Collection_Precedence);
		private final @NonNull NullableType _Nullable_Collection_PrimitiveType = createNullableType(_Collection_PrimitiveType);
		private final @NonNull NullableType _Nullable_Collection_ProfileApplication = createNullableType(_Collection_ProfileApplication);
		private final @NonNull NullableType _Nullable_Collection_PropertyCallExp = createNullableType(_Collection_PropertyCallExp);
		private final @NonNull NullableType _Nullable_Collection_Property = createNullableType(_Collection_Property);
		private final @NonNull NullableType _Nullable_Collection_Pseudostate = createNullableType(_Collection_Pseudostate);
		private final @NonNull NullableType _Nullable_Collection_Region = createNullableType(_Collection_Region);
		private final @NonNull NullableType _Nullable_Collection_SendSignalAction = createNullableType(_Collection_SendSignalAction);
		private final @NonNull NullableType _Nullable_Collection_ShadowPart = createNullableType(_Collection_ShadowPart);
		private final @NonNull NullableType _Nullable_Collection_Slot = createNullableType(_Collection_Slot);
		private final @NonNull NullableType _Nullable_Collection_StateExp = createNullableType(_Collection_StateExp);
		private final @NonNull NullableType _Nullable_Collection_StateMachine = createNullableType(_Collection_StateMachine);
		private final @NonNull NullableType _Nullable_Collection_State = createNullableType(_Collection_State);
		private final @NonNull NullableType _Nullable_Collection_StereotypeExtender = createNullableType(_Collection_StereotypeExtender);
		private final @NonNull NullableType _Nullable_Collection_TemplateBinding = createNullableType(_Collection_TemplateBinding);
		private final @NonNull NullableType _Nullable_Collection_TemplateParameterSubstitution = createNullableType(_Collection_TemplateParameterSubstitution);
		private final @NonNull NullableType _Nullable_Collection_TemplateParameter = createNullableType(_Collection_TemplateParameter);
		private final @NonNull NullableType _Nullable_Collection_TemplateableElement = createNullableType(_Collection_TemplateableElement);
		private final @NonNull NullableType _Nullable_Collection_Transition = createNullableType(_Collection_Transition);
		private final @NonNull NullableType _Nullable_Collection_Trigger = createNullableType(_Collection_Trigger);
		private final @NonNull NullableType _Nullable_Collection_TupleLiteralPart = createNullableType(_Collection_TupleLiteralPart);
		private final @NonNull NullableType _Nullable_Collection_TypeExp = createNullableType(_Collection_TypeExp);
		private final @NonNull NullableType _Nullable_Collection_Type = createNullableType(_Collection_Type);
		private final @NonNull NullableType _Nullable_Collection_TypedElement = createNullableType(_Collection_TypedElement);
		private final @NonNull NullableType _Nullable_Collection_ValueSpecification = createNullableType(_Collection_ValueSpecification);
		private final @NonNull NullableType _Nullable_Collection_VariableDeclaration = createNullableType(_Collection_VariableDeclaration);
		private final @NonNull NullableType _Nullable_Collection_VariableExp = createNullableType(_Collection_VariableExp);
		private final @NonNull NullableType _Nullable_Collection_Variable = createNullableType(_Collection_Variable);
		private final @NonNull NullableType _Nullable_Collection_Vertex = createNullableType(_Collection_Vertex);
		private final @NonNull NullableType _Nullable_Collection_WildcardType = createNullableType(_Collection_WildcardType);
		private final @NonNull NullableType _Nullable_OrderedCollection_CollectionLiteralPart = createNullableType(_OrderedCollection_CollectionLiteralPart);
		private final @NonNull NullableType _Nullable_OrderedCollection_Detail = createNullableType(_OrderedCollection_Detail);
		private final @NonNull NullableType _Nullable_OrderedCollection_Element = createNullableType(_OrderedCollection_Element);
		...
		private final @NonNull NullableType _Nullable_OrderedCollection_Import = createNullableType(_OrderedCollection_Import);
		private final @NonNull NullableType _Nullable_OrderedCollection_MapLiteralPart = createNullableType(_OrderedCollection_MapLiteralPart);
		private final @NonNull NullableType _Nullable_OrderedCollection_OCLExpression = createNullableType(_OrderedCollection_OCLExpression);
		private final @NonNull NullableType _Nullable_OrderedCollection_Operation = createNullableType(_OrderedCollection_Operation);
		private final @NonNull NullableType _Nullable_OrderedCollection_Parameter = createNullableType(_OrderedCollection_Parameter);
		private final @NonNull NullableType _Nullable_OrderedCollection_Precedence = createNullableType(_OrderedCollection_Precedence);
		private final @NonNull NullableType _Nullable_OrderedCollection_Property = createNullableType(_OrderedCollection_Property);
		private final @NonNull NullableType _Nullable_OrderedCollection_ShadowPart = createNullableType(_OrderedCollection_ShadowPart);
		private final @NonNull NullableType _Nullable_OrderedCollection_TemplateParameter = createNullableType(_OrderedCollection_TemplateParameter);
		private final @NonNull NullableType _Nullable_OrderedCollection_TupleLiteralPart = createNullableType(_OrderedCollection_TupleLiteralPart);
		private final @NonNull NullableType _Nullable_OrderedCollection_Type = createNullableType(_OrderedCollection_Type);
		private final @NonNull NullableType _Nullable_OrderedCollection_ValueSpecification = createNullableType(_OrderedCollection_ValueSpecification);
		private final @NonNull NullableType _Nullable_OrderedCollection_Variable = createNullableType(_OrderedCollection_Variable);
		private final @NonNull NullableType _Nullable_OrderedSet_CollectionLiteralPart_NullFree = createNullableType(_OrderedSet_CollectionLiteralPart_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Detail_NullFree = createNullableType(_OrderedSet_Detail_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Element_NullFree = createNullableType(_OrderedSet_Element_NullFree);
		...
		private final @NonNull NullableType _Nullable_OrderedSet_Import_NullFree = createNullableType(_OrderedSet_Import_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_MapLiteralPart_NullFree = createNullableType(_OrderedSet_MapLiteralPart_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_OCLExpression_NullFree = createNullableType(_OrderedSet_OCLExpression_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Operation_NullFree = createNullableType(_OrderedSet_Operation_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Parameter_NullFree = createNullableType(_OrderedSet_Parameter_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Precedence_NullFree = createNullableType(_OrderedSet_Precedence_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Property_NullFree = createNullableType(_OrderedSet_Property_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_ShadowPart_NullFree = createNullableType(_OrderedSet_ShadowPart_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_TemplateParameter_NullFree = createNullableType(_OrderedSet_TemplateParameter_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_TupleLiteralPart_NullFree = createNullableType(_OrderedSet_TupleLiteralPart_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_ValueSpecification_NullFree = createNullableType(_OrderedSet_ValueSpecification_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Variable_NullFree = createNullableType(_OrderedSet_Variable_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_Type_NullFree = createNullableType(_Sequence_Type_NullFree);
		private final @NonNull NullableType _Nullable_Set_String_NullFree = createNullableType(_Set_String_NullFree);
		private final @NonNull NullableType _Nullable_Set_Behavior_NullFree = createNullableType(_Set_Behavior_NullFree);
		private final @NonNull NullableType _Nullable_Set_Class_NullFree = createNullableType(_Set_Class_NullFree);
		private final @NonNull NullableType _Nullable_Set_Comment_NullFree = createNullableType(_Set_Comment_NullFree);
		private final @NonNull NullableType _Nullable_Set_CompleteClass_NullFree = createNullableType(_Set_CompleteClass_NullFree);
		private final @NonNull NullableType _Nullable_Set_CompletePackage_NullFree = createNullableType(_Set_CompletePackage_NullFree);
		private final @NonNull NullableType _Nullable_Set_ConnectionPointReference_NullFree = createNullableType(_Set_ConnectionPointReference_NullFree);
		private final @NonNull NullableType _Nullable_Set_Constraint_NullFree = createNullableType(_Set_Constraint_NullFree);
		private final @NonNull NullableType _Nullable_Set_DynamicProperty_NullFree = createNullableType(_Set_DynamicProperty_NullFree);
		private final @NonNull NullableType _Nullable_Set_ElementExtension_NullFree = createNullableType(_Set_ElementExtension_NullFree);
		private final @NonNull NullableType _Nullable_Set_Element_NullFree = createNullableType(_Set_Element_NullFree);
		private final @NonNull NullableType _Nullable_Set_InstanceSpecification_NullFree = createNullableType(_Set_InstanceSpecification_NullFree);
		private final @NonNull NullableType _Nullable_Set_Model_NullFree = createNullableType(_Set_Model_NullFree);
		private final @NonNull NullableType _Nullable_Set_Operation_NullFree = createNullableType(_Set_Operation_NullFree);
		private final @NonNull NullableType _Nullable_Set_Package_NullFree = createNullableType(_Set_Package_NullFree);
		private final @NonNull NullableType _Nullable_Set_ProfileApplication_NullFree = createNullableType(_Set_ProfileApplication_NullFree);
		private final @NonNull NullableType _Nullable_Set_Property_NullFree = createNullableType(_Set_Property_NullFree);
		private final @NonNull NullableType _Nullable_Set_Pseudostate_NullFree = createNullableType(_Set_Pseudostate_NullFree);
		private final @NonNull NullableType _Nullable_Set_Region_NullFree = createNullableType(_Set_Region_NullFree);
		private final @NonNull NullableType _Nullable_Set_Region_NullFree_1 = createNullableType(_Set_Region_NullFree_1);
		private final @NonNull NullableType _Nullable_Set_Slot_NullFree = createNullableType(_Set_Slot_NullFree);
		private final @NonNull NullableType _Nullable_Set_StateMachine_NullFree = createNullableType(_Set_StateMachine_NullFree);
		private final @NonNull NullableType _Nullable_Set_State_NullFree = createNullableType(_Set_State_NullFree);
		private final @NonNull NullableType _Nullable_Set_StereotypeExtender_NullFree = createNullableType(_Set_StereotypeExtender_NullFree);
		private final @NonNull NullableType _Nullable_Set_TemplateBinding_NullFree = createNullableType(_Set_TemplateBinding_NullFree);
		private final @NonNull NullableType _Nullable_Set_TemplateParameterSubstitution_NullFree = createNullableType(_Set_TemplateParameterSubstitution_NullFree);
		private final @NonNull NullableType _Nullable_Set_Transition_NullFree = createNullableType(_Set_Transition_NullFree);
		private final @NonNull NullableType _Nullable_Set_Trigger_NullFree = createNullableType(_Set_Trigger_NullFree);
		private final @NonNull NullableType _Nullable_Set_Type_NullFree = createNullableType(_Set_Type_NullFree);
		private final @NonNull NullableType _Nullable_Set_Vertex_NullFree = createNullableType(_Set_Vertex_NullFree);
		private final @NonNull NullableType _Nullable_UniqueCollection_String = createNullableType(_UniqueCollection_String);
		private final @NonNull NullableType _Nullable_UniqueCollection_Behavior = createNullableType(_UniqueCollection_Behavior);
		private final @NonNull NullableType _Nullable_UniqueCollection_Class = createNullableType(_UniqueCollection_Class);
		private final @NonNull NullableType _Nullable_UniqueCollection_CollectionLiteralPart = createNullableType(_UniqueCollection_CollectionLiteralPart);
		private final @NonNull NullableType _Nullable_UniqueCollection_Comment = createNullableType(_UniqueCollection_Comment);
		private final @NonNull NullableType _Nullable_UniqueCollection_CompleteClass = createNullableType(_UniqueCollection_CompleteClass);
		private final @NonNull NullableType _Nullable_UniqueCollection_CompletePackage = createNullableType(_UniqueCollection_CompletePackage);
		private final @NonNull NullableType _Nullable_UniqueCollection_ConnectionPointReference = createNullableType(_UniqueCollection_ConnectionPointReference);
		private final @NonNull NullableType _Nullable_UniqueCollection_Constraint = createNullableType(_UniqueCollection_Constraint);
		private final @NonNull NullableType _Nullable_UniqueCollection_Detail = createNullableType(_UniqueCollection_Detail);
		private final @NonNull NullableType _Nullable_UniqueCollection_DynamicProperty = createNullableType(_UniqueCollection_DynamicProperty);
		private final @NonNull NullableType _Nullable_UniqueCollection_ElementExtension = createNullableType(_UniqueCollection_ElementExtension);
		private final @NonNull NullableType _Nullable_UniqueCollection_Element = createNullableType(_UniqueCollection_Element);
		...
		private final @NonNull NullableType _Nullable_UniqueCollection_Import = createNullableType(_UniqueCollection_Import);
		private final @NonNull NullableType _Nullable_UniqueCollection_InstanceSpecification = createNullableType(_UniqueCollection_InstanceSpecification);
		private final @NonNull NullableType _Nullable_UniqueCollection_MapLiteralPart = createNullableType(_UniqueCollection_MapLiteralPart);
		private final @NonNull NullableType _Nullable_UniqueCollection_Model = createNullableType(_UniqueCollection_Model);
		private final @NonNull NullableType _Nullable_UniqueCollection_OCLExpression = createNullableType(_UniqueCollection_OCLExpression);
		private final @NonNull NullableType _Nullable_UniqueCollection_Operation = createNullableType(_UniqueCollection_Operation);
		private final @NonNull NullableType _Nullable_UniqueCollection_Package = createNullableType(_UniqueCollection_Package);
		private final @NonNull NullableType _Nullable_UniqueCollection_Parameter = createNullableType(_UniqueCollection_Parameter);
		private final @NonNull NullableType _Nullable_UniqueCollection_Precedence = createNullableType(_UniqueCollection_Precedence);
		private final @NonNull NullableType _Nullable_UniqueCollection_ProfileApplication = createNullableType(_UniqueCollection_ProfileApplication);
		private final @NonNull NullableType _Nullable_UniqueCollection_Property = createNullableType(_UniqueCollection_Property);
		private final @NonNull NullableType _Nullable_UniqueCollection_Pseudostate = createNullableType(_UniqueCollection_Pseudostate);
		private final @NonNull NullableType _Nullable_UniqueCollection_Region = createNullableType(_UniqueCollection_Region);
		private final @NonNull NullableType _Nullable_UniqueCollection_ShadowPart = createNullableType(_UniqueCollection_ShadowPart);
		private final @NonNull NullableType _Nullable_UniqueCollection_Slot = createNullableType(_UniqueCollection_Slot);
		private final @NonNull NullableType _Nullable_UniqueCollection_StateMachine = createNullableType(_UniqueCollection_StateMachine);
		private final @NonNull NullableType _Nullable_UniqueCollection_State = createNullableType(_UniqueCollection_State);
		private final @NonNull NullableType _Nullable_UniqueCollection_StereotypeExtender = createNullableType(_UniqueCollection_StereotypeExtender);
		private final @NonNull NullableType _Nullable_UniqueCollection_TemplateBinding = createNullableType(_UniqueCollection_TemplateBinding);
		private final @NonNull NullableType _Nullable_UniqueCollection_TemplateParameterSubstitution = createNullableType(_UniqueCollection_TemplateParameterSubstitution);
		private final @NonNull NullableType _Nullable_UniqueCollection_TemplateParameter = createNullableType(_UniqueCollection_TemplateParameter);
		private final @NonNull NullableType _Nullable_UniqueCollection_Transition = createNullableType(_UniqueCollection_Transition);
		private final @NonNull NullableType _Nullable_UniqueCollection_Trigger = createNullableType(_UniqueCollection_Trigger);
		private final @NonNull NullableType _Nullable_UniqueCollection_TupleLiteralPart = createNullableType(_UniqueCollection_TupleLiteralPart);
		private final @NonNull NullableType _Nullable_UniqueCollection_Type = createNullableType(_UniqueCollection_Type);
		private final @NonNull NullableType _Nullable_UniqueCollection_ValueSpecification = createNullableType(_UniqueCollection_ValueSpecification);
		private final @NonNull NullableType _Nullable_UniqueCollection_Variable = createNullableType(_UniqueCollection_Variable);
		private final @NonNull NullableType _Nullable_UniqueCollection_Vertex = createNullableType(_UniqueCollection_Vertex);
		private final @NonNull NullableType _Nullable_Annotation = createNullableType(_Annotation);
		private final @NonNull NullableType _Nullable_AnyType = createNullableType(_AnyType);
		private final @NonNull NullableType _Nullable_AssociationClass = createNullableType(_AssociationClass);
		private final @NonNull NullableType _Nullable_AssociationClassCallExp = createNullableType(_AssociationClassCallExp);
		private final @NonNull NullableType _Nullable_AssociativityKind = createNullableType(_AssociativityKind);
		private final @NonNull NullableType _Nullable_BagType = createNullableType(_BagType);
		private final @NonNull NullableType _Nullable_Behavior = createNullableType(_Behavior);
		private final @NonNull NullableType _Nullable_BooleanLiteralExp = createNullableType(_BooleanLiteralExp);
		private final @NonNull NullableType _Nullable_CallExp = createNullableType(_CallExp);
		private final @NonNull NullableType _Nullable_CallOperationAction = createNullableType(_CallOperationAction);
		private final @NonNull NullableType _Nullable_Class = createNullableType(_Class);
		private final @NonNull NullableType _Nullable_CollectionItem = createNullableType(_CollectionItem);
		private final @NonNull NullableType _Nullable_CollectionKind = createNullableType(_CollectionKind);
		private final @NonNull NullableType _Nullable_CollectionLiteralExp = createNullableType(_CollectionLiteralExp);
		private final @NonNull NullableType _Nullable_CollectionLiteralPart = createNullableType(_CollectionLiteralPart);
		private final @NonNull NullableType _Nullable_CollectionRange = createNullableType(_CollectionRange);
		private final @NonNull NullableType _Nullable_CollectionType = createNullableType(_CollectionType);
		private final @NonNull NullableType _Nullable_Comment = createNullableType(_Comment);
		private final @NonNull NullableType _Nullable_CompleteClass = createNullableType(_CompleteClass);
		private final @NonNull NullableType _Nullable_CompleteEnvironment = createNullableType(_CompleteEnvironment);
		private final @NonNull NullableType _Nullable_CompleteModel = createNullableType(_CompleteModel);
		private final @NonNull NullableType _Nullable_CompletePackage = createNullableType(_CompletePackage);
		private final @NonNull NullableType _Nullable_ConnectionPointReference = createNullableType(_ConnectionPointReference);
		private final @NonNull NullableType _Nullable_Constraint = createNullableType(_Constraint);
		private final @NonNull NullableType _Nullable_DataType = createNullableType(_DataType);
		private final @NonNull NullableType _Nullable_Detail = createNullableType(_Detail);
		private final @NonNull NullableType _Nullable_DynamicBehavior = createNullableType(_DynamicBehavior);
		private final @NonNull NullableType _Nullable_DynamicElement = createNullableType(_DynamicElement);
		private final @NonNull NullableType _Nullable_DynamicProperty = createNullableType(_DynamicProperty);
		private final @NonNull NullableType _Nullable_DynamicType = createNullableType(_DynamicType);
		private final @NonNull NullableType _Nullable_DynamicValueSpecification = createNullableType(_DynamicValueSpecification);
		private final @NonNull NullableType _Nullable_Element = createNullableType(_Element);
		private final @NonNull NullableType _Nullable_ElementExtension = createNullableType(_ElementExtension);
		private final @NonNull NullableType _Nullable_EnumLiteralExp = createNullableType(_EnumLiteralExp);
		...
		private final @NonNull NullableType _Nullable_ExpressionInOCL = createNullableType(_ExpressionInOCL);
		private final @NonNull NullableType _Nullable_Feature = createNullableType(_Feature);
		private final @NonNull NullableType _Nullable_FeatureCallExp = createNullableType(_FeatureCallExp);
		private final @NonNull NullableType _Nullable_FinalState = createNullableType(_FinalState);
		private final @NonNull NullableType _Nullable_IfExp = createNullableType(_IfExp);
		private final @NonNull NullableType _Nullable_Import = createNullableType(_Import);
		private final @NonNull NullableType _Nullable_InstanceSpecification = createNullableType(_InstanceSpecification);
		private final @NonNull NullableType _Nullable_IntegerLiteralExp = createNullableType(_IntegerLiteralExp);
		private final @NonNull NullableType _Nullable_InvalidLiteralExp = createNullableType(_InvalidLiteralExp);
		private final @NonNull NullableType _Nullable_InvalidType = createNullableType(_InvalidType);
		private final @NonNull NullableType _Nullable_InvalidableType = createNullableType(_InvalidableType);
		private final @NonNull NullableType _Nullable_IterateExp = createNullableType(_IterateExp);
		private final @NonNull NullableType _Nullable_Iteration = createNullableType(_Iteration);
		private final @NonNull NullableType _Nullable_IteratorExp = createNullableType(_IteratorExp);
		private final @NonNull NullableType _Nullable_IteratorVariable = createNullableType(_IteratorVariable);
		private final @NonNull NullableType _Nullable_LambdaType = createNullableType(_LambdaType);
		private final @NonNull NullableType _Nullable_LanguageExpression = createNullableType(_LanguageExpression);
		private final @NonNull NullableType _Nullable_LetExp = createNullableType(_LetExp);
		private final @NonNull NullableType _Nullable_LetVariable = createNullableType(_LetVariable);
		private final @NonNull NullableType _Nullable_Library = createNullableType(_Library);
		private final @NonNull NullableType _Nullable_LibraryFeature = createNullableType(_LibraryFeature);
		private final @NonNull NullableType _Nullable_LiteralExp = createNullableType(_LiteralExp);
		private final @NonNull NullableType _Nullable_LoopExp = createNullableType(_LoopExp);
		private final @NonNull NullableType _Nullable_MapLiteralExp = createNullableType(_MapLiteralExp);
		private final @NonNull NullableType _Nullable_MapLiteralPart = createNullableType(_MapLiteralPart);
		private final @NonNull NullableType _Nullable_MapType = createNullableType(_MapType);
		private final @NonNull NullableType _Nullable_MessageExp = createNullableType(_MessageExp);
		private final @NonNull NullableType _Nullable_MessageType = createNullableType(_MessageType);
		private final @NonNull NullableType _Nullable_Model = createNullableType(_Model);
		private final @NonNull NullableType _Nullable_MorePivotable = createNullableType(_MorePivotable);
		private final @NonNull NullableType _Nullable_Nameable = createNullableType(_Nameable);
		private final @NonNull NullableType _Nullable_NamedElement = createNullableType(_NamedElement);
		private final @NonNull NullableType _Nullable_Namespace = createNullableType(_Namespace);
		private final @NonNull NullableType _Nullable_NavigationCallExp = createNullableType(_NavigationCallExp);
		private final @NonNull NullableType _Nullable_NullLiteralExp = createNullableType(_NullLiteralExp);
		private final @NonNull NullableType _Nullable_NullableType = createNullableType(_NullableType);
		private final @NonNull NullableType _Nullable_NumericLiteralExp = createNullableType(_NumericLiteralExp);
		private final @NonNull NullableType _Nullable_OCLExpression = createNullableType(_OCLExpression);
		private final @NonNull NullableType _Nullable_Object = createNullableType(_Object);
		private final @NonNull NullableType _Nullable_Operation = createNullableType(_Operation);
		private final @NonNull NullableType _Nullable_OperationCallExp = createNullableType(_OperationCallExp);
		private final @NonNull NullableType _Nullable_OppositePropertyCallExp = createNullableType(_OppositePropertyCallExp);
		private final @NonNull NullableType _Nullable_OrderedSetType = createNullableType(_OrderedSetType);
		private final @NonNull NullableType _Nullable_OrphanCompletePackage = createNullableType(_OrphanCompletePackage);
		private final @NonNull NullableType _Nullable_Package = createNullableType(_Package);
		private final @NonNull NullableType _Nullable_Parameter = createNullableType(_Parameter);
		private final @NonNull NullableType _Nullable_ParameterVariable = createNullableType(_ParameterVariable);
		private final @NonNull NullableType _Nullable_Pivotable = createNullableType(_Pivotable);
		private final @NonNull NullableType _Nullable_Precedence = createNullableType(_Precedence);
		private final @NonNull NullableType _Nullable_PrimitiveCompletePackage = createNullableType(_PrimitiveCompletePackage);
		private final @NonNull NullableType _Nullable_PrimitiveLiteralExp = createNullableType(_PrimitiveLiteralExp);
		private final @NonNull NullableType _Nullable_PrimitiveType = createNullableType(_PrimitiveType);
		private final @NonNull NullableType _Nullable_Profile = createNullableType(_Profile);
		private final @NonNull NullableType _Nullable_ProfileApplication = createNullableType(_ProfileApplication);
		private final @NonNull NullableType _Nullable_Property = createNullableType(_Property);
		private final @NonNull NullableType _Nullable_PropertyCallExp = createNullableType(_PropertyCallExp);
		private final @NonNull NullableType _Nullable_Pseudostate = createNullableType(_Pseudostate);
		private final @NonNull NullableType _Nullable_PseudostateKind = createNullableType(_PseudostateKind);
		private final @NonNull NullableType _Nullable_RealLiteralExp = createNullableType(_RealLiteralExp);
		private final @NonNull NullableType _Nullable_ReferringElement = createNullableType(_ReferringElement);
		private final @NonNull NullableType _Nullable_Region = createNullableType(_Region);
		private final @NonNull NullableType _Nullable_ResultVariable = createNullableType(_ResultVariable);
		private final @NonNull NullableType _Nullable_SelfType = createNullableType(_SelfType);
		private final @NonNull NullableType _Nullable_SendSignalAction = createNullableType(_SendSignalAction);
		private final @NonNull NullableType _Nullable_SequenceType = createNullableType(_SequenceType);
		private final @NonNull NullableType _Nullable_SetType = createNullableType(_SetType);
		private final @NonNull NullableType _Nullable_ShadowExp = createNullableType(_ShadowExp);
		private final @NonNull NullableType _Nullable_ShadowPart = createNullableType(_ShadowPart);
		private final @NonNull NullableType _Nullable_Signal = createNullableType(_Signal);
		private final @NonNull NullableType _Nullable_Slot = createNullableType(_Slot);
		private final @NonNull NullableType _Nullable_StandardLibrary = createNullableType(_StandardLibrary);
		private final @NonNull NullableType _Nullable_State = createNullableType(_State);
		private final @NonNull NullableType _Nullable_StateExp = createNullableType(_StateExp);
		private final @NonNull NullableType _Nullable_StateMachine = createNullableType(_StateMachine);
		private final @NonNull NullableType _Nullable_Stereotype = createNullableType(_Stereotype);
		private final @NonNull NullableType _Nullable_StereotypeExtender = createNullableType(_StereotypeExtender);
		private final @NonNull NullableType _Nullable_StringLiteralExp = createNullableType(_StringLiteralExp);
		private final @NonNull NullableType _Nullable_TemplateBinding = createNullableType(_TemplateBinding);
		private final @NonNull NullableType _Nullable_TemplateParameter = createNullableType(_TemplateParameter);
		private final @NonNull NullableType _Nullable_TemplateParameterSubstitution = createNullableType(_TemplateParameterSubstitution);
		private final @NonNull NullableType _Nullable_TemplateSignature = createNullableType(_TemplateSignature);
		private final @NonNull NullableType _Nullable_TemplateableElement = createNullableType(_TemplateableElement);
		private final @NonNull NullableType _Nullable_Throwable = createNullableType(_Throwable);
		private final @NonNull NullableType _Nullable_Transition = createNullableType(_Transition);
		private final @NonNull NullableType _Nullable_TransitionKind = createNullableType(_TransitionKind);
		private final @NonNull NullableType _Nullable_Trigger = createNullableType(_Trigger);
		private final @NonNull NullableType _Nullable_TupleLiteralExp = createNullableType(_TupleLiteralExp);
		private final @NonNull NullableType _Nullable_TupleLiteralPart = createNullableType(_TupleLiteralPart);
		private final @NonNull NullableType _Nullable_TupleType = createNullableType(_TupleType);
		private final @NonNull NullableType _Nullable_Type = createNullableType(_Type);
		private final @NonNull NullableType _Nullable_TypeExp = createNullableType(_TypeExp);
		private final @NonNull NullableType _Nullable_TypedElement = createNullableType(_TypedElement);
		private final @NonNull NullableType _Nullable_UnlimitedNaturalLiteralExp = createNullableType(_UnlimitedNaturalLiteralExp);
		private final @NonNull NullableType _Nullable_UnspecifiedValueExp = createNullableType(_UnspecifiedValueExp);
		private final @NonNull NullableType _Nullable_ValueSpecification = createNullableType(_ValueSpecification);
		private final @NonNull NullableType _Nullable_Variable = createNullableType(_Variable);
		private final @NonNull NullableType _Nullable_VariableDeclaration = createNullableType(_VariableDeclaration);
		private final @NonNull NullableType _Nullable_VariableExp = createNullableType(_VariableExp);
		private final @NonNull NullableType _Nullable_Vertex = createNullableType(_Vertex);
		private final @NonNull NullableType _Nullable_Visitable = createNullableType(_Visitable);
		private final @NonNull NullableType _Nullable_VoidType = createNullableType(_VoidType);
		private final @NonNull NullableType _Nullable_WildcardType = createNullableType(_WildcardType);
