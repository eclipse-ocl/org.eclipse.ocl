...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private final @NonNull NullableType _Nullable_Lambda_Collection_T = createNullableType(_Lambda_Collection_T_3);
		private final @NonNull NullableType _Nullable_Lambda_Sequence_T = createNullableType(_Lambda_Sequence_T_3);
		...
		private final @NonNull NullableType _Nullable_Lambda_OrderedSet_T = createNullableType(_Lambda_OrderedSet_T_2);
		private final @NonNull NullableType _Nullable_Lambda_OrderedSet_T_1 = createNullableType(_Lambda_OrderedSet_T_4);
		private final @NonNull NullableType _Nullable_Lambda_OrderedSet_T_2 = createNullableType(_Lambda_OrderedSet_T_3);
		private final @NonNull NullableType _Nullable_Lambda_Bag_T = createNullableType(_Lambda_Bag_T_4);
		private final @NonNull NullableType _Nullable_Lambda_Bag_T_1 = createNullableType(_Lambda_Bag_T_2);
		private final @NonNull NullableType _Nullable_Lambda_Bag_T_2 = createNullableType(_Lambda_Bag_T_3);
		...
		private final @NonNull NullableType _Nullable_Lambda_Sequence_T_1 = createNullableType(_Lambda_Sequence_T_2);
		private final @NonNull NullableType _Nullable_Lambda_Collection_T_3 = createNullableType(_Lambda_Collection_T);
		private final @NonNull NullableType _Nullable_Lambda_Collection_T_4 = createNullableType(_Lambda_Collection_T_4);
		private final @NonNull NullableType _Nullable_Lambda_Set_T_3 = createNullableType(_Lambda_Set_T_4);
		private final @NonNull NullableType _Nullable_Lambda_OrderedSet_T_3 = createNullableType(_Lambda_OrderedSet_T_1);
		private final @NonNull NullableType _Nullable_Lambda_Bag_T_3 = createNullableType(_Lambda_Bag_T_1);
		private final @NonNull NullableType _Nullable_Lambda_Sequence_T_2 = createNullableType(_Lambda_Sequence_T_4);
		private final @NonNull NullableType _Nullable_Lambda_Collection_T_5 = createNullableType(_Lambda_Collection_T_1);
		private final @NonNull NullableType _Nullable_Lambda_Sequence_T_3 = createNullableType(_Lambda_Sequence_T_1);
		private final @NonNull NullableType _Nullable_Lambda_UniqueCollection_T = createNullableType(_Lambda_UniqueCollection_T);
		private final @NonNull NullableType _Nullable_Map = createNullableType(_Map_Map_K_Map_V);
		private final @NonNull NullableType _Nullable_Map_1 = createNullableType(_Map_Map_includesMap_K2_Map_includesMap_V2);
		private final @NonNull NullableType _Nullable_Map_2 = createNullableType(_Map_Map_excludesMap_K2_Map_excludesMap_V2);
		private final @NonNull NullableType _Nullable_Map_3 = createNullableType(_Map_Map_includingMap_K2_Map_includingMap_V2);
		private final @NonNull NullableType _Nullable_Map_4 = createNullableType(_Map_Map_excludingMap_K2_Map_excludingMap_V2);
		...
		private final @NonNull InvalidableType _Invalidable_OrderedCollection_T = createInvalidableType(_Nullable_OrderedCollection_T);
		...
		private final @NonNull InvalidableType _Invalidable_Map_V = createInvalidableType(_Nullable_Map_V);
		...
		private final @NonNull Operation op_Map_excluding = createOperation("excluding", _Nullable_Map, "org.eclipse.ocl.pivot.library.map.MapExcludingOperation", org.eclipse.ocl.pivot.library.map.MapExcludingOperation.INSTANCE);
		private final @NonNull Operation op_Map_excluding_1 = createOperation("excluding", _Nullable_Map, "org.eclipse.ocl.pivot.library.map.MapExcludingPairOperation", org.eclipse.ocl.pivot.library.map.MapExcludingPairOperation.INSTANCE);
		private final @NonNull Operation op_Map_excludingAll = createOperation("excludingAll", _Nullable_Map, "org.eclipse.ocl.pivot.library.map.MapExcludingAllOperation", org.eclipse.ocl.pivot.library.map.MapExcludingAllOperation.INSTANCE);
		private final @NonNull Operation op_Map_excludingMap = createOperation("excludingMap", _Nullable_Map, "org.eclipse.ocl.pivot.library.map.MapExcludingMapOperation", org.eclipse.ocl.pivot.library.map.MapExcludingMapOperation.INSTANCE, tp_Map_excludingMap_K2, tp_Map_excludingMap_V2);
		...
		private final @NonNull Operation op_Map_including = createOperation("including", _Nullable_Map, "org.eclipse.ocl.pivot.library.map.MapIncludingPairOperation", org.eclipse.ocl.pivot.library.map.MapIncludingPairOperation.INSTANCE);
		private final @NonNull Operation op_Map_includingMap = createOperation("includingMap", _Nullable_Map, "org.eclipse.ocl.pivot.library.map.MapIncludingMapOperation", org.eclipse.ocl.pivot.library.map.MapIncludingMapOperation.INSTANCE, tp_Map_includingMap_K2, tp_Map_includingMap_V2);
		...
		private void installOperations() {
			...
			operation.setIsRequired(false);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("map", _Nullable_Map_4, false));
			...
			operation.setIsInvalidating(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_OclElement_oclAsModelType_TT_1, false));
			parameter.setIsTypeof(true);
		...
		private void installIterations() {
			...
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Collection_T, false));
