...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private void installAggregateTypes2() {
			...
			type = _Bag_Bag_T = (BagType)createCollectionType(ocl, OCLstdlibPackage.Literals.BAG, tp_Bag_T, false, 0, -1);
		...
		private void installAggregateTypes4() {
			...
			type = _OrderedSet_OrderedSet_T = (OrderedSetType)createCollectionType(ocl, OCLstdlibPackage.Literals.ORDERED_SET, tp_OrderedSet_T, false, 0, -1);
			...
			type = _Sequence_Sequence_T = (SequenceType)createCollectionType(ocl, OCLstdlibPackage.Literals.SEQUENCE, tp_Sequence_T, false, 0, -1);
			...
			type = _Set_Set_T = (SetType)createCollectionType(ocl, OCLstdlibPackage.Literals.SET, tp_Set_T, false, 0, -1);
