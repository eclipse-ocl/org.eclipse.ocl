...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractLibraryContents
	{
		...
		private final @NonNull LambdaType _Lambda_self_$$1_T_i_$$0_F_result_$$1_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$1_T_i_$$0_F_result_$$2_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$1_T_i_$$0_F_result_Boolean_T = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_result_$$1_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_result_$$2_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_result_Boolean_T = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_k_$$0_F_result_$$1_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_k_$$0_F_result_$$2_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_k_$$0_F_result_Boolean_T = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$2_T_i_$$0_F_result_$$2_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$2_T_i_$$0_F_result_$$3_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$2_T_i_$$0_F_result_Boolean_T = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_result_$$2_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_result_$$3_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_result_Boolean_T = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_k_$$0_F_result_$$2_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_k_$$0_F_result_$$3_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_k_$$0_F_result_Boolean_T = createLambdaType("Lambda");
		...
		private void installLambdaTypes() {
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$1_T_i_$$0_F_result_$$1_F);
			type.setOwnedContext(createLambdaParameter("self", $$1, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", $$1, false));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$1_T_i_$$0_F_result_$$2_F);
			type.setOwnedContext(createLambdaParameter("self", $$1, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", $$2, false));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$1_T_i_$$0_F_result_Boolean_T);
			type.setOwnedContext(createLambdaParameter("self", $$1, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", _Boolean, true));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_result_$$1_F);
			type.setOwnedContext(createLambdaParameter("self", $$1, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_result_$$2_F);
			type.setOwnedContext(createLambdaParameter("self", $$1, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", $$2, false));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_result_Boolean_T);
			type.setOwnedContext(createLambdaParameter("self", $$1, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", _Boolean, true));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_k_$$0_F_result_$$1_F);
			type.setOwnedContext(createLambdaParameter("self", $$1, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_k_$$0_F_result_$$2_F);
			type.setOwnedContext(createLambdaParameter("self", $$1, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("k", $$0, false));
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_k_$$0_F_result_Boolean_T);
			type.setOwnedContext(createLambdaParameter("self", $$1, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("k", $$0, false));
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$2_T_i_$$0_F_result_$$2_F);
			type.setOwnedContext(createLambdaParameter("self", $$2, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", $$2, false));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$2_T_i_$$0_F_result_$$3_F);
			type.setOwnedContext(createLambdaParameter("self", $$2, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", $$3, false));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$2_T_i_$$0_F_result_Boolean_T);
			type.setOwnedContext(createLambdaParameter("self", $$2, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", _Boolean, true));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_result_$$2_F);
			type.setOwnedContext(createLambdaParameter("self", $$2, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", $$2, false));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_result_$$3_F);
			type.setOwnedContext(createLambdaParameter("self", $$2, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", $$3, false));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_result_Boolean_T);
			type.setOwnedContext(createLambdaParameter("self", $$2, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", _Boolean, true));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_k_$$0_F_result_$$2_F);
			type.setOwnedContext(createLambdaParameter("self", $$2, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("k", $$0, false));
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_k_$$0_F_result_$$3_F);
			type.setOwnedContext(createLambdaParameter("self", $$2, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("k", $$0, false));
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_k_$$0_F_result_Boolean_T);
			type.setOwnedContext(createLambdaParameter("self", $$2, true));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("k", $$0, false));
		...
		private final @NonNull Iteration it_Collection_gather = createIteration("gather", _Bag_$$1_T, "org.eclipse.ocl.pivot.library.iterator.GatherIteration", org.eclipse.ocl.pivot.library.iterator.GatherIteration.INSTANCE, tp_Collection_gather_V);
		...
		private void installIterations() {
			...
			iteration.setOwnedAccumulator(parameter = createParameter("acc", $$1, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_k_$$0_F_result_$$1_F, true));
			ownedParameters.add(parameter = createParameter("break", _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_k_$$0_F_result_Boolean_T, true));
			ownedParameters.add(parameter = createParameter("return", _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_k_$$0_F_result_$$2_F, true));
			...
			iteration.setOwnedAccumulator(parameter = createParameter("acc", $$1, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_result_$$1_F, true));
			ownedParameters.add(parameter = createParameter("break", _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_result_Boolean_T, true));
			ownedParameters.add(parameter = createParameter("return", _Lambda_self_$$1_T_i_$$0_F_j_$$0_F_result_$$2_F, true));
			...
			iteration.setOwnedAccumulator(parameter = createParameter("acc", $$1, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_self_$$1_T_i_$$0_F_result_$$1_F, true));
			ownedParameters.add(parameter = createParameter("break", _Lambda_self_$$1_T_i_$$0_F_result_Boolean_T, true));
			ownedParameters.add(parameter = createParameter("return", _Lambda_self_$$1_T_i_$$0_F_result_$$2_F, true));
			...
			iteration.setOwnedAccumulator(parameter = createParameter("acc", $$2, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_k_$$0_F_result_$$2_F, true));
			ownedParameters.add(parameter = createParameter("break", _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_k_$$0_F_result_Boolean_T, true));
			ownedParameters.add(parameter = createParameter("return", _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_k_$$0_F_result_$$3_F, true));
			...
			iteration.setOwnedAccumulator(parameter = createParameter("acc", $$2, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_result_$$2_F, true));
			ownedParameters.add(parameter = createParameter("break", _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_result_Boolean_T, true));
			ownedParameters.add(parameter = createParameter("return", _Lambda_self_$$2_T_i_$$0_F_j_$$0_F_result_$$3_F, true));
			...
			iteration.setOwnedAccumulator(parameter = createParameter("acc", $$2, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_self_$$2_T_i_$$0_F_result_$$2_F, true));
			ownedParameters.add(parameter = createParameter("break", _Lambda_self_$$2_T_i_$$0_F_result_Boolean_T, true));
			ownedParameters.add(parameter = createParameter("return", _Lambda_self_$$2_T_i_$$0_F_result_$$3_F, true));
