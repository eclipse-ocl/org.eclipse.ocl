...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private Contents(@NonNull  Resource resource, @NonNull String asURI)
		{
			...
			installAggregateTypes3();
			installAggregateTypes4();
			installAggregateTypes5();
			installAggregateTypes6();
			installOperations();
			installIterations();
			installProperties();
		}
		...
		private void installClassTypes() {
			...
			ownedClasses.add(type = _BooleanType = createClass(ocl, "BooleanType"));
			...
			ownedClasses.add(type = _Class = createClass(ocl, "Class"));
			ownedClasses.add(type = _CollectionType = createClass(ocl, "CollectionType"));
			ownedClasses.add(type = _Enumeration = createClass(ocl, "Enumeration"));
			installComment(type, "@Deprecated: Use OclEnumeration\nThe Enumeration type is the type of an OrderedSet of EnumerationLiteral.");
			ownedClasses.add(type = _EnumerationLiteral = createClass(ocl, "EnumerationLiteral"));
			installComment(type, "The standard type EnumerationLiteral represents a named constant value of an Enumeration.");
			ownedClasses.add(type = _InvalidType = createClass(ocl, "InvalidType"));
			ownedClasses.add(type = _MapType = createClass(ocl, "MapType"));
			ownedClasses.add(type = _OclAny = createAnyType(ocl, OCLstdlibPackage.Literals.OCL_ANY));
			...
			ownedClasses.add(type = _OclComparable = createClass(ocl, OCLstdlibPackage.Literals.OCL_COMPARABLE));
			type.setIsAbstract(true);
			...
			ownedClasses.add(type = _OclElement = createClass(ocl, OCLstdlibPackage.Literals.OCL_ELEMENT));
			type.setIsAbstract(true);
			...
			ownedClasses.add(type = _OclEnumeration = createClass(ocl, OCLstdlibPackage.Literals.OCL_ENUMERATION));
			type.setIsAbstract(true);
			...
			ownedClasses.add(type = _OclInvalid = createInvalidType(ocl, OCLstdlibPackage.Literals.OCL_INVALID));
			type.setIsAbstract(true);
			...
			ownedClasses.add(type = _OclLambda = createClass(ocl, OCLstdlibPackage.Literals.OCL_LAMBDA));
			type.setIsAbstract(true);
			...
			ownedClasses.add(type = _OclMessage = createClass(ocl, OCLstdlibPackage.Literals.OCL_MESSAGE));
			type.setIsAbstract(true);
			...
			ownedClasses.add(type = _OclSelf = createSelfType(ocl, OCLstdlibPackage.Literals.OCL_SELF));
			type.setIsAbstract(true);
			...
			ownedClasses.add(type = _OclState = createClass(ocl, OCLstdlibPackage.Literals.OCL_STATE));
			type.setIsAbstract(true);
			ownedClasses.add(type = _OclStereotype = createClass(ocl, OCLstdlibPackage.Literals.OCL_STEREOTYPE));
			type.setIsAbstract(true);
			...
			ownedClasses.add(type = _OclSummable = createClass(ocl, OCLstdlibPackage.Literals.OCL_SUMMABLE));
			type.setIsAbstract(true);
			...
			ownedClasses.add(type = _OclTuple = createClass(ocl, OCLstdlibPackage.Literals.OCL_TUPLE));
			type.setIsAbstract(true);
			...
			ownedClasses.add(type = _OclType = createClass(ocl, OCLstdlibPackage.Literals.OCL_TYPE));
			type.setIsAbstract(true);
			...
			ownedClasses.add(type = _OclVoid = createVoidType(ocl, OCLstdlibPackage.Literals.OCL_VOID));
			type.setIsAbstract(true);
			...
			ownedClasses.add(type = _State = createClass(ocl, "State"));
			ownedClasses.add(type = _Stereotype = createClass(ocl, "Stereotype"));
			ownedClasses.add(type = _Type = createClass(ocl, "Type"));
			installComment(type, "The UML Type is the supertype of anything that may be used as a type.");
			ownedClasses.add(type = _VoidType = createClass(ocl, "VoidType"));
		...
		private void installAggregateTypes0() {
			...
			type = _Lambda_Bag_T_Boolean = createLambdaType(orphanPackage, "Lambda", tp_Bag_T, _Boolean);
			type = _Lambda_Bag_T_Bag_collectNested_V = createLambdaType(orphanPackage, "Lambda", tp_Bag_T, tp_Bag_collectNested_V);
			type = _Lambda_Bag_T_Bag_collect_V = createLambdaType(orphanPackage, "Lambda", tp_Bag_T, tp_Bag_collect_V);
			type = _Lambda_Bag_T_OclAny = createLambdaType(orphanPackage, "Lambda", tp_Bag_T, _OclAny);
			type = _Lambda_Collection_T_Boolean = createLambdaType(orphanPackage, "Lambda", tp_Collection_T, _Boolean);
			type = _Lambda_Collection_T_Collection_collectBy_V = createLambdaType(orphanPackage, "Lambda", tp_Collection_T, tp_Collection_collectBy_V);
			type = _Lambda_Collection_T_Collection_collectNested_V = createLambdaType(orphanPackage, "Lambda", tp_Collection_T, tp_Collection_collectNested_V);
			type = _Lambda_Collection_T_Collection_collect_V = createLambdaType(orphanPackage, "Lambda", tp_Collection_T, tp_Collection_collect_V);
			type = _Lambda_Collection_T_Collection_iterate_Tacc = createLambdaType(orphanPackage, "Lambda", tp_Collection_T, tp_Collection_iterate_Tacc);
			type = _Lambda_Collection_T_OclAny = createLambdaType(orphanPackage, "Lambda", tp_Collection_T, _OclAny);
			type = _Lambda_Map_K_Boolean = createLambdaType(orphanPackage, "Lambda", tp_Map_K, _Boolean);
			type = _Lambda_Map_K_Map_collectBy_V2 = createLambdaType(orphanPackage, "Lambda", tp_Map_K, tp_Map_collectBy_V2);
			type = _Lambda_Map_K_Map_collectNested_V2 = createLambdaType(orphanPackage, "Lambda", tp_Map_K, tp_Map_collectNested_V2);
			type = _Lambda_Map_K_Map_collect_V2 = createLambdaType(orphanPackage, "Lambda", tp_Map_K, tp_Map_collect_V2);
			type = _Lambda_Map_K_Map_iterate_Tacc = createLambdaType(orphanPackage, "Lambda", tp_Map_K, tp_Map_iterate_Tacc);
			type = _Lambda_Map_K_OclAny = createLambdaType(orphanPackage, "Lambda", tp_Map_K, _OclAny);
			type = _Lambda_OrderedSet_T_Boolean = createLambdaType(orphanPackage, "Lambda", tp_OrderedSet_T, _Boolean);
			type = _Lambda_OrderedSet_T_OclAny = createLambdaType(orphanPackage, "Lambda", tp_OrderedSet_T, _OclAny);
			type = _Lambda_OrderedSet_T_OrderedSet_collectNested_V = createLambdaType(orphanPackage, "Lambda", tp_OrderedSet_T, tp_OrderedSet_collectNested_V);
			type = _Lambda_OrderedSet_T_OrderedSet_collect_V = createLambdaType(orphanPackage, "Lambda", tp_OrderedSet_T, tp_OrderedSet_collect_V);
			type = _Lambda_Sequence_T_Boolean = createLambdaType(orphanPackage, "Lambda", tp_Sequence_T, _Boolean);
			type = _Lambda_Sequence_T_OclAny = createLambdaType(orphanPackage, "Lambda", tp_Sequence_T, _OclAny);
			type = _Lambda_Sequence_T_Sequence_collectNested_V = createLambdaType(orphanPackage, "Lambda", tp_Sequence_T, tp_Sequence_collectNested_V);
			type = _Lambda_Sequence_T_Sequence_collect_V = createLambdaType(orphanPackage, "Lambda", tp_Sequence_T, tp_Sequence_collect_V);
			type = _Lambda_Set_T_Boolean = createLambdaType(orphanPackage, "Lambda", tp_Set_T, _Boolean);
			type = _Lambda_Set_T_OclAny = createLambdaType(orphanPackage, "Lambda", tp_Set_T, _OclAny);
			type = _Lambda_Set_T_Set_collectNested_V = createLambdaType(orphanPackage, "Lambda", tp_Set_T, tp_Set_collectNested_V);
			type = _Lambda_Set_T_Set_collect_V = createLambdaType(orphanPackage, "Lambda", tp_Set_T, tp_Set_collect_V);
			type = _Lambda_UniqueCollection_T_OclAny = createLambdaType(orphanPackage, "Lambda", tp_UniqueCollection_T, _OclAny);
			type = _Tuple = createTupleType(orphanPackage, "Tuple",
		...
		private void installAggregateTypes1() {
			...
			type = _Collection_Integer_F = getCollectionType(orphanPackage, _Collection_Collection_T, _Integer, false, 0, -1);
			type = _Collection_String_F = getCollectionType(orphanPackage, _Collection_Collection_T, _String, false, 0, -1);
			type = _Collection_Tuple_F = getCollectionType(orphanPackage, _Collection_Collection_T, _Tuple, false, 0, -1);
			type = _Collection_Bag_collectNested_V_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Bag_collectNested_V, false, 0, -1);
			type = _Collection_Bag_collect_V_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Bag_collect_V, false, 0, -1);
			type = _Collection_Bag_flatten_T2_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Bag_flatten_T2, false, 0, -1);
			type = _Collection_Bag_selectByKind_TT_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Bag_selectByKind_TT, false, 0, -1);
			type = _Collection_Bag_selectByType_TT_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Bag_selectByType_TT, false, 0, -1);
			type = _Collection_Bag_T_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Bag_T, false, 0, -1);
			type = _Collection_CollectionType_F = getCollectionType(orphanPackage, _Collection_Collection_T, _CollectionType, false, 0, -1);
			type = _Collection_Collection_collectNested_V_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Collection_collectNested_V, false, 0, -1);
			type = _Collection_Collection_collect_V_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Collection_collect_V, false, 0, -1);
			type = _Collection_Collection_excludesAll_T2_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Collection_excludesAll_T2, false, 0, -1);
			type = _Collection_Collection_flatten_T2_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Collection_flatten_T2, false, 0, -1);
			type = _Collection_Collection_includesAll_T2_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Collection_includesAll_T2, false, 0, -1);
			type = _Collection_Collection_product_T2_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Collection_product_T2, false, 0, -1);
			type = _Collection_Collection_selectByKind_TT_T = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Collection_selectByKind_TT, true, 0, -1);
			type = _Collection_Collection_selectByType_TT_T = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Collection_selectByType_TT, true, 0, -1);
			type = _Collection_Collection_T_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Collection_T, false, 0, -1);
			type = _Collection_MapType_F = getCollectionType(orphanPackage, _Collection_Collection_T, _MapType, false, 0, -1);
			type = _Collection_Map_collect_V2_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Map_collect_V2, false, 0, -1);
			type = _Collection_Map_excludesAll_K2_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Map_excludesAll_K2, false, 0, -1);
			type = _Collection_Map_includesAll_K2_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Map_includesAll_K2, false, 0, -1);
			type = _Collection_Map_K_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Map_K, false, 0, -1);
			type = _Collection_Map_V_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Map_V, false, 0, -1);
			type = _Collection_OclAny_F = getCollectionType(orphanPackage, _Collection_Collection_T, _OclAny, false, 0, -1);
			type = _Collection_OclElement_F = getCollectionType(orphanPackage, _Collection_Collection_T, _OclElement, false, 0, -1);
			type = _Collection_OclInvalid_F = getCollectionType(orphanPackage, _Collection_Collection_T, _OclInvalid, false, 0, -1);
			type = _Collection_OclSelf_F = getCollectionType(orphanPackage, _Collection_Collection_T, _OclSelf, false, 0, -1);
			type = _Collection_OrderedCollection_T_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_OrderedCollection_T, false, 0, -1);
			type = _Collection_OrderedSet_collectNested_V_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_OrderedSet_collectNested_V, false, 0, -1);
			type = _Collection_OrderedSet_collect_V_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_OrderedSet_collect_V, false, 0, -1);
			type = _Collection_OrderedSet_flatten_T2_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_OrderedSet_flatten_T2, false, 0, -1);
			type = _Collection_OrderedSet_selectByKind_TT_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_OrderedSet_selectByKind_TT, false, 0, -1);
			type = _Collection_OrderedSet_selectByType_TT_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_OrderedSet_selectByType_TT, false, 0, -1);
			type = _Collection_OrderedSet_T_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_OrderedSet_T, false, 0, -1);
			type = _Collection_Sequence_collectNested_V_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Sequence_collectNested_V, false, 0, -1);
			type = _Collection_Sequence_collect_V_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Sequence_collect_V, false, 0, -1);
			type = _Collection_Sequence_flatten_T2_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Sequence_flatten_T2, false, 0, -1);
			type = _Collection_Sequence_selectByKind_TT_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Sequence_selectByKind_TT, false, 0, -1);
			type = _Collection_Sequence_selectByType_TT_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Sequence_selectByType_TT, false, 0, -1);
			type = _Collection_Sequence_T_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Sequence_T, false, 0, -1);
			type = _Collection_Set_collectNested_V_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Set_collectNested_V, false, 0, -1);
			type = _Collection_Set_collect_V_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Set_collect_V, false, 0, -1);
			type = _Collection_Set_flatten_T2_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Set_flatten_T2, false, 0, -1);
			type = _Collection_Set_selectByKind_TT_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Set_selectByKind_TT, false, 0, -1);
			type = _Collection_Set_selectByType_TT_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Set_selectByType_TT, false, 0, -1);
			type = _Collection_Set_T_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_Set_T, false, 0, -1);
			type = _Collection_UniqueCollection_T_F = getCollectionType(orphanPackage, _Collection_Collection_T, tp_UniqueCollection_T, false, 0, -1);
			type = _Map_Collection_T_F_Collection_collectBy_V_F = getMapType(orphanPackage, _Map_Map_K_Map_V, tp_Collection_T, false, tp_Collection_collectBy_V, false);
			type = _Map_Map_excludesMap_K2_T_Map_excludesMap_V2_T = getMapType(orphanPackage, _Map_Map_K_Map_V, tp_Map_excludesMap_K2, true, tp_Map_excludesMap_V2, true);
			type = _Map_Map_excludingMap_K2_T_Map_excludingMap_V2_T = getMapType(orphanPackage, _Map_Map_K_Map_V, tp_Map_excludingMap_K2, true, tp_Map_excludingMap_V2, true);
			type = _Map_Map_includesMap_K2_T_Map_includesMap_V2_T = getMapType(orphanPackage, _Map_Map_K_Map_V, tp_Map_includesMap_K2, true, tp_Map_includesMap_V2, true);
			type = _Map_Map_includingMap_K2_T_Map_includingMap_V2_T = getMapType(orphanPackage, _Map_Map_K_Map_V, tp_Map_includingMap_K2, true, tp_Map_includingMap_V2, true);
			type = _Map_Map_K_F_Map_collectBy_V2_F = getMapType(orphanPackage, _Map_Map_K_Map_V, tp_Map_K, false, tp_Map_collectBy_V2, false);
			type = _Map_Map_K_F_Map_collectNested_V2_F = getMapType(orphanPackage, _Map_Map_K_Map_V, tp_Map_K, false, tp_Map_collectNested_V2, false);
			type = _Map_Map_K_F_Map_V_F = getMapType(orphanPackage, _Map_Map_K_Map_V, tp_Map_K, false, tp_Map_V, false);
		...
		private void installAggregateTypes2() {
			...
			type = _Bag_Bag_T = createBagType(ocl, OCLstdlibPackage.Literals.BAG, tp_Bag_T, false, 0, -1);
		...
		private void installAggregateTypes3() {
			Class type;

			type = _Bag_Bag_collectNested_V_F = getBagType(orphanPackage, _Bag_Bag_T, tp_Bag_collectNested_V, false, 0, -1);
			type = _Bag_Bag_collect_V_F = getBagType(orphanPackage, _Bag_Bag_T, tp_Bag_collect_V, false, 0, -1);
			type = _Bag_Bag_flatten_T2_F = getBagType(orphanPackage, _Bag_Bag_T, tp_Bag_flatten_T2, false, 0, -1);
			type = _Bag_Bag_selectByKind_TT_T = getBagType(orphanPackage, _Bag_Bag_T, tp_Bag_selectByKind_TT, true, 0, -1);
			type = _Bag_Bag_selectByType_TT_T = getBagType(orphanPackage, _Bag_Bag_T, tp_Bag_selectByType_TT, true, 0, -1);
			type = _Bag_CollectionType_F = getBagType(orphanPackage, _Bag_Bag_T, _CollectionType, false, 0, -1);
			type = _Bag_Collection_T_F = getBagType(orphanPackage, _Bag_Bag_T, tp_Collection_T, false, 0, -1);
			type = _Bag_MapType_F = getBagType(orphanPackage, _Bag_Bag_T, _MapType, false, 0, -1);
			type = _Bag_Map_collect_V2_F = getBagType(orphanPackage, _Bag_Bag_T, tp_Map_collect_V2, false, 0, -1);
			type = _Bag_Map_V_F = getBagType(orphanPackage, _Bag_Bag_T, tp_Map_V, false, 0, -1);
			type = _Bag_OclElement_F = getBagType(orphanPackage, _Bag_Bag_T, _OclElement, false, 0, -1);
			type = _Bag_OclInvalid_F = getBagType(orphanPackage, _Bag_Bag_T, _OclInvalid, false, 0, -1);
			type = _Bag_Set_collectNested_V_F = getBagType(orphanPackage, _Bag_Bag_T, tp_Set_collectNested_V, false, 0, -1);
			type = _Bag_Set_collect_V_F = getBagType(orphanPackage, _Bag_Bag_T, tp_Set_collect_V, false, 0, -1);
			type = _OrderedCollection_Integer_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, _Integer, false, 0, -1);
			type = _OrderedCollection_String_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, _String, false, 0, -1);
			type = _OrderedCollection_Bag_T_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_Bag_T, false, 0, -1);
			type = _OrderedCollection_Collection_T_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_Collection_T, false, 0, -1);
			type = _OrderedCollection_OrderedSet_collectNested_V_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_OrderedSet_collectNested_V, false, 0, -1);
			type = _OrderedCollection_OrderedSet_collect_V_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_OrderedSet_collect_V, false, 0, -1);
			type = _OrderedCollection_OrderedSet_flatten_T2_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_OrderedSet_flatten_T2, false, 0, -1);
			type = _OrderedCollection_OrderedSet_selectByKind_TT_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_OrderedSet_selectByKind_TT, false, 0, -1);
			type = _OrderedCollection_OrderedSet_selectByType_TT_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_OrderedSet_selectByType_TT, false, 0, -1);
			type = _OrderedCollection_OrderedSet_T_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_OrderedSet_T, false, 0, -1);
			type = _OrderedCollection_Sequence_collectNested_V_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_Sequence_collectNested_V, false, 0, -1);
			type = _OrderedCollection_Sequence_collect_V_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_Sequence_collect_V, false, 0, -1);
			type = _OrderedCollection_Sequence_flatten_T2_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_Sequence_flatten_T2, false, 0, -1);
			type = _OrderedCollection_Sequence_selectByKind_TT_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_Sequence_selectByKind_TT, false, 0, -1);
			type = _OrderedCollection_Sequence_selectByType_TT_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_Sequence_selectByType_TT, false, 0, -1);
			type = _OrderedCollection_Sequence_T_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_Sequence_T, false, 0, -1);
			type = _OrderedCollection_Set_T_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_Set_T, false, 0, -1);
			type = _OrderedCollection_UniqueCollection_T_F = getCollectionType(orphanPackage, _OrderedCollection_OrderedCollection_T, tp_UniqueCollection_T, false, 0, -1);
			type = _UniqueCollection_Tuple_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, _Tuple, false, 0, -1);
			type = _UniqueCollection_Bag_T_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_Bag_T, false, 0, -1);
			type = _UniqueCollection_Collection_T_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_Collection_T, false, 0, -1);
			type = _UniqueCollection_Map_K_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_Map_K, false, 0, -1);
			type = _UniqueCollection_OclAny_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, _OclAny, false, 0, -1);
			type = _UniqueCollection_OclElement_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, _OclElement, false, 0, -1);
			type = _UniqueCollection_OclSelf_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, _OclSelf, false, 0, -1);
			type = _UniqueCollection_OrderedSet_flatten_T2_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_OrderedSet_flatten_T2, false, 0, -1);
			type = _UniqueCollection_OrderedSet_selectByKind_TT_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_OrderedSet_selectByKind_TT, false, 0, -1);
			type = _UniqueCollection_OrderedSet_selectByType_TT_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_OrderedSet_selectByType_TT, false, 0, -1);
			type = _UniqueCollection_OrderedSet_T_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_OrderedSet_T, false, 0, -1);
			type = _UniqueCollection_Sequence_T_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_Sequence_T, false, 0, -1);
			type = _UniqueCollection_Set_flatten_T2_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_Set_flatten_T2, false, 0, -1);
			type = _UniqueCollection_Set_selectByKind_TT_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_Set_selectByKind_TT, false, 0, -1);
			type = _UniqueCollection_Set_selectByType_TT_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_Set_selectByType_TT, false, 0, -1);
			type = _UniqueCollection_Set_T_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_Set_T, false, 0, -1);
			type = _UniqueCollection_UniqueCollection_T_F = getCollectionType(orphanPackage, _UniqueCollection_UniqueCollection_T, tp_UniqueCollection_T, false, 0, -1);
		...
		private void installAggregateTypes4() {
			Class type;

			type = _OrderedSet_OrderedSet_T = createOrderedSetType(ocl, OCLstdlibPackage.Literals.ORDERED_SET, tp_OrderedSet_T, false, 0, -1);
			...
			type = _Sequence_Sequence_T = createSequenceType(ocl, OCLstdlibPackage.Literals.SEQUENCE, tp_Sequence_T, false, 0, -1);
			...
			type = _Set_Set_T = createSetType(ocl, OCLstdlibPackage.Literals.SET, tp_Set_T, false, 0, -1);
		...
		private void installAggregateTypes5() {
			Class type;

			type = _Lambda_OrderedSet_T_OrderedSet = createLambdaType(orphanPackage, "Lambda", tp_OrderedSet_T, _OrderedSet_OrderedSet_T);
			type = _Lambda_Set_T_Set = createLambdaType(orphanPackage, "Lambda", tp_Set_T, _Set_Set_T);
			type = _OrderedSet_Collection_T_F = getOrderedSetType(orphanPackage, _OrderedSet_OrderedSet_T, tp_Collection_T, false, 0, -1);
			type = _OrderedSet_OrderedSet_flatten_T2_F = getOrderedSetType(orphanPackage, _OrderedSet_OrderedSet_T, tp_OrderedSet_flatten_T2, false, 0, -1);
			type = _OrderedSet_OrderedSet_selectByKind_TT_T = getOrderedSetType(orphanPackage, _OrderedSet_OrderedSet_T, tp_OrderedSet_selectByKind_TT, true, 0, -1);
			type = _OrderedSet_OrderedSet_selectByType_TT_T = getOrderedSetType(orphanPackage, _OrderedSet_OrderedSet_T, tp_OrderedSet_selectByType_TT, true, 0, -1);
			type = _OrderedSet_Sequence_T_F = getOrderedSetType(orphanPackage, _OrderedSet_OrderedSet_T, tp_Sequence_T, false, 0, -1);
			type = _OrderedSet_Set_T_F = getOrderedSetType(orphanPackage, _OrderedSet_OrderedSet_T, tp_Set_T, false, 0, -1);
			type = _OrderedSet_UniqueCollection_T_F = getOrderedSetType(orphanPackage, _OrderedSet_OrderedSet_T, tp_UniqueCollection_T, false, 0, -1);
			type = _Sequence_Integer_T = getSequenceType(orphanPackage, _Sequence_Sequence_T, _Integer, true, 0, -1);
			type = _Sequence_String_T = getSequenceType(orphanPackage, _Sequence_Sequence_T, _String, true, 0, -1);
			type = _Sequence_Bag_T_F = getSequenceType(orphanPackage, _Sequence_Sequence_T, tp_Bag_T, false, 0, -1);
			type = _Sequence_Collection_T_F = getSequenceType(orphanPackage, _Sequence_Sequence_T, tp_Collection_T, false, 0, -1);
			type = _Sequence_OrderedSet_collectNested_V_F = getSequenceType(orphanPackage, _Sequence_Sequence_T, tp_OrderedSet_collectNested_V, false, 0, -1);
			type = _Sequence_OrderedSet_collect_V_F = getSequenceType(orphanPackage, _Sequence_Sequence_T, tp_OrderedSet_collect_V, false, 0, -1);
			type = _Sequence_Sequence_collectNested_V_F = getSequenceType(orphanPackage, _Sequence_Sequence_T, tp_Sequence_collectNested_V, false, 0, -1);
			type = _Sequence_Sequence_collect_V_F = getSequenceType(orphanPackage, _Sequence_Sequence_T, tp_Sequence_collect_V, false, 0, -1);
			type = _Sequence_Sequence_flatten_T2_F = getSequenceType(orphanPackage, _Sequence_Sequence_T, tp_Sequence_flatten_T2, false, 0, -1);
			type = _Sequence_Sequence_selectByKind_TT_T = getSequenceType(orphanPackage, _Sequence_Sequence_T, tp_Sequence_selectByKind_TT, true, 0, -1);
			type = _Sequence_Sequence_selectByType_TT_T = getSequenceType(orphanPackage, _Sequence_Sequence_T, tp_Sequence_selectByType_TT, true, 0, -1);
			type = _Set_Tuple_T = getSetType(orphanPackage, _Set_Set_T, _Tuple, true, 0, -1);
			type = _Set_Bag_T_F = getSetType(orphanPackage, _Set_Set_T, tp_Bag_T, false, 0, -1);
			type = _Set_Collection_T_F = getSetType(orphanPackage, _Set_Set_T, tp_Collection_T, false, 0, -1);
			type = _Set_Map_K_F = getSetType(orphanPackage, _Set_Set_T, tp_Map_K, false, 0, -1);
			type = _Set_OclElement_T = getSetType(orphanPackage, _Set_Set_T, _OclElement, true, 0, -1);
			type = _Set_OclSelf_T = getSetType(orphanPackage, _Set_Set_T, _OclSelf, true, 0, -1);
			type = _Set_OclSelf_F = getSetType(orphanPackage, _Set_Set_T, _OclSelf, false, 0, -1);
			type = _Set_Set_flatten_T2_F = getSetType(orphanPackage, _Set_Set_T, tp_Set_flatten_T2, false, 0, -1);
			type = _Set_Set_selectByKind_TT_T = getSetType(orphanPackage, _Set_Set_T, tp_Set_selectByKind_TT, true, 0, -1);
			type = _Set_Set_selectByType_TT_T = getSetType(orphanPackage, _Set_Set_T, tp_Set_selectByType_TT, true, 0, -1);
			type = _Set_UniqueCollection_T_F = getSetType(orphanPackage, _Set_Set_T, tp_UniqueCollection_T, false, 0, -1);
		...
		private void installAggregateTypes6() {
			Class type;

			type = _Lambda_Bag_T_Set = createLambdaType(orphanPackage, "Lambda", tp_Bag_T, _Set_Bag_T_F);
			type = _Lambda_Sequence_T_OrderedSet = createLambdaType(orphanPackage, "Lambda", tp_Sequence_T, _OrderedSet_Sequence_T_F);
		...
		private void installProperties() {
			...
			ownedProperties.add(property = pr_OclAny_OclInvalid_oclBadProperty = createProperty("OclInvalid", _Bag_OclInvalid_F));
			...
			ownedProperties.add(property = pr_OclElement_OclElement_oclContainer = createProperty("OclElement", _Bag_OclElement_F));
			property.setIsImplicit(true);
			property.setIsResolveProxies(true);
			ownedProperties.add(property = pr_OclElement_OclElement_oclContents = createProperty("OclElement", _Bag_OclElement_F));
			property.setIsImplicit(true);
			property.setIsResolveProxies(true);
