...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractLibraryContents
	{
		...
		private final @NonNull LambdaType _Lambda_self_$$0_T_result_Boolean_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$0_T_result_OclAny_F = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_self_$$0_T_result_OclComparable_F = createLambdaType("Lambda");
		...
		private void installLambdaTypes() {
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$0_T_result_Boolean_F);
			type.setOwnedContext(createLambdaParameter("self", $$0, true));
			type.setOwnedResult(createLambdaParameter("result", _Boolean, false));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$0_T_result_OclAny_F);
			type.setOwnedContext(createLambdaParameter("self", $$0, true));
			type.setOwnedResult(createLambdaParameter("result", _OclAny, false));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$0_T_result_OclComparable_F);
			type.setOwnedContext(createLambdaParameter("self", $$0, true));
		...
		private void installIterations() {
			...
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_T_result_OclComparable_F, true));
			...
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_T_result_Boolean_F, true));
			...
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_T_result_OclAny_F, true));
