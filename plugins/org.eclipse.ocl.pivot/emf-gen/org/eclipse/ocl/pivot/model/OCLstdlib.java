...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private final @NonNull BagType _Bag = createBagType(OCLstdlibPackage.Literals.BAG, tp_Bag_T);
		private final @NonNull CollectionType _Collection = createCollectionType(OCLstdlibPackage.Literals.COLLECTION, tp_Collection_T);
		private final @NonNull CollectionType _OrderedCollection = createCollectionType(OCLstdlibPackage.Literals.ORDERED_COLLECTION, tp_OrderedCollection_T);
		private final @NonNull OrderedSetType _OrderedSet = createOrderedSetType(OCLstdlibPackage.Literals.ORDERED_SET, tp_OrderedSet_T);
		private final @NonNull SequenceType _Sequence = createSequenceType(OCLstdlibPackage.Literals.SEQUENCE, tp_Sequence_T);
		private final @NonNull SetType _Set = createSetType(OCLstdlibPackage.Literals.SET, tp_Set_T);
		private final @NonNull CollectionType _UniqueCollection = createCollectionType(OCLstdlibPackage.Literals.UNIQUE_COLLECTION, tp_UniqueCollection_T);

		private final @NonNull BagType _Bag_Bag_collect_V_T = createBagType(_Bag);
		private final @NonNull BagType _Bag_Bag_collectNested_V_T = createBagType(_Bag);
		private final @NonNull BagType _Bag_Bag_flatten_T2_T = createBagType(_Bag);
		private final @NonNull BagType _Bag_Bag_selectByKind_TT_T = createBagType(_Bag);
		private final @NonNull BagType _Bag_Bag_selectByType_TT_T = createBagType(_Bag);
		private final @NonNull BagType _Bag_Collection_T_T = createBagType(_Bag);
		private final @NonNull BagType _Bag_CollectionType_F = createBagType(_Bag);
		private final @NonNull BagType _Bag_Map_V_T = createBagType(_Bag);
		private final @NonNull BagType _Bag_Map_collect_V2_F = createBagType(_Bag);
		private final @NonNull BagType _Bag_MapType_F = createBagType(_Bag);
		private final @NonNull BagType _Bag_OclElement_F = createBagType(_Bag);
		private final @NonNull BagType _Bag_OclInvalid_F = createBagType(_Bag);
		private final @NonNull BagType _Bag_Set_collect_V_T = createBagType(_Bag);
		private final @NonNull BagType _Bag_Set_collectNested_V_T = createBagType(_Bag);
		private final @NonNull CollectionType _Collection_Bag_T_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Bag_T_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Bag_collect_V_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Bag_collectNested_V_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Bag_flatten_T2_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Bag_selectByKind_TT_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Bag_selectByType_TT_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Collection_T_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Collection_collect_V_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Collection_collectNested_V_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Collection_excludesAll_T2_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Collection_flatten_T2_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Collection_includesAll_T2_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Collection_product_T2_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Collection_selectByKind_TT_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Collection_selectByType_TT_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_CollectionType_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Integer_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Map_K_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Map_K_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Map_V_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Map_collect_V2_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Map_excludesAll_K2_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Map_includesAll_K2_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_MapType_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_OclAny_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_OclElement_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_OclInvalid_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_OclSelf_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_OrderedCollection_T_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_OrderedSet_T_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_OrderedSet_T_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_OrderedSet_collect_V_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_OrderedSet_collectNested_V_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_OrderedSet_flatten_T2_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_OrderedSet_selectByKind_TT_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_OrderedSet_selectByType_TT_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Sequence_T_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Sequence_T_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Sequence_collect_V_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Sequence_collectNested_V_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Sequence_flatten_T2_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Sequence_selectByKind_TT_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Sequence_selectByType_TT_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Set_T_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Set_T_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Set_collect_V_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Set_collectNested_V_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Set_flatten_T2_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Set_selectByKind_TT_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Set_selectByType_TT_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_String_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_Tuple_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_UniqueCollection_T_F = createCollectionType(_Collection);
		private final @NonNull CollectionType _Collection_UniqueCollection_T_T = createCollectionType(_Collection);
		private final @NonNull CollectionType _OrderedCollection_Bag_T_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_Collection_T_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_Integer_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_T_T = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_collect_V_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_collectNested_V_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_flatten_T2_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_selectByKind_TT_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_selectByType_TT_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_Sequence_T_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_Sequence_T_T = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_Sequence_collect_V_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_Sequence_collectNested_V_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_Sequence_flatten_T2_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_Sequence_selectByKind_TT_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_Sequence_selectByType_TT_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_Set_T_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_String_F = createCollectionType(_OrderedCollection);
		private final @NonNull CollectionType _OrderedCollection_UniqueCollection_T_F = createCollectionType(_OrderedCollection);
		private final @NonNull OrderedSetType _OrderedSet_Collection_T_T = createOrderedSetType(_OrderedSet);
		private final @NonNull OrderedSetType _OrderedSet_OrderedSet_flatten_T2_T = createOrderedSetType(_OrderedSet);
		private final @NonNull OrderedSetType _OrderedSet_OrderedSet_selectByKind_TT_T = createOrderedSetType(_OrderedSet);
		private final @NonNull OrderedSetType _OrderedSet_OrderedSet_selectByType_TT_T = createOrderedSetType(_OrderedSet);
		private final @NonNull OrderedSetType _OrderedSet_Sequence_T_T = createOrderedSetType(_OrderedSet);
		private final @NonNull OrderedSetType _OrderedSet_Set_T_T = createOrderedSetType(_OrderedSet);
		private final @NonNull OrderedSetType _OrderedSet_UniqueCollection_T_T = createOrderedSetType(_OrderedSet);
		private final @NonNull SequenceType _Sequence_Bag_T_T = createSequenceType(_Sequence);
		private final @NonNull SequenceType _Sequence_Collection_T_T = createSequenceType(_Sequence);
		private final @NonNull SequenceType _Sequence_Integer_T = createSequenceType(_Sequence);
		private final @NonNull SequenceType _Sequence_OrderedSet_collect_V_T = createSequenceType(_Sequence);
		private final @NonNull SequenceType _Sequence_OrderedSet_collectNested_V_T = createSequenceType(_Sequence);
		private final @NonNull SequenceType _Sequence_Sequence_collect_V_T = createSequenceType(_Sequence);
		private final @NonNull SequenceType _Sequence_Sequence_collectNested_V_T = createSequenceType(_Sequence);
		private final @NonNull SequenceType _Sequence_Sequence_flatten_T2_T = createSequenceType(_Sequence);
		private final @NonNull SequenceType _Sequence_Sequence_selectByKind_TT_T = createSequenceType(_Sequence);
		private final @NonNull SequenceType _Sequence_Sequence_selectByType_TT_T = createSequenceType(_Sequence);
		private final @NonNull SequenceType _Sequence_String_T = createSequenceType(_Sequence);
		private final @NonNull SetType _Set_Bag_T_T = createSetType(_Set);
		private final @NonNull SetType _Set_Collection_T_T = createSetType(_Set);
		private final @NonNull SetType _Set_Map_K_T = createSetType(_Set);
		private final @NonNull SetType _Set_OclElement_T = createSetType(_Set);
		private final @NonNull SetType _Set_OclSelf_F = createSetType(_Set);
		private final @NonNull SetType _Set_OclSelf_T = createSetType(_Set);
		private final @NonNull SetType _Set_Set_flatten_T2_T = createSetType(_Set);
		private final @NonNull SetType _Set_Set_selectByKind_TT_T = createSetType(_Set);
		private final @NonNull SetType _Set_Set_selectByType_TT_T = createSetType(_Set);
		private final @NonNull SetType _Set_Tuple_T = createSetType(_Set);
		private final @NonNull SetType _Set_UniqueCollection_T_T = createSetType(_Set);
		private final @NonNull CollectionType _UniqueCollection_Bag_T_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_Collection_T_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_Collection_T_T = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_Map_K_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_OclAny_T = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_OclElement_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_OclSelf_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_T_T = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_flatten_T2_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_selectByKind_TT_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_selectByType_TT_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_Sequence_T_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_Set_T_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_Set_T_T = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_Set_flatten_T2_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_Set_selectByKind_TT_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_Set_selectByType_TT_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_Tuple_F = createCollectionType(_UniqueCollection);
		private final @NonNull CollectionType _UniqueCollection_UniqueCollection_T_F = createCollectionType(_UniqueCollection);

		private final @NonNull MapType _Map = createMapType(OCLstdlibPackage.Literals.MAP, tp_Map_K, tp_Map_V);
		private final @NonNull MapType _Map_Collection_T_F_Collection_collectBy_V_F = createMapType(_Map);
		private final @NonNull MapType _Map_Map_excludesMap_K2_T_Map_excludesMap_V2_T = createMapType(_Map);
		private final @NonNull MapType _Map_Map_excludingMap_K2_T_Map_excludingMap_V2_T = createMapType(_Map);
		private final @NonNull MapType _Map_Map_includesMap_K2_T_Map_includesMap_V2_T = createMapType(_Map);
		private final @NonNull MapType _Map_Map_includingMap_K2_T_Map_includingMap_V2_T = createMapType(_Map);
		private final @NonNull MapType _Map_Map_K_F_Map_collectBy_V2_F = createMapType(_Map);
		private final @NonNull MapType _Map_Map_K_F_Map_collectNested_V2_F = createMapType(_Map);
		...
		private void installLambdaTypes() {
			...
			type.setContextType(tp_OrderedSet_T);
			type.setResultType(_OrderedSet);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
		...
		private final @NonNull Operation op_Bag_excluding = createOperation("excluding", _Bag, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE);
		private final @NonNull Operation op_Bag_excludingAll = createOperation("excludingAll", _Bag, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE);
		...
		private final @NonNull Operation op_Bag_including = createOperation("including", _Bag, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE);
		private final @NonNull Operation op_Bag_includingAll = createOperation("includingAll", _Bag, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE);
		...
		private final @NonNull Operation op_Collection_excluding = createOperation("excluding", _Collection, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE);
		private final @NonNull Operation op_Collection_excludingAll = createOperation("excludingAll", _Collection, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE);
		...
		private final @NonNull Operation op_Collection_including = createOperation("including", _Collection, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE);
		private final @NonNull Operation op_Collection_includingAll = createOperation("includingAll", _Collection, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE);
		...
		private final @NonNull Operation op_Map_excluding = createOperation("excluding", _Map, "org.eclipse.ocl.pivot.library.map.MapExcludingOperation", org.eclipse.ocl.pivot.library.map.MapExcludingOperation.INSTANCE);
		private final @NonNull Operation op_Map_excluding_1 = createOperation("excluding", _Map, "org.eclipse.ocl.pivot.library.map.MapExcludingPairOperation", org.eclipse.ocl.pivot.library.map.MapExcludingPairOperation.INSTANCE);
		private final @NonNull Operation op_Map_excludingAll = createOperation("excludingAll", _Map, "org.eclipse.ocl.pivot.library.map.MapExcludingAllOperation", org.eclipse.ocl.pivot.library.map.MapExcludingAllOperation.INSTANCE);
		private final @NonNull Operation op_Map_excludingMap = createOperation("excludingMap", _Map, "org.eclipse.ocl.pivot.library.map.MapExcludingMapOperation", org.eclipse.ocl.pivot.library.map.MapExcludingMapOperation.INSTANCE, tp_Map_excludingMap_K2, tp_Map_excludingMap_V2);
		...
		private final @NonNull Operation op_Map_including = createOperation("including", _Map, "org.eclipse.ocl.pivot.library.map.MapIncludingPairOperation", org.eclipse.ocl.pivot.library.map.MapIncludingPairOperation.INSTANCE);
		private final @NonNull Operation op_Map_includingMap = createOperation("includingMap", _Map, "org.eclipse.ocl.pivot.library.map.MapIncludingMapOperation", org.eclipse.ocl.pivot.library.map.MapIncludingMapOperation.INSTANCE, tp_Map_includingMap_K2, tp_Map_includingMap_V2);
		...
		private final @NonNull Operation op_OrderedSet__neg_ = createOperation("-", _OrderedSet, "org.eclipse.ocl.pivot.library.collection.SetMinusOperation", org.eclipse.ocl.pivot.library.collection.SetMinusOperation.INSTANCE);
		...
		private final @NonNull Operation op_OrderedSet_append = createOperation("append", _OrderedSet, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_appendAll = createOperation("appendAll", _OrderedSet, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendAllOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendAllOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_excluding = createOperation("excluding", _OrderedSet, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_excludingAll = createOperation("excludingAll", _OrderedSet, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE);
		...
		private final @NonNull Operation op_OrderedSet_including = createOperation("including", _OrderedSet, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_includingAll = createOperation("includingAll", _OrderedSet, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_insertAt = createOperation("insertAt", _OrderedSet, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionInsertAtOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionInsertAtOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_prepend = createOperation("prepend", _OrderedSet, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_prependAll = createOperation("prependAll", _OrderedSet, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependAllOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependAllOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_reverse = createOperation("reverse", _OrderedSet, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionReverseOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionReverseOperation.INSTANCE);
		...
		private final @NonNull Operation op_OrderedSet_subOrderedSet = createOperation("subOrderedSet", _OrderedSet, "org.eclipse.ocl.pivot.library.collection.OrderedSetSubOrderedSetOperation", org.eclipse.ocl.pivot.library.collection.OrderedSetSubOrderedSetOperation.INSTANCE);
		...
		private final @NonNull Operation op_Sequence_append = createOperation("append", _Sequence, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_appendAll = createOperation("appendAll", _Sequence, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendAllOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendAllOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_excluding = createOperation("excluding", _Sequence, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_excludingAll = createOperation("excludingAll", _Sequence, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE);
		...
		private final @NonNull Operation op_Sequence_including = createOperation("including", _Sequence, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_includingAll = createOperation("includingAll", _Sequence, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_insertAt = createOperation("insertAt", _Sequence, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionInsertAtOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionInsertAtOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_prepend = createOperation("prepend", _Sequence, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_prependAll = createOperation("prependAll", _Sequence, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependAllOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependAllOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_reverse = createOperation("reverse", _Sequence, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionReverseOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionReverseOperation.INSTANCE);
		...
		private final @NonNull Operation op_Sequence_subSequence = createOperation("subSequence", _Sequence, "org.eclipse.ocl.pivot.library.collection.SequenceSubSequenceOperation", org.eclipse.ocl.pivot.library.collection.SequenceSubSequenceOperation.INSTANCE);
		private final @NonNull Operation op_Set__neg_ = createOperation("-", _Set, "org.eclipse.ocl.pivot.library.collection.SetMinusOperation", org.eclipse.ocl.pivot.library.collection.SetMinusOperation.INSTANCE);
		...
		private final @NonNull Operation op_Set_excluding = createOperation("excluding", _Set, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE);
		private final @NonNull Operation op_Set_excludingAll = createOperation("excludingAll", _Set, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE);
		...
		private final @NonNull Operation op_Set_including = createOperation("including", _Set, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE);
		private final @NonNull Operation op_Set_includingAll = createOperation("includingAll", _Set, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE);
		...
		private final @NonNull Operation op_UniqueCollection__neg_ = createOperation("-", _UniqueCollection, "org.eclipse.ocl.pivot.library.collection.SetMinusOperation", org.eclipse.ocl.pivot.library.collection.SetMinusOperation.INSTANCE);
		...
		private void installOperations() {
			...
			ownedOperations = _Bag.getOwnedOperations();
			...
			ownedOperations = _Collection.getOwnedOperations();
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("objects", _Collection, true));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("c", _Collection, true));
			...
			ownedOperations = _Map.getOwnedOperations();
			...
			ownedOperations = _OrderedCollection.getOwnedOperations();
			...
			ownedOperations = _OrderedSet.getOwnedOperations();
			...
			ownedOperations = _Sequence.getOwnedOperations();
			...
			ownedOperations = _Set.getOwnedOperations();
			...
			ownedOperations = _UniqueCollection.getOwnedOperations();
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("s", _UniqueCollection, true));
		...
		private final @NonNull Iteration it_Bag_reject = createIteration("reject", _Bag, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		private final @NonNull Iteration it_Bag_select = createIteration("select", _Bag, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE);
		...
		private final @NonNull Iteration it_Collection_reject = createIteration("reject", _Collection, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		private final @NonNull Iteration it_Collection_select = createIteration("select", _Collection, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE);
		...
		private final @NonNull Iteration it_Map_reject = createIteration("reject", _Map, "org.eclipse.ocl.pivot.library.iterator.MapRejectIteration", org.eclipse.ocl.pivot.library.iterator.MapRejectIteration.INSTANCE);
		private final @NonNull Iteration it_Map_select = createIteration("select", _Map, "org.eclipse.ocl.pivot.library.iterator.MapSelectIteration", org.eclipse.ocl.pivot.library.iterator.MapSelectIteration.INSTANCE);
		private final @NonNull Iteration it_OrderedSet_closure = createIteration("closure", _OrderedSet, "org.eclipse.ocl.pivot.library.iterator.ClosureIteration", org.eclipse.ocl.pivot.library.iterator.ClosureIteration.INSTANCE);
		...
		private final @NonNull Iteration it_OrderedSet_reject = createIteration("reject", _OrderedSet, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		private final @NonNull Iteration it_OrderedSet_select = createIteration("select", _OrderedSet, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE);
		private final @NonNull Iteration it_OrderedSet_sortedBy = createIteration("sortedBy", _OrderedSet, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE);
		...
		private final @NonNull Iteration it_Sequence_reject = createIteration("reject", _Sequence, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		private final @NonNull Iteration it_Sequence_select = createIteration("select", _Sequence, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE);
		private final @NonNull Iteration it_Sequence_sortedBy = createIteration("sortedBy", _Sequence, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE);
		private final @NonNull Iteration it_Set_closure = createIteration("closure", _Set, "org.eclipse.ocl.pivot.library.iterator.ClosureIteration", org.eclipse.ocl.pivot.library.iterator.ClosureIteration.INSTANCE);
		...
		private final @NonNull Iteration it_Set_reject = createIteration("reject", _Set, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		private final @NonNull Iteration it_Set_select = createIteration("select", _Set, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE);
		...
		private void installIterations() {
			...
			ownedIterations = _Bag.getOwnedOperations();
			...
			ownedIterations = _Collection.getOwnedOperations();
			...
			ownedIterations = _Map.getOwnedOperations();
			...
			ownedIterations = _OrderedSet.getOwnedOperations();
			...
			ownedIterations = _Sequence.getOwnedOperations();
			...
			ownedIterations = _Set.getOwnedOperations();
			...
			ownedIterations = _UniqueCollection.getOwnedOperations();
