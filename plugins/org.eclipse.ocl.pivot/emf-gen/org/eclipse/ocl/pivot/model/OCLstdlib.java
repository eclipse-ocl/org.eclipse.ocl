...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private final @NonNull TemplateParameter tp_Collection_inverseCollectBy_V = createTemplateParameter("V");
		...
		private final @NonNull BagType _Bag_Collection_collectBy_V = createBagType(_Bag_Bag_T);
		...
		private final @NonNull BagType _Bag_Map_collectBy_V2 = createBagType(_Bag_Bag_T);
		...
		private final @NonNull SetType _Set_Collection_T = createSetType(_Set_Set_T);
		...
		private final @NonNull MapType _Map_Collection_inverseCollectBy_V_Set = createMapType(_Map_Map_K_Map_V);
		private final @NonNull MapType _Map_Collection_T_Bag = createMapType(_Map_Map_K_Map_V);
		...
		private final @NonNull MapType _Map_Map_K_Bag = createMapType(_Map_Map_K_Map_V);
		...
		private void installCollectionTypes() {
			...
			ownedClasses.add(type = _Bag_Collection_collectBy_V);
			type.setUpper(1);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclElement);
			...
			ownedClasses.add(type = _Bag_Map_collectBy_V2);
			type.setUpper(1);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclElement);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_OrderedSet_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_Sequence_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
		...
		private void installMapTypes() {
			...
			ownedClasses = orphanage.getOwnedClasses();
			ownedClasses.add(type = _Map_Collection_inverseCollectBy_V_Set);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Map_Collection_T_Bag);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Map_Map_K_Bag);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
		...
		private final @NonNull LambdaType _Lambda_Collection_T_6 = createLambdaType("Lambda");
		...
		private void installLambdaTypes() {
			...
			type.setContextType(tp_Collection_T);
			type.setResultType(tp_Collection_inverseCollectBy_V);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
		...
		private final @NonNull Iteration it_Collection_collectBy = createIteration("collectBy", _Map_Collection_T_Bag, "org.eclipse.ocl.pivot.library.iterator.CollectByIteration", org.eclipse.ocl.pivot.library.iterator.CollectByIteration.INSTANCE, tp_Collection_collectBy_V);
		...
		private final @NonNull Iteration it_Collection_inverseCollectBy = createIteration("inverseCollectBy", _Map_Collection_inverseCollectBy_V_Set, "org.eclipse.ocl.pivot.library.iterator.CollectByIteration", org.eclipse.ocl.pivot.library.iterator.CollectByIteration.INSTANCE, tp_Collection_inverseCollectBy_V);
		...
		private final @NonNull Iteration it_Map_collectBy = createIteration("collectBy", _Map_Map_K_Bag, "org.eclipse.ocl.pivot.library.iterator.CollectByIteration", org.eclipse.ocl.pivot.library.iterator.CollectByIteration.INSTANCE, tp_Map_collectBy_V2);
		...
		private final @NonNull Iteration it_Map_reject = createIteration("reject", _Map_Map_K_Map_V, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		private final @NonNull Iteration it_Map_select = createIteration("select", _Map_Map_K_Map_V, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE);
		...
		private void installIterations() {
			...
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_Collection_T, false));
			ownedIterations.add(iteration = it_Collection_inverseCollectBy);
			iteration.setIsRequired(false);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Collection_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedParameters.add(parameter = createParameter("i", tp_Collection_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_Collection_T_6, false));
		...
		private void installTemplateBindings() {
			...
			addBinding(_Bag_Collection_collectBy_V, tp_Collection_collectBy_V);
			addBinding(_Bag_Enumeration, _Enumeration);
			addBinding(_Bag_Map_V_NullFree, tp_Map_V);
			addBinding(_Bag_Map_collectBy_V2, tp_Map_collectBy_V2);
			...
			addBinding(_Map_Collection_T_Bag, tp_Collection_T);
			addBinding(_Map_Collection_T_Bag, _Bag_Collection_collectBy_V);
			addBinding(_Map_Collection_inverseCollectBy_V_Set, tp_Collection_inverseCollectBy_V);
			addBinding(_Map_Collection_inverseCollectBy_V_Set, _Set_Collection_T);
			addBinding(_Map_Map_K_Bag, tp_Map_K);
			addBinding(_Map_Map_K_Bag, _Bag_Map_collectBy_V2);
			...
			addBinding(_Set_Collection_T, tp_Collection_T);
		...
		private void installComments() {
			...
			installComment(it_Collection_exists, "Results in oclText[true] if body evaluates to oclText[true] for at least one permutation of elements oclText[i], oclText[j] in the source collection.");
			installComment(it_Collection_exists_1, "Results in oclText[true] if body evaluates to oclText[true] for at least one element oclText[i] in the source collection.");
			...
			installComment(it_Collection_forAll_1, "Results in oclText[true] if the body expression evaluates to oclText[true] for each element oclText[i] in the source collection; otherwise, result is oclText[false].");
			...
			installComment(it_Collection_inverseCollectBy, "The Map from each element oclText[i] of the source collection, the key, to the set of values to and values that results from applying body to every value of the source map.\nThe result is not flattened.");
			...
			installComment(it_Map_exists, "Results in oclText[true] if body evaluates to oclText[true] for at least one permutation of keys oclText[k1], oclText[k2] in the source map.");
			installComment(it_Map_exists_1, "Results in oclText[true] if body evaluates to oclText[true] for at least one key oclText[k] in the source map.");
			installComment(it_Map_forAll, "Results in oclText[true] if the body expression evaluates to oclText[true] for each permutation of keys oclText[k1], oclText[k2] in the source map; otherwise, result is oclText[false].");
			installComment(it_Map_forAll_1, "Results in oclText[true] if the body expression evaluates to oclText[true] for each key oclText[k] in the source map; otherwise, result is oclText[false].");
