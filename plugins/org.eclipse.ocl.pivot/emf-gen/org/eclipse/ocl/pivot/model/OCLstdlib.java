...
public class OCLstdlib extends ASResourceImpl
{
	...
	{
		protected final @NonNull Library library;
	...
	private static class Contents extends AbstractLibraryContents
	{
		...
		private final @NonNull TemplateParameter tp_Collection_gather_V = createTemplateParameter("V");
		...
		private final @NonNull TemplateParameter tp_Collection_search_Q = createTemplateParameter("Q");
		private final @NonNull TemplateParameter tp_Collection_search_R = createTemplateParameter("R");
		private final @NonNull TemplateParameter tp_Collection_search_Q_1 = createTemplateParameter("Q");
		private final @NonNull TemplateParameter tp_Collection_search_R_1 = createTemplateParameter("R");
		private final @NonNull TemplateParameter tp_Collection_search_Q_2 = createTemplateParameter("Q");
		private final @NonNull TemplateParameter tp_Collection_search_R_2 = createTemplateParameter("R");
		...
		private final @NonNull TemplateParameter tp_Map_gather_E = createTemplateParameter("E");
		...
		private final @NonNull TemplateParameter tp_Map_search_Q = createTemplateParameter("Q");
		private final @NonNull TemplateParameter tp_Map_search_R = createTemplateParameter("R");
		private final @NonNull TemplateParameter tp_Map_search_Q_1 = createTemplateParameter("Q");
		private final @NonNull TemplateParameter tp_Map_search_R_1 = createTemplateParameter("R");
		private final @NonNull TemplateParameter tp_Map_search_Q_2 = createTemplateParameter("Q");
		private final @NonNull TemplateParameter tp_Map_search_R_2 = createTemplateParameter("R");
		...
		private final @NonNull TemplateParameter tp_OrderedCollection_gather_E = createTemplateParameter("E");
		...
		private final @NonNull BagType _Bag_$$0_F = createBagType(_Bag_Bag_T);
		...
		private final @NonNull CollectionType _Collection_Integer_T = createCollectionType(_Collection_Collection_T);
		...
		private final @NonNull CollectionType _Collection_OclElement_T = createCollectionType(_Collection_Collection_T);
		...
		private final @NonNull CollectionType _Collection_Tuple_T = createCollectionType(_Collection_Collection_T);
		...
		private final @NonNull CollectionType _OrderedCollection_Integer_T = createCollectionType(_OrderedCollection_OrderedCollection_T);
		private final @NonNull CollectionType _OrderedCollection_String_T = createCollectionType(_OrderedCollection_OrderedCollection_T);
		private final @NonNull OrderedSetType _OrderedSet_$$0_F = createOrderedSetType(_OrderedSet_OrderedSet_T);
		...
		private final @NonNull SequenceType _Sequence_$$0_F = createSequenceType(_Sequence_Sequence_T);
		...
		private final @NonNull SetType _Set_$$0_F = createSetType(_Set_Set_T);
		...
		private final @NonNull CollectionType _UniqueCollection_$$1_T = createCollectionType(_UniqueCollection_UniqueCollection_T);
		private final @NonNull CollectionType _UniqueCollection_OclAny_F = createCollectionType(_UniqueCollection_UniqueCollection_T);
		private final @NonNull CollectionType _UniqueCollection_OclElement_T = createCollectionType(_UniqueCollection_UniqueCollection_T);
		...
		private final @NonNull MapType _Map_$$0_T_$$2_T = createMapType(_Map_Map_K_Map_V);
		...
		private void installCollectionTypes() {
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_$$1_T);
			ownedClasses.add(type);
			type = _Bag_$$2_F;
			superClasses = type.getSuperClasses();
			...
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			type = _Collection_OclSelf_F_L1_U1;
			type.setLower(1);
			type.setUpper(1);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			type = _Collection_OclSelf_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			...
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			type = _Collection_OclSelf_T_L1_U1;
			type.setLower(1);
			type.setUpper(1);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			type = _Collection_OclSelf_T_L2_U2;
			type.setLower(2);
			type.setUpper(2);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			type = _Collection_String_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			type = _Collection_Tuple_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type);
			...
			superClasses.add(_Collection_$$1_T);
			ownedClasses.add(type);
			type = _OrderedCollection_Integer_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_Integer_T);
			ownedClasses.add(type);
			type = _OrderedCollection_String_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_String_T);
			ownedClasses.add(type);
			type = _OrderedSet_$$0_F;
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_$$0_F);
			superClasses.add(_UniqueCollection_$$0_F);
			ownedClasses.add(type);
			...
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_$$1_T);
			superClasses.add(_UniqueCollection_$$1_T);
			ownedClasses.add(type);
			type = _Sequence_$$0_F;
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_$$0_F);
			...
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_Integer_T);
			ownedClasses.add(type);
			type = _Sequence_String_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_String_T);
			ownedClasses.add(type);
			type = _Set_$$0_F;
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_$$0_F);
			...
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_OclElement_T);
			ownedClasses.add(type);
			type = _Set_OclSelf_F;
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_OclSelf_F);
			ownedClasses.add(type);
			type = _Set_OclSelf_F_L1_U1;
			type.setLower(1);
			type.setUpper(1);
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_OclSelf_F_L1_U1);
			ownedClasses.add(type);
			type = _Set_OclSelf_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			...
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_OclSelf_T_L1_U1);
			ownedClasses.add(type);
			type = _Set_OclSelf_T_L2_U2;
			type.setLower(2);
			type.setUpper(2);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_OclSelf_T_L2_U2);
			ownedClasses.add(type);
			type = _Set_Tuple_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_Tuple_T);
			ownedClasses.add(type);
			...
			superClasses.add(_Collection_$$1_F);
			ownedClasses.add(type);
			type = _UniqueCollection_$$1_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_$$1_T);
			ownedClasses.add(type);
			type = _UniqueCollection_OclAny_F;
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_OclAny_F);
			ownedClasses.add(type);
			type = _UniqueCollection_OclElement_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_OclElement_T);
			ownedClasses.add(type);
			type = _UniqueCollection_OclSelf_F;
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_OclSelf_F);
			ownedClasses.add(type);
			type = _UniqueCollection_OclSelf_F_L1_U1;
			type.setLower(1);
			type.setUpper(1);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_OclSelf_F_L1_U1);
			ownedClasses.add(type);
			type = _UniqueCollection_OclSelf_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			...
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_OclSelf_T_L1_U1);
			ownedClasses.add(type);
			type = _UniqueCollection_OclSelf_T_L2_U2;
			type.setLower(2);
			type.setUpper(2);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_OclSelf_T_L2_U2);
			ownedClasses.add(type);
			type = _UniqueCollection_Tuple_T;
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_Tuple_T);
			ownedClasses.add(type);
		}
		...
		private void installLambdaTypes() {
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$1_F_i_$$0_F_result_$$2_F);
			type.setOwnedContext(createLambdaParameter("self", $$1, false));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", $$2, false));
			superClasses = type.getSuperClasses();
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$1_F_i_$$0_F_j_$$0_F_result_$$2_F);
			type.setOwnedContext(createLambdaParameter("self", $$1, false));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", $$2, false));
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$1_F_i_$$0_F_j_$$0_F_k_$$0_F_result_$$2_F);
			type.setOwnedContext(createLambdaParameter("self", $$1, false));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("k", $$0, false));
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$2_F_i_$$0_F_result_$$3_F);
			type.setOwnedContext(createLambdaParameter("self", $$2, false));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$2_F_i_$$0_F_j_$$0_F_result_$$3_F);
			type.setOwnedContext(createLambdaParameter("self", $$2, false));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", $$3, false));
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$2_F_i_$$0_F_j_$$0_F_k_$$0_F_result_$$3_F);
			type.setOwnedContext(createLambdaParameter("self", $$2, false));
			type.getOwnedParameters().add(createLambdaParameter("i", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("j", $$0, false));
			type.getOwnedParameters().add(createLambdaParameter("k", $$0, false));
		...
		private final @NonNull Operation op_Bag_excluding = createOperation("excluding", _Bag_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE);
		private final @NonNull Operation op_Bag_excludingAll = createOperation("excludingAll", _Bag_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE);
		private final @NonNull Operation op_Bag_flatten = createOperation("flatten", _Bag_$$1_F, "org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation", org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation.INSTANCE, tp_Bag_flatten_T2);
		private final @NonNull Operation op_Bag_including = createOperation("including", _Bag_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE);
		private final @NonNull Operation op_Bag_includingAll = createOperation("includingAll", _Bag_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE);
		...
		private final @NonNull Operation op_BooleanType_allInstances = createOperation("allInstances", _Set_OclSelf_T_L2_U2, "org.eclipse.ocl.pivot.library.classifier.ClassifierAllInstancesOperation", org.eclipse.ocl.pivot.library.classifier.ClassifierAllInstancesOperation.INSTANCE);
		...
		private final @NonNull Operation op_Collection_asBag = createOperation("asBag", _Bag_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionAsBagOperation", org.eclipse.ocl.pivot.library.collection.CollectionAsBagOperation.INSTANCE);
		private final @NonNull Operation op_Collection_asOrderedSet = createOperation("asOrderedSet", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionAsOrderedSetOperation", org.eclipse.ocl.pivot.library.collection.CollectionAsOrderedSetOperation.INSTANCE);
		private final @NonNull Operation op_Collection_asSequence = createOperation("asSequence", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionAsSequenceOperation", org.eclipse.ocl.pivot.library.collection.CollectionAsSequenceOperation.INSTANCE);
		private final @NonNull Operation op_Collection_asSet = createOperation("asSet", _Set_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionAsSetOperation", org.eclipse.ocl.pivot.library.collection.CollectionAsSetOperation.INSTANCE);
		...
		private final @NonNull Operation op_Collection_excluding = createOperation("excluding", _Collection_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE);
		private final @NonNull Operation op_Collection_excludingAll = createOperation("excludingAll", _Collection_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE);
		private final @NonNull Operation op_Collection_flatten = createOperation("flatten", _Collection_$$1_F, "org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation", org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation.INSTANCE, tp_Collection_flatten_T2);
		...
		private final @NonNull Operation op_Collection_including = createOperation("including", _Collection_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE);
		private final @NonNull Operation op_Collection_includingAll = createOperation("includingAll", _Collection_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE);
		private final @NonNull Operation op_Collection_intersection = createOperation("intersection", _Bag_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIntersectionOperation", org.eclipse.ocl.pivot.library.collection.CollectionIntersectionOperation.INSTANCE);
		private final @NonNull Operation op_Collection_intersection_1 = createOperation("intersection", _Set_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIntersectionOperation", org.eclipse.ocl.pivot.library.collection.CollectionIntersectionOperation.INSTANCE);
		...
		private final @NonNull Operation op_Collection_union = createOperation("union", _Bag_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionUnionOperation", org.eclipse.ocl.pivot.library.collection.CollectionUnionOperation.INSTANCE);
		private final @NonNull Operation op_Enumeration_allInstances = createOperation("allInstances", _Set_OclSelf_T_L1_U1, "org.eclipse.ocl.pivot.library.classifier.ClassifierAllInstancesOperation", org.eclipse.ocl.pivot.library.classifier.ClassifierAllInstancesOperation.INSTANCE);
		private final @NonNull Operation op_InvalidType_allInstances = createOperation("allInstances", _Set_OclSelf_F, "org.eclipse.ocl.pivot.library.classifier.ClassifierAllInstancesOperation", org.eclipse.ocl.pivot.library.classifier.ClassifierAllInstancesOperation.INSTANCE);
		...
		private final @NonNull Operation op_Map_keys = createOperation("keys", _Set_$$0_F, "org.eclipse.ocl.pivot.library.map.MapKeysOperation", org.eclipse.ocl.pivot.library.map.MapKeysOperation.INSTANCE);
		...
		private final @NonNull Operation op_Map_values = createOperation("values", _Bag_$$1_F, "org.eclipse.ocl.pivot.library.map.MapValuesOperation", org.eclipse.ocl.pivot.library.map.MapValuesOperation.INSTANCE);
		...
		private final @NonNull Operation op_OclAny_oclAsSet = createOperation("oclAsSet", _Set_OclSelf_T_L1_U1, "org.eclipse.ocl.pivot.library.oclany.OclAnyOclAsSetOperation", org.eclipse.ocl.pivot.library.oclany.OclAnyOclAsSetOperation.INSTANCE);
		...
		private final @NonNull Operation op_OclAny_oclTypes = createOperation("oclTypes", _Set_OclSelf_F_L1_U1, "org.eclipse.ocl.pivot.library.oclany.OclAnyOclTypesOperation", org.eclipse.ocl.pivot.library.oclany.OclAnyOclTypesOperation.INSTANCE);
		...
		private final @NonNull Operation op_OclVoid_oclTypes = createOperation("oclTypes", _Set_OclSelf_F_L1_U1, "org.eclipse.ocl.pivot.library.oclany.OclAnyOclTypesOperation", org.eclipse.ocl.pivot.library.oclany.OclAnyOclTypesOperation.INSTANCE);
		...
		private final @NonNull Operation op_OrderedSet__neg_ = createOperation("-", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.SetMinusOperation", org.eclipse.ocl.pivot.library.collection.SetMinusOperation.INSTANCE);
		...
		private final @NonNull Operation op_OrderedSet_append = createOperation("append", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_appendAll = createOperation("appendAll", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendAllOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendAllOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_excluding = createOperation("excluding", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_excludingAll = createOperation("excludingAll", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_flatten = createOperation("flatten", _OrderedSet_$$1_F, "org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation", org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation.INSTANCE, tp_OrderedSet_flatten_T2);
		private final @NonNull Operation op_OrderedSet_including = createOperation("including", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_includingAll = createOperation("includingAll", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_insertAt = createOperation("insertAt", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionInsertAtOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionInsertAtOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_prepend = createOperation("prepend", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_prependAll = createOperation("prependAll", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependAllOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependAllOperation.INSTANCE);
		private final @NonNull Operation op_OrderedSet_reverse = createOperation("reverse", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionReverseOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionReverseOperation.INSTANCE);
		...
		private final @NonNull Operation op_OrderedSet_subOrderedSet = createOperation("subOrderedSet", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedSetSubOrderedSetOperation", org.eclipse.ocl.pivot.library.collection.OrderedSetSubOrderedSetOperation.INSTANCE);
		...
		private final @NonNull Operation op_Sequence_append = createOperation("append", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_appendAll = createOperation("appendAll", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendAllOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendAllOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_excluding = createOperation("excluding", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_excludingAll = createOperation("excludingAll", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_flatten = createOperation("flatten", _Sequence_$$1_F, "org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation", org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation.INSTANCE, tp_Sequence_flatten_T2);
		private final @NonNull Operation op_Sequence_including = createOperation("including", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_includingAll = createOperation("includingAll", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_insertAt = createOperation("insertAt", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionInsertAtOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionInsertAtOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_prepend = createOperation("prepend", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_prependAll = createOperation("prependAll", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependAllOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependAllOperation.INSTANCE);
		private final @NonNull Operation op_Sequence_reverse = createOperation("reverse", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionReverseOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionReverseOperation.INSTANCE);
		...
		private final @NonNull Operation op_Sequence_subSequence = createOperation("subSequence", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.collection.SequenceSubSequenceOperation", org.eclipse.ocl.pivot.library.collection.SequenceSubSequenceOperation.INSTANCE);
		private final @NonNull Operation op_Set__neg_ = createOperation("-", _Set_$$0_F, "org.eclipse.ocl.pivot.library.collection.SetMinusOperation", org.eclipse.ocl.pivot.library.collection.SetMinusOperation.INSTANCE);
		...
		private final @NonNull Operation op_Set_excluding = createOperation("excluding", _Set_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE);
		private final @NonNull Operation op_Set_excludingAll = createOperation("excludingAll", _Set_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE);
		private final @NonNull Operation op_Set_flatten = createOperation("flatten", _Set_$$1_F, "org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation", org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation.INSTANCE, tp_Set_flatten_T2);
		private final @NonNull Operation op_Set_including = createOperation("including", _Set_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE);
		private final @NonNull Operation op_Set_includingAll = createOperation("includingAll", _Set_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE);
		...
		private final @NonNull Operation op_UniqueCollection__neg_ = createOperation("-", _UniqueCollection_$$0_F, "org.eclipse.ocl.pivot.library.collection.SetMinusOperation", org.eclipse.ocl.pivot.library.collection.SetMinusOperation.INSTANCE);
		private final @NonNull Operation op_UniqueCollection_intersection = createOperation("intersection", _Set_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionIntersectionOperation", org.eclipse.ocl.pivot.library.collection.CollectionIntersectionOperation.INSTANCE);
		private final @NonNull Operation op_UniqueCollection_symmetricDifference = createOperation("symmetricDifference", _Set_$$0_F, "org.eclipse.ocl.pivot.library.collection.SetSymmetricDifferenceOperation", org.eclipse.ocl.pivot.library.collection.SetSymmetricDifferenceOperation.INSTANCE);
		private final @NonNull Operation op_UniqueCollection_union = createOperation("union", _Set_$$0_F, "org.eclipse.ocl.pivot.library.collection.CollectionUnionOperation", org.eclipse.ocl.pivot.library.collection.CollectionUnionOperation.INSTANCE);
		private final @NonNull Operation op_VoidType_allInstances = createOperation("allInstances", _Set_OclSelf_F_L1_U1, "org.eclipse.ocl.pivot.library.classifier.ClassifierAllInstancesOperation", org.eclipse.ocl.pivot.library.classifier.ClassifierAllInstancesOperation.INSTANCE);
		...
		private void installOperations() {
			...
			operation.setIsRequired(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("objects", _Collection_$$0_F, true));
			...
			operation.setIsRequired(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("c2", _Collection_$$1_F, true));
			...
			operation.setIsRequired(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("c", _Collection_$$0_F, true));
			ownedOperations.add(operation = op_Collection_intersection_1);
			operation.setIsRequired(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("u", _UniqueCollection_$$0_F, true));
			...
			operation.setIsRequired(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("coll", _Collection_$$2_F, true));
			ownedOperations.add(operation = op_Map_excludesMap);
			operation.setIsRequired(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("map", _Map_$$2_T_$$3_T, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("keys", _Collection_$$0_F, true));
			...
			operation.setIsRequired(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("objects", _OrderedCollection_$$0_F, true));
			...
			operation.setIsRequired(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("s", _UniqueCollection_$$0_F, true));
		...
		private final @NonNull Iteration it_Bag_reject = createIteration("reject", _Bag_$$0_F, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		private final @NonNull Iteration it_Bag_select = createIteration("select", _Bag_$$0_F, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE);
		private final @NonNull Iteration it_Bag_sortedBy = createIteration("sortedBy", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE);
		...
		private final @NonNull Iteration it_Collection_collectBy = createIteration("collectBy", _Map_$$0_T_$$1_T, "org.eclipse.ocl.pivot.library.iterator.CollectByIteration", org.eclipse.ocl.pivot.library.iterator.CollectByIteration.INSTANCE, tp_Collection_collectBy_E);
		...
		private final @NonNull Iteration it_Collection_gather = createIteration("gather", _Bag_$$1_F, "org.eclipse.ocl.pivot.library.iterator.GatherIteration", org.eclipse.ocl.pivot.library.iterator.GatherIteration.INSTANCE, tp_Collection_gather_V);
		...
		private final @NonNull Iteration it_Collection_reject = createIteration("reject", _Collection_$$0_F, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		private final @NonNull Iteration it_Collection_search = createIteration("search", $$2, "org.eclipse.ocl.pivot.library.iterator.SearchIteration", org.eclipse.ocl.pivot.library.iterator.SearchIteration.INSTANCE, tp_Collection_search_Q, tp_Collection_search_R);
		private final @NonNull Iteration it_Collection_search_1 = createIteration("search", $$2, "org.eclipse.ocl.pivot.library.iterator.SearchIteration", org.eclipse.ocl.pivot.library.iterator.SearchIteration.INSTANCE, tp_Collection_search_Q_1, tp_Collection_search_R_1);
		private final @NonNull Iteration it_Collection_search_2 = createIteration("search", $$2, "org.eclipse.ocl.pivot.library.iterator.SearchIteration", org.eclipse.ocl.pivot.library.iterator.SearchIteration.INSTANCE, tp_Collection_search_Q_2, tp_Collection_search_R_2);
		private final @NonNull Iteration it_Collection_select = createIteration("select", _Collection_$$0_F, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE);
		private final @NonNull Iteration it_Collection_sortedBy = createIteration("sortedBy", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE);
		...
		private final @NonNull Iteration it_Map_collectBy = createIteration("collectBy", _Map_$$0_T_$$2_T, "org.eclipse.ocl.pivot.library.iterator.CollectByIteration", org.eclipse.ocl.pivot.library.iterator.CollectByIteration.INSTANCE, tp_Map_collectBy_E);
		...
		private final @NonNull Iteration it_Map_gather = createIteration("gather", _Bag_$$2_F, "org.eclipse.ocl.pivot.library.iterator.GatherIteration", org.eclipse.ocl.pivot.library.iterator.GatherIteration.INSTANCE, tp_Map_gather_E);
		...
		private final @NonNull Iteration it_Map_reject = createIteration("reject", _Map_$$0_T_$$1_T, "org.eclipse.ocl.pivot.library.iterator.MapRejectIteration", org.eclipse.ocl.pivot.library.iterator.MapRejectIteration.INSTANCE);
		private final @NonNull Iteration it_Map_search = createIteration("search", $$3, "org.eclipse.ocl.pivot.library.iterator.SearchIteration", org.eclipse.ocl.pivot.library.iterator.SearchIteration.INSTANCE, tp_Map_search_Q, tp_Map_search_R);
		private final @NonNull Iteration it_Map_search_1 = createIteration("search", $$3, "org.eclipse.ocl.pivot.library.iterator.SearchIteration", org.eclipse.ocl.pivot.library.iterator.SearchIteration.INSTANCE, tp_Map_search_Q_1, tp_Map_search_R_1);
		private final @NonNull Iteration it_Map_search_2 = createIteration("search", $$3, "org.eclipse.ocl.pivot.library.iterator.SearchIteration", org.eclipse.ocl.pivot.library.iterator.SearchIteration.INSTANCE, tp_Map_search_Q_2, tp_Map_search_R_2);
		private final @NonNull Iteration it_Map_select = createIteration("select", _Map_$$0_T_$$1_T, "org.eclipse.ocl.pivot.library.iterator.MapSelectIteration", org.eclipse.ocl.pivot.library.iterator.MapSelectIteration.INSTANCE);
		private final @NonNull Iteration it_OrderedCollection_gather = createIteration("gather", _Sequence_$$1_F, "org.eclipse.ocl.pivot.library.iterator.GatherIteration", org.eclipse.ocl.pivot.library.iterator.GatherIteration.INSTANCE, tp_OrderedCollection_gather_E);
		...
		private final @NonNull Iteration it_OrderedSet_reject = createIteration("reject", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		private final @NonNull Iteration it_OrderedSet_select = createIteration("select", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE);
		private final @NonNull Iteration it_OrderedSet_sortedBy = createIteration("sortedBy", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE);
		...
		private final @NonNull Iteration it_Sequence_reject = createIteration("reject", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		private final @NonNull Iteration it_Sequence_select = createIteration("select", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE);
		private final @NonNull Iteration it_Sequence_sortedBy = createIteration("sortedBy", _Sequence_$$0_F, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE);
		...
		private final @NonNull Iteration it_Set_reject = createIteration("reject", _Set_$$0_F, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE);
		private final @NonNull Iteration it_Set_select = createIteration("select", _Set_$$0_F, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE);
		private final @NonNull Iteration it_Set_sortedBy = createIteration("sortedBy", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE);
		private final @NonNull Iteration it_UniqueCollection_sortedBy = createIteration("sortedBy", _OrderedSet_$$0_F, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE);
		...
		private void installIterations() {
			...
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$1_F_result_Collection_F, false));
			ownedIterations.add(iteration = it_Bag_collectNested);
			iteration.setIsRequired(true);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_$$1_F, false));
			...
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_Boolean_T, false));
			...
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_OclComparable_F, false));
			...
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_Boolean_F, false));
			...
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_Boolean_F, false));
			ownedIterations.add(iteration = it_Collection_gather);
			iteration.setIsRequired(true);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_OclAny_F, false));
			...
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_Boolean_T, false));
			ownedIterations.add(iteration = it_Collection_search);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters.add(parameter = createParameter("j", $$0, false));
			ownedParameters.add(parameter = createParameter("k", $$0, false));
			iteration.setOwnedAccumulator(parameter = createParameter("acc", $$1, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_self_$$1_F_i_$$0_F_j_$$0_F_k_$$0_F_result_$$1_F, false));
			ownedParameters.add(parameter = createParameter("break", _Lambda_self_$$1_F_i_$$0_F_j_$$0_F_k_$$0_F_result_Boolean_F, false));
			ownedParameters.add(parameter = createParameter("return", _Lambda_self_$$1_F_i_$$0_F_j_$$0_F_k_$$0_F_result_$$2_F, false));
			...
			iteration.setOwnedAccumulator(parameter = createParameter("acc", $$1, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_self_$$1_F_i_$$0_F_j_$$0_F_result_$$1_F, false));
			ownedParameters.add(parameter = createParameter("break", _Lambda_self_$$1_F_i_$$0_F_j_$$0_F_result_Boolean_F, false));
			ownedParameters.add(parameter = createParameter("return", _Lambda_self_$$1_F_i_$$0_F_j_$$0_F_result_$$2_F, false));
			ownedIterations.add(iteration = it_Collection_search_2);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			iteration.setOwnedAccumulator(parameter = createParameter("acc", $$1, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_self_$$1_F_i_$$0_F_result_$$1_F, false));
			ownedParameters.add(parameter = createParameter("break", _Lambda_self_$$1_F_i_$$0_F_result_Boolean_F, false));
			ownedParameters.add(parameter = createParameter("return", _Lambda_self_$$1_F_i_$$0_F_result_$$2_F, false));
			...
			ownedParameters.add(parameter = createParameter("k", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_$$2_F, false));
			...
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_Boolean_F, false));
			ownedIterations.add(iteration = it_Map_gather);
			iteration.setIsRequired(true);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_Boolean_T, false));
			ownedIterations.add(iteration = it_Map_search);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters.add(parameter = createParameter("j", $$0, false));
			ownedParameters.add(parameter = createParameter("k", $$0, false));
			iteration.setOwnedAccumulator(parameter = createParameter("acc", $$2, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_self_$$2_F_i_$$0_F_j_$$0_F_k_$$0_F_result_$$2_F, false));
			ownedParameters.add(parameter = createParameter("break", _Lambda_self_$$2_F_i_$$0_F_j_$$0_F_k_$$0_F_result_Boolean_F, false));
			ownedParameters.add(parameter = createParameter("return", _Lambda_self_$$2_F_i_$$0_F_j_$$0_F_k_$$0_F_result_$$3_F, false));
			...
			iteration.setOwnedAccumulator(parameter = createParameter("acc", $$2, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_self_$$2_F_i_$$0_F_j_$$0_F_result_$$2_F, false));
			ownedParameters.add(parameter = createParameter("break", _Lambda_self_$$2_F_i_$$0_F_j_$$0_F_result_Boolean_F, false));
			ownedParameters.add(parameter = createParameter("return", _Lambda_self_$$2_F_i_$$0_F_j_$$0_F_result_$$3_F, false));
			ownedIterations.add(iteration = it_Map_search_2);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			iteration.setOwnedAccumulator(parameter = createParameter("acc", $$2, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_self_$$2_F_i_$$0_F_result_$$2_F, false));
			ownedParameters.add(parameter = createParameter("break", _Lambda_self_$$2_F_i_$$0_F_result_Boolean_F, false));
			ownedParameters.add(parameter = createParameter("return", _Lambda_self_$$2_F_i_$$0_F_result_$$3_F, false));
			...
			ownedIterations = _OrderedCollection_OrderedCollection_T.getOwnedOperations();
			ownedIterations.add(iteration = it_OrderedCollection_gather);
			iteration.setIsRequired(true);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedParameters.add(parameter = createParameter("i", $$1, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$1_F_result_OrderedCollection_F, false));
		...
		private void installTemplateBindings() {
			...
			addBinding(_Collection_Integer_T, _Integer);
			...
			addBinding(_Collection_OclElement_T, _OclElement);
			addBinding(_Collection_OclInvalid_F, _OclInvalid);
			addBinding(_Collection_OclSelf_F, _OclSelf);
			addBinding(_Collection_OclSelf_F_L1_U1, _OclSelf);
			...
			addBinding(_Map_$$0_T_$$2_T, $$0);
			addBinding(_Map_$$0_T_$$2_T, $$2);
			...
			addBinding(_OrderedCollection_Integer_T, _Integer);
			addBinding(_OrderedCollection_String_T, _String);
			addBinding(_OrderedSet_$$0_F, $$0);
			addBinding(_OrderedSet_$$1_F, $$1);
			addBinding(_OrderedSet_$$1_T, $$1);
			addBinding(_Sequence_$$0_F, $$0);
			...
			addBinding(_Set_OclSelf_F_L1_U1, _OclSelf);
			...
			addBinding(_UniqueCollection_$$1_T, $$1);
			addBinding(_UniqueCollection_OclAny_F, _OclAny);
			addBinding(_UniqueCollection_OclElement_T, _OclElement);
			addBinding(_UniqueCollection_OclSelf_F, _OclSelf);
			addBinding(_UniqueCollection_OclSelf_F_L1_U1, _OclSelf);
		...
		private void installPrecedences() {
			...
			ownedPrecedences = library.getOwnedPrecedences();
		...
		private void installComments() {
			...
			installComment(it_Bag_closure, "The closure of applying body transitively to every distinct non-null element of the source collection.");
			...
			installComment(it_Collection_gather, "The bag of elements which results from applying oclText[lambda] to every member of the source collection.");
			...
			installComment(it_Collection_search, "Search the source elements three-dimensionally using each element triple in turn to update oclText[acc] with oclText[next] the result of oclText[source.nextAcc(nextAcc,i,j,k)].\nThe search proceeds so long as oclText[source.break(nextAcc,i,j,k)] returns oclText[true].\nThe final result for a non-empty collection is determined by oclText[source.return(nextAcc,i,j,k)].\nFor an empty collection the final result is determined by oclText[source.return(nextAcc,null,null,null)].");
			installComment(it_Collection_search_1, "Search the source elements two-dimensionally using each element pair in turn to update oclText[acc] with oclText[next] the result of oclText[source.nextAcc(nextAcc,i,j)].\nThe search proceeds so long as oclText[source.break(nextAcc,i,j)] returns oclText[true].\nThe final result for a non-empty collection is determined by oclText[source.return(nextAcc,i,j)].\nFor an empty collection the final result is determined by oclText[source.return(nextAcc,null,null)].");
			installComment(it_Collection_search_2, "Search the source elements one-dimensionally using each element in turn to update oclText[acc] with oclText[next] the result of oclText[source.nextAcc(nextAcc,i)].\nThe search proceeds so long as oclText[source.break(nextAcc,i)] returns oclText[true].\nThe final result for a non-empty collection is determined by oclText[source.return(nextAcc,i)].\nFor an empty collection the final result is determined by oclText[source.return(nextAcc,null)].");
			...
			installComment(it_Map_gather, "The bag of elements which results from applying oclText[lambda] to every member of the source collection.");
			...
			installComment(it_Map_search, "Search the source keys three-dimensionally using each key triple in turn to update oclText[acc] with oclText[next] the result of oclText[source.nextAcc(nextAcc,i,j,k)].\nThe search proceeds so long as oclText[source.break(nextAcc,i,j,k)] returns oclText[true].\nThe final result for a non-empty collection is determined by oclText[source.return(nextAcc,i,j,k)].\nFor an empty map the final result is determined by oclText[source.return(nextAcc,null,null,null)].");
			installComment(it_Map_search_1, "Search the source keys two-dimensionally using each key pair in turn to update oclText[acc] with oclText[next] the result of oclText[source.nextAcc(nextAcc,i,j)].\nThe search proceeds so long as oclText[source.break(nextAcc,i,j)] returns oclText[true].\nThe final result for a non-empty collection is determined by oclText[source.return(nextAcc,i,j)].\nFor an empty map the final result is determined by oclText[source.return(nextAcc,null,null)].");
			installComment(it_Map_search_2, "Search the source keys one-dimensionally using each key in turn to update oclText[acc] with oclText[next] the result of oclText[source.nextAcc(nextAcc,i)].\nThe search proceeds so long as oclText[source.break(nextAcc,i)] returns oclText[true].\nThe final result for a non-empty collection is determined by oclText[source.return(nextAcc,i)].\nFor an empty map the final result is determined by oclText[source.return(nextAcc,null)].");
			...
			installComment(it_OrderedCollection_gather, "The sequence of elements which results from applying oclText[lambda] to every member of the source collection.");
			...
			installComment(it_OrderedSet_closure, "The closure of applying body transitively to every distinct non-null element of the source collection.");
			...
			installComment(it_Sequence_closure, "The closure of applying body transitively to every distinct non-null element of the source collection.");
			...
			installComment(it_Set_closure, "The closure of applying body transitively to every distinct non-null element of the source collection.");
