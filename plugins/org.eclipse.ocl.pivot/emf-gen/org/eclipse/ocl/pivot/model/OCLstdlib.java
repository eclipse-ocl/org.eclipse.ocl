...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private final @NonNull TemplateParameter tp_Collection_search_V = createTemplateParameter("V");
		private final @NonNull TemplateParameter tp_Collection_search_W = createTemplateParameter("W");
		...
		private final @NonNull TemplateParameter tp_Map_search_W = createTemplateParameter("W");
		...
		private final @NonNull LambdaType _Lambda_Collection_T_Collection_search_V = createLambdaType("Lambda");
		private final @NonNull LambdaType _Lambda_Collection_T_Collection_search_W = createLambdaType("Lambda");
		...
		private final @NonNull LambdaType _Lambda_Map_K_Map_search_W = createLambdaType("Lambda");
		...
		private void installLambdaTypes() {
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_Collection_T_Collection_search_V);
			type.setContextType(tp_Collection_T);
			type.setResultType(tp_Collection_search_V);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_Collection_T_Collection_search_W);
			type.setContextType(tp_Collection_T);
			type.setResultType(tp_Collection_search_W);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_Map_K_Map_search_W);
			type.setContextType(tp_Map_K);
			type.setResultType(tp_Map_search_W);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
		...
		private final @NonNull Iteration it_Collection_search = createIteration("search", tp_Collection_search_V, "org.eclipse.ocl.pivot.library.iterator.SearchIteration", org.eclipse.ocl.pivot.library.iterator.SearchIteration.INSTANCE, tp_Collection_search_V, tp_Collection_search_W);
		...
		private final @NonNull Iteration it_Map_search = createIteration("search", tp_Map_search_V2, "org.eclipse.ocl.pivot.library.iterator.SearchIteration", org.eclipse.ocl.pivot.library.iterator.SearchIteration.INSTANCE, tp_Map_search_V2, tp_Map_search_W);
		...
		private void installIterations() {
			...
			ownedParameters.add(parameter = createParameter("i", tp_Collection_T, false));
			ownedParameters = iteration.getOwnedAccumulators();
			ownedParameters.add(parameter = createParameter("acc", tp_Collection_search_W, true));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_Collection_T_Collection_search_W, false));
			ownedParameters.add(parameter = createParameter("isDone", _Lambda_Collection_T_Boolean, false));
			ownedParameters.add(parameter = createParameter("result", _Lambda_Collection_T_Collection_search_V, false));
			...
			ownedParameters.add(parameter = createParameter("i", tp_Map_K, false));
			ownedParameters = iteration.getOwnedAccumulators();
			ownedParameters.add(parameter = createParameter("acc", tp_Map_search_W, true));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("nextAcc", _Lambda_Map_K_Map_search_W, false));
