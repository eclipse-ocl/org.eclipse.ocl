...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private final @NonNull InvalidableType _Invalidable = createInvalidableType(OCLstdlibPackage.Literals.INVALIDABLE);
		private final @NonNull NullableType _Nullable = createNullableType(OCLstdlibPackage.Literals.NULLABLE);
		...
		private final @NonNull TemplateParameter tp_Invalidable_T = createTemplateParameter("T");
		...
		private final @NonNull TemplateParameter tp_Nullable_T = createTemplateParameter("T");
		...
		private void installClassTypes() {
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Invalidable);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclType);
			createTemplateSignature(type, tp_Invalidable_T);
			ownedClasses.add(type = _Nullable);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclType);
			createTemplateSignature(type, tp_Nullable_T);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _OclEnumeration);
			type.setIsAbstract(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclType);
		...
		private void installCollectionTypes() {
			...
			ownedClasses.add(type = _Bag_Bag_collectNested_V_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_Bag_collectNested_V);
			ownedClasses.add(type = _Bag_Bag_collect_V_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_Bag_collect_V);
			ownedClasses.add(type = _Bag_Bag_flatten_T2_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			...
			ownedClasses.add(type = _Bag_Set_collect_V_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_Bag_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_Collection_collect_V_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_Collection_excludesAll_T2_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_Collection_flatten_T2_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_Collection_includesAll_T2_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_Collection_product_T2_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_Map_includesAll_K2_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_OclAny_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_OrderedCollection_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_Set_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_UniqueCollection_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			...
			ownedClasses.add(type = _OrderedCollection_OrderedSet_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			...
			ownedClasses.add(type = _OrderedCollection_Sequence_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			...
			ownedClasses.add(type = _OrderedSet_Collection_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			...
			ownedClasses.add(type = _OrderedSet_OrderedSet_flatten_T2_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			...
			ownedClasses.add(type = _Sequence_String_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_String);
			ownedClasses.add(type = _Sequence_Bag_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_Bag_T);
			ownedClasses.add(type = _Sequence_Collection_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_Collection_T);
			ownedClasses.add(type = _Sequence_OrderedSet_collectNested_V_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_OrderedSet_collectNested_V);
			ownedClasses.add(type = _Sequence_OrderedSet_collect_V_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_OrderedSet_collect_V);
			ownedClasses.add(type = _Sequence_Sequence_collectNested_V_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_Sequence_collectNested_V);
			ownedClasses.add(type = _Sequence_Sequence_collect_V_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_OrderedCollection_Sequence_collect_V);
			ownedClasses.add(type = _Sequence_Sequence_flatten_T2_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			...
			ownedClasses.add(type = _Set_Bag_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_Bag_T);
			ownedClasses.add(type = _Set_Collection_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_Collection_T);
			ownedClasses.add(type = _Set_Map_K_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_OclSelf);
			ownedClasses.add(type = _Set_Set_flatten_T2_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			...
			ownedClasses.add(type = _Set_UniqueCollection_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_UniqueCollection_UniqueCollection_T_1);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_Bag_T);
			ownedClasses.add(type = _UniqueCollection_Collection_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_Collection_T_1);
			...
			ownedClasses.add(type = _UniqueCollection_OclAny_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_OrderedSet_selectByType_TT);
			ownedClasses.add(type = _UniqueCollection_OrderedSet_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_OrderedSet_T);
			...
			ownedClasses.add(type = _UniqueCollection_Set_T_NullFree);
			type.setIsNullFree(true);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_Set_T);
		...
		private final @NonNull NullableType _Nullable_Lambda_Bag_T = createNullableType(_Nullable, _Lambda_Bag_T_1);
		private final @NonNull NullableType _Nullable_Lambda_Bag_T_1 = createNullableType(_Nullable, _Lambda_Bag_T_2);
		private final @NonNull NullableType _Nullable_Lambda_Bag_T_2 = createNullableType(_Nullable, _Lambda_Bag_T_3);
		private final @NonNull NullableType _Nullable_Lambda_Bag_T_3 = createNullableType(_Nullable, _Lambda_Bag_T_4);
		private final @NonNull NullableType _Nullable_Lambda_Collection_T = createNullableType(_Nullable, _Lambda_Collection_T);
		private final @NonNull NullableType _Nullable_Lambda_Collection_T_1 = createNullableType(_Nullable, _Lambda_Collection_T);
		private final @NonNull NullableType _Nullable_Lambda_Collection_T_2 = createNullableType(_Nullable, _Lambda_Collection_T_1);
		private final @NonNull NullableType _Nullable_Lambda_Collection_T_3 = createNullableType(_Nullable, _Lambda_Collection_T_2);
		private final @NonNull NullableType _Nullable_Lambda_Collection_T_4 = createNullableType(_Nullable, _Lambda_Collection_T_3);
		private final @NonNull NullableType _Nullable_Lambda_Collection_T_5 = createNullableType(_Nullable, _Lambda_Collection_T_4);
		private final @NonNull NullableType _Nullable_Lambda_OrderedSet_T = createNullableType(_Nullable, _Lambda_OrderedSet_T_1);
		private final @NonNull NullableType _Nullable_Lambda_OrderedSet_T_1 = createNullableType(_Nullable, _Lambda_OrderedSet_T_3);
		private final @NonNull NullableType _Nullable_Lambda_OrderedSet_T_2 = createNullableType(_Nullable, _Lambda_OrderedSet_T_4);
		private final @NonNull NullableType _Nullable_Lambda_OrderedSet_T_3 = createNullableType(_Nullable, _Lambda_OrderedSet_T_2);
		private final @NonNull NullableType _Nullable_Lambda_Sequence_T = createNullableType(_Nullable, _Lambda_Sequence_T_1);
		private final @NonNull NullableType _Nullable_Lambda_Sequence_T_1 = createNullableType(_Nullable, _Lambda_Sequence_T_2);
		private final @NonNull NullableType _Nullable_Lambda_Sequence_T_2 = createNullableType(_Nullable, _Lambda_Sequence_T_3);
		private final @NonNull NullableType _Nullable_Lambda_Sequence_T_3 = createNullableType(_Nullable, _Lambda_Sequence_T_4);
		...
		private final @NonNull NullableType _Nullable_Map = createNullableType(_Nullable, _Map_Map_excludesMap_K2_Map_excludesMap_V2);
		private final @NonNull NullableType _Nullable_Map_1 = createNullableType(_Nullable, _Map_Map_excludingMap_K2_Map_excludingMap_V2);
		private final @NonNull NullableType _Nullable_Map_2 = createNullableType(_Nullable, _Map_Map_includesMap_K2_Map_includesMap_V2);
		private final @NonNull NullableType _Nullable_Map_3 = createNullableType(_Nullable, _Map_Map_includingMap_K2_Map_includingMap_V2);
		...
		private void installNullableTypes() {
			...
			orphanTypes.add(_Nullable_Boolean_1);
			orphanTypes.add(_Nullable_Integer);
			orphanTypes.add(_Nullable_Integer_1);
			...
			orphanTypes.add(_Nullable_Lambda_Collection_T_5);
			...
			orphanTypes.add(_Nullable_String_1);
			orphanTypes.add(_Nullable_UnlimitedNatural_oclAsType_TT);
			orphanTypes.add(_Nullable_UnlimitedNatural_oclAsType_TT_1);
			orphanTypes.add(_Nullable_Bag_selectByKind_TT);
			orphanTypes.add(_Nullable_Bag_selectByType_TT);
			orphanTypes.add(_Nullable_Bag_T);
			orphanTypes.add(_Nullable_Collection_iterate_Tacc);
			orphanTypes.add(_Nullable_Collection_selectByKind_TT);
			orphanTypes.add(_Nullable_Collection_selectByType_TT);
			orphanTypes.add(_Nullable_Collection_T);
			orphanTypes.add(_Nullable_Collection_T_1);
			orphanTypes.add(_Nullable_Map);
			orphanTypes.add(_Nullable_Map_1);
			orphanTypes.add(_Nullable_Map_2);
			orphanTypes.add(_Nullable_Map_3);
			orphanTypes.add(_Nullable_Map_K);
			orphanTypes.add(_Nullable_Map_V);
			orphanTypes.add(_Nullable_Map_V_1);
			orphanTypes.add(_Nullable_Map_4);
			orphanTypes.add(_Nullable_OclAny_oclAsType_TT);
			orphanTypes.add(_Nullable_OclAny_oclAsType_TT_1);
			orphanTypes.add(_Nullable_OclAny);
			orphanTypes.add(_Nullable_OclElement_oclAsModelType_TT);
			orphanTypes.add(_Nullable_OclElement_oclAsModelType_TT_1);
			orphanTypes.add(_Nullable_OclElement);
			orphanTypes.add(_Nullable_OclInvalid_oclAsType_TT);
			orphanTypes.add(_Nullable_OclSelf);
			orphanTypes.add(_Nullable_OclState);
			orphanTypes.add(_Nullable_OclType);
			orphanTypes.add(_Nullable_OrderedCollection_T);
			orphanTypes.add(_Nullable_OrderedCollection_T_1);
			orphanTypes.add(_Nullable_OrderedSet_selectByKind_TT);
			orphanTypes.add(_Nullable_OrderedSet_selectByType_TT);
			orphanTypes.add(_Nullable_OrderedSet_T);
			orphanTypes.add(_Nullable_OrderedSet);
			orphanTypes.add(_Nullable_Sequence_selectByKind_TT);
			orphanTypes.add(_Nullable_Sequence_selectByType_TT);
			orphanTypes.add(_Nullable_Sequence_T);
			orphanTypes.add(_Nullable_Sequence);
			orphanTypes.add(_Nullable_Set_selectByKind_TT);
			orphanTypes.add(_Nullable_Set_selectByType_TT);
			orphanTypes.add(_Nullable_Set_T);
			orphanTypes.add(_Nullable_Type);
			orphanTypes.add(_Nullable_UniqueCollection_T);
		}
		...
		private final @NonNull InvalidableType _Invalidable_Lambda_Collection_T = createInvalidableType(_Invalidable, _Nullable_Lambda_Collection_T);
		...
		private final @NonNull InvalidableType _Invalidable_Map_V = createInvalidableType(_Invalidable, _Nullable_Map_V);
		...
		private final @NonNull InvalidableType _Invalidable_OclElement_oclAsModelType_TT = createInvalidableType(_Invalidable, _Nullable_OclElement_oclAsModelType_TT_1);
		private final @NonNull InvalidableType _Invalidable_OrderedCollection_T = createInvalidableType(_Invalidable, _Nullable_OrderedCollection_T);
		...
		private void installInvalidableTypes() {
			final List<Class> orphanTypes = orphanage.getOwnedClasses();
			orphanTypes.add(_Invalidable_Boolean);
			orphanTypes.add(_Invalidable_Integer);
			orphanTypes.add(_Invalidable_Lambda_Collection_T);
			orphanTypes.add(_Invalidable_Real);
			orphanTypes.add(_Invalidable_String);
			orphanTypes.add(_Invalidable_UnlimitedNatural_oclAsType_TT);
			orphanTypes.add(_Invalidable_Collection_T);
			orphanTypes.add(_Invalidable_Map_V);
			orphanTypes.add(_Invalidable_OclAny_oclAsType_TT);
			orphanTypes.add(_Invalidable_OclElement_oclAsModelType_TT);
			orphanTypes.add(_Invalidable_OrderedCollection_T);
			orphanTypes.add(_Invalidable_OrderedSet);
			orphanTypes.add(_Invalidable_Sequence);
		}
		...
		private final @NonNull Operation op_Boolean_and = createOperation("and", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.logical.BooleanAndOperation", org.eclipse.ocl.pivot.library.logical.BooleanAndOperation.INSTANCE);
		private final @NonNull Operation op_Boolean_and2 = createOperation("and2", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.logical.BooleanAndOperation2", org.eclipse.ocl.pivot.library.logical.BooleanAndOperation2.INSTANCE);
		private final @NonNull Operation op_Boolean_implies = createOperation("implies", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.logical.BooleanImpliesOperation", org.eclipse.ocl.pivot.library.logical.BooleanImpliesOperation.INSTANCE);
		private final @NonNull Operation op_Boolean_implies2 = createOperation("implies2", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.logical.BooleanImpliesOperation2", org.eclipse.ocl.pivot.library.logical.BooleanImpliesOperation2.INSTANCE);
		private final @NonNull Operation op_Boolean_not = createOperation("not", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.logical.BooleanNotOperation", org.eclipse.ocl.pivot.library.logical.BooleanNotOperation.INSTANCE);
		...
		private final @NonNull Operation op_Boolean_or = createOperation("or", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.logical.BooleanOrOperation", org.eclipse.ocl.pivot.library.logical.BooleanOrOperation.INSTANCE);
		private final @NonNull Operation op_Boolean_or2 = createOperation("or2", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.logical.BooleanOrOperation2", org.eclipse.ocl.pivot.library.logical.BooleanOrOperation2.INSTANCE);
		...
		private final @NonNull Operation op_Boolean_xor = createOperation("xor", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.logical.BooleanXorOperation", org.eclipse.ocl.pivot.library.logical.BooleanXorOperation.INSTANCE);
		private final @NonNull Operation op_Boolean_xor2 = createOperation("xor2", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.logical.BooleanXorOperation2", org.eclipse.ocl.pivot.library.logical.BooleanXorOperation2.INSTANCE);
		...
		private final @NonNull Operation op_UnlimitedNatural_oclAsType = createOperation("oclAsType", _Nullable_UnlimitedNatural_oclAsType_TT_1, "org.eclipse.ocl.pivot.library.numeric.UnlimitedNaturalOclAsTypeOperation", org.eclipse.ocl.pivot.library.numeric.UnlimitedNaturalOclAsTypeOperation.INSTANCE, tp_UnlimitedNatural_oclAsType_TT);
		...
		private final @NonNull Operation op_Map_at = createOperation("at", _Nullable_Map_V_1, "org.eclipse.ocl.pivot.library.map.MapAtOperation", org.eclipse.ocl.pivot.library.map.MapAtOperation.INSTANCE);
		...
		private final @NonNull Operation op_Map_excluding = createOperation("excluding", _Nullable_Map_4, "org.eclipse.ocl.pivot.library.map.MapExcludingOperation", org.eclipse.ocl.pivot.library.map.MapExcludingOperation.INSTANCE);
		private final @NonNull Operation op_Map_excluding_1 = createOperation("excluding", _Nullable_Map_4, "org.eclipse.ocl.pivot.library.map.MapExcludingPairOperation", org.eclipse.ocl.pivot.library.map.MapExcludingPairOperation.INSTANCE);
		private final @NonNull Operation op_Map_excludingAll = createOperation("excludingAll", _Nullable_Map_4, "org.eclipse.ocl.pivot.library.map.MapExcludingAllOperation", org.eclipse.ocl.pivot.library.map.MapExcludingAllOperation.INSTANCE);
		private final @NonNull Operation op_Map_excludingMap = createOperation("excludingMap", _Nullable_Map_4, "org.eclipse.ocl.pivot.library.map.MapExcludingMapOperation", org.eclipse.ocl.pivot.library.map.MapExcludingMapOperation.INSTANCE, tp_Map_excludingMap_K2, tp_Map_excludingMap_V2);
		...
		private final @NonNull Operation op_Map_including = createOperation("including", _Nullable_Map_4, "org.eclipse.ocl.pivot.library.map.MapIncludingPairOperation", org.eclipse.ocl.pivot.library.map.MapIncludingPairOperation.INSTANCE);
		private final @NonNull Operation op_Map_includingMap = createOperation("includingMap", _Nullable_Map_4, "org.eclipse.ocl.pivot.library.map.MapIncludingMapOperation", org.eclipse.ocl.pivot.library.map.MapIncludingMapOperation.INSTANCE, tp_Map_includingMap_K2, tp_Map_includingMap_V2);
		...
		private final @NonNull Operation op_OclAny_oclLog = createOperation("oclLog", _Nullable_OclSelf, "org.eclipse.ocl.pivot.library.oclany.OclAnyOclLogOperation", org.eclipse.ocl.pivot.library.oclany.OclAnyOclLogOperation.INSTANCE);
		private final @NonNull Operation op_OclAny_oclLog_1 = createOperation("oclLog", _Nullable_OclSelf, "org.eclipse.ocl.pivot.library.oclany.OclAnyOclLogOperation", org.eclipse.ocl.pivot.library.oclany.OclAnyOclLogOperation.INSTANCE);
		...
		private final @NonNull Operation op_OclElement_oclContainer = createOperation("oclContainer", _Nullable_OclElement, "org.eclipse.ocl.pivot.library.classifier.ClassifierOclContainerOperation", org.eclipse.ocl.pivot.library.classifier.ClassifierOclContainerOperation.INSTANCE);
		...
		private final @NonNull Operation op_OclEnumeration_allInstances = createOperation("allInstances", _Set_OclSelf_NullFree, "org.eclipse.ocl.pivot.library.enumeration.EnumerationAllInstancesOperation", org.eclipse.ocl.pivot.library.enumeration.EnumerationAllInstancesOperation.INSTANCE);
		...
		private final @NonNull Operation op_OclInvalid_and = createOperation("and", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.logical.BooleanAndOperation", org.eclipse.ocl.pivot.library.logical.BooleanAndOperation.INSTANCE);
		private final @NonNull Operation op_OclInvalid_implies = createOperation("implies", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.logical.BooleanImpliesOperation", org.eclipse.ocl.pivot.library.logical.BooleanImpliesOperation.INSTANCE);
		...
		private final @NonNull Operation op_OclInvalid_oclAsType = createOperation("oclAsType", _Nullable_OclInvalid_oclAsType_TT, "org.eclipse.ocl.pivot.library.oclany.OclAnyOclAsTypeOperation", org.eclipse.ocl.pivot.library.oclany.OclAnyOclAsTypeOperation.INSTANCE, tp_OclInvalid_oclAsType_TT);
		...
		private final @NonNull Operation op_OclInvalid_or = createOperation("or", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.logical.BooleanAndOperation", org.eclipse.ocl.pivot.library.logical.BooleanAndOperation.INSTANCE);
		...
		private final @NonNull Operation op_OclMessage_result = createOperation("result", _Nullable_OclAny, "org.eclipse.ocl.pivot.library.oclany.OclAnyUnsupportedOperation", org.eclipse.ocl.pivot.library.oclany.OclAnyUnsupportedOperation.INSTANCE);
		...
		private final @NonNull Operation op_OclSummable_sum = createOperation("sum", _Nullable_OclSelf, null, null);
		private final @NonNull Operation op_OclSummable_zero = createOperation("zero", _Nullable_OclSelf, null, null);
		...
		private final @NonNull Operation op_OclType_asNonInvalid = createOperation("asNonInvalid", _OclType, "org.eclipse.ocl.pivot.library.classifier.OclTypeAsNonInvalidOperation", org.eclipse.ocl.pivot.library.classifier.OclTypeAsNonInvalidOperation.INSTANCE);
		private final @NonNull Operation op_OclType_asNonNull = createOperation("asNonNull", _OclType, "org.eclipse.ocl.pivot.library.classifier.OclTypeAsNonNullOperation", org.eclipse.ocl.pivot.library.classifier.OclTypeAsNonNullOperation.INSTANCE);
		...
		private final @NonNull Operation op_OclVoid_and = createOperation("and", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.oclvoid.OclVoidAndOperation", org.eclipse.ocl.pivot.library.oclvoid.OclVoidAndOperation.INSTANCE);
		private final @NonNull Operation op_OclVoid_implies = createOperation("implies", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.oclvoid.OclVoidImpliesOperation", org.eclipse.ocl.pivot.library.oclvoid.OclVoidImpliesOperation.INSTANCE);
		...
		private final @NonNull Operation op_OclVoid_or = createOperation("or", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.oclvoid.OclVoidOrOperation", org.eclipse.ocl.pivot.library.oclvoid.OclVoidOrOperation.INSTANCE);
		...
		private final @NonNull Operation op_OrderedCollection_at = createOperation("at", _Nullable_OrderedCollection_T_1, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAtOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAtOperation.INSTANCE);
		private final @NonNull Operation op_OrderedCollection_first = createOperation("first", _Nullable_OrderedCollection_T_1, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionFirstOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionFirstOperation.INSTANCE);
		...
		private final @NonNull Operation op_OrderedCollection_last = createOperation("last", _Nullable_OrderedCollection_T_1, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionLastOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionLastOperation.INSTANCE);
		...
		private void installOperations() {
			...
			ownedParameters.add(parameter = createParameter("object2", _Nullable_OclSelf, false));
			...
			operation.setBodyExpression(createExpressionInOCL(_Nullable_Boolean, "if self.oclIsInvalid() then\n\t\t        if b.oclIsInvalid() then self\n\t\t        elseif b = false then false\n\t\t        else self\n\t\t        endif\n\t\t      elseif self = false then false\n\t\t      elseif b.oclIsInvalid() then b\n\t\t      elseif b = false then false\n\t\t      elseif self = null then null\n\t\t      elseif b = null then null\n\t\t      else true\n\t\t      endif"));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("b", _Nullable_Boolean, false));
			ownedOperations.add(operation = op_Boolean_and2);
			operation.setIsRequired(false);
			operation.setBodyExpression(createExpressionInOCL(_Nullable_Boolean, "if self = false then false\n\t\t      elseif b = false then false\n\t\t      else true\n\t\t      endif"));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("b", _Nullable_Boolean, false));
			...
			operation.setIsRequired(false);
			operation.setBodyExpression(createExpressionInOCL(_Nullable_Boolean, "if self = false then true\n\t\t      elseif b = true then true\n\t\t      else false\n\t\t      endif"));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("b", _Nullable_Boolean, false));
			ownedOperations.add(operation = op_Boolean_not);
			operation.setIsRequired(false);
			operation.setIsValidating(true);
			operation.setBodyExpression(createExpressionInOCL(_Nullable_Boolean, "if self.oclIsInvalid() then self\n\t\t      elseif self = null then null\n\t\t      else self = false\n\t\t      endif"));
			ownedOperations.add(operation = op_Boolean_not2);
			operation.setBodyExpression(createExpressionInOCL(_Boolean, "if self then false else true endif"));
			...
			operation.setIsRequired(false);
			operation.setBodyExpression(createExpressionInOCL(_Nullable_Boolean, "if self = true then true\n\t\t\t  elseif b = true then true\n\t\t      else false\n\t\t      endif"));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("b", _Nullable_Boolean, false));
			...
			operation.setIsRequired(false);
			operation.setBodyExpression(createExpressionInOCL(_Nullable_Boolean, "self <> b"));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("b", _Nullable_Boolean, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("i", _Nullable_OclSelf, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("i", _Nullable_Integer, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("r", _Nullable_OclSelf, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("s", _Nullable_String_1, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("regex", _Nullable_String_1, false));
			ownedOperations.add(operation = op_String_replaceAll);
			operation.setIsInvalidating(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("regex", _Nullable_String_1, false));
			ownedParameters.add(parameter = createParameter("replacement", _Nullable_String_1, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("oldSubstring", _Nullable_String_1, false));
			ownedParameters.add(parameter = createParameter("newSubstring", _Nullable_String_1, false));
			...
			operation.setIsInvalidating(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lower", _Nullable_Integer, false));
			ownedParameters.add(parameter = createParameter("upper", _Nullable_Integer, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("delimiters", _Nullable_String_1, false));
			ownedOperations.add(operation = op_String_tokenize_2);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("delimiters", _Nullable_String_1, false));
			ownedParameters.add(parameter = createParameter("returnDelimiters", _Nullable_Boolean, false));
			...
			operation.setIsRequired(false);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_UnlimitedNatural_oclAsType_TT_1, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", _Nullable_OclAny, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", _Nullable_Bag_T, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_Bag_selectByKind_TT, false));
			parameter.setIsTypeof(true);
			ownedOperations.add(operation = op_Bag_selectByType);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_Bag_selectByType_TT, false));
			parameter.setIsTypeof(true);
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", _Nullable_Collection_T_1, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_Collection_selectByKind_TT, false));
			parameter.setIsTypeof(true);
			ownedOperations.add(operation = op_Collection_selectByType);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_Collection_selectByType_TT, false));
			parameter.setIsTypeof(true);
			...
			operation.setIsRequired(false);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("key", _Nullable_OclAny, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("key", _Nullable_OclAny, false));
			ownedParameters.add(parameter = createParameter("value", _Nullable_OclAny, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("map", _Nullable_Map, false));
			...
			operation.setIsRequired(false);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("map", _Nullable_Map_1, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("map", _Nullable_Map_2, false));
			...
			operation.setIsRequired(false);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("key", _Nullable_Map_K, false));
			ownedParameters.add(parameter = createParameter("value", _Nullable_Map_V_1, false));
			ownedOperations.add(operation = op_Map_includingMap);
			operation.setIsRequired(false);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("map", _Nullable_Map_3, false));
			...
			operation.setIsInvalidating(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_OclAny_oclAsType_TT, false));
			parameter.setIsTypeof(true);
			ownedOperations.add(operation = op_OclAny_oclIsInState);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("statespec", _Nullable_OclState, false));
			ownedOperations.add(operation = op_OclAny_oclIsInvalid);
			operation.setIsValidating(true);
			ownedOperations.add(operation = op_OclAny_oclIsKindOf);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_OclType, false));
			...
			operation.setIsRequired(false);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("message", _Nullable_String_1, false));
			...
			operation.setIsInvalidating(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_OclElement_oclAsModelType_TT, false));
			parameter.setIsTypeof(true);
			...
			operation.setIsRequired(false);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_OclInvalid_oclAsType_TT, false));
			parameter.setIsTypeof(true);
			...
			operation.setIsRequired(false);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("that", _Nullable_OclSelf, false));
			...
			ownedOperations.add(operation = op_OclType_asNonInvalid);
			ownedOperations.add(operation = op_OclType_asNonNull);
			ownedOperations.add(operation = op_OclType_conformsTo);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type2", _Nullable_OclType, false));
			...
			operation.setIsRequired(false);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("index", _Nullable_Integer, false));
			...
			operation.setIsInvalidating(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("obj", _Nullable_OclAny, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", _Nullable_OrderedSet_T, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_OrderedSet_selectByKind_TT, false));
			parameter.setIsTypeof(true);
			ownedOperations.add(operation = op_OrderedSet_selectByType);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_OrderedSet_selectByType_TT, false));
			parameter.setIsTypeof(true);
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", _Nullable_Sequence_T, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_Sequence_selectByKind_TT, false));
			parameter.setIsTypeof(true);
			ownedOperations.add(operation = op_Sequence_selectByType);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_Sequence_selectByType_TT, false));
			parameter.setIsTypeof(true);
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", _Nullable_Set_T, false));
			...
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_Set_selectByKind_TT, false));
			parameter.setIsTypeof(true);
			ownedOperations.add(operation = op_Set_selectByType);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type", _Nullable_Set_selectByType_TT, false));
			parameter.setIsTypeof(true);

			ownedOperations = _Type.getOwnedOperations();
			ownedOperations.add(operation = op_Type_conformsTo);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("type2", _Nullable_Type, false));
		...
		private final @NonNull Iteration it_Collection_any = createIteration("any", _Nullable_Collection_T_1, "org.eclipse.ocl.pivot.library.iterator.AnyIteration", org.eclipse.ocl.pivot.library.iterator.AnyIteration.INSTANCE);
		...
		private final @NonNull Iteration it_Collection_exists = createIteration("exists", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.iterator.ExistsIteration", org.eclipse.ocl.pivot.library.iterator.ExistsIteration.INSTANCE);
		private final @NonNull Iteration it_Collection_exists_1 = createIteration("exists", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.iterator.ExistsIteration", org.eclipse.ocl.pivot.library.iterator.ExistsIteration.INSTANCE);
		private final @NonNull Iteration it_Collection_forAll = createIteration("forAll", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.iterator.ForAllIteration", org.eclipse.ocl.pivot.library.iterator.ForAllIteration.INSTANCE);
		private final @NonNull Iteration it_Collection_forAll_1 = createIteration("forAll", _Nullable_Boolean, "org.eclipse.ocl.pivot.library.iterator.ForAllIteration", org.eclipse.ocl.pivot.library.iterator.ForAllIteration.INSTANCE);
		...
		private final @NonNull Iteration it_Collection_iterate = createIteration("iterate", _Nullable_Collection_iterate_Tacc, "org.eclipse.ocl.pivot.library.iterator.IterateIteration", org.eclipse.ocl.pivot.library.iterator.IterateIteration.INSTANCE, tp_Collection_iterate_Tacc);
		...
		private void installIterations() {
			...
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Bag_T_3, false));
			ownedIterations.add(iteration = it_Bag_collectNested);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_Bag_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Bag_T, false));
			ownedIterations.add(iteration = it_Bag_collect);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_Bag_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Bag_T_1, false));
			...
			ownedParameters.add(parameter = createParameter("i", _Nullable_Bag_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Bag_T_2, false));
			...
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_Collection_T_1, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedParameters.add(parameter = createParameter("i", _Nullable_Collection_T_1, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Collection_T_2, false));
			ownedIterations.add(iteration = it_Collection_collect);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_Collection_T_1, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Collection_T_3, false));
			...
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_Collection_T_1, false));
			ownedParameters.add(parameter = createParameter("j", _Nullable_Collection_T_1, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Collection_T_1, false));
			...
			ownedParameters.add(parameter = createParameter("i", _Nullable_Collection_T_1, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Collection_T_5, false));
			ownedIterations.add(iteration = it_Collection_iterate);
			iteration.setIsRequired(false);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_Collection_T_1, false));
			ownedParameters = iteration.getOwnedAccumulators();
			ownedParameters.add(parameter = createParameter("acc", _Nullable_Collection_iterate_Tacc, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Collection_T_4, false));
			...
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_OrderedSet_T_3, false));
			ownedIterations.add(iteration = it_OrderedSet_collectNested);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_OrderedSet_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_OrderedSet_T_1, false));
			ownedIterations.add(iteration = it_OrderedSet_collect);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_OrderedSet_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_OrderedSet_T_2, false));
			...
			ownedParameters.add(parameter = createParameter("i", _Nullable_OrderedSet_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_OrderedSet_T, false));
			...
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Sequence_T_1, false));
			ownedIterations.add(iteration = it_Sequence_collectNested);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_Sequence_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Sequence_T_2, false));
			ownedIterations.add(iteration = it_Sequence_collect);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_Sequence_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Sequence_T_3, false));
			...
			ownedParameters.add(parameter = createParameter("i", _Nullable_Sequence_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Sequence_T, false));
			...
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Set_T_3, false));
			ownedIterations.add(iteration = it_Set_collectNested);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_Set_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Set_T_1, false));
			ownedIterations.add(iteration = it_Set_collect);
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_Set_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Set_T_2, false));
			...
			ownedParameters.add(parameter = createParameter("i", _Nullable_Set_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_Set_T, false));
			...
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", _Nullable_UniqueCollection_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Nullable_Lambda_UniqueCollection_T, false));
		}
		...
		private final @NonNull Property pr_Invalidable_nonInvalidType = createProperty("nonInvalidType", _Nullable_OclType);
		private final @NonNull Property pr_Map_keyType = createProperty("keyType", _Nullable_Map_K);
		private final @NonNull Property pr_Map_valueType = createProperty("valueType", _Nullable_Map_V_1);
		private final @NonNull Property pr_Nullable_nonNullType = createProperty("nonNullType", _Nullable_OclType);
		...
		private void installProperties() {
			...
			property.setIsImplicit(true);
			property.setIsResolveProxies(true);
			property.setOpposite(pr_OclEnumeration_allLiterals);

			ownedProperties = _Invalidable.getOwnedProperties();
			ownedProperties.add(property = pr_Invalidable_nonInvalidType);
			...
			ownedProperties = _Nullable.getOwnedProperties();
			ownedProperties.add(property = pr_Nullable_nonNullType);
			property.setIsRequired(false);
			property.setIsResolveProxies(true);
			property.setIsStatic(true);
		...
		private void installTemplateBindings() {
			...
			_Nullable_Bag_T.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Bag_T)));
			_Nullable_Bag_selectByKind_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Bag_selectByKind_TT)));
			_Nullable_Bag_selectByType_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Bag_selectByType_TT)));
			_Nullable_Boolean.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Boolean)));
			_Nullable_Collection_T_1.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Collection_T)));
			_Nullable_Collection_iterate_Tacc.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Collection_iterate_Tacc)));
			_Nullable_Collection_selectByKind_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Collection_selectByKind_TT)));
			_Nullable_Collection_selectByType_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Collection_selectByType_TT)));
			_Nullable_Integer.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Integer)));
			_Nullable_Lambda_Bag_T.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Bag_T_1)));
			_Nullable_Lambda_Bag_T_1.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Bag_T_2)));
			_Nullable_Lambda_Bag_T_2.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Bag_T_3)));
			_Nullable_Lambda_Bag_T_3.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Bag_T_4)));
			_Nullable_Lambda_Collection_T_1.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Collection_T)));
			_Nullable_Lambda_Collection_T_2.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Collection_T_1)));
			_Nullable_Lambda_Collection_T_3.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Collection_T_2)));
			_Nullable_Lambda_Collection_T_4.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Collection_T_3)));
			_Nullable_Lambda_Collection_T_5.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Collection_T_4)));
			_Nullable_Lambda_OrderedSet_T.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_OrderedSet_T_1)));
			_Nullable_Lambda_OrderedSet_T_1.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_OrderedSet_T_3)));
			_Nullable_Lambda_OrderedSet_T_2.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_OrderedSet_T_4)));
			_Nullable_Lambda_OrderedSet_T_3.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_OrderedSet_T_2)));
			_Nullable_Lambda_Sequence_T.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Sequence_T_1)));
			_Nullable_Lambda_Sequence_T_1.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Sequence_T_2)));
			_Nullable_Lambda_Sequence_T_2.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Sequence_T_3)));
			_Nullable_Lambda_Sequence_T_3.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Sequence_T_4)));
			_Nullable_Lambda_Set_T.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Set_T_1)));
			_Nullable_Lambda_Set_T_1.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Set_T_3)));
			_Nullable_Lambda_Set_T_2.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Set_T_4)));
			_Nullable_Lambda_Set_T_3.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_Set_T_2)));
			_Nullable_Lambda_UniqueCollection_T.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Lambda_UniqueCollection_T)));
			_Nullable_Map.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Map_Map_excludesMap_K2_Map_excludesMap_V2)));
			_Nullable_Map_1.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Map_Map_excludingMap_K2_Map_excludingMap_V2)));
			_Nullable_Map_2.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Map_Map_includesMap_K2_Map_includesMap_V2)));
			_Nullable_Map_3.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Map_Map_includingMap_K2_Map_includingMap_V2)));
			_Nullable_Map_4.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Map_Map_K_Map_V)));
			_Nullable_Map_K.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Map_K)));
			_Nullable_Map_V_1.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Map_V)));
			_Nullable_OclAny.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _OclAny)));
			_Nullable_OclAny_oclAsType_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_OclAny_oclAsType_TT)));
			_Nullable_OclElement.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _OclElement)));
			_Nullable_OclElement_oclAsModelType_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_OclElement_oclAsModelType_TT)));
			_Nullable_OclInvalid_oclAsType_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_OclInvalid_oclAsType_TT)));
			_Nullable_OclSelf.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _OclSelf)));
			_Nullable_OclState.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _OclState)));
			_Nullable_OclType.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _OclType)));
			_Nullable_OrderedCollection_T_1.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_OrderedCollection_T)));
			_Nullable_OrderedSet_T.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_OrderedSet_T)));
			_Nullable_OrderedSet_selectByKind_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_OrderedSet_selectByKind_TT)));
			_Nullable_OrderedSet_selectByType_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_OrderedSet_selectByType_TT)));
			_Nullable_Sequence_T.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Sequence_T)));
			_Nullable_Sequence_selectByKind_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Sequence_selectByKind_TT)));
			_Nullable_Sequence_selectByType_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Sequence_selectByType_TT)));
			_Nullable_Set_T.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Set_T)));
			_Nullable_Set_selectByKind_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Set_selectByKind_TT)));
			_Nullable_Set_selectByType_TT.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_Set_selectByType_TT)));
			_Nullable_String_1.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _String)));
			_Nullable_Type.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, _Type)));
			_Nullable_UniqueCollection_T.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_UniqueCollection_T)));
			_Nullable_UnlimitedNatural_oclAsType_TT_1.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Nullable_T, tp_UnlimitedNatural_oclAsType_TT)));
		...
		private void installComments() {
			...
			installComment(op_UnlimitedNatural_toInteger, "Converts oclText[self] to an Integer value unless oclText[self] is e[unlimited] in which case oclText[self] is converted to oclText[invalid].");
			...
			installComment(_Invalidable, "The Invalidable wraps a maybe-null, non-invalid type to provide a maybe-null, maybe-invalid variant of the type.");
			installComment(pr_Invalidable_nonInvalidType, "The non-invalid, maybe-null type wrapped by this Invalidable.");
			...
			installComment(_Nullable, "The Nullable wraps a non-null, non-invalid type to provide a may-be-null, non-invalid variant of the type.");
			installComment(pr_Nullable_nonNullType, "The non-invalid, non-null type wrapped by this Nullable.");
			...
			installComment(pr_OclEnumeration_allLiterals, "Evaluates to the literals of the enumeration.");
			...
			installComment(op_OclType_asNonInvalid, "Return the non-invalid type underlying this type, which is self for unwrapped types.");
			installComment(op_OclType_asNonNull, "Return the non-null type underlying this type, which is self for unwrapped types.");
