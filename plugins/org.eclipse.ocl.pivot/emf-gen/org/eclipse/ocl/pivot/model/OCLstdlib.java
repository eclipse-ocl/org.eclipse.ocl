...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private void installAggregateTypes0() {
			...
			type = _Lambda_Bag_T_Boolean = createLambdaType(orphanage, "Lambda", tp_Bag_T, _Boolean);
			type = _Lambda_Bag_T_Bag_collectNested_V = createLambdaType(orphanage, "Lambda", tp_Bag_T, tp_Bag_collectNested_V);
			type = _Lambda_Bag_T_Bag_collect_V = createLambdaType(orphanage, "Lambda", tp_Bag_T, tp_Bag_collect_V);
			type = _Lambda_Bag_T_OclAny = createLambdaType(orphanage, "Lambda", tp_Bag_T, _OclAny);
			type = _Lambda_Collection_T_Boolean = createLambdaType(orphanage, "Lambda", tp_Collection_T, _Boolean);
			type = _Lambda_Collection_T_Collection_collectBy_V = createLambdaType(orphanage, "Lambda", tp_Collection_T, tp_Collection_collectBy_V);
			type = _Lambda_Collection_T_Collection_collectNested_V = createLambdaType(orphanage, "Lambda", tp_Collection_T, tp_Collection_collectNested_V);
			type = _Lambda_Collection_T_Collection_collect_V = createLambdaType(orphanage, "Lambda", tp_Collection_T, tp_Collection_collect_V);
			type = _Lambda_Collection_T_Collection_iterate_Tacc = createLambdaType(orphanage, "Lambda", tp_Collection_T, tp_Collection_iterate_Tacc);
			type = _Lambda_Collection_T_OclAny = createLambdaType(orphanage, "Lambda", tp_Collection_T, _OclAny);
			type = _Lambda_Map_K_Boolean = createLambdaType(orphanage, "Lambda", tp_Map_K, _Boolean);
			type = _Lambda_Map_K_Map_collectBy_V2 = createLambdaType(orphanage, "Lambda", tp_Map_K, tp_Map_collectBy_V2);
			type = _Lambda_Map_K_Map_collectNested_V2 = createLambdaType(orphanage, "Lambda", tp_Map_K, tp_Map_collectNested_V2);
			type = _Lambda_Map_K_Map_collect_V2 = createLambdaType(orphanage, "Lambda", tp_Map_K, tp_Map_collect_V2);
			type = _Lambda_Map_K_Map_iterate_Tacc = createLambdaType(orphanage, "Lambda", tp_Map_K, tp_Map_iterate_Tacc);
			type = _Lambda_Map_K_OclAny = createLambdaType(orphanage, "Lambda", tp_Map_K, _OclAny);
			type = _Lambda_OrderedSet_T_Boolean = createLambdaType(orphanage, "Lambda", tp_OrderedSet_T, _Boolean);
			type = _Lambda_OrderedSet_T_OclAny = createLambdaType(orphanage, "Lambda", tp_OrderedSet_T, _OclAny);
			type = _Lambda_OrderedSet_T_OrderedSet_collectNested_V = createLambdaType(orphanage, "Lambda", tp_OrderedSet_T, tp_OrderedSet_collectNested_V);
			type = _Lambda_OrderedSet_T_OrderedSet_collect_V = createLambdaType(orphanage, "Lambda", tp_OrderedSet_T, tp_OrderedSet_collect_V);
			type = _Lambda_Sequence_T_Boolean = createLambdaType(orphanage, "Lambda", tp_Sequence_T, _Boolean);
			type = _Lambda_Sequence_T_OclAny = createLambdaType(orphanage, "Lambda", tp_Sequence_T, _OclAny);
			type = _Lambda_Sequence_T_Sequence_collectNested_V = createLambdaType(orphanage, "Lambda", tp_Sequence_T, tp_Sequence_collectNested_V);
			type = _Lambda_Sequence_T_Sequence_collect_V = createLambdaType(orphanage, "Lambda", tp_Sequence_T, tp_Sequence_collect_V);
			type = _Lambda_Set_T_Boolean = createLambdaType(orphanage, "Lambda", tp_Set_T, _Boolean);
			type = _Lambda_Set_T_OclAny = createLambdaType(orphanage, "Lambda", tp_Set_T, _OclAny);
			type = _Lambda_Set_T_Set_collectNested_V = createLambdaType(orphanage, "Lambda", tp_Set_T, tp_Set_collectNested_V);
			type = _Lambda_Set_T_Set_collect_V = createLambdaType(orphanage, "Lambda", tp_Set_T, tp_Set_collect_V);
			type = _Lambda_UniqueCollection_T_OclAny = createLambdaType(orphanage, "Lambda", tp_UniqueCollection_T, _OclAny);
			type = _Tuple = createTupleType(orphanage, "Tuple",
		...
		private void installAggregateTypes1() {
			...
			type = _Collection_Integer_F = getCollectionType(orphanage, _Collection_Collection_T, _Integer, false, 0, -1);
			type = _Collection_String_F = getCollectionType(orphanage, _Collection_Collection_T, _String, false, 0, -1);
			type = _Collection_Tuple_F = getCollectionType(orphanage, _Collection_Collection_T, _Tuple, false, 0, -1);
			type = _Collection_Bag_collectNested_V_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Bag_collectNested_V, false, 0, -1);
			type = _Collection_Bag_collect_V_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Bag_collect_V, false, 0, -1);
			type = _Collection_Bag_flatten_T2_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Bag_flatten_T2, false, 0, -1);
			type = _Collection_Bag_selectByKind_TT_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Bag_selectByKind_TT, false, 0, -1);
			type = _Collection_Bag_selectByType_TT_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Bag_selectByType_TT, false, 0, -1);
			type = _Collection_Bag_T_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Bag_T, false, 0, -1);
			type = _Collection_CollectionType_F = getCollectionType(orphanage, _Collection_Collection_T, _CollectionType, false, 0, -1);
			type = _Collection_Collection_collectNested_V_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Collection_collectNested_V, false, 0, -1);
			type = _Collection_Collection_collect_V_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Collection_collect_V, false, 0, -1);
			type = _Collection_Collection_excludesAll_T2_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Collection_excludesAll_T2, false, 0, -1);
			type = _Collection_Collection_flatten_T2_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Collection_flatten_T2, false, 0, -1);
			type = _Collection_Collection_includesAll_T2_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Collection_includesAll_T2, false, 0, -1);
			type = _Collection_Collection_product_T2_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Collection_product_T2, false, 0, -1);
			type = _Collection_Collection_selectByKind_TT_T = getCollectionType(orphanage, _Collection_Collection_T, tp_Collection_selectByKind_TT, true, 0, -1);
			type = _Collection_Collection_selectByType_TT_T = getCollectionType(orphanage, _Collection_Collection_T, tp_Collection_selectByType_TT, true, 0, -1);
			type = _Collection_Collection_T_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Collection_T, false, 0, -1);
			type = _Collection_MapType_F = getCollectionType(orphanage, _Collection_Collection_T, _MapType, false, 0, -1);
			type = _Collection_Map_collect_V2_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Map_collect_V2, false, 0, -1);
			type = _Collection_Map_excludesAll_K2_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Map_excludesAll_K2, false, 0, -1);
			type = _Collection_Map_includesAll_K2_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Map_includesAll_K2, false, 0, -1);
			type = _Collection_Map_K_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Map_K, false, 0, -1);
			type = _Collection_Map_V_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Map_V, false, 0, -1);
			type = _Collection_OclAny_F = getCollectionType(orphanage, _Collection_Collection_T, _OclAny, false, 0, -1);
			type = _Collection_OclElement_F = getCollectionType(orphanage, _Collection_Collection_T, _OclElement, false, 0, -1);
			type = _Collection_OclInvalid_F = getCollectionType(orphanage, _Collection_Collection_T, _OclInvalid, false, 0, -1);
			type = _Collection_OclSelf_F = getCollectionType(orphanage, _Collection_Collection_T, _OclSelf, false, 0, -1);
			type = _Collection_OrderedCollection_T_F = getCollectionType(orphanage, _Collection_Collection_T, tp_OrderedCollection_T, false, 0, -1);
			type = _Collection_OrderedSet_collectNested_V_F = getCollectionType(orphanage, _Collection_Collection_T, tp_OrderedSet_collectNested_V, false, 0, -1);
			type = _Collection_OrderedSet_collect_V_F = getCollectionType(orphanage, _Collection_Collection_T, tp_OrderedSet_collect_V, false, 0, -1);
			type = _Collection_OrderedSet_flatten_T2_F = getCollectionType(orphanage, _Collection_Collection_T, tp_OrderedSet_flatten_T2, false, 0, -1);
			type = _Collection_OrderedSet_selectByKind_TT_F = getCollectionType(orphanage, _Collection_Collection_T, tp_OrderedSet_selectByKind_TT, false, 0, -1);
			type = _Collection_OrderedSet_selectByType_TT_F = getCollectionType(orphanage, _Collection_Collection_T, tp_OrderedSet_selectByType_TT, false, 0, -1);
			type = _Collection_OrderedSet_T_F = getCollectionType(orphanage, _Collection_Collection_T, tp_OrderedSet_T, false, 0, -1);
			type = _Collection_Sequence_collectNested_V_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Sequence_collectNested_V, false, 0, -1);
			type = _Collection_Sequence_collect_V_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Sequence_collect_V, false, 0, -1);
			type = _Collection_Sequence_flatten_T2_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Sequence_flatten_T2, false, 0, -1);
			type = _Collection_Sequence_selectByKind_TT_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Sequence_selectByKind_TT, false, 0, -1);
			type = _Collection_Sequence_selectByType_TT_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Sequence_selectByType_TT, false, 0, -1);
			type = _Collection_Sequence_T_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Sequence_T, false, 0, -1);
			type = _Collection_Set_collectNested_V_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Set_collectNested_V, false, 0, -1);
			type = _Collection_Set_collect_V_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Set_collect_V, false, 0, -1);
			type = _Collection_Set_flatten_T2_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Set_flatten_T2, false, 0, -1);
			type = _Collection_Set_selectByKind_TT_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Set_selectByKind_TT, false, 0, -1);
			type = _Collection_Set_selectByType_TT_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Set_selectByType_TT, false, 0, -1);
			type = _Collection_Set_T_F = getCollectionType(orphanage, _Collection_Collection_T, tp_Set_T, false, 0, -1);
			type = _Collection_UniqueCollection_T_F = getCollectionType(orphanage, _Collection_Collection_T, tp_UniqueCollection_T, false, 0, -1);
			type = _Map_Collection_T_F_Collection_collectBy_V_F = getMapType(orphanage, _Map_Map_K_Map_V, tp_Collection_T, false, tp_Collection_collectBy_V, false);
			type = _Map_Map_excludesMap_K2_T_Map_excludesMap_V2_T = getMapType(orphanage, _Map_Map_K_Map_V, tp_Map_excludesMap_K2, true, tp_Map_excludesMap_V2, true);
			type = _Map_Map_excludingMap_K2_T_Map_excludingMap_V2_T = getMapType(orphanage, _Map_Map_K_Map_V, tp_Map_excludingMap_K2, true, tp_Map_excludingMap_V2, true);
			type = _Map_Map_includesMap_K2_T_Map_includesMap_V2_T = getMapType(orphanage, _Map_Map_K_Map_V, tp_Map_includesMap_K2, true, tp_Map_includesMap_V2, true);
			type = _Map_Map_includingMap_K2_T_Map_includingMap_V2_T = getMapType(orphanage, _Map_Map_K_Map_V, tp_Map_includingMap_K2, true, tp_Map_includingMap_V2, true);
			type = _Map_Map_K_F_Map_collectBy_V2_F = getMapType(orphanage, _Map_Map_K_Map_V, tp_Map_K, false, tp_Map_collectBy_V2, false);
			type = _Map_Map_K_F_Map_collectNested_V2_F = getMapType(orphanage, _Map_Map_K_Map_V, tp_Map_K, false, tp_Map_collectNested_V2, false);
			type = _Map_Map_K_F_Map_V_F = getMapType(orphanage, _Map_Map_K_Map_V, tp_Map_K, false, tp_Map_V, false);
		...
		private void installAggregateTypes3() {
			...
			type = _Bag_Bag_collectNested_V_F = getBagType(orphanage, _Bag_Bag_T, tp_Bag_collectNested_V, false, 0, -1);
			type = _Bag_Bag_collect_V_F = getBagType(orphanage, _Bag_Bag_T, tp_Bag_collect_V, false, 0, -1);
			type = _Bag_Bag_flatten_T2_F = getBagType(orphanage, _Bag_Bag_T, tp_Bag_flatten_T2, false, 0, -1);
			type = _Bag_Bag_selectByKind_TT_T = getBagType(orphanage, _Bag_Bag_T, tp_Bag_selectByKind_TT, true, 0, -1);
			type = _Bag_Bag_selectByType_TT_T = getBagType(orphanage, _Bag_Bag_T, tp_Bag_selectByType_TT, true, 0, -1);
			type = _Bag_CollectionType_F = getBagType(orphanage, _Bag_Bag_T, _CollectionType, false, 0, -1);
			type = _Bag_Collection_T_F = getBagType(orphanage, _Bag_Bag_T, tp_Collection_T, false, 0, -1);
			type = _Bag_MapType_F = getBagType(orphanage, _Bag_Bag_T, _MapType, false, 0, -1);
			type = _Bag_Map_collect_V2_F = getBagType(orphanage, _Bag_Bag_T, tp_Map_collect_V2, false, 0, -1);
			type = _Bag_Map_V_F = getBagType(orphanage, _Bag_Bag_T, tp_Map_V, false, 0, -1);
			type = _Bag_OclElement_F = getBagType(orphanage, _Bag_Bag_T, _OclElement, false, 0, -1);
			type = _Bag_OclInvalid_F = getBagType(orphanage, _Bag_Bag_T, _OclInvalid, false, 0, -1);
			type = _Bag_Set_collectNested_V_F = getBagType(orphanage, _Bag_Bag_T, tp_Set_collectNested_V, false, 0, -1);
			type = _Bag_Set_collect_V_F = getBagType(orphanage, _Bag_Bag_T, tp_Set_collect_V, false, 0, -1);
			type = _OrderedCollection_Integer_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, _Integer, false, 0, -1);
			type = _OrderedCollection_String_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, _String, false, 0, -1);
			type = _OrderedCollection_Bag_T_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_Bag_T, false, 0, -1);
			type = _OrderedCollection_Collection_T_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_Collection_T, false, 0, -1);
			type = _OrderedCollection_OrderedSet_collectNested_V_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_OrderedSet_collectNested_V, false, 0, -1);
			type = _OrderedCollection_OrderedSet_collect_V_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_OrderedSet_collect_V, false, 0, -1);
			type = _OrderedCollection_OrderedSet_flatten_T2_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_OrderedSet_flatten_T2, false, 0, -1);
			type = _OrderedCollection_OrderedSet_selectByKind_TT_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_OrderedSet_selectByKind_TT, false, 0, -1);
			type = _OrderedCollection_OrderedSet_selectByType_TT_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_OrderedSet_selectByType_TT, false, 0, -1);
			type = _OrderedCollection_OrderedSet_T_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_OrderedSet_T, false, 0, -1);
			type = _OrderedCollection_Sequence_collectNested_V_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_Sequence_collectNested_V, false, 0, -1);
			type = _OrderedCollection_Sequence_collect_V_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_Sequence_collect_V, false, 0, -1);
			type = _OrderedCollection_Sequence_flatten_T2_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_Sequence_flatten_T2, false, 0, -1);
			type = _OrderedCollection_Sequence_selectByKind_TT_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_Sequence_selectByKind_TT, false, 0, -1);
			type = _OrderedCollection_Sequence_selectByType_TT_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_Sequence_selectByType_TT, false, 0, -1);
			type = _OrderedCollection_Sequence_T_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_Sequence_T, false, 0, -1);
			type = _OrderedCollection_Set_T_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_Set_T, false, 0, -1);
			type = _OrderedCollection_UniqueCollection_T_F = getCollectionType(orphanage, _OrderedCollection_OrderedCollection_T, tp_UniqueCollection_T, false, 0, -1);
			type = _UniqueCollection_Tuple_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, _Tuple, false, 0, -1);
			type = _UniqueCollection_Bag_T_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_Bag_T, false, 0, -1);
			type = _UniqueCollection_Collection_T_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_Collection_T, false, 0, -1);
			type = _UniqueCollection_Map_K_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_Map_K, false, 0, -1);
			type = _UniqueCollection_OclAny_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, _OclAny, false, 0, -1);
			type = _UniqueCollection_OclElement_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, _OclElement, false, 0, -1);
			type = _UniqueCollection_OclSelf_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, _OclSelf, false, 0, -1);
			type = _UniqueCollection_OrderedSet_flatten_T2_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_OrderedSet_flatten_T2, false, 0, -1);
			type = _UniqueCollection_OrderedSet_selectByKind_TT_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_OrderedSet_selectByKind_TT, false, 0, -1);
			type = _UniqueCollection_OrderedSet_selectByType_TT_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_OrderedSet_selectByType_TT, false, 0, -1);
			type = _UniqueCollection_OrderedSet_T_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_OrderedSet_T, false, 0, -1);
			type = _UniqueCollection_Sequence_T_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_Sequence_T, false, 0, -1);
			type = _UniqueCollection_Set_flatten_T2_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_Set_flatten_T2, false, 0, -1);
			type = _UniqueCollection_Set_selectByKind_TT_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_Set_selectByKind_TT, false, 0, -1);
			type = _UniqueCollection_Set_selectByType_TT_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_Set_selectByType_TT, false, 0, -1);
			type = _UniqueCollection_Set_T_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_Set_T, false, 0, -1);
			type = _UniqueCollection_UniqueCollection_T_F = getCollectionType(orphanage, _UniqueCollection_UniqueCollection_T, tp_UniqueCollection_T, false, 0, -1);
		...
		private void installAggregateTypes5() {
			...
			type = _Lambda_OrderedSet_T_OrderedSet = createLambdaType(orphanage, "Lambda", tp_OrderedSet_T, _OrderedSet_OrderedSet_T);
			type = _Lambda_Set_T_Set = createLambdaType(orphanage, "Lambda", tp_Set_T, _Set_Set_T);
			type = _OrderedSet_Collection_T_F = getOrderedSetType(orphanage, _OrderedSet_OrderedSet_T, tp_Collection_T, false, 0, -1);
			type = _OrderedSet_OrderedSet_flatten_T2_F = getOrderedSetType(orphanage, _OrderedSet_OrderedSet_T, tp_OrderedSet_flatten_T2, false, 0, -1);
			type = _OrderedSet_OrderedSet_selectByKind_TT_T = getOrderedSetType(orphanage, _OrderedSet_OrderedSet_T, tp_OrderedSet_selectByKind_TT, true, 0, -1);
			type = _OrderedSet_OrderedSet_selectByType_TT_T = getOrderedSetType(orphanage, _OrderedSet_OrderedSet_T, tp_OrderedSet_selectByType_TT, true, 0, -1);
			type = _OrderedSet_Sequence_T_F = getOrderedSetType(orphanage, _OrderedSet_OrderedSet_T, tp_Sequence_T, false, 0, -1);
			type = _OrderedSet_Set_T_F = getOrderedSetType(orphanage, _OrderedSet_OrderedSet_T, tp_Set_T, false, 0, -1);
			type = _OrderedSet_UniqueCollection_T_F = getOrderedSetType(orphanage, _OrderedSet_OrderedSet_T, tp_UniqueCollection_T, false, 0, -1);
			type = _Sequence_Integer_T = getSequenceType(orphanage, _Sequence_Sequence_T, _Integer, true, 0, -1);
			type = _Sequence_String_T = getSequenceType(orphanage, _Sequence_Sequence_T, _String, true, 0, -1);
			type = _Sequence_Bag_T_F = getSequenceType(orphanage, _Sequence_Sequence_T, tp_Bag_T, false, 0, -1);
			type = _Sequence_Collection_T_F = getSequenceType(orphanage, _Sequence_Sequence_T, tp_Collection_T, false, 0, -1);
			type = _Sequence_OrderedSet_collectNested_V_F = getSequenceType(orphanage, _Sequence_Sequence_T, tp_OrderedSet_collectNested_V, false, 0, -1);
			type = _Sequence_OrderedSet_collect_V_F = getSequenceType(orphanage, _Sequence_Sequence_T, tp_OrderedSet_collect_V, false, 0, -1);
			type = _Sequence_Sequence_collectNested_V_F = getSequenceType(orphanage, _Sequence_Sequence_T, tp_Sequence_collectNested_V, false, 0, -1);
			type = _Sequence_Sequence_collect_V_F = getSequenceType(orphanage, _Sequence_Sequence_T, tp_Sequence_collect_V, false, 0, -1);
			type = _Sequence_Sequence_flatten_T2_F = getSequenceType(orphanage, _Sequence_Sequence_T, tp_Sequence_flatten_T2, false, 0, -1);
			type = _Sequence_Sequence_selectByKind_TT_T = getSequenceType(orphanage, _Sequence_Sequence_T, tp_Sequence_selectByKind_TT, true, 0, -1);
			type = _Sequence_Sequence_selectByType_TT_T = getSequenceType(orphanage, _Sequence_Sequence_T, tp_Sequence_selectByType_TT, true, 0, -1);
			type = _Set_Tuple_T = getSetType(orphanage, _Set_Set_T, _Tuple, true, 0, -1);
			type = _Set_Bag_T_F = getSetType(orphanage, _Set_Set_T, tp_Bag_T, false, 0, -1);
			type = _Set_Collection_T_F = getSetType(orphanage, _Set_Set_T, tp_Collection_T, false, 0, -1);
			type = _Set_Map_K_F = getSetType(orphanage, _Set_Set_T, tp_Map_K, false, 0, -1);
			type = _Set_OclElement_T = getSetType(orphanage, _Set_Set_T, _OclElement, true, 0, -1);
			type = _Set_OclSelf_T = getSetType(orphanage, _Set_Set_T, _OclSelf, true, 0, -1);
			type = _Set_OclSelf_F = getSetType(orphanage, _Set_Set_T, _OclSelf, false, 0, -1);
			type = _Set_Set_flatten_T2_F = getSetType(orphanage, _Set_Set_T, tp_Set_flatten_T2, false, 0, -1);
			type = _Set_Set_selectByKind_TT_T = getSetType(orphanage, _Set_Set_T, tp_Set_selectByKind_TT, true, 0, -1);
			type = _Set_Set_selectByType_TT_T = getSetType(orphanage, _Set_Set_T, tp_Set_selectByType_TT, true, 0, -1);
			type = _Set_UniqueCollection_T_F = getSetType(orphanage, _Set_Set_T, tp_UniqueCollection_T, false, 0, -1);
		...
		private void installAggregateTypes6() {
			...
			type = _Lambda_Bag_T_Set = createLambdaType(orphanage, "Lambda", tp_Bag_T, _Set_Bag_T_F);
			type = _Lambda_Sequence_T_OrderedSet = createLambdaType(orphanage, "Lambda", tp_Sequence_T, _OrderedSet_Sequence_T_F);
