...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractLibraryContents
	{
		...
		private void installLambdaTypes() {
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$0_F_result_Boolean_T);
			type.setOwnedContext(createLambdaParameter("self", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", _Boolean, true));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$0_F_result_Boolean_F);
			type.setOwnedContext(createLambdaParameter("self", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", _Boolean, false));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$0_F_result_OclAny_F);
			type.setOwnedContext(createLambdaParameter("self", $$0, false));
			type.setOwnedResult(createLambdaParameter("result", _OclAny, false));
			superClasses = type.getSuperClasses();
			superClasses.add(_OclLambda);
			orphanTypes.add(type = _Lambda_self_$$0_F_result_OclComparable_F);
			type.setOwnedContext(createLambdaParameter("self", $$0, false));
		...
		private void installIterations() {
			...
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_Boolean_T, true));
			...
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_OclComparable_F, true));
			...
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_Boolean_F, true));
			...
			ownedParameters.add(parameter = createParameter("i", $$0, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_self_$$0_F_result_OclAny_F, true));
