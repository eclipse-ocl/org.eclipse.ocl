...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private void installCollectionTypes() {
			...
			type.setIsNullFree(true);
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Collection_collect_V);
			ownedClasses.add(type);
			type = _Collection_Collection_collectNested_V_T;
			type.setIsNullFree(true);
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Collection_collectNested_V);
			ownedClasses.add(type);
			type = _Collection_Collection_excludesAll_T2_T;
			type.setIsNullFree(true);
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Collection_excludesAll_T2);
			ownedClasses.add(type);
			type = _Collection_Collection_flatten_T2_T;
			type.setIsNullFree(true);
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Collection_flatten_T2);
			ownedClasses.add(type);
			type = _Collection_Collection_includesAll_T2_T;
			type.setIsNullFree(true);
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Collection_includesAll_T2);
			ownedClasses.add(type);
			type = _Collection_Collection_product_T2_T;
			type.setIsNullFree(true);
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Collection_product_T2);
			ownedClasses.add(type);
			type = _Collection_Collection_selectByKind_TT_T;
			type.setIsNullFree(true);
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Collection_selectByKind_TT);
			ownedClasses.add(type);
			type = _Collection_Collection_selectByType_TT_T;
			type.setIsNullFree(true);
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Collection_selectByType_TT);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, _Integer);
			ownedClasses.add(type);
			type = _Collection_Map_K_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Map_K);
			ownedClasses.add(type);
			...
			type.setIsNullFree(true);
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Map_excludesAll_K2);
			ownedClasses.add(type);
			type = _Collection_Map_includesAll_K2_T;
			type.setIsNullFree(true);
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Map_includesAll_K2);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, _OclSelf);
			ownedClasses.add(type);
			type = _Collection_OrderedCollection_T_T;
			type.setIsNullFree(true);
			addSuperClass(type, _OclAny);
			addBinding(type, tp_OrderedCollection_T);
			ownedClasses.add(type);
			type = _Collection_OrderedSet_T_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_OrderedSet_T);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, tp_OrderedSet_collect_V);
			ownedClasses.add(type);
			type = _Collection_OrderedSet_collectNested_V_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_OrderedSet_collectNested_V);
			ownedClasses.add(type);
			type = _Collection_OrderedSet_flatten_T2_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_OrderedSet_flatten_T2);
			ownedClasses.add(type);
			type = _Collection_OrderedSet_selectByKind_TT_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_OrderedSet_selectByKind_TT);
			ownedClasses.add(type);
			type = _Collection_OrderedSet_selectByType_TT_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_OrderedSet_selectByType_TT);
			ownedClasses.add(type);
			type = _Collection_Sequence_T_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Sequence_T);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Sequence_collect_V);
			ownedClasses.add(type);
			type = _Collection_Sequence_collectNested_V_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Sequence_collectNested_V);
			ownedClasses.add(type);
			type = _Collection_Sequence_flatten_T2_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Sequence_flatten_T2);
			ownedClasses.add(type);
			type = _Collection_Sequence_selectByKind_TT_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Sequence_selectByKind_TT);
			ownedClasses.add(type);
			type = _Collection_Sequence_selectByType_TT_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Sequence_selectByType_TT);
			ownedClasses.add(type);
			type = _Collection_Set_T_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Set_T);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Set_flatten_T2);
			ownedClasses.add(type);
			type = _Collection_Set_selectByKind_TT_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Set_selectByKind_TT);
			ownedClasses.add(type);
			type = _Collection_Set_selectByType_TT_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Set_selectByType_TT);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, _Tuple);
			ownedClasses.add(type);
			type = _Collection_UniqueCollection_T_F;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_UniqueCollection_T);
			ownedClasses.add(type);
		...
		private void installMapTypes() {
			...
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Collection_T);
			addBinding(type, tp_Collection_collectBy_V);
			ownedClasses.add(type);
			type = _Map_Map_excludesMap_K2_T_Map_excludesMap_V2_T;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Map_excludesMap_K2);
			addBinding(type, tp_Map_excludesMap_V2);
			ownedClasses.add(type);
			type = _Map_Map_excludingMap_K2_T_Map_excludingMap_V2_T;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Map_excludingMap_K2);
			addBinding(type, tp_Map_excludingMap_V2);
			ownedClasses.add(type);
			type = _Map_Map_includesMap_K2_T_Map_includesMap_V2_T;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Map_includesMap_K2);
			addBinding(type, tp_Map_includesMap_V2);
			ownedClasses.add(type);
			type = _Map_Map_includingMap_K2_T_Map_includingMap_V2_T;
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Map_includingMap_K2);
			addBinding(type, tp_Map_includingMap_V2);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Map_K);
			addBinding(type, tp_Map_collectBy_V2);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OclAny);
			addBinding(type, tp_Map_K);
			addBinding(type, tp_Map_collectNested_V2);
			ownedClasses.add(type);
