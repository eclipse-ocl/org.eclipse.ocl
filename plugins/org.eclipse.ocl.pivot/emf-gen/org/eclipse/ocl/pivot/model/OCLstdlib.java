...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private final @NonNull CollectionType _Collection_Invalidable = createCollectionType(_Collection_Collection_T, _Invalidable);
		...
		private void installCollectionTypes() {
			...
			ownedClasses.add(type = _Bag_Invalidable);
			superClasses = type.getSuperClasses();
			superClasses.add(_Collection_Invalidable);
			...
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
			ownedClasses.add(type = _Collection_Invalidable);
			superClasses = type.getSuperClasses();
			superClasses.add(_OclAny);
		...
		private final @NonNull NullableType _Nullable_UnlimitedNatural = createNullableType(_UnlimitedNatural);
		private final @NonNull NullableType _Nullabletp_UnlimitedNatural_oclAsType_TT = createNullableType(tp_UnlimitedNatural_oclAsType_TT);
		private final @NonNull NullableType _Nullable_Bag_Bag_collectNested_V_NullFree = createNullableType(_Bag_Bag_collectNested_V_NullFree);
		private final @NonNull NullableType _Nullable_Bag_Bag_collect_V_NullFree = createNullableType(_Bag_Bag_collect_V_NullFree);
		private final @NonNull NullableType _Nullable_Bag_Bag_flatten_T2_NullFree = createNullableType(_Bag_Bag_flatten_T2_NullFree);
		private final @NonNull NullableType _Nullable_Bag_Bag_selectByKind_TT_NullFree = createNullableType(_Bag_Bag_selectByKind_TT_NullFree);
		private final @NonNull NullableType _Nullable_Bag_Bag_selectByType_TT_NullFree = createNullableType(_Bag_Bag_selectByType_TT_NullFree);
		private final @NonNull NullableType _Nullable_Bag_Collection_T_NullFree = createNullableType(_Bag_Collection_T_NullFree);
		private final @NonNull NullableType _Nullable_Bag_Collection = createNullableType(_Bag_Collection);
		...
		private final @NonNull NullableType _Nullable_Bag_Set_collectNested_V_NullFree = createNullableType(_Bag_Set_collectNested_V_NullFree);
		private final @NonNull NullableType _Nullable_Bag_Set_collect_V_NullFree = createNullableType(_Bag_Set_collect_V_NullFree);
		private final @NonNull NullableType _Nullable_Bag_Bag_T = createNullableType(_Bag_Bag_T);
		private final @NonNull NullableType _Nullabletp_Bag_collectNested_V = createNullableType(tp_Bag_collectNested_V);
		private final @NonNull NullableType _Nullabletp_Bag_collect_V = createNullableType(tp_Bag_collect_V);
		private final @NonNull NullableType _Nullabletp_Bag_flatten_T2 = createNullableType(tp_Bag_flatten_T2);
		private final @NonNull NullableType _Nullabletp_Bag_selectByKind_TT = createNullableType(tp_Bag_selectByKind_TT);
		private final @NonNull NullableType _Nullabletp_Bag_selectByType_TT = createNullableType(tp_Bag_selectByType_TT);
		private final @NonNull NullableType _Nullabletp_Bag_T = createNullableType(tp_Bag_T);
		private final @NonNull NullableType _Nullable_Class = createNullableType(_Class);
		private final @NonNull NullableType _Nullable_Collection_Integer = createNullableType(_Collection_Integer);
		private final @NonNull NullableType _Nullable_Collection_String = createNullableType(_Collection_String);
		private final @NonNull NullableType _Nullable_Collection_Tuple = createNullableType(_Collection_Tuple);
		private final @NonNull NullableType _Nullable_Collection_Bag_collectNested_V = createNullableType(_Collection_Bag_collectNested_V);
		private final @NonNull NullableType _Nullable_Collection_Bag_collect_V = createNullableType(_Collection_Bag_collect_V);
		...
		private final @NonNull NullableType _Nullable_Collection_Collection_flatten_T2_NullFree = createNullableType(_Collection_Collection_flatten_T2_NullFree);
		private final @NonNull NullableType _Nullable_Collection_Collection_includesAll_T2_NullFree = createNullableType(_Collection_Collection_includesAll_T2_NullFree);
		private final @NonNull NullableType _Nullable_Collection_Collection_product_T2_NullFree = createNullableType(_Collection_Collection_product_T2_NullFree);
		private final @NonNull NullableType _Nullable_Collection_Collection_selectByKind_TT_NullFree = createNullableType(_Collection_Collection_selectByKind_TT_NullFree);
		private final @NonNull NullableType _Nullable_Collection_Collection_selectByType_TT_NullFree = createNullableType(_Collection_Collection_selectByType_TT_NullFree);
		private final @NonNull NullableType _Nullable_Collection_Collection_T_1 = createNullableType(_Collection_Collection_T_1);
		private final @NonNull NullableType _Nullable_Collection_Collection = createNullableType(_Collection_Collection);
		private final @NonNull NullableType _Nullable_Collection_EnumerationLiteral = createNullableType(_Collection_EnumerationLiteral);
		private final @NonNull NullableType _Nullable_Collection_Enumeration = createNullableType(_Collection_Enumeration);
		private final @NonNull NullableType _Nullable_Collection_Invalidable = createNullableType(_Collection_Invalidable);
		private final @NonNull NullableType _Nullable_Collection_Map_excludesAll_K2_NullFree = createNullableType(_Collection_Map_excludesAll_K2_NullFree);
		...
		private final @NonNull NullableType _Nullable_Collection_OclElement = createNullableType(_Collection_OclElement);
		private final @NonNull NullableType _Nullable_Collection_OclEnumeration = createNullableType(_Collection_OclEnumeration);
		private final @NonNull NullableType _Nullable_Collection_OclSelf = createNullableType(_Collection_OclSelf);
		private final @NonNull NullableType _Nullable_Collection_OrderedCollection_T_NullFree = createNullableType(_Collection_OrderedCollection_T_NullFree);
		private final @NonNull NullableType _Nullable_Collection_OrderedSet_collectNested_V = createNullableType(_Collection_OrderedSet_collectNested_V);
		private final @NonNull NullableType _Nullable_Collection_OrderedSet_collect_V = createNullableType(_Collection_OrderedSet_collect_V);
		private final @NonNull NullableType _Nullable_Collection_OrderedSet_flatten_T2 = createNullableType(_Collection_OrderedSet_flatten_T2);
		private final @NonNull NullableType _Nullable_Collection_OrderedSet_selectByKind_TT = createNullableType(_Collection_OrderedSet_selectByKind_TT);
		private final @NonNull NullableType _Nullable_Collection_OrderedSet_selectByType_TT = createNullableType(_Collection_OrderedSet_selectByType_TT);
		private final @NonNull NullableType _Nullable_Collection_OrderedSet_T = createNullableType(_Collection_OrderedSet_T);
		private final @NonNull NullableType _Nullable_Collection_Sequence_collectNested_V = createNullableType(_Collection_Sequence_collectNested_V);
		private final @NonNull NullableType _Nullable_Collection_Sequence_collect_V = createNullableType(_Collection_Sequence_collect_V);
		private final @NonNull NullableType _Nullable_Collection_Sequence_flatten_T2 = createNullableType(_Collection_Sequence_flatten_T2);
		private final @NonNull NullableType _Nullable_Collection_Sequence_selectByKind_TT = createNullableType(_Collection_Sequence_selectByKind_TT);
		private final @NonNull NullableType _Nullable_Collection_Sequence_selectByType_TT = createNullableType(_Collection_Sequence_selectByType_TT);
		private final @NonNull NullableType _Nullable_Collection_Sequence_T = createNullableType(_Collection_Sequence_T);
		private final @NonNull NullableType _Nullable_Collection_Set_collectNested_V = createNullableType(_Collection_Set_collectNested_V);
		private final @NonNull NullableType _Nullable_Collection_Set_collect_V = createNullableType(_Collection_Set_collect_V);
		...
		private final @NonNull NullableType _Nullabletp_Collection_excludesAll_T2 = createNullableType(tp_Collection_excludesAll_T2);
		private final @NonNull NullableType _Nullabletp_Collection_flatten_T2 = createNullableType(tp_Collection_flatten_T2);
		private final @NonNull NullableType _Nullabletp_Collection_includesAll_T2 = createNullableType(tp_Collection_includesAll_T2);
		private final @NonNull NullableType _Nullabletp_Collection_iterate_Tacc = createNullableType(tp_Collection_iterate_Tacc);
		private final @NonNull NullableType _Nullabletp_Collection_product_T2 = createNullableType(tp_Collection_product_T2);
		private final @NonNull NullableType _Nullabletp_Collection_selectByKind_TT = createNullableType(tp_Collection_selectByKind_TT);
		private final @NonNull NullableType _Nullabletp_Collection_selectByType_TT = createNullableType(tp_Collection_selectByType_TT);
		private final @NonNull NullableType _Nullabletp_Collection_T = createNullableType(tp_Collection_T);
		...
		private final @NonNull NullableType _Nullabletp_Map_excludingMap_K2 = createNullableType(tp_Map_excludingMap_K2);
		private final @NonNull NullableType _Nullabletp_Map_excludingMap_V2 = createNullableType(tp_Map_excludingMap_V2);
		private final @NonNull NullableType _Nullabletp_Map_includesAll_K2 = createNullableType(tp_Map_includesAll_K2);
		private final @NonNull NullableType _Nullabletp_Map_includesMap_K2 = createNullableType(tp_Map_includesMap_K2);
		private final @NonNull NullableType _Nullabletp_Map_includesMap_V2 = createNullableType(tp_Map_includesMap_V2);
		private final @NonNull NullableType _Nullabletp_Map_includingMap_K2 = createNullableType(tp_Map_includingMap_K2);
		private final @NonNull NullableType _Nullabletp_Map_includingMap_V2 = createNullableType(tp_Map_includingMap_V2);
		private final @NonNull NullableType _Nullabletp_Map_K = createNullableType(tp_Map_K);
		private final @NonNull NullableType _Nullabletp_Map_V = createNullableType(tp_Map_V);
		private final @NonNull NullableType _Nullabletp_Nullable_T = createNullableType(tp_Nullable_T);
		private final @NonNull NullableType _Nullable_OclAny = createNullableType(_OclAny);
		private final @NonNull NullableType _Nullabletp_OclAny_oclAsType_TT = createNullableType(tp_OclAny_oclAsType_TT);
		private final @NonNull NullableType _Nullable_OclComparable = createNullableType(_OclComparable);
		private final @NonNull NullableType _Nullable_OclElement = createNullableType(_OclElement);
		private final @NonNull NullableType _Nullabletp_OclElement_oclAsModelType_TT = createNullableType(tp_OclElement_oclAsModelType_TT);
		private final @NonNull NullableType _Nullable_OclEnumeration = createNullableType(_OclEnumeration);
		private final @NonNull NullableType _Nullabletp_OclInvalid_oclAsType_TT = createNullableType(tp_OclInvalid_oclAsType_TT);
		private final @NonNull NullableType _Nullable_OclLambda = createNullableType(_OclLambda);
		private final @NonNull NullableType _Nullable_OclMessage = createNullableType(_OclMessage);
		...
		private final @NonNull NullableType _Nullable_OclStereotype = createNullableType(_OclStereotype);
		private final @NonNull NullableType _Nullable_OclSummable = createNullableType(_OclSummable);
		private final @NonNull NullableType _Nullable_OclTuple = createNullableType(_OclTuple);
		private final @NonNull NullableType _Nullable_OclType = createNullableType(_OclType);
		private final @NonNull NullableType _Nullable_OrderedCollection_Integer = createNullableType(_OrderedCollection_Integer);
		private final @NonNull NullableType _Nullable_OrderedCollection_String = createNullableType(_OrderedCollection_String);
		private final @NonNull NullableType _Nullable_OrderedCollection_Bag_T = createNullableType(_OrderedCollection_Bag_T);
		private final @NonNull NullableType _Nullable_OrderedCollection_Collection_T = createNullableType(_OrderedCollection_Collection_T);
		private final @NonNull NullableType _Nullable_OrderedCollection_EnumerationLiteral = createNullableType(_OrderedCollection_EnumerationLiteral);
		private final @NonNull NullableType _Nullable_OrderedCollection_OrderedSet_collectNested_V = createNullableType(_OrderedCollection_OrderedSet_collectNested_V);
		private final @NonNull NullableType _Nullable_OrderedCollection_OrderedSet_collect_V = createNullableType(_OrderedCollection_OrderedSet_collect_V);
		private final @NonNull NullableType _Nullable_OrderedCollection_OrderedSet_flatten_T2 = createNullableType(_OrderedCollection_OrderedSet_flatten_T2);
		private final @NonNull NullableType _Nullable_OrderedCollection_OrderedSet_selectByKind_TT = createNullableType(_OrderedCollection_OrderedSet_selectByKind_TT);
		private final @NonNull NullableType _Nullable_OrderedCollection_OrderedSet_selectByType_TT = createNullableType(_OrderedCollection_OrderedSet_selectByType_TT);
		private final @NonNull NullableType _Nullable_OrderedCollection_OrderedSet_T_NullFree = createNullableType(_OrderedCollection_OrderedSet_T_NullFree);
		private final @NonNull NullableType _Nullable_OrderedCollection_Sequence_collectNested_V = createNullableType(_OrderedCollection_Sequence_collectNested_V);
		private final @NonNull NullableType _Nullable_OrderedCollection_Sequence_collect_V = createNullableType(_OrderedCollection_Sequence_collect_V);
		...
		private final @NonNull NullableType _Nullabletp_OrderedCollection_T = createNullableType(tp_OrderedCollection_T);
		private final @NonNull NullableType _Nullable_OrderedSet_Collection_T_NullFree = createNullableType(_OrderedSet_Collection_T_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_EnumerationLiteral_NullFree = createNullableType(_OrderedSet_EnumerationLiteral_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_OrderedSet_flatten_T2_NullFree = createNullableType(_OrderedSet_OrderedSet_flatten_T2_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_OrderedSet_selectByKind_TT_NullFree = createNullableType(_OrderedSet_OrderedSet_selectByKind_TT_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_OrderedSet_selectByType_TT_NullFree = createNullableType(_OrderedSet_OrderedSet_selectByType_TT_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Sequence_T_NullFree = createNullableType(_OrderedSet_Sequence_T_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_Set_T_NullFree = createNullableType(_OrderedSet_Set_T_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_UniqueCollection_T_NullFree = createNullableType(_OrderedSet_UniqueCollection_T_NullFree);
		private final @NonNull NullableType _Nullable_OrderedSet_OrderedSet_T = createNullableType(_OrderedSet_OrderedSet_T);
		private final @NonNull NullableType _Nullabletp_OrderedSet_collectNested_V = createNullableType(tp_OrderedSet_collectNested_V);
		private final @NonNull NullableType _Nullabletp_OrderedSet_collect_V = createNullableType(tp_OrderedSet_collect_V);
		private final @NonNull NullableType _Nullabletp_OrderedSet_flatten_T2 = createNullableType(tp_OrderedSet_flatten_T2);
		private final @NonNull NullableType _Nullabletp_OrderedSet_selectByKind_TT = createNullableType(tp_OrderedSet_selectByKind_TT);
		private final @NonNull NullableType _Nullabletp_OrderedSet_selectByType_TT = createNullableType(tp_OrderedSet_selectByType_TT);
		private final @NonNull NullableType _Nullabletp_OrderedSet_T = createNullableType(tp_OrderedSet_T);
		private final @NonNull NullableType _Nullable_Sequence_Integer_NullFree = createNullableType(_Sequence_Integer_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_String_NullFree = createNullableType(_Sequence_String_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_Bag_T_NullFree = createNullableType(_Sequence_Bag_T_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_Collection_T_NullFree = createNullableType(_Sequence_Collection_T_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_OrderedSet_collectNested_V_NullFree = createNullableType(_Sequence_OrderedSet_collectNested_V_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_OrderedSet_collect_V_NullFree = createNullableType(_Sequence_OrderedSet_collect_V_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_Sequence_collectNested_V_NullFree = createNullableType(_Sequence_Sequence_collectNested_V_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_Sequence_collect_V_NullFree = createNullableType(_Sequence_Sequence_collect_V_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_Sequence_flatten_T2_NullFree = createNullableType(_Sequence_Sequence_flatten_T2_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_Sequence_selectByKind_TT_NullFree = createNullableType(_Sequence_Sequence_selectByKind_TT_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_Sequence_selectByType_TT_NullFree = createNullableType(_Sequence_Sequence_selectByType_TT_NullFree);
		private final @NonNull NullableType _Nullable_Sequence_Sequence_T = createNullableType(_Sequence_Sequence_T);
		private final @NonNull NullableType _Nullabletp_Sequence_collectNested_V = createNullableType(tp_Sequence_collectNested_V);
		private final @NonNull NullableType _Nullabletp_Sequence_collect_V = createNullableType(tp_Sequence_collect_V);
		private final @NonNull NullableType _Nullabletp_Sequence_flatten_T2 = createNullableType(tp_Sequence_flatten_T2);
		private final @NonNull NullableType _Nullabletp_Sequence_selectByKind_TT = createNullableType(tp_Sequence_selectByKind_TT);
		private final @NonNull NullableType _Nullabletp_Sequence_selectByType_TT = createNullableType(tp_Sequence_selectByType_TT);
		private final @NonNull NullableType _Nullabletp_Sequence_T = createNullableType(tp_Sequence_T);
		private final @NonNull NullableType _Nullable_Set_Tuple_NullFree = createNullableType(_Set_Tuple_NullFree);
		private final @NonNull NullableType _Nullable_Set_Bag_T_NullFree = createNullableType(_Set_Bag_T_NullFree);
		private final @NonNull NullableType _Nullable_Set_Collection_T_NullFree = createNullableType(_Set_Collection_T_NullFree);
		private final @NonNull NullableType _Nullable_Set_Map_K_NullFree = createNullableType(_Set_Map_K_NullFree);
		private final @NonNull NullableType _Nullable_Set_OclElement_NullFree = createNullableType(_Set_OclElement_NullFree);
		private final @NonNull NullableType _Nullable_Set_OclSelf = createNullableType(_Set_OclSelf);
		private final @NonNull NullableType _Nullable_Set_OclSelf_NullFree = createNullableType(_Set_OclSelf_NullFree);
		private final @NonNull NullableType _Nullable_Set_Set_flatten_T2_NullFree = createNullableType(_Set_Set_flatten_T2_NullFree);
		private final @NonNull NullableType _Nullable_Set_Set_selectByKind_TT_NullFree = createNullableType(_Set_Set_selectByKind_TT_NullFree);
		private final @NonNull NullableType _Nullable_Set_Set_selectByType_TT_NullFree = createNullableType(_Set_Set_selectByType_TT_NullFree);
		private final @NonNull NullableType _Nullable_Set_UniqueCollection_T_NullFree = createNullableType(_Set_UniqueCollection_T_NullFree);
		private final @NonNull NullableType _Nullable_Set_Set_T = createNullableType(_Set_Set_T);
		private final @NonNull NullableType _Nullabletp_Set_collectNested_V = createNullableType(tp_Set_collectNested_V);
		private final @NonNull NullableType _Nullabletp_Set_collect_V = createNullableType(tp_Set_collect_V);
		private final @NonNull NullableType _Nullabletp_Set_flatten_T2 = createNullableType(tp_Set_flatten_T2);
		private final @NonNull NullableType _Nullabletp_Set_selectByKind_TT = createNullableType(tp_Set_selectByKind_TT);
		private final @NonNull NullableType _Nullabletp_Set_selectByType_TT = createNullableType(tp_Set_selectByType_TT);
		private final @NonNull NullableType _Nullabletp_Set_T = createNullableType(tp_Set_T);
		private final @NonNull NullableType _Nullable_State = createNullableType(_State);
		private final @NonNull NullableType _Nullable_Type = createNullableType(_Type);
		private final @NonNull NullableType _Nullable_UniqueCollection_Tuple = createNullableType(_UniqueCollection_Tuple);
		private final @NonNull NullableType _Nullable_UniqueCollection_Bag_T = createNullableType(_UniqueCollection_Bag_T);
		private final @NonNull NullableType _Nullable_UniqueCollection_Collection_T_NullFree = createNullableType(_UniqueCollection_Collection_T_NullFree);
		private final @NonNull NullableType _Nullable_UniqueCollection_Collection_T = createNullableType(_UniqueCollection_Collection_T);
		private final @NonNull NullableType _Nullable_UniqueCollection_EnumerationLiteral = createNullableType(_UniqueCollection_EnumerationLiteral);
		private final @NonNull NullableType _Nullable_UniqueCollection_Map_K = createNullableType(_UniqueCollection_Map_K);
		private final @NonNull NullableType _Nullable_UniqueCollection_OclAny_NullFree = createNullableType(_UniqueCollection_OclAny_NullFree);
		private final @NonNull NullableType _Nullable_UniqueCollection_OclElement = createNullableType(_UniqueCollection_OclElement);
		private final @NonNull NullableType _Nullable_UniqueCollection_OclSelf = createNullableType(_UniqueCollection_OclSelf);
		private final @NonNull NullableType _Nullable_UniqueCollection_OrderedSet_flatten_T2 = createNullableType(_UniqueCollection_OrderedSet_flatten_T2);
		private final @NonNull NullableType _Nullable_UniqueCollection_OrderedSet_selectByKind_TT = createNullableType(_UniqueCollection_OrderedSet_selectByKind_TT);
		private final @NonNull NullableType _Nullable_UniqueCollection_OrderedSet_selectByType_TT = createNullableType(_UniqueCollection_OrderedSet_selectByType_TT);
		private final @NonNull NullableType _Nullable_UniqueCollection_OrderedSet_T_NullFree = createNullableType(_UniqueCollection_OrderedSet_T_NullFree);
		private final @NonNull NullableType _Nullable_UniqueCollection_Sequence_T = createNullableType(_UniqueCollection_Sequence_T);
		...
		private void installNullableTypes() {
			...
			orphanTypes.add(_Nullable_UnlimitedNatural);
			orphanTypes.add(_Nullabletp_UnlimitedNatural_oclAsType_TT);
			orphanTypes.add(_Nullable_Bag_Bag_collectNested_V_NullFree);
			orphanTypes.add(_Nullable_Bag_Bag_collect_V_NullFree);
			orphanTypes.add(_Nullable_Bag_Bag_flatten_T2_NullFree);
			orphanTypes.add(_Nullable_Bag_Bag_selectByKind_TT_NullFree);
			orphanTypes.add(_Nullable_Bag_Bag_selectByType_TT_NullFree);
			orphanTypes.add(_Nullable_Bag_Collection_T_NullFree);
			orphanTypes.add(_Nullable_Bag_Collection);
			...
			orphanTypes.add(_Nullable_Bag_Set_collectNested_V_NullFree);
			orphanTypes.add(_Nullable_Bag_Set_collect_V_NullFree);
			orphanTypes.add(_Nullable_Bag_Bag_T);
			orphanTypes.add(_Nullabletp_Bag_collectNested_V);
			orphanTypes.add(_Nullabletp_Bag_collect_V);
			orphanTypes.add(_Nullabletp_Bag_flatten_T2);
			orphanTypes.add(_Nullabletp_Bag_selectByKind_TT);
			orphanTypes.add(_Nullabletp_Bag_selectByType_TT);
			orphanTypes.add(_Nullabletp_Bag_T);
			orphanTypes.add(_Nullable_Class);
			orphanTypes.add(_Nullable_Collection_Integer);
			orphanTypes.add(_Nullable_Collection_String);
			orphanTypes.add(_Nullable_Collection_Tuple);
			orphanTypes.add(_Nullable_Collection_Bag_collectNested_V);
			orphanTypes.add(_Nullable_Collection_Bag_collect_V);
			...
			orphanTypes.add(_Nullable_Collection_Collection_flatten_T2_NullFree);
			orphanTypes.add(_Nullable_Collection_Collection_includesAll_T2_NullFree);
			orphanTypes.add(_Nullable_Collection_Collection_product_T2_NullFree);
			orphanTypes.add(_Nullable_Collection_Collection_selectByKind_TT_NullFree);
			orphanTypes.add(_Nullable_Collection_Collection_selectByType_TT_NullFree);
			orphanTypes.add(_Nullable_Collection_Collection_T_1);
			orphanTypes.add(_Nullable_Collection_Collection);
			orphanTypes.add(_Nullable_Collection_EnumerationLiteral);
			orphanTypes.add(_Nullable_Collection_Enumeration);
			orphanTypes.add(_Nullable_Collection_Invalidable);
			orphanTypes.add(_Nullable_Collection_Map_excludesAll_K2_NullFree);
			...
			orphanTypes.add(_Nullable_Collection_OclElement);
			orphanTypes.add(_Nullable_Collection_OclEnumeration);
			orphanTypes.add(_Nullable_Collection_OclSelf);
			orphanTypes.add(_Nullable_Collection_OrderedCollection_T_NullFree);
			orphanTypes.add(_Nullable_Collection_OrderedSet_collectNested_V);
			orphanTypes.add(_Nullable_Collection_OrderedSet_collect_V);
			orphanTypes.add(_Nullable_Collection_OrderedSet_flatten_T2);
			orphanTypes.add(_Nullable_Collection_OrderedSet_selectByKind_TT);
			orphanTypes.add(_Nullable_Collection_OrderedSet_selectByType_TT);
			orphanTypes.add(_Nullable_Collection_OrderedSet_T);
			orphanTypes.add(_Nullable_Collection_Sequence_collectNested_V);
			orphanTypes.add(_Nullable_Collection_Sequence_collect_V);
			orphanTypes.add(_Nullable_Collection_Sequence_flatten_T2);
			orphanTypes.add(_Nullable_Collection_Sequence_selectByKind_TT);
			orphanTypes.add(_Nullable_Collection_Sequence_selectByType_TT);
			orphanTypes.add(_Nullable_Collection_Sequence_T);
			orphanTypes.add(_Nullable_Collection_Set_collectNested_V);
			orphanTypes.add(_Nullable_Collection_Set_collect_V);
			...
			orphanTypes.add(_Nullabletp_Collection_excludesAll_T2);
			orphanTypes.add(_Nullabletp_Collection_flatten_T2);
			orphanTypes.add(_Nullabletp_Collection_includesAll_T2);
			orphanTypes.add(_Nullabletp_Collection_iterate_Tacc);
			orphanTypes.add(_Nullabletp_Collection_product_T2);
			orphanTypes.add(_Nullabletp_Collection_selectByKind_TT);
			orphanTypes.add(_Nullabletp_Collection_selectByType_TT);
			orphanTypes.add(_Nullabletp_Collection_T);
			...
			orphanTypes.add(_Nullabletp_Map_excludingMap_K2);
			orphanTypes.add(_Nullabletp_Map_excludingMap_V2);
			orphanTypes.add(_Nullabletp_Map_includesAll_K2);
			orphanTypes.add(_Nullabletp_Map_includesMap_K2);
			orphanTypes.add(_Nullabletp_Map_includesMap_V2);
			orphanTypes.add(_Nullabletp_Map_includingMap_K2);
			orphanTypes.add(_Nullabletp_Map_includingMap_V2);
			orphanTypes.add(_Nullabletp_Map_K);
			orphanTypes.add(_Nullabletp_Map_V);
			orphanTypes.add(_Nullabletp_Nullable_T);
			orphanTypes.add(_Nullable_OclAny);
			orphanTypes.add(_Nullabletp_OclAny_oclAsType_TT);
			orphanTypes.add(_Nullable_OclComparable);
			orphanTypes.add(_Nullable_OclElement);
			orphanTypes.add(_Nullabletp_OclElement_oclAsModelType_TT);
			orphanTypes.add(_Nullable_OclEnumeration);
			orphanTypes.add(_Nullabletp_OclInvalid_oclAsType_TT);
			orphanTypes.add(_Nullable_OclLambda);
			orphanTypes.add(_Nullable_OclMessage);
			orphanTypes.add(_Nullable_OclSelf);
			orphanTypes.add(_Nullable_OclState);
			orphanTypes.add(_Nullable_OclStereotype);
			orphanTypes.add(_Nullable_OclSummable);
			orphanTypes.add(_Nullable_OclTuple);
			orphanTypes.add(_Nullable_OclType);
			orphanTypes.add(_Nullable_OrderedCollection_Integer);
			orphanTypes.add(_Nullable_OrderedCollection_String);
			orphanTypes.add(_Nullable_OrderedCollection_Bag_T);
			orphanTypes.add(_Nullable_OrderedCollection_Collection_T);
			orphanTypes.add(_Nullable_OrderedCollection_EnumerationLiteral);
			orphanTypes.add(_Nullable_OrderedCollection_OrderedSet_collectNested_V);
			orphanTypes.add(_Nullable_OrderedCollection_OrderedSet_collect_V);
			orphanTypes.add(_Nullable_OrderedCollection_OrderedSet_flatten_T2);
			orphanTypes.add(_Nullable_OrderedCollection_OrderedSet_selectByKind_TT);
			orphanTypes.add(_Nullable_OrderedCollection_OrderedSet_selectByType_TT);
			orphanTypes.add(_Nullable_OrderedCollection_OrderedSet_T_NullFree);
			orphanTypes.add(_Nullable_OrderedCollection_Sequence_collectNested_V);
			orphanTypes.add(_Nullable_OrderedCollection_Sequence_collect_V);
			...
			orphanTypes.add(_Nullabletp_OrderedCollection_T);
			orphanTypes.add(_Nullable_OrderedSet_Collection_T_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_EnumerationLiteral_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_OrderedSet_flatten_T2_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_OrderedSet_selectByKind_TT_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_OrderedSet_selectByType_TT_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_Sequence_T_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_Set_T_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_UniqueCollection_T_NullFree);
			orphanTypes.add(_Nullable_OrderedSet_OrderedSet_T);
			orphanTypes.add(_Nullabletp_OrderedSet_collectNested_V);
			orphanTypes.add(_Nullabletp_OrderedSet_collect_V);
			orphanTypes.add(_Nullabletp_OrderedSet_flatten_T2);
			orphanTypes.add(_Nullabletp_OrderedSet_selectByKind_TT);
			orphanTypes.add(_Nullabletp_OrderedSet_selectByType_TT);
			orphanTypes.add(_Nullabletp_OrderedSet_T);
			orphanTypes.add(_Nullable_Sequence_Integer_NullFree);
			orphanTypes.add(_Nullable_Sequence_String_NullFree);
			orphanTypes.add(_Nullable_Sequence_Bag_T_NullFree);
			orphanTypes.add(_Nullable_Sequence_Collection_T_NullFree);
			orphanTypes.add(_Nullable_Sequence_OrderedSet_collectNested_V_NullFree);
			orphanTypes.add(_Nullable_Sequence_OrderedSet_collect_V_NullFree);
			orphanTypes.add(_Nullable_Sequence_Sequence_collectNested_V_NullFree);
			orphanTypes.add(_Nullable_Sequence_Sequence_collect_V_NullFree);
			orphanTypes.add(_Nullable_Sequence_Sequence_flatten_T2_NullFree);
			orphanTypes.add(_Nullable_Sequence_Sequence_selectByKind_TT_NullFree);
			orphanTypes.add(_Nullable_Sequence_Sequence_selectByType_TT_NullFree);
			orphanTypes.add(_Nullable_Sequence_Sequence_T);
			orphanTypes.add(_Nullabletp_Sequence_collectNested_V);
			orphanTypes.add(_Nullabletp_Sequence_collect_V);
			orphanTypes.add(_Nullabletp_Sequence_flatten_T2);
			orphanTypes.add(_Nullabletp_Sequence_selectByKind_TT);
			orphanTypes.add(_Nullabletp_Sequence_selectByType_TT);
			orphanTypes.add(_Nullabletp_Sequence_T);
			orphanTypes.add(_Nullable_Set_Tuple_NullFree);
			orphanTypes.add(_Nullable_Set_Bag_T_NullFree);
			orphanTypes.add(_Nullable_Set_Collection_T_NullFree);
			orphanTypes.add(_Nullable_Set_Map_K_NullFree);
			orphanTypes.add(_Nullable_Set_OclElement_NullFree);
			orphanTypes.add(_Nullable_Set_OclSelf);
			orphanTypes.add(_Nullable_Set_OclSelf_NullFree);
			orphanTypes.add(_Nullable_Set_Set_flatten_T2_NullFree);
			orphanTypes.add(_Nullable_Set_Set_selectByKind_TT_NullFree);
			orphanTypes.add(_Nullable_Set_Set_selectByType_TT_NullFree);
			orphanTypes.add(_Nullable_Set_UniqueCollection_T_NullFree);
			orphanTypes.add(_Nullable_Set_Set_T);
			orphanTypes.add(_Nullabletp_Set_collectNested_V);
			orphanTypes.add(_Nullabletp_Set_collect_V);
			orphanTypes.add(_Nullabletp_Set_flatten_T2);
			orphanTypes.add(_Nullabletp_Set_selectByKind_TT);
			orphanTypes.add(_Nullabletp_Set_selectByType_TT);
			orphanTypes.add(_Nullabletp_Set_T);
			orphanTypes.add(_Nullable_State);
			orphanTypes.add(_Nullable_Type);
			orphanTypes.add(_Nullable_UniqueCollection_Tuple);
			orphanTypes.add(_Nullable_UniqueCollection_Bag_T);
			orphanTypes.add(_Nullable_UniqueCollection_Collection_T_NullFree);
			orphanTypes.add(_Nullable_UniqueCollection_Collection_T);
			orphanTypes.add(_Nullable_UniqueCollection_EnumerationLiteral);
			orphanTypes.add(_Nullable_UniqueCollection_Map_K);
			orphanTypes.add(_Nullable_UniqueCollection_OclAny_NullFree);
			orphanTypes.add(_Nullable_UniqueCollection_OclElement);
			orphanTypes.add(_Nullable_UniqueCollection_OclSelf);
			orphanTypes.add(_Nullable_UniqueCollection_OrderedSet_flatten_T2);
			orphanTypes.add(_Nullable_UniqueCollection_OrderedSet_selectByKind_TT);
			orphanTypes.add(_Nullable_UniqueCollection_OrderedSet_selectByType_TT);
			orphanTypes.add(_Nullable_UniqueCollection_OrderedSet_T_NullFree);
			orphanTypes.add(_Nullable_UniqueCollection_Sequence_T);
		...
		private final @NonNull InvalidableType _Invalidabletp_Collection_T = createInvalidableType(_Nullabletp_Collection_T);
		private final @NonNull InvalidableType _Invalidabletp_Map_V = createInvalidableType(_Nullabletp_Map_V);
		private final @NonNull InvalidableType _Invalidabletp_OclAny_oclAsType_TT = createInvalidableType(_Nullabletp_OclAny_oclAsType_TT);
		private final @NonNull InvalidableType _Invalidabletp_OclElement_oclAsModelType_TT = createInvalidableType(_Nullabletp_OclElement_oclAsModelType_TT);
		private final @NonNull InvalidableType _Invalidabletp_OrderedCollection_T = createInvalidableType(_Nullabletp_OrderedCollection_T);
		private final @NonNull InvalidableType _Invalidable_OrderedSet_OrderedSet_T = createInvalidableType(_Nullable_OrderedSet_OrderedSet_T);
		private final @NonNull InvalidableType _Invalidable_Sequence_Sequence_T = createInvalidableType(_Nullable_Sequence_Sequence_T);
		...
		private final @NonNull Property pr_Invalidable_nonInvalidType = createProperty("nonInvalidType", _OclType);
		...
		private void installTemplateBindings() {
			...
			_Bag_Nullable.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Bag_T, _Nullable)));
			...
			_Collection_Nullable.getOwnedBindings().add(createTemplateBinding(
				createTemplateParameterSubstitution(tp_Collection_T, _Nullable)));
