...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private final @NonNull BagType _Bag_Bag_T_T = getBagType(_Bag_Bag_T, true, 0, -1, tp_Bag_T);
		private final @NonNull BagType _Bag_Bag_collect_V_T = getBagType(_Bag_Bag_T, true, 0, -1, tp_Bag_collect_V);
		private final @NonNull BagType _Bag_Bag_collectNested_V_T = getBagType(_Bag_Bag_T, true, 0, -1, tp_Bag_collectNested_V);
		private final @NonNull BagType _Bag_Bag_flatten_T2_T = getBagType(_Bag_Bag_T, true, 0, -1, tp_Bag_flatten_T2);
		private final @NonNull BagType _Bag_Bag_selectByKind_TT_T = getBagType(_Bag_Bag_T, true, 0, -1, tp_Bag_selectByKind_TT);
		private final @NonNull BagType _Bag_Bag_selectByType_TT_T = getBagType(_Bag_Bag_T, true, 0, -1, tp_Bag_selectByType_TT);
		private final @NonNull BagType _Bag_Collection_T_T = getBagType(_Bag_Bag_T, true, 0, -1, tp_Collection_T);
		private final @NonNull BagType _Bag_CollectionType_F = getBagType(_Bag_Bag_T, false, 0, -1, _CollectionType);
		private final @NonNull BagType _Bag_Map_V_T = getBagType(_Bag_Bag_T, true, 0, -1, tp_Map_V);
		private final @NonNull BagType _Bag_Map_collect_V2_F = getBagType(_Bag_Bag_T, false, 0, -1, tp_Map_collect_V2);
		private final @NonNull BagType _Bag_MapType_F = getBagType(_Bag_Bag_T, false, 0, -1, _MapType);
		private final @NonNull BagType _Bag_OclElement_F = getBagType(_Bag_Bag_T, false, 0, -1, _OclElement);
		private final @NonNull BagType _Bag_OclInvalid_F = getBagType(_Bag_Bag_T, false, 0, -1, _OclInvalid);
		private final @NonNull BagType _Bag_Set_collect_V_T = getBagType(_Bag_Bag_T, true, 0, -1, tp_Set_collect_V);
		private final @NonNull BagType _Bag_Set_collectNested_V_T = getBagType(_Bag_Bag_T, true, 0, -1, tp_Set_collectNested_V);
		private final @NonNull CollectionType _Collection_Bag_T_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Bag_T);
		private final @NonNull CollectionType _Collection_Bag_T_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Bag_T);
		private final @NonNull CollectionType _Collection_Bag_collect_V_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Bag_collect_V);
		private final @NonNull CollectionType _Collection_Bag_collectNested_V_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Bag_collectNested_V);
		private final @NonNull CollectionType _Collection_Bag_flatten_T2_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Bag_flatten_T2);
		private final @NonNull CollectionType _Collection_Bag_selectByKind_TT_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Bag_selectByKind_TT);
		private final @NonNull CollectionType _Collection_Bag_selectByType_TT_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Bag_selectByType_TT);
		private final @NonNull CollectionType _Collection_Collection_T_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Collection_T);
		private final @NonNull CollectionType _Collection_Collection_T_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Collection_T);
		private final @NonNull CollectionType _Collection_Collection_collect_V_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Collection_collect_V);
		private final @NonNull CollectionType _Collection_Collection_collectNested_V_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Collection_collectNested_V);
		private final @NonNull CollectionType _Collection_Collection_excludesAll_T2_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Collection_excludesAll_T2);
		private final @NonNull CollectionType _Collection_Collection_flatten_T2_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Collection_flatten_T2);
		private final @NonNull CollectionType _Collection_Collection_includesAll_T2_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Collection_includesAll_T2);
		private final @NonNull CollectionType _Collection_Collection_product_T2_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Collection_product_T2);
		private final @NonNull CollectionType _Collection_Collection_selectByKind_TT_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Collection_selectByKind_TT);
		private final @NonNull CollectionType _Collection_Collection_selectByType_TT_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Collection_selectByType_TT);
		private final @NonNull CollectionType _Collection_CollectionType_F = getCollectionType(_Collection_Collection_T, false, 0, -1, _CollectionType);
		private final @NonNull CollectionType _Collection_Integer_F = getCollectionType(_Collection_Collection_T, false, 0, -1, _Integer);
		private final @NonNull CollectionType _Collection_Map_K_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Map_K);
		private final @NonNull CollectionType _Collection_Map_K_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Map_K);
		private final @NonNull CollectionType _Collection_Map_V_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Map_V);
		private final @NonNull CollectionType _Collection_Map_collect_V2_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Map_collect_V2);
		private final @NonNull CollectionType _Collection_Map_excludesAll_K2_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Map_excludesAll_K2);
		private final @NonNull CollectionType _Collection_Map_includesAll_K2_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Map_includesAll_K2);
		private final @NonNull CollectionType _Collection_MapType_F = getCollectionType(_Collection_Collection_T, false, 0, -1, _MapType);
		private final @NonNull CollectionType _Collection_OclAny_F = getCollectionType(_Collection_Collection_T, false, 0, -1, _OclAny);
		private final @NonNull CollectionType _Collection_OclElement_F = getCollectionType(_Collection_Collection_T, false, 0, -1, _OclElement);
		private final @NonNull CollectionType _Collection_OclInvalid_F = getCollectionType(_Collection_Collection_T, false, 0, -1, _OclInvalid);
		private final @NonNull CollectionType _Collection_OclSelf_F = getCollectionType(_Collection_Collection_T, false, 0, -1, _OclSelf);
		private final @NonNull CollectionType _Collection_OrderedCollection_T_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_OrderedCollection_T);
		private final @NonNull CollectionType _Collection_OrderedSet_T_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_OrderedSet_T);
		private final @NonNull CollectionType _Collection_OrderedSet_T_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_OrderedSet_T);
		private final @NonNull CollectionType _Collection_OrderedSet_collect_V_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_OrderedSet_collect_V);
		private final @NonNull CollectionType _Collection_OrderedSet_collectNested_V_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_OrderedSet_collectNested_V);
		private final @NonNull CollectionType _Collection_OrderedSet_flatten_T2_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_OrderedSet_flatten_T2);
		private final @NonNull CollectionType _Collection_OrderedSet_selectByKind_TT_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_OrderedSet_selectByKind_TT);
		private final @NonNull CollectionType _Collection_OrderedSet_selectByType_TT_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_OrderedSet_selectByType_TT);
		private final @NonNull CollectionType _Collection_Sequence_T_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Sequence_T);
		private final @NonNull CollectionType _Collection_Sequence_T_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Sequence_T);
		private final @NonNull CollectionType _Collection_Sequence_collect_V_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Sequence_collect_V);
		private final @NonNull CollectionType _Collection_Sequence_collectNested_V_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Sequence_collectNested_V);
		private final @NonNull CollectionType _Collection_Sequence_flatten_T2_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Sequence_flatten_T2);
		private final @NonNull CollectionType _Collection_Sequence_selectByKind_TT_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Sequence_selectByKind_TT);
		private final @NonNull CollectionType _Collection_Sequence_selectByType_TT_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Sequence_selectByType_TT);
		private final @NonNull CollectionType _Collection_Set_T_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Set_T);
		private final @NonNull CollectionType _Collection_Set_T_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_Set_T);
		private final @NonNull CollectionType _Collection_Set_collect_V_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Set_collect_V);
		private final @NonNull CollectionType _Collection_Set_collectNested_V_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Set_collectNested_V);
		private final @NonNull CollectionType _Collection_Set_flatten_T2_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Set_flatten_T2);
		private final @NonNull CollectionType _Collection_Set_selectByKind_TT_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Set_selectByKind_TT);
		private final @NonNull CollectionType _Collection_Set_selectByType_TT_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_Set_selectByType_TT);
		private final @NonNull CollectionType _Collection_String_F = getCollectionType(_Collection_Collection_T, false, 0, -1, _String);
		private final @NonNull CollectionType _Collection_Tuple_F = getCollectionType(_Collection_Collection_T, false, 0, -1, _Tuple);
		private final @NonNull CollectionType _Collection_UniqueCollection_T_F = getCollectionType(_Collection_Collection_T, false, 0, -1, tp_UniqueCollection_T);
		private final @NonNull CollectionType _Collection_UniqueCollection_T_T = getCollectionType(_Collection_Collection_T, true, 0, -1, tp_UniqueCollection_T);
		private final @NonNull CollectionType _OrderedCollection_Bag_T_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_Bag_T);
		private final @NonNull CollectionType _OrderedCollection_Collection_T_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_Collection_T);
		private final @NonNull CollectionType _OrderedCollection_Integer_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, _Integer);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_T_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_OrderedSet_T);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_T_T = getCollectionType(_OrderedCollection_OrderedCollection_T, true, 0, -1, tp_OrderedSet_T);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_collect_V_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_OrderedSet_collect_V);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_collectNested_V_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_OrderedSet_collectNested_V);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_flatten_T2_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_OrderedSet_flatten_T2);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_selectByKind_TT_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_OrderedSet_selectByKind_TT);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_selectByType_TT_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_OrderedSet_selectByType_TT);
		private final @NonNull CollectionType _OrderedCollection_Sequence_T_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_Sequence_T);
		private final @NonNull CollectionType _OrderedCollection_Sequence_T_T = getCollectionType(_OrderedCollection_OrderedCollection_T, true, 0, -1, tp_Sequence_T);
		private final @NonNull CollectionType _OrderedCollection_Sequence_collect_V_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_Sequence_collect_V);
		private final @NonNull CollectionType _OrderedCollection_Sequence_collectNested_V_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_Sequence_collectNested_V);
		private final @NonNull CollectionType _OrderedCollection_Sequence_flatten_T2_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_Sequence_flatten_T2);
		private final @NonNull CollectionType _OrderedCollection_Sequence_selectByKind_TT_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_Sequence_selectByKind_TT);
		private final @NonNull CollectionType _OrderedCollection_Sequence_selectByType_TT_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_Sequence_selectByType_TT);
		private final @NonNull CollectionType _OrderedCollection_Set_T_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_Set_T);
		private final @NonNull CollectionType _OrderedCollection_String_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, _String);
		private final @NonNull CollectionType _OrderedCollection_UniqueCollection_T_F = getCollectionType(_OrderedCollection_OrderedCollection_T, false, 0, -1, tp_UniqueCollection_T);
		private final @NonNull OrderedSetType _OrderedSet_Collection_T_T = getOrderedSetType(_OrderedSet_OrderedSet_T, true, 0, -1, tp_Collection_T);
		private final @NonNull OrderedSetType _OrderedSet_OrderedSet_T_T = getOrderedSetType(_OrderedSet_OrderedSet_T, true, 0, -1, tp_OrderedSet_T);
		private final @NonNull OrderedSetType _OrderedSet_OrderedSet_flatten_T2_T = getOrderedSetType(_OrderedSet_OrderedSet_T, true, 0, -1, tp_OrderedSet_flatten_T2);
		private final @NonNull OrderedSetType _OrderedSet_OrderedSet_selectByKind_TT_T = getOrderedSetType(_OrderedSet_OrderedSet_T, true, 0, -1, tp_OrderedSet_selectByKind_TT);
		private final @NonNull OrderedSetType _OrderedSet_OrderedSet_selectByType_TT_T = getOrderedSetType(_OrderedSet_OrderedSet_T, true, 0, -1, tp_OrderedSet_selectByType_TT);
		private final @NonNull OrderedSetType _OrderedSet_Sequence_T_T = getOrderedSetType(_OrderedSet_OrderedSet_T, true, 0, -1, tp_Sequence_T);
		private final @NonNull OrderedSetType _OrderedSet_Set_T_T = getOrderedSetType(_OrderedSet_OrderedSet_T, true, 0, -1, tp_Set_T);
		private final @NonNull OrderedSetType _OrderedSet_UniqueCollection_T_T = getOrderedSetType(_OrderedSet_OrderedSet_T, true, 0, -1, tp_UniqueCollection_T);
		private final @NonNull SequenceType _Sequence_Bag_T_T = getSequenceType(_Sequence_Sequence_T, true, 0, -1, tp_Bag_T);
		private final @NonNull SequenceType _Sequence_Collection_T_T = getSequenceType(_Sequence_Sequence_T, true, 0, -1, tp_Collection_T);
		private final @NonNull SequenceType _Sequence_Integer_T = getSequenceType(_Sequence_Sequence_T, true, 0, -1, _Integer);
		private final @NonNull SequenceType _Sequence_OrderedSet_collect_V_T = getSequenceType(_Sequence_Sequence_T, true, 0, -1, tp_OrderedSet_collect_V);
		private final @NonNull SequenceType _Sequence_OrderedSet_collectNested_V_T = getSequenceType(_Sequence_Sequence_T, true, 0, -1, tp_OrderedSet_collectNested_V);
		private final @NonNull SequenceType _Sequence_Sequence_T_T = getSequenceType(_Sequence_Sequence_T, true, 0, -1, tp_Sequence_T);
		private final @NonNull SequenceType _Sequence_Sequence_collect_V_T = getSequenceType(_Sequence_Sequence_T, true, 0, -1, tp_Sequence_collect_V);
		private final @NonNull SequenceType _Sequence_Sequence_collectNested_V_T = getSequenceType(_Sequence_Sequence_T, true, 0, -1, tp_Sequence_collectNested_V);
		private final @NonNull SequenceType _Sequence_Sequence_flatten_T2_T = getSequenceType(_Sequence_Sequence_T, true, 0, -1, tp_Sequence_flatten_T2);
		private final @NonNull SequenceType _Sequence_Sequence_selectByKind_TT_T = getSequenceType(_Sequence_Sequence_T, true, 0, -1, tp_Sequence_selectByKind_TT);
		private final @NonNull SequenceType _Sequence_Sequence_selectByType_TT_T = getSequenceType(_Sequence_Sequence_T, true, 0, -1, tp_Sequence_selectByType_TT);
		private final @NonNull SequenceType _Sequence_String_T = getSequenceType(_Sequence_Sequence_T, true, 0, -1, _String);
		private final @NonNull SetType _Set_Bag_T_T = getSetType(_Set_Set_T, true, 0, -1, tp_Bag_T);
		private final @NonNull SetType _Set_Collection_T_T = getSetType(_Set_Set_T, true, 0, -1, tp_Collection_T);
		private final @NonNull SetType _Set_Map_K_T = getSetType(_Set_Set_T, true, 0, -1, tp_Map_K);
		private final @NonNull SetType _Set_OclElement_T = getSetType(_Set_Set_T, true, 0, -1, _OclElement);
		private final @NonNull SetType _Set_OclSelf_F = getSetType(_Set_Set_T, false, 0, -1, _OclSelf);
		private final @NonNull SetType _Set_OclSelf_T = getSetType(_Set_Set_T, true, 0, -1, _OclSelf);
		private final @NonNull SetType _Set_Set_T_T = getSetType(_Set_Set_T, true, 0, -1, tp_Set_T);
		private final @NonNull SetType _Set_Set_flatten_T2_T = getSetType(_Set_Set_T, true, 0, -1, tp_Set_flatten_T2);
		private final @NonNull SetType _Set_Set_selectByKind_TT_T = getSetType(_Set_Set_T, true, 0, -1, tp_Set_selectByKind_TT);
		private final @NonNull SetType _Set_Set_selectByType_TT_T = getSetType(_Set_Set_T, true, 0, -1, tp_Set_selectByType_TT);
		private final @NonNull SetType _Set_Tuple_T = getSetType(_Set_Set_T, true, 0, -1, _Tuple);
		private final @NonNull SetType _Set_UniqueCollection_T_T = getSetType(_Set_Set_T, true, 0, -1, tp_UniqueCollection_T);
		private final @NonNull CollectionType _UniqueCollection_Bag_T_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_Bag_T);
		private final @NonNull CollectionType _UniqueCollection_Collection_T_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_Collection_T);
		private final @NonNull CollectionType _UniqueCollection_Collection_T_T = getCollectionType(_UniqueCollection_UniqueCollection_T, true, 0, -1, tp_Collection_T);
		private final @NonNull CollectionType _UniqueCollection_Map_K_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_Map_K);
		private final @NonNull CollectionType _UniqueCollection_OclAny_T = getCollectionType(_UniqueCollection_UniqueCollection_T, true, 0, -1, _OclAny);
		private final @NonNull CollectionType _UniqueCollection_OclElement_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, _OclElement);
		private final @NonNull CollectionType _UniqueCollection_OclSelf_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, _OclSelf);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_T_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_OrderedSet_T);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_T_T = getCollectionType(_UniqueCollection_UniqueCollection_T, true, 0, -1, tp_OrderedSet_T);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_flatten_T2_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_OrderedSet_flatten_T2);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_selectByKind_TT_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_OrderedSet_selectByKind_TT);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_selectByType_TT_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_OrderedSet_selectByType_TT);
		private final @NonNull CollectionType _UniqueCollection_Sequence_T_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_Sequence_T);
		private final @NonNull CollectionType _UniqueCollection_Set_T_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_Set_T);
		private final @NonNull CollectionType _UniqueCollection_Set_T_T = getCollectionType(_UniqueCollection_UniqueCollection_T, true, 0, -1, tp_Set_T);
		private final @NonNull CollectionType _UniqueCollection_Set_flatten_T2_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_Set_flatten_T2);
		private final @NonNull CollectionType _UniqueCollection_Set_selectByKind_TT_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_Set_selectByKind_TT);
		private final @NonNull CollectionType _UniqueCollection_Set_selectByType_TT_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_Set_selectByType_TT);
		private final @NonNull CollectionType _UniqueCollection_Tuple_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, _Tuple);
		private final @NonNull CollectionType _UniqueCollection_UniqueCollection_T_F = getCollectionType(_UniqueCollection_UniqueCollection_T, false, 0, -1, tp_UniqueCollection_T);
		private final @NonNull CollectionType _UniqueCollection_UniqueCollection_T_T = getCollectionType(_UniqueCollection_UniqueCollection_T, true, 0, -1, tp_UniqueCollection_T);

		private final @NonNull MapType _Map_Map_K_Map_V = createMapType(OCLstdlibPackage.Literals.MAP, tp_Map_K, tp_Map_V);
		private final @NonNull MapType _Map_Collection_T_F_Collection_collectBy_V_F = getMapType(_Map_Map_K_Map_V, tp_Collection_T, tp_Collection_collectBy_V);
		private final @NonNull MapType _Map_Map_excludesMap_K2_T_Map_excludesMap_V2_T = getMapType(_Map_Map_K_Map_V, tp_Map_excludesMap_K2, tp_Map_excludesMap_V2);
		private final @NonNull MapType _Map_Map_excludingMap_K2_T_Map_excludingMap_V2_T = getMapType(_Map_Map_K_Map_V, tp_Map_excludingMap_K2, tp_Map_excludingMap_V2);
		private final @NonNull MapType _Map_Map_includesMap_K2_T_Map_includesMap_V2_T = getMapType(_Map_Map_K_Map_V, tp_Map_includesMap_K2, tp_Map_includesMap_V2);
		private final @NonNull MapType _Map_Map_includingMap_K2_T_Map_includingMap_V2_T = getMapType(_Map_Map_K_Map_V, tp_Map_includingMap_K2, tp_Map_includingMap_V2);
		private final @NonNull MapType _Map_Map_K_F_Map_collectBy_V2_F = getMapType(_Map_Map_K_Map_V, tp_Map_K, tp_Map_collectBy_V2);
		private final @NonNull MapType _Map_Map_K_F_Map_collectNested_V2_F = getMapType(_Map_Map_K_Map_V, tp_Map_K, tp_Map_collectNested_V2);
		private final @NonNull MapType _Map_Map_K_F_Map_V_F = getMapType(_Map_Map_K_Map_V, tp_Map_K, tp_Map_V);

		private final @NonNull Precedence prec_ADDITIVE = createPrecedence("ADDITIVE", AssociativityKind.LEFT);
		private final @NonNull Precedence prec_AND = createPrecedence("AND", AssociativityKind.LEFT);
		private final @NonNull Precedence prec_EQUALITY = createPrecedence("EQUALITY", AssociativityKind.LEFT);
		private final @NonNull Precedence prec_IMPLIES = createPrecedence("IMPLIES", AssociativityKind.LEFT);
		private final @NonNull Precedence prec_MULTIPLICATIVE = createPrecedence("MULTIPLICATIVE", AssociativityKind.LEFT);
		private final @NonNull Precedence prec_NAVIGATION = createPrecedence("NAVIGATION", AssociativityKind.LEFT);
		private final @NonNull Precedence prec_OR = createPrecedence("OR", AssociativityKind.LEFT);
		private final @NonNull Precedence prec_RELATIONAL = createPrecedence("RELATIONAL", AssociativityKind.LEFT);
		private final @NonNull Precedence prec_UNARY = createPrecedence("UNARY", AssociativityKind.LEFT);
		private final @NonNull Precedence prec_XOR = createPrecedence("XOR", AssociativityKind.LEFT);
		...
		private void installClassTypes() {
			...
			type = _State;
			addSuperClass(type, _OclState);
			ownedClasses.add(type);
			type = _Stereotype;
			addSuperClass(type, _OclStereotype);
			ownedClasses.add(type);
			type = _Type;
			addSuperClass(type, _OclType);
			ownedClasses.add(type);
		...
		private void installCollectionTypes() {
			...
			ownedClasses = ocl.getOwnedClasses();
			type = _Bag_Bag_T;
			addSuperClass(type, _Collection_Bag_T_T);
			ownedClasses.add(type);
			...
			type.setIsAbstract(true);
			addSuperClass(type, _Collection_OrderedCollection_T_T);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OrderedCollection_OrderedSet_T_T);
			addSuperClass(type, _UniqueCollection_OrderedSet_T_T);
			ownedClasses.add(type);
			...
			addSuperClass(type, _OrderedCollection_Sequence_T_T);
			ownedClasses.add(type);
			...
			type = _Set_Set_T;
			addSuperClass(type, _UniqueCollection_Set_T_T);
			ownedClasses.add(type);
			type = _UniqueCollection_UniqueCollection_T;
			type.setIsAbstract(true);
			addSuperClass(type, _Collection_UniqueCollection_T_T);
			ownedClasses.add(type);
			...
			type = _Bag_Bag_T_T;
			addSuperClass(type, _Collection_Bag_T_F);
			ownedClasses.add(type);
			type = _Bag_Bag_collect_V_T;
			addSuperClass(type, _Collection_Bag_collect_V_F);
			ownedClasses.add(type);
			type = _Bag_Bag_collectNested_V_T;
			addSuperClass(type, _Collection_Bag_collectNested_V_F);
			ownedClasses.add(type);
			type = _Bag_Bag_flatten_T2_T;
			addSuperClass(type, _Collection_Bag_flatten_T2_F);
			ownedClasses.add(type);
			type = _Bag_Bag_selectByKind_TT_T;
			addSuperClass(type, _Collection_Bag_selectByKind_TT_F);
			ownedClasses.add(type);
			type = _Bag_Bag_selectByType_TT_T;
			addSuperClass(type, _Collection_Bag_selectByType_TT_F);
			ownedClasses.add(type);
			type = _Bag_Collection_T_T;
			addSuperClass(type, _Collection_Collection_T_F);
			ownedClasses.add(type);
			type = _Bag_CollectionType_F;
			addSuperClass(type, _Collection_CollectionType_F);
			ownedClasses.add(type);
			type = _Bag_Map_V_T;
			addSuperClass(type, _Collection_Map_V_F);
			ownedClasses.add(type);
			type = _Bag_Map_collect_V2_F;
			addSuperClass(type, _Collection_Map_collect_V2_F);
			ownedClasses.add(type);
			type = _Bag_MapType_F;
			addSuperClass(type, _Collection_MapType_F);
			ownedClasses.add(type);
			type = _Bag_OclElement_F;
			addSuperClass(type, _Collection_OclElement_F);
			ownedClasses.add(type);
			type = _Bag_OclInvalid_F;
			addSuperClass(type, _Collection_OclInvalid_F);
			ownedClasses.add(type);
			type = _Bag_Set_collect_V_T;
			addSuperClass(type, _Collection_Set_collect_V_F);
			ownedClasses.add(type);
			type = _Bag_Set_collectNested_V_T;
			addSuperClass(type, _Collection_Set_collectNested_V_F);
			ownedClasses.add(type);
			...
			addSuperClass(type, _Collection_Integer_F);
			ownedClasses.add(type);
			type = _OrderedCollection_OrderedSet_T_F;
			addSuperClass(type, _Collection_OrderedSet_T_F);
			ownedClasses.add(type);
			type = _OrderedCollection_OrderedSet_T_T;
			addSuperClass(type, _Collection_OrderedSet_T_F);
			ownedClasses.add(type);
			type = _OrderedCollection_OrderedSet_collect_V_F;
			addSuperClass(type, _Collection_OrderedSet_collect_V_F);
			ownedClasses.add(type);
			type = _OrderedCollection_OrderedSet_collectNested_V_F;
			addSuperClass(type, _Collection_OrderedSet_collectNested_V_F);
			ownedClasses.add(type);
			type = _OrderedCollection_OrderedSet_flatten_T2_F;
			addSuperClass(type, _Collection_OrderedSet_flatten_T2_F);
			ownedClasses.add(type);
			type = _OrderedCollection_OrderedSet_selectByKind_TT_F;
			addSuperClass(type, _Collection_OrderedSet_selectByKind_TT_F);
			ownedClasses.add(type);
			type = _OrderedCollection_OrderedSet_selectByType_TT_F;
			addSuperClass(type, _Collection_OrderedSet_selectByType_TT_F);
			ownedClasses.add(type);
			type = _OrderedCollection_Sequence_T_F;
			addSuperClass(type, _Collection_Sequence_T_F);
			ownedClasses.add(type);
			type = _OrderedCollection_Sequence_T_T;
			addSuperClass(type, _Collection_Sequence_T_F);
			ownedClasses.add(type);
			type = _OrderedCollection_Sequence_collect_V_F;
			addSuperClass(type, _Collection_Sequence_collect_V_F);
			ownedClasses.add(type);
			type = _OrderedCollection_Sequence_collectNested_V_F;
			addSuperClass(type, _Collection_Sequence_collectNested_V_F);
			ownedClasses.add(type);
			type = _OrderedCollection_Sequence_flatten_T2_F;
			addSuperClass(type, _Collection_Sequence_flatten_T2_F);
			ownedClasses.add(type);
			type = _OrderedCollection_Sequence_selectByKind_TT_F;
			addSuperClass(type, _Collection_Sequence_selectByKind_TT_F);
			ownedClasses.add(type);
			type = _OrderedCollection_Sequence_selectByType_TT_F;
			addSuperClass(type, _Collection_Sequence_selectByType_TT_F);
			ownedClasses.add(type);
			type = _OrderedCollection_Set_T_F;
			addSuperClass(type, _Collection_Set_T_F);
			ownedClasses.add(type);
			type = _OrderedCollection_String_F;
			addSuperClass(type, _Collection_String_F);
			ownedClasses.add(type);
			type = _OrderedCollection_UniqueCollection_T_F;
			addSuperClass(type, _Collection_UniqueCollection_T_F);
			ownedClasses.add(type);
			type = _OrderedSet_Collection_T_T;
			addSuperClass(type, _OrderedCollection_Collection_T_F);
			addSuperClass(type, _UniqueCollection_Collection_T_F);
			ownedClasses.add(type);
			type = _OrderedSet_OrderedSet_T_T;
			addSuperClass(type, _OrderedCollection_OrderedSet_T_F);
			addSuperClass(type, _UniqueCollection_OrderedSet_T_F);
			ownedClasses.add(type);
			type = _OrderedSet_OrderedSet_flatten_T2_T;
			addSuperClass(type, _OrderedCollection_OrderedSet_flatten_T2_F);
			addSuperClass(type, _UniqueCollection_OrderedSet_flatten_T2_F);
			ownedClasses.add(type);
			type = _OrderedSet_OrderedSet_selectByKind_TT_T;
			addSuperClass(type, _OrderedCollection_OrderedSet_selectByKind_TT_F);
			addSuperClass(type, _UniqueCollection_OrderedSet_selectByKind_TT_F);
			ownedClasses.add(type);
			type = _OrderedSet_OrderedSet_selectByType_TT_T;
			addSuperClass(type, _OrderedCollection_OrderedSet_selectByType_TT_F);
			addSuperClass(type, _UniqueCollection_OrderedSet_selectByType_TT_F);
			ownedClasses.add(type);
			type = _OrderedSet_Sequence_T_T;
			addSuperClass(type, _OrderedCollection_Sequence_T_F);
			addSuperClass(type, _UniqueCollection_Sequence_T_F);
			ownedClasses.add(type);
			type = _OrderedSet_Set_T_T;
			addSuperClass(type, _OrderedCollection_Set_T_F);
			addSuperClass(type, _UniqueCollection_Set_T_F);
			ownedClasses.add(type);
			type = _OrderedSet_UniqueCollection_T_T;
			addSuperClass(type, _OrderedCollection_UniqueCollection_T_F);
			addSuperClass(type, _UniqueCollection_UniqueCollection_T_F);
			ownedClasses.add(type);
			type = _Sequence_Bag_T_T;
			addSuperClass(type, _OrderedCollection_Bag_T_F);
			ownedClasses.add(type);
			type = _Sequence_Collection_T_T;
			addSuperClass(type, _OrderedCollection_Collection_T_F);
			ownedClasses.add(type);
			type = _Sequence_Integer_T;
			addSuperClass(type, _OrderedCollection_Integer_F);
			ownedClasses.add(type);
			type = _Sequence_OrderedSet_collect_V_T;
			addSuperClass(type, _OrderedCollection_OrderedSet_collect_V_F);
			ownedClasses.add(type);
			type = _Sequence_OrderedSet_collectNested_V_T;
			addSuperClass(type, _OrderedCollection_OrderedSet_collectNested_V_F);
			ownedClasses.add(type);
			type = _Sequence_Sequence_T_T;
			addSuperClass(type, _OrderedCollection_Sequence_T_F);
			ownedClasses.add(type);
			type = _Sequence_Sequence_collect_V_T;
			addSuperClass(type, _OrderedCollection_Sequence_collect_V_F);
			ownedClasses.add(type);
			type = _Sequence_Sequence_collectNested_V_T;
			addSuperClass(type, _OrderedCollection_Sequence_collectNested_V_F);
			ownedClasses.add(type);
			type = _Sequence_Sequence_flatten_T2_T;
			addSuperClass(type, _OrderedCollection_Sequence_flatten_T2_F);
			ownedClasses.add(type);
			type = _Sequence_Sequence_selectByKind_TT_T;
			addSuperClass(type, _OrderedCollection_Sequence_selectByKind_TT_F);
			ownedClasses.add(type);
			type = _Sequence_Sequence_selectByType_TT_T;
			addSuperClass(type, _OrderedCollection_Sequence_selectByType_TT_F);
			ownedClasses.add(type);
			type = _Sequence_String_T;
			addSuperClass(type, _OrderedCollection_String_F);
			ownedClasses.add(type);
			type = _Set_Bag_T_T;
			addSuperClass(type, _UniqueCollection_Bag_T_F);
			ownedClasses.add(type);
			type = _Set_Collection_T_T;
			addSuperClass(type, _UniqueCollection_Collection_T_F);
			ownedClasses.add(type);
			type = _Set_Map_K_T;
			addSuperClass(type, _UniqueCollection_Map_K_F);
			ownedClasses.add(type);
			type = _Set_OclElement_T;
			addSuperClass(type, _UniqueCollection_OclElement_F);
			ownedClasses.add(type);
			type = _Set_OclSelf_F;
			addSuperClass(type, _UniqueCollection_OclSelf_F);
			ownedClasses.add(type);
			type = _Set_OclSelf_T;
			addSuperClass(type, _UniqueCollection_OclSelf_F);
			ownedClasses.add(type);
			...
			addSuperClass(type, _UniqueCollection_Set_flatten_T2_F);
			ownedClasses.add(type);
			type = _Set_Set_selectByKind_TT_T;
			addSuperClass(type, _UniqueCollection_Set_selectByKind_TT_F);
			ownedClasses.add(type);
			type = _Set_Set_selectByType_TT_T;
			addSuperClass(type, _UniqueCollection_Set_selectByType_TT_F);
			ownedClasses.add(type);
			type = _Set_Tuple_T;
			addSuperClass(type, _UniqueCollection_Tuple_F);
			ownedClasses.add(type);
			...
			addSuperClass(type, _Collection_Map_K_F);
			ownedClasses.add(type);
			type = _UniqueCollection_OclAny_T;
			addSuperClass(type, _Collection_OclAny_F);
			ownedClasses.add(type);
			type = _UniqueCollection_OclElement_F;
			addSuperClass(type, _Collection_OclElement_F);
			ownedClasses.add(type);
			type = _UniqueCollection_OclSelf_F;
			addSuperClass(type, _Collection_OclSelf_F);
			ownedClasses.add(type);
			...
			addSuperClass(type, _Collection_Set_flatten_T2_F);
			ownedClasses.add(type);
			type = _UniqueCollection_Set_selectByKind_TT_F;
			addSuperClass(type, _Collection_Set_selectByKind_TT_F);
			ownedClasses.add(type);
			type = _UniqueCollection_Set_selectByType_TT_F;
			addSuperClass(type, _Collection_Set_selectByType_TT_F);
			ownedClasses.add(type);
			type = _UniqueCollection_Tuple_F;
			addSuperClass(type, _Collection_Tuple_F);
			ownedClasses.add(type);
		...
		private void installOperations() {
			...
			ownedOperations.add(operation = createOperation("excluding", _Bag_Bag_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("excludingAll", _Bag_Bag_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("flatten", _Bag_Bag_flatten_T2_T, "org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation", org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation.INSTANCE, tp_Bag_flatten_T2));
			...
			ownedOperations.add(operation = createOperation("including", _Bag_Bag_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", tp_Bag_T, false));
			installComment(operation, "The bag containing all elements of oclText[self] plus object.");
			ownedOperations.add(operation = createOperation("includingAll", _Bag_Bag_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("objects", _Collection_Bag_T_T, true));
			...
			ownedOperations.add(operation = createOperation("asBag", _Bag_Collection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionAsBagOperation", org.eclipse.ocl.pivot.library.collection.CollectionAsBagOperation.INSTANCE));
			installComment(operation, "The Bag that contains all the elements from oclText[self].");
			ownedOperations.add(operation = createOperation("asOrderedSet", _OrderedSet_Collection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionAsOrderedSetOperation", org.eclipse.ocl.pivot.library.collection.CollectionAsOrderedSetOperation.INSTANCE));
			...
			ownedOperations.add(operation = createOperation("asSequence", _Sequence_Collection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionAsSequenceOperation", org.eclipse.ocl.pivot.library.collection.CollectionAsSequenceOperation.INSTANCE));
			...
			ownedOperations.add(operation = createOperation("asSet", _Set_Collection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionAsSetOperation", org.eclipse.ocl.pivot.library.collection.CollectionAsSetOperation.INSTANCE));
			...
			ownedOperations.add(operation = createOperation("excluding", _Collection_Collection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", tp_Collection_T, false));
			installComment(operation, "The collection containing all elements of oclText[self] apart from object.");
			ownedOperations.add(operation = createOperation("excludingAll", _Collection_Collection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("flatten", _Collection_Collection_flatten_T2_T, "org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation", org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation.INSTANCE, tp_Collection_flatten_T2));
			...
			ownedOperations.add(operation = createOperation("including", _Collection_Collection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", tp_Collection_T, false));
			installComment(operation, "The collection containing all elements of oclText[self] plus object.");
			ownedOperations.add(operation = createOperation("includingAll", _Collection_Collection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("objects", _Collection_Collection_T_T, true));
			installComment(operation, "The collection containing all elements of oclText[self] and objects.");
			ownedOperations.add(operation = createOperation("intersection", _Bag_Collection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIntersectionOperation", org.eclipse.ocl.pivot.library.collection.CollectionIntersectionOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("intersection", _Set_Collection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIntersectionOperation", org.eclipse.ocl.pivot.library.collection.CollectionIntersectionOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("union", _Bag_Collection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionUnionOperation", org.eclipse.ocl.pivot.library.collection.CollectionUnionOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("c", _Collection_Collection_T_T, true));
			...
			ownedOperations.add(operation = createOperation("keys", _Set_Map_K_T, "org.eclipse.ocl.pivot.library.map.MapKeysOperation", org.eclipse.ocl.pivot.library.map.MapKeysOperation.INSTANCE));
			...
			ownedOperations.add(operation = createOperation("values", _Bag_Map_V_T, "org.eclipse.ocl.pivot.library.map.MapValuesOperation", org.eclipse.ocl.pivot.library.map.MapValuesOperation.INSTANCE));
			...
			ownedOperations.add(operation = createOperation("-", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.collection.SetMinusOperation", org.eclipse.ocl.pivot.library.collection.SetMinusOperation.INSTANCE));
			operation.setPrecedence(prec_ADDITIVE);
			ownedParameters = operation.getOwnedParameters();
			...
			ownedParameters.add(parameter = createParameter("object2", _OclSelf, false));
			installComment(operation, "Evaluates to oclText[true] if oclText[self] and s contain the same elements.");
			ownedOperations.add(operation = createOperation("append", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("appendAll", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendAllOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("excluding", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", tp_OrderedSet_T, false));
			installComment(operation, "The ordered set  containing all elements of oclText[self] apart from object.\n\nThe order of the remaining elements is not changed.");
			ownedOperations.add(operation = createOperation("excludingAll", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("flatten", _OrderedSet_OrderedSet_flatten_T2_T, "org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation", org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation.INSTANCE, tp_OrderedSet_flatten_T2));
			ownedOperations.add(operation = createOperation("including", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", tp_OrderedSet_T, false));
			...
			ownedOperations.add(operation = createOperation("includingAll", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("objects", _Collection_OrderedSet_T_T, true));
			installComment(operation, "The ordered set containing all elements of oclText[self] plus objects added as the last elements.");
			ownedOperations.add(operation = createOperation("insertAt", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionInsertAtOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionInsertAtOperation.INSTANCE));
			operation.setIsInvalidating(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("index", _Integer, true));
			ownedParameters.add(parameter = createParameter("object", tp_OrderedSet_T, false));
			installComment(operation, "The ordered set consisting of oclText[self] with object present at position index.");
			ownedOperations.add(operation = createOperation("prepend", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", tp_OrderedSet_T, false));
			installComment(operation, "The sequence consisting of object, followed by all elements in oclText[self].");
			ownedOperations.add(operation = createOperation("prependAll", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependAllOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("objects", _OrderedCollection_OrderedSet_T_T, true));
			installComment(operation, "The sequence consisting of objects, followed by all elements in oclText[self].");
			ownedOperations.add(operation = createOperation("reverse", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionReverseOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionReverseOperation.INSTANCE));
			...
			ownedOperations.add(operation = createOperation("subOrderedSet", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedSetSubOrderedSetOperation", org.eclipse.ocl.pivot.library.collection.OrderedSetSubOrderedSetOperation.INSTANCE));
			operation.setIsInvalidating(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lower", _Integer, true));
			ownedParameters.add(parameter = createParameter("upper", _Integer, true));
			...
			ownedOperations.add(operation = createOperation("append", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("appendAll", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendAllOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionAppendAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("excluding", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", tp_Sequence_T, false));
			installComment(operation, "The sequence containing all elements of oclText[self] apart from all occurrences of object.\n\nThe order of the remaining elements is not changed.");
			ownedOperations.add(operation = createOperation("excludingAll", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("flatten", _Sequence_Sequence_flatten_T2_T, "org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation", org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation.INSTANCE, tp_Sequence_flatten_T2));
			...
			ownedOperations.add(operation = createOperation("including", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", tp_Sequence_T, false));
			installComment(operation, "The sequence containing all elements of oclText[self] plus object added as the last element.");
			ownedOperations.add(operation = createOperation("includingAll", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("objects", _Collection_Sequence_T_T, true));
			installComment(operation, "The sequence containing all elements of oclText[self] plus objects added as the last elements.");
			ownedOperations.add(operation = createOperation("insertAt", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionInsertAtOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionInsertAtOperation.INSTANCE));
			operation.setIsInvalidating(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("index", _Integer, true));
			ownedParameters.add(parameter = createParameter("object", tp_Sequence_T, false));
			installComment(operation, "The sequence consisting of oclText[self] with object inserted at position index.");
			ownedOperations.add(operation = createOperation("prepend", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", tp_Sequence_T, false));
			installComment(operation, "The sequence consisting of object, followed by all elements in oclText[self].");
			ownedOperations.add(operation = createOperation("prependAll", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependAllOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionPrependAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("objects", _OrderedCollection_Sequence_T_T, true));
			installComment(operation, "The sequence consisting of objects, followed by all elements in oclText[self].");
			ownedOperations.add(operation = createOperation("reverse", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.collection.OrderedCollectionReverseOperation", org.eclipse.ocl.pivot.library.collection.OrderedCollectionReverseOperation.INSTANCE));
			...
			ownedOperations.add(operation = createOperation("subSequence", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.collection.SequenceSubSequenceOperation", org.eclipse.ocl.pivot.library.collection.SequenceSubSequenceOperation.INSTANCE));
			operation.setIsInvalidating(true);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lower", _Integer, true));
			ownedParameters.add(parameter = createParameter("upper", _Integer, true));
			...
			ownedOperations.add(operation = createOperation("-", _Set_Set_T_T, "org.eclipse.ocl.pivot.library.collection.SetMinusOperation", org.eclipse.ocl.pivot.library.collection.SetMinusOperation.INSTANCE));
			operation.setPrecedence(prec_ADDITIVE);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("s", _UniqueCollection_OclAny_T, true));
			installComment(operation, "The elements of oclText[self], which are not in s.");
			...
			ownedParameters.add(parameter = createParameter("object2", _OclSelf, false));
			installComment(operation, "Evaluates to oclText[true] if oclText[self] and s contain the same elements.");
			ownedOperations.add(operation = createOperation("excluding", _Set_Set_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("excludingAll", _Set_Set_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionExcludingAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("flatten", _Set_Set_flatten_T2_T, "org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation", org.eclipse.ocl.pivot.library.collection.CollectionFlattenOperation.INSTANCE, tp_Set_flatten_T2));
			...
			ownedOperations.add(operation = createOperation("including", _Set_Set_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("object", tp_Set_T, false));
			installComment(operation, "The set containing all elements of oclText[self] plus object.");
			ownedOperations.add(operation = createOperation("includingAll", _Set_Set_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation", org.eclipse.ocl.pivot.library.collection.CollectionIncludingAllOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("objects", _Collection_Set_T_T, true));
			...
			ownedOperations.add(operation = createOperation("-", _UniqueCollection_UniqueCollection_T_T, "org.eclipse.ocl.pivot.library.collection.SetMinusOperation", org.eclipse.ocl.pivot.library.collection.SetMinusOperation.INSTANCE));
			operation.setPrecedence(prec_ADDITIVE);
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("s", _UniqueCollection_OclAny_T, true));
			installComment(operation, "The elements of oclText[self], which are not in s.");
			ownedOperations.add(operation = createOperation("intersection", _Set_UniqueCollection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionIntersectionOperation", org.eclipse.ocl.pivot.library.collection.CollectionIntersectionOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			...
			ownedOperations.add(operation = createOperation("symmetricDifference", _Set_UniqueCollection_T_T, "org.eclipse.ocl.pivot.library.collection.SetSymmetricDifferenceOperation", org.eclipse.ocl.pivot.library.collection.SetSymmetricDifferenceOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("s", _UniqueCollection_OclAny_T, true));
			installComment(operation, "The set containing all the elements that are in oclText[self] or s, but not in both.");
			ownedOperations.add(operation = createOperation("union", _Set_UniqueCollection_T_T, "org.eclipse.ocl.pivot.library.collection.CollectionUnionOperation", org.eclipse.ocl.pivot.library.collection.CollectionUnionOperation.INSTANCE));
			ownedParameters = operation.getOwnedParameters();
		...
		private void installIterations() {
			...
			ownedIterations.add(iteration = createIteration("closure", _Set_Bag_T_T, "org.eclipse.ocl.pivot.library.iterator.ClosureIteration", org.eclipse.ocl.pivot.library.iterator.ClosureIteration.INSTANCE));
			...
			ownedIterations.add(iteration = createIteration("collectNested", _Bag_Bag_collectNested_V_T, "org.eclipse.ocl.pivot.library.iterator.CollectNestedIteration", org.eclipse.ocl.pivot.library.iterator.CollectNestedIteration.INSTANCE, tp_Bag_collectNested_V));
			ownedParameters = iteration.getOwnedIterators();
			...
			ownedIterations.add(iteration = createIteration("collect", _Bag_Bag_collect_V_T, "org.eclipse.ocl.pivot.library.iterator.CollectIteration", org.eclipse.ocl.pivot.library.iterator.CollectIteration.INSTANCE, tp_Bag_collect_V));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Bag_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_Bag_T_Bag_collect_V, false));
			ownedIterations.add(iteration = createIteration("reject", _Bag_Bag_T_T, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Bag_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedIterations.add(iteration = createIteration("select", _Bag_Bag_T_T, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Bag_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_Bag_T_Boolean, true));
			...
			ownedIterations.add(iteration = createIteration("sortedBy", _Sequence_Bag_T_T, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Bag_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedIterations.add(iteration = createIteration("collectNested", _Collection_Collection_collectNested_V_T, "org.eclipse.ocl.pivot.library.iterator.CollectNestedIteration", org.eclipse.ocl.pivot.library.iterator.CollectNestedIteration.INSTANCE, tp_Collection_collectNested_V));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Collection_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedIterations.add(iteration = createIteration("collect", _Collection_Collection_collect_V_T, "org.eclipse.ocl.pivot.library.iterator.CollectIteration", org.eclipse.ocl.pivot.library.iterator.CollectIteration.INSTANCE, tp_Collection_collect_V));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Collection_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedIterations.add(iteration = createIteration("reject", _Collection_Collection_T_T, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Collection_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_Collection_T_Boolean, true));
			installComment(iteration, "The sub-collection of the source collection for which body is oclText[false].");
			ownedIterations.add(iteration = createIteration("select", _Collection_Collection_T_T, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Collection_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_Collection_T_Boolean, true));
			installComment(iteration, "The sub-collection of the source collection for which body is oclText[true].");
			ownedIterations.add(iteration = createIteration("sortedBy", _Sequence_Collection_T_T, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Collection_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_Collection_T_OclAny, false));
			...
			ownedIterations.add(iteration = createIteration("closure", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.iterator.ClosureIteration", org.eclipse.ocl.pivot.library.iterator.ClosureIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			...
			installComment(iteration, "The closure of applying body transitively to every distinct element of the source collection.");
			ownedIterations.add(iteration = createIteration("collectNested", _Sequence_OrderedSet_collectNested_V_T, "org.eclipse.ocl.pivot.library.iterator.CollectNestedIteration", org.eclipse.ocl.pivot.library.iterator.CollectNestedIteration.INSTANCE, tp_OrderedSet_collectNested_V));
			ownedParameters = iteration.getOwnedIterators();
			...
			ownedIterations.add(iteration = createIteration("collect", _Sequence_OrderedSet_collect_V_T, "org.eclipse.ocl.pivot.library.iterator.CollectIteration", org.eclipse.ocl.pivot.library.iterator.CollectIteration.INSTANCE, tp_OrderedSet_collect_V));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_OrderedSet_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedIterations.add(iteration = createIteration("reject", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_OrderedSet_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedIterations.add(iteration = createIteration("select", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_OrderedSet_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_OrderedSet_T_Boolean, true));
			installComment(iteration, "The ordered set of the source ordered set for which body is oclText[true]");
			ownedIterations.add(iteration = createIteration("sortedBy", _OrderedSet_OrderedSet_T_T, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_OrderedSet_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedIterations.add(iteration = createIteration("closure", _OrderedSet_Sequence_T_T, "org.eclipse.ocl.pivot.library.iterator.ClosureIteration", org.eclipse.ocl.pivot.library.iterator.ClosureIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			...
			installComment(iteration, "The closure of applying body transitively to every distinct element of the source collection.");
			ownedIterations.add(iteration = createIteration("collectNested", _Sequence_Sequence_collectNested_V_T, "org.eclipse.ocl.pivot.library.iterator.CollectNestedIteration", org.eclipse.ocl.pivot.library.iterator.CollectNestedIteration.INSTANCE, tp_Sequence_collectNested_V));
			ownedParameters = iteration.getOwnedIterators();
			...
			installComment(iteration, "The sequence of elements that results from applying body to every member of the source ordered collection.");
			ownedIterations.add(iteration = createIteration("collect", _Sequence_Sequence_collect_V_T, "org.eclipse.ocl.pivot.library.iterator.CollectIteration", org.eclipse.ocl.pivot.library.iterator.CollectIteration.INSTANCE, tp_Sequence_collect_V));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Sequence_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedIterations.add(iteration = createIteration("reject", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Sequence_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedIterations.add(iteration = createIteration("select", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Sequence_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_Sequence_T_Boolean, true));
			installComment(iteration, "The subsequence of the source sequence for which body is oclText[true].");
			ownedIterations.add(iteration = createIteration("sortedBy", _Sequence_Sequence_T_T, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Sequence_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedIterations.add(iteration = createIteration("closure", _Set_Set_T_T, "org.eclipse.ocl.pivot.library.iterator.ClosureIteration", org.eclipse.ocl.pivot.library.iterator.ClosureIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			...
			installComment(iteration, "The closure of applying body transitively to every distinct element of the source collection.");
			ownedIterations.add(iteration = createIteration("collectNested", _Bag_Set_collectNested_V_T, "org.eclipse.ocl.pivot.library.iterator.CollectNestedIteration", org.eclipse.ocl.pivot.library.iterator.CollectNestedIteration.INSTANCE, tp_Set_collectNested_V));
			ownedParameters = iteration.getOwnedIterators();
			...
			installComment(iteration, "The Bag of elements which results from applying body to every member of the source nonordered collection.");
			ownedIterations.add(iteration = createIteration("collect", _Bag_Set_collect_V_T, "org.eclipse.ocl.pivot.library.iterator.CollectIteration", org.eclipse.ocl.pivot.library.iterator.CollectIteration.INSTANCE, tp_Set_collect_V));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Set_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedIterations.add(iteration = createIteration("reject", _Set_Set_T_T, "org.eclipse.ocl.pivot.library.iterator.RejectIteration", org.eclipse.ocl.pivot.library.iterator.RejectIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Set_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_Set_T_Boolean, true));
			installComment(iteration, "The subset of the source set for which body is oclText[false].");
			ownedIterations.add(iteration = createIteration("select", _Set_Set_T_T, "org.eclipse.ocl.pivot.library.iterator.SelectIteration", org.eclipse.ocl.pivot.library.iterator.SelectIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Set_T, false));
			ownedParameters = iteration.getOwnedParameters();
			ownedParameters.add(parameter = createParameter("lambda", _Lambda_Set_T_Boolean, true));
			installComment(iteration, "The subset of set for which expr is oclText[true].");
			ownedIterations.add(iteration = createIteration("sortedBy", _OrderedSet_Set_T_T, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
			ownedParameters.add(parameter = createParameter("i", tp_Set_T, false));
			ownedParameters = iteration.getOwnedParameters();
			...
			ownedIterations.add(iteration = createIteration("sortedBy", _OrderedSet_UniqueCollection_T_T, "org.eclipse.ocl.pivot.library.iterator.SortedByIteration", org.eclipse.ocl.pivot.library.iterator.SortedByIteration.INSTANCE));
			ownedParameters = iteration.getOwnedIterators();
		...
		private void installProperties() {
			...
			pr_OclAny_OclInvalid_oclBadProperty.setOpposite(pr_OclInvalid_oclBadProperty);
			pr_OclInvalid_oclBadProperty.setOpposite(pr_OclAny_OclInvalid_oclBadProperty);
			pr_OclElement_oclContainer.setOpposite(pr_OclElement_OclElement_oclContainer);
			pr_OclElement_OclElement_oclContainer.setOpposite(pr_OclElement_oclContainer);
			pr_OclElement_oclContents.setOpposite(pr_OclElement_OclElement_oclContents);
			pr_OclElement_OclElement_oclContents.setOpposite(pr_OclElement_oclContents);
		}
	}
}
