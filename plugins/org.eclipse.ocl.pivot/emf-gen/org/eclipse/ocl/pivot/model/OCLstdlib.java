...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private final @NonNull BagType _Bag_Bag_T_T = getBagType(_Bag_Bag_T, tp_Bag_T);
		private final @NonNull BagType _Bag_Bag_collect_V_T = getBagType(_Bag_Bag_T, tp_Bag_collect_V);
		private final @NonNull BagType _Bag_Bag_collectNested_V_T = getBagType(_Bag_Bag_T, tp_Bag_collectNested_V);
		private final @NonNull BagType _Bag_Bag_flatten_T2_T = getBagType(_Bag_Bag_T, tp_Bag_flatten_T2);
		private final @NonNull BagType _Bag_Bag_selectByKind_TT_T = getBagType(_Bag_Bag_T, tp_Bag_selectByKind_TT);
		private final @NonNull BagType _Bag_Bag_selectByType_TT_T = getBagType(_Bag_Bag_T, tp_Bag_selectByType_TT);
		private final @NonNull BagType _Bag_Collection_T_T = getBagType(_Bag_Bag_T, tp_Collection_T);
		private final @NonNull BagType _Bag_CollectionType_F = getBagType(_Bag_Bag_T, _CollectionType);
		private final @NonNull BagType _Bag_Map_V_T = getBagType(_Bag_Bag_T, tp_Map_V);
		private final @NonNull BagType _Bag_Map_collect_V2_F = getBagType(_Bag_Bag_T, tp_Map_collect_V2);
		private final @NonNull BagType _Bag_MapType_F = getBagType(_Bag_Bag_T, _MapType);
		private final @NonNull BagType _Bag_OclElement_F = getBagType(_Bag_Bag_T, _OclElement);
		private final @NonNull BagType _Bag_OclInvalid_F = getBagType(_Bag_Bag_T, _OclInvalid);
		private final @NonNull BagType _Bag_Set_collect_V_T = getBagType(_Bag_Bag_T, tp_Set_collect_V);
		private final @NonNull BagType _Bag_Set_collectNested_V_T = getBagType(_Bag_Bag_T, tp_Set_collectNested_V);
		private final @NonNull CollectionType _Collection_Bag_T_F = getCollectionType(_Collection_Collection_T, tp_Bag_T);
		private final @NonNull CollectionType _Collection_Bag_T_T = getCollectionType(_Collection_Collection_T, tp_Bag_T);
		private final @NonNull CollectionType _Collection_Bag_collect_V_F = getCollectionType(_Collection_Collection_T, tp_Bag_collect_V);
		private final @NonNull CollectionType _Collection_Bag_collectNested_V_F = getCollectionType(_Collection_Collection_T, tp_Bag_collectNested_V);
		private final @NonNull CollectionType _Collection_Bag_flatten_T2_F = getCollectionType(_Collection_Collection_T, tp_Bag_flatten_T2);
		private final @NonNull CollectionType _Collection_Bag_selectByKind_TT_F = getCollectionType(_Collection_Collection_T, tp_Bag_selectByKind_TT);
		private final @NonNull CollectionType _Collection_Bag_selectByType_TT_F = getCollectionType(_Collection_Collection_T, tp_Bag_selectByType_TT);
		private final @NonNull CollectionType _Collection_Collection_T_F = getCollectionType(_Collection_Collection_T, tp_Collection_T);
		private final @NonNull CollectionType _Collection_Collection_T_T = getCollectionType(_Collection_Collection_T, tp_Collection_T);
		private final @NonNull CollectionType _Collection_Collection_collect_V_T = getCollectionType(_Collection_Collection_T, tp_Collection_collect_V);
		private final @NonNull CollectionType _Collection_Collection_collectNested_V_T = getCollectionType(_Collection_Collection_T, tp_Collection_collectNested_V);
		private final @NonNull CollectionType _Collection_Collection_excludesAll_T2_T = getCollectionType(_Collection_Collection_T, tp_Collection_excludesAll_T2);
		private final @NonNull CollectionType _Collection_Collection_flatten_T2_T = getCollectionType(_Collection_Collection_T, tp_Collection_flatten_T2);
		private final @NonNull CollectionType _Collection_Collection_includesAll_T2_T = getCollectionType(_Collection_Collection_T, tp_Collection_includesAll_T2);
		private final @NonNull CollectionType _Collection_Collection_product_T2_T = getCollectionType(_Collection_Collection_T, tp_Collection_product_T2);
		private final @NonNull CollectionType _Collection_Collection_selectByKind_TT_T = getCollectionType(_Collection_Collection_T, tp_Collection_selectByKind_TT);
		private final @NonNull CollectionType _Collection_Collection_selectByType_TT_T = getCollectionType(_Collection_Collection_T, tp_Collection_selectByType_TT);
		private final @NonNull CollectionType _Collection_CollectionType_F = getCollectionType(_Collection_Collection_T, _CollectionType);
		private final @NonNull CollectionType _Collection_Integer_F = getCollectionType(_Collection_Collection_T, _Integer);
		private final @NonNull CollectionType _Collection_Map_K_F = getCollectionType(_Collection_Collection_T, tp_Map_K);
		private final @NonNull CollectionType _Collection_Map_K_T = getCollectionType(_Collection_Collection_T, tp_Map_K);
		private final @NonNull CollectionType _Collection_Map_V_F = getCollectionType(_Collection_Collection_T, tp_Map_V);
		private final @NonNull CollectionType _Collection_Map_collect_V2_F = getCollectionType(_Collection_Collection_T, tp_Map_collect_V2);
		private final @NonNull CollectionType _Collection_Map_excludesAll_K2_T = getCollectionType(_Collection_Collection_T, tp_Map_excludesAll_K2);
		private final @NonNull CollectionType _Collection_Map_includesAll_K2_T = getCollectionType(_Collection_Collection_T, tp_Map_includesAll_K2);
		private final @NonNull CollectionType _Collection_MapType_F = getCollectionType(_Collection_Collection_T, _MapType);
		private final @NonNull CollectionType _Collection_OclAny_F = getCollectionType(_Collection_Collection_T, _OclAny);
		private final @NonNull CollectionType _Collection_OclElement_F = getCollectionType(_Collection_Collection_T, _OclElement);
		private final @NonNull CollectionType _Collection_OclInvalid_F = getCollectionType(_Collection_Collection_T, _OclInvalid);
		private final @NonNull CollectionType _Collection_OclSelf_F = getCollectionType(_Collection_Collection_T, _OclSelf);
		private final @NonNull CollectionType _Collection_OrderedCollection_T_T = getCollectionType(_Collection_Collection_T, tp_OrderedCollection_T);
		private final @NonNull CollectionType _Collection_OrderedSet_T_F = getCollectionType(_Collection_Collection_T, tp_OrderedSet_T);
		private final @NonNull CollectionType _Collection_OrderedSet_T_T = getCollectionType(_Collection_Collection_T, tp_OrderedSet_T);
		private final @NonNull CollectionType _Collection_OrderedSet_collect_V_F = getCollectionType(_Collection_Collection_T, tp_OrderedSet_collect_V);
		private final @NonNull CollectionType _Collection_OrderedSet_collectNested_V_F = getCollectionType(_Collection_Collection_T, tp_OrderedSet_collectNested_V);
		private final @NonNull CollectionType _Collection_OrderedSet_flatten_T2_F = getCollectionType(_Collection_Collection_T, tp_OrderedSet_flatten_T2);
		private final @NonNull CollectionType _Collection_OrderedSet_selectByKind_TT_F = getCollectionType(_Collection_Collection_T, tp_OrderedSet_selectByKind_TT);
		private final @NonNull CollectionType _Collection_OrderedSet_selectByType_TT_F = getCollectionType(_Collection_Collection_T, tp_OrderedSet_selectByType_TT);
		private final @NonNull CollectionType _Collection_Sequence_T_F = getCollectionType(_Collection_Collection_T, tp_Sequence_T);
		private final @NonNull CollectionType _Collection_Sequence_T_T = getCollectionType(_Collection_Collection_T, tp_Sequence_T);
		private final @NonNull CollectionType _Collection_Sequence_collect_V_F = getCollectionType(_Collection_Collection_T, tp_Sequence_collect_V);
		private final @NonNull CollectionType _Collection_Sequence_collectNested_V_F = getCollectionType(_Collection_Collection_T, tp_Sequence_collectNested_V);
		private final @NonNull CollectionType _Collection_Sequence_flatten_T2_F = getCollectionType(_Collection_Collection_T, tp_Sequence_flatten_T2);
		private final @NonNull CollectionType _Collection_Sequence_selectByKind_TT_F = getCollectionType(_Collection_Collection_T, tp_Sequence_selectByKind_TT);
		private final @NonNull CollectionType _Collection_Sequence_selectByType_TT_F = getCollectionType(_Collection_Collection_T, tp_Sequence_selectByType_TT);
		private final @NonNull CollectionType _Collection_Set_T_F = getCollectionType(_Collection_Collection_T, tp_Set_T);
		private final @NonNull CollectionType _Collection_Set_T_T = getCollectionType(_Collection_Collection_T, tp_Set_T);
		private final @NonNull CollectionType _Collection_Set_collect_V_F = getCollectionType(_Collection_Collection_T, tp_Set_collect_V);
		private final @NonNull CollectionType _Collection_Set_collectNested_V_F = getCollectionType(_Collection_Collection_T, tp_Set_collectNested_V);
		private final @NonNull CollectionType _Collection_Set_flatten_T2_F = getCollectionType(_Collection_Collection_T, tp_Set_flatten_T2);
		private final @NonNull CollectionType _Collection_Set_selectByKind_TT_F = getCollectionType(_Collection_Collection_T, tp_Set_selectByKind_TT);
		private final @NonNull CollectionType _Collection_Set_selectByType_TT_F = getCollectionType(_Collection_Collection_T, tp_Set_selectByType_TT);
		private final @NonNull CollectionType _Collection_String_F = getCollectionType(_Collection_Collection_T, _String);
		private final @NonNull CollectionType _Collection_Tuple_F = getCollectionType(_Collection_Collection_T, _Tuple);
		private final @NonNull CollectionType _Collection_UniqueCollection_T_F = getCollectionType(_Collection_Collection_T, tp_UniqueCollection_T);
		private final @NonNull CollectionType _Collection_UniqueCollection_T_T = getCollectionType(_Collection_Collection_T, tp_UniqueCollection_T);
		private final @NonNull CollectionType _OrderedCollection_Bag_T_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_Bag_T);
		private final @NonNull CollectionType _OrderedCollection_Collection_T_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_Collection_T);
		private final @NonNull CollectionType _OrderedCollection_Integer_F = getCollectionType(_OrderedCollection_OrderedCollection_T, _Integer);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_T_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_OrderedSet_T);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_T_T = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_OrderedSet_T);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_collect_V_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_OrderedSet_collect_V);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_collectNested_V_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_OrderedSet_collectNested_V);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_flatten_T2_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_OrderedSet_flatten_T2);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_selectByKind_TT_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_OrderedSet_selectByKind_TT);
		private final @NonNull CollectionType _OrderedCollection_OrderedSet_selectByType_TT_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_OrderedSet_selectByType_TT);
		private final @NonNull CollectionType _OrderedCollection_Sequence_T_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_Sequence_T);
		private final @NonNull CollectionType _OrderedCollection_Sequence_T_T = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_Sequence_T);
		private final @NonNull CollectionType _OrderedCollection_Sequence_collect_V_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_Sequence_collect_V);
		private final @NonNull CollectionType _OrderedCollection_Sequence_collectNested_V_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_Sequence_collectNested_V);
		private final @NonNull CollectionType _OrderedCollection_Sequence_flatten_T2_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_Sequence_flatten_T2);
		private final @NonNull CollectionType _OrderedCollection_Sequence_selectByKind_TT_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_Sequence_selectByKind_TT);
		private final @NonNull CollectionType _OrderedCollection_Sequence_selectByType_TT_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_Sequence_selectByType_TT);
		private final @NonNull CollectionType _OrderedCollection_Set_T_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_Set_T);
		private final @NonNull CollectionType _OrderedCollection_String_F = getCollectionType(_OrderedCollection_OrderedCollection_T, _String);
		private final @NonNull CollectionType _OrderedCollection_UniqueCollection_T_F = getCollectionType(_OrderedCollection_OrderedCollection_T, tp_UniqueCollection_T);
		private final @NonNull OrderedSetType _OrderedSet_Collection_T_T = getOrderedSetType(_OrderedSet_OrderedSet_T, tp_Collection_T);
		private final @NonNull OrderedSetType _OrderedSet_OrderedSet_T_T = getOrderedSetType(_OrderedSet_OrderedSet_T, tp_OrderedSet_T);
		private final @NonNull OrderedSetType _OrderedSet_OrderedSet_flatten_T2_T = getOrderedSetType(_OrderedSet_OrderedSet_T, tp_OrderedSet_flatten_T2);
		private final @NonNull OrderedSetType _OrderedSet_OrderedSet_selectByKind_TT_T = getOrderedSetType(_OrderedSet_OrderedSet_T, tp_OrderedSet_selectByKind_TT);
		private final @NonNull OrderedSetType _OrderedSet_OrderedSet_selectByType_TT_T = getOrderedSetType(_OrderedSet_OrderedSet_T, tp_OrderedSet_selectByType_TT);
		private final @NonNull OrderedSetType _OrderedSet_Sequence_T_T = getOrderedSetType(_OrderedSet_OrderedSet_T, tp_Sequence_T);
		private final @NonNull OrderedSetType _OrderedSet_Set_T_T = getOrderedSetType(_OrderedSet_OrderedSet_T, tp_Set_T);
		private final @NonNull OrderedSetType _OrderedSet_UniqueCollection_T_T = getOrderedSetType(_OrderedSet_OrderedSet_T, tp_UniqueCollection_T);
		private final @NonNull SequenceType _Sequence_Bag_T_T = getSequenceType(_Sequence_Sequence_T, tp_Bag_T);
		private final @NonNull SequenceType _Sequence_Collection_T_T = getSequenceType(_Sequence_Sequence_T, tp_Collection_T);
		private final @NonNull SequenceType _Sequence_Integer_T = getSequenceType(_Sequence_Sequence_T, _Integer);
		private final @NonNull SequenceType _Sequence_OrderedSet_collect_V_T = getSequenceType(_Sequence_Sequence_T, tp_OrderedSet_collect_V);
		private final @NonNull SequenceType _Sequence_OrderedSet_collectNested_V_T = getSequenceType(_Sequence_Sequence_T, tp_OrderedSet_collectNested_V);
		private final @NonNull SequenceType _Sequence_Sequence_T_T = getSequenceType(_Sequence_Sequence_T, tp_Sequence_T);
		private final @NonNull SequenceType _Sequence_Sequence_collect_V_T = getSequenceType(_Sequence_Sequence_T, tp_Sequence_collect_V);
		private final @NonNull SequenceType _Sequence_Sequence_collectNested_V_T = getSequenceType(_Sequence_Sequence_T, tp_Sequence_collectNested_V);
		private final @NonNull SequenceType _Sequence_Sequence_flatten_T2_T = getSequenceType(_Sequence_Sequence_T, tp_Sequence_flatten_T2);
		private final @NonNull SequenceType _Sequence_Sequence_selectByKind_TT_T = getSequenceType(_Sequence_Sequence_T, tp_Sequence_selectByKind_TT);
		private final @NonNull SequenceType _Sequence_Sequence_selectByType_TT_T = getSequenceType(_Sequence_Sequence_T, tp_Sequence_selectByType_TT);
		private final @NonNull SequenceType _Sequence_String_T = getSequenceType(_Sequence_Sequence_T, _String);
		private final @NonNull SetType _Set_Bag_T_T = getSetType(_Set_Set_T, tp_Bag_T);
		private final @NonNull SetType _Set_Collection_T_T = getSetType(_Set_Set_T, tp_Collection_T);
		private final @NonNull SetType _Set_Map_K_T = getSetType(_Set_Set_T, tp_Map_K);
		private final @NonNull SetType _Set_OclElement_T = getSetType(_Set_Set_T, _OclElement);
		private final @NonNull SetType _Set_OclSelf_F = getSetType(_Set_Set_T, _OclSelf);
		private final @NonNull SetType _Set_OclSelf_T = getSetType(_Set_Set_T, _OclSelf);
		private final @NonNull SetType _Set_Set_T_T = getSetType(_Set_Set_T, tp_Set_T);
		private final @NonNull SetType _Set_Set_flatten_T2_T = getSetType(_Set_Set_T, tp_Set_flatten_T2);
		private final @NonNull SetType _Set_Set_selectByKind_TT_T = getSetType(_Set_Set_T, tp_Set_selectByKind_TT);
		private final @NonNull SetType _Set_Set_selectByType_TT_T = getSetType(_Set_Set_T, tp_Set_selectByType_TT);
		private final @NonNull SetType _Set_Tuple_T = getSetType(_Set_Set_T, _Tuple);
		private final @NonNull SetType _Set_UniqueCollection_T_T = getSetType(_Set_Set_T, tp_UniqueCollection_T);
		private final @NonNull CollectionType _UniqueCollection_Bag_T_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_Bag_T);
		private final @NonNull CollectionType _UniqueCollection_Collection_T_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_Collection_T);
		private final @NonNull CollectionType _UniqueCollection_Collection_T_T = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_Collection_T);
		private final @NonNull CollectionType _UniqueCollection_Map_K_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_Map_K);
		private final @NonNull CollectionType _UniqueCollection_OclAny_T = getCollectionType(_UniqueCollection_UniqueCollection_T, _OclAny);
		private final @NonNull CollectionType _UniqueCollection_OclElement_F = getCollectionType(_UniqueCollection_UniqueCollection_T, _OclElement);
		private final @NonNull CollectionType _UniqueCollection_OclSelf_F = getCollectionType(_UniqueCollection_UniqueCollection_T, _OclSelf);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_T_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_OrderedSet_T);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_T_T = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_OrderedSet_T);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_flatten_T2_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_OrderedSet_flatten_T2);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_selectByKind_TT_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_OrderedSet_selectByKind_TT);
		private final @NonNull CollectionType _UniqueCollection_OrderedSet_selectByType_TT_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_OrderedSet_selectByType_TT);
		private final @NonNull CollectionType _UniqueCollection_Sequence_T_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_Sequence_T);
		private final @NonNull CollectionType _UniqueCollection_Set_T_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_Set_T);
		private final @NonNull CollectionType _UniqueCollection_Set_T_T = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_Set_T);
		private final @NonNull CollectionType _UniqueCollection_Set_flatten_T2_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_Set_flatten_T2);
		private final @NonNull CollectionType _UniqueCollection_Set_selectByKind_TT_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_Set_selectByKind_TT);
		private final @NonNull CollectionType _UniqueCollection_Set_selectByType_TT_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_Set_selectByType_TT);
		private final @NonNull CollectionType _UniqueCollection_Tuple_F = getCollectionType(_UniqueCollection_UniqueCollection_T, _Tuple);
		private final @NonNull CollectionType _UniqueCollection_UniqueCollection_T_F = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_UniqueCollection_T);
		private final @NonNull CollectionType _UniqueCollection_UniqueCollection_T_T = getCollectionType(_UniqueCollection_UniqueCollection_T, tp_UniqueCollection_T);
