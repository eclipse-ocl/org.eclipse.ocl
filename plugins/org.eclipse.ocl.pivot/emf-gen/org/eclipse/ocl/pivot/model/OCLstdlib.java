...
public class OCLstdlib extends ASResourceImpl
{
	...
	private static class Contents extends AbstractContents
	{
		...
		private void installComments() {
			...
			installComment(_OclAny, "The number of elements in the collection oclText[self].essions.\nny is itself an instance of the metatype AnyType.\n\nclasses in a UML model inherit all operations defined on OclAny.\nvoid name conflicts between properties in the model and the properties inherited from OclAny,\nnames on the properties of OclAny start with \u2018ocl.\u2019\nough theoretically there may still be name conflicts, they can be avoided. \ncan also use qualification by OclAny (name of the type) to explicitly refer to the OclAny properties.\n\nations of OclAny, where the instance of OclAny is called object.");
