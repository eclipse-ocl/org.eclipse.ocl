...
extends EObjectValidator {
	...
	protected boolean validate(int classifierID, Object value,
		...
		switch (classifierID)
		{
			...
			case 11:
				return validateCoCollectionType((CoCollectionType)value, diagnostics, context);
			case 12:
			...
			case 138:
				return validateCoCollection((CoCollectionValue)value, diagnostics, context);
			case 139:
	 ...
	 * @generated
	 */
	public boolean validateCoCollectionType(CoCollectionType coCollectionType, DiagnosticChain diagnostics, Map<Object, Object> context)
	{
		if (!validate_NoCircularContainment(coCollectionType, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(coCollectionType, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(coCollectionType, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(coCollectionType, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(coCollectionType, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(coCollectionType, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(coCollectionType, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(coCollectionType, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(coCollectionType, diagnostics, context);
		if (result || diagnostics != null) result &= validateClass_validateNameIsNotNull(coCollectionType, diagnostics, context);
		if (result || diagnostics != null) result &= validateClass_validateUniqueInvariantName(coCollectionType, diagnostics, context);
		if (result || diagnostics != null) result &= validateDataType_validateBehavioralClassHasDistinctName(coCollectionType, diagnostics, context);
		if (result || diagnostics != null) result &= validateDataType_validateBehavioralClassIsPrimitiveType(coCollectionType, diagnostics, context);
		if (result || diagnostics != null) result &= validateDataType_validateBehavioralClassIsSuperClass(coCollectionType, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateCoCollection(CoCollectionValue coCollection, DiagnosticChain diagnostics, Map<Object, Object> context)
	{
		return true;
	}
