...
public class PivotSwitch<@Nullable T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID)
		{
			...
			case 11:
			{
				CoCollectionType coCollectionType = (CoCollectionType)theEObject;
				T result = caseCoCollectionType(coCollectionType);
				if (result == null) result = caseDataType(coCollectionType);
				if (result == null) result = caseClass(coCollectionType);
				if (result == null) result = caseType(coCollectionType);
				if (result == null) result = caseNamespace(coCollectionType);
				if (result == null) result = caseTemplateableElement(coCollectionType);
				if (result == null) result = caseNamedElement(coCollectionType);
				if (result == null) result = caseElement(coCollectionType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case 12:
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Co Collection Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Co Collection Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCoCollectionType(CoCollectionType object)
	{
		return null;
	}
