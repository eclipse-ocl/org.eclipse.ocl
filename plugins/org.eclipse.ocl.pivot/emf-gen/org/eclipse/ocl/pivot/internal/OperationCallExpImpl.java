				...
				try {
					...
					while (true) {
						...
						try {
							...
							final /*@Thrown*/ @NonNull OrderedSetValue _171_UNRESOLVED_187 = (@Nullable OrderedSetValue)CollectionExcludingOperation.INSTANCE.evaluate(parameters, (Object)null);
							final /*@Thrown*/ @Nullable Parameter parameter = (@Nullable Parameter)OrderedCollectionAtOperation.INSTANCE.evaluate(_171_UNRESOLVED_187, i);
							if (parameter == null) {
