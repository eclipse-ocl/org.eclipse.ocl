				...
				try {
					...
					while (true) {
						...
						try {
							...
							if (isTypeof) {
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class TYP_Class_30 = idResolver.getClass(PivotTables.CLSSid_Class, null);
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_Class = TYP_Class_30;
