			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@NonInvalid*/ boolean IsEQ__0 = bodyExpression_1 != null;
						...
						if (!IsEQ__0) {
							...
							try {
								...
								final /*@Thrown*/ @Nullable ExpressionInOCL oclAsType = (@Nullable ExpressionInOCL)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, bodyExpression_1, TYP_ExpressionInOCL_0);
								if (oclAsType == null) {
