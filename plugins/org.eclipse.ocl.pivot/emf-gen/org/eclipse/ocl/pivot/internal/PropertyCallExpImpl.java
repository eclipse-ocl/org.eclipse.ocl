...
implements PropertyCallExp {
	...
	public boolean validateNonStaticSourceTypeIsConformant(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
			...
			final /*@NonInvalid*/ @Nullable IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, PivotPackage.Literals.PROPERTY_CALL_EXP___VALIDATE_NON_STATIC_SOURCE_TYPE_IS_CONFORMANT__DIAGNOSTICCHAIN_MAP);
			if (severity_0 == null) {
			...
			if (le) {
				...
				try {
					...
					try {
						...
						try {
							if (this == null) {
								throw new InvalidValueException("Null source for \'PropertyCallExp::referredProperty\'");
							}
							final /*@Thrown*/ @Nullable Property referredProperty = this.getReferredProperty();
							...
							final /*@NonInvalid*/ @NonNull Object isStatic = CAUGHT_referredProperty == null;
					...
					if (CAUGHT_not == ValueUtil.FALSE_VALUE) {
						...
						try {
							if (this == null) {
								throw new InvalidValueException("Null source for \'pivot::PropertyCallExp::getSpecializedReferredPropertyOwningType() : Type[1]\'");
							}
							...
							if (conformsTo == Boolean.TRUE) {
								...
								final /*@Thrown*/ @NonNull Type getSpecializedReferredPropertyOwningType = this.getSpecializedReferredPropertyOwningType();
	...
	public boolean validateSafeSourceCanBeNull(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
			 ...
			 */
			final /*@NonInvalid*/ @NonNull Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ @Nullable IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, PivotPackage.Literals.PROPERTY_CALL_EXP___VALIDATE_SAFE_SOURCE_CAN_BE_NULL__DIAGNOSTICCHAIN_MAP);
			if (severity_0 == null) {
				throw new InvalidValueException("Null \'\'OclComparable\'\' rather than \'\'OclVoid\'\' value required");
			}
			final /*@Thrown*/ @Nullable Boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, PivotTables.INT_0);
	...
	public boolean validateUnsafeSourceCanNotBeNull(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
			 ...
			 */
			final /*@NonInvalid*/ @NonNull Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ @Nullable IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, PivotPackage.Literals.PROPERTY_CALL_EXP___VALIDATE_UNSAFE_SOURCE_CAN_NOT_BE_NULL__DIAGNOSTICCHAIN_MAP);
			if (severity_0 == null) {
				throw new InvalidValueException("Null \'\'OclComparable\'\' rather than \'\'OclVoid\'\' value required");
			}
			final /*@Thrown*/ @Nullable Boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, PivotTables.INT_0);
	...
	public boolean validateCompatibleResultType(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
			 ...
			 *     then true
			 *     else
			 *       let result : Boolean[?] = type = getSpecializedReferredPropertyType()
			 *       in
			 *         constraintName.logDiagnostic(self, null, diagnostics, context, null, severity, result, 0)
			 *     endif
			 */
			final /*@NonInvalid*/ @NonNull Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ @Nullable IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, PivotPackage.Literals.PROPERTY_CALL_EXP___VALIDATE_COMPATIBLE_RESULT_TYPE__DIAGNOSTICCHAIN_MAP);
			if (severity_0 == null) {
				throw new InvalidValueException("Null \'\'OclComparable\'\' rather than \'\'OclVoid\'\' value required");
			}
			final /*@Thrown*/ @Nullable Boolean le = OclComparableLessThanEqualOperation.INSTANCE.evaluate(executor, severity_0, PivotTables.INT_0);
			...
			if (le) {
				...
				try {
					if (this == null) {
						throw new InvalidValueException("Null source for \'pivot::PropertyCallExp::getSpecializedReferredPropertyType() : Type[1]\'");
					}
					final /*@Thrown*/ @Nullable Type type = this.getType();
					@SuppressWarnings("null")
					final /*@Thrown*/ @NonNull Type getSpecializedReferredPropertyType = this.getSpecializedReferredPropertyType();
