					...
					if (CAUGHT_and == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							if (oclIsKindOf) {
								...
								final /*@Thrown*/ @Nullable CollectionType oclAsType_0 = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_CollectionType_11);
								if (oclAsType_0 == null) {
					...
					if (!IsEQ_) {
						...
						try {
							...
							if (oclIsKindOf_0) {
								...
								final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, TYP_MapType_7).booleanValue();
								/*@Thrown*/ @Nullable Type IF_oclIsKindOf;
								if (oclIsKindOf) {
									final /*@Thrown*/ @Nullable MapType oclAsType_0 = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, TYP_MapType_7);
									if (oclAsType_0 == null) {
						...
						try {
							...
							try {
								...
								if (IsEQ2_ == Boolean.TRUE) {
									...
									final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, SAFE_type_1, TYP_SequenceType_0).booleanValue();
							...
							if (CAUGHT_SAFE_oclIsKindOf_0 == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, SAFE_type_0, TYP_OrderedSetType_2).booleanValue();
				...
				try {
					...
					if (!IsEQ__0) {
						...
						try {
							...
							final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type_0, TYP_CollectionType_0);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
							final /*@Thrown*/ @NonNull Type elementType = CollectionElementTypeProperty.INSTANCE.evaluate(executor, PivotTables.CLSSid_Type, oclAsType);
					...
					if (!IsEQ_) {
						...
						try {
							...
							try {
								...
								final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, SAFE_type_1, TYP_SequenceType_4).booleanValue();
								CAUGHT_oclIsKindOf_1 = oclIsKindOf_1;
							}
							catch (Exception THROWN_oclIsKindOf_1) {
								CAUGHT_oclIsKindOf_1 = ValueUtil.createInvalidValue(THROWN_oclIsKindOf_1);
							...
							if (CAUGHT_oclIsKindOf_1 == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, SAFE_type_0, TYP_OrderedSetType_0).booleanValue();
					...
					if (!IsEQ_) {
						...
						try {
							...
							try {
								...
								final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, SAFE_type_1, TYP_SequenceType_5).booleanValue();
								CAUGHT_oclIsKindOf_1 = oclIsKindOf_1;
							}
							catch (Exception THROWN_oclIsKindOf_1) {
								CAUGHT_oclIsKindOf_1 = ValueUtil.createInvalidValue(THROWN_oclIsKindOf_1);
							...
							if (CAUGHT_oclIsKindOf_1 == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, SAFE_type, TYP_BagType_1).booleanValue();
									CAUGHT_oclIsKindOf_0 = oclIsKindOf_0;
								}
								catch (Exception THROWN_oclIsKindOf_0) {
									CAUGHT_oclIsKindOf_0 = ValueUtil.createInvalidValue(THROWN_oclIsKindOf_0);
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_0, TYP_SequenceType_2).booleanValue();
								IF_or = oclIsKindOf;
							}
							else {
								...
								final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_0, TYP_OrderedSetType_3).booleanValue();
								IF_or = oclIsKindOf_2;
							}
							CAUGHT_IF_or = IF_or;
						}
				...
				try {
					...
					if (!IsEQ__0) {
						...
						try {
							...
							final /*@NonInvalid*/ @Nullable Type type = this.getType();
							final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, TYP_CollectionType_2);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
							final /*@Thrown*/ @NonNull Type elementType = CollectionElementTypeProperty.INSTANCE.evaluate(executor, PivotTables.CLSSid_Type, oclAsType);
							...
							final /*@Thrown*/ @Nullable CollectionType oclAsType_0 = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, SAFE_type_0, TYP_CollectionType_2);
							if (oclAsType_0 == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, CAUGHT_sourceType, TYP_CollectionType_1).booleanValue();
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, CAUGHT_sourceType, TYP_CollectionType_5);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, CAUGHT_sourceType, TYP_MapType_9).booleanValue();
						CAUGHT_oclIsKindOf = oclIsKindOf;
					}
					catch (Exception THROWN_oclIsKindOf) {
						CAUGHT_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_oclIsKindOf);
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@Thrown*/ @Nullable MapType oclAsType = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, CAUGHT_sourceType, TYP_MapType_5);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'MapType::keyType\'");
							}
