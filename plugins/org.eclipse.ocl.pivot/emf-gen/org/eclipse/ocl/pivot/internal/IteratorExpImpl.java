				...
				try {
					...
					if (CAUGHT_and == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_MapType = (org.eclipse.ocl.pivot.Class)TYP_MapType_4;
					...
					if (!eq) {
						...
						try {
							...
							if (oclIsKindOf_0) {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_MapType = (org.eclipse.ocl.pivot.Class)TYP_MapType_6;
				...
				try {
					...
					if (!eq) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType = (org.eclipse.ocl.pivot.Class)TYP_CollectionType_12;
							@SuppressWarnings("null")
							final /*@Thrown*/ @NonNull CollectionType oclAsType = (@NonNull CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, CAST_TYP_CollectionType);
					...
					if (!eq) {
						...
						try {
							...
							try {
								...
								final /*@NonInvalid*/ @NonNull Object oclIsKindOf_2 = CAUGHT_safe_type_source == null;
								/*@Thrown*/ @Nullable Boolean safe_oclIsKindOf_source;
								if (oclIsKindOf_2 == Boolean.TRUE) {
									...
									final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_SequenceType).booleanValue();
									safe_oclIsKindOf_source = oclIsKindOf_1;
								}
							...
							if (CAUGHT_safe_oclIsKindOf_source == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_OrderedSetType_0 = (org.eclipse.ocl.pivot.Class)TYP_OrderedSetType_0;
									final /*@Thrown*/ boolean oclIsKindOf_3 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source_0, CAST_TYP_OrderedSetType_0).booleanValue();
									CAUGHT_oclIsKindOf = oclIsKindOf_3;
								}
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_0, CAST_TYP_OrderedSetType).booleanValue();
								IF_or = oclIsKindOf_0;
							}
							else {
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class TYP_SetType_1 = idResolver.getClass(PivotTables.CLSSid_SetType, null);
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_SetType = (org.eclipse.ocl.pivot.Class)TYP_SetType_1;
								final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_0, CAST_TYP_SetType).booleanValue();
								IF_or = oclIsKindOf;
							}
							CAUGHT_IF_or = IF_or;
						}
					...
					if (!eq) {
						...
						try {
							...
							try {
								...
								final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_SequenceType_0).booleanValue();
								CAUGHT_oclIsKindOf_0 = oclIsKindOf_2;
							}
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_SequenceType).booleanValue();
								IF_or = oclIsKindOf_1;
							}
							else {
								...
								final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_BagType).booleanValue();
								IF_or = oclIsKindOf_0;
							}
							CAUGHT_IF_or = IF_or;
						}
					...
					if (!eq) {
						...
						try {
							...
							try {
								...
								final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_SequenceType).booleanValue();
								CAUGHT_oclIsKindOf_0 = oclIsKindOf_2;
							}
							catch (Exception THROWN_oclIsKindOf_0) {
								CAUGHT_oclIsKindOf_0 = ValueUtil.createInvalidValue(THROWN_oclIsKindOf_0);
							...
							if (or) {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_SequenceType_0 = (org.eclipse.ocl.pivot.Class)TYP_SequenceType;
								final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_SequenceType_0).booleanValue();
								IF_or = oclIsKindOf_0;
							}
							else {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_OrderedSetType = (org.eclipse.ocl.pivot.Class)TYP_OrderedSetType_1;
				...
				try {
					...
					if (!eq_0) {
						...
						try {
							...
							final /*@Thrown*/ boolean eq = elementType_0.getTypeId() == elementType.getTypeId();
							CAUGHT__q = eq;
						}
						catch (Exception THROWN__q) {
							CAUGHT__q = ValueUtil.createInvalidValue(THROWN__q);
				...
				try {
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType_0 = (org.eclipse.ocl.pivot.Class)TYP_CollectionType_10;
							@SuppressWarnings("null")
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, CAUGHT_safe_type_source, CAST_TYP_MapType_0).booleanValue();
						CAUGHT_oclIsKindOf = oclIsKindOf;
					}
					catch (Exception THROWN_oclIsKindOf) {
						CAUGHT_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_oclIsKindOf);
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_MapType = (org.eclipse.ocl.pivot.Class)TYP_MapType_9;
							@SuppressWarnings("null")
