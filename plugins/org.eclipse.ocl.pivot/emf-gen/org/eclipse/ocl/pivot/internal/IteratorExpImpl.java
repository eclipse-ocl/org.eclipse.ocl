	...
	public boolean validateSortedByIteratorTypeIsComparable(DiagnosticChain diagnostics, Map<Object, Object> context)
	{
		...
		try {
			...
			if (staticOperation == null) {
				...
				Type specializedBodyType = bodyType != null ? TemplateArgumentVisitor.specializeType(bodyType, this, standardLibrary, sourceType) : null;
				boolean isOk = false;
				if (bodyType != null) {
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, CAUGHT_parameterType1, TYP_LambdaType_0).booleanValue();
						/*@Thrown*/ @Nullable Type parameterType2;
						if (oclIsKindOf) {
							@SuppressWarnings("null")
							final /*@Thrown*/ @NonNull LambdaType oclAsType = (@NonNull LambdaType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, CAUGHT_parameterType1, TYP_LambdaType_0);
							@SuppressWarnings("null")
					...
					try {
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class TYP_LambdaType_2 = idResolver.getClass(PivotTables.CLSSid_LambdaType, null);
						if (CAUGHT_parameterType1 instanceof InvalidValueException) {
							throw (InvalidValueException)CAUGHT_parameterType1;
						}
						final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, CAUGHT_parameterType1, TYP_LambdaType_2).booleanValue();
						/*@Thrown*/ boolean parameterIsRequired;
						if (oclIsKindOf_0) {
							@SuppressWarnings("null")
							final /*@Thrown*/ @NonNull LambdaType oclAsType_0 = (@NonNull LambdaType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, CAUGHT_parameterType1, TYP_LambdaType_2);
							@SuppressWarnings("null")
