				...
				try {
					...
					if (CAUGHT_and == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							if (oclIsKindOf) {
								final /*@Thrown*/ @Nullable MapType oclAsType = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_MapType_5);
								if (oclAsType == null) {
				...
				try {
					...
					if (!IsEQ_) {
						...
						try {
							...
							if (oclIsKindOf) {
								final /*@Thrown*/ @Nullable CollectionType oclAsType_0 = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, TYP_CollectionType_6);
								if (oclAsType_0 == null) {
								...
								if (oclIsKindOf_0) {
									final /*@Thrown*/ @Nullable MapType oclAsType = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, TYP_MapType_4);
									if (oclAsType == null) {
				...
				try {
					...
					if (!IsEQ_) {
						...
						try {
							...
							final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, TYP_CollectionType_7);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
			...
			if (le) {
				...
				try {
					...
					if (!IsEQ_) {
						...
						try {
							final /*@NonInvalid*/ @Nullable Type type = this.getType();
							/*@Caught*/ @Nullable Object CAUGHT_SAFE_oclIsKindOf_1;
							try {
								final /*@NonInvalid*/ @Nullable OCLExpression ownedSource = this.getOwnedSource();
								...
								/*@Caught*/ @Nullable Object CAUGHT_SAFE_type_1;
								try {
									CAUGHT_SAFE_type_1 = SAFE_type_1;
								}
								catch (Exception THROWN_SAFE_type_1) {
									CAUGHT_SAFE_type_1 = ValueUtil.createInvalidValue(THROWN_SAFE_type_1);
								}
								final /*@NonInvalid*/ @NonNull Object IsEQ2_ = CAUGHT_SAFE_type_1 == null;
								/*@Thrown*/ @Nullable Boolean SAFE_oclIsKindOf_1;
								if (IsEQ2_ == Boolean.TRUE) {
									SAFE_oclIsKindOf_1 = null;
								}
								else {
									...
									final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, SAFE_type_1, TYP_SequenceType_1).booleanValue();
									SAFE_oclIsKindOf_1 = oclIsKindOf_1;
								}
								CAUGHT_SAFE_oclIsKindOf_1 = SAFE_oclIsKindOf_1;
							}
							catch (Exception THROWN_SAFE_oclIsKindOf_1) {
								CAUGHT_SAFE_oclIsKindOf_1 = ValueUtil.createInvalidValue(THROWN_SAFE_oclIsKindOf_1);
							}
							final /*@Thrown*/ @Nullable Boolean or;
							if (CAUGHT_SAFE_oclIsKindOf_1 == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, SAFE_type_0, TYP_OrderedSetType_4).booleanValue();
								...
								if (CAUGHT_oclIsKindOf == ValueUtil.TRUE_VALUE) {
									...
									if (CAUGHT_SAFE_oclIsKindOf_1 instanceof InvalidValueException) {
										throw (InvalidValueException)CAUGHT_SAFE_oclIsKindOf_1;
									}
									if (CAUGHT_oclIsKindOf instanceof InvalidValueException) {
										throw (InvalidValueException)CAUGHT_oclIsKindOf;
									}
									if (CAUGHT_SAFE_oclIsKindOf_1 == null) {
										or = null;
									}
									else {
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, TYP_OrderedSetType_1).booleanValue();
								IF_or = oclIsKindOf_2;
							}
							else {
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class TYP_SetType_0 = idResolver.getClass(PivotTables.CLSSid_SetType, null);
								final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, TYP_SetType_0).booleanValue();
								IF_or = oclIsKindOf_0;
							}
							CAUGHT_IF_or = IF_or;
						}
				...
				try {
					...
					if (!IsEQ__0) {
						...
						try {
							...
							final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type_0, TYP_CollectionType_12);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
					...
					if (!IsEQ_) {
						...
						try {
							...
							try {
								...
								final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, SAFE_type_0, TYP_SequenceType_4).booleanValue();
							...
							if (CAUGHT_oclIsKindOf_0 == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, SAFE_type_1, TYP_OrderedSetType_3).booleanValue();
									CAUGHT_oclIsKindOf = oclIsKindOf;
								}
								catch (Exception THROWN_oclIsKindOf) {
									CAUGHT_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_oclIsKindOf);
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, TYP_SequenceType_0).booleanValue();
								IF_or = oclIsKindOf_2;
							}
							else {
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class TYP_BagType_2 = idResolver.getClass(PivotTables.CLSSid_BagType, null);
								final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, TYP_BagType_2).booleanValue();
								IF_or = oclIsKindOf_1;
							}
							CAUGHT_IF_or = IF_or;
						}
						...
						try {
							...
							if (CAUGHT_oclIsKindOf == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, SAFE_type_0, TYP_BagType).booleanValue();
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, TYP_SequenceType).booleanValue();
								IF_or = oclIsKindOf_0;
							}
							else {
				...
				try {
					...
					if (!IsEQ__0) {
						...
						try {
							...
							final /*@NonInvalid*/ @Nullable Type type_0 = this.getType();
							final /*@Thrown*/ @Nullable CollectionType oclAsType_0 = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type_0, TYP_CollectionType);
							if (oclAsType_0 == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
							final /*@Thrown*/ @NonNull Type elementType = CollectionElementTypeProperty.INSTANCE.evaluate(executor, PivotTables.CLSSid_Type, oclAsType_0);
							...
							final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, SAFE_type, TYP_CollectionType);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
							...
							final /*@Thrown*/ boolean IsEQ_ = elementType.getTypeId() == elementType_0.getTypeId();
							CAUGHT_IsEQ_ = IsEQ_;
						}
						catch (Exception THROWN_IsEQ_) {
							CAUGHT_IsEQ_ = ValueUtil.createInvalidValue(THROWN_IsEQ_);
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, CAUGHT_sourceType, TYP_CollectionType_2).booleanValue();
						CAUGHT_oclIsKindOf = oclIsKindOf;
					}
					catch (Exception THROWN_oclIsKindOf) {
						CAUGHT_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_oclIsKindOf);
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, CAUGHT_sourceType, TYP_CollectionType_9);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, CAUGHT_sourceType, TYP_MapType_10).booleanValue();
						CAUGHT_oclIsKindOf = oclIsKindOf;
					}
					catch (Exception THROWN_oclIsKindOf) {
						CAUGHT_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_oclIsKindOf);
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@Thrown*/ @Nullable MapType oclAsType = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, CAUGHT_sourceType, TYP_MapType);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'MapType::keyType\'");
							}
					...
					if (!isSafe) {
						...
						try {
							...
							try {
								...
								/*@Thrown*/ boolean IF_oclIsKindOf;
								if (oclIsKindOf) {
									final /*@Thrown*/ @Nullable MapType oclAsType_0 = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_MapType_1);
									if (oclAsType_0 == null) {
										throw new InvalidValueException("Null source for \'MapType::keysAreNullFree\'");
									}
