				...
				try {
					...
					if (CAUGHT_and == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, THROWN_IF_IsEQ2_, TYP_MapType_11).booleanValue();
						...
						if (CAUGHT_oclIsKindOf == Boolean.TRUE) {
							...
							try {
								...
								final /*@Thrown*/ @Nullable MapType oclAsType = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, THROWN_IF_IsEQ2__0, TYP_MapType_12);
								if (oclAsType == null) {
					...
					if (!IsEQ_) {
						...
						if (CAUGHT_oclIsKindOf == Boolean.TRUE) {
							...
							try {
								...
								final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_1, TYP_MapType_5).booleanValue();
							...
							if (CAUGHT_oclIsKindOf_0 == Boolean.TRUE) {
								...
								try {
									...
									final /*@Thrown*/ @Nullable MapType oclAsType_0 = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type_2, TYP_MapType_6);
									if (oclAsType_0 == null) {
					...
					if (!IsEQ_) {
						...
						try {
							...
							if (IsEQ2__0) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, THROWN_IF_IsEQ2_, TYP_SequenceType_1).booleanValue();
									CAUGHT_oclIsKindOf = oclIsKindOf;
								}
								catch (Exception THROWN_CAUGHT_oclIsKindOf) {
									CAUGHT_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_CAUGHT_oclIsKindOf);
							...
							if (IF_IsEQ2_ == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, IF_IsEQ2__1, TYP_OrderedSetType_1).booleanValue();
									CAUGHT_oclIsKindOf_0 = oclIsKindOf_0;
								}
								catch (Exception THROWN_CAUGHT_oclIsKindOf_0) {
									CAUGHT_oclIsKindOf_0 = ValueUtil.createInvalidValue(THROWN_CAUGHT_oclIsKindOf_0);
						...
						if (CAUGHT_or == Boolean.TRUE) {
							...
							try {
								...
								final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_1, TYP_OrderedSetType_2).booleanValue();
							...
							try {
								...
								final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_2, TYP_SetType_1).booleanValue();
					...
					if (!IsEQ_) {
						...
						try {
							...
							try {
								...
								final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, IF_IsEQ2_, TYP_SequenceType_2).booleanValue();
								CAUGHT_oclIsKindOf = oclIsKindOf;
							}
							catch (Exception THROWN_CAUGHT_oclIsKindOf) {
								CAUGHT_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_CAUGHT_oclIsKindOf);
							...
							if (CAUGHT_oclIsKindOf == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, IF_IsEQ2__0, TYP_OrderedSetType_3).booleanValue();
									CAUGHT_oclIsKindOf_0 = oclIsKindOf_0;
								}
								catch (Exception THROWN_CAUGHT_oclIsKindOf_0) {
									CAUGHT_oclIsKindOf_0 = ValueUtil.createInvalidValue(THROWN_CAUGHT_oclIsKindOf_0);
						...
						if (CAUGHT_or == Boolean.TRUE) {
							...
							try {
								...
								final /*@NonInvalid*/ @Nullable Type type_1 = this.getType();
								final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_1, TYP_SequenceType_3).booleanValue();
								CAUGHT_oclIsKindOf_1 = oclIsKindOf_1;
							}
							catch (Exception THROWN_CAUGHT_oclIsKindOf_1) {
								CAUGHT_oclIsKindOf_1 = ValueUtil.createInvalidValue(THROWN_CAUGHT_oclIsKindOf_1);
							...
							try {
								...
								final /*@NonInvalid*/ @Nullable Type type_2 = this.getType();
								final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_2, TYP_BagType_1).booleanValue();
								CAUGHT_oclIsKindOf_2 = oclIsKindOf_2;
							}
							catch (Exception THROWN_CAUGHT_oclIsKindOf_2) {
								CAUGHT_oclIsKindOf_2 = ValueUtil.createInvalidValue(THROWN_CAUGHT_oclIsKindOf_2);
					...
					if (!IsEQ_) {
						...
						try {
							...
							if (CAUGHT_oclIsKindOf == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, IF_IsEQ2__0, TYP_BagType_2).booleanValue();
									CAUGHT_oclIsKindOf_0 = oclIsKindOf_0;
								}
								catch (Exception THROWN_CAUGHT_oclIsKindOf_0) {
									CAUGHT_oclIsKindOf_0 = ValueUtil.createInvalidValue(THROWN_CAUGHT_oclIsKindOf_0);
						...
						if (CAUGHT_or == Boolean.TRUE) {
							...
							try {
								...
								final /*@NonInvalid*/ @Nullable Type type_1 = this.getType();
								final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_1, TYP_SequenceType_5).booleanValue();
								CAUGHT_oclIsKindOf_1 = oclIsKindOf_1;
							}
							catch (Exception THROWN_CAUGHT_oclIsKindOf_1) {
								CAUGHT_oclIsKindOf_1 = ValueUtil.createInvalidValue(THROWN_CAUGHT_oclIsKindOf_1);
							...
							try {
								...
								final /*@NonInvalid*/ @Nullable Type type_2 = this.getType();
								final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_2, TYP_OrderedSetType_4).booleanValue();
								CAUGHT_oclIsKindOf_2 = oclIsKindOf_2;
							}
							catch (Exception THROWN_CAUGHT_oclIsKindOf_2) {
								CAUGHT_oclIsKindOf_2 = ValueUtil.createInvalidValue(THROWN_CAUGHT_oclIsKindOf_2);
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@Thrown*/ @Nullable Type THROWN_IF_IsEQ2_ = (@Nullable Type)IF_IsEQ2_;
						final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, THROWN_IF_IsEQ2_, TYP_MapType_7).booleanValue();
						CAUGHT_oclIsKindOf = oclIsKindOf;
					}
					catch (Exception THROWN_CAUGHT_oclIsKindOf) {
						CAUGHT_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_CAUGHT_oclIsKindOf);
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@Thrown*/ @Nullable Type THROWN_IF_IsEQ2__0 = (@Nullable Type)IF_IsEQ2_;
							final /*@Thrown*/ @Nullable MapType oclAsType = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, THROWN_IF_IsEQ2__0, TYP_MapType_8);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'MapType::keyType\'");
							}
					...
					if (!isSafe) {
						...
						try {
							...
							try {
								...
								final /*@Thrown*/ @Nullable Type THROWN_IF_IsEQ2_ = (@Nullable Type)IF_IsEQ2_;
								final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, THROWN_IF_IsEQ2_, TYP_MapType_9).booleanValue();
								CAUGHT_oclIsKindOf = oclIsKindOf;
							}
							catch (Exception THROWN_CAUGHT_oclIsKindOf) {
								CAUGHT_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_CAUGHT_oclIsKindOf);
							...
							if (CAUGHT_oclIsKindOf == Boolean.TRUE) {
								...
								try {
									...
									final /*@Thrown*/ @Nullable Type THROWN_IF_IsEQ2__0 = (@Nullable Type)IF_IsEQ2_;
									final /*@Thrown*/ @Nullable MapType oclAsType = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, THROWN_IF_IsEQ2__0, TYP_MapType_10);
									if (oclAsType == null) {
										throw new InvalidValueException("Null source for \'MapType::keysAreNullFree\'");
									}
									final /*@Thrown*/ boolean keysAreNullFree = oclAsType.isKeysAreNullFree();
