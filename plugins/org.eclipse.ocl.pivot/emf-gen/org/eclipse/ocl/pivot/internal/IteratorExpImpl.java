					...
					if (!eq) {
						...
						try {
							...
							if (oclIsKindOf) {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_MapType = TYP_MapType_10;
					...
					if (!eq) {
						...
						try {
							...
							if (or) {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_OrderedSetType_0 = TYP_OrderedSetType_1;
								final /*@Thrown*/ boolean oclIsKindOf_3 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_OrderedSetType_0).booleanValue();
								IF_or = oclIsKindOf_3;
							}
							else {
				...
				try {
					...
					if (!eq_0) {
						...
						try {
							...
							final /*@NonInvalid*/ @NonNull Object flattenedType_0 = type_0 == null;
					...
					if (!eq) {
						...
						try {
							...
							try {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_SequenceType_0 = TYP_SequenceType_1;
							...
							if (CAUGHT_oclIsKindOf_0 == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_OrderedSetType = TYP_OrderedSetType;
									final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source_0, CAST_TYP_OrderedSetType).booleanValue();
							...
							if (or) {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_SequenceType = TYP_SequenceType_3;
				...
				try {
					...
					if (!eq_0) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType = TYP_CollectionType_0;
							final /*@NonInvalid*/ @Nullable Type type = this.getType();
							@SuppressWarnings("null")
							final /*@Thrown*/ @NonNull CollectionType oclAsType = (@NonNull CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, CAST_TYP_CollectionType);
							final /*@Thrown*/ @NonNull Type elementType = CollectionElementTypeProperty.INSTANCE.evaluate(executor, PivotTables.CLSSid_Type, oclAsType);
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType_0 = TYP_CollectionType_12;
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType = TYP_CollectionType_11;
							@SuppressWarnings("null")
				...
				try {
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_MapType_0 = TYP_MapType_2;
							@SuppressWarnings("null")
