				...
				try {
					...
					if (CAUGHT_and == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_MapType = TYP_MapType_9;
						...
						try {
							...
							try {
								...
								if (oclIsKindOf_3 == Boolean.TRUE) {
									...
									final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_SequenceType = TYP_SequenceType_1;
							...
							if (or) {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_SetType = TYP_SetType;
								final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_SetType).booleanValue();
								IF_or = oclIsKindOf_2;
							}
							CAUGHT_IF_or = IF_or;
						}
					...
					if (!eq) {
						...
						try {
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_SequenceType_0).booleanValue();
								IF_or = oclIsKindOf_2;
							}
							else {
					...
					if (!eq) {
						...
						try {
							...
							try {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_SequenceType_0 = TYP_SequenceType_2;
								final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source_0, CAST_TYP_SequenceType_0).booleanValue();
								CAUGHT_oclIsKindOf = oclIsKindOf_0;
							}
							catch (Exception THROWN_oclIsKindOf) {
								CAUGHT_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_oclIsKindOf);
							...
							if (CAUGHT_oclIsKindOf == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_BagType).booleanValue();
							...
							if (or) {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_SequenceType = TYP_SequenceType;
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType_0 = TYP_CollectionType_10;
		...
		try {
			...
			if (le) {
				...
				try {
					...
					/*@Caught*/ @NonNull Object CAUGHT_oclIsKindOf;
					try {
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class TYP_MapType_12 = idResolver.getClass(PivotTables.CLSSid_MapType, null);
						if (CAUGHT_safe_type_source instanceof InvalidValueException) {
							throw (InvalidValueException)CAUGHT_safe_type_source;
						}
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_MapType_0 = TYP_MapType_12;
