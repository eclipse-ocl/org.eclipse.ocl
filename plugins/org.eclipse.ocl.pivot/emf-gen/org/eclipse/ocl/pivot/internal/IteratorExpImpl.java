				...
				try {
					...
					if (CAUGHT_and == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, sourceType, TYP_MapType_8).booleanValue();
							/*@Thrown*/ boolean IF_oclIsKindOf;
							if (oclIsKindOf) {
								final /*@Thrown*/ @Nullable MapType oclAsType_0 = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_MapType_8);
								if (oclAsType_0 == null) {
								...
								final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_CollectionType_9);
								if (oclAsType == null) {
				...
				try {
					...
					if (!IsEQ_) {
						...
						try {
							...
							final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, TYP_CollectionType_6).booleanValue();
							...
							if (oclIsKindOf) {
								...
								final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, TYP_MapType_10).booleanValue();
								/*@Thrown*/ @Nullable Type IF_oclIsKindOf;
								if (oclIsKindOf_0) {
									final /*@Thrown*/ @Nullable MapType oclAsType_0 = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, TYP_MapType_10);
									if (oclAsType_0 == null) {
							...
							/*@Caught*/ @Nullable Object CAUGHT_IF_oclIsKindOf;
							try {
								CAUGHT_IF_oclIsKindOf = bodyElementType;
							}
							catch (Exception THROWN_CAUGHT_IF_oclIsKindOf) {
								CAUGHT_IF_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_CAUGHT_IF_oclIsKindOf);
							}
							final /*@NonInvalid*/ @NonNull Object IsEQ2_ = CAUGHT_IF_oclIsKindOf == null;
				...
				try {
					...
					if (!IsEQ_) {
						...
						try {
							...
							final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, TYP_CollectionType_10);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
							...
							catch (Exception THROWN_CAUGHT_iteratorType) {
								CAUGHT_iteratorType = ValueUtil.createInvalidValue(THROWN_CAUGHT_iteratorType);
							}
				...
				try {
					...
					if (!IsEQ_) {
						...
						try {
							...
							try {
								final /*@NonInvalid*/ @Nullable OCLExpression ownedSource = this.getOwnedSource();
								final /*@NonInvalid*/ @NonNull Object IsEQ2__1 = ownedSource == null;
								...
								final /*@NonInvalid*/ @NonNull Object IsEQ2__0 = CAUGHT_IF_IsEQ2__0 == null;
								/*@Thrown*/ @Nullable Boolean IF_IsEQ2_;
								if (IsEQ2__0 == Boolean.TRUE) {
									...
									final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, IF_IsEQ2__0, TYP_SequenceType).booleanValue();
									IF_IsEQ2_ = oclIsKindOf_0;
								}
								CAUGHT_IF_IsEQ2_ = IF_IsEQ2_;
							}
							catch (Exception THROWN_CAUGHT_IF_IsEQ2_) {
							...
							if (CAUGHT_IF_IsEQ2_ == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@NonInvalid*/ @NonNull Object IsEQ2_ = ownedSource_0 == null;
									...
									final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, IF_IsEQ2__1, TYP_OrderedSetType_4).booleanValue();
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, TYP_OrderedSetType_0).booleanValue();
								IF_or = oclIsKindOf_1;
							}
							else {
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class TYP_SetType_1 = idResolver.getClass(PivotTables.CLSSid_SetType, null);
								final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, TYP_SetType_1).booleanValue();
								IF_or = oclIsKindOf;
							}
							CAUGHT_IF_or = IF_or;
						}
						catch (Exception THROWN_CAUGHT_IF_or) {
							CAUGHT_IF_or = ValueUtil.createInvalidValue(THROWN_CAUGHT_IF_or);
						}
				...
				try {
					...
					if (!IsEQ__0) {
						...
						try {
							...
							final /*@Thrown*/ boolean IsEQ_ = (IF_IsEQ2_ != null) ? (elementType.getTypeId() == IF_IsEQ2_.getTypeId()) : false;
							CAUGHT_IsEQ_ = IsEQ_;
						}
					...
					if (!IsEQ_) {
						...
						try {
							...
							try {
								...
								final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, IF_IsEQ2__0, TYP_SequenceType_1).booleanValue();
							...
							if (CAUGHT_oclIsKindOf == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, IF_IsEQ2_, TYP_OrderedSetType_2).booleanValue();
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, TYP_SequenceType_3).booleanValue();
								IF_or = oclIsKindOf_0;
							}
							else {
					...
					if (!IsEQ_) {
						...
						try {
							...
							try {
								...
								final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, IF_IsEQ2_, TYP_SequenceType_5).booleanValue();
							...
							if (CAUGHT_oclIsKindOf == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, IF_IsEQ2__0, TYP_BagType_2).booleanValue();
									CAUGHT_oclIsKindOf_0 = oclIsKindOf_2;
								}
								catch (Exception THROWN_CAUGHT_oclIsKindOf_0) {
									CAUGHT_oclIsKindOf_0 = ValueUtil.createInvalidValue(THROWN_CAUGHT_oclIsKindOf_0);
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_1, TYP_OrderedSetType).booleanValue();
								IF_or = oclIsKindOf_1;
							}
							CAUGHT_IF_or = IF_or;
						}
				...
				try {
					...
					if (!IsEQ__0) {
						...
						try {
							...
							final /*@NonInvalid*/ @Nullable Type type_0 = this.getType();
							final /*@Thrown*/ @Nullable CollectionType oclAsType_0 = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type_0, TYP_CollectionType_2);
							if (oclAsType_0 == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
							...
							final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, IF_IsEQ2_, TYP_CollectionType_2);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
							final /*@Thrown*/ @NonNull Type elementType = CollectionElementTypeProperty.INSTANCE.evaluate(executor, PivotTables.CLSSid_Type, oclAsType);
	...
	public boolean validateIteratorTypeIsSourceElementType(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
			...
			if (le) {
				...
				/*@Caught*/ @Nullable Object result;
				try {
					/*@Caught*/ @Nullable Object sourceType;
					try {
						final /*@NonInvalid*/ @Nullable OCLExpression ownedSource = this.getOwnedSource();
						final /*@NonInvalid*/ @NonNull Object IsEQ2_ = ownedSource == null;
						/*@Thrown*/ @Nullable Type IF_IsEQ2_;
						...
						sourceType = IF_IsEQ2_;
					}
					catch (Exception THROWN_sourceType) {
						sourceType = ValueUtil.createInvalidValue(THROWN_sourceType);
					}
					/*@Caught*/ @NonNull Object CAUGHT_oclIsKindOf;
					try {
						...
						if (sourceType instanceof InvalidValueException) {
							throw (InvalidValueException)sourceType;
						}
						final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, sourceType, TYP_CollectionType_12).booleanValue();
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_CollectionType_7);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'CollectionType::elementType\'");
							}
				...
				try {
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@Thrown*/ @Nullable MapType oclAsType = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_MapType_4);
							if (oclAsType == null) {
								throw new InvalidValueException("Null source for \'MapType::keyType\'");
							}
					...
					if (!isSafe) {
						...
						try {
							...
							try {
								...
								/*@Thrown*/ boolean IF_oclIsKindOf;
								if (oclIsKindOf) {
									final /*@Thrown*/ @Nullable MapType oclAsType = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_MapType);
									if (oclAsType == null) {
										throw new InvalidValueException("Null source for \'MapType::keysAreNullFree\'");
									}
									...
									final /*@Thrown*/ @Nullable CollectionType oclAsType_0 = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_CollectionType);
									if (oclAsType_0 == null) {
										throw new InvalidValueException("Null source for \'CollectionType::isNullFree\'");
									}
