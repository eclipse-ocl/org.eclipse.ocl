						...
						try {
							...
							try {
								...
								if (oclIsKindOf == Boolean.TRUE) {
									...
									final /*@Thrown*/ boolean oclIsKindOf_3 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_SequenceType).booleanValue();
									safe_oclIsKindOf_source = oclIsKindOf_3;
								}
							...
							if (CAUGHT_safe_oclIsKindOf_source == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source_0, CAST_TYP_OrderedSetType_0).booleanValue();
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_OrderedSetType).booleanValue();
								IF_or = oclIsKindOf_1;
							}
							else {
								...
								final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_SetType).booleanValue();
								IF_or = oclIsKindOf_0;
							}
							CAUGHT_IF_or = IF_or;
						}
						...
						try {
							...
							if (CAUGHT_oclIsKindOf_0 == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source_0, CAST_TYP_OrderedSetType).booleanValue();
									CAUGHT_oclIsKindOf = oclIsKindOf_2;
								}
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf_1 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_SequenceType_0).booleanValue();
								IF_or = oclIsKindOf_1;
							}
							else {
								...
								final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_BagType).booleanValue();
								IF_or = oclIsKindOf;
							}
							CAUGHT_IF_or = IF_or;
						}
						...
						try {
							...
							if (CAUGHT_oclIsKindOf == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_BagType = (org.eclipse.ocl.pivot.Class)TYP_BagType;
							...
							if (or) {
								...
								final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_0, CAST_TYP_SequenceType).booleanValue();
								IF_or = oclIsKindOf;
							}
							else {
								...
								final /*@Thrown*/ boolean oclIsKindOf_2 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_0, CAST_TYP_OrderedSetType).booleanValue();
								IF_or = oclIsKindOf_2;
							}
							CAUGHT_IF_or = IF_or;
						}
				...
				try {
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType_0 = (org.eclipse.ocl.pivot.Class)TYP_CollectionType_1;
							@SuppressWarnings("null")
				...
				try {
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_MapType_0 = (org.eclipse.ocl.pivot.Class)TYP_MapType_1;
							@SuppressWarnings("null")
