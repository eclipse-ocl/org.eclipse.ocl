				...
				try {
					...
					try {
						...
						if (not == ValueUtil.FALSE_VALUE) {
							...
							@NonNull Iterator<Object> ITER_1_ = BOXED_ownedIterators.iterator();
							...
							while (true) {
								...
								@SuppressWarnings("null")
								/*@NonInvalid*/ @NonNull Variable _1 = (@NonNull Variable)ITER_1_.next();
								/**
								 * isRequired
								 */
					...
					if (CAUGHT_and == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_MapType = (org.eclipse.ocl.pivot.Class)TYP_MapType_8;
							@SuppressWarnings("null")
							final /*@Thrown*/ boolean oclIsKindOf = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_MapType)).booleanValue();
							/*@Thrown*/ boolean IF_oclIsKindOf;
							if (oclIsKindOf) {
								@SuppressWarnings("null")
								final /*@Thrown*/ @NonNull MapType oclAsType_0 = (@NonNull MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_MapType);
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType = (org.eclipse.ocl.pivot.Class)TYP_CollectionType;
								@SuppressWarnings("null")
								final /*@Thrown*/ @NonNull CollectionType oclAsType = (@NonNull CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_CollectionType);
				...
				try {
					...
					if (!eq) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType = (org.eclipse.ocl.pivot.Class)TYP_CollectionType_3;
							final /*@NonInvalid*/ @Nullable Type type = ownedBody.getType();
							@SuppressWarnings("null")
							final /*@Thrown*/ boolean oclIsKindOf = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_CollectionType)).booleanValue();
							/*@Thrown*/ @Nullable Type bodyElementType;
							if (oclIsKindOf) {
								@SuppressWarnings("null")
								final /*@Thrown*/ @NonNull CollectionType oclAsType = (@NonNull CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, CAST_TYP_CollectionType);
								...
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean oclIsKindOf_0 = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_MapType)).booleanValue();
								/*@Thrown*/ @Nullable Type IF_oclIsKindOf;
								if (oclIsKindOf_0) {
									@SuppressWarnings("null")
									final /*@Thrown*/ @NonNull MapType oclAsType_0 = (@NonNull MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, CAST_TYP_MapType);
							...
							if (conformsTo == Boolean.TRUE) {
								...
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean conformsTo_0 = ((@NonNull Boolean)OclTypeConformsToOperation.INSTANCE.evaluate(executor, bodyElementType, iteratorType)).booleanValue();
				...
				try {
					...
					if (!eq) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType = (org.eclipse.ocl.pivot.Class)TYP_CollectionType_6;
							@SuppressWarnings("null")
							final /*@Thrown*/ @NonNull CollectionType oclAsType = (@NonNull CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, CAST_TYP_CollectionType);
							...
							if (conformsTo == Boolean.TRUE) {
								...
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean conformsTo_0 = ((@NonNull Boolean)OclTypeConformsToOperation.INSTANCE.evaluate(executor, iteratorType, resultElementType)).booleanValue();
								safe_conformsTo_source = conformsTo_0;
							}
							CAUGHT_safe_conformsTo_source = safe_conformsTo_source;
						}
					...
					if (!eq) {
						...
						try {
							...
							try {
								...
								final /*@NonInvalid*/ @NonNull Object oclIsKindOf_3 = CAUGHT_safe_type_source == null;
								/*@Thrown*/ @Nullable Boolean safe_oclIsKindOf_source;
								if (oclIsKindOf_3 == Boolean.TRUE) {
									...
									@SuppressWarnings("null")
									final /*@Thrown*/ boolean oclIsKindOf_0 = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_SequenceType)).booleanValue();
									safe_oclIsKindOf_source = oclIsKindOf_0;
								}
								CAUGHT_safe_oclIsKindOf_source = safe_oclIsKindOf_source;
							}
							catch (Exception THROWN_safe_oclIsKindOf_source) {
								CAUGHT_safe_oclIsKindOf_source = ValueUtil.createInvalidValue(THROWN_safe_oclIsKindOf_source);
							}
							...
							if (CAUGHT_safe_oclIsKindOf_source == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									if (type_2 == Boolean.TRUE) {
										...
										assert ownedSource != null;
										final /*@Thrown*/ @Nullable Type type_3 = ownedSource.getType();
										safe_type_source_0 = type_3;
									}
									final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_OrderedSetType_0 = (org.eclipse.ocl.pivot.Class)TYP_OrderedSetType;
									@SuppressWarnings("null")
									final /*@Thrown*/ boolean oclIsKindOf_1 = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source_0, CAST_TYP_OrderedSetType_0)).booleanValue();
									CAUGHT_oclIsKindOf = oclIsKindOf_1;
								}
							...
							if (or) {
								...
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean oclIsKindOf_2 = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_0, CAST_TYP_OrderedSetType)).booleanValue();
								IF_or = oclIsKindOf_2;
							}
							else {
								...
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean oclIsKindOf = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_0, CAST_TYP_SetType)).booleanValue();
								IF_or = oclIsKindOf;
							}
							CAUGHT_IF_or = IF_or;
						}
	...
	public boolean validateCollectElementTypeIsFlattenedBodyType(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
			...
			if (le) {
				...
				try {
					final /*@NonInvalid*/ @Nullable String name = this.getName();
					final /*@NonInvalid*/ boolean eq_0 = PivotTables.STR_collect.equals(name);
					final /*@Thrown*/ @Nullable Boolean result;
					if (!eq_0) {
						result = ValueUtil.TRUE_VALUE;
					}
					else {
						/*@Caught*/ @NonNull Object CAUGHT__q;
						try {
							...
							final /*@NonInvalid*/ @Nullable Type type_0 = this.getType();
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType = (org.eclipse.ocl.pivot.Class)TYP_CollectionType_4;
							@SuppressWarnings("null")
							final /*@Thrown*/ @NonNull CollectionType oclAsType = (@NonNull CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type_0, CAST_TYP_CollectionType);
							final /*@Thrown*/ @NonNull Type elementType = CollectionElementTypeProperty.INSTANCE.evaluate(executor, PivotTables.CLSSid_Type, oclAsType);
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull OCLExpression ownedBody = this.getOwnedBody();
							final /*@NonInvalid*/ @Nullable Type type = ownedBody.getType();
							final /*@NonInvalid*/ @NonNull Object flattenedType = type == null;
							...
							if (flattenedType == Boolean.TRUE) {
								...
								assert type != null;
								@SuppressWarnings("null")
								final /*@Thrown*/ @NonNull Type flattenedType_0 = type.flattenedType();
								safe_flattenedType_source = flattenedType_0;
							}
							final /*@Thrown*/ boolean eq = (safe_flattenedType_source != null) ? (elementType.getTypeId() == safe_flattenedType_source.getTypeId()) : false;
							CAUGHT__q = eq;
						}
						catch (Exception THROWN__q) {
							CAUGHT__q = ValueUtil.createInvalidValue(THROWN__q);
						}
						if (CAUGHT__q == ValueUtil.TRUE_VALUE) {
							result = ValueUtil.TRUE_VALUE;
						}
						else {
							if (CAUGHT__q instanceof InvalidValueException) {
								throw (InvalidValueException)CAUGHT__q;
							}
							result = ValueUtil.FALSE_VALUE;
						}
					}
					...
					if (!eq) {
						...
						try {
							...
							try {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_SequenceType = (org.eclipse.ocl.pivot.Class)TYP_SequenceType_3;
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean oclIsKindOf_2 = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source_0, CAST_TYP_SequenceType)).booleanValue();
								CAUGHT_oclIsKindOf = oclIsKindOf_2;
							}
							...
							if (CAUGHT_oclIsKindOf == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									if (type_1 == Boolean.TRUE) {
										...
										assert ownedSource_0 != null;
										final /*@Thrown*/ @Nullable Type type_3 = ownedSource_0.getType();
									...
									@SuppressWarnings("null")
									final /*@Thrown*/ boolean oclIsKindOf = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_OrderedSetType)).booleanValue();
							...
							if (or) {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_SequenceType_0 = (org.eclipse.ocl.pivot.Class)TYP_SequenceType_4;
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean oclIsKindOf_0 = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_SequenceType_0)).booleanValue();
								IF_or = oclIsKindOf_0;
							}
							else {
								...
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean oclIsKindOf_1 = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_BagType)).booleanValue();
								IF_or = oclIsKindOf_1;
							}
							CAUGHT_IF_or = IF_or;
						}
					...
					if (!eq) {
						...
						try {
							...
							try {
								...
								final /*@NonInvalid*/ @Nullable OCLExpression ownedSource_0 = this.getOwnedSource();
								final /*@NonInvalid*/ @NonNull Object type_3 = ownedSource_0 == null;
								/*@Thrown*/ @Nullable Type safe_type_source;
								if (type_3 == Boolean.TRUE) {
									safe_type_source = null;
								}
								else {
									assert ownedSource_0 != null;
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_SequenceType = (org.eclipse.ocl.pivot.Class)TYP_SequenceType_1;
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean oclIsKindOf_2 = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_SequenceType)).booleanValue();
								CAUGHT_oclIsKindOf = oclIsKindOf_2;
							}
							catch (Exception THROWN_oclIsKindOf_0) {
								CAUGHT_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_oclIsKindOf_0);
							...
							if (CAUGHT_oclIsKindOf == ValueUtil.TRUE_VALUE) {
								...
								try {
									...
									final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_BagType = (org.eclipse.ocl.pivot.Class)TYP_BagType_2;
									@SuppressWarnings("null")
									final /*@Thrown*/ boolean oclIsKindOf_1 = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source_0, CAST_TYP_BagType)).booleanValue();
									CAUGHT_oclIsKindOf_0 = oclIsKindOf_1;
								}
								catch (Exception THROWN_oclIsKindOf) {
									CAUGHT_oclIsKindOf_0 = ValueUtil.createInvalidValue(THROWN_oclIsKindOf);
								}
							...
							if (or) {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_SequenceType_0 = (org.eclipse.ocl.pivot.Class)TYP_SequenceType_5;
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean oclIsKindOf = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_SequenceType_0)).booleanValue();
								IF_or = oclIsKindOf;
							}
							else {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_OrderedSetType = (org.eclipse.ocl.pivot.Class)TYP_OrderedSetType_0;
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean oclIsKindOf_0 = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_OrderedSetType)).booleanValue();
								IF_or = oclIsKindOf_0;
							}
							CAUGHT_IF_or = IF_or;
						}
	...
	public boolean validateSortedByElementTypeIsSourceElementType(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
			...
			if (le) {
				...
				try {
					final /*@NonInvalid*/ @Nullable String name = this.getName();
					final /*@NonInvalid*/ boolean eq_0 = PivotTables.STR_sortedBy.equals(name);
					final /*@Thrown*/ @Nullable Boolean result;
					if (!eq_0) {
						result = ValueUtil.TRUE_VALUE;
					}
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType = (org.eclipse.ocl.pivot.Class)TYP_CollectionType_0;
							final /*@NonInvalid*/ @Nullable Type type_0 = this.getType();
							@SuppressWarnings("null")
							final /*@Thrown*/ @NonNull CollectionType oclAsType = (@NonNull CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type_0, CAST_TYP_CollectionType);
							final /*@Thrown*/ @NonNull Type elementType = CollectionElementTypeProperty.INSTANCE.evaluate(executor, PivotTables.CLSSid_Type, oclAsType);
							final /*@NonInvalid*/ @Nullable OCLExpression ownedSource = this.getOwnedSource();
							final /*@NonInvalid*/ @NonNull Object type_1 = ownedSource == null;
							/*@Thrown*/ @Nullable Type safe_type_source;
							if (type_1 == Boolean.TRUE) {
								safe_type_source = null;
							}
							...
							@SuppressWarnings("null")
							final /*@Thrown*/ @NonNull CollectionType oclAsType_0 = (@NonNull CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_CollectionType);
							...
							final /*@Thrown*/ boolean eq = elementType.getTypeId() == elementType_0.getTypeId();
							CAUGHT__q = eq;
						}
						catch (Exception THROWN__q) {
							CAUGHT__q = ValueUtil.createInvalidValue(THROWN__q);
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType = (org.eclipse.ocl.pivot.Class)TYP_CollectionType_10;
						@SuppressWarnings("null")
						final /*@Thrown*/ boolean oclIsKindOf = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, CAUGHT_safe_type_source, CAST_TYP_CollectionType)).booleanValue();
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType_0 = (org.eclipse.ocl.pivot.Class)TYP_CollectionType_5;
							@SuppressWarnings("null")
							final /*@Thrown*/ @NonNull CollectionType oclAsType = (@NonNull CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, CAUGHT_safe_type_source, CAST_TYP_CollectionType_0);
							...
							while (true) {
								...
								try {
									...
									@SuppressWarnings("null")
									final /*@Thrown*/ boolean conformsTo = ((@NonNull Boolean)OclTypeConformsToOperation.INSTANCE.evaluate(executor, sourceElementType, type_1)).booleanValue();
				...
				catch (Exception THROWN_implies) {
					CAUGHT_implies = ValueUtil.createInvalidValue(THROWN_implies);
				}
				@SuppressWarnings("null")
				final /*@NonInvalid*/ boolean logDiagnostic = ((@NonNull Boolean)CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, constraintName, this, (Object)null, diagnostics, context, (Object)null, severity, CAUGHT_implies, PivotTables.INT_0)).booleanValue();
				IF__l_q = logDiagnostic;
			}
			return IF__l_q;
		}
			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_MapType_0 = (org.eclipse.ocl.pivot.Class)TYP_MapType_7;
						@SuppressWarnings("null")
						final /*@Thrown*/ boolean oclIsKindOf = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, CAUGHT_safe_type_source, CAST_TYP_MapType_0)).booleanValue();
						CAUGHT_oclIsKindOf = oclIsKindOf;
					}
					catch (Exception THROWN_oclIsKindOf) {
						CAUGHT_oclIsKindOf = ValueUtil.createInvalidValue(THROWN_oclIsKindOf);
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_MapType = (org.eclipse.ocl.pivot.Class)TYP_MapType_1;
							@SuppressWarnings("null")
							final /*@Thrown*/ @NonNull MapType oclAsType = (@NonNull MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, CAUGHT_safe_type_source, CAST_TYP_MapType);
							...
							while (true) {
								...
								try {
									final /*@NonInvalid*/ @Nullable Type type_1 = p.getType();
									@SuppressWarnings("null")
									final /*@Thrown*/ boolean conformsTo = ((@NonNull Boolean)OclTypeConformsToOperation.INSTANCE.evaluate(executor, sourceKeyType, type_1)).booleanValue();
									CAUGHT_conformsTo = conformsTo;
								}
								catch (Exception THROWN_conformsTo) {
									CAUGHT_conformsTo = ValueUtil.createInvalidValue(THROWN_conformsTo);
					...
					if (!isSafe) {
						...
						try {
							...
							try {
								...
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_MapType = (org.eclipse.ocl.pivot.Class)TYP_MapType_2;
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean oclIsKindOf = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_MapType)).booleanValue();
								/*@Thrown*/ boolean IF_oclIsKindOf;
								if (oclIsKindOf) {
									@SuppressWarnings("null")
									final /*@Thrown*/ @NonNull MapType oclAsType = (@NonNull MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_MapType);
									...
									final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_CollectionType = (org.eclipse.ocl.pivot.Class)TYP_CollectionType_2;
									@SuppressWarnings("null")
									final /*@Thrown*/ @NonNull CollectionType oclAsType_0 = (@NonNull CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, safe_type_source, CAST_TYP_CollectionType);
