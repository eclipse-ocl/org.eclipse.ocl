...
implements DataType {
	...
	public void setIsSerializable(boolean newIsSerializable)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 22, oldIsSerializable, newIsSerializable));
	}
	...
	public org.eclipse.ocl.pivot.Class getBehavioralClass()
	{
		if (behavioralClass != null && behavioralClass.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 21, oldBehavioralClass, behavioralClass));
			}
		}
	...
	public void setBehavioralClass(org.eclipse.ocl.pivot.Class newBehavioralClass)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 21, oldBehavioralClass, behavioralClass));
	}
	...
	public @NonNull FlatClass getFlatClass(@NonNull StandardLibrary standardLibrary) {
		...
		org.eclipse.ocl.pivot.Class unspecializedClass = flattenableClass.getGeneric();
