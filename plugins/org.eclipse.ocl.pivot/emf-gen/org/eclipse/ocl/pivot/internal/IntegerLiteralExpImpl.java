...
public class IntegerLiteralExpImpl
	 ...
	 * @ordered
	 */
	public static final int INTEGER_LITERAL_EXP_FEATURE_COUNT = NumericLiteralExpImpl.NUMERIC_LITERAL_EXP_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	public static final int INTEGER_LITERAL_EXP_OPERATION_COUNT = NumericLiteralExpImpl.NUMERIC_LITERAL_EXP_OPERATION_COUNT + 1;
	...
	{
		final @NonNull String constraintName = "IntegerLiteralExp::TypeIsInteger";
		try {
			/**
			 *
			 * inv TypeIsInteger:
			 ...
			 *     then true
			 *     else
			 *       let result : Boolean[1] = self.type = Integer
			 *       in
			...
			final /*@NonInvalid*/ @NonNull IntegerValue severity = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, PivotPackage.Literals.INTEGER_LITERAL_EXP___VALIDATE_TYPE_IS_INTEGER__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ @NonNull PrimitiveType CAST_TYP_Integer = (PrimitiveType)TYP_Integer;
				final /*@NonInvalid*/ boolean result = (type != null) ? (type.getTypeId() == CAST_TYP_Integer.getTypeId()) : false;
				@SuppressWarnings("null")
