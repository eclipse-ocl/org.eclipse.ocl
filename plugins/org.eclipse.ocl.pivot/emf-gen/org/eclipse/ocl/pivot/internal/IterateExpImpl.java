					...
					if (CAUGHT_and == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							if (oclIsKindOf) {
								...
								final /*@Thrown*/ @Nullable CollectionType oclAsType_0 = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_CollectionType_4);
								if (oclAsType_0 == null) {
					...
					if (!isSafe) {
						...
						try {
							...
							try {
								...
								/*@Thrown*/ boolean IF_oclIsKindOf;
								if (oclIsKindOf) {
									final /*@Thrown*/ @Nullable MapType oclAsType_0 = (@Nullable MapType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_MapType_2);
									if (oclAsType_0 == null) {
										throw new InvalidValueException("Null source for \'MapType::keysAreNullFree\'");
									}
