					...
					if (CAUGHT_and == ValueUtil.FALSE_VALUE) {
						...
						try {
							...
							if (oclIsKindOf) {
								...
								final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_CollectionType_12);
								if (oclAsType == null) {
						...
						try {
							...
							try {
								...
								if (oclIsKindOf) {
									...
									final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, sourceType, TYP_CollectionType_0);
									if (oclAsType == null) {
										throw new InvalidValueException("Null source for \'CollectionType::isNullFree\'");
									}
									final /*@Thrown*/ boolean isNullFree = oclAsType.isIsNullFree();
