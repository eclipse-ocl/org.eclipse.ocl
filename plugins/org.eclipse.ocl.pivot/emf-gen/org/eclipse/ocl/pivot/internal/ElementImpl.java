	...
	public @NonNull List<Element> allOwnedElements()
	{
		...
		final @NonNull AbstractBinaryOperation BODY0_closure_1 = new AbstractBinaryOperation()
		{
			...
			public @Nullable Object evaluate(final @NonNull Executor executor, final @NonNull TypeId typeId, final @Nullable Object oclAsSet, final /*@NonInvalid*/ @Nullable Object _1) {
				final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class TYP_pivot_c_c_Element_0 = idResolver.getClass(PivotTables.CLSSid_Element, null);
				...
				final /*@Thrown*/ @NonNull SetValue selectByKind = (@Nullable SetValue)CollectionSelectByKindOperation.INSTANCE.evaluate(executor, oclContents, TYP_pivot_c_c_Element_0);
				return selectByKind;
			}
		};
