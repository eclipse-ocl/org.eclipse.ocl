			...
			if (le) {
				...
				try {
					...
					try {
						...
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_DataType = (org.eclipse.ocl.pivot.Class)TYP_DataType;
						@SuppressWarnings("null")
						final /*@Thrown*/ boolean oclIsKindOf = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_DataType)).booleanValue();
					...
					if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
						...
						@SuppressWarnings("null")
						final /*@NonInvalid*/ @NonNull IntegerValue size = (@NonNull IntegerValue)CollectionSizeOperation.INSTANCE.evaluate(BOXED_ownedParts);
		...
		try {
			...
			if (le) {
				...
				try {
					...
					final /*@NonInvalid*/ @Nullable Type type = this.getType();
					final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_DataType = (org.eclipse.ocl.pivot.Class)TYP_DataType_0;
					@SuppressWarnings("null")
					final /*@Thrown*/ boolean oclIsKindOf = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type, CAST_TYP_DataType)).booleanValue();
					...
					if (oclIsKindOf) {
						...
						final /*@NonInvalid*/ @NonNull List<ShadowPart> ownedParts = this.getOwnedParts();
						final /*@NonInvalid*/ @NonNull OrderedSetValue BOXED_ownedParts = idResolver.createOrderedSetOfAll(PivotTables.ORD_CLSSid_ShadowPart, ownedParts);
						/*@Thrown*/ @NonNull Accumulator accumulator_5 = ValueUtil.createSequenceAccumulatorValue(PivotTables.SEQ_CLSSid_Property);
						@NonNull Iterator<Object> ITER_1__5 = BOXED_ownedParts.iterator();
						/*@NonInvalid*/ @NonNull SequenceValue collect_0;
						while (true) {
							if (!ITER_1__5.hasNext()) {
								collect_0 = accumulator_5;
								break;
							}
							@SuppressWarnings("null")
							/*@NonInvalid*/ @NonNull ShadowPart _1_5 = (@NonNull ShadowPart)ITER_1__5.next();
							/**
							 * referredProperty
							 */
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull Property referredProperty = _1_5.getReferredProperty();
							//
							accumulator_5.add(referredProperty);
						}
						@SuppressWarnings("null")
						final /*@NonInvalid*/ @NonNull SetValue partProperties = (@NonNull SetValue)CollectionAsSetOperation.INSTANCE.evaluate(collect_0);
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class TYP_Class_22 = idResolver.getClass(PivotTables.CLSSid_Class, null);
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_Class = (org.eclipse.ocl.pivot.Class)TYP_Class_22;
						@SuppressWarnings("null")
						final /*@Thrown*/ org.eclipse.ocl.pivot.@NonNull Class oclAsType = (org.eclipse.ocl.pivot.@NonNull Class)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, type, CAST_TYP_Class);
						@SuppressWarnings("null")
						final /*@Thrown*/ @NonNull SetValue oclAsSet = (@NonNull SetValue)OclAnyOclAsSetOperation.INSTANCE.evaluate(executor, PivotTables.SET_CLSSid_Class, oclAsType);
						...
						final @NonNull AbstractBinaryOperation BODY_closure = new AbstractBinaryOperation()
						{
							 ...
							 */
							@Override
							public @Nullable Object evaluate(final @NonNull Executor executor, final @NonNull TypeId typeId, final @Nullable Object oclAsSet, final /*@NonInvalid*/ @Nullable Object _1_9) {
								final /*@NonInvalid*/ org.eclipse.ocl.pivot.@Nullable Class CAST_1_ = (org.eclipse.ocl.pivot.Class)_1_9;
								if (CAST_1_ == null) {
						...
						@NonNull Iterator<Object> ITER_1__1 = closure.iterator();
						/*@Thrown*/ @NonNull BagValue collect;
						while (true) {
							if (!ITER_1__1.hasNext()) {
								collect = accumulator_0;
								break;
							}
							@SuppressWarnings("null")
							/*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class _1_1 = (org.eclipse.ocl.pivot.@NonNull Class)ITER_1__1.next();
							/**
							 * ownedProperties
							 */
						...
						@SuppressWarnings("null")
						final /*@Thrown*/ @NonNull SetValue allProperties = (@NonNull SetValue)CollectionAsSetOperation.INSTANCE.evaluate(collect);
						...
						@NonNull Iterator<Object> ITER_1__8 = allProperties.iterator();
						/*@Thrown*/ @NonNull SetValue reject_1;
						while (true) {
							if (!ITER_1__8.hasNext()) {
								reject_1 = accumulator_1;
								break;
							}
							@SuppressWarnings("null")
							/*@NonInvalid*/ @NonNull Property _1_8 = (@NonNull Property)ITER_1__8.next();
							/**
							 * isDerived or isImplicit or isStatic or isTransient
							 */
							/*@Caught*/ @Nullable Object CAUGHT_or;
							try {
								final /*@NonInvalid*/ boolean isDerived = _1_8.isIsDerived();
								final /*@NonInvalid*/ @Nullable Boolean or_1;
								if (isDerived) {
									or_1 = ValueUtil.TRUE_VALUE;
								}
								else {
									final /*@NonInvalid*/ boolean isImplicit = _1_8.isIsImplicit();
									if (isImplicit) {
										or_1 = ValueUtil.TRUE_VALUE;
									}
									else {
								...
								if (or_1 == ValueUtil.TRUE_VALUE) {
									...
									final /*@NonInvalid*/ boolean isStatic = _1_8.isIsStatic();
									if (isStatic) {
										or = ValueUtil.TRUE_VALUE;
									}
									else {
							...
							if (CAUGHT_or == ValueUtil.TRUE_VALUE) {
								...
								final /*@NonInvalid*/ boolean isTransient = _1_8.isIsTransient();
								if (isTransient) {
									or_0 = ValueUtil.TRUE_VALUE;
								}
								else {
						...
						@NonNull Iterator<Object> ITER_1__2 = reject_1.iterator();
						/*@Thrown*/ @NonNull SetValue classProperties;
						while (true) {
							if (!ITER_1__2.hasNext()) {
								classProperties = accumulator_6;
								break;
							}
							@SuppressWarnings("null")
							/*@NonInvalid*/ @NonNull Property _1_2 = (@NonNull Property)ITER_1__2.next();
							/**
							 * name?.startsWith('ocl')
							 */
							final /*@NonInvalid*/ @Nullable String name = _1_2.getName();
							final /*@NonInvalid*/ @NonNull Object startsWith_0 = name == null;
							/*@Thrown*/ @Nullable Boolean safe_startsWith_source;
							if (startsWith_0 == Boolean.TRUE) {
								...
								@SuppressWarnings("null")
								final /*@Thrown*/ boolean startsWith = ((@NonNull Boolean)StringStartsWithOperation.INSTANCE.evaluate(name, PivotTables.STR_ocl)).booleanValue();
						...
						@NonNull Iterator<Object> ITER_1__6 = classProperties.iterator();
						/*@Thrown*/ @NonNull SetValue reject_0;
						while (true) {
							if (!ITER_1__6.hasNext()) {
								reject_0 = accumulator_2;
								break;
							}
							@SuppressWarnings("null")
							/*@NonInvalid*/ @NonNull Property _1_6 = (@NonNull Property)ITER_1__6.next();
							/**
						...
						@NonNull Iterator<Object> ITER_1__7 = reject_0.iterator();
						/*@Thrown*/ @NonNull SetValue reject_2;
						while (true) {
							if (!ITER_1__7.hasNext()) {
								reject_2 = accumulator_3;
								break;
							}
							@SuppressWarnings("null")
							/*@NonInvalid*/ @NonNull Property _1_7 = (@NonNull Property)ITER_1__7.next();
							/**
							 * isVolatile or not isRequired
							 */
							final /*@NonInvalid*/ boolean isVolatile = _1_7.isIsVolatile();
							final /*@Thrown*/ @Nullable Boolean or;
							if (isVolatile) {
								or = ValueUtil.TRUE_VALUE;
							}
							else {
								final /*@NonInvalid*/ boolean isRequired = _1_7.isIsRequired();
						...
						@NonNull Iterator<Object> ITER_1__4 = reject_2.iterator();
						/*@Thrown*/ @NonNull SetValue reject;
						while (true) {
							if (!ITER_1__4.hasNext()) {
								reject = accumulator;
								break;
							}
							@SuppressWarnings("null")
							/*@NonInvalid*/ @NonNull Property _1_4 = (@NonNull Property)ITER_1__4.next();
							/**
							...
							final /*@NonInvalid*/ @Nullable Type type_0 = _1_4.getType();
							...
							@SuppressWarnings("null")
							final /*@Thrown*/ boolean oclIsKindOf_0 = ((@NonNull Boolean)OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_0, CAST_TYP_CollectionType)).booleanValue();
							//
							if (oclIsKindOf_0 == ValueUtil.FALSE_VALUE) {
								accumulator.add(_1_4);
							}
						}
						...
						@NonNull Iterator<Object> ITER_1__0 = reject.iterator();
						/*@Thrown*/ @NonNull SetValue requiredClassProperties;
						while (true) {
							if (!ITER_1__0.hasNext()) {
								requiredClassProperties = accumulator_4;
								break;
							}
							@SuppressWarnings("null")
							/*@NonInvalid*/ @NonNull Property _1_0 = (@NonNull Property)ITER_1__0.next();
							/**
							 * opposite <> null and opposite.isComposite
							 */
							final /*@NonInvalid*/ @Nullable Property opposite = _1_0.getOpposite();
							...
							if (!ne) {
								...
								catch (Exception THROWN_isComposite) {
									CAUGHT_isComposite = ValueUtil.createInvalidValue(THROWN_isComposite);
								}
						...
						@SuppressWarnings("null")
						final /*@Thrown*/ @NonNull SetValue extraProperties = (@NonNull SetValue)CollectionExcludingAllOperation.INSTANCE.evaluate(partProperties, classProperties);
						@SuppressWarnings("null")
						final /*@Thrown*/ @NonNull SetValue missingProperties = (@NonNull SetValue)CollectionExcludingAllOperation.INSTANCE.evaluate(requiredClassProperties, partProperties);
						@SuppressWarnings("null")
						final /*@Thrown*/ boolean notEmpty_0 = ((@NonNull Boolean)CollectionNotEmptyOperation.INSTANCE.evaluate(extraProperties)).booleanValue();
						...
						if (notEmpty_0) {
							...
							final @NonNull AbstractBinaryOperation BODY_sortedBy = new AbstractBinaryOperation()
							{
								 ...
								 */
								@Override
								public @Nullable Object evaluate(final @NonNull Executor executor, final @NonNull TypeId typeId, final @Nullable Object extraProperties, final /*@NonInvalid*/ @Nullable Object _1) {
									final /*@NonInvalid*/ @Nullable NamedElement CAST_1_ = (NamedElement)_1;
									if (CAST_1_ == null) {
							...
							while (true) {
								 ...
								 */
								@SuppressWarnings("null")
								final /*@NonInvalid*/ @NonNull String sum = (@NonNull String)StringConcatOperation.INSTANCE.evaluate(acc, PivotTables.STR__32);
								final /*@NonInvalid*/ @Nullable String name = p.getName();
								@SuppressWarnings("null")
								final /*@Thrown*/ @NonNull String sum_0 = (@NonNull String)StringConcatOperation.INSTANCE.evaluate(sum, name);
								//
								acc = sum_0;
							}
							...
							@SuppressWarnings("null")
							final /*@Thrown*/ boolean notEmpty = ((@NonNull Boolean)CollectionNotEmptyOperation.INSTANCE.evaluate(missingProperties)).booleanValue();
							...
							if (notEmpty) {
								...
								final @NonNull AbstractBinaryOperation BODY_sortedBy_0 = new AbstractBinaryOperation()
								{
									 ...
									 */
									@Override
									public @Nullable Object evaluate(final @NonNull Executor executor, final @NonNull TypeId typeId, final @Nullable Object missingProperties, final /*@NonInvalid*/ @Nullable Object _1_3) {
										final /*@NonInvalid*/ @Nullable NamedElement CAST_1_ = (NamedElement)_1_3;
										if (CAST_1_ == null) {
											throw new InvalidValueException("Null source for \'NamedElement::name\'");
										}
										final /*@Thrown*/ @Nullable String name = CAST_1_.getName();
								...
								while (true) {
									 ...
									 */
									@SuppressWarnings("null")
									final /*@NonInvalid*/ @NonNull String sum_0 = (@NonNull String)StringConcatOperation.INSTANCE.evaluate(acc_0, PivotTables.STR__32);
									final /*@NonInvalid*/ @Nullable String name = p_0.getName();
									@SuppressWarnings("null")
									final /*@Thrown*/ @NonNull String sum = (@NonNull String)StringConcatOperation.INSTANCE.evaluate(sum_0, name);
									//
									acc_0 = sum;
								}
	...
	public boolean validateTypeIsNotInvalid(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
			...
			if (le) {
				...
				@SuppressWarnings("null")
				final /*@NonInvalid*/ boolean logDiagnostic = ((@NonNull Boolean)CGStringLogDiagnosticOperation.INSTANCE.evaluate(executor, TypeId.BOOLEAN, constraintName, this, (Object)null, diagnostics, context, (Object)null, severity, result, PivotTables.INT_0)).booleanValue();
				IF__l_q = logDiagnostic;
			}
			return IF__l_q;
		}
