			...
			if (le) {
				...
				try {
					...
					if (oclIsKindOf) {
						...
						@NonNull Iterator<Object> ITER__1 = BOXED_ownedParts_0.iterator();
						...
						/*@Thrown*/ org.eclipse.ocl.pivot.values.BagValue.@NonNull Accumulator accumulator_3 = ValueUtil.createBagAccumulatorValue(PivotTables.BAG_CLSSid_Property);
						...
						@NonNull Iterator<Object> ITER__1_6 = allProperties.iterator();
						...
						@NonNull Iterator<Object> ITER__1_0 = reject_0.iterator();
						...
						while (true) {
							...
							final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_0, TYP_CollectionType_12).booleanValue();
							//
							if (oclIsKindOf_0 == ValueUtil.FALSE_VALUE) {
								accumulator_1.add(_1_4);
							}
						}
						...
						while (true) {
							 ...
							 */
							final /*@NonInvalid*/ @Nullable Property opposite = _1_5.getOpposite();
							...
							if (!IsEQ_) {
								...
								try {
									final /*@NonInvalid*/ @Nullable Property opposite_0 = _1_5.getOpposite();
									if (opposite_0 == null) {
