			...
			if (le) {
				...
				try {
					...
					if (oclIsKindOf) {
						...
						@NonNull Iterator<Object> ITER__1_1 = BOXED_ownedParts_0.iterator();
						...
						while (true) {
							...
							@SuppressWarnings("null")
							/*@NonInvalid*/ @NonNull ShadowPart _1_1 = (@NonNull ShadowPart)ITER__1_1.next();
							/**
							 * referredProperty
							 */
							@SuppressWarnings("null")
						...
						while (true) {
							...
							catch (Exception THROWN_or_1) {
								CAUGHT_or_1 = ValueUtil.createInvalidValue(THROWN_or_1);
							}
						...
						@NonNull Iterator<Object> ITER__1_2 = classProperties.iterator();
						/*@Thrown*/ @NonNull SetValue reject_1;
						while (true) {
							if (!ITER__1_2.hasNext()) {
								reject_1 = accumulator;
								break;
							}
							@SuppressWarnings("null")
						...
						@NonNull Iterator<Object> ITER__1_5 = reject_1.iterator();
						...
						@NonNull Iterator<Object> ITER__1_4 = reject.iterator();
						...
						while (true) {
							...
							final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_0, TYP_CollectionType_2).booleanValue();
							//
							if (oclIsKindOf_0 == ValueUtil.FALSE_VALUE) {
								accumulator_6.add(_1_4);
							}
						}
						...
						@NonNull Iterator<Object> ITER__1 = reject_0.iterator();
						...
						while (true) {
							...
							if (!IsEQ_) {
								...
								try {
									final /*@NonInvalid*/ @Nullable Property opposite_0 = _1.getOpposite();
									if (opposite_0 == null) {
	...
	public boolean validateTypeIsNotInvalid(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
			...
			if (le) {
				...
				final /*@NonInvalid*/ @NonNull InvalidType TYP_OclInvalid_6 = (@NonNull InvalidType)idResolver.getClass(TypeId.OCL_INVALID, null);
				final /*@NonInvalid*/ @Nullable Type type = this.getType();
