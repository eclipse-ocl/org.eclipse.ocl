			...
			if (le) {
				...
				try {
					...
					if (oclIsKindOf) {
						...
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class TYP_Class_11 = idResolver.getClass(PivotTables.CLSSid_Class, null);
						final /*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class CAST_TYP_Class = TYP_Class_11;
						@SuppressWarnings("null")
						...
						@NonNull Iterator<Object> ITER_1__3 = closure.iterator();
						/*@Thrown*/ @NonNull BagValue collect;
						while (true) {
							if (!ITER_1__3.hasNext()) {
								collect = accumulator_6;
								break;
							}
							@SuppressWarnings("null")
							/*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class _1_3 = (org.eclipse.ocl.pivot.@NonNull Class)ITER_1__3.next();
							/**
							 * ownedProperties
							 */
							final /*@NonInvalid*/ @NonNull List<Property> ownedProperties = _1_3.getOwnedProperties();
						...
						@NonNull Iterator<Object> ITER_1__6 = allProperties.iterator();
						...
						while (true) {
							...
							try {
								final /*@NonInvalid*/ boolean isDerived = _1_6.isIsDerived();
								final /*@NonInvalid*/ @Nullable Boolean or_1;
								if (isDerived) {
									or_1 = ValueUtil.TRUE_VALUE;
								}
								else {
									final /*@NonInvalid*/ boolean isImplicit = _1_6.isIsImplicit();
									if (isImplicit) {
										or_1 = ValueUtil.TRUE_VALUE;
									}
									else {
								...
								if (or_1 == ValueUtil.TRUE_VALUE) {
									...
									final /*@NonInvalid*/ boolean isStatic = _1_6.isIsStatic();
									if (isStatic) {
										or = ValueUtil.TRUE_VALUE;
									}
									else {
							...
							if (CAUGHT_or == ValueUtil.TRUE_VALUE) {
								...
								final /*@NonInvalid*/ boolean isTransient = _1_6.isIsTransient();
								if (isTransient) {
									or_0 = ValueUtil.TRUE_VALUE;
								}
								else {
						...
						@NonNull Iterator<Object> ITER_1__1 = classProperties.iterator();
						/*@Thrown*/ @NonNull SetValue reject_2;
						while (true) {
							if (!ITER_1__1.hasNext()) {
								reject_2 = accumulator_2;
								break;
							}
							@SuppressWarnings("null")
							/*@NonInvalid*/ @NonNull Property _1_1 = (@NonNull Property)ITER_1__1.next();
							/**
							 * defaultValueString <> null
							 */
							final /*@NonInvalid*/ @Nullable String defaultValueString = _1_1.getDefaultValueString();
							final /*@NonInvalid*/ boolean ne = defaultValueString != null;
							//
							if (!ne) {
								accumulator_2.add(_1_1);
							}
						}
						...
						@NonNull Iterator<Object> ITER_1_ = reject_0.iterator();
						/*@Thrown*/ @NonNull SetValue requiredClassProperties;
						while (true) {
							if (!ITER_1_.hasNext()) {
								requiredClassProperties = accumulator_0;
								break;
							}
							@SuppressWarnings("null")
						...
						if (notEmpty_0) {
							...
							final @NonNull AbstractBinaryOperation BODY_sortedBy_0 = new AbstractBinaryOperation()
							{
								...
								public @Nullable Object evaluate(final @NonNull Executor executor, final @NonNull TypeId typeId, final @Nullable Object extraProperties, final /*@NonInvalid*/ @Nullable Object _1_8) {
									final /*@NonInvalid*/ @Nullable NamedElement CAST_1_ = (NamedElement)_1_8;
									if (CAST_1_ == null) {
							...
							if (notEmpty) {
								...
								final @NonNull AbstractBinaryOperation BODY_sortedBy = new AbstractBinaryOperation()
								{
									...
									public @Nullable Object evaluate(final @NonNull Executor executor, final @NonNull TypeId typeId, final @Nullable Object missingProperties, final /*@NonInvalid*/ @Nullable Object _1_9) {
										final /*@NonInvalid*/ @Nullable NamedElement CAST_1_ = (NamedElement)_1_9;
										if (CAST_1_ == null) {
											throw new InvalidValueException("Null source for \'NamedElement::name\'");
										}
										final /*@Thrown*/ @Nullable String name = CAST_1_.getName();
