			...
			if (le) {
				...
				try {
					...
					if (oclIsKindOf) {
						...
						@NonNull Iterator<Object> ITER_1__6 = BOXED_ownedParts.iterator();
						...
						while (true) {
							...
							@SuppressWarnings("null")
							/*@NonInvalid*/ @NonNull ShadowPart _1_6 = (@NonNull ShadowPart)ITER_1__6.next();
							/**
							 * referredProperty
							 */
							@SuppressWarnings("null")
							final /*@NonInvalid*/ @NonNull Property referredProperty = _1_6.getReferredProperty();
							//
						...
						/*@Thrown*/ org.eclipse.ocl.pivot.values.BagValue.@NonNull Accumulator accumulator_3 = ValueUtil.createBagAccumulatorValue(PivotTables.BAG_CLSSid_Property_0);
						...
						@NonNull Iterator<Object> ITER_1_ = classProperties.iterator();
						...
						while (true) {
							 ...
							 */
							final /*@NonInvalid*/ @Nullable String defaultValueString = _1.getDefaultValueString();
							final /*@NonInvalid*/ boolean ne = defaultValueString != null;
							//
							if (!ne) {
								accumulator_1.add(_1);
							}
						}
						...
						@NonNull Iterator<Object> ITER_1__2 = reject_2.iterator();
						...
						while (true) {
							...
							final /*@NonInvalid*/ @Nullable Type type_0 = _1_9.getType();
							final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_0, TYP_CollectionType_10).booleanValue();
							//
							if (oclIsKindOf_0 == ValueUtil.FALSE_VALUE) {
								accumulator_0.add(_1_9);
							}
						}
						...
						while (true) {
							 ...
							 */
							final /*@NonInvalid*/ @Nullable Property opposite = _1_8.getOpposite();
	...
	public boolean validateTypeIsNotInvalid(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
			...
			if (le) {
				...
				final /*@NonInvalid*/ @NonNull InvalidType TYP_OclInvalid_3 = (@NonNull InvalidType)idResolver.getClass(TypeId.OCL_INVALID, null);
				final /*@NonInvalid*/ @Nullable Type type = this.getType();
				final /*@NonInvalid*/ boolean result = (type != null) ? (type.getTypeId() != TYP_OclInvalid_3.getTypeId()) : true;
