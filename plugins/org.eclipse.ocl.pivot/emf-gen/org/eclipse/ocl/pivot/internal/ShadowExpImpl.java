			...
			if (le) {
				...
				try {
					...
					if (oclIsKindOf) {
						...
						@NonNull Iterator<Object> ITER__1_0 = BOXED_ownedParts.iterator();
						...
						while (true) {
							...
							@SuppressWarnings("null")
							/*@NonInvalid*/ @NonNull ShadowPart _1_0 = (@NonNull ShadowPart)ITER__1_0.next();
							/**
							 * referredProperty
							 */
							@SuppressWarnings("null")
						...
						/*@Thrown*/ org.eclipse.ocl.pivot.values.BagValue.@NonNull Accumulator accumulator_4 = ValueUtil.createBagAccumulatorValue(PivotTables.BAG_CLSSid_Property_0);
						@NonNull Iterator<Object> ITER__1_5 = closure.iterator();
						...
						while (true) {
							...
							@SuppressWarnings("null")
							/*@NonInvalid*/ org.eclipse.ocl.pivot.@NonNull Class _1_5 = (org.eclipse.ocl.pivot.@NonNull Class)ITER__1_5.next();
							/**
							 * ownedProperties
							 */
						...
						@NonNull Iterator<Object> ITER__1_3 = classProperties.iterator();
						...
						@NonNull Iterator<Object> ITER__1_4 = reject_2.iterator();
						...
						@NonNull Iterator<Object> ITER__1_6 = reject_1.iterator();
						...
						@NonNull Iterator<Object> ITER__1_1 = reject.iterator();
						...
						while (true) {
							 ...
							 */
							final /*@NonInvalid*/ @Nullable Property opposite = _1_1.getOpposite();
