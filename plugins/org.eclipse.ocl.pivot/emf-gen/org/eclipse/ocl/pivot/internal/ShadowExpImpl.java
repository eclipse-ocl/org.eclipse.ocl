...
public class ShadowExpImpl extends OCLExpressionImpl implements ShadowExp
{
	...
	public boolean validateDataTypeHasOnePartInitializer(final DiagnosticChain diagnostics, final Map<Object, Object> context)
	{
		...
		try {
			 ...
			 *     then true
			 *     else
			 *       let result : Boolean[?] = type <> null implies
			 *         type.oclIsKindOf(DataType) implies
			 *         ownedParts->size() = 1
			 *       in
			...
			if (le) {
				...
				try {
					...
					if (ne) {
						...
						/*@Thrown*/ @NonNull Object symbol_7;
						if (oclIsKindOf) {
							...
							while (true) {
								...
								/**
								 * type <> null and type.oclIsKindOf(CollectionType)
								 */
								final /*@NonInvalid*/ @Nullable Type type_2 = _1_6.getType();
								final /*@NonInvalid*/ boolean ne_1 = type_2 != null;
								...
								if (!ne_1) {
									...
									try {
										...
										final /*@Thrown*/ boolean oclIsKindOf_0 = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, type_2, TYP_CollectionType_0).booleanValue();
							...
							while (true) {
								...
								final /*@NonInvalid*/ boolean ne_2 = opposite != null;
