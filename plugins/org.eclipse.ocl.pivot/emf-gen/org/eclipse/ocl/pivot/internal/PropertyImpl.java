	...
	public boolean isAttribute(final Property p)
	{
		...
		if (CAUGHT_oclIsKindOf == ValueUtil.FALSE_VALUE) {
			...
			try {
				...
				final /*@Thrown*/ org.eclipse.ocl.pivot.@Nullable Class oclAsType = (org.eclipse.ocl.pivot.@Nullable Class)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, container, TYP_Class_0);
				if (oclAsType == null) {
