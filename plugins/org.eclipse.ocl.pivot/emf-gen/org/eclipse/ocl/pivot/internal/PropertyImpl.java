...
implements Property {
	...
	@Override
	public @NonNull FlatClass getFlatClass(@NonNull CompleteStandardLibrary standardLibrary) {
	...
	public void unloaded(@NonNull ASResource asResource) {
		...
		// XXX this happens when finalizing testMoniker_oclstdlib_oclstdlib - maybe not easier
