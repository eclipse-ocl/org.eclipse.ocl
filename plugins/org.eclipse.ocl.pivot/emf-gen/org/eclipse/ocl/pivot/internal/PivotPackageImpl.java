...
implements PivotPackage  {
	 ...
	 * @generated
	 */
	private EClass coCollectionTypeEClass = null;
	 ...
	 */
	@Override
	public EAttribute getCollectionType_CoCollection()
	{
	 ...
	 */
	@Override
	public EClass getCoCollectionType()
	{
		return coCollectionTypeEClass;
	}
	...
	public void createPackageContents()
	{
		...
		coCollectionTypeEClass = createEClass(11);
		...
		createEAttribute(collectionTypeEClass, 23);
		...
		coCollectionEDataType = createEDataType(138);
	...
	public void initializePackageContents()
	{
		...
		coCollectionTypeEClass.getESuperTypes().add(this.getDataType());
		...
		initEClass(coCollectionTypeEClass, CoCollectionType.class, "CoCollectionType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		...
		initEAttribute(getCollectionType_CoCollection(), this.getCoCollection(), "coCollection", null, 0, 1, CollectionType.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
