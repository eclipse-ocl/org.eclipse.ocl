...
implements PivotPackage  {
	 ...
	 */
	@Override
	public EAttribute getVariableDeclaration_CacheNeeded()
	{
	...
	public void createPackageContents()
	{
		...
		createEAttribute(variableDeclarationEClass, VARIABLE_DECLARATION__CACHE_NEEDED);
	...
	public void initializePackageContents()
	{
		...
		initEAttribute(getVariableDeclaration_CacheNeeded(), this.getBoolean(), "cacheNeeded", "false", 1, 1, VariableDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$ //$NON-NLS-2$
