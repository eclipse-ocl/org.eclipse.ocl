					...
					if (!isSafe_0) {
						...
						try {
							...
							try {
								...
								final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, IF_IsEQ2_, TYP_CollectionType_12);
								if (oclAsType == null) {
