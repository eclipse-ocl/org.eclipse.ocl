					...
					if (!isSafe_0) {
						...
						try {
							...
							try {
								...
								final /*@Thrown*/ @Nullable CollectionType oclAsType = (@Nullable CollectionType)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, IF_IsEQ2_, TYP_CollectionType_7);
								if (oclAsType == null) {
					...
					if (!isSafe_0) {
						...
						try {
							...
							try {
								...
								final /*@Thrown*/ boolean IsEQ_ = sourceType != null;
								CAUGHT_IsEQ_ = IsEQ_;
							}
							...
							if (CAUGHT_IsEQ_ == ValueUtil.FALSE_VALUE) {
								...
								try {
									...
									try {
										...
										final /*@Thrown*/ boolean oclIsKindOf = OclAnyOclIsKindOfOperation.INSTANCE.evaluate(executor, sourceType, TYP_MapType_11).booleanValue();
