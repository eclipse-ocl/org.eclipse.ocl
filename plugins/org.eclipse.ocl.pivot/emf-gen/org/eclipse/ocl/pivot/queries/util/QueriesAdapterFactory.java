...
public class QueriesAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected QueriesSwitch<@Nullable Adapter> modelSwitch =
		new QueriesSwitch<@Nullable Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.ocl.pivot.queries.QueryModel <em>Query Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.ocl.pivot.queries.QueryResult <em>Query Result</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
