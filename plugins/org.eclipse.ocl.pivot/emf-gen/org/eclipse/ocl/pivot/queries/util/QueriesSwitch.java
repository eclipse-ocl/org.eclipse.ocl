 ...
 * @generated
 */
public class QueriesSwitch<@Nullable T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case 0: {
				...
				if (result == null) result = caseModel(queryModel);
				if (result == null) result = caseNamespace(queryModel);
				if (result == null) result = caseNamedElement(queryModel);
				if (result == null) result = caseElement(queryModel);
			...
			case 1: {
				...
				if (result == null) result = caseElement(queryResult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
