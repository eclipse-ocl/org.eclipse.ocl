 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.SendSignalActionImpl#getSignal <em>Signal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SendSignalActionImpl extends NamedElementImpl implements SendSignalAction
{
	...
	{
		return OCLASPackage.Literals.SEND_SIGNAL_ACTION;
	}
		...
		if (signal != null && signal.eIsProxy())
		{
			...
			if (signal != oldSignal)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 7, oldSignal, signal));
			}
		}
		return signal;
	}
	...
	public void setSignal(Signal newSignal)
	{
		...
		signal = newSignal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 7, oldSignal, signal));
	}
