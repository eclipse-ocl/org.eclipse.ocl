 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.RealLiteralExpImpl#getRealSymbol <em>Real Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RealLiteralExpImpl extends NumericLiteralExpImpl implements RealLiteralExp
{
	 ...
	 * @ordered
	 */
	public static final int REAL_LITERAL_EXP_FEATURE_COUNT = NumericLiteralExpImpl.NUMERIC_LITERAL_EXP_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	public static final int REAL_LITERAL_EXP_OPERATION_COUNT = NumericLiteralExpImpl.NUMERIC_LITERAL_EXP_OPERATION_COUNT + 0;
	...
	{
		return OCLASPackage.Literals.REAL_LITERAL_EXP;
	}
	...
	public void setRealSymbol(RealValue newRealSymbol)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 11, oldRealSymbol, realSymbol));
	}
