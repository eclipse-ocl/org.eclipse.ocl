 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.MapLiteralPartImpl#getOwnedKey <em>Owned Key</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.MapLiteralPartImpl#getOwnedValue <em>Owned Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapLiteralPartImpl extends ElementImpl implements MapLiteralPart
{
	...
	{
		return OCLASPackage.Literals.MAP_LITERAL_PART;
	}
	...
	public NotificationChain basicSetOwnedKey(OCLExpression newOwnedKey, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, 6, oldOwnedKey, newOwnedKey);
	...
	public void setOwnedKey(OCLExpression newOwnedKey)
	{
		if (newOwnedKey != ownedKey)
		{
			...
			if (ownedKey != null)
				msgs = ((InternalEObject)ownedKey).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - (6), null, msgs);
			if (newOwnedKey != null)
				msgs = ((InternalEObject)newOwnedKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - (6), null, msgs);
			msgs = basicSetOwnedKey(newOwnedKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 6, newOwnedKey, newOwnedKey));
	}
	...
	public NotificationChain basicSetOwnedValue(OCLExpression newOwnedValue, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, 7, oldOwnedValue, newOwnedValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOwnedValue(OCLExpression newOwnedValue)
	{
		if (newOwnedValue != ownedValue)
		{
			NotificationChain msgs = null;
			if (ownedValue != null)
				msgs = ((InternalEObject)ownedValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - (7), null, msgs);
			if (newOwnedValue != null)
				msgs = ((InternalEObject)newOwnedValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - (7), null, msgs);
			msgs = basicSetOwnedValue(newOwnedValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 7, newOwnedValue, newOwnedValue));
	}
