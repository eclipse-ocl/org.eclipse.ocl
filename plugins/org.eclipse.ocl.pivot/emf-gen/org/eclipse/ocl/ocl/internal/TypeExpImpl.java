 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.TypeExpImpl#getReferredType <em>Referred Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeExpImpl extends OCLExpressionImpl implements TypeExp
{
	 ...
	 * @ordered
	 */
	public static final int TYPE_EXP_OPERATION_COUNT = OCLExpressionImpl.OCL_EXPRESSION_OPERATION_COUNT + 0;
	...
	{
		return OCLASPackage.Literals.TYPE_EXP;
	}
		...
		if (referredType != null && referredType.eIsProxy())
		{
			...
			if (referredType != oldReferredType)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 11, oldReferredType, referredType));
			}
		}
		return referredType;
	}
	...
	public void setReferredType(Type newReferredType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 11, oldReferredType, referredType));
	}
