 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.TupleLiteralExpImpl#getOwnedParts <em>Owned Parts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleLiteralExpImpl extends LiteralExpImpl implements TupleLiteralExp
{
	...
	{
		return OCLASPackage.Literals.TUPLE_LITERAL_EXP;
	}
	...
	public List<TupleLiteralPart> getOwnedParts()
	{
		if (ownedParts == null)
		{
			ownedParts = new EObjectContainmentEList<TupleLiteralPart>(TupleLiteralPart.class, this, 11);
		}
		return ownedParts;
	}
