 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CommentImpl#getAnnotatedElements <em>Annotated Elements</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CommentImpl#getBody <em>Body</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CommentImpl#getOwningElement <em>Owning Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommentImpl extends ElementImpl implements Comment
{
	...
	{
		return OCLASPackage.Literals.COMMENT;
	}
	...
	public List<Element> getAnnotatedElements()
	{
		...
		{
			annotatedElements = new EObjectWithInverseResolvingEList.ManyInverse<Element>(Element.class, this, 6, 2);
		}
	...
	public void setBody(String newBody)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 7, oldBody, body));
	}
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newOwningElement, 8, msgs);
		return msgs;
	}
	...
	{
		if (newOwningElement != eInternalContainer() || (eContainerFeatureID() != (8) && newOwningElement != null))
		{
			...
			if (newOwningElement != null)
				msgs = ((InternalEObject)newOwningElement).eInverseAdd(this, 4, Element.class, msgs);
			msgs = basicSetOwningElement(newOwningElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 8, newOwningElement, newOwningElement));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case 8:
				return eInternalContainer().eInverseRemove(this, 4, Element.class, msgs);
		}
