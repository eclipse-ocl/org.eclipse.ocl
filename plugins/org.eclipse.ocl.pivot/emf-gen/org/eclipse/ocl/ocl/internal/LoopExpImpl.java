 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.LoopExpImpl#getOwnedBody <em>Owned Body</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.LoopExpImpl#getOwnedCoIterators <em>Owned Co Iterators</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.LoopExpImpl#getOwnedIterators <em>Owned Iterators</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.LoopExpImpl#getReferredIteration <em>Referred Iteration</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class LoopExpImpl extends CallExpImpl implements LoopExp
{
	...
	{
		return OCLASPackage.Literals.LOOP_EXP;
	}
	...
	public NotificationChain basicSetOwnedBody(OCLExpression newOwnedBody, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, 14, oldOwnedBody, newOwnedBody);
	...
	public void setOwnedBody(OCLExpression newOwnedBody)
	{
		if (newOwnedBody != ownedBody)
		{
			...
			if (ownedBody != null)
				msgs = ((InternalEObject)ownedBody).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - (14), null, msgs);
			if (newOwnedBody != null)
				msgs = ((InternalEObject)newOwnedBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - (14), null, msgs);
			msgs = basicSetOwnedBody(newOwnedBody, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 14, newOwnedBody, newOwnedBody));
	}
	...
	public List<IteratorVariable> getOwnedCoIterators()
	{
		...
		{
			ownedCoIterators = new EObjectContainmentEList<IteratorVariable>(IteratorVariable.class, this, 15);
		}
	...
	public List<Variable> getOwnedIterators()
	{
		...
		{
			ownedIterators = new EObjectContainmentEList<Variable>(Variable.class, this, 16);
		}
	...
	public Iteration getReferredIteration()
	{
		if (referredIteration != null && referredIteration.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 17, oldReferredIteration, referredIteration));
			}
		}
	...
	public void setReferredIteration(Iteration newReferredIteration)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 17, oldReferredIteration, referredIteration));
	}
