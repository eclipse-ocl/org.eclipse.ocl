 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.WildcardTypeImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.WildcardTypeImpl#getUpperBound <em>Upper Bound</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WildcardTypeImpl extends ClassImpl implements WildcardType
{
	...
	{
		return OCLASPackage.Literals.WILDCARD_TYPE;
	}
		...
		if (lowerBound != null && lowerBound.eIsProxy())
		{
			...
			if (lowerBound != oldLowerBound)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 22, oldLowerBound, lowerBound));
			}
		}
		return lowerBound;
	}
	...
	public void setLowerBound(Type newLowerBound)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 22, oldLowerBound, lowerBound));
	}
