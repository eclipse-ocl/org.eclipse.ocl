 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.DynamicBehaviorImpl#getMetaType <em>Meta Type</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.DynamicBehaviorImpl#getOwnedDynamicProperties <em>Owned Dynamic Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DynamicBehaviorImpl extends BehaviorImpl implements DynamicBehavior
{
	...
	{
		return OCLASPackage.Literals.DYNAMIC_BEHAVIOR;
	}
		...
		if (metaType != null && metaType.eIsProxy())
		{
			...
			if (metaType != oldMetaType)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 23, oldMetaType, metaType));
			}
		}
		return metaType;
	}
	...
	public void setMetaType(Type newMetaType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 23, oldMetaType, metaType));
	}
	...
	public List<DynamicProperty> getOwnedDynamicProperties()
	{
		...
		{
			ownedDynamicProperties = new EObjectContainmentEList<DynamicProperty>(DynamicProperty.class, this, 24);
		}
