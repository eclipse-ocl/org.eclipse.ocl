 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.OperationCallExpImpl#getIsVirtual <em>Is Virtual</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.OperationCallExpImpl#getOwnedArguments <em>Owned Arguments</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.OperationCallExpImpl#getReferredOperation <em>Referred Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationCallExpImpl extends FeatureCallExpImpl implements OperationCallExp
{
	 ...
	 * @ordered
	 */
	public static final int OPERATION_CALL_EXP_OPERATION_COUNT = FeatureCallExpImpl.FEATURE_CALL_EXP_OPERATION_COUNT + 0;
	...
	{
		return OCLASPackage.Literals.OPERATION_CALL_EXP;
	}
	...
	public void setIsVirtual(Boolean newIsVirtual)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 15, oldIsVirtual, isVirtual));
	}
	...
	public List<OCLExpression> getOwnedArguments()
	{
		...
		{
			ownedArguments = new EObjectContainmentEList<OCLExpression>(OCLExpression.class, this, 16);
		}
	...
	public Operation getReferredOperation()
	{
		if (referredOperation != null && referredOperation.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 17, oldReferredOperation, referredOperation));
			}
		}
	...
	public void setReferredOperation(Operation newReferredOperation)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 17, oldReferredOperation, referredOperation));
	}
