 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.PropertyCallExpImpl#getReferredProperty <em>Referred Property</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PropertyCallExpImpl extends NavigationCallExpImpl implements PropertyCallExp
{
	 ...
	 * @ordered
	 */
	public static final int PROPERTY_CALL_EXP_OPERATION_COUNT = NavigationCallExpImpl.NAVIGATION_CALL_EXP_OPERATION_COUNT + 0;
	...
	{
		return OCLASPackage.Literals.PROPERTY_CALL_EXP;
	}
		...
		if (referredProperty != null && referredProperty.eIsProxy())
		{
			...
			if (referredProperty != oldReferredProperty)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 17, oldReferredProperty, referredProperty));
			}
		}
	...
	public void setReferredProperty(Property newReferredProperty)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 17, oldReferredProperty, referredProperty));
	}
