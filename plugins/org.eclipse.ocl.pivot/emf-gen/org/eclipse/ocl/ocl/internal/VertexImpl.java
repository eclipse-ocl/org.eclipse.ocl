 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VertexImpl#getIncomingTransitions <em>Incoming Transitions</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VertexImpl#getOutgoingTransitions <em>Outgoing Transitions</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VertexImpl#getOwningRegion <em>Owning Region</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class VertexImpl extends NamedElementImpl implements Vertex
{
	 ...
	 * @ordered
	 */
	public static final int VERTEX_FEATURE_COUNT = NamedElementImpl.NAMED_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	public static final int VERTEX_OPERATION_COUNT = NamedElementImpl.NAMED_ELEMENT_OPERATION_COUNT + 0;
	...
	{
		return OCLASPackage.Literals.VERTEX;
	}
	...
	public List<Transition> getIncomingTransitions()
	{
		...
		{
			incomingTransitions = new EObjectWithInverseResolvingEList<Transition>(Transition.class, this, 7, 14);
		}
	...
	public List<Transition> getOutgoingTransitions()
	{
		...
		{
			outgoingTransitions = new EObjectWithInverseResolvingEList<Transition>(Transition.class, this, 8, 13);
		}
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newOwningRegion, 9, msgs);
		return msgs;
	}
	...
	{
		if (newOwningRegion != eInternalContainer() || (eContainerFeatureID() != (9) && newOwningRegion != null))
		{
			...
			eNotify(new ENotificationImpl(this, Notification.SET, 9, newOwningRegion, newOwningRegion));
	}
