 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.MapLiteralExpImpl#getOwnedParts <em>Owned Parts</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapLiteralExpImpl extends LiteralExpImpl implements MapLiteralExp
{
	...
	{
		return OCLASPackage.Literals.MAP_LITERAL_EXP;
	}
	...
	public List<MapLiteralPart> getOwnedParts()
	{
		if (ownedParts == null)
		{
			ownedParts = new EObjectContainmentEList<MapLiteralPart>(MapLiteralPart.class, this, 11);
		}
		return ownedParts;
	}
