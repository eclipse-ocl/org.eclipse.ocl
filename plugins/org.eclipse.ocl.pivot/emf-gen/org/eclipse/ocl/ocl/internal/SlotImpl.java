 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.SlotImpl#getDefiningProperty <em>Defining Property</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.SlotImpl#getOwnedValues <em>Owned Values</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.SlotImpl#getOwningInstance <em>Owning Instance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SlotImpl extends ElementImpl implements Slot
{
	...
	{
		return OCLASPackage.Literals.SLOT;
	}
		...
		if (definingProperty != null && definingProperty.eIsProxy())
		{
			...
			if (definingProperty != oldDefiningProperty)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 6, oldDefiningProperty, definingProperty));
			}
		}
	...
	public void setDefiningProperty(Property newDefiningProperty)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 6, oldDefiningProperty, definingProperty));
	}
	...
	public List<ValueSpecification> getOwnedValues()
	{
		if (ownedValues == null)
		{
			ownedValues = new EObjectContainmentEList<ValueSpecification>(ValueSpecification.class, this, 7);
		}
		return ownedValues;
	}
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newOwningInstance, 8, msgs);
		return msgs;
	}
	...
	{
		if (newOwningInstance != eInternalContainer() || (eContainerFeatureID() != (8) && newOwningInstance != null))
		{
			...
			if (newOwningInstance != null)
				msgs = ((InternalEObject)newOwningInstance).eInverseAdd(this, 8, InstanceSpecification.class, msgs);
			msgs = basicSetOwningInstance(newOwningInstance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 8, newOwningInstance, newOwningInstance));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case 8:
				return eInternalContainer().eInverseRemove(this, 8, InstanceSpecification.class, msgs);
		}
