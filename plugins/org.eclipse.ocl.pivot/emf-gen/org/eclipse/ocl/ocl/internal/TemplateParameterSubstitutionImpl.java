 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.TemplateParameterSubstitutionImpl#getActual <em>Actual</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.TemplateParameterSubstitutionImpl#getFormal <em>Formal</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.TemplateParameterSubstitutionImpl#getOwnedWildcard <em>Owned Wildcard</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.TemplateParameterSubstitutionImpl#getOwningBinding <em>Owning Binding</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TemplateParameterSubstitutionImpl extends ElementImpl implements TemplateParameterSubstitution
{
	...
	{
		return OCLASPackage.Literals.TEMPLATE_PARAMETER_SUBSTITUTION;
	}
		...
		if (actual != null && actual.eIsProxy())
		{
			...
			if (actual != oldActual)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 6, oldActual, actual));
			}
		}
		return actual;
	}
	...
	public void setActual(Type newActual)
	{
		...
		actual = newActual;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 6, oldActual, actual));
	}
	...
	public TemplateParameter getFormal()
	{
		if (formal != null && formal.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 7, oldFormal, formal));
			}
		}
		return formal;
	}
	...
	public void setFormal(TemplateParameter newFormal)
	{
		...
		formal = newFormal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 7, oldFormal, formal));
	}
	...
	public NotificationChain basicSetOwnedWildcard(WildcardType newOwnedWildcard, NotificationChain msgs)
	{
		...
		if (eNotificationRequired())
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, 8, oldOwnedWildcard, newOwnedWildcard);
	...
	public void setOwnedWildcard(WildcardType newOwnedWildcard)
	{
		if (newOwnedWildcard != ownedWildcard)
		{
			...
			if (ownedWildcard != null)
				msgs = ((InternalEObject)ownedWildcard).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - (8), null, msgs);
			if (newOwnedWildcard != null)
				msgs = ((InternalEObject)newOwnedWildcard).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - (8), null, msgs);
			msgs = basicSetOwnedWildcard(newOwnedWildcard, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 8, newOwnedWildcard, newOwnedWildcard));
	}
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newOwningBinding, 9, msgs);
		return msgs;
	}
	...
	{
		if (newOwningBinding != eInternalContainer() || (eContainerFeatureID() != (9) && newOwningBinding != null))
		{
			...
			if (newOwningBinding != null)
				msgs = ((InternalEObject)newOwningBinding).eInverseAdd(this, 6, TemplateBinding.class, msgs);
			msgs = basicSetOwningBinding(newOwningBinding, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 9, newOwningBinding, newOwningBinding));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case 9:
				return eInternalContainer().eInverseRemove(this, 6, TemplateBinding.class, msgs);
		}
