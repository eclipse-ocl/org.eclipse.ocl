 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOclContainer <em>Ocl Container</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOclContents <em>Ocl Contents</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getAnnotatingComments <em>Annotating Comments</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOwnedAnnotations <em>Owned Annotations</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOwnedComments <em>Owned Comments</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOwnedExtensions <em>Owned Extensions</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOwnedConstraints <em>Owned Constraints</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOwnedBindings <em>Owned Bindings</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOwnedSignature <em>Owned Signature</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getUnspecializedElement <em>Unspecialized Element</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getExtenders <em>Extenders</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getInstanceClassName <em>Instance Class Name</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getIsActive <em>Is Active</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getIsInterface <em>Is Interface</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOwnedBehaviors <em>Owned Behaviors</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOwnedInvariants <em>Owned Invariants</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOwnedOperations <em>Owned Operations</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOwnedProperties <em>Owned Properties</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getOwningPackage <em>Owning Package</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VoidTypeImpl#getSuperClasses <em>Super Classes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VoidTypeImpl extends PivotObjectImpl implements VoidType
{
	/**
	 ...
	 * @ordered
	 */
	public static final int VOID_TYPE_FEATURE_COUNT = 22;
	...
	{
		return OCLASPackage.Literals.VOID_TYPE;
	}
