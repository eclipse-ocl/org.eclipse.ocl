...
public abstract class CollectionLiteralPartImpl extends TypedElementImpl implements CollectionLiteralPart
{
	 ...
	 * @ordered
	 */
	public static final int COLLECTION_LITERAL_PART_OPERATION_COUNT = TypedElementImpl.TYPED_ELEMENT_OPERATION_COUNT + 0;
	...
	{
		return OCLASPackage.Literals.COLLECTION_LITERAL_PART;
	}
