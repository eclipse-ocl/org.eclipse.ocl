 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VariableDeclarationImpl#getTypeValue <em>Type Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class VariableDeclarationImpl extends TypedElementImpl implements VariableDeclaration
{
	 ...
	 * @ordered
	 */
	public static final int VARIABLE_DECLARATION_OPERATION_COUNT = TypedElementImpl.TYPED_ELEMENT_OPERATION_COUNT + 0;
	...
	{
		return OCLASPackage.Literals.VARIABLE_DECLARATION;
	}
	...
	public void setTypeValue(Type newTypeValue)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 10, oldTypeValue, typeValue));
	}
