 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CallOperationActionImpl#getOperation <em>Operation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CallOperationActionImpl extends NamedElementImpl implements CallOperationAction
{
	...
	{
		return OCLASPackage.Literals.CALL_OPERATION_ACTION;
	}
		...
		if (operation != null && operation.eIsProxy())
		{
			...
			if (operation != oldOperation)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 7, oldOperation, operation));
			}
		}
		return operation;
	}
	...
	public void setOperation(Operation newOperation)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 7, oldOperation, operation));
	}
