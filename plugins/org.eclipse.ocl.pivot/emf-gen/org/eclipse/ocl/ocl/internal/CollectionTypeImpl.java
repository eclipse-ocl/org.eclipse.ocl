 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOclContainer <em>Ocl Container</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOclContents <em>Ocl Contents</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getAnnotatingComments <em>Annotating Comments</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOwnedAnnotations <em>Owned Annotations</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOwnedComments <em>Owned Comments</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOwnedExtensions <em>Owned Extensions</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOwnedConstraints <em>Owned Constraints</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOwnedBindings <em>Owned Bindings</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOwnedSignature <em>Owned Signature</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getUnspecializedElement <em>Unspecialized Element</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getExtenders <em>Extenders</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getInstanceClassName <em>Instance Class Name</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getIsActive <em>Is Active</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getIsInterface <em>Is Interface</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOwnedBehaviors <em>Owned Behaviors</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOwnedInvariants <em>Owned Invariants</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOwnedOperations <em>Owned Operations</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOwnedProperties <em>Owned Properties</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getOwningPackage <em>Owning Package</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getSuperClasses <em>Super Classes</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getBehavioralClass <em>Behavioral Class</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getIsSerializable <em>Is Serializable</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getElementType <em>Element Type</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getIsNullFree <em>Is Null Free</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getLower <em>Lower</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CollectionTypeImpl#getUpper <em>Upper</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionTypeImpl extends PivotObjectImpl implements CollectionType
{
	/**
	 ...
	 * @ordered
	 */
	public static final int COLLECTION_TYPE_FEATURE_COUNT = 29;
	...
	/**
	 * The default value of the '{@link #getIsNullFree() <em>Is Null Free</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIsNullFree()
	 * @generated
	 * @ordered
	 */
	protected static final Boolean IS_NULL_FREE_EDEFAULT = Boolean.FALSE;

	/**
	 * The cached value of the '{@link #getIsNullFree() <em>Is Null Free</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIsNullFree()
	 * @generated
	 ...
	 * @ordered
	 */
	protected static final IntegerValue LOWER_EDEFAULT = (IntegerValue)OCLASFactory.eINSTANCE.createFromString(OCLASPackage.eINSTANCE.getInteger(), "0");
	 ...
	 * @ordered
	 */
	protected static final IntegerValue UPPER_EDEFAULT = (IntegerValue)OCLASFactory.eINSTANCE.createFromString(OCLASPackage.eINSTANCE.getInteger(), "*");
	 ...
	 * @ordered
	 */
	protected IntegerValue upper = UPPER_EDEFAULT;
	...
	{
		return OCLASPackage.Literals.COLLECTION_TYPE;
	}
	...
	{
		// TODO: implement this method to set the 'Element Type' reference
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public void setIsNullFree(Boolean newIsNullFree)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 26, oldIsNullFree, isNullFree));
	}
	...
	public void setLower(IntegerValue newLower)
	{
		...
		lower = newLower;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 27, oldLower, lower));
	}
	...
	public void setUpper(IntegerValue newUpper)
	{
		...
		upper = newUpper;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 28, oldUpper, upper));
	}
	...
	public boolean eIsSet(int featureID)
	{
		switch (featureID)
		{
			...
			case 26:
				return IS_NULL_FREE_EDEFAULT == null ? isNullFree != null : !IS_NULL_FREE_EDEFAULT.equals(isNullFree);
			case 27:
