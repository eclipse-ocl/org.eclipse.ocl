 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.StateExpImpl#getReferredState <em>Referred State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateExpImpl extends OCLExpressionImpl implements StateExp
{
	 ...
	 * @ordered
	 */
	public static final int STATE_EXP_OPERATION_COUNT = OCLExpressionImpl.OCL_EXPRESSION_OPERATION_COUNT + 0;
	...
	{
		return OCLASPackage.Literals.STATE_EXP;
	}
		...
		if (referredState != null && referredState.eIsProxy())
		{
			...
			if (referredState != oldReferredState)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 11, oldReferredState, referredState));
			}
		}
	...
	public void setReferredState(State newReferredState)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 11, oldReferredState, referredState));
	}
