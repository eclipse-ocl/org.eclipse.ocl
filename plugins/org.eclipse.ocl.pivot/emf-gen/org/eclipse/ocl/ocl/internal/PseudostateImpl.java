 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.PseudostateImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.PseudostateImpl#getOwningState <em>Owning State</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.PseudostateImpl#getOwningStateMachine <em>Owning State Machine</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PseudostateImpl extends VertexImpl implements Pseudostate
{
	...
	{
		return OCLASPackage.Literals.PSEUDOSTATE;
	}
	...
	{
		PseudostateKind oldKind = KIND_EFLAG_VALUES[(eFlags2 & KIND_EFLAG) >>> KIND_EFLAG_OFFSET];
		if (newKind == null) newKind = KIND_EDEFAULT;
		eFlags2 = eFlags2 & ~KIND_EFLAG | newKind.ordinal() << KIND_EFLAG_OFFSET;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 10, oldKind, newKind));
	}
