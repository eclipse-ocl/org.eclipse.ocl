 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CompleteClassImpl#getOwningCompletePackage <em>Owning Complete Package</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.CompleteClassImpl#getPartialClasses <em>Partial Classes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompleteClassImpl extends NamedElementImpl implements CompleteClass
{
	 ...
	 * @ordered
	 */
	protected EList<org.eclipse.ocl.ocl.Class> partialClasses;
	...
	{
		return OCLASPackage.Literals.COMPLETE_CLASS;
	}
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newOwningCompletePackage, 7, msgs);
		return msgs;
	}
	...
	{
		if (newOwningCompletePackage != eInternalContainer() || (eContainerFeatureID() != (7) && newOwningCompletePackage != null))
		{
			...
			if (newOwningCompletePackage != null)
				msgs = ((InternalEObject)newOwningCompletePackage).eInverseAdd(this, 7, CompletePackage.class, msgs);
			msgs = basicSetOwningCompletePackage(newOwningCompletePackage, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 7, newOwningCompletePackage, newOwningCompletePackage));
	}
	 ...
	 */
	@Override
	public List<org.eclipse.ocl.ocl.Class> getPartialClasses()
	{
		if (partialClasses == null)
		{
			partialClasses = new EObjectResolvingEList<org.eclipse.ocl.ocl.Class>(org.eclipse.ocl.ocl.Class.class, this, 8);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case 7:
				return eInternalContainer().eInverseRemove(this, 7, CompletePackage.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue)
	{
		switch (featureID)
		{
			...
			case 8:
				...
				getPartialClasses().addAll((Collection<? extends org.eclipse.ocl.ocl.Class>)newValue);
				return;
		}
