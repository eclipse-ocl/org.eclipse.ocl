 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.BooleanLiteralExpImpl#getBooleanSymbol <em>Boolean Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanLiteralExpImpl extends PrimitiveLiteralExpImpl implements BooleanLiteralExp
{
	 ...
	 * @ordered
	 */
	protected static final int BOOLEAN_SYMBOL_ESETFLAG = 1 << 8;
	...
	{
		return OCLASPackage.Literals.BOOLEAN_LITERAL_EXP;
	}
	...
	public void setBooleanSymbol(Boolean newBooleanSymbol)
	{
		...
		boolean oldBooleanSymbolESet = (eFlags2 & BOOLEAN_SYMBOL_ESETFLAG) != 0;
		eFlags2 |= BOOLEAN_SYMBOL_ESETFLAG;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 11, oldBooleanSymbol, booleanSymbol, !oldBooleanSymbolESet));
	}
	...
	public void unsetBooleanSymbol()
	{
		Boolean oldBooleanSymbol = booleanSymbol;
		boolean oldBooleanSymbolESet = (eFlags2 & BOOLEAN_SYMBOL_ESETFLAG) != 0;
		booleanSymbol = BOOLEAN_SYMBOL_EDEFAULT;
		eFlags2 &= ~BOOLEAN_SYMBOL_ESETFLAG;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, 11, oldBooleanSymbol, BOOLEAN_SYMBOL_EDEFAULT, oldBooleanSymbolESet));
	}
	...
	{
		return (eFlags2 & BOOLEAN_SYMBOL_ESETFLAG) != 0;
	}
	...
	public String toString()
	{
		...
		if ((eFlags2 & BOOLEAN_SYMBOL_ESETFLAG) != 0) result.append(booleanSymbol); else result.append("<unset>"); //$NON-NLS-1$
		result.append(')');
