 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.StandardLibraryImpl#getOwningCompleteEnvironment <em>Owning Complete Environment</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StandardLibraryImpl extends ElementImpl implements StandardLibrary
{
	/**
	...
	{
		return OCLASPackage.Literals.STANDARD_LIBRARY;
	}
	...
	{
		msgs = eBasicSetContainer((InternalEObject)newOwningCompleteEnvironment, 6, msgs);
		return msgs;
	}
	...
	{
		if (newOwningCompleteEnvironment != eInternalContainer() || (eContainerFeatureID() != (6) && newOwningCompleteEnvironment != null))
		{
			...
			if (newOwningCompleteEnvironment != null)
				msgs = ((InternalEObject)newOwningCompleteEnvironment).eInverseAdd(this, 7, CompleteEnvironment.class, msgs);
			msgs = basicSetOwningCompleteEnvironment(newOwningCompleteEnvironment, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 6, newOwningCompleteEnvironment, newOwningCompleteEnvironment));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
	{
		...
		{
			case 6:
				return eInternalContainer().eInverseRemove(this, 7, CompleteEnvironment.class, msgs);
		}
