 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VariableExpImpl#getIsImplicit <em>Is Implicit</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.VariableExpImpl#getReferredVariable <em>Referred Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableExpImpl extends OCLExpressionImpl implements VariableExp
{
	...
	{
		return OCLASPackage.Literals.VARIABLE_EXP;
	}
	...
	public void setIsImplicit(Boolean newIsImplicit)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 11, oldIsImplicit, isImplicit));
	}
	...
	public VariableDeclaration getReferredVariable()
	{
		if (referredVariable != null && referredVariable.eIsProxy())
		{
			...
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 12, oldReferredVariable, referredVariable));
			}
		}
	...
	public void setReferredVariable(VariableDeclaration newReferredVariable)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 12, oldReferredVariable, referredVariable));
	}
