 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.DynamicTypeImpl#getMetaType <em>Meta Type</em>}</li>
 *   <li>{@link org.eclipse.ocl.ocl.internal.DynamicTypeImpl#getOwnedDynamicProperties <em>Owned Dynamic Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DynamicTypeImpl extends ClassImpl implements DynamicType
{
	...
	{
		return OCLASPackage.Literals.DYNAMIC_TYPE;
	}
		...
		if (metaType != null && metaType.eIsProxy())
		{
			...
			if (metaType != oldMetaType)
			{
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, 22, oldMetaType, metaType));
			}
		}
		return metaType;
	}
	...
	public void setMetaType(Type newMetaType)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 22, oldMetaType, metaType));
	}
	...
	public List<DynamicProperty> getOwnedDynamicProperties()
	{
		...
		{
			ownedDynamicProperties = new EObjectContainmentEList<DynamicProperty>(DynamicProperty.class, this, 23);
		}
