 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.ProfileImpl#getProfileApplications <em>Profile Applications</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProfileImpl extends PackageImpl implements Profile
{
	...
	{
		return OCLASPackage.Literals.PROFILE;
	}
	...
	public List<ProfileApplication> getProfileApplications()
	{
		...
		{
			profileApplications = new EObjectWithInverseResolvingEList<ProfileApplication>(ProfileApplication.class, this, 16, 6);
		}
