 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.ocl.ocl.internal.StringLiteralExpImpl#getStringSymbol <em>String Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringLiteralExpImpl extends PrimitiveLiteralExpImpl implements StringLiteralExp
{
	 ...
	 * @ordered
	 */
	public static final int STRING_LITERAL_EXP_FEATURE_COUNT = PrimitiveLiteralExpImpl.PRIMITIVE_LITERAL_EXP_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	public static final int STRING_LITERAL_EXP_OPERATION_COUNT = PrimitiveLiteralExpImpl.PRIMITIVE_LITERAL_EXP_OPERATION_COUNT + 0;
	...
	{
		return OCLASPackage.Literals.STRING_LITERAL_EXP;
	}
	...
	public void setStringSymbol(String newStringSymbol)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, 11, oldStringSymbol, stringSymbol));
	}
