 ...
 * @since 1.3
 */
public class CollectionMutableIntersectionOperation extends AbstractBinaryOperation
{
	public static final @NonNull CollectionMutableIntersectionOperation INSTANCE = new CollectionMutableIntersectionOperation();
	...
	public @NonNull CollectionValue evaluate(@NonNull Executor executor, @NonNull TypeId returnTypeId, @Nullable Object sourceValue, @Nullable Object argumentValue) {
		...
		if (iterable instanceof LazyIterable) {
			return ((LazyIterable<@Nullable Object>)iterable).mutableIntersection(leftCollectionValue, rightCollectionValue.iterator(), leftCollectionValue.isUnique() || rightCollectionValue.isUnique());
		}
		else {
