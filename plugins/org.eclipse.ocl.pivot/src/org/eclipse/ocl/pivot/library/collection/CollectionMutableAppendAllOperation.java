 ...
 * @since 1.3
 */
public class CollectionMutableAppendAllOperation extends AbstractBinaryOperation
{
	public static final @NonNull CollectionMutableAppendAllOperation INSTANCE = new CollectionMutableAppendAllOperation();
	...
	public @NonNull CollectionValue evaluate(@NonNull Executor executor, @NonNull TypeId returnTypeId, @Nullable Object sourceValue, @Nullable Object argumentValue) {
		...
		if (iterable instanceof LazyIterable) {
			return ((LazyIterable<@Nullable Object>)iterable).mutableAppendAll(leftCollectionValue, rightCollectionValue.iterator());
		}
		else {
