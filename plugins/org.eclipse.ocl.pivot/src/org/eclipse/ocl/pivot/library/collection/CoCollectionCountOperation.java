 ...
 * @since 1.23
 */
public class CoCollectionCountOperation extends AbstractSimpleBinaryOperation
{
	public static final @NonNull CoCollectionCountOperation INSTANCE = new CoCollectionCountOperation();

	@Override
	public @NonNull IntegerValue evaluate(@Nullable Object left, @Nullable Object right) {
		CoCollectionValue leftCollectionValue = asCoCollectionValue(left);
