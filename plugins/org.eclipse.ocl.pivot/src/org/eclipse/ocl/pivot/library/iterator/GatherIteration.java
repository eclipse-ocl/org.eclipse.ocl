...
/**
 * GatherIteration realizes the Collection::gather() library iteration.
 *
 * @since 1.23
 */
public class GatherIteration extends AbstractIteration
{
	public static final @NonNull GatherIteration INSTANCE = new GatherIteration();
