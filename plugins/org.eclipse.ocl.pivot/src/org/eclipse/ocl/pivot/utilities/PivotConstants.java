...
public interface PivotConstants
{
	...
	// FIXME The following should be defined by autogenerated read and promote
	/**
	 * @since 1.14
	 */
	public static final @NonNull String UML2_UML_PACKAGE_2_0_NS_URI = "http://www.eclipse.org/uml2/2.0.0/UML"; // UMLUtil.UML2_UML_PACKAGE_2_0_NS_URI
	/**
	 * @since 1.14
	 */
	public static final String ANNOTATION_DETAIL__ORIGINAL_NAME = "originalName"; // UMLUtil.ANNOTATION_DETAIL__ORIGINAL_NAME
}
