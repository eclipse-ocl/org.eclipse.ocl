...
public interface SymbolicEvaluationEnvironment
{
	...
	@NonNull SymbolicValue getUnknownValue(@NonNull TypedElement typedElement, @Nullable SymbolicReason mayBeNullReason, @Nullable SymbolicReason mayBeInvalidReason);
...
//	boolean mayBeInvalid(@NonNull TypedElement typedElement);
	@Nullable SymbolicReason mayBeInvalidReason(@NonNull TypedElement typedElement);
	boolean mayBeInvalidOrNull(@NonNull TypedElement typedElement);
//	boolean mayBeNull(@NonNull TypedElement typedElement);
	@Nullable SymbolicReason mayBeNullReason(@NonNull TypedElement typedElement);
