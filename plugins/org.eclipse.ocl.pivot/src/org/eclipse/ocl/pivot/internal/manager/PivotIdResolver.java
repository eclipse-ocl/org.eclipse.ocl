...
public class PivotIdResolver extends AbstractIdResolver
{
	...
	public @NonNull EcoreFlatClass getFlatClass(@NonNull EClassifier eClassifier) {
		return (EcoreFlatClass)metamodelManager.getFlatClass(getType(eClassifier));
	}
	...
	public org.eclipse.ocl.pivot.@NonNull Class getType(@NonNull EClassifier eClassifier) {
		...
		try {
			pivotType = ((EnvironmentFactoryInternal)environmentFactory).getASOf(org.eclipse.ocl.pivot.Class.class, eType);
			if (pivotType != null) {
