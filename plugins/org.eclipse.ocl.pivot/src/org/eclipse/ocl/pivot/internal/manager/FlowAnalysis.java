	...
	protected static class CallPath
	{
		...
		protected boolean isSameTerm(@NonNull OCLExpression firstExpression, @NonNull OCLExpression secondExpression,
			...
			if (firstExpression instanceof BooleanLiteralExp) {
				...
				List<@NonNull OCLExpression> firstBodies = PivotUtilInternal.getOwnedBodiesList(firstIterateExp);
				List<@NonNull OCLExpression> secondBodies = PivotUtilInternal.getOwnedBodiesList(secondIterateExp);
