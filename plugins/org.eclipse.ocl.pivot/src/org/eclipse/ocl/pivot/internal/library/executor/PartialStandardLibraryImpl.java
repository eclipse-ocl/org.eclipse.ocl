...
{
	public static class ImmutablePartialStandardLibraryImpl extends PartialStandardLibraryImpl
	{
		public ImmutablePartialStandardLibraryImpl(org.eclipse.ocl.pivot.@NonNull Package... execPackages) {
	...
	public static class MutablePartialStandardLibraryImpl extends PartialStandardLibraryImpl
	{
		/**
		 * @since 7.0
		 */
		public MutablePartialStandardLibraryImpl(@NonNull ImmutablePartialStandardLibraryImpl immutableStandardLibrary) {
...
//				flatClass = type.getFlatClass(this);
	 ...
	 * @since 7.0
	 */
	protected static class PartialJavaTypeManager extends AbstractJavaTypeManager
	{
		protected PartialJavaTypeManager( @NonNull StandardLibrary standardLibrary) {
			super(standardLibrary);
		}
	}
	...
	protected @NonNull Map<@NonNull String, @NonNull WeakReference<org.eclipse.ocl.pivot.@NonNull Package>> ePackageMap = new WeakHashMap<>();		// Keys are interned
	...
	protected /*@LazyNonNull*/ Map<org.eclipse.ocl.pivot.@NonNull Package, @NonNull List<org.eclipse.ocl.pivot.@NonNull Package>> extensions = null;
	...
	public @NonNull CompleteInheritance getInheritance(org.eclipse.ocl.pivot.@NonNull Class asClass) {
		...
		synchronized (this) {
			...
			if (ecoreExecutorPackage != null) {
				...
				Map<org.eclipse.ocl.pivot.@NonNull Package, @NonNull List<org.eclipse.ocl.pivot.@NonNull Package>> extensions2 = extensions;
				if (extensions2 != null) {
					List<org.eclipse.ocl.pivot.@NonNull Package> packages = extensions2.get(ecoreExecutorPackage);
					if (packages != null) {
						for (org.eclipse.ocl.pivot.@NonNull Package extensionPackage : packages) {
...
/*	@Override
	...
	public org.eclipse.ocl.pivot.Package getNsURIPackage(@NonNull String nsURI) {
		WeakReference<org.eclipse.ocl.pivot.Package> weakReference = ePackageMap.get(nsURI.intern());
