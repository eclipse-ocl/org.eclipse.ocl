...
{
	public static final @NonNull OCL_Import_AnnotationValidator INSTANCE = new OCL_Import_AnnotationValidator(AnnotationUtil.EPACKAGE_IMPORT_ANNOTATION_SOURCE);
	...
	{
		public static final @NonNull OCL_Import_AnnotationValidator INSTANCE = new OCL_Import_AnnotationValidator(AnnotationUtil.legacy_IMPORT_ANNOTATION_SOURCE);
	}

	private OCL_Import_AnnotationValidator(@NonNull String annotationSource) {
		super(annotationSource, ANNOTATION_NAME, DIAGNOSTIC_SOURCE, PivotAnnotationsPackage.Literals.IMPORT_EPACKAGE);
	}
