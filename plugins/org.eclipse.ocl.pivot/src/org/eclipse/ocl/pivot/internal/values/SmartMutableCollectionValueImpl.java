 ...
 */
public class SmartMutableCollectionValueImpl extends SmartCollectionValueImpl
{
	public SmartMutableCollectionValueImpl(@NonNull CollectionTypeId typeId, @NonNull LazyIterator inputIterator) {
	...
	@Override
	protected @NonNull CollectionValue reValue2(@NonNull CollectionTypeId typeId, @NonNull LazyIterator inputIterator, int lazyDepth) {
		return new SmartMutableCollectionValueImpl(typeId, inputIterator.reIterator());
	}
}