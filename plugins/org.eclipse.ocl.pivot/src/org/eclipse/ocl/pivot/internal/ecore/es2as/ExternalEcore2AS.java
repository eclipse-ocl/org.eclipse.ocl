...
/**
 * Manage conversion of a *.ecore model to a *.ecore.oclas.
 *
 ...
 * @since 7.0
 */
public class ExternalEcore2AS extends Ecore2AS
{
	/**
	 * @since 7.0
	 */
	public static @Nullable ExternalEcore2AS basicGetAdapter(@NonNull Resource resource, @NonNull EnvironmentFactory environmentFactory) {
		External2AS adapter = External2AS.findAdapter(resource, environmentFactory);
		ExternalEcore2AS castAdapter = (ExternalEcore2AS)adapter;
		return castAdapter;
	}
	 ...
	 * @since 7.0
	 */
	public static @NonNull ExternalEcore2AS createExternal2AS(@NonNull Resource resource, @NonNull EnvironmentFactory environmentFactory) {
	...
	public static @Nullable ExternalEcore2AS loadFromEcore(@NonNull ASResource ecoreASResource, @NonNull URI ecoreURI) {
	 ...
	 * @since 7.0
	 */
	public ExternalEcore2AS(@NonNull Resource ecoreResource, @NonNull EnvironmentFactory environmentFactory) {
		super(ecoreResource, environmentFactory);
...
//			PivotUtil.debugPrintln("getASModel: " + ecoreResource.getURI());
	...
	protected @Nullable EPackage isLibrary(@NonNull Collection<@NonNull EObject> ecoreContents) {
		...
		return PivotUtil.isLibrary(ecorePackage) ? ecorePackage : null;
	}
	...
	protected void resolveDeclarations(@NonNull ASResource asResource, @NonNull Iterable<@NonNull EObject> ecoreContents) {
		...
		PivotUtil.refreshList(asResource.getContents(), true, Collections.singletonList(ClassUtil.requireNonNull(pivotModel)));
