 ...
 * @since 1.3
 */
public class PrependAllIterator extends AbstractCollectionIterator
{
	public static @NonNull CollectionValue prependAll(@NonNull CollectionValue firstValue, @NonNull CollectionValue secondValue) {
		return new PrependAllIterator(firstValue, secondValue);
	}
	...
	public PrependAllIterator(@NonNull CollectionValue firstValue, @NonNull CollectionValue secondValue) {
		super(firstValue.getTypeId());
		this.suffix = firstValue.iterator();
		this.prefix = secondValue.iterator();
	}
